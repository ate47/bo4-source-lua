...
CoD.SelectedFilmInformation.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MatchType:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	MatchType:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	SelectedFilmSummaryInformation:subscribeToGlobalModel( f1_arg1, "GlobalModel", "fileshareRoot.summaryDownloadTask.state", function ( model )
		...
		if CoD.ModelUtility.IsGlobalModelValueEqualToEnum( "fileshareRoot.summaryDownloadTask.state", Enum[@"FileshareTaskUIState"][@"hash_6FE5B3BE5B00EEEA"] ) and CoD.ModelUtility.IsGlobalModelValueTrue( "fileshareRoot.summaryDownloadTask.success" ) then
