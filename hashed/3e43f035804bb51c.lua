...
CoD.StartMenu_Options.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	GraphicContent.StartMenuOptionsSubFrame.ButtonText:setText( LocalizeToUpperString( @"menu/content_filter" ) ) --[[ @ 0]]
	...
	Muting.StartMenuOptionsSubFrame.ButtonText:setText( LocalizeToUpperString( @"menu/muting" ) ) --[[ @ 0]]
	...
	Network.StartMenuOptionsSubFrame.ButtonText:setText( LocalizeToUpperString( @"menu/network" ) ) --[[ @ 0]]
	...
	Blackout.StartMenuOptionsSubFrame.ButtonText:setText( LocalizeToUpperString( @"menu/warzone" ) ) --[[ @ 0]]
	...
	Audio.StartMenuOptionsSubFrame.ButtonText:setText( LocalizeToUpperString( @"menu/audio" ) ) --[[ @ 0]]
	...
	Controls.StartMenuOptionsSubFrame.ButtonText:setText( LocalizeToUpperString( @"menu/controls" ) ) --[[ @ 0]]
	...
	QuitButtonCodcaster:appendEventHandler( "input_source_changed", function ( f36_arg0, f36_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f36_arg0, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( QuitButton, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"], "MOUSE1", function ( element, menu, controller, model )
		...
		if IsMouseOrKeyboard( controller ) and IsPC() then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xba_pscross"], @"menu/quit", nil, "MOUSE1" ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	f1_arg0:AddButtonCallbackFunction( QuitButton, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"], nil, function ( element, menu, controller, model )
		...
		if IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xba_pscross"], @"menu/quit", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	DirectorGenericButton.DirectorSelectButtonMiniInternal.MiddleText:setText( LocalizeToUpperString( @"warzone/start_warzone" ) ) --[[ @ 0]]
	DirectorGenericButton.DirectorSelectButtonMiniInternal.MiddleTextFocus:setText( LocalizeToUpperString( @"warzone/start_warzone" ) ) --[[ @ 0]]
	DirectorGenericButton:appendEventHandler( "on_session_start", function ( f60_arg0, f60_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f60_arg0, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_local13( f1_local15, f1_local16["hudItems.hasStartedWZMatch"], function ( f62_arg0, f62_arg1 )
		CoD.Menu.UpdateButtonShownState( f62_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
