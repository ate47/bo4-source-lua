...
require( "x64:499d9debb5e8ab3c" ) --[[ @ 0]]

CoD.ChallengesOperationsWZ = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.ChallengesOperationsWZ = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "ChallengesOperationsWZ", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	self:setClass( CoD.ChallengesOperationsWZ ) --[[ @ 0]]
	...
	MenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_12177A3C9161B05A" ) ) --[[ @ 0]]
	...
	local FETabBar = CoD.StartMenu_challengesOperationTab.new( f1_local1, f1_arg0, 0, 0, 0, 1920, 0, 0, 0, 62 ) --[[ @ 0]]
	FETabBar.TabBacking.TabBackingBlur:setAlpha( 0 ) --[[ @ 0]]
