...
CoD.ZombiesCallingsUtility.FactionCallingPact = {
	[@"hash_7F3FE25D461A019F"] = @"hash_20DEAB97ABBF7B12",
	[@"hash_134B8FF9BDDB205F"] = @"hash_764A5FC3BA8820D2",
	[@"hash_278132D0DAB0252B"] = @"hash_647EBC7D24425FEE",
	[@"tcmgoal"] = @"tcmgoal"
} --[[ @ 0]]
...
CoD.ZombiesCallingsUtility.FactionCallingRewardCasts = {
	@"hash_28C2C53B0617E2CD",
	@"hash_28C2C23B0617DDB4",
	@"hash_28C2C33B0617DF67"
} --[[ @ 0]]
CoD.ZombiesCallingsUtility.FactionCallingRewards = {
	...
	[@"hash_BF0B067663640F5"] = {
		name = @"hash_7B3BEA931147DB0",
		index = 3
	},
	[@"hash_BF0AD6766363BDC"] = {
		name = @"hash_7B3BEA931147DB0",
		index = 4
	}
} --[[ @ 0]]
CoD.ZombiesCallingsUtility.FactionRewardCompletions = {
	[@"hash_575736026043571B"] = {},
	[@"headgear"] = {
		rewardHashes = {
			@"headgear"
		},
	...
	[@"hash_6BD6E1F8964DCE86"] = {
		rewardHashes = {
			@"hash_BF0B067663640F5",
			@"hash_BF0AD6766363BDC"
		},
		rewardName = @"hash_2AEABC7E65D1B259",
...
CoD.ZombiesCallingsUtility.GetFactionIndex = function ( f2_arg0, f2_arg1 )
	...
	for f2_local4, f2_local5 in ipairs( f2_local0.factioncallingseasons[f2_arg0].factionlist ) --[[ @ 0]] do
		if Engine[@"hash_1C53F8D38DF9042B"]( f2_local5[@"hash_237E6733A4393CBA"] ) == f2_arg1 then
			return f2_local4
		end
	end
	return nil
	...
	for f3_local28, f3_local29 in ipairs( f3_local0.factioncallingseasons ) --[[ @ 0]] do
		...
		if f3_local29.factionlist then
			for f3_local25, f3_local26 in ipairs( f3_local29.factionlist ) --[[ @ 0]] do
				local f3_local27 = Engine[@"hash_1C53F8D38DF9042B"]( f3_local26[@"hash_237E6733A4393CBA"] ) --[[ @ 0]]
				if f3_local27 then
										...
										if f3_local20 and f3_local20 ~= @"hash_0" then
											f3_arg0[f3_local20] = {
												...
												path = {
													...
													@"factions",
													f3_local27,
													@"hash_28833743622919CB",
													f3_local24,
													@"hash_68F54E2E72E0EA12",
													f3_local21
												},
		...
		for f3_local25, f3_local26 in pairs( CoD.ZombiesCallingsUtility.FactionRewardCompletions ) --[[ @ 0]] do
			...
			if f3_local27 == @"hash_575736026043571B" and f3_local29.factionlist then
				for f3_local23, f3_local24 in ipairs( f3_local29.factionlist ) --[[ @ 0]] do
					local f3_local10 = Engine[@"hash_1C53F8D38DF9042B"]( f3_local24[@"hash_237E6733A4393CBA"] ) --[[ @ 0]]
...
CoD.ZombiesCallingsUtility.UpdateTimerModelsCustom = function ( f9_arg0, f9_arg1, f9_arg2, f9_arg3 )
	local f9_local0 = Engine[@"hash_254084D7CA2317BB"]( f9_arg1 ) --[[ @ 0]]
...
CoD.ZombiesCallingsUtility.AddZombieCallingsNotification = function ( f12_arg0, f12_arg1, f12_arg2 )
	...
	if f12_local2 == CoD.ZombiesCallingsUtility.NotificationType.SPECIAL_EVENT then
		...
		if f12_local5 then
			...
			f12_arg1:appendNotification( {
				...
				title = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_6B8A596A6E17EB28", f12_local7[@"hash_47598EB883D65047"] ),
				description = f12_local6.event[@"hash_255FF29A262A17DC"],
				taskImage = RegisterImage( f12_local7[@"image"] )
			} ) --[[ @ 0]]
		end
	elseif f12_local2 == CoD.ZombiesCallingsUtility.NotificationType.DAILY_TASK then
		local f12_local3 = f12_local1[2] --[[ @ 0]]
		local f12_local4 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"hash_1C53F8D38DF9042B"]( f12_local0.tasklist[f12_local1[2] + 1][@"hash_59603BEF07A9524C"] ) ) --[[ @ 0]]
		f12_arg1:appendNotification( {
			clip = "TextandImageCallings",
			title = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_6B8A596A6E17EB28", f12_local4[@"hash_47598EB883D65047"] ),
	...
	elseif f12_local2 == CoD.ZombiesCallingsUtility.NotificationType.FACTION_TASK then
		...
		f12_arg1:appendNotification( {
			clip = "TextandImageCallings",
			title = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_6B8A596A6E17EB28", f12_local4[@"hash_47598EB883D65047"] ),
			description = @"hash_29371F14531FAD6A",
			taskImage = RegisterImage( f12_local4[@"image"] )
		} ) --[[ @ 0]]
	elseif f12_local2 == CoD.ZombiesCallingsUtility.NotificationType.FACTION_PACT then
		local f12_local3 = f12_local1[2] --[[ @ 0]]
		local f12_local4 = f12_local1[3] --[[ @ 0]]
		local f12_local5 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"hash_1C53F8D38DF9042B"]( f12_local0.factioncallingseasons[f12_local1[3]].factionlist[f12_local3][@"hash_237E6733A4393CBA"] ) ) --[[ @ 0]]
		f12_arg1:appendNotification( {
			clip = "TextandImageCallings",
			title = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_6FF2D60C66A90DF" ),
			description = f12_local5[@"hash_358D0903C2038AC0"],
			taskImage = RegisterImage( f12_local5[@"hash_74F6D1B168CA7CD7"] )
		} ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.ZombiesCallingsUtility.GetCallingTaskInfo = function ( f13_arg0 )
	local f13_local0 = function ()
		...
		for f14_local4, f14_local5 in ipairs( f14_local0.tasklist ) --[[ @ 0]] do
			local f14_local6 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"hash_1C53F8D38DF9042B"]( f14_local5[@"hash_59603BEF07A9524C"] ) ) --[[ @ 0]]
			CoD.ZombiesCallingsUtility.CallingTaskInfo[f14_local6[@"hash_47598EB883D65047"]] = f14_local6 --[[ @ 0]]
		end
	end
	 --[[ @ 0]]
...
CoD.ZombiesCallingsUtility.GetEventInfo = function ( f15_arg0 )
	local f15_local0 = function ( f16_arg0 )
		...
		for f16_local12, f16_local13 in ipairs( f16_local0.eventlist ) --[[ @ 0]] do
			local f16_local14 = Engine[@"hash_1C53F8D38DF9042B"]( f16_local13[@"event"] ) --[[ @ 0]]
			if f16_local14 == f16_arg0 then
				...
				if f16_local4.rewardlist then
					for f16_local9, f16_local10 in ipairs( f16_local4.rewardlist ) --[[ @ 0]] do
						local f16_local11 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"hash_1C53F8D38DF9042B"]( f16_local10[@"reward"] ) ) --[[ @ 0]]
						f16_local5[f16_local11[@"hash_2EFD5A191D95E3F7"]] = f16_local11 --[[ @ 0]]
					end
				end
...
CoD.ZombiesCallingsUtility.GetCurrentDailyCallingInfo = function ()
	return CoD.ZombiesCallingsUtility.GetDailyCallingInfo( Engine[@"hash_622EAAB59AA27E9B"]( @"zm_active_daily_calling" ) )
end
 --[[ @ 0]]
	...
	if f19_arg0 and 0 < f19_arg0 and not CoD.ZombiesCallingsUtility.DailyCallings[f19_arg0] then
		...
		if f19_local1 then
			...
			if f19_local3 then
				...
				local f19_local5 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"hash_1C53F8D38DF9042B"]( f19_local3[@"hash_59603BEF07A9524C"] ) ) --[[ @ 0]]
				f19_local0 = {
					name = f19_local5[@"hash_47598EB883D65047"],
					target = f19_local5[@"hash_2AC86645F588C84F"],
					xp = f19_local4
				} --[[ @ 0]]
			end
		end
		...
		if f20_local5 < f20_local7 and f20_local7 <= f20_local6 then
			...
			if f20_local8 then
				local f20_local9 = {
					...
					levelText = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_E7E238DA43A9CC9", Engine[@"hash_4F9F1239CFD921FE"]( f20_local8[@"hash_47598EB883D65047"] ) ),
					mainIcon = f20_local8[@"image"],
					rewardType = CoD.AARUtility.AARRewardType.DAILY_CALLING,
					totalXP = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D6137AA2004DB90", f20_local4.xp )
				} --[[ @ 0]]
				local f20_local10 = CoD.ZombiesCallingsUtility.DailyCallingCompletionNP --[[ @ 0]]
				f20_local9.reward1Icon = @"ui_icon_nebulium_medium" --[[ @ 0]]
				f20_local9.reward1Desc = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_79DB9C526E6370AB", f20_local10 ) --[[ @ 0]]
	...
	getModel = function ( f25_arg0 )
		...
		if IsBooleanDvarSet( @"hash_27FF853067D7C38C" ) then
			...
			if f25_local12 then
				...
				local f25_local15 = f25_local14[@"hash_7EA461D5E8A182EA"] --[[ @ 0]]
	...
	if f26_local2 and IsBooleanDvarSet( @"hash_27FF853067D7C38C" ) then
		table.insert( f26_local0, {
			models = {
				...
				rewardText = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D6137AA2004DB90", f26_local2.xp )
			}
		} ) --[[ @ 0]]
		table.insert( f26_local0, {
			models = {
				rewardImage = @"ui_icon_nebulium_medium",
				rewardText = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_79DB9C526E6370AB", CoD.ZombiesCallingsUtility.DailyCallingCompletionNP )
			}
		} ) --[[ @ 0]]
	end
	...
	if f29_local1 == nil then
		...
		local f29_local2 = function ( f30_arg0, f30_arg1, f30_arg2, f30_arg3, f30_arg4 )
			...
			table.insert( f30_arg0[f30_arg1].tasks, {
				name = f30_local0[@"hash_47598EB883D65047"],
				target = f30_arg3,
				xp = f30_arg4
			} ) --[[ @ 0]]
		end
		...
		local f29_local3 = function ( f31_arg0, f31_arg1, f31_arg2, f31_arg3 )
			...
			if f31_arg3.array then
				for f31_local3, f31_local4 in ipairs( f31_arg3.array ) --[[ @ 0]] do
					f29_local2( f31_arg0, f31_arg1, Engine[@"hash_1C53F8D38DF9042B"]( f31_local4[@"hash_59603BEF07A9524C"] ), f31_local4[@"target"], f31_local4[@"xp"] ) --[[ @ 0]]
				end
			else
				f29_local2( f31_arg0, f31_arg1, Engine[@"hash_1C53F8D38DF9042B"]( f31_arg3.task ), f31_arg3.target, f31_arg3.xp ) --[[ @ 0]]
			end
		end
		 --[[ @ 0]]
		f29_local3( f29_local0, CoD.ZombiesCallingsUtility.FactionCallingPact[@"hash_7F3FE25D461A019F"], @"zclassic", {
			array = f29_local1.factioncallings[f29_arg2].classicpact
		} ) --[[ @ 0]]
		f29_local3( f29_local0, CoD.ZombiesCallingsUtility.FactionCallingPact[@"hash_134B8FF9BDDB205F"], @"zstandard", {
		...
		f29_local3( f29_local0, CoD.ZombiesCallingsUtility.FactionCallingPact[@"hash_278132D0DAB0252B"], f29_local4[@"hash_5C06BF0019BE575"], {
			array = f29_local4.tcmpact
		} ) --[[ @ 0]]
		f29_local3( f29_local0, CoD.ZombiesCallingsUtility.FactionCallingPact[@"tcmgoal"], f29_local4[@"hash_5C06BF0019BE575"], {
			task = f29_local4[@"tcmgoal"],
			target = f29_local4[@"hash_29B627608B32BD21"],
			xp = f29_local4[@"hash_733F7036B1F73870"]
		} ) --[[ @ 0]]
		return f29_local0
	end
end
	...
	if not f38_local0 then
		...
		if f38_local1 == nil or f38_local1.factioncallingseasons == nil then
			...
			return {
				...
				factionAsset = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"hash_1C53F8D38DF9042B"]( f38_local1.factioncallingseasons[f38_local2].factionlist[f38_local7][@"hash_237E6733A4393CBA"] ) ),
				bundle = f38_local1
			}
		end
	end
	...
	for f41_local7, f41_local8 in pairs( CoD.ZombiesCallingsUtility.FactionCallingPact ) --[[ @ 0]] do
		if not f41_local1.prematchCallingInfo.pacts[f41_local8].complete and f41_local1.currentCallingInfo.pacts[f41_local8].complete then
			...
			local f41_local6 = {
				...
				factionName = f41_local1.factionAsset[@"hash_358D0903C2038AC0"]
			} --[[ @ 0]]
			if CoD.ZombiesCallingsUtility.FactionCallingsPerSeason < f41_local2 then
				f41_local6.message = @"hash_0" --[[ @ 0]]
			else
				f41_local6.message = f41_local1.bundle.factioncallingseasons[f41_local1.season].factionlist[f41_local1.factionIndex].factionlorelist[f41_local2][@"hash_4E47FBAD712250AD"] --[[ @ 0]]
			end
...
CoD.ZombiesCallingsUtility.GetFactionCallingRewardModels = function ( f42_arg0, f42_arg1, f42_arg2 )
	...
	for f42_local8, f42_local9 in pairs( CoD.ZombiesCallingsUtility.FactionCallingPact ) --[[ @ 0]] do
		if not f42_local1.prematchCallingInfo.pacts[f42_local9].complete and f42_local1.currentCallingInfo.pacts[f42_local9].complete then
			...
			f42_local5.mainTitle = @"hash_29371F14531FAD6A" --[[ @ 0]]
			local f42_local7 = "" --[[ @ 0]]
			...
			f42_local5.challengeName = f42_local1.factionAsset[@"hash_358D0903C2038AC0"] --[[ @ 0]]
			f42_local5.challengeDesc = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7E3CA357FB929775" ) --[[ @ 0]]
			f42_local5.challengeImage = f42_local1.factionAsset[@"hash_74F6D1B168CA7CD7"] --[[ @ 0]]
			...
			if not f42_local1.prematchCallingInfo.pacts[f42_local9].tasks[f42_local5].complete and f42_local1.currentCallingInfo.pacts[f42_local9].tasks[f42_local5].complete then
				...
				if f42_local10 then
					table.insert( f42_local0, {
						mainTitle = @"hash_29371F14531FAD6A",
						levelText = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_E7E238DA43A9CC9", Engine[@"hash_4F9F1239CFD921FE"]( f42_local10[@"hash_47598EB883D65047"] ) ),
						mainIcon = f42_local10[@"image"],
						rewardType = CoD.AARUtility.AARRewardType.FACTION_CALLING,
						isFactionPact = false,
						totalXP = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D6137AA2004DB90", f42_local1.prematchCallingInfo.pacts[f42_local9].tasks[f42_local5].xp )
					} ) --[[ @ 0]]
				end
			end
		end
...
CoD.ZombiesCallingsUtility.GetRewardCompletion = function ( f43_arg0, f43_arg1, f43_arg2 )
	...
	for f43_local17, f43_local18 in pairs( CoD.ZombiesCallingsUtility.FactionCirclePositions ) --[[ @ 0]] do
		...
		if f43_local19 then
			local f43_local6 = Engine[@"hash_1C53F8D38DF9042B"]( f43_local19[@"hash_237E6733A4393CBA"] ) --[[ @ 0]]
			for f43_local13, f43_local14 in ipairs( CoD.ZombiesCallingsUtility.FactionCallingRewardCasts ) --[[ @ 0]] do
				for f43_local10, f43_local11 in ipairs( f43_local1 ) --[[ @ 0]] do
					if f43_local0[@"seasons"][f43_arg1 - 1][@"factions"][f43_local6][@"hash_28833743622919CB"][f43_local14][@"hash_68F54E2E72E0EA12"][f43_local11]:get() == 0 then
						return false
					end
				end
			end
...
CoD.ZombiesCallingsUtility.GetFactionCompletion = function ( f44_arg0, f44_arg1, f44_arg2 )
	...
	for f44_local7, f44_local8 in ipairs( CoD.ZombiesCallingsUtility.FactionCallingRewardCasts ) --[[ @ 0]] do
		for f44_local4, f44_local5 in pairs( CoD.ZombiesCallingsUtility.FactionCallingRewards ) --[[ @ 0]] do
			if f44_local0[@"seasons"][f44_arg1 - 1][@"factions"][f44_arg2][@"hash_28833743622919CB"][f44_local8][@"hash_68F54E2E72E0EA12"][f44_local4]:get() == 0 then
				return false
			end
		end
	end
...
CoD.ZombiesCallingsUtility.GetFactionRewardCompletionInfo = function ( f45_arg0, f45_arg1 )
	...
	for f45_local12, f45_local13 in pairs( CoD.ZombiesCallingsUtility.FactionRewardCompletions ) --[[ @ 0]] do
		...
		if f45_local12 == @"hash_575736026043571B" then
			...
			if f45_local4 then
				for f45_local9, f45_local10 in pairs( CoD.ZombiesCallingsUtility.FactionCirclePositions ) --[[ @ 0]] do
					...
					if f45_local11 then
						local f45_local8 = Engine[@"hash_1C53F8D38DF9042B"]( f45_local11[@"hash_237E6733A4393CBA"] ) --[[ @ 0]]
...
CoD.ZombiesCallingsUtility.TryPurchaseReward = function ( f48_arg0, f48_arg1, f48_arg2, f48_arg3 )
	...
	if CoD.SafeGetModelValue( f48_local0, "purchased" ) then
		LuaUtils.ShowMessageDialog( f48_arg1, Enum[@"MessageDialogType"][@"hash_48D00D07404A3DE5"], Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7C0691CE32B2B9FE" ), Engine[@"hash_4F9F1239CFD921FE"]( @"hash_69AE5112F8179F4E" ) ) --[[ @ 0]]
	elseif f48_local2 > 0 then
		...
		LuaUtils.ShowMessageDialog( f48_arg1, Enum[@"MessageDialogType"][@"hash_68BCCDF5038F1B0B"], Engine[@"hash_4F9F1239CFD921FE"]( @"hash_27A5B9FFE84B2B9", CoD.ZombiesCallingsUtility.GetFactionName( f48_local1 ) ), Engine[@"hash_4F9F1239CFD921FE"]( @"hash_21EC34717A510BE7" ) ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.ZombiesCallingsUtility.GetFactionCircleModels = function ( f56_arg0, f56_arg1, f56_arg2 )
	...
	local f56_local3 = Engine[@"hash_1C53F8D38DF9042B"]( f56_local1[@"hash_237E6733A4393CBA"] ) --[[ @ 0]]
	...
	if f56_local4 then
		...
		if f56_local9 then
			f56_local6 = f56_local9[@"hash_499F44FE42EA380B"] or @"hash_0" --[[ @ 0]]
			f56_local7 = f56_local9[@"hash_40991ACE26CFCCE2"] or @"hash_0" --[[ @ 0]]
		end
				...
				if f58_local6 then
					table.insert( f58_local0, {
						models = {
							...
							purchased = f56_local2[@"seasons"][f56_arg1 - 1][@"factions"][f56_local3][@"hash_28833743622919CB"][f57_arg1][@"hash_68F54E2E72E0EA12"][f58_local4]:get() ~= 0,
			...
			for f61_local4, f61_local5 in ipairs( CoD.ZombiesCallingsUtility.FactionCallingRewardCasts ) --[[ @ 0]] do
				...
				if f61_local6 then
					table.insert( f61_local0, {
						models = {
							castName = f61_local6[@"hash_651A7777D06AD06D"] or @"hash_0",
		...
		DataSources[f62_local0] = DataSourceHelpers.ListSetup( f62_local0, function ( f63_arg0, f63_arg1 )
			...
			for f63_local2 = 1 --[[ @ 0]], math.min( f56_local5, #f63_local1 ), 1 do
				table.insert( f63_local0, {
					models = {
						message = f63_local1[f63_local2][@"hash_4E47FBAD712250AD"] or @"hash_0"
					},
					properties = {}
				} ) --[[ @ 0]]
			end
...
CoD.ZombiesCallingsUtility.GetFactionArtifactModels = function ( f64_arg0, f64_arg1, f64_arg2 )
	...
	local f64_local3 = function ( f65_arg0, f65_arg1 )
		...
		if f65_local0 == nil then
			...
			return Engine[@"hash_4F9F1239CFD921FE"]( @"hash_5FD4CBD5EDED0247", Engine[@"hash_4F9F1239CFD921FE"]( f65_local0.factioncallingseasons[f65_arg0][@"hash_56D1F47E5A47AC1B"] ), Engine[@"hash_4F9F1239CFD921FE"]( @"hash_4B8B9F328BC7D3AE", f65_arg1 .. "" ) )
		end
	end
	 --[[ @ 0]]
			...
			for f67_local2 = 1 --[[ @ 0]], f66_local2, 1 do
				...
				table.insert( f67_local0, {
					models = {
						...
						callingIntroMessage = f67_local1.factioncallingseasons[f66_local1].callinglist[f67_local2][@"hash_60EEEC863A9F9263"]
					},
					properties = {
	...
	if f64_local5 then
		f64_local0.seasonIntroMessage = f64_local5.factioncallingseasons[f64_arg1][@"hash_2BE6C029B2AEF8FA"] --[[ @ 0]]
	end
	return f64_local0
end
 --[[ @ 0]]
...
DataSources.ZMFactionCallings = ListHelper_SetupDataSource( "ZMFactionCallings", function ( f76_arg0, f76_arg1 )
		...
		DataSources[f77_arg1] = DataSourceHelpers.ListSetup( f77_arg1, function ( f78_arg0, f78_arg1 )
			...
			for f78_local5, f78_local6 in ipairs( f77_arg0.tasks ) --[[ @ 0]] do
				...
				local f78_local12 = {
					...
					name = f78_local7,
					desc = f78_local8[@"hash_7EA461D5E8A182EA"],
					xp = f78_local6.xp,
	...
	local f76_local9 = function ( f80_arg0, f80_arg1, f80_arg2 )
		...
		for f80_local5, f80_local6 in pairs( Engine[@"GetGametypesBase"]() ) --[[ @ 0]] do
			if Engine[@"hash_1C53F8D38DF9042B"]( f80_local6.gametype ) == f80_arg0.gametype then
	...
	for f76_local11 = 1 --[[ @ 0]], f76_local6, 1 do
		...
		table.insert( f76_local0, {
			models = {
				...
				classicPact = f76_local9( f76_local14.pacts[CoD.ZombiesCallingsUtility.FactionCallingPact[@"hash_7F3FE25D461A019F"]], "classicPactTasks_" .. f76_local4 .. "_" .. f76_local11, f76_local11 ),
				rushPact = f76_local9( f76_local14.pacts[CoD.ZombiesCallingsUtility.FactionCallingPact[@"hash_134B8FF9BDDB205F"]], "rushPactTasks_" .. f76_local4 .. "_" .. f76_local11, f76_local11 ),
				tcmPact = f76_local9( f76_local14.pacts[CoD.ZombiesCallingsUtility.FactionCallingPact[@"hash_278132D0DAB0252B"]], "tcmPactTasks_" .. f76_local4 .. "_" .. f76_local11, f76_local11 ),
			...
			if f89_local1 and f89_local3 then
				...
				table.insert( f89_local2, {
					models = {
						...
						factionName = f89_local6[@"hash_358D0903C2038AC0"],
						isSticker = true,
		...
		return function ( f96_arg0, f96_arg1 )
			...
			local f96_local2 = function ( f97_arg0, f97_arg1 )
				for f97_local9, f97_local10 in pairs( CoD.ZombiesCallingsUtility.FactionRewardCompletions ) --[[ @ 0]] do
					if f97_local9 == @"hash_575736026043571B" then
			...
			local f96_local3 = function ( f98_arg0 )
				for f98_local8, f98_local9 in pairs( CoD.ZombiesCallingsUtility.FactionRewardCompletions ) --[[ @ 0]] do
					if f98_local8 == @"hash_575736026043571B" then
			...
			f96_local1[@"seasons"][f96_local0.seasonId - 1][@"factions"][f96_local0.factionHash][@"hash_28833743622919CB"][f96_local0.castHash][@"hash_68F54E2E72E0EA12"][f96_local0.rewardHash]:set( 1 ) --[[ @ 0]]
...
CoD.OverlayUtility.AddSystemOverlay( "FactionRewardCompletion", {
	...
	description = function ( f99_arg0, f99_arg1 )
		...
		for f99_local10, f99_local11 in pairs( CoD.ZombiesCallingsUtility.FactionRewardCompletions ) --[[ @ 0]] do
			if f99_local10 == @"hash_575736026043571B" then
	...
	[CoD.OverlayUtility.ContinuePropertyName] = function ( f100_arg0, f100_arg1 )
		return function ( f101_arg0, f101_arg1 )
			...
			for f101_local9, f101_local10 in pairs( CoD.ZombiesCallingsUtility.FactionRewardCompletions ) --[[ @ 0]] do
				if f101_local9 == @"hash_575736026043571B" then
	...
	listDatasource = function ( f102_arg0, f102_arg1 )
		DataSources.FactionRewardCompletion = DataSourceHelpers.ListSetup( "FactionRewardCompletion", function ()
			...
			for f103_local13, f103_local14 in pairs( CoD.ZombiesCallingsUtility.FactionRewardCompletions ) --[[ @ 0]] do
				if f103_local13 == @"hash_575736026043571B" then
...
CoD.ZombiesCallingsUtility.GetFactionName = function ( f105_arg0 )
	...
	if not f105_local0 then
		...
		return f105_local0[@"hash_358D0903C2038AC0"] or @"hash_0"
	end
end
 --[[ @ 0]]
...
CoD.ZombiesCallingsUtility.GetFactionTokenImage = function ( f107_arg0 )
	...
	if not f107_local0 then
		...
		return f107_local0[@"hash_74F6D1B168CA7CD7"] or @"blacktransparent"
	end
end
 --[[ @ 0]]
CoD.ZombiesCallingsUtility.GetFactionWelcomeMessage = function ( f108_arg0 )
	...
	if not f108_local0 then
		...
		return f108_local0[@"hash_4774593C24A1383C"] or @"hash_0"
	end
end
 --[[ @ 0]]
CoD.ZombiesCallingsUtility.GetSeasonName = function ( f109_arg0 )
	...
	if f109_local0 == nil then
		...
		if f109_local1 == nil then
			...
			return f109_local1[@"hash_56D1F47E5A47AC1B"] or @"hash_0"
		end
	end
end
 --[[ @ 0]]
CoD.ZombiesCallingsUtility.GetSeasonIntroMessage = function ( f110_arg0 )
	...
	if f110_local0 == nil then
		...
		if f110_local1 == nil then
			...
			return f110_local1[@"hash_2BE6C029B2AEF8FA"] or @"hash_0"
		end
	end
end
 --[[ @ 0]]
		...
		if f111_local1 == nil then
			...
			if f111_local2:get() == nil then
				...
				if f111_local3 == nil then
					...
					return f111_local3[@"hash_60EEEC863A9F9263"] or @"hash_0"
				end
			end
		end
	end
				...
				if f112_local3 == nil then
					...
					if f112_local4:get() == nil then
						...
						if f112_local5 == nil then
							...
							return f112_local5[@"hash_272B8E1B509387A"] or @"hash_0"
						end
					end
				end
			end
	...
	for f113_local3 = 1 --[[ @ 0]], CoD.ZombiesCallingsUtility.MaxFactionCallingSeasons, 1 do
		...
		for f113_local13, f113_local14 in ipairs( CoD.ZombiesCallingsUtility.FactionCallingRewardCasts ) --[[ @ 0]] do
			for f113_local10, f113_local11 in pairs( CoD.ZombiesCallingsUtility.FactionCallingRewards ) --[[ @ 0]] do
				if f113_local6[@"hash_28833743622919CB"][f113_local14][@"hash_68F54E2E72E0EA12"][f113_local10]:get() ~= 0 then
