...
CoD.LauncherMultiReticle_UI3D_Internal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.LauncherMultiReticle_UI3D_Internal.__defaultWidth = 768 --[[ @ 0]]
CoD.LauncherMultiReticle_UI3D_Internal.__defaultHeight = 768 --[[ @ 0]]
CoD.LauncherMultiReticle_UI3D_Internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.LauncherMultiReticle_UI3D_Internal ) --[[ @ 0]]
	self.id = "LauncherMultiReticle_UI3D_Internal" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local reticle = LUI.UIImage.new( 0, 0, 0, 768, 0, 0, 2, 770 ) --[[ @ 0]]
	reticle:setRGB( 0.64, 1, 0.81 ) --[[ @ 0]]
	reticle:setImage( RegisterImage( @"uie_mtl_wpn_t7_launch_multi_glass_red" ) ) --[[ @ 0]]
	...
	local reticlelock = LUI.UIImage.new( 0, 0, 0, 768, 0, 0, 2, 770 ) --[[ @ 0]]
	reticlelock:setRGB( 1, 0, 0 ) --[[ @ 0]]
	reticlelock:setAlpha( 0 ) --[[ @ 0]]
	reticlelock:setImage( RegisterImage( @"uie_mtl_wpn_t7_launch_multi_glass" ) ) --[[ @ 0]]
	self:addElement( reticlelock ) --[[ @ 0]]
	self.reticlelock = reticlelock --[[ @ 0]]
...
CoD.LauncherMultiReticle_UI3D_Internal.__clipsPerState = {
	...
	Locked = {
		DefaultClip = function ( f4_arg0, f4_arg1 )
			...
			f4_arg0.reticlelock:completeAnimation() --[[ @ 0]]
			f4_arg0.reticlelock:setAlpha( 1 ) --[[ @ 0]]
			f4_arg0.clipFinished( f4_arg0.reticlelock ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
