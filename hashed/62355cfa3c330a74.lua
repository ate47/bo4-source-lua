...
LUI.createMenu.QuarterMasterMenu = function ( f1_arg0, f1_arg1 )
	...
	f1_local8( f1_local7, f1_local9["LootStreamProgress.pagedRequestStatus"], function ( f8_arg0, f8_arg1 )
		CoD.Menu.UpdateButtonShownState( f8_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local7 = self --[[ @ 0]]
	f1_local8 = self.subscribeToModel --[[ @ 0]]
	...
	f1_local8( f1_local7, f1_local9["lobbyRoot.lobbyNetworkMode"], function ( f9_arg0, f9_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f9_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local7 = self --[[ @ 0]]
	f1_local8 = self.subscribeToModel --[[ @ 0]]
	f1_local9 = DataSources.AutoEvents.getModel( f1_arg0 ) --[[ @ 0]]
	f1_local8( f1_local7, f1_local9.cycled, function ( f10_arg0, f10_arg1 )
		CoD.Menu.UpdateButtonShownState( f10_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
	...
	self:appendEventHandler( "input_source_changed", function ( f11_arg0, f11_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f11_arg0, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
	...
	f1_local8( f1_local7, f1_local9.LastInput, function ( f12_arg0, f12_arg1 )
		CoD.Menu.UpdateButtonShownState( f12_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], nil, function ( element, menu, controller, model )
		if CoD.BlackMarketUtility.IsPageStreamHoldActionReady( menu, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"] ) and IsDesiredFrameWidget( controller, self.Frame, "SupplyChainFrame" ) and not IsMenuInState( menu, "Processing" ) and IsPerControllerTablePropertyValue( controller, "allowTierPurchase", true ) then
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], nil, function ( element, menu, controller, model )
		if CoD.BlackMarketUtility.IsPageStreamHoldActionReady( menu, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"] ) and IsDesiredFrameWidget( controller, self.Frame, "SupplyChainFrame" ) and not IsMenuInState( menu, "Processing" ) and IsPerControllerTablePropertyValue( controller, "allowTierPurchase", true ) then
			CoD.BlackMarketUtility.PageStreamHoldUpdateAction( menu ) --[[ @ 0]]
			PlaySoundAlias( "uin_trigger_slide" ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
		...
		if IsDesiredFrameWidget( controller, self.Frame, "SupplyChainFrame" ) and not IsMenuInState( menu, "Processing" ) and CoD.BlackMarketUtility.ShowPurchaseTiersPrompt( controller, self.Frame, "PurchaseTiers" ) and AreCodPointsEnabled( controller ) and IsPerControllerTablePropertyValue( controller, "allowTierPurchase", true ) and not IsGameTrial() then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], @"hash_5FAF2C4773992641", nil, nil ) --[[ @ 0]]
			return true
		elseif IsDesiredFrameWidget( controller, self.Frame, "SupplyChainFrame" ) and not IsMenuInState( menu, "Processing" ) and AreCodPointsEnabled( controller ) and IsPerControllerTablePropertyValue( controller, "allowTierPurchase", true ) and not IsGameTrial() then
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"], "ui_contextual_1", function ( element, menu, controller, model )
		if not IsMenuInState( menu, "Processing" ) and CoD.BlackMarketUtility.CanToggleSignatureWeapon( self.Frame ) then
			...
			return true
		elseif IsDesiredFrameWidget( controller, self.Frame, "SupplyChainFrame" ) and CoD.BlackMarketUtility.IsSupplyChainActiveWidgetModelValueEqualTo( self.Frame, controller, "allowTogglePreview", true ) and not CoD.BlackMarketUtility.IsSupplyChainActiveWidgetModelValueEqualTo( self.Frame, controller, "itemCategory", @"hash_5CC13B0F8EEFF726" ) then
