...
CoD.systemOverlay_Compact_BasicFrame_Loading = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.systemOverlay_Compact_BasicFrame_Loading.__defaultWidth = 1920 --[[ @ 0]]
CoD.systemOverlay_Compact_BasicFrame_Loading.__defaultHeight = 286 --[[ @ 0]]
CoD.systemOverlay_Compact_BasicFrame_Loading.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.systemOverlay_Compact_BasicFrame_Loading ) --[[ @ 0]]
	self.id = "systemOverlay_Compact_BasicFrame_Loading" --[[ @ 0]]
	...
	local largeImage = CoD.systemOverlay_connectinganim.new( f1_arg0, f1_arg1, 0, 0, 0, 549, 0, 0, 0, 286 ) --[[ @ 0]]
	largeImage:linkToElementModel( self, nil, false, function ( model )
		largeImage:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
...
CoD.systemOverlay_Compact_BasicFrame_Loading.__resetProperties = function ( f6_arg0 )
	...
	f6_arg0.foregroundPC:setLeftRight( 0, 0, 0, 1920 ) --[[ @ 0]]
	f6_arg0.foregroundPC:setTopBottom( 0, 0, 0, 286 ) --[[ @ 0]]
...
CoD.systemOverlay_Compact_BasicFrame_Loading.__clipsPerState = {
	...
	PC = {
		DefaultClip = function ( f8_arg0, f8_arg1 )
			...
			f8_arg0.foregroundPC:setLeftRight( 0, 0, 0, 1920 ) --[[ @ 0]]
			f8_arg0.foregroundPC:setTopBottom( 0, 0, 0, 294 ) --[[ @ 0]]
