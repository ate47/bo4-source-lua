...
LUI.createMenu.PurchaseTiersConfirmation = function ( f1_arg0, f1_arg1 )
	...
	CratePurchaseTip:linkToElementModel( self, "CrateCost", true, function ( model )
		...
		if f9_local0 ~= nil then
			CratePurchaseTip.ImagePromptInternal.warningTextPrompt:setText( LocalizeIntoString( @"menu/crate_tip", f9_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	if IsPC() then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput( f1_local1, f1_arg0, f1_local21, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
	end
	return self
end
 --[[ @ 0]]
