...
CoD.DirectorReadyButton.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	DirectorSelectButtonMiniInternal.MiddleText:setText( LocalizeToUpperString( @"hash_17A9F166E7248D86" ) ) --[[ @ 0]]
	DirectorSelectButtonMiniInternal.MiddleTextFocus:setText( LocalizeToUpperString( @"hash_17A9F166E7248D86" ) ) --[[ @ 0]]
	...
	PlayText:setText( LocalizeToUpperString( @"hash_17A9F166E7248D86" ) ) --[[ @ 0]]
	...
	WaitingText:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	self:appendEventHandler( "input_source_changed", function ( f21_arg0, f21_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f21_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f21_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local14 = self --[[ @ 0]]
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local15( f1_local14, f1_local16.LastInput, function ( f22_arg0, f22_arg1 )
		CoD.Menu.UpdateButtonShownState( f22_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f22_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local14 = self --[[ @ 0]]
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetGlobalModel"]() --[[ @ 0]]
	f1_local15( f1_local14, f1_local16["lobbyRoot.lobbyNav"], function ( f23_arg0, f23_arg1 )
		CoD.Menu.UpdateButtonShownState( f23_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f23_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local14 = self --[[ @ 0]]
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetGlobalModel"]() --[[ @ 0]]
	f1_local15( f1_local14, f1_local16["lobbyRoot.publicLobby.stage"], function ( f24_arg0, f24_arg1 )
		CoD.Menu.UpdateButtonShownState( f24_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
	...
	f1_local15( f1_local14, f1_local16["lobbyRoot.playlistId"], function ( f25_arg0, f25_arg1 )
		CoD.Menu.UpdateButtonShownState( f25_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
	...
	f1_local15( f1_local14, f1_local16["lobbyRoot.lobbyList.playerCount"], function ( f26_arg0, f26_arg1 )
		CoD.Menu.UpdateButtonShownState( f26_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f26_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_arg0:AddButtonCallbackFunction( self, f1_arg1, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"], "ESCAPE", function ( element, menu, controller, model )
		...
		if IsGamepad( controller ) and CoD.DirectorUtility.CanReadyDown( controller ) and not CoD.DirectorUtility.IsNumClientsExceeded( controller ) and CoD.DirectorUtility.AllClientsOwnDLCForPlaylist( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"], @"hash_26DA4540B4705513", nil, "ESCAPE" ) --[[ @ 0]]
			return true
		elseif IsGamepad( controller ) and CoD.DirectorUtility.CanReadyDown( controller ) and CoD.DirectorUtility.IsNumClientsExceeded( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"], @"hash_26DA4540B4705513", nil, "ESCAPE" ) --[[ @ 0]]
			return true
	...
	self:linkToElementModel( self, nil, true, function ( model )
		...
		if CoD.ModelUtility.IsParamModelEqualTo( model, Enum[@"LUIButtonFlags"][@"hash_4715085B24AAB606"] | Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) and IsElementInFocus( self.DirectorCustomStartButton ) and CoD.DirectorUtility.CanReadyUp( f1_arg1 ) and not CoD.DirectorUtility.IsNumClientsExceeded( f1_arg1 ) and CoD.DirectorUtility.AllClientsOwnDLCForPlaylist( f1_arg1 ) then
			CoD.BaseUtility.StopPlayOnceSound( f35_local0, "uin_ready_bar_fill_1shot" ) --[[ @ 0]]
			PlaySoundAlias( "uin_ready_bar_done" ) --[[ @ 0]]
			SetState( self, "Ready", f1_arg1 ) --[[ @ 0]]
			CoD.DirectorUtility.SetLocalClientsReady() --[[ @ 0]]
		elseif CoD.ModelUtility.IsParamModelEqualTo( model, Enum[@"LUIButtonFlags"][@"hash_4715085B24AAB606"] | Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) and IsElementInFocus( self.DirectorCustomStartButton ) and CoD.DirectorUtility.CanReadyUp( f1_arg1 ) and CoD.DirectorUtility.IsNumClientsExceeded( f1_arg1 ) then
			CoD.BaseUtility.StopPlayOnceSound( f35_local0, "uin_ready_bar_fill_1shot" ) --[[ @ 0]]
			PlaySoundAlias( "uin_ready_bar_done" ) --[[ @ 0]]
			CoD.DirectorUtility.OpenTooManyClientsPopup( self, f1_arg1 ) --[[ @ 0]]
		elseif CoD.ModelUtility.IsParamModelEqualTo( model, Enum[@"LUIButtonFlags"][@"hash_4715085B24AAB606"] | Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) and IsElementInFocus( self.DirectorCustomStartButton ) and CoD.DirectorUtility.CanReadyUp( f1_arg1 ) and not CoD.DirectorUtility.AllClientsOwnDLCForPlaylist( f1_arg1 ) then
			CoD.BaseUtility.StopPlayOnceSound( f35_local0, "uin_ready_bar_fill_1shot" ) --[[ @ 0]]
			PlaySoundAlias( "uin_ready_bar_done" ) --[[ @ 0]]
...
CoD.DirectorReadyButton.__resetProperties = function ( f36_arg0 )
	...
	f36_arg0.PlayText:setText( LocalizeToUpperString( @"hash_17A9F166E7248D86" ) ) --[[ @ 0]]
	...
	f36_arg0.DirectorSelectButtonMiniInternal.MiddleText:setText( LocalizeToUpperString( @"hash_17A9F166E7248D86" ) ) --[[ @ 0]]
	f36_arg0.DirectorSelectButtonMiniInternal.MiddleTextFocus:setText( LocalizeToUpperString( @"hash_17A9F166E7248D86" ) ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.DirectorReadyButton.__clipsPerState = {
	...
	Ready = {
		DefaultClip = function ( f76_arg0, f76_arg1 )
			...
			f76_arg0.DirectorSelectButtonMiniInternal.MiddleText:setText( LocalizeToUpperString( @"hash_5E6F6113B8B75F3E" ) ) --[[ @ 0]]
			f76_arg0.DirectorSelectButtonMiniInternal.MiddleTextFocus:setText( LocalizeToUpperString( @"hash_5E6F6113B8B75F3E" ) ) --[[ @ 0]]
			f76_arg0.clipFinished( f76_arg0.DirectorSelectButtonMiniInternal ) --[[ @ 0]]
			f76_arg0.PlayText:completeAnimation() --[[ @ 0]]
			f76_arg0.PlayText:setText( LocalizeToUpperString( @"hash_5E6F6113B8B75F3E" ) ) --[[ @ 0]]
		...
		ChildFocus = function ( f77_arg0, f77_arg1 )
			...
			f77_arg0.PlayText:setText( LocalizeToUpperString( @"hash_5E6F6113B8B75F3E" ) ) --[[ @ 0]]
		...
		GainChildFocus = function ( f78_arg0, f78_arg1 )
			...
			f78_arg0.PlayText:setText( LocalizeToUpperString( @"hash_5E6F6113B8B75F3E" ) ) --[[ @ 0]]
		...
		LoseChildFocus = function ( f81_arg0, f81_arg1 )
			...
			f81_arg0.PlayText:setText( LocalizeToUpperString( @"hash_5E6F6113B8B75F3E" ) ) --[[ @ 0]]
