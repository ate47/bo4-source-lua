...
CoD.callingcards_loot2_circusclown_fire03 = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.callingcards_loot2_circusclown_fire03.__defaultWidth = 120 --[[ @ 0]]
CoD.callingcards_loot2_circusclown_fire03.__defaultHeight = 264 --[[ @ 0]]
CoD.callingcards_loot2_circusclown_fire03.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.callingcards_loot2_circusclown_fire03 ) --[[ @ 0]]
	self.id = "callingcards_loot2_circusclown_fire03" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local fire03 = LUI.UIImage.new( 0, 0, 0, 120, 0, 0, 24, 288 ) --[[ @ 0]]
	fire03:setImage( RegisterImage( @"uie_ui_menu_callingcards_circusclown_fire01" ) ) --[[ @ 0]]
	fire03:setMaterial( LUI.UIImage.GetCachedMaterial( @"ui_add" ) ) --[[ @ 0]]
...
CoD.callingcards_loot2_circusclown_fire03.__resetProperties = function ( f2_arg0 )
	...
	f2_arg0.fire03:setLeftRight( 0, 0, 0, 120 ) --[[ @ 0]]
	f2_arg0.fire03:setTopBottom( 0, 0, 24, 288 ) --[[ @ 0]]
	f2_arg0.fire03:setScale( 1, 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
											...
											local f11_local0 = function ( f12_arg0 )
												local f12_local0 = function ( f13_arg0 )
													local f13_local0 = function ( f14_arg0 )
																		...
																		local f18_local0 = function ( f19_arg0 )
																			local f19_local0 = function ( f20_arg0 )
																				local f20_local0 = function ( f21_arg0 )
																					...
																					f21_arg0:setTopBottom( 0, 0, 24, 288 ) --[[ @ 0]]
														...
														f14_arg0:setTopBottom( 0, 0, 30.5, 294.5 ) --[[ @ 0]]
													...
													f13_arg0:setTopBottom( 0, 0, 26, 290 ) --[[ @ 0]]
												...
												f12_arg0:setTopBottom( 0, 0, 35.5, 299.5 ) --[[ @ 0]]
												f12_arg0:setScale( 1, 0.9 ) --[[ @ 0]]
												f12_arg0:registerEventHandler( "transition_complete_keyframe", f12_local0 ) --[[ @ 0]]
											end
											 --[[ @ 0]]
											f11_arg0:beginAnimation( 70 ) --[[ @ 0]]
											f11_arg0:setTopBottom( 0, 0, 25.5, 289.5 ) --[[ @ 0]]
											f11_arg0:setScale( 1, 1 ) --[[ @ 0]]
											f11_arg0:registerEventHandler( "transition_complete_keyframe", f11_local0 ) --[[ @ 0]]
										end
										 --[[ @ 0]]
										f10_arg0:beginAnimation( 230 ) --[[ @ 0]]
										f10_arg0:setTopBottom( 0, 0, 36, 300 ) --[[ @ 0]]
										f10_arg0:setScale( 1, 0.9 ) --[[ @ 0]]
										f10_arg0:registerEventHandler( "transition_complete_keyframe", f10_local0 ) --[[ @ 0]]
									end
									 --[[ @ 0]]
									f9_arg0:beginAnimation( 69 ) --[[ @ 0]]
									f9_arg0:setTopBottom( 0, 0, 26, 290 ) --[[ @ 0]]
									f9_arg0:setScale( 1, 1 ) --[[ @ 0]]
									f9_arg0:registerEventHandler( "transition_complete_keyframe", f9_local0 ) --[[ @ 0]]
								end
								 --[[ @ 0]]
								f8_arg0:beginAnimation( 130 ) --[[ @ 0]]
								f8_arg0:setTopBottom( 0, 0, 31, 295 ) --[[ @ 0]]
								f8_arg0:setScale( 1, 0.95 ) --[[ @ 0]]
								f8_arg0:registerEventHandler( "transition_complete_keyframe", f8_local0 ) --[[ @ 0]]
							end
							 --[[ @ 0]]
							f7_arg0:beginAnimation( 69 ) --[[ @ 0]]
							f7_arg0:setTopBottom( 0, 0, 26, 290 ) --[[ @ 0]]
							f7_arg0:setScale( 1, 1 ) --[[ @ 0]]
							f7_arg0:registerEventHandler( "transition_complete_keyframe", f7_local0 ) --[[ @ 0]]
						end
						 --[[ @ 0]]
						f6_arg0:beginAnimation( 199 ) --[[ @ 0]]
						f6_arg0:setTopBottom( 0, 0, 31, 295 ) --[[ @ 0]]
						f6_arg0:setScale( 1, 0.95 ) --[[ @ 0]]
						f6_arg0:registerEventHandler( "transition_complete_keyframe", f6_local0 ) --[[ @ 0]]
					end
					 --[[ @ 0]]
					f5_arg0:beginAnimation( 100 ) --[[ @ 0]]
					f5_arg0:setTopBottom( 0, 0, 14.5, 278.5 ) --[[ @ 0]]
					f5_arg0:setScale( 1, 1.1 ) --[[ @ 0]]
					f5_arg0:registerEventHandler( "transition_complete_keyframe", f5_local0 ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f3_arg0.fire03:beginAnimation( 200 ) --[[ @ 0]]
				f3_arg0.fire03:setTopBottom( 0, 0, 36, 300 ) --[[ @ 0]]
				f3_arg0.fire03:setScale( 1, 0.9 ) --[[ @ 0]]
				f3_arg0.fire03:registerEventHandler( "interrupted_keyframe", f3_arg0.clipInterrupted ) --[[ @ 0]]
				f3_arg0.fire03:registerEventHandler( "transition_complete_keyframe", f4_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f3_arg0.fire03:completeAnimation() --[[ @ 0]]
			f3_arg0.fire03:setLeftRight( 0, 0, 0, 120 ) --[[ @ 0]]
			f3_arg0.fire03:setTopBottom( 0, 0, 24, 288 ) --[[ @ 0]]
			f3_arg0.fire03:setScale( 1, 1 ) --[[ @ 0]]
			f3_local0( f3_arg0.fire03 ) --[[ @ 0]]
