...
CoD.LaboratoryElixirLabel.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	name:linkToElementModel( self, "id", true, function ( model )
		...
		if f3_local0 ~= nil then
			name:setText( Engine[@"hash_4F9F1239CFD921FE"]( GetItemNameFromRef( Enum[@"emodes"][@"mode_zombies"], f3_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	quantity:setAlignment( Enum[@"luialignment"][@"lui_alignment_middle"] ) --[[ @ 0]]
	quantity:linkToElementModel( self, "quantity", true, function ( model )
		local f4_local0 = model:get() --[[ @ 0]]
		if f4_local0 ~= nil then
			quantity:setText( LocalizeIntoStringIfNotEmpty( @"menu/multiplier_x", f4_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
