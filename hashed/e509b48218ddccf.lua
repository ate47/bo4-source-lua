...
CoD.Support_Button.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	ArrowUp( ArrowDown, Rule["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f10_arg0 )
	...
	ArrowUp( ArrowDown, Rule["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f11_arg0 )
		f1_arg0:updateElementState( ControllerDependentTextBox, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	Usable = {
		...
		Focus = function ( f32_arg0, f32_arg1 )
			...
			local f32_local0 = function ( f33_arg0 )
				f32_arg0.Background:beginAnimation( 230, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
			...
			local f32_local1 = function ( f34_arg0 )
				f32_arg0.buttonInternal:beginAnimation( 230, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
