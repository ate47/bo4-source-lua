...
CoD.CharacterSelection_CustomCharacterFrameWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( CustomCharacter, f1_arg1, Enum[@"luibutton"][@"lui_key_xby_pstriangle"], "ui_contextual_2", function ( element, menu, controller, model )
		...
		if IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xby_pstriangle"], @"hash_72AA2EA68ACC2317", nil, "ui_contextual_2" ) --[[ @ 0]]
			return true
		elseif not IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xby_pstriangle"], @"hash_72AA2EA68ACC2317", Enum[@"luibuttonpromptflags"][@"bpf_contextual"], "ui_contextual_2" ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	Characters:appendEventHandler( "input_source_changed", function ( f18_arg0, f18_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f18_arg0, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	IconsLine( IconsText, DefaultLine.LastInput, function ( f19_arg0, f19_arg1 )
		CoD.Menu.UpdateButtonShownState( f19_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	IconsText:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	IconsText:setAlignment( Enum[@"luialignment"][@"lui_alignment_bottom"] ) --[[ @ 0]]
	...
	DefaultText:setText( LocalizeToUpperString( @"menu/default" ) ) --[[ @ 0]]
	DefaultText:setTTF( "default" ) --[[ @ 0]]
	DefaultText:setLetterSpacing( 3 ) --[[ @ 0]]
	DefaultText:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	DefaultText:setAlignment( Enum[@"luialignment"][@"lui_alignment_bottom"] ) --[[ @ 0]]
