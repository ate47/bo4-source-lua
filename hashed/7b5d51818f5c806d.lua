...
CoD.AARTierRewardShowcaseInternalCoreEpic = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCoreEpic.__defaultWidth = 310 --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCoreEpic.__defaultHeight = 632 --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCoreEpic.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARTierRewardShowcaseInternalCoreEpic ) --[[ @ 0]]
	self.id = "AARTierRewardShowcaseInternalCoreEpic" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local CardEpicMain = LUI.UIImage.new( 0.5, 0.5, -176, 176, 0.5, 0.5, -336, 336 ) --[[ @ 0]]
	CardEpicMain:setImage( RegisterImage( @"uie_ui_menu_mtx_card_epic_main" ) ) --[[ @ 0]]
	self:addElement( CardEpicMain ) --[[ @ 0]]
	self.CardEpicMain = CardEpicMain --[[ @ 0]]
	...
	CornerGlowTL:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f5_local0 ~= nil then
			CornerGlowTL:setRGB( CoD.BlackMarketUtility.LootRarityToColor( f5_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	CornerGlowTL2:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f6_local0 ~= nil then
			CornerGlowTL2:setRGB( CoD.BlackMarketUtility.LootRarityToColorBright( f6_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	CornerGlowBR:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f7_local0 ~= nil then
			CornerGlowBR:setRGB( CoD.BlackMarketUtility.LootRarityToColorBright( f7_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	CornerGlowBR2:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f8_local0 ~= nil then
			CornerGlowBR2:setRGB( CoD.BlackMarketUtility.LootRarityToColorBright( f8_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	GlowRimBorder:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f9_local0 ~= nil then
			GlowRimBorder:setRGB( CoD.BlackMarketUtility.LootRarityToColor( f9_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	BGPatternThick:setImage( RegisterImage( @"uie_ui_menu_common_mtx_button_bg_epic_thick" ) ) --[[ @ 0]]
	...
	BGPatternThick:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f10_local0 ~= nil then
			BGPatternThick:setRGB( CoD.BlackMarketUtility.LootRarityToColor( f10_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
...
CoD.AARTierRewardShowcaseInternalCoreEpic.__resetProperties = function ( f11_arg0 )
	...
	f11_arg0.GlowRimBorder:completeAnimation() --[[ @ 0]]
	...
	f11_arg0.BGPatternThick:setAlpha( 1 ) --[[ @ 0]]
	...
	f11_arg0.GlowRimBorder:setAlpha( 0.5 ) --[[ @ 0]]
end
 --[[ @ 0]]
		...
		DefaultClip = function ( f12_arg0, f12_arg1 )
			...
			local f12_local0 = function ( f13_arg0 )
				local f13_local0 = function ( f14_arg0 )
					...
					f14_arg0:setShaderVector( 2, 0.05, 1.09, 0, 0 ) --[[ @ 0]]
				...
				f12_arg0.GlowRimThinAdd:registerEventHandler( "transition_complete_keyframe", f13_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			f12_local0( f12_arg0.GlowRimThinAdd ) --[[ @ 0]]
			local f12_local1 = function ( f17_arg0 )
				local f17_local0 = function ( f18_arg0 )
					local f18_local0 = function ( f19_arg0 )
						local f19_local0 = function ( f20_arg0 )
							f20_arg0:beginAnimation( 2000 ) --[[ @ 0]]
							f20_arg0:setAlpha( 0 ) --[[ @ 0]]
							f20_arg0:setShaderVector( 2, -0.14, 0.65, 0, 0 ) --[[ @ 0]]
							f20_arg0:setShaderVector( 3, 0.4, 1.41, 0, 0 ) --[[ @ 0]]
							f20_arg0:registerEventHandler( "transition_complete_keyframe", f12_arg0.clipFinished ) --[[ @ 0]]
						end
						 --[[ @ 0]]
						f19_arg0:beginAnimation( 500 ) --[[ @ 0]]
						f19_arg0:setShaderVector( 2, -0.07, 0.66, 0, 0 ) --[[ @ 0]]
					...
					f18_arg0:setShaderVector( 2, 0.01, 0.92, 0, 0 ) --[[ @ 0]]
				...
				f12_arg0.GlowRimThick:registerEventHandler( "transition_complete_keyframe", f17_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			local f12_local2 = function ( f21_arg0 )
				local f21_local0 = function ( f22_arg0 )
					...
					f22_arg0:setShaderVector( 2, 0.02, 1.03, 0, 0 ) --[[ @ 0]]
				...
				f12_arg0.GlowRimThick2:registerEventHandler( "transition_complete_keyframe", f21_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			f12_local2( f12_arg0.GlowRimThick2 ) --[[ @ 0]]
			local f12_local3 = function ( f25_arg0 )
				local f25_local0 = function ( f26_arg0 )
				 ...
				 --[[ @ 0]]
				f12_arg0.CornerGlowTL:beginAnimation( 400 ) --[[ @ 0]]
				...
				f12_arg0.CornerGlowTL:registerEventHandler( "transition_complete_keyframe", f25_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			f12_local3( f12_arg0.CornerGlowTL ) --[[ @ 0]]
			local f12_local4 = function ( f28_arg0 )
				local f28_local0 = function ( f29_arg0 )
				 ...
				 --[[ @ 0]]
				f12_arg0.CornerGlowTL2:beginAnimation( 400 ) --[[ @ 0]]
				...
				f12_arg0.CornerGlowTL2:registerEventHandler( "transition_complete_keyframe", f28_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			f12_local4( f12_arg0.CornerGlowTL2 ) --[[ @ 0]]
			local f12_local5 = function ( f31_arg0 )
				local f31_local0 = function ( f32_arg0 )
				 ...
				 --[[ @ 0]]
				f12_arg0.CornerGlowBR:beginAnimation( 400 ) --[[ @ 0]]
				...
				f12_arg0.CornerGlowBR:registerEventHandler( "transition_complete_keyframe", f31_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			f12_local5( f12_arg0.CornerGlowBR ) --[[ @ 0]]
			local f12_local6 = function ( f34_arg0 )
				local f34_local0 = function ( f35_arg0 )
				 ...
				 --[[ @ 0]]
				f12_arg0.CornerGlowBR2:beginAnimation( 400 ) --[[ @ 0]]
				...
				f12_arg0.CornerGlowBR2:registerEventHandler( "transition_complete_keyframe", f34_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			f12_local6( f12_arg0.CornerGlowBR2 ) --[[ @ 0]]
			local f12_local7 = function ( f37_arg0 )
				local f37_local0 = function ( f38_arg0 )
					local f38_local0 = function ( f39_arg0 )
						local f39_local0 = function ( f40_arg0 )
							f40_arg0:beginAnimation( 3010, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
							f40_arg0:setAlpha( 0.5 ) --[[ @ 0]]
							f40_arg0:registerEventHandler( "transition_complete_keyframe", f12_arg0.clipFinished ) --[[ @ 0]]
						end
						 --[[ @ 0]]
						f39_arg0:beginAnimation( 3489 ) --[[ @ 0]]
						f39_arg0:setAlpha( 1 ) --[[ @ 0]]
						f39_arg0:registerEventHandler( "transition_complete_keyframe", f39_local0 ) --[[ @ 0]]
					end
					 --[[ @ 0]]
					f38_arg0:beginAnimation( 3500, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
					f38_arg0:setAlpha( 0.5 ) --[[ @ 0]]
					f38_arg0:registerEventHandler( "transition_complete_keyframe", f38_local0 ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f12_arg0.GlowRimBorder:beginAnimation( 3000 ) --[[ @ 0]]
				f12_arg0.GlowRimBorder:setAlpha( 1 ) --[[ @ 0]]
				f12_arg0.GlowRimBorder:registerEventHandler( "interrupted_keyframe", f12_arg0.clipInterrupted ) --[[ @ 0]]
				f12_arg0.GlowRimBorder:registerEventHandler( "transition_complete_keyframe", f37_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f12_arg0.GlowRimBorder:completeAnimation() --[[ @ 0]]
			f12_arg0.GlowRimBorder:setAlpha( 0.5 ) --[[ @ 0]]
			f12_local7( f12_arg0.GlowRimBorder ) --[[ @ 0]]
			local f12_local8 = function ( f41_arg0 )
				local f41_local0 = function ( f42_arg0 )
					local f42_local0 = function ( f43_arg0 )
						local f43_local0 = function ( f44_arg0 )
							f44_arg0:beginAnimation( 9000 ) --[[ @ 0]]
							f44_arg0:registerEventHandler( "transition_complete_keyframe", f12_arg0.clipFinished ) --[[ @ 0]]
						end
						 --[[ @ 0]]
						f43_arg0:beginAnimation( 2000 ) --[[ @ 0]]
						f43_arg0:setAlpha( 0 ) --[[ @ 0]]
						f43_arg0:setShaderVector( 2, 1, 1, 0, 0 ) --[[ @ 0]]
						f43_arg0:setShaderVector( 3, 0, 0, 0, 0 ) --[[ @ 0]]
					...
					f42_arg0:setShaderVector( 2, 0, 1, 0, 0 ) --[[ @ 0]]
					f42_arg0:setShaderVector( 3, 0.5, 0, 0, 0 ) --[[ @ 0]]
					f42_arg0:registerEventHandler( "transition_complete_keyframe", f42_local0 ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f12_arg0.BGPatternThick:beginAnimation( 1000 ) --[[ @ 0]]
				f12_arg0.BGPatternThick:setAlpha( 0.75 ) --[[ @ 0]]
				f12_arg0.BGPatternThick:setShaderVector( 2, 0, 0.5, 0, 0 ) --[[ @ 0]]
				f12_arg0.BGPatternThick:setShaderVector( 3, 0.25, 0.25, 0, 0 ) --[[ @ 0]]
				f12_arg0.BGPatternThick:registerEventHandler( "interrupted_keyframe", f12_arg0.clipInterrupted ) --[[ @ 0]]
				f12_arg0.BGPatternThick:registerEventHandler( "transition_complete_keyframe", f41_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f12_arg0.BGPatternThick:completeAnimation() --[[ @ 0]]
			f12_arg0.BGPatternThick:setAlpha( 1 ) --[[ @ 0]]
			...
			f12_local8( f12_arg0.BGPatternThick ) --[[ @ 0]]
			f12_arg0.nextClip = "DefaultClip" --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCoreEpic.__onClose = function ( f45_arg0 )
	f45_arg0.GlowRimThinAdd:close() --[[ @ 0]]
	f45_arg0.GlowRimThick:close() --[[ @ 0]]
	f45_arg0.GlowRimThick2:close() --[[ @ 0]]
	f45_arg0.CornerGlowTL:close() --[[ @ 0]]
	f45_arg0.CornerGlowTL2:close() --[[ @ 0]]
	f45_arg0.CornerGlowBR:close() --[[ @ 0]]
	f45_arg0.CornerGlowBR2:close() --[[ @ 0]]
	f45_arg0.GlowRimBorder:close() --[[ @ 0]]
	f45_arg0.BGPatternThick:close() --[[ @ 0]]
end
 --[[ @ 0]]
