...
CoD.DirectorCustomizeClassZM.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	primarygrenade.LoadoutClassItemContainerZombie.loadoutName:setText( LocalizeToUpperString( @"zmui/equipment" ) ) --[[ @ 0]]
	...
	PerkAltars( ZMTalismanEquipLine, LabelWeapons["lobbyRoot.lobbyNav"], function ( f18_arg0, f18_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f18_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_pckey_2"] ) --[[ @ 0]]
	...
	ZMTallismanStatusButton:linkToElementModel( ZMTallismanStatusButton, "itemIndex", true, function ( model, f19_arg1 )
		CoD.Menu.UpdateButtonShownState( f19_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_pckey_2"] ) --[[ @ 0]]
	...
	ZMTallismanStatusButton:appendEventHandler( "input_source_changed", function ( f20_arg0, f20_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f20_arg0, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_pckey_2"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f20_arg0, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	ZMTalismanEquipLine = ZMTallismanStatusButton --[[ @ 0]]
	PerkAltars = ZMTallismanStatusButton.subscribeToModel --[[ @ 0]]
	...
	PerkAltars( ZMTalismanEquipLine, LabelWeapons.LastInput, function ( f21_arg0, f21_arg1 )
		CoD.Menu.UpdateButtonShownState( f21_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_pckey_2"] ) --[[ @ 0]]
	...
	PerkAltars:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	LabelWeapons:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"zmui/weapons" ) ) --[[ @ 0]]
	...
	LabelWeapons:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	LabelWeapons:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	LabelPerks:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"zmui/perks" ) ) --[[ @ 0]]
	...
	LabelPerks:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	LabelPerks:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	LabelElixirs:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"zmui/elixirs" ) ) --[[ @ 0]]
	...
	LabelElixirs:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	LabelElixirs:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	LabelTalisman:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"zmui/talisman" ) ) --[[ @ 0]]
	...
	LabelTalisman:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	LabelTalisman:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
