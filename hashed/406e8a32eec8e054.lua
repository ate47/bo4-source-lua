...
LUI.createMenu.BribeMenu = function ( f1_arg0, f1_arg1 )
	...
	GenericMenuFrameIdentity.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"menu/bribes" ) ) --[[ @ 0]]
	...
	BribeList:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
