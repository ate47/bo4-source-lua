...
CoD.WZAAR_Challenge.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	ProgressCount:setAlignment( Enum[@"luialignment"][@"lui_alignment_right"] ) --[[ @ 0]]
	...
	Completed:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/completed" ) ) --[[ @ 0]]
	Completed:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	Completed:setLetterSpacing( 2 ) --[[ @ 0]]
	Completed:setAlignment( Enum[@"luialignment"][@"lui_alignment_right"] ) --[[ @ 0]]
	...
	XpEarned:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
