...
CoD.GameSettings_ZMGeneral = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.GameSettings_ZMGeneral.__defaultWidth = 1920 --[[ @ 0]]
CoD.GameSettings_ZMGeneral.__defaultHeight = 877 --[[ @ 0]]
CoD.GameSettings_ZMGeneral.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.GameSettings_ZMGeneral ) --[[ @ 0]]
	self.id = "GameSettings_ZMGeneral" --[[ @ 0]]
	...
	OptionCategoryGrid:setDataSource( "ZMGeneralOptionCategories" ) --[[ @ 0]]
