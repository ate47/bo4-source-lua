...
CoD.HUD_ZM_Trial_Round_Failed.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	Reason:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	RoundReached:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	RoundReached:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	Failed:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	Failed:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
			...
			condition = function ( menu, element, event )
				...
				if not f5_local0 then
					...
					if not f5_local0 then
						...
						if not f5_local0 then
							f5_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_11CDCB451655ABCF"] ) --[[ @ 0]]
							if not f5_local0 then
														...
														if not f5_local0 then
															...
															if not f5_local0 then
																...
																if not f5_local0 then
																	...
																	if not f5_local0 then
																		f5_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_54828BED794DA0A5"] ) --[[ @ 0]]
																		if not f5_local0 then
	...
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4B8E9B69F4B87954"]], function ( f7_arg0 )
	...
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5D3ABF9A2753CE40"]], function ( f8_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_59333FC97F7870"]], function ( f9_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_11CDCB451655ABCF"]], function ( f10_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_669C28E2FCA82769"]], function ( f11_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_7ADC477DDE486DD7"]], function ( f12_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_523CD9BAB9B9F4C8"]], function ( f13_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f14_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_47B52A87BC9AA4C7"]], function ( f15_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_6668F0686232679"]], function ( f17_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_33AEEAA452536E6E"]], function ( f18_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_1D298E43D0B6FEF2"]], function ( f19_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f20_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_54828BED794DA0A5"]], function ( f21_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HudZMTrialShame1 = Strikes.subscribeToModel --[[ @ 0]]
	HudZMTrialShame3 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HudZMTrialShame1( HudZMTrialShame2, HudZMTrialShame3["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_2A69E34E231CE8B6"]], function ( f22_arg0 )
		f1_arg0:updateElementState( Strikes, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
...
CoD.HUD_ZM_Trial_Round_Failed.__clipsPerState = {
	...
	VisibleNoShame_GameOver = {
		DefaultClip = function ( f56_arg0, f56_arg1 )
			...
			f56_arg0.Failed:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_722EF41D702EE72D" ) ) --[[ @ 0]]
	...
	Visible_4_Shame_GameOver = {
		DefaultClip = function ( f57_arg0, f57_arg1 )
			...
			f57_arg0.Failed:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_722EF41D702EE72D" ) ) --[[ @ 0]]
	...
	Visible_3_Shame_GameOver = {
		DefaultClip = function ( f58_arg0, f58_arg1 )
			...
			f58_arg0.Failed:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_722EF41D702EE72D" ) ) --[[ @ 0]]
	...
	Visible_2_Shame_GameOver = {
		DefaultClip = function ( f59_arg0, f59_arg1 )
			...
			f59_arg0.Failed:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_722EF41D702EE72D" ) ) --[[ @ 0]]
	...
	Visible_1_Shame_GameOver = {
		DefaultClip = function ( f60_arg0, f60_arg1 )
			...
			f60_arg0.Failed:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_722EF41D702EE72D" ) ) --[[ @ 0]]
