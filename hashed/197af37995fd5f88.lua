...
CoD.ZMStartWeaponSelect = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.ZMStartWeaponSelect = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "ZMStartWeaponSelect", f1_arg0 ) --[[ @ 0]]
	...
	self:setClass( CoD.ZMStartWeaponSelect ) --[[ @ 0]]
	...
	XCamMouseControl = CoD.XCamMouseControl.new( f1_local1, f1_arg0, 0, 1, 0, 0, 0.5, 0.5, -392, 108 ) --[[ @ 0]]
	...
	local RestrictedText = CoD.RestrictedItemWarningText.new( f1_local1, f1_arg0, 0.5, 0.5, -247, 247, 0.5, 0.5, 54, 84 ) --[[ @ 0]]
	...
	local WeaponListWidget = CoD.Armory_WeaponListWidget.new( f1_local1, f1_arg0, 0.5, 0.5, -960, 960, 0.5, 0.5, 133, 623 ) --[[ @ 0]]
	WeaponListWidget.weaponCategoryList.Tabs.grid:setDataSource( "ZMStartingWeaponGroups" ) --[[ @ 0]]
	self:addElement( WeaponListWidget ) --[[ @ 0]]
	self.WeaponListWidget = WeaponListWidget --[[ @ 0]]
	
	local ItemInfo = CoD.ItemNameDescUnlockText.new( f1_local1, f1_arg0, 0.5, 0.5, -792, -292, 0.5, 0.5, -88.5, 18.5 ) --[[ @ 0]]
	...
	local WeaponAttributes = CoD.WeaponAttributes.new( f1_local1, f1_arg0, 0.5, 0.5, 461, 906, 0.5, 0.5, -120, 130 ) --[[ @ 0]]
	...
	CACHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_493CE015442D7E04" ) ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"], nil, function ( element, menu, controller, model )
		...
		elseif not IsPC() then
			CoD.CACUtility.UpdateClassModelWeaponIfPrimary( self, controller ) --[[ @ 0]]
...
CoD.ZMStartWeaponSelect.__resetProperties = function ( f17_arg0 )
	...
	f17_arg0.WeaponListWidget:setTopBottom( 0.5, 0.5, 133, 623 ) --[[ @ 0]]
	f17_arg0.WeaponListWidget:setAlpha( 1 ) --[[ @ 0]]
	f17_arg0.BackgroundSlidePanel:setTopBottom( 0.5, 0.5, 132, 754 ) --[[ @ 0]]
	...
	DefaultState = {
		...
		OpenPC = function ( f27_arg0, f27_arg1 )
			...
			local f27_local0 = function ( f28_arg0 )
				f27_arg0.BackgroundSlidePanel:beginAnimation( 70 ) --[[ @ 0]]
			...
			local f27_local1 = function ( f29_arg0 )
				f27_arg0.WeaponListWidget:beginAnimation( 70 ) --[[ @ 0]]
				f27_arg0.WeaponListWidget:setAlpha( 1 ) --[[ @ 0]]
				f27_arg0.WeaponListWidget:registerEventHandler( "interrupted_keyframe", f27_arg0.clipInterrupted ) --[[ @ 0]]
				f27_arg0.WeaponListWidget:registerEventHandler( "transition_complete_keyframe", f27_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f27_arg0.WeaponListWidget:completeAnimation() --[[ @ 0]]
			f27_arg0.WeaponListWidget:setAlpha( 0 ) --[[ @ 0]]
			f27_local1( f27_arg0.WeaponListWidget ) --[[ @ 0]]
		end,
		ClosePC = function ( f30_arg0, f30_arg1 )
			f30_arg0:__resetProperties() --[[ @ 0]]
			f30_arg0:setupElementClipCounter( 2 ) --[[ @ 0]]
			local f30_local0 = function ( f31_arg0 )
				f30_arg0.BackgroundSlidePanel:beginAnimation( 40 ) --[[ @ 0]]
				f30_arg0.BackgroundSlidePanel:setAlpha( 0 ) --[[ @ 0]]
				f30_arg0.BackgroundSlidePanel:registerEventHandler( "interrupted_keyframe", f30_arg0.clipInterrupted ) --[[ @ 0]]
				f30_arg0.BackgroundSlidePanel:registerEventHandler( "transition_complete_keyframe", f30_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f30_arg0.BackgroundSlidePanel:completeAnimation() --[[ @ 0]]
			f30_arg0.BackgroundSlidePanel:setAlpha( 1 ) --[[ @ 0]]
			f30_local0( f30_arg0.BackgroundSlidePanel ) --[[ @ 0]]
			local f30_local1 = function ( f32_arg0 )
				f30_arg0.WeaponListWidget:beginAnimation( 40 ) --[[ @ 0]]
				f30_arg0.WeaponListWidget:setAlpha( 0 ) --[[ @ 0]]
				f30_arg0.WeaponListWidget:registerEventHandler( "interrupted_keyframe", f30_arg0.clipInterrupted ) --[[ @ 0]]
				f30_arg0.WeaponListWidget:registerEventHandler( "transition_complete_keyframe", f30_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f30_arg0.WeaponListWidget:completeAnimation() --[[ @ 0]]
			f30_arg0.WeaponListWidget:setAlpha( 1 ) --[[ @ 0]]
			f30_local1( f30_arg0.WeaponListWidget ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.ZMStartWeaponSelect.__onClose = function ( f33_arg0 )
	f33_arg0.RestrictedText:close() --[[ @ 0]]
	f33_arg0.WeaponLevel:close() --[[ @ 0]]
	f33_arg0.ItemInfo:close() --[[ @ 0]]
	f33_arg0.WeaponAttributes:close() --[[ @ 0]]
	f33_arg0.XCamMouseControl:close() --[[ @ 0]]
	f33_arg0.BackgroundSlidePanel:close() --[[ @ 0]]
	f33_arg0.WeaponListWidget:close() --[[ @ 0]]
	f33_arg0.CACHeader:close() --[[ @ 0]]
	f33_arg0.BackingGrayMediumLeft:close() --[[ @ 0]]
