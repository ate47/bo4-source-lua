...
CoD.EntitlementPopupEreg = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.EntitlementPopupEreg = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "EntitlementPopupEreg", f1_arg0 ) --[[ @ 0]]
	...
	self:setClass( CoD.EntitlementPopupEreg ) --[[ @ 0]]
	...
	OptionDesc = LUI.UIText.new( 0.5, 0.5, -482.5, 672.5, 0.5, 0.5, -209, -184 ) --[[ @ 0]]
	OptionDesc:setRGB( ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b ) --[[ @ 0]]
	OptionDesc:setText( LocalizeHash( @"hash_4EEEC9D4E868F544" ) ) --[[ @ 0]]
	...
	PCDisclaimer:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	PCDisclaimer:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	CheckboxConfirm:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	CheckboxConfirm:setAlignment( Enum[@"luialignment"][@"lui_alignment_middle"] ) --[[ @ 0]]
	...
	local Codpoints = CoD.StartMenu_CODpoints.new( f1_local1, f1_arg0, 0.5, 0.5, 509, 723, 0.5, 0.5, -302, -253 ) --[[ @ 0]]
	...
	local Title = LUI.UIText.new( 0.5, 0.5, -492, 477, 0.5, 0.5, -315, -240 ) --[[ @ 0]]
	...
	local BoundaryBot2 = LUI.UIImage.new( 0.5, 0.5, -792.5, -231.5, 0.5, 0.5, -61, -45 ) --[[ @ 0]]
	...
	local BoundaryBot = LUI.UIImage.new( 0.5, 0.5, 392, 953, 0.5, 0.5, -61, -45 ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], nil, function ( element, menu, controller, model )
		...
		if not IsPC() then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xba_pscross"], @"menu/ok", Enum[@"luibuttonpromptflags"][@"hash_771B04FAC5BE0E35"] | 750 << Enum[@"luibuttonpromptflags"][@"hash_176ADD225D738C93"], nil ) --[[ @ 0]]
			return true
