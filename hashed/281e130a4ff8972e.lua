...
CoD.AmmoWidgetMP_Ultimate_Internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	TankUseString( Frame, GlowHero["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f7_arg0 )
	...
	TankUseString( Frame, GlowHero["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f8_arg0 )
		f1_arg0:updateElementState( ControllerDependentTextBox, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	TankUseString = ControllerDependentTextBox.subscribeToModel --[[ @ 0]]
	GlowHero = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	TankUseString( Frame, GlowHero["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5C57360571B0917E"]], function ( f9_arg0 )
		f1_arg0:updateElementState( ControllerDependentTextBox, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f33_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "state", Enum[@"hash_F0447219F15F7F3"][@"hash_958A6962CA8F9B7"] ) --[[ @ 0]]
				if f33_local0 then
		...
		DefaultClip = function ( f81_arg0, f81_arg1 )
			...
			local f81_local0 = function ( f82_arg0 )
				local f82_local0 = function ( f83_arg0 )
				 ...
				 --[[ @ 0]]
				f81_arg0.FlareBack:beginAnimation( 1000, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
				...
				local f90_local0 = function ( f91_arg0 )
					local f91_local0 = function ( f92_arg0 )
						local f92_local0 = function ( f93_arg0 )
							f93_arg0:beginAnimation( 59, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
							f93_arg0:setScale( 0.94, 0.92 ) --[[ @ 0]]
							f93_arg0:registerEventHandler( "transition_complete_keyframe", f86_arg0.clipFinished ) --[[ @ 0]]
						end
						 --[[ @ 0]]
						f92_arg0:beginAnimation( 20, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
