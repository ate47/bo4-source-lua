...
CoD.ItemShopRarityBackgroundStream_Common = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ItemShopRarityBackgroundStream_Common.__defaultWidth = 600 --[[ @ 0]]
CoD.ItemShopRarityBackgroundStream_Common.__defaultHeight = 600 --[[ @ 0]]
CoD.ItemShopRarityBackgroundStream_Common.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ItemShopRarityBackgroundStream_Common ) --[[ @ 0]]
	self.id = "ItemShopRarityBackgroundStream_Common" --[[ @ 0]]
	...
	RadialGlow:setShaderVector( 0, 1, 1, 0, 0 ) --[[ @ 0]]
	...
	BGPatternThin:setAlpha( 0 ) --[[ @ 0]]
	BGPatternThin:setImage( RegisterImage( @"uie_ui_menu_common_mtx_button_bg_rare_thin" ) ) --[[ @ 0]]
...
CoD.ItemShopRarityBackgroundStream_Common.__onClose = function ( f7_arg0 )
	f7_arg0.CommonOuterGlow01:close() --[[ @ 0]]
