...
require( "x64:4e113f326efe4f55" ) --[[ @ 0]]

CoD.AmmoWidgetZM_Prompt = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AmmoWidgetZM_Prompt.__defaultWidth = 64 --[[ @ 0]]
CoD.AmmoWidgetZM_Prompt.__defaultHeight = 12 --[[ @ 0]]
CoD.AmmoWidgetZM_Prompt.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AmmoWidgetZM_Prompt ) --[[ @ 0]]
	self.id = "AmmoWidgetZM_Prompt" --[[ @ 0]]
	...
	PromptText:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	PromptText:setAlignment( Enum[@"luialignment"][@"lui_alignment_middle"] ) --[[ @ 0]]
	self:addElement( PromptText ) --[[ @ 0]]
	self.PromptText = PromptText --[[ @ 0]]
	
	local empty = CoD.Common_CappedLine.new( f1_arg0, f1_arg1, 0, 0, 10, 54, 0, 0, 3, 6 ) --[[ @ 0]]
...
CoD.AmmoWidgetZM_Prompt.__resetProperties = function ( f2_arg0 )
	...
	f2_arg0.PromptText:setAlignment( Enum[@"luialignment"][@"lui_alignment_middle"] ) --[[ @ 0]]
...
CoD.AmmoWidgetZM_Prompt.__clipsPerState = {
	...
	LowAmmo = {
		DefaultClip = function ( f4_arg0, f4_arg1 )
			...
			f4_arg0.PromptText:setAlignment( Enum[@"luialignment"][@"lui_alignment_middle"] ) --[[ @ 0]]
	...
	LowHealth = {
		DefaultClip = function ( f7_arg0, f7_arg1 )
			...
			f7_arg0.empty:completeAnimation() --[[ @ 0]]
			f7_arg0.empty:setAlpha( 0 ) --[[ @ 0]]
			f7_arg0.clipFinished( f7_arg0.empty ) --[[ @ 0]]
			f7_arg0.nextClip = "DefaultClip" --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.AmmoWidgetZM_Prompt.__onClose = function ( f10_arg0 )
	f10_arg0.empty:close() --[[ @ 0]]
end
 --[[ @ 0]]
