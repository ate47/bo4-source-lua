		...
		CycleDown = function ( f38_arg0, f38_arg1 )
			...
			local f38_local0 = function ( f39_arg0 )
				local f39_local0 = function ( f40_arg0 )
				 ...
				 --[[ @ 0]]
				f38_arg0.QuickInventoryItemCurrent:beginAnimation( 180, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
				f38_arg0.QuickInventoryItemCurrent.Button.Blur:beginAnimation( 180, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
				f38_arg0.QuickInventoryItemCurrent.Button.Backing:beginAnimation( 180, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
				f38_arg0.QuickInventoryItemCurrent.Button.LED:beginAnimation( 180, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
				f38_arg0.QuickInventoryItemCurrent.Button.Border:beginAnimation( 180, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
				f38_arg0.QuickInventoryItemCurrent.Button.StackCount:beginAnimation( 180, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
