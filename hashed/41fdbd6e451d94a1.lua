...
LUI.createMenu.WZPurchaseCamo = function ( f1_arg0, f1_arg1 )
	...
	Purchase:setText( LocalizeToUpperString( @"hash_11A06466EC351FA7" ) ) --[[ @ 0]]
	...
	if IsPC() then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput( f1_local1, f1_arg0, f1_local19, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
	end
	return self
end
 --[[ @ 0]]
