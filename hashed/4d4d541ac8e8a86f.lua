...
CoD.ItemShopTitleAndDesc = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ItemShopTitleAndDesc.__defaultWidth = 463 --[[ @ 0]]
CoD.ItemShopTitleAndDesc.__defaultHeight = 226 --[[ @ 0]]
CoD.ItemShopTitleAndDesc.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ItemShopTitleAndDesc ) --[[ @ 0]]
	self.id = "ItemShopTitleAndDesc" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local SubExtraText = LUI.UIText.new( 0, 0, 2, 325, 0, 0, 208, 226 ) --[[ @ 0]]
	...
	local MainExtraText = LUI.UIText.new( 0, 0, 2, 325, 0, 0, 182, 202 ) --[[ @ 0]]
	...
	local SetBonusWidget = CoD.SetBonusWidget.new( f1_arg0, f1_arg1, 0, 0, 335, 463, 0, 0, 0, 216 ) --[[ @ 0]]
	...
	local Desc = LUI.UIText.new( 0, 0, 2, 325, 0, 0, 101.5, 119.5 ) --[[ @ 0]]
	...
	local Name = LUI.UIText.new( 0, 0, 0, 325, 0, 0, 27.5, 65.5 ) --[[ @ 0]]
...
CoD.ItemShopTitleAndDesc.__resetProperties = function ( f9_arg0 )
	...
	f9_arg0.Name:setLeftRight( 0, 0, 0, 325 ) --[[ @ 0]]
	f9_arg0.Desc:setLeftRight( 0, 0, 2, 325 ) --[[ @ 0]]
	f9_arg0.MainExtraText:setLeftRight( 0, 0, 2, 325 ) --[[ @ 0]]
	f9_arg0.SubExtraText:setLeftRight( 0, 0, 2, 325 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.ItemShopTitleAndDesc.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f10_arg0, f10_arg1 )
			...
			f10_arg0.SubExtraText:setLeftRight( 0, 0, 2, 448 ) --[[ @ 0]]
			f10_arg0.clipFinished( f10_arg0.SubExtraText ) --[[ @ 0]]
			f10_arg0.MainExtraText:completeAnimation() --[[ @ 0]]
			f10_arg0.MainExtraText:setLeftRight( 0, 0, 2, 448 ) --[[ @ 0]]
			...
			f10_arg0.Desc:setLeftRight( 0, 0, 2, 448 ) --[[ @ 0]]
			f10_arg0.clipFinished( f10_arg0.Desc ) --[[ @ 0]]
			f10_arg0.Name:completeAnimation() --[[ @ 0]]
			f10_arg0.Name:setLeftRight( 0, 0, 0, 450 ) --[[ @ 0]]
