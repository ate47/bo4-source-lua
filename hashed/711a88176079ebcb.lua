...
LUI.createMenu.EmpRebootIndicator = function ( f3_arg0, f3_arg1 )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f4_local0 = Engine[@"IsVisibilityBitSet"]( f3_arg0, Enum[@"UIVisibilityBit"][@"hash_6668F0686232679"] ) --[[ @ 0]]
				if not f4_local0 then
					f4_local0 = Engine[@"IsVisibilityBitSet"]( f3_arg0, Enum[@"UIVisibilityBit"][@"hash_523CD9BAB9B9F4C8"] ) --[[ @ 0]]
					if not f4_local0 then
						f4_local0 = Engine[@"IsVisibilityBitSet"]( f3_arg0, Enum[@"UIVisibilityBit"][@"hash_1C630DB86D235A5"] ) --[[ @ 0]]
						if not f4_local0 then
							f4_local0 = Engine[@"IsVisibilityBitSet"]( f3_arg0, Enum[@"UIVisibilityBit"][@"hash_DA8E6697A56A554"] ) --[[ @ 0]]
						end
					end
				end
				return f4_local0
	...
	f3_local5( f3_local4, f3_local6["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_6668F0686232679"]], function ( f6_arg0 )
	...
	f3_local5( f3_local4, f3_local6["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_523CD9BAB9B9F4C8"]], function ( f7_arg0 )
		f3_local1:updateElementState( self, {
			name = "model_validation",
			menu = f3_local1,
			controller = f3_arg0,
	...
	f3_local5 = self.subscribeToModel --[[ @ 0]]
	f3_local6 = Engine[@"GetModelForController"]( f3_arg0 ) --[[ @ 0]]
	f3_local5( f3_local4, f3_local6["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_1C630DB86D235A5"]], function ( f8_arg0 )
		f3_local1:updateElementState( self, {
			name = "model_validation",
			menu = f3_local1,
			controller = f3_arg0,
	...
	f3_local5 = self.subscribeToModel --[[ @ 0]]
	f3_local6 = Engine[@"GetModelForController"]( f3_arg0 ) --[[ @ 0]]
	f3_local5( f3_local4, f3_local6["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_DA8E6697A56A554"]], function ( f9_arg0 )
		f3_local1:updateElementState( self, {
			name = "model_validation",
			menu = f3_local1,
			controller = f3_arg0,
			modelValue = f9_arg0:get(),
			modelName = "UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_DA8E6697A56A554"]
		} ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f3_local4 = self --[[ @ 0]]
	f3_local5 = self.subscribeToModel --[[ @ 0]]
	...
	DefaultState = {
		...
		Boot = function ( f14_arg0, f14_arg1 )
			...
			local f14_local0 = function ( f15_arg0 )
				f14_arg0.EmpRebootIndicatorWidget:beginAnimation( 400, Enum[@"hash_1F50FFF429AB1890"][@"hash_55D2D9CF90AB1735"] | Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
			...
			local f14_local1 = function ( f16_arg0 )
				f14_arg0.EmpRebootElectromagneticWidget0:beginAnimation( 400, Enum[@"hash_1F50FFF429AB1890"][@"hash_55D2D9CF90AB1735"] | Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
