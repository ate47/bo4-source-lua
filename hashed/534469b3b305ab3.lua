...
CoD.StartMenu_ChangeSpecialist_CT.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	specialistRespawnDesc:setText( LocalizeToUpperString( @"hash_2666D479022F3E32" ) ) --[[ @ 0]]
	...
	DraftCooldown( f1_local3, SignatureAbility["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_534C7B2375D2D47"]], function ( f9_arg0 )
		f1_arg0:updateElementState( Characters, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
