...
CoD.BlackJacksShopFrame = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.BlackJacksShopFrame.__defaultWidth = 1920 --[[ @ 0]]
CoD.BlackJacksShopFrame.__defaultHeight = 1080 --[[ @ 0]]
CoD.BlackJacksShopFrame.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.BlackJacksShopFrame ) --[[ @ 0]]
	self.id = "BlackJacksShopFrame" --[[ @ 0]]
	...
	FeaturedSlot1:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_52FB29ED3A3CA79", function ( f23_arg0, f23_arg1, f23_arg2, f23_arg3 )
	...
	FeaturedSlot2:linkToElementModel( FeaturedSlot2, "movieName", true, function ( model, f26_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f26_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	FeaturedSlot2:appendEventHandler( "input_source_changed", function ( f27_arg0, f27_arg1 )
		f27_arg1.menu = f27_arg1.menu or f1_arg0 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f27_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f27_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	SpecialOrders( FeaturedItemsBracket, SpecialOrdersLabel.LastInput, function ( f28_arg0, f28_arg1 )
		CoD.Menu.UpdateButtonShownState( f28_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f28_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	FeaturedSlot2:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_52FB29ED3A3CA79", function ( f46_arg0, f46_arg1, f46_arg2, f46_arg3 )
	...
	SpecialOrders:appendEventHandler( "input_source_changed", function ( f49_arg0, f49_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f49_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f49_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	FeaturedItemsBracket( SpecialOrdersLabel, MyShopTimer.LastInput, function ( f50_arg0, f50_arg1 )
		CoD.Menu.UpdateButtonShownState( f50_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f50_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	SpecialOrders:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_52FB29ED3A3CA79", function ( f68_arg0, f68_arg1, f68_arg2, f68_arg3 )
	...
	MyShop:linkToElementModel( MyShop, "lootType", true, function ( model, f72_arg1 )
		CoD.Menu.UpdateButtonShownState( f72_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	local f1_local18 = SupplyChainDetails --[[ @ 0]]
	...
	self:appendEventHandler( "input_source_changed", function ( f101_arg0, f101_arg1 )
		f101_arg1.menu = f101_arg1.menu or f1_arg0 --[[ @ 0]]
		f1_arg0:updateElementState( self, f101_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local20 = self --[[ @ 0]]
	...
	f1_local18 = FeaturedSlot1 --[[ @ 0]]
	CoD.BaseUtility.DisableNavigation( f1_local18 ) --[[ @ 0]]
	SetElementProperty( f1_local18, "__loopOnSameRow", true ) --[[ @ 0]]
	SetElementProperty( f1_local18, "__allowCreateOnLoop", true ) --[[ @ 0]]
	CoD.BlackMarketUtility.InitialHideScrollPrompts( self, f1_arg1, f1_local18 ) --[[ @ 0]]
	CoD.BlackMarketUtility.ShopCycleThroughItems( f1_arg0, f1_arg1, f1_local18, 0.5 ) --[[ @ 0]]
	f1_local18 = FeaturedSlot2 --[[ @ 0]]
	CoD.BaseUtility.DisableNavigation( f1_local18 ) --[[ @ 0]]
	SetElementProperty( f1_local18, "__loopOnSameRow", true ) --[[ @ 0]]
	SetElementProperty( f1_local18, "__allowCreateOnLoop", true ) --[[ @ 0]]
	CoD.BlackMarketUtility.InitialHideScrollPrompts( self, f1_arg1, f1_local18 ) --[[ @ 0]]
	CoD.BlackMarketUtility.ShopCycleThroughItems( f1_arg0, f1_arg1, f1_local18, 0.5 ) --[[ @ 0]]
	f1_local18 = SpecialOrders --[[ @ 0]]
	CoD.BaseUtility.DisableNavigation( f1_local18 ) --[[ @ 0]]
	SetElementProperty( f1_local18, "__loopOnSameRow", true ) --[[ @ 0]]
	SetElementProperty( f1_local18, "__allowCreateOnLoop", true ) --[[ @ 0]]
	CoD.BlackMarketUtility.InitialHideScrollPrompts( self, f1_arg1, f1_local18 ) --[[ @ 0]]
	...
	SetElementProperty( f1_local18, "__allowCreateOnLoop", true ) --[[ @ 0]]
	CoD.BlackMarketUtility.InitialHideScrollPrompts( self, f1_arg1, f1_local18 ) --[[ @ 0]]
	f1_local18 = TransactionDeepLinkButton --[[ @ 0]]
...
CoD.BlackJacksShopFrame.__resetProperties = function ( f104_arg0 )
	f104_arg0.MyShop:completeAnimation() --[[ @ 0]]
	f104_arg0.SpecialOrders:completeAnimation() --[[ @ 0]]
	f104_arg0.FeaturedSlot2:completeAnimation() --[[ @ 0]]
	f104_arg0.FeaturedSlot1:completeAnimation() --[[ @ 0]]
	f104_arg0.MyShop:setHorizontalCounter( CoD.horizontalCounterTriggerPrompts ) --[[ @ 0]]
	f104_arg0.SpecialOrders:setHorizontalCounter( CoD.horizontalCounterTriggerPrompts ) --[[ @ 0]]
	f104_arg0.FeaturedSlot2:setHorizontalCounter( CoD.horizontalCounterTriggerPrompts ) --[[ @ 0]]
	f104_arg0.FeaturedSlot1:setHorizontalCounter( CoD.horizontalCounterTriggerPrompts ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.BlackJacksShopFrame.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f105_arg0, f105_arg1 )
			...
			f105_arg0:setupElementClipCounter( 0 ) --[[ @ 0]]
		end
	},
	KBM = {
		DefaultClip = function ( f106_arg0, f106_arg1 )
			f106_arg0:__resetProperties() --[[ @ 0]]
			f106_arg0:setupElementClipCounter( 4 ) --[[ @ 0]]
			f106_arg0.FeaturedSlot1:completeAnimation() --[[ @ 0]]
			f106_arg0.FeaturedSlot1:setHorizontalCounter( CoD.horizontalCounter ) --[[ @ 0]]
			f106_arg0.clipFinished( f106_arg0.FeaturedSlot1 ) --[[ @ 0]]
			f106_arg0.FeaturedSlot2:completeAnimation() --[[ @ 0]]
			f106_arg0.FeaturedSlot2:setHorizontalCounter( CoD.horizontalCounter ) --[[ @ 0]]
			f106_arg0.clipFinished( f106_arg0.FeaturedSlot2 ) --[[ @ 0]]
			f106_arg0.SpecialOrders:completeAnimation() --[[ @ 0]]
			f106_arg0.SpecialOrders:setHorizontalCounter( CoD.horizontalCounter ) --[[ @ 0]]
			f106_arg0.clipFinished( f106_arg0.SpecialOrders ) --[[ @ 0]]
			f106_arg0.MyShop:completeAnimation() --[[ @ 0]]
			f106_arg0.MyShop:setHorizontalCounter( CoD.horizontalCounter ) --[[ @ 0]]
			f106_arg0.clipFinished( f106_arg0.MyShop ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.BlackJacksShopFrame.__onClose = function ( f107_arg0 )
	f107_arg0.FeaturedSlot1Timer:close() --[[ @ 0]]
	f107_arg0.FeaturedSlot1:close() --[[ @ 0]]
	f107_arg0.FeaturedSlot2Timer:close() --[[ @ 0]]
	f107_arg0.FeaturedSlot2:close() --[[ @ 0]]
	f107_arg0.SpecialOrders:close() --[[ @ 0]]
	f107_arg0.MyShopTimer:close() --[[ @ 0]]
	f107_arg0.SpecialOrdersTimer:close() --[[ @ 0]]
	f107_arg0.MyShop:close() --[[ @ 0]]
	f107_arg0.TransactionDeepLinkButton:close() --[[ @ 0]]
	f107_arg0.SupplyChainDetails:close() --[[ @ 0]]
	f107_arg0.DiscountTiersWidget:close() --[[ @ 0]]
end
 --[[ @ 0]]
