...
CoD.OverheadName_PlayerNameAndClanTagGlow = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.OverheadName_PlayerNameAndClanTagGlow.__defaultWidth = 200 --[[ @ 0]]
CoD.OverheadName_PlayerNameAndClanTagGlow.__defaultHeight = 37 --[[ @ 0]]
CoD.OverheadName_PlayerNameAndClanTagGlow.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.OverheadName_PlayerNameAndClanTagGlow ) --[[ @ 0]]
	self.id = "OverheadName_PlayerNameAndClanTagGlow" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local ClanTag = LUI.UIText.new( 0, 0, 0, 62, 0, 0, 0, 24 ) --[[ @ 0]]
	ClanTag:setRGB( 0.14, 0.14, 0.14 ) --[[ @ 0]]
	ClanTag:setTTF( "notosans_bold" ) --[[ @ 0]]
	ClanTag:setMaterial( LUI.UIImage.GetCachedMaterial( @"hash_2AE166D9BA8C6907" ) ) --[[ @ 0]]
	ClanTag:setShaderVector( 0, 0.3, 0, 0, 0 ) --[[ @ 0]]
	ClanTag:setShaderVector( 1, 0, 0, 0, 0 ) --[[ @ 0]]
	ClanTag:setShaderVector( 2, 1, 0, 0, 0 ) --[[ @ 0]]
	...
	PlayerName:setRGB( 0.14, 0.14, 0.14 ) --[[ @ 0]]
	PlayerName:setTTF( "notosans_bold" ) --[[ @ 0]]
	PlayerName:setMaterial( LUI.UIImage.GetCachedMaterial( @"hash_2AE166D9BA8C6907" ) ) --[[ @ 0]]
	PlayerName:setShaderVector( 0, 0.3, 0, 0, 0 ) --[[ @ 0]]
	PlayerName:setShaderVector( 1, 0, 0, 0, 0 ) --[[ @ 0]]
	PlayerName:setShaderVector( 2, 1, 0, 0, 0 ) --[[ @ 0]]
