...
CoD.FooterButton_PersistentLeftContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonChat, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonChat, f1_arg1, Enum[@"luibutton"][@"lui_key_none"], "MOUSE1", function ( element, menu, controller, model )
		CoD.PCUtility.ToggleChatVisibility( controller ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonFriends, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonFriends, f1_arg1, Enum[@"luibutton"][@"lui_key_none"], "MOUSE1", function ( element, menu, controller, model )
		CoD.PCBattlenetUtility.ToggleBattlenetMenuVisibility( element, menu, controller ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "MOUSE1" ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonSocial, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonSocial, f1_arg1, Enum[@"luibutton"][@"lui_key_none"], "MOUSE1", function ( element, menu, controller, model )
		if not IsLAN() and not IsPlayerAGuest( controller ) and IsPlayerAllowedToPlayOnline( controller ) then
			CoD.PCUtility.ToggleShortcutMenu( menu, controller, "ui_opensocial" ) --[[ @ 0]]
			return true
		else
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonStore, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonStore, f1_arg1, Enum[@"luibutton"][@"lui_key_none"], "MOUSE1", function ( element, menu, controller, model )
		CoD.PCUtility.ToggleShortcutMenu( menu, controller, "ui_openstore" ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "MOUSE1" ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonSettings, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonSettings, f1_arg1, Enum[@"luibutton"][@"lui_key_none"], "MOUSE1", function ( element, menu, controller, model )
		CoD.PCUtility.ToggleShortcutMenu( menu, controller, "ui_opensettings" ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "MOUSE1" ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonPlayerAccount, f1_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FooterButtonPlayerAccount, f1_arg1, Enum[@"luibutton"][@"lui_key_none"], "MOUSE1", function ( element, menu, controller, model )
		CoD.PCUtility.ToggleShortcutMenu( menu, controller, "ui_openPlayerAccount" ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "MOUSE1" ) --[[ @ 0]]
