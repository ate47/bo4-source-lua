...
CoD.Mark2BonusExpBadge = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.Mark2BonusExpBadge.__defaultWidth = 260 --[[ @ 0]]
CoD.Mark2BonusExpBadge.__defaultHeight = 18 --[[ @ 0]]
CoD.Mark2BonusExpBadge.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.Mark2BonusExpBadge ) --[[ @ 0]]
	self.id = "Mark2BonusExpBadge" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local Text = LUI.UIText.new( 0, 0, 0, 260, 0, 0, 1, 16 ) --[[ @ 0]]
	Text:setRGB( 0.22, 0.93, 1 ) --[[ @ 0]]
	Text:setZoom( 3 ) --[[ @ 0]]
	...
	self:mergeStateConditions( {
			...
			condition = function ( menu, element, event )
				...
				if f2_local0 then
					if not IsCurrentMenu( menu, "PaintjobWeaponSelect" ) then
						...
						if f2_local0 then
							f2_local0 = IsDoubleXP( f1_arg1 ) --[[ @ 0]]
							if f2_local0 then
								f2_local0 = CoD.BaseUtility.IsCurrentLanguageAsian() --[[ @ 0]]
							end
						end
					else
						f2_local0 = false --[[ @ 0]]
			...
			condition = function ( menu, element, event )
				...
				if f3_local0 then
					if not IsCurrentMenu( menu, "PaintjobWeaponSelect" ) then
						...
						if f3_local0 then
							f3_local0 = CoD.BaseUtility.IsCurrentLanguageAsian() --[[ @ 0]]
						end
					else
						f3_local0 = false --[[ @ 0]]
					end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f4_local0 = CoD.CACUtility.IsMark2Weapon( f1_arg1, self ) --[[ @ 0]]
				if f4_local0 then
					if not IsCurrentMenu( menu, "PaintjobWeaponSelect" ) then
						f4_local0 = CoD.CACUtility.IsProgressionEnabledForMenu( menu ) --[[ @ 0]]
						if f4_local0 then
		...
		},
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				local f5_local0 = CoD.CACUtility.IsMark2Weapon( f1_arg1, self ) --[[ @ 0]]
				if f5_local0 then
					if not IsCurrentMenu( menu, "PaintjobWeaponSelect" ) then
...
CoD.Mark2BonusExpBadge.__resetProperties = function ( f9_arg0 )
	...
	f9_arg0.Text:setTopBottom( 0, 0, 1, 16 ) --[[ @ 0]]
	f9_arg0.Text:setRGB( 0.22, 0.93, 1 ) --[[ @ 0]]
	f9_arg0.Text:setAlpha( 1 ) --[[ @ 0]]
	f9_arg0.Text:setText( LocalizeToUpperString( @"hash_6DF923C238938C67" ) ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.Mark2BonusExpBadge.__clipsPerState = {
	...
	VisibleDoubleExpAsianLanguage = {
		DefaultClip = function ( f11_arg0, f11_arg1 )
			...
			f11_arg0.Text:setTopBottom( 0, 0, 3, 16 ) --[[ @ 0]]
			f11_arg0.Text:setRGB( 0.22, 0.94, 1 ) --[[ @ 0]]
			f11_arg0.Text:setText( LocalizeToUpperString( @"hash_18DC8ECEFEBF1515" ) ) --[[ @ 0]]
	...
	VisibleAsianLanguage = {
		DefaultClip = function ( f12_arg0, f12_arg1 )
			...
			f12_arg0.Text:setTopBottom( 0, 0, 3, 16 ) --[[ @ 0]]
			f12_arg0.Text:setRGB( 0.22, 0.94, 1 ) --[[ @ 0]]
	...
	VisibleDoubleExp = {
		DefaultClip = function ( f13_arg0, f13_arg1 )
			...
			f13_arg0.Text:setTopBottom( 0, 0, -2, 16 ) --[[ @ 0]]
			f13_arg0.Text:setText( LocalizeToUpperString( @"hash_18DC8ECEFEBF1515" ) ) --[[ @ 0]]
	...
	Visible = {
		DefaultClip = function ( f14_arg0, f14_arg1 )
			...
			f14_arg0.Text:setTopBottom( 0, 0, -2, 16 ) --[[ @ 0]]
			f14_arg0.Text:setRGB( 0.22, 0.94, 1 ) --[[ @ 0]]
