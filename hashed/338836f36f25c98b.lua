...
if Enum[@"LUIAlignment"] then
	LUI.Alignment = {
		None = Enum[@"LUIAlignment"][@"hash_11539396E54B179A"],
		Left = Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"],
		Center = Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"],
		Right = Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"],
		Top = Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"],
		Middle = Enum[@"LUIAlignment"][@"hash_6ED4298C93DC5ED"],
		Bottom = Enum[@"LUIAlignment"][@"hash_670510683C22104B"]
	} --[[ @ 0]]
end
if hpairs ~= nil then
	pairs = hpairs --[[ @ 0]]
	...
	if Engine[@"hash_72DA54CF5D6B7F02"]() then
		f28_local0.__index = function ( f30_arg0, f30_arg1 )
			...
			if string.find( f30_local0, "debuggerIndexMeta" ) == nil then
				if nil ~= Dvar[@"hash_296B7991ACA20308"] and Dvar[@"hash_296B7991ACA20308"]:get() then
