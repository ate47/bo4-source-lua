...
CoD.ItemShopRarityBackgroundStream_Legendary = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ItemShopRarityBackgroundStream_Legendary.__defaultWidth = 600 --[[ @ 0]]
CoD.ItemShopRarityBackgroundStream_Legendary.__defaultHeight = 600 --[[ @ 0]]
CoD.ItemShopRarityBackgroundStream_Legendary.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ItemShopRarityBackgroundStream_Legendary ) --[[ @ 0]]
	self.id = "ItemShopRarityBackgroundStream_Legendary" --[[ @ 0]]
	...
	RadialGlow:setImage( RegisterImage( @"hash_58F71B593239CEE7" ) ) --[[ @ 0]]
	RadialGlow:linkToElementModel( self, "rarity", true, function ( model )
		local f3_local0 = model:get() --[[ @ 0]]
		if f3_local0 ~= nil then
			RadialGlow:setRGB( CoD.BlackMarketUtility.LootRarityToColor( f3_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	BGPatternThin:setAlpha( 0.15 ) --[[ @ 0]]
	BGPatternThin:setImage( RegisterImage( @"uie_ui_menu_common_mtx_button_bg_legendary_thin" ) ) --[[ @ 0]]
