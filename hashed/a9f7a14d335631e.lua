...
CoD.BGBListItem.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	ZMElixirSlot:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				return CoD.ZMLoadoutUtility.IsBubbleGumBuffEquippedInAnySlot( menu, self, f1_arg1 ) and not CoD.CACUtility.DoesCACItemHaveConsumablesRemaining( menu, element, f1_arg1, Enum[@"hash_6EB546760F890D2"][@"hash_648CD0338EE0B3AE"] )
			end
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not CoD.ZMLoadoutUtility.IsBubbleGumBuffEquippedInAnySlot( menu, self, f1_arg1 ) then
					f4_local0 = not CoD.CACUtility.DoesCACItemHaveConsumablesRemaining( menu, element, f1_arg1, Enum[@"hash_6EB546760F890D2"][@"hash_648CD0338EE0B3AE"] ) --[[ @ 0]]
				else
					f4_local0 = false --[[ @ 0]]
				end
				return f4_local0
	...
	DefaultState = {
		...
		GainChildFocus = function ( f14_arg0, f14_arg1 )
			...
			local f14_local0 = function ( f15_arg0 )
				f14_arg0.ZMElixirSlot:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
		...
		LoseChildFocus = function ( f16_arg0, f16_arg1 )
			...
			local f16_local0 = function ( f17_arg0 )
				f16_arg0.ZMElixirSlot:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
