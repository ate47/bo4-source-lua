...
CoD.ZMTalismanSafeAreaContainer = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ZMTalismanSafeAreaContainer.__defaultWidth = 1920 --[[ @ 0]]
CoD.ZMTalismanSafeAreaContainer.__defaultHeight = 1080 --[[ @ 0]]
CoD.ZMTalismanSafeAreaContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ZMTalismanSafeAreaContainer ) --[[ @ 0]]
	self.id = "ZMTalismanSafeAreaContainer" --[[ @ 0]]
	...
	CACHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_4813595698C26EB" ) ) --[[ @ 0]]
	...
	local BackingGrayMediumLeft = CoD.header_container_frontend.new( f1_arg0, f1_arg1, 0.5, 1.5, -960, -960, 0, 0, 0, 42 ) --[[ @ 0]]
	...
	CategoryTabs.Tabs.grid:setWidgetType( CoD.CommonTabButton ) --[[ @ 0]]
	CategoryTabs.Tabs.grid:setDataSource( "TalismanCategories" ) --[[ @ 0]]
