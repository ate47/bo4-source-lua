...
CoD.SupplyChainDetails_ButtonPromptContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	ToggleOutfitPreview:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f2_local0 then
					...
					if f2_local0 then
						f2_local0 = not CoD.ModelUtility.IsSelfModelValueEqualTo( element, f1_arg1, "itemCategory", @"hash_5CC13B0F8EEFF726" ) --[[ @ 0]]
					end
				end
				return f2_local0
			end
		...
		},
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				return CoD.ModelUtility.IsSelfModelValueTrue( element, f1_arg1, "allowTogglePreview" ) and not CoD.ModelUtility.IsSelfModelValueEqualTo( element, f1_arg1, "itemCategory", @"hash_5CC13B0F8EEFF726" )
			end
		}
	} ) --[[ @ 0]]
	...
	ToggleOutfitPreview.togglePreviewLabel:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7C59A6407407976" ) ) --[[ @ 0]]
	...
	ToggleWeaponPreview:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f11_local0 then
					...
					if f11_local0 then
						f11_local0 = CoD.ModelUtility.IsSelfModelValueEqualTo( element, f1_arg1, "itemCategory", @"hash_5CC13B0F8EEFF726" ) --[[ @ 0]]
					end
				end
				return f11_local0
			end
		...
		},
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				return CoD.ModelUtility.IsSelfModelValueTrue( element, f1_arg1, "allowTogglePreview" ) and CoD.ModelUtility.IsSelfModelValueEqualTo( element, f1_arg1, "itemCategory", @"hash_5CC13B0F8EEFF726" )
			end
		}
	} ) --[[ @ 0]]
	...
	PreviewGesture.togglePreviewLabel:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_5DE61F05A2F38605" ) ) --[[ @ 0]]
	...
	VideoPreview.togglePreviewLabel:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_20612B1DD49195D5" ) ) --[[ @ 0]]
