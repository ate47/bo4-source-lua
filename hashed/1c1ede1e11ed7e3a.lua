	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f7_local0 then
					f7_local0 = Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_demo_all_game_hud_hidden"] ) --[[ @ 0]]
		...
		},
		{
			stateName = "Killcam",
			condition = function ( menu, element, event )
				local f8_local0 = Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_final_killcam"] ) --[[ @ 0]]
				if not f8_local0 then
					f8_local0 = Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_in_killcam"] ) --[[ @ 0]]
					if not f8_local0 then
						f8_local0 = Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_round_end_killcam"] ) --[[ @ 0]]
					end
				end
				return f8_local0
			end
