...
CoD.ItemShopCaseExchangeConfirmation = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.ItemShopCaseExchangeConfirmation = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "ItemShopCaseExchangeConfirmation", f1_arg0 ) --[[ @ 0]]
	...
	self:setClass( CoD.ItemShopCaseExchangeConfirmation ) --[[ @ 0]]
	...
	FullscreenPopupTemplate.Subtitle:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_5FD2315D7C41480E" ) ) --[[ @ 0]]
	FullscreenPopupTemplate.ErrorSubtitle:setText( LocalizeToUpperString( @"hash_A5FEF098BBBD5A3" ) ) --[[ @ 0]]
	FullscreenPopupTemplate.WorkingTitle:setText( LocalizeToUpperString( @"hash_354D5E3ECAB13858" ) ) --[[ @ 0]]
	FullscreenPopupTemplate.DoneTitle:setText( LocalizeToUpperString( @"hash_5456F58A03ED7888" ) ) --[[ @ 0]]
	...
	FullscreenPopupTemplate:linkToElementModel( self, "name", true, function ( model )
		...
		if f7_local0 ~= nil then
			FullscreenPopupTemplate.Title:setText( ToUpper( LocalizeIntoString( @"hash_1BCE67CC57BD00E0", f7_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	CostText:setRGB( ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b ) --[[ @ 0]]
	...
	CostText:linkToElementModel( self, "casePrice", true, function ( model )
		...
		if f11_local0 ~= nil then
			CostText:setText( LocalizeIntoStringIfNotEmpty( @"hash_79CBD79D3C8A2BED", f11_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		...
		if IsElementInState( self.FullscreenPopupTemplate, "ErrorState" ) then
			...
			return false
		elseif not IsElementInState( self.FullscreenPopupTemplate, "WorkingState" ) and not IsElementInState( self.FullscreenPopupTemplate, "FinishedState" ) and CoD.ModelUtility.IsSelfModelValueGreaterThan( self, controller, "casePrice", 0 ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_7C2737E72EC4A26", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
...
CoD.ItemShopCaseExchangeConfirmation.__resetProperties = function ( f20_arg0 )
	...
	f20_arg0.TextBox:setTopBottom( 0.5, 0.5, -132, -110 ) --[[ @ 0]]
...
CoD.ItemShopCaseExchangeConfirmation.__clipsPerState = {
	...
	UnlockingTiers = {
		DefaultClip = function ( f22_arg0, f22_arg1 )
			...
			f22_arg0.SpinnerLoadingAnimation:completeAnimation() --[[ @ 0]]
			f22_arg0.SpinnerLoadingAnimation:setAlpha( 1 ) --[[ @ 0]]
			f22_arg0.clipFinished( f22_arg0.SpinnerLoadingAnimation ) --[[ @ 0]]
			f22_arg0.TextBox:completeAnimation() --[[ @ 0]]
			f22_arg0.TextBox:setTopBottom( 0, 0, 406, 428 ) --[[ @ 0]]
			f22_arg0.TextBox:setAlpha( 1 ) --[[ @ 0]]
			f22_arg0.clipFinished( f22_arg0.TextBox ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.ItemShopCaseExchangeConfirmation.__onClose = function ( f23_arg0 )
	f23_arg0.FullscreenPopupTemplate:close() --[[ @ 0]]
	f23_arg0.SelfIdentityBadge:close() --[[ @ 0]]
	f23_arg0.ContentImage:close() --[[ @ 0]]
	f23_arg0.CostText:close() --[[ @ 0]]
	f23_arg0.StartMenuCODpoints:close() --[[ @ 0]]
	f23_arg0.CommonIdentityWidgetStreamlinedPC:close() --[[ @ 0]]
	f23_arg0.CommonIdentityWidgetStreamlinedC:close() --[[ @ 0]]
	f23_arg0.SpinnerLoadingAnimation:close() --[[ @ 0]]
end
 --[[ @ 0]]
