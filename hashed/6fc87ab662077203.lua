...
CoD.GameSettings_AttachmentRestrictionSettings = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.GameSettings_AttachmentRestrictionSettings = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "GameSettings_AttachmentRestrictionSettings", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	MenuHidesFreeCursor( f1_local1, f1_arg0 ) --[[ @ 0]]
	self:setClass( CoD.GameSettings_AttachmentRestrictionSettings ) --[[ @ 0]]
	...
	SlidersPC:setLeftRight( 0, 0, 426, 1126 ) --[[ @ 0]]
	SlidersPC:setTopBottom( 0, 0, 142, 950 ) --[[ @ 0]]
	...
	self.__on_menuOpened_self = function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3 )
		...
		if IsPC() then
			CoD.OptionsUtility.SetCurrentActiveWeaponAttachmentCategory( f14_arg2 ) --[[ @ 0]]
