...
CoD.ThemeOptionGrid.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MasteryGrid:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( MasteryGrid, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( MasteryGrid, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( MasteryGrid, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( MasteryGrid, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_contextual_1", function ( element, menu, controller, model )
	...
	MasteryGrid:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f18_arg0, f18_arg1, f18_arg2, f18_arg3 )
	...
	MasteryGrid:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_6B1A784560EDFEA7", function ( f20_arg0, f20_arg1, f20_arg2, f20_arg3 )
