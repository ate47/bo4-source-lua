...
CoD.PC_BattlenetFriend_SentInvite = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.PC_BattlenetFriend_SentInvite.__defaultWidth = 400 --[[ @ 0]]
CoD.PC_BattlenetFriend_SentInvite.__defaultHeight = 60 --[[ @ 0]]
CoD.PC_BattlenetFriend_SentInvite.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.PC_BattlenetFriend_SentInvite ) --[[ @ 0]]
	self.id = "PC_BattlenetFriend_SentInvite" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	self.onlyChildrenFocusable = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local IMG_Background = LUI.UIImage.new( 0.02, 1, 0, 0, 0, 1, 0, 0 ) --[[ @ 0]]
	...
	local TXTPlayerTag = LUI.UIText.new( 0.23, 0.23, 0, 268, 0, 0, 7, 28 ) --[[ @ 0]]
	...
	local TXTPending = LUI.UIText.new( 0.23, 0.23, 0, 270, 0.49, 0.49, 0, 15 ) --[[ @ 0]]
...
CoD.PC_BattlenetFriend_SentInvite.__resetProperties = function ( f10_arg0 )
	f10_arg0.IMG_Background:completeAnimation() --[[ @ 0]]
	f10_arg0.BTN_Remove:completeAnimation() --[[ @ 0]]
	f10_arg0.IMG_Background:setAlpha( 0 ) --[[ @ 0]]
...
CoD.PC_BattlenetFriend_SentInvite.__clipsPerState = {
	DefaultState = {
		...
		ChildFocus = function ( f12_arg0, f12_arg1 )
			...
			f12_arg0.IMG_Background:completeAnimation() --[[ @ 0]]
			f12_arg0.IMG_Background:setAlpha( 1 ) --[[ @ 0]]
			f12_arg0.clipFinished( f12_arg0.IMG_Background ) --[[ @ 0]]
		end
	},
	ReceiveFriendInvite = {
		DefaultClip = function ( f13_arg0, f13_arg1 )
			...
			f13_arg0.BTN_Remove:completeAnimation() --[[ @ 0]]
			f13_arg0.BTN_Remove:setAlpha( 1 ) --[[ @ 0]]
			f13_arg0.clipFinished( f13_arg0.BTN_Remove ) --[[ @ 0]]
		end,
		ChildFocus = function ( f14_arg0, f14_arg1 )
			f14_arg0:__resetProperties() --[[ @ 0]]
			f14_arg0:setupElementClipCounter( 1 ) --[[ @ 0]]
			f14_arg0.IMG_Background:completeAnimation() --[[ @ 0]]
			f14_arg0.IMG_Background:setAlpha( 1 ) --[[ @ 0]]
			f14_arg0.clipFinished( f14_arg0.IMG_Background ) --[[ @ 0]]
		end
	},
	SentFriendInvite = {
		DefaultClip = function ( f15_arg0, f15_arg1 )
			...
			f15_arg0.BTN_Remove:completeAnimation() --[[ @ 0]]
			f15_arg0.BTN_Remove:setAlpha( 1 ) --[[ @ 0]]
			f15_arg0.clipFinished( f15_arg0.BTN_Remove ) --[[ @ 0]]
		end,
		ChildFocus = function ( f16_arg0, f16_arg1 )
			f16_arg0:__resetProperties() --[[ @ 0]]
			f16_arg0:setupElementClipCounter( 1 ) --[[ @ 0]]
			f16_arg0.IMG_Background:completeAnimation() --[[ @ 0]]
			f16_arg0.IMG_Background:setAlpha( 1 ) --[[ @ 0]]
			f16_arg0.clipFinished( f16_arg0.IMG_Background ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.PC_BattlenetFriend_SentInvite.__onClose = function ( f17_arg0 )
	f17_arg0.TXTPlayerTag:close() --[[ @ 0]]
	f17_arg0.emptyFocusable:close() --[[ @ 0]]
	f17_arg0.BTN_Remove:close() --[[ @ 0]]
	f17_arg0.TXTPending:close() --[[ @ 0]]
end
 --[[ @ 0]]
