...
CoD.DropdownListItem = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.DropdownListItem.__defaultWidth = 336 --[[ @ 0]]
CoD.DropdownListItem.__defaultHeight = 60 --[[ @ 0]]
CoD.DropdownListItem.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DropdownListItem ) --[[ @ 0]]
	self.id = "DropdownListItem" --[[ @ 0]]
	...
	local TextBox = LUI.UIText.new( 0, 1, 42, -42, 0.5, 0.5, -9.5, 9.5 ) --[[ @ 0]]
