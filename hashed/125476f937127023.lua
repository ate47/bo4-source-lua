...
CoD.StartMenu_Options_CoDAccount_NewAccount = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.StartMenu_Options_CoDAccount_NewAccount = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "StartMenu_Options_CoDAccount_NewAccount", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	self:setClass( CoD.StartMenu_Options_CoDAccount_NewAccount ) --[[ @ 0]]
	...
	local StartMenuOptionsRegistrationForm = CoD.StartMenu_Options_RegistrationForm.new( f1_local1, f1_arg0, 0.5, 0.5, -960, 960, 0.5, 0.5, -545, 535 ) --[[ @ 0]]
	StartMenuOptionsRegistrationForm:subscribeToGlobalModel( f1_arg0, "CODAccountRegistrationForm", nil, function ( model )
		StartMenuOptionsRegistrationForm:setModel( model, f1_arg0 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( StartMenuOptionsRegistrationForm ) --[[ @ 0]]
	self.StartMenuOptionsRegistrationForm = StartMenuOptionsRegistrationForm --[[ @ 0]]
	...
	local DirectorSelectButtonMiniInternal = CoD.DirectorSelectButtonMiniInternal.new( f1_local1, f1_arg0, 0, 0, 147, 448, 0, 0, 789, 858 ) --[[ @ 0]]
	...
	local DirectorSelectButtonMiniInternal2 = CoD.DirectorSelectButtonMiniInternal.new( f1_local1, f1_arg0, 0, 0, 147, 448, 0, 0, 710, 779 ) --[[ @ 0]]
	...
	self:registerEventHandler( "ui_keyboard_input", function ( self, event )
		...
		CoD.CoDAccountUtility.CodAccountHandleKeyboardComplete( self, f1_arg0, event, self.StartMenuOptionsRegistrationForm ) --[[ @ 0]]
	...
	StartMenuOptionsRegistrationForm.id = "StartMenuOptionsRegistrationForm" --[[ @ 0]]
...
CoD.StartMenu_Options_CoDAccount_NewAccount.__onClose = function ( f20_arg0 )
	...
	f20_arg0.StartMenuOptionsRegistrationForm:close() --[[ @ 0]]
