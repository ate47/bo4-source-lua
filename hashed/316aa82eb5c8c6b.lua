...
CoD.CodCasterMiniMapPosition.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	CodCasterMiniMap:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f2_local0 --[[ @ 0]]
				if not Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"] ) and not ScoreboardVisible( f1_arg1 ) and not CoD.ModelUtility.IsModelValueTrue( f1_arg1, "CodCaster.showFullScreenMap" ) and not CoD.CodCasterUtility.CodCasterIsInAerialCam( f1_arg1 ) then
	...
	f1_local3 = CodCasterMiniMap.subscribeToModel --[[ @ 0]]
	f1_local4 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local3( f1_local2, f1_local4["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"]], function ( f6_arg0 )
		f1_arg0:updateElementState( CodCasterMiniMap, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
