...
CoD.ScoreInfo_Timer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	WhistleTime:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	WhistleTime:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	OvertimeText:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	OvertimeText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	BombTimer:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsGametypeSettingsValue( "autoDestroyTime", 0 ) then
					f3_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_4ABEA46F8DE7F02F"] ) --[[ @ 0]]
				else
					f3_local0 = false --[[ @ 0]]
				end
				return f3_local0
	...
	GameTimer2( HardpointObjective, WhistleImage["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4ABEA46F8DE7F02F"]], function ( f4_arg0 )
	...
	BombTimer.TimerText:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	GameTimer2:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	HardpointObjective:mergeStateConditions( {
		{
			stateName = "visible",
			condition = function ( menu, element, event )
				return Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_4ABEA46F8DE7F02F"] ) and CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "state", Enum[@"objectiveState_t"][@"hash_754563D60375E060"] )
			end
		}
	} ) --[[ @ 0]]
	...
	WhistleImage( PropHuntDivider, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4ABEA46F8DE7F02F"]], function ( f7_arg0 )
...
CoD.ScoreInfo_Timer.__resetProperties = function ( f19_arg0 )
	...
	f19_arg0.GameTimerSeconds:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f19_arg0.GameTimer2:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
...
CoD.ScoreInfo_Timer.__clipsPerState = {
	...
	HardpointTimeLow = {
		DefaultClip = function ( f26_arg0, f26_arg1 )
			...
			f26_arg0.GameTimer2:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	DepositTimeLow = {
		DefaultClip = function ( f31_arg0, f31_arg1 )
			...
			f31_arg0.GameTimer2:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	TimeLow = {
		DefaultClip = function ( f42_arg0, f42_arg1 )
			...
			f42_arg0.GameTimerSeconds:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
