	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f4_local0 then
					f4_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg1, "playerAbilities.playerGadget1.state", Enum[@"weapongadgetstates"][@"player_ability_state_inuse"] ) --[[ @ 0]]
					if f4_local0 then
						f4_local0 = not Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_player_dead"] ) --[[ @ 0]]
					end
				end
				return f4_local0
			end
