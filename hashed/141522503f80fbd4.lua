	...
	if not IsInGame() then
		...
		if not f2_local0.__breadcrumbTasks then
			...
			f2_local0.__breadcrumbTaskTimer = LUI.UITimer.newElementTimer( 0, false, function ()
				local f3_local0 = Engine[@"getdvarint"]( @"hash_285F070D3156AF02" ) --[[ @ 0]]
				if f3_local0 <= 0 then
					f3_local0 = 1 --[[ @ 0]]
				end
				for f3_local1 = 1 --[[ @ 0]], math.min( #f2_local0.__breadcrumbTasks, f3_local0 ), 1 do
					...
					Engine[@"beginpixevent"]( "Breadcrumb: " .. f3_local5 ) --[[ @ 0]]
...
CoD.BreadcrumbUtility.GetStorageLoadoutBufferForPlayer = function ( f11_arg0, f11_arg1 )
	...
	local f11_local0 = Enum[@"storagefiletype"][@"storage_mp_loadouts"] --[[ @ 0]]
	if f11_arg1 == Enum[@"emodes"][@"mode_zombies"] then
		f11_local0 = Enum[@"storagefiletype"][@"storage_zm_loadouts"] --[[ @ 0]]
	elseif f11_arg1 == Enum[@"emodes"][@"mode_warzone"] then
		f11_local0 = Enum[@"storagefiletype"][@"storage_wz_loadouts"] --[[ @ 0]]
	end
...
CoD.BreadcrumbUtility.UpdateEmblemOwnedAndCheckIfSeenStat = function ( f15_arg0, f15_arg1, f15_arg2 )
	if not CoD.BreadcrumbUtility.AreBreadcrumbsEnabled() then
		...
		if f15_local0 and f15_local0[@"icon_owned"] and f15_local0[@"icon_owned"][f15_arg2] then
			f15_local0[@"icon_owned"][f15_arg2]:set( CoD.BreadcrumbUtility.ItemOwnedValue ) --[[ @ 0]]
...
CoD.BreadcrumbUtility.UpdateOwnedCallingCardsAndCount = function ( f51_arg0, f51_arg1, f51_arg2 )
	...
	if IsLive() and f51_arg2 == "loot" then
		...
		elseif f51_arg2 == "mp" then
			f51_local0 = CoD.ChallengesUtility.GetChallengeCardsForSessionMode( f51_arg1, Enum[@"emodes"][@"mode_multiplayer"], f51_arg2, false ) --[[ @ 0]]
		elseif f51_arg2 == "zm" then
			f51_local0 = CoD.ChallengesUtility.GetChallengeCardsForSessionMode( f51_arg1, Enum[@"emodes"][@"mode_zombies"], f51_arg2, false ) --[[ @ 0]]
		elseif f51_arg2 == "wz" then
			f51_local0 = CoD.ChallengesUtility.GetChallengeCardsForSessionMode( f51_arg1, Enum[@"emodes"][@"mode_warzone"], f51_arg2, false ) --[[ @ 0]]
...
CoD.BreadcrumbUtility.UpdateSprayGestureNewCountTable = function ( f52_arg0, f52_arg1, f52_arg2 )
	...
	for f52_local8, f52_local9 in ipairs( CoD.BreadcrumbUtility.GetSprayGestureTable() ) --[[ @ 0]] do
		local f52_local10 = f52_local9[@"assetname"] --[[ @ 0]]
		if CoD.BreadcrumbUtility.IsStatSpecialistSprayGestureNew( f52_arg0, f52_arg1, f52_local8 ) and CoDShared.IsNotLootItemOrIsOwnedById( f52_arg1, f52_local10 ) then
			...
			if CoD.PlayerRoleUtility.AllowSprayOrGesture( f52_arg1, f52_local9, f52_local5 ) then
				local f52_local6 = f52_local9[@"entitlement"] --[[ @ 0]]
				if f52_local6 then
					f52_local6 = f52_local9[@"entitlement"] ~= @"hash_0" --[[ @ 0]]
				end
				local f52_local7 = f52_local9[@"isdefault"] --[[ @ 0]]
				if f52_local7 then
					f52_local7 = f52_local9[@"isdefault"] == 1 --[[ @ 0]]
				end
...
CoD.BreadcrumbUtility.GetAccessoryNewCountForWeapon = function ( f53_arg0, f53_arg1, f53_arg2 )
	...
	if f53_local2 then
		for f53_local7, f53_local8 in ipairs( f53_local2 ) --[[ @ 0]] do
			local f53_local9 = CoD.BlackMarketTableUtility.LootInfoLookup( f53_arg1, f53_local8[@"lootid"], f53_local8[@"entitlement"], f53_local3 ) --[[ @ 0]]
...
CoD.BreadcrumbUtility.GetDeathFxNewCountForWeapon = function ( f54_arg0, f54_arg1, f54_arg2 )
	...
	if f54_local2 then
		for f54_local7, f54_local8 in ipairs( f54_local2 ) --[[ @ 0]] do
			local f54_local9 = CoD.BlackMarketTableUtility.LootInfoLookup( f54_arg1, f54_local8[@"lootid"], f54_local8[@"entitlement"], f54_local3 ) --[[ @ 0]]
		...
		if f55_local1 then
			for f55_local7, f55_local8 in ipairs( f55_local1 ) --[[ @ 0]] do
				...
				if not f55_local5 then
					f55_local5 = Engine[@"converttoxhash"]( "reticle_" .. f55_arg0._attachmentRef .. "_" .. f55_local8.reticleIndex ) --[[ @ 0]]
				end
	...
	if f58_arg2 ~= nil then
		for f58_local9, f58_local10 in ipairs( f58_arg2 ) --[[ @ 0]] do
			...
			if f58_local10 and f58_local10.ref and f58_local10.ref:get() then
				f58_local4 = Engine[@"converttoxhash"]( f58_local10.ref:get() ) --[[ @ 0]]
				...
				elseif f58_local4 then
					...
					local f58_local6 = Engine[@"tablelookup"]( CoD.attachmentTable, Enum[@"attachmenttablecolumn_e"][@"attachmenttable_column_entitlement_name"], Enum[@"attachmenttablecolumn_e"][@"hash_2419575E672F6FA2"], f58_local4 ) --[[ @ 0]]
					local f58_local7 --[[ @ 0]]
					if f58_local4 then
...
DataSourceHelpers.PerControllerDataSourceSetup( "CharacterBreadcrumbs", "Breadcrumbs.characters", function ( f115_arg0, f115_arg1 )
	...
	if f115_local0 ~= Enum[@"emodes"][@"mode_invalid"] and not IsInGame() and not IsLobbyNetworkModeLAN() then
		...
		local f115_local4 = {} --[[ @ 0]]
		for f115_local5 = 0 --[[ @ 0]], Enum[@"emodes"][@"mode_count"] - 1, 1 do
				...
				if f115_local16 and f115_local16.bodyIndex then
					...
					if CoD.PlayerRoleUtility.IsRoleUnlocked( f115_arg1, f115_local0, f115_local11 ) then
						...
						if f115_local0 == Enum[@"emodes"][@"mode_warzone"] then
							local f115_local15 = Engine[@"getpositionrolebundleinfo"]( f115_local0, f115_local11 ) --[[ @ 0]]
							if f115_local15[@"isdefaultcharacter"] ~= 1 then
								CoD.BreadcrumbUtility.AddChildCountLink( f115_arg1, f115_local4[f115_local15[@"modecategory"]], f115_local13 ) --[[ @ 0]]
							end
						end
	...
	updateJumpkitBreadcrumbs = function ( f126_arg0, f126_arg1 )
		if Engine[@"currentsessionmode"]() == Enum[@"emodes"][@"mode_warzone"] then
			CoD.BreadcrumbUtility.QueueBreadcrumbTask( f126_arg0, "updateJumpkitBreadcrumbs ", function ()
				...
				local f127_local1 = Enum[@"emodes"][@"mode_warzone"] --[[ @ 0]]
				local f127_local3 = {
				...
				if f127_local4 then
					for f127_local11, f127_local12 in ipairs( f127_local4 ) --[[ @ 0]] do
						local f127_local13, f127_local14 = CoD.BlackMarketTableUtility.SimpleLootLookup( f126_arg0, f127_local12[@"lootid"], f127_local12[@"entitlement"] ) --[[ @ 0]]
...
DataSourceHelpers.PerControllerDataSourceSetup( "EmblemCallingCardBreadcrumbs", "Breadcrumbs", function ( f136_arg0, f136_arg1 )
	local f136_local0 = Enum[@"emodes"][@"mode_multiplayer"] --[[ @ 0]]
...
DataSourceHelpers.PerControllerDataSourceSetup( "LoadoutBreadcrumbs", "Breadcrumbs", function ( f144_arg0, f144_arg1 )
	...
	if f144_local1 and f144_local1:get() == true then
		f144_local0 = Enum[@"emodes"][@"mode_multiplayer"] --[[ @ 0]]
	end
	local f144_local2 = {
