...
CoD.PC_Prestige_Scrollbar = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.PC_Prestige_Scrollbar.__defaultWidth = 1215 --[[ @ 0]]
CoD.PC_Prestige_Scrollbar.__defaultHeight = 528 --[[ @ 0]]
CoD.PC_Prestige_Scrollbar.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.PC_Prestige_Scrollbar ) --[[ @ 0]]
	self.id = "PC_Prestige_Scrollbar" --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( PCArrowR, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "MOUSE1", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( PCArrowL, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "MOUSE1", function ( element, menu, controller, model )
		PlaySoundAlias( "uin_list_horizontal_generic" ) --[[ @ 0]]
		CoD.PrestigeUtility.UpdateCurrentTargetIndex( self, controller, menu, true ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
...
CoD.PC_Prestige_Scrollbar.__clipsPerState = {
	...
	AtLeftAndRight = {
		DefaultClip = function ( f18_arg0, f18_arg1 )
			...
			f18_arg0.leftArrow:completeAnimation() --[[ @ 0]]
			f18_arg0.leftArrow:setAlpha( 0.05 ) --[[ @ 0]]
			f18_arg0.clipFinished( f18_arg0.leftArrow ) --[[ @ 0]]
			...
			f18_arg0.PCArrowL:completeAnimation() --[[ @ 0]]
			f18_arg0.PCArrowL:setAlpha( 0.02 ) --[[ @ 0]]
			f18_arg0.clipFinished( f18_arg0.PCArrowL ) --[[ @ 0]]
		end
	},
	AtLeft = {
	...
	AtRight = {
		DefaultClip = function ( f20_arg0, f20_arg1 )
			...
			f20_arg0.rightArrow:setAlpha( 0.05 ) --[[ @ 0]]
			f20_arg0.clipFinished( f20_arg0.rightArrow ) --[[ @ 0]]
			f20_arg0.PCArrowR:completeAnimation() --[[ @ 0]]
			f20_arg0.PCArrowR:setAlpha( 0.02 ) --[[ @ 0]]
			f20_arg0.clipFinished( f20_arg0.PCArrowR ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
