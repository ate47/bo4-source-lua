	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f4_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "team", Enum[@"team_t"][@"team_allies"] ) --[[ @ 0]]
				if f4_local0 then
		...
		},
		{
			stateName = "Axis",
			condition = function ( menu, element, event )
				local f5_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "team", Enum[@"team_t"][@"team_axis"] ) --[[ @ 0]]
				if f5_local0 then
