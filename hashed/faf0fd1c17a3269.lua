...
CoD.ReserveLarge.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	UltraCategory:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	Rarity:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	Rarity:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	mainExtraText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	OldSignaturesBonusExpBadge:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsCurrentMenu( menu, "PaintjobWeaponSelect" ) then
					...
					if f12_local0 then
						f12_local0 = CoD.ModelUtility.IsSelfModelValueEqualTo( self, f1_arg1, "itemCategory", @"hash_5CC13B0F8EEFF726" ) --[[ @ 0]]
					end
				else
					f12_local0 = false --[[ @ 0]]
				end
	...
	MK2BonusExpBadge:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsCurrentMenu( menu, "PaintjobWeaponSelect" ) then
					...
					if f17_local0 then
						f17_local0 = CoD.ModelUtility.IsSelfModelValueEqualTo( self, f1_arg1, "itemCategory", @"hash_7FB1719175C1461" ) --[[ @ 0]]
					end
				else
					f17_local0 = false --[[ @ 0]]
				end
