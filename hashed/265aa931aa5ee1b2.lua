...
CoD.Challenges_Scorestreaks = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.Challenges_Scorestreaks = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "Challenges_Scorestreaks", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	self:setClass( CoD.Challenges_Scorestreaks ) --[[ @ 0]]
	...
	MenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"challenge/scorestreaks" ) ) --[[ @ 0]]
	...
	SafeAreaWidget.FETabBar.Tabs.grid:setHorizontalCount( 6 ) --[[ @ 0]]
	SafeAreaWidget.FETabBar.Tabs.grid:setDataSource( "ScorestreaksTabs" ) --[[ @ 0]]
