...
require( "x64:6fb4ac1597b7dda8" ) --[[ @ 0]]
require( "x64:291b90da1df3a5f" ) --[[ @ 0]]

CoD.VehicleGround_ButtonPrompts_Left_Internal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.VehicleGround_ButtonPrompts_Left_Internal.__defaultWidth = 1400 --[[ @ 0]]
CoD.VehicleGround_ButtonPrompts_Left_Internal.__defaultHeight = 48 --[[ @ 0]]
CoD.VehicleGround_ButtonPrompts_Left_Internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.VehicleGround_ButtonPrompts_Left_Internal ) --[[ @ 0]]
	self.id = "VehicleGround_ButtonPrompts_Left_Internal" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	
	local Left4Btn = CoD.VehicleButtonPrompt.new( f1_arg0, f1_arg1, 0, 0, 0, 200, 0, 0, 0, 48 ) --[[ @ 0]]
	Left4Btn:linkToElementModel( self, "bindings.LEFT_4", false, function ( model )
		Left4Btn:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	self:addElement( Left4Btn ) --[[ @ 0]]
	self.Left4Btn = Left4Btn --[[ @ 0]]
	
	local Left3Btn = CoD.VehicleButtonPrompt.new( f1_arg0, f1_arg1, 0, 0, 200, 400, 0, 0, 0, 48 ) --[[ @ 0]]
	Left3Btn:linkToElementModel( self, "bindings.LEFT_3", false, function ( model )
		Left3Btn:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	LUI.OverrideFunction_CallOriginalFirst( Left3Btn, "setState", function ( element, controller, f5_arg2, f5_arg3, f5_arg4 )
		RecalculateScaleToElementWidth( self, self ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( Left3Btn ) --[[ @ 0]]
	self.Left3Btn = Left3Btn --[[ @ 0]]
	
	local Left2Btn = CoD.VehicleButtonPrompt.new( f1_arg0, f1_arg1, 0, 0, 400, 600, 0, 0, 0, 48 ) --[[ @ 0]]
	Left2Btn:linkToElementModel( self, "bindings.LEFT_2", false, function ( model )
		Left2Btn:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	LUI.OverrideFunction_CallOriginalFirst( Left2Btn, "setState", function ( element, controller, f7_arg2, f7_arg3, f7_arg4 )
		RecalculateScaleToElementWidth( self, self ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( Left2Btn ) --[[ @ 0]]
	self.Left2Btn = Left2Btn --[[ @ 0]]
	
	local Left1Btn = CoD.VehicleButtonPrompt.new( f1_arg0, f1_arg1, 0, 0, 600, 800, 0, 0, 0, 48 ) --[[ @ 0]]
	Left1Btn:linkToElementModel( self, "bindings.LEFT_1", false, function ( model )
		Left1Btn:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	LUI.OverrideFunction_CallOriginalFirst( Left1Btn, "setState", function ( element, controller, f9_arg2, f9_arg3, f9_arg4 )
		RecalculateScaleToElementWidth( self, self ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( Left1Btn ) --[[ @ 0]]
	self.Left1Btn = Left1Btn --[[ @ 0]]
	
	local Left0Btn = CoD.VehicleButtonPrompt.new( f1_arg0, f1_arg1, 0, 0, 800, 1000, 0, 0, 0, 48 ) --[[ @ 0]]
	Left0Btn:linkToElementModel( self, "bindings.LEFT_0", false, function ( model )
		Left0Btn:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	LUI.OverrideFunction_CallOriginalFirst( Left0Btn, "setState", function ( element, controller, f11_arg2, f11_arg3, f11_arg4 )
		RecalculateScaleToElementWidth( self, self ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( Left0Btn ) --[[ @ 0]]
	self.Left0Btn = Left0Btn --[[ @ 0]]
	
	local SwitchToDriverBtn = CoD.VehicleHoldSwitchSeat.new( f1_arg0, f1_arg1, 0, 0, 1000, 1200, 0, 0, 0, 48 ) --[[ @ 0]]
	SwitchToDriverBtn:linkToElementModel( self, nil, false, function ( model )
		SwitchToDriverBtn:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	SwitchToDriverBtn:linkToElementModel( self, "vehicleDriverStringOverrideRef", true, function ( model )
		...
		if f13_local0 ~= nil then
			SwitchToDriverBtn.label:setText( LocalizeToUpperString( f13_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	LUI.OverrideFunction_CallOriginalFirst( SwitchToDriverBtn, "setState", function ( element, controller, f14_arg2, f14_arg3, f14_arg4 )
		RecalculateScaleToElementWidth( self, self ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( SwitchToDriverBtn ) --[[ @ 0]]
	self.SwitchToDriverBtn = SwitchToDriverBtn --[[ @ 0]]
	
	local ExitVehicleBtn = CoD.VehicleHoldButtonPrompt.new( f1_arg0, f1_arg1, 0, 0, 1200, 1400, 0, 0, 0, 48 ) --[[ @ 0]]
...
CoD.VehicleGround_ButtonPrompts_Left_Internal.__onClose = function ( f19_arg0 )
	f19_arg0.Left4Btn:close() --[[ @ 0]]
	f19_arg0.Left3Btn:close() --[[ @ 0]]
	f19_arg0.Left2Btn:close() --[[ @ 0]]
	f19_arg0.Left1Btn:close() --[[ @ 0]]
	f19_arg0.Left0Btn:close() --[[ @ 0]]
	f19_arg0.SwitchToDriverBtn:close() --[[ @ 0]]
	f19_arg0.ExitVehicleBtn:close() --[[ @ 0]]
end
 --[[ @ 0]]
