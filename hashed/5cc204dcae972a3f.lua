...
CoD.PaintjobOptionGrid.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( paintjobsList, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		...
		elseif IsZombies() and not CoD.ModelUtility.IsSelfModelPathValueEqualTo( element, controller, "ref", "paintjob_create" ) and not CoD.WeaponOptionsUtility.IsWeaponOptionEquipped( menu, element, controller, "paintjobSlot" ) then
			...
			return true
		elseif CoD.ModelUtility.IsSelfModelPathValueEqualTo( element, controller, "ref", "paintjob_create" ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_4DFFD9B8A1D5E6D4", nil, nil ) --[[ @ 0]]
			return true
		elseif IsZombies() and CoD.WeaponOptionsUtility.IsWeaponOptionEquipped( menu, element, controller, "paintjobSlot" ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_6D0BB36CD318F55F", nil, nil ) --[[ @ 0]]
			return true
	...
	f1_arg0:AddButtonCallbackFunction( paintjobsList, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
	...
	paintjobsList:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
