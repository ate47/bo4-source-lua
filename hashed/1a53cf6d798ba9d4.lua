...
CoD.Waypoint_ContestedArrowWidget = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.Waypoint_ContestedArrowWidget.__defaultWidth = 24 --[[ @ 0]]
CoD.Waypoint_ContestedArrowWidget.__defaultHeight = 24 --[[ @ 0]]
CoD.Waypoint_ContestedArrowWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.Waypoint_ContestedArrowWidget ) --[[ @ 0]]
	self.id = "Waypoint_ContestedArrowWidget" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local Arrow4 = LUI.UIImage.new( 0, 0, 64, 128, 0, 0, -4, 28 ) --[[ @ 0]]
	...
	local Arrow3 = LUI.UIImage.new( 0, 0, 42, 74, 0, 0, -4, 28 ) --[[ @ 0]]
	...
	local Arrow2 = LUI.UIImage.new( 0, 0, 21, 53, 0, 0, -4, 28 ) --[[ @ 0]]
