...
CoD.prestigeRewardWidget_UI3D = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.prestigeRewardWidget_UI3D.__defaultWidth = 187 --[[ @ 0]]
CoD.prestigeRewardWidget_UI3D.__defaultHeight = 37 --[[ @ 0]]
CoD.prestigeRewardWidget_UI3D.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.prestigeRewardWidget_UI3D ) --[[ @ 0]]
	self.id = "prestigeRewardWidget_UI3D" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	
	local digit1 = LUI.UIText.new( 0.5, 0.5, -94, -63, 0.5, 0.5, -19, 19 ) --[[ @ 0]]
	digit1:setTTF( "ttmussels_demibold" ) --[[ @ 0]]
	digit1:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	...
	digit2:setTTF( "ttmussels_demibold" ) --[[ @ 0]]
	digit2:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	...
	digit3:setTTF( "ttmussels_demibold" ) --[[ @ 0]]
	digit3:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	...
	digit4:setTTF( "ttmussels_demibold" ) --[[ @ 0]]
	digit4:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	...
	digit5:setTTF( "ttmussels_demibold" ) --[[ @ 0]]
	digit5:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	...
	digit6:setTTF( "ttmussels_demibold" ) --[[ @ 0]]
	digit6:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
