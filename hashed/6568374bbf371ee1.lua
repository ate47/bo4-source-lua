...
CoD.Challenges_Career = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.Challenges_Career = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "Challenges_Career", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	self:setClass( CoD.Challenges_Career ) --[[ @ 0]]
	...
	MenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_70C18F2AE62C195" ) ) --[[ @ 0]]
	...
	SafeAreaWidget.FETabBar.Tabs.grid:setDataSource( "CareerTabs" ) --[[ @ 0]]
