...
CoD.PCOptionsUtility.PreparePCOptionListFromExpanderAsset = function ( f4_arg0, f4_arg1 )
	...
	for f4_local4, f4_local5 in pairs( f4_arg1 ) --[[ @ 0]] do
		local f4_local6 = CoD.PCOptionsUtility.CreatePCOptionTableFromAsset( f4_arg0, Engine[@"hash_2E00B2F29271C60B"]( Engine[@"hash_1C53F8D38DF9042B"]( f4_local5[@"hash_7C26A1C9201BF12F"] ) ) ) --[[ @ 0]]
		if f4_local6 then
...
CoD.PCOptionsUtility.PrepareCategoryListFromAsset = function ( f5_arg0, f5_arg1 )
	...
	for f5_local6, f5_local7 in ipairs( f5_local1 ) --[[ @ 0]] do
		if f5_local7[@"hash_19C678A18C0948A1"] == 1 then
			table.insert( f5_local0, {
				models = {
					name = f5_local7[@"hash_455F116BF695C8F6"],
...
CoD.PCOptionsUtility.CreatePCOptionTableFromAsset = function ( f8_arg0, f8_arg1 )
	if f8_arg1 and not CoD.OptionsUtility.ExcludeOption( f8_arg0, f8_arg1 ) then
		...
		elseif f8_arg1[@"hash_23F5AD2205070F2E"] == 1 then
			...
			return CoD.PCOptionsUtility.MakeKeybindTable( f8_arg0, f8_arg1[@"hash_455F116BF695C8F6"], f8_local0, f8_arg1[@"hash_7E4CF24FFB07F9A2"], f8_arg1[@"hash_7B092C1CAD1F6A32"], f8_arg1[@"hash_2ABB4544CC59EA03"], f8_arg1[@"hash_245C555A23CB4AE"] )
		elseif f8_arg1[@"hash_39A5811D217C6EA1"] == 1 then
			return CoD.PCOptionsUtility.CreateEmptySeparator( f8_arg0 )
		end
		local f8_local0 = nil --[[ @ 0]]
		local f8_local1 = f8_arg1[@"hash_66E183377E0C37F4"] --[[ @ 0]]
		if f8_local1 then
			f8_local1 = Engine[@"hash_1C53F8D38DF9042B"]( f8_arg1[@"hash_66E183377E0C37F4"] ) --[[ @ 0]]
		end
		...
		local f8_local4 = {} --[[ @ 0]]
		local f8_local5 = {} --[[ @ 0]]
		local f8_local6 = f8_arg1[@"hash_455F116BF695C8F6"] --[[ @ 0]]
		if not f8_local6 then
			f8_local6 = @"hash_0" --[[ @ 0]]
		end
		f8_local5.name = f8_local6 --[[ @ 0]]
		f8_local5.desc = f8_local3 --[[ @ 0]]
		f8_local5.image = f8_arg1[@"hash_245C555A23CB4AE"] --[[ @ 0]]
		...
		if f8_local1 then
			...
			if f8_arg1.option_dependencies then
				...
				for f8_local10, f8_local11 in ipairs( f8_arg1.option_dependencies ) --[[ @ 0]] do
					f8_local11[@"hash_2409E4C67236C70F"] = Engine[@"hash_1C53F8D38DF9042B"]( f8_local11[@"hash_2409E4C67236C70F"] ) --[[ @ 0]]
					local f8_local12 = f8_local11[@"hash_2409E4C67236C70F"] --[[ @ 0]]
				...
				if #f8_local5 > 0 then
					...
					f8_local6.unavailableFunction = function ( f9_arg0 )
						...
						for f9_local5, f9_local6 in ipairs( f8_local5 ) --[[ @ 0]] do
							local f9_local7 = CoD.PCOptionsUtility.GetCurrentOptionValue( f9_local6[@"hash_2409E4C67236C70F"], f9_arg0 ) --[[ @ 0]]
							local f9_local8 = f9_local6[@"hash_568600B190E05ED"] --[[ @ 0]]
		...
		if f8_arg1[@"hash_3A37009BD8B9445C"] == 1 and f8_arg1[@"hash_58CB8A755382AF5D"] == "StartMenu_Options_CoDAccount_CTA" then
		...
		if f8_arg1[@"hash_4C90BD2A41B080F5"] == 1 then
			f8_local4.models.unavailableFunction = function ()
				return true
			end
			 --[[ @ 0]]
		...
		if f8_arg1[@"hash_715A0D9812F3D286"] == 1 then
			...
			if f8_local1 then
				...
				f8_local6 = f8_arg1[@"hash_763B3C67E28785EC"] --[[ @ 0]]
				if not f8_local6 then
					f8_local6 = 0 --[[ @ 0]]
				end
				f8_local5.minValue = f8_local6 --[[ @ 0]]
				f8_local5 = f8_local4.models --[[ @ 0]]
				f8_local6 = f8_arg1[@"hash_41FE13CC0DCFA646"] --[[ @ 0]]
				if not f8_local6 then
					f8_local6 = 1 --[[ @ 0]]
				end
				...
				if not f8_local6 then
					f8_local6 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_25BE4D02B20F370A" ) --[[ @ 0]]
				end
				f8_local5.toggleOnString = f8_local6 --[[ @ 0]]
				f8_local5 = f8_local4.models --[[ @ 0]]
				f8_local6 = f8_arg1[@"hash_7E511B9A41A891A3"] --[[ @ 0]]
				if not f8_local6 then
					f8_local6 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_317857948FC2CCFC" ) --[[ @ 0]]
				end
		...
		elseif f8_arg1[@"hash_4C97F4CCEE4EFEB7"] == 1 then
			...
			if f8_local1 then
				f8_local5 = f8_local4.models --[[ @ 0]]
				f8_local6 = f8_arg1[@"hash_4B5A1CBBE01A23F3"] --[[ @ 0]]
				if not f8_local6 then
					f8_local6 = 0 --[[ @ 0]]
				end
				f8_local5.minValue = f8_local6 --[[ @ 0]]
		...
		elseif f8_arg1[@"hash_36145412E62302A1"] == 1 then
			...
			if f8_local1 then
				...
				f8_local5 = f8_arg1[@"hash_66E183377E0C37F4"] .. "Values" --[[ @ 0]]
		...
		elseif f8_arg1[@"hash_60C196D6034CA07F"] == 1 then
			f8_local6 = CoD.PCOptionsUtility.CreatePCOptionTableFromAsset( f8_arg0, Engine[@"hash_2E00B2F29271C60B"]( Engine[@"hash_1C53F8D38DF9042B"]( f8_arg1[@"hash_789A4DE9FEE4913"] ) ) ) --[[ @ 0]]
			if not f8_local6 then
				return nil
			end
			...
			local f8_local7 = f8_arg1[@"hash_66E183377E0C37F4"] .. "Values" --[[ @ 0]]
		...
		elseif f8_arg1[@"hash_19C678A18C0948A1"] == 1 then
			f8_local5 = CoD.PCOptionsUtility.CreatePCOptionCategorySeparator --[[ @ 0]]
			f8_local6 = f8_arg0 --[[ @ 0]]
			local f8_local7 = f8_arg1[@"hash_A9944DEDBF80E87"] --[[ @ 0]]
			if not f8_local7 then
				f8_local7 = 0 --[[ @ 0]]
			end
			local f8_local8 = f8_arg1[@"hash_455F116BF695C8F6"] --[[ @ 0]]
		...
		elseif f8_arg1[@"hash_3A37009BD8B9445C"] == 1 then
			...
			f8_local4.models.openMenuName = f8_arg1[@"hash_58CB8A755382AF5D"] --[[ @ 0]]
		else
...
CoD.PCOptionsUtility.GetMonitorOptions = function ( f34_arg0 )
	local f34_local0 = {} --[[ @ 0]]
	local f34_local1 = Dvar[@"hash_4B5360289B81FB4F"]:get() --[[ @ 0]]
...
CoD.PCOptionsUtility.GetScreenResolutions = function ( f35_arg0 )
	...
	if CoD.PCOptionsUtility.GetCurrentOptionValue( @"r_fullscreen", f35_arg0 ) == 0 then
		...
		if f35_local2 > Dvar[@"hash_4B5360289B81FB4F"]:get() then
			f35_local2 = 0 --[[ @ 0]]
		end
...
CoD.PCOptionsUtility.GetRefreshRateOptions = function ( f39_arg0 )
	...
	if f39_local3 > Dvar[@"hash_4B5360289B81FB4F"]:get() then
		f39_local3 = 0 --[[ @ 0]]
	end
...
CoD.PCOptionsUtility.GetDisplayGammaModelOptions = function ( f41_arg0 )
	local f41_local0 = {} --[[ @ 0]]
	local f41_local1 = Dvar[@"hash_5AAA15D9B94E876A"]:getDomainEnumStrings() --[[ @ 0]]
	local f41_local2 = {} --[[ @ 0]]
...
CoD.PCOptionsUtility.SpecialProfileDefaults = {
	[@"hash_3822BC17B9C05B55"] = {
		get = function ( f68_arg0 )
			return tonumber( Engine[@"GetProfileVarInt"]( f68_arg0, @"hash_3822BC17B9C05B55" ) )
		end,
		apply = function ( f69_arg0, f69_arg1 )
			Engine[@"SetProfileVar"]( f69_arg0, @"hash_3822BC17B9C05B55", f69_arg1 ) --[[ @ 0]]
	...
	[@"hash_4F0960B187602076"] = {
		get = function ( f80_arg0 )
			return CoD.PCOptionsUtility.LinearMapFromTo( math.abs( Dvar[@"hash_68045F57217A8E71"]:get() ), 0, 0.04, 0.1, 2 )
		end,
		apply = function ( f81_arg0, f81_arg1 )
			local f81_local0 = Dvar[@"hash_68045F57217A8E71"]:get() --[[ @ 0]]
			Dvar[@"hash_68045F57217A8E71"]:set( f81_local0 / math.abs( f81_local0 ) * CoD.PCOptionsUtility.LinearMapFromTo( f81_arg1, 0.1, 2, 0, 0.04 ) ) --[[ @ 0]]
		end
	},
	[@"hash_7F0FB2125D28A0C0"] = {
		get = function ( f82_arg0 )
			if Dvar[@"hash_68045F57217A8E71"]:get() < 0 then
				return -1
			else
				return 1
			end
		...
		apply = function ( f83_arg0, f83_arg1 )
			Dvar[@"hash_68045F57217A8E71"]:set( f83_arg1 * math.abs( Dvar[@"hash_68045F57217A8E71"]:get() ) ) --[[ @ 0]]
		end
	},
	[@"hash_4F1BFEB2452744FE"] = {
		get = function ( f84_arg0 )
			local f84_local0 = Dvar[@"hash_4F1BFEB2452744FE"]:get() --[[ @ 0]]
			local f84_local1 = Dvar[@"hash_6EA85F8276AE6F39"]:get() --[[ @ 0]]
		...
		apply = function ( f85_arg0, f85_arg1 )
			if f85_arg1 == 0 then
				Dvar[@"hash_4F1BFEB2452744FE"]:latch( false ) --[[ @ 0]]
			elseif f85_arg1 == 1 then
				Dvar[@"hash_4F1BFEB2452744FE"]:latch( true ) --[[ @ 0]]
				Dvar[@"hash_6EA85F8276AE6F39"]:latch( 0 ) --[[ @ 0]]
			elseif f85_arg1 == 2 then
				Dvar[@"hash_4F1BFEB2452744FE"]:latch( true ) --[[ @ 0]]
				Dvar[@"hash_6EA85F8276AE6F39"]:latch( 2 ) --[[ @ 0]]
			elseif f85_arg1 == 3 then
				Dvar[@"hash_4F1BFEB2452744FE"]:latch( true ) --[[ @ 0]]
				Dvar[@"hash_6EA85F8276AE6F39"]:latch( 3 ) --[[ @ 0]]
			end
		end
	},
	[@"hash_3007F3D0B2A87CE0"] = {
	...
	[@"hash_4A9B3F99F070C094"] = {
		getOptions = function ( f88_arg0 )
			return CoD.PCOptionsUtility.GetAvailableDisplayAdapters( f88_arg0 )
		end
	},
	[@"hash_6075FAB09C00BEF8"] = {
		get = function ( f89_arg0 )
			return tonumber( Dvar[@"hash_442B9136D7EB8906"]:get() )
		end,
		apply = function ( f90_arg0, f90_arg1 )
			Dvar[@"hash_442B9136D7EB8906"]:set( f90_arg1 ) --[[ @ 0]]
		end
	},
	[@"hash_3067CC3ACAB147B9"] = {
		get = function ( f91_arg0 )
			local f91_local0 = Dvar[@"hash_30880C893C1C3B86"]:get() == true --[[ @ 0]]
			local f91_local1 = nil --[[ @ 0]]
			if CoD.PCOptionsUtility.ChangedOptionsList[@"hash_3067CC3ACAB147B9"] == nil then
				f91_local1 = Dvar[@"hash_3067CC3ACAB147B9"]:get() --[[ @ 0]]
			else
				f91_local1 = CoD.PCOptionsUtility.ChangedOptionsList[@"hash_3067CC3ACAB147B9"] --[[ @ 0]]
			end
		...
		apply = function ( f92_arg0, f92_arg1 )
			local f92_local0 = Dvar[@"hash_3067CC3ACAB147B9"] --[[ @ 0]]
	...
	[@"hash_40D1506D7E0D5B9"] = {
		...
		get = function ( f101_arg0 )
			local f101_local0 = Dvar[@"hash_40D1506D7E0D5B9"]:get() --[[ @ 0]]
	...
	[@"hash_66B2142845794848"] = {
		...
		get = function ( f105_arg0 )
			local f105_local0 = Dvar[@"hash_66B2142845794848"]:get() --[[ @ 0]]
	...
	[@"hash_360DAE1D26156AD3"] = {
		apply = function ( f108_arg0, f108_arg1 )
			Engine[@"SetProfileVar"]( f108_arg0, @"hash_360DAE1D26156AD3", f108_arg1 ) --[[ @ 0]]
	...
	[@"hash_3A65074E99DCE92F"] = {
		apply = function ( f110_arg0, f110_arg1 )
			Engine[@"SetProfileVar"]( f110_arg0, @"hash_3A65074E99DCE92F", f110_arg1 ) --[[ @ 0]]
	...
	[@"r_lightingsunshadowdisabledynamicdraw"] = {
		apply = function ( f114_arg0, f114_arg1 )
			...
			if 1 <= f114_arg1 then
				...
				if not f114_local0 then
					...
					Dvar[@"hash_6FDA5D20BF93E4D6"]:set( f114_local0 ) --[[ @ 0]]
					Dvar[@"hash_7584D68D5979628B"]:set( f114_local1 ) --[[ @ 0]]
		...
		get = function ( f115_arg0 )
			...
			if not Dvar[@"r_lightingsunshadowdisabledynamicdraw"]:get() then
				f115_local0 = 2 --[[ @ 0]]
			elseif Dvar[@"hash_6FDA5D20BF93E4D6"]:get() == 3 then
				f115_local0 = 1 --[[ @ 0]]
			end
			return f115_local0
		end
	},
	[@"hash_52A69EB47F9E465F"] = {
		get = function ( f116_arg0 )
			local f116_local0 = Dvar[@"hash_52A69EB47F9E465F"]:get() and 1 or 0 --[[ @ 0]]
		...
		apply = function ( f117_arg0, f117_arg1 )
			Dvar[@"hash_52A69EB47F9E465F"]:set( f117_arg1 == 1 ) --[[ @ 0]]
		end,
		unavailableFunction = function ( f118_arg0 )
			return not Engine[@"hash_1DFF1D0F8D75A972"]( f118_arg0 )
		end
	},
	[@"hash_48C156AE83C76D5E"] = {
		get = function ( f119_arg0 )
			return Dvar[@"hash_48C156AE83C76D5E"]:get() and 1 or 0
		end,
		apply = function ( f120_arg0, f120_arg1 )
			Dvar[@"hash_48C156AE83C76D5E"]:set( f120_arg1 == 1 ) --[[ @ 0]]
...
CoD.PCOptionsUtility.VRAMPredictOptionNames = {
	@"hash_210198A6861793FE",
	@"r_motionblurmode",
	@"hash_24B8757D7CB6ED3A",
	@"hash_3007F3D0B2A87CE0",
	@"r_picmip",
	@"hash_3067CC3ACAB147B9",
	@"hash_4F1BFEB2452744FE",
	@"r_ssr_enabled",
	@"r_fullscreen",
	@"hash_55A15D5A249FE0ED",
	@"hash_7A86ED746CA5D8E3",
	@"r_fullscreenmode",
	@"r_monitor",
	@"hash_E2E4C9FF8CB579E",
	@"hash_5D679AB6B6B38EFD"
} --[[ @ 0]]
...
CoD.PCOptionsUtility.PrepareVRAMBarUpdate = function ( f136_arg0 )
	...
	local f136_local6 = Engine[@"hash_BE57033070D5585"]( f136_local1, f136_local2, f136_local0[@"r_fullscreen"], f136_local0[@"r_monitor"], f136_local0[@"hash_55A15D5A249FE0ED"], f136_local0[@"hash_7A86ED746CA5D8E3"], f136_local0[@"hash_210198A6861793FE"], f136_local0[@"r_motionblurmode"], f136_local0[@"hash_24B8757D7CB6ED3A"], f136_local0[@"hash_3007F3D0B2A87CE0"], f136_local0[@"r_picmip"], f136_local0[@"hash_E2E4C9FF8CB579E"], f136_local0[@"hash_5D679AB6B6B38EFD"], f136_local0[@"hash_3067CC3ACAB147B9"], f136_local0[@"hash_4F1BFEB2452744FE"], f136_local0[@"r_motionblurmode"] > 0, f136_local0[@"r_ssr_enabled"] == 1, f136_local0[@"hash_24B8757D7CB6ED3A"] > 1, f136_local0[@"hash_4F1BFEB2452744FE"] > 0 ) --[[ @ 0]]
...
CoD.PCOptionsUtility.SyncVoiceModel = function ( f139_arg0 )
	CoD.PCOptionsUtility.SyncOptionModel( f139_arg0, @"hash_52A69EB47F9E465F" ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.PCOptionsUtility.SyncAudioDeviceModel = function ( f140_arg0 )
	local f140_local0 = CoD.PCOptionsUtility.GetOptionModel( f140_arg0, @"hash_66B2142845794848" ) --[[ @ 0]]
	if f140_local0 then
		Engine[@"ForceNotifyModelSubscriptions"]( f140_local0.refreshWidget ) --[[ @ 0]]
		CoD.PCOptionsUtility.SyncOptionModel( f140_arg0, @"hash_66B2142845794848" ) --[[ @ 0]]
	end
	local f140_local1 = CoD.PCOptionsUtility.GetOptionModel( f140_arg0, @"hash_40D1506D7E0D5B9" ) --[[ @ 0]]
	if f140_local1 then
		Engine[@"ForceNotifyModelSubscriptions"]( f140_local1.refreshWidget ) --[[ @ 0]]
		CoD.PCOptionsUtility.SyncOptionModel( f140_arg0, @"hash_40D1506D7E0D5B9" ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.PCOptionsUtility.RefreshVoiceChatTelemetryDisplay = function ( f141_arg0 )
	SetGlobalModelValue( "PCTelemetry.showVoiceSuspended", CoD.PCOptionsUtility.GetCurrentOptionValue( @"hash_48C156AE83C76D5E", f141_arg0 ) ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.PCOptionsUtility.IsVoiceOverflown = function ( f149_arg0 )
	local f149_local0 = Engine[@"hash_622EAAB59AA27E9B"]( "voiceBar_maxValue" ) --[[ @ 0]]
...
CoD.PCOptionsUtility.UpdateVoiceBar = function ( f150_arg0, f150_arg1, f150_arg2 )
	local f150_local0 = Engine[@"hash_622EAAB59AA27E9B"]( "voiceBar_recommendedValue" ) and Engine[@"hash_622EAAB59AA27E9B"]( "voiceBar_recommendedValue" ) or 50 --[[ @ 0]]
	local f150_local1 = Engine[@"hash_622EAAB59AA27E9B"]( "voiceBar_maxValue" ) and Engine[@"hash_622EAAB59AA27E9B"]( "voiceBar_maxValue" ) or 100 --[[ @ 0]]
...
CoD.PCOptionsUtility.InitializeVoiceBar = function ( f152_arg0, f152_arg1 )
	local f152_local0 = f152_arg1.DynamicBar:getWidth() * (Engine[@"hash_622EAAB59AA27E9B"]( "voiceBar_recommendedValue" ) and Engine[@"hash_622EAAB59AA27E9B"]( "voiceBar_recommendedValue" ) or 50) / (Engine[@"hash_622EAAB59AA27E9B"]( "voiceBar_maxValue" ) and Engine[@"hash_622EAAB59AA27E9B"]( "voiceBar_maxValue" ) or 100) --[[ @ 0]]
