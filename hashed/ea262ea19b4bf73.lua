...
CoD.StartMenu_Options_Frame_Warzone = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.StartMenu_Options_Frame_Warzone.__defaultWidth = 1920 --[[ @ 0]]
CoD.StartMenu_Options_Frame_Warzone.__defaultHeight = 890 --[[ @ 0]]
CoD.StartMenu_Options_Frame_Warzone.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.StartMenu_Options_Frame_Warzone ) --[[ @ 0]]
	self.id = "StartMenu_Options_Frame_Warzone" --[[ @ 0]]
	...
	OptionGroups:setTopBottom( 0, 0, 0, 830 ) --[[ @ 0]]
	OptionGroups:setWidgetType( CoD.StartMenu_Options_SettingSlider_Wrapper ) --[[ @ 0]]
	OptionGroups:setVerticalCount( 15 ) --[[ @ 0]]
	OptionGroups:setSpacing( 10 ) --[[ @ 0]]
	OptionGroups:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	OptionGroups:setVerticalCounter( CoD.verticalCounter ) --[[ @ 0]]
	OptionGroups:setDataSource( "PlayerSettingsWarzoneList" ) --[[ @ 0]]
