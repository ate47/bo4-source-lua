...
CoD.EmblemEditorMaterialSwatch.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	materialSwatch:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( materialSwatch, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	Materials:setText( LocalizeToUpperString( @"hash_6E5BDA73054BDF29" ) ) --[[ @ 0]]
	Materials:setTTF( "ttmussels_demibold" ) --[[ @ 0]]
	Materials:setLetterSpacing( 6 ) --[[ @ 0]]
	Materials:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	Materials:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
