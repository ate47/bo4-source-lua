...
LUI.createMenu.EULA = function ( f1_arg0, f1_arg1 )
	...
	PCEULAButtons:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( PCEULAButtons, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_local11( f1_local12, f1_local13.CurrentEULAPage, function ( f18_arg0, f18_arg1 )
		CoD.Menu.UpdateButtonShownState( f18_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f18_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_249A252B20B48936"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local12 = self --[[ @ 0]]
	f1_local11 = self.subscribeToModel --[[ @ 0]]
	f1_local13 = DataSources.EULA.getModel( f1_arg0 ) --[[ @ 0]]
	f1_local11( f1_local12, f1_local13.MaxEULAPage, function ( f19_arg0, f19_arg1 )
		CoD.Menu.UpdateButtonShownState( f19_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_249A252B20B48936"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		...
		if not IsPC() then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_40BD872543F8A833", nil, "ui_confirm" ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"], "ESCAPE", function ( element, menu, controller, model )
		...
		if not IsPC() then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"], @"hash_1FD0A4EC72EF5F3F", nil, "ESCAPE" ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"], "ui_navleft", function ( element, menu, controller, model )
		...
		CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"], @"hash_6272B11A2E0CC67C", nil, "ui_navleft" ) --[[ @ 0]]
		if not CoD.LobbyUtility.IsFirstEULAPage( controller ) then
			return true
		else
			return false
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_249A252B20B48936"], "ui_navright", function ( element, menu, controller, model )
		...
		CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_249A252B20B48936"], @"hash_192878DD19A9AAD8", nil, "ui_navright" ) --[[ @ 0]]
		if not CoD.LobbyUtility.IsLastEULAPage( controller ) then
			return true
		else
			return false
