...
CoD.ZmAmmo_BGBCarouselItemInternalFactory.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	icon:linkToElementModel( self, "gum_idx", true, function ( model )
		...
		if f2_local0 ~= nil then
			icon:setImage( RegisterImage( GetItemImageFromIndex( Enum[@"hash_6EB546760F890D2"][@"hash_648CD0338EE0B3AE"], f2_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	clockOverlay:linkToElementModel( self, "gum_idx", true, function ( model )
		...
		if f3_local0 ~= nil then
			clockOverlay:setImage( RegisterImage( GetItemImageFromIndex( Enum[@"hash_6EB546760F890D2"][@"hash_648CD0338EE0B3AE"], f3_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not f6_local0 then
					f6_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"] ) --[[ @ 0]]
					if not f6_local0 then
						f6_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_5C57360571B0917E"] ) --[[ @ 0]]
					end
				end
				return f6_local0
			end
	...
	f1_local7 = ZMConsumableItemCountInGame.subscribeToModel --[[ @ 0]]
	f1_local8 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local7( f1_local6, f1_local8["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5C57360571B0917E"]], function ( f10_arg0 )
		f1_arg0:updateElementState( ZMConsumableItemCountInGame, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
