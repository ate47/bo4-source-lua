...
CoD.PCWidgetUtility.PrepareMainAltKeyBinder = function ( f38_arg0, f38_arg1, f38_arg2, f38_arg3, f38_arg4, f38_arg5 )
	...
	for f38_local4, f38_local5 in ipairs( {
		...
		f38_arg2:AddButtonCallbackFunction( f38_arg4, f38_arg1, Enum[@"luibutton"][@"lui_key_none"], f38_local5, f38_local0 ) --[[ @ 0]]
		f38_arg2:AddButtonCallbackFunction( f38_arg5, f38_arg1, Enum[@"luibutton"][@"lui_key_none"], f38_local5, f38_local0 ) --[[ @ 0]]
	end
...
CoD.PCWidgetUtility.CanShowMenuStyleChat = function ( f214_arg0 )
	...
	local f214_local2 = IsVisibilityBitSet( f214_arg0, Enum[@"uivisibilitybit"][@"bit_ui_active"] ) --[[ @ 0]]
...
CoD.PCWidgetUtility.ShowWhisperPlayer = function ( f253_arg0, f253_arg1, f253_arg2 )
	...
	local f253_local2 = Engine[@"isplayerblocked"]( f253_arg2 ) --[[ @ 0]]
	local f253_local3 --[[ @ 0]]
...
CoD.PCWidgetUtility.ShowBlockPlayer = function ( f254_arg0, f254_arg1, f254_arg2 )
	...
	if not (Engine[@"getxuid64"]( f254_arg0 ) == f254_arg2) and not Engine[@"isfriendfromxuid"]( f254_arg0, f254_arg2 ) then
		f254_local0 = not Engine[@"isplayerblocked"]( f254_arg2 ) --[[ @ 0]]
	else
		f254_local0 = false --[[ @ 0]]
	end
	return f254_local0
...
CoD.PCWidgetUtility.ShowUnblockPlayer = function ( f255_arg0, f255_arg1, f255_arg2 )
	...
	if not (Engine[@"getxuid64"]( f255_arg0 ) == f255_arg2) then
		f255_local0 = Engine[@"isplayerblocked"]( f255_arg2 ) --[[ @ 0]]
	else
		f255_local0 = false --[[ @ 0]]
	end
	return f255_local0
...
CoD.PCWidgetUtility.UpdatePlayerContextualMenuOptions = function ( f276_arg0, f276_arg1, f276_arg2 )
	...
	local f276_local6 = CoD.SocialUtility.GetFriendsButtonOptions( f276_arg2, nil, f276_local1, f276_local5, (f276_local0.battlenetPresence and f276_local0.battlenetPresence:get() or Engine[@"getbattlenetpresence"]( f276_local1 )) ~= Enum[@"hash_28811A60F2FF3ADA"][@"hash_5D7B6D45F00CF380"], true, f276_arg1.menuName ) --[[ @ 0]]
...
CoD.PCWidgetUtility.SetupChatFiltersButton = function ( f285_arg0, f285_arg1 )
	...
	f285_arg0:appendEventHandler( "leftmousedown", function ( f286_arg0, f286_arg1 )
		...
		if f286_local5 ~= nil then
			local f286_local9, f286_local10 = Engine[@"getscreensize"]( f286_arg1.controller ) --[[ @ 0]]
