...
CoD.GameEndScoreRoundListReverse = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.GameEndScoreRoundListReverse.__defaultWidth = 316 --[[ @ 0]]
CoD.GameEndScoreRoundListReverse.__defaultHeight = 74 --[[ @ 0]]
CoD.GameEndScoreRoundListReverse.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.GameEndScoreRoundListReverse ) --[[ @ 0]]
	self.id = "GameEndScoreRoundListReverse" --[[ @ 0]]
	...
	RoundPipList:setTopBottom( 0.5, 0.5, -24, 24 ) --[[ @ 0]]
	RoundPipList:setYRot( 180 ) --[[ @ 0]]
	RoundPipList:setWidgetType( CoD.GameEndScoreRoundPip ) --[[ @ 0]]
	RoundPipList:setSpacing( 47 ) --[[ @ 0]]
	RoundPipList:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_local2 = self.subscribeToModel --[[ @ 0]]
	f1_local5 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local2( f1_local4, f1_local5["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f12_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local2 = self.subscribeToModel --[[ @ 0]]
	f1_local5 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local2( f1_local4, f1_local5["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_11CDCB451655ABCF"]], function ( f13_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local2 = self.subscribeToModel --[[ @ 0]]
	f1_local5 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local2( f1_local4, f1_local5["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f14_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local2 = self.subscribeToModel --[[ @ 0]]
	f1_local5 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local2( f1_local4, f1_local5["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"]], function ( f15_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	ShowNumber = {
		DefaultClip = function ( f18_arg0, f18_arg1 )
			...
			local f18_local0 = function ( f19_arg0 )
				f18_arg0.Score:beginAnimation( 450, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
				f18_arg0.Score:setAlpha( 1 ) --[[ @ 0]]
