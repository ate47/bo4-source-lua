...
CoD.AARTierRewardShowcaseInternalCoreRare = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCoreRare.__defaultWidth = 310 --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCoreRare.__defaultHeight = 632 --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCoreRare.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARTierRewardShowcaseInternalCoreRare ) --[[ @ 0]]
	self.id = "AARTierRewardShowcaseInternalCoreRare" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local CardRareMain = LUI.UIImage.new( 0.5, 0.5, -176, 176, 0.5, 0.5, -336, 336 ) --[[ @ 0]]
	CardRareMain:setImage( RegisterImage( @"uie_ui_menu_mtx_card_rare_main" ) ) --[[ @ 0]]
	self:addElement( CardRareMain ) --[[ @ 0]]
	self.CardRareMain = CardRareMain --[[ @ 0]]
	
	local BGPatternThick = LUI.UIImage.new( 0.5, 0.5, -160, 152, 0, 0, 23, 603 ) --[[ @ 0]]
	BGPatternThick:setAlpha( 0.62 ) --[[ @ 0]]
	BGPatternThick:setImage( RegisterImage( @"uie_ui_menu_common_mtx_button_bg_rare_thin" ) ) --[[ @ 0]]
	...
	GlowRimThickBorder:setAlpha( 0.08 ) --[[ @ 0]]
