...
LUI.createMenu.Main = function ( f1_arg0, f1_arg1 )
	...
	StartLabel:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_6A86639565BE5841"] ) --[[ @ 0]]
		return f3_local0
	end ) --[[ @ 0]]
	f1_local1:AddButtonCallbackFunction( StartLabel, f1_arg0, Enum[@"LUIButton"][@"hash_6A86639565BE5841"], nil, function ( element, menu, controller, model )
		SendButtonPressToMenu( menu, controller, model, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_6A86639565BE5841"], @"hash_0", nil, nil ) --[[ @ 0]]
		return false
	end, false ) --[[ @ 0]]
