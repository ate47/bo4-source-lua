...
CoD.WZTeamScoreboard.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	WZTeamScoreboard:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	PlayerColumnHeader( Column1Header, Column2Header["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"]], function ( f4_arg0, f4_arg1 )
	...
	f1_arg0:AddButtonCallbackFunction( WZTeamScoreboard, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		...
		if not IsScoreboardPlayerSelf( element, controller ) and IsScoreboardPlayerMuted( controller, element ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_39685D9366015DB", nil, nil ) --[[ @ 0]]
			return true
		elseif not IsScoreboardPlayerSelf( element, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_112FAB6BE7D9F2EA", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	PlayerColumnHeader:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_31995691035EAE4E" ) ) --[[ @ 0]]
	PlayerColumnHeader:setTTF( "0arame_mono_stencil" ) --[[ @ 0]]
	PlayerColumnHeader:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	PlayerColumnHeader:setAlignment( Enum[@"LUIAlignment"][@"hash_670510683C22104B"] ) --[[ @ 0]]
	...
	Column1Header:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	Column1Header:setAlignment( Enum[@"LUIAlignment"][@"hash_670510683C22104B"] ) --[[ @ 0]]
	...
	Column2Header:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	Column2Header:setAlignment( Enum[@"LUIAlignment"][@"hash_670510683C22104B"] ) --[[ @ 0]]
	...
	Column3Header:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	Column3Header:setAlignment( Enum[@"LUIAlignment"][@"hash_670510683C22104B"] ) --[[ @ 0]]
	...
	ColumnExtraHeader:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	ColumnExtraHeader:setAlignment( Enum[@"LUIAlignment"][@"hash_670510683C22104B"] ) --[[ @ 0]]
