...
CoD.LaboratoryListItemNebuliumPlasmaDiscount_Internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	Quantity:linkToElementModel( self, "displayName", true, function ( model )
		...
		if f11_local0 ~= nil then
			Quantity:setText( LocalizeIntoString( @"hash_79DB9C526E6370AB", f11_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	Discount:setAlignment( Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"] ) --[[ @ 0]]
	Discount:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	codpointCost:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
