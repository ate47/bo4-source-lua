...
LUI.createMenu.BountyHunterPackageSelect = function ( f1_arg0, f1_arg1 )
	...
	weaponCategoryList:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	PCBackButton.Button.ButtonContainer.Title:setText( LocalizeToUpperString( @"menu/back" ) ) --[[ @ 0]]
	PCBackButton.GamepadTitle:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/back" ) ) --[[ @ 0]]
