...
Lobby.MatchmakingPriority.OnMatchmakingPriorityQuit = function ( f1_arg0 )
	...
	if f1_local0[@"id"] == LobbyData.GetLobbyMenuIDByName( LuaEnum.UI.DIRECTOR_ONLINE_MP_PUBLIC ) then
		Lobby.MatchmakingPriority.AddHost( f1_arg0.hostSecId, Enum[@"JoinType"][@"hash_11375971BA46DA71"] ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
Lobby.MatchmakingPriority.GetSettings = function ()
	...
	local f2_local2 = 0 --[[ @ 0]]
	if Engine[@"hash_69882F293C327557"]() == LobbyData.GetLobbyMenuIDByName( LuaEnum.UI.DIRECTOR_ONLINE_MP_PUBLIC ) and Dvar[@"hash_3B7E7D205283F9AA"]:exists() then
		f2_local0 = Dvar[@"hash_3B7E7D205283F9AA"]:get() --[[ @ 0]]
		f2_local1 = Lobby.MatchmakingPriority.mpPublicGame --[[ @ 0]]
		f2_local2 = Dvar[@"hash_393504697ED9246D"]:get() --[[ @ 0]]
	end
...
Lobby.MatchmakingPriority.AddHost = function ( f3_arg0, f3_arg1 )
	...
	if f3_local0 == Lobby.MatchmakingPriority.SETTING.DISABLED then
		return 
	elseif f3_arg1 ~= Enum[@"JoinType"][@"hash_11375971BA46DA71"] then
		return 
	end
