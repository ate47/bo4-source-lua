...
require( "x64:48c7cd4f692e6a2c" ) --[[ @ 0]]

CoD.PCSocialMenu_DropDown_ItemList = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.PCSocialMenu_DropDown_ItemList.__defaultWidth = 364 --[[ @ 0]]
CoD.PCSocialMenu_DropDown_ItemList.__defaultHeight = 246 --[[ @ 0]]
CoD.PCSocialMenu_DropDown_ItemList.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.PCSocialMenu_DropDown_ItemList ) --[[ @ 0]]
	self.id = "PCSocialMenu_DropDown_ItemList" --[[ @ 0]]
	...
	ScrollView.View:setWidgetType( CoD.PC_SocialMenu_DropDownListItem ) --[[ @ 0]]
