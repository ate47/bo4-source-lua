...
CoD.freeCursorHeaderInfo.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_local8( f1_local7, f1_local9["ButtonBits." .. Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"]], function ( f6_arg0 )
		f1_arg0:updateElementState( cautionHint, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local8( f1_local7, f1_local9["ButtonBits." .. Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"]], function ( f14_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
