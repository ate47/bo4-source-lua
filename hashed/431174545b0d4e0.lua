...
LUI.createMenu.DirectorFirstTimeContentWarning = function ( f1_arg0, f1_arg1 )
	...
	CommomCenteredPopup.featureOverlayButtonMouseOnly.featureOverlayButtonContainer.Title:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/confirm" ) ) --[[ @ 0]]
	CommomCenteredPopup.TitleText:setText( LocalizeToUpperString( @"menu/content_filter" ) ) --[[ @ 0]]
	...
	PCOptionGroup:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	OptionTitle:setText( LocalizeToUpperString( @"menu/graphic_content" ) ) --[[ @ 0]]
