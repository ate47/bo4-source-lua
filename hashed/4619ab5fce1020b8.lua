...
LUI.createMenu.FileshareOptions = function ( f1_arg0, f1_arg1 )
	...
	SetGlobalModelValueArg( "fileshareRoot.deleteTask.state", Enum[@"FileshareTaskUIState"][@"hash_53D25EE7E8459854"] ) --[[ @ 0]]
	...
	self:subscribeToGlobalModel( f1_arg0, "GlobalModel", "fileshareRoot.deleteTask.state", function ( model )
		...
		if CoD.ModelUtility.IsGlobalModelValueEqualToEnum( "fileshareRoot.deleteTask.state", Enum[@"FileshareTaskUIState"][@"hash_6FE5B3BE5B00EEEA"] ) and CoD.ModelUtility.IsGlobalModelValueTrue( "fileshareRoot.deleteTask.success" ) then
