...
local PostLoadFunc = function ( self, controller, menu )
	...
	CoD.Menu.AddButtonCallbackFunction( menu, self, controller, Enum[@"LUIButton"][@"hash_1057783F8DA4AAEF"], "ui_navleft", function ( element, menu, controller, f10_arg3 )
	...
	CoD.Menu.AddButtonCallbackFunction( menu, self, controller, Enum[@"LUIButton"][@"hash_4571F08AD84807E0"], "ui_navright", function ( element, menu, controller, f11_arg3 )
		if not self.m_disableNavigation then
			if not self.m_beat then
				self:updateSlideDirection( 1 ) --[[ @ 0]]
				self:addElement( self.m_timer ) --[[ @ 0]]
...
CoD.StartMenu_Options_SliderBar.new = function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3, f12_arg4, f12_arg5, f12_arg6, f12_arg7, f12_arg8, f12_arg9 )
	...
	numeric:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_393E719493E9E18F" ) ) --[[ @ 0]]
	numeric:setTTF( "default" ) --[[ @ 0]]
	numeric:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
