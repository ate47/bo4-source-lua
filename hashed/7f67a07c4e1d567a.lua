...
LUI.createMenu.self_revive_visuals = function ( f1_arg0, f1_arg1 )
	...
	self_revive_progress_text:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	self_revive_progress_text:setAlignment( Enum[@"luialignment"][@"lui_alignment_bottom"] ) --[[ @ 0]]
