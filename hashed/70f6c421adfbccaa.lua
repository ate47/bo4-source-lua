...
CoD.horizontalCounterVerticalSpace = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.horizontalCounterVerticalSpace.__defaultWidth = 300 --[[ @ 0]]
CoD.horizontalCounterVerticalSpace.__defaultHeight = 37 --[[ @ 0]]
CoD.horizontalCounterVerticalSpace.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.horizontalCounterVerticalSpace ) --[[ @ 0]]
	self.id = "horizontalCounterVerticalSpace" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	self.onlyChildrenFocusable = true --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local currentItem = LUI.UIText.new( 0.5, 0.5, -57, -12, 0.5, 0.5, 6, 24 ) --[[ @ 0]]
	...
	local dividor = LUI.UIText.new( 0.5, 0.5, -4.5, 4.5, 0.5, 0.5, 6, 24 ) --[[ @ 0]]
	...
	local count = LUI.UIText.new( 0.5, 0.5, 12, 57, 0.5, 0.5, 6, 24 ) --[[ @ 0]]
	...
	local rightArrowBtn = CoD.listCounterButton.new( f1_arg0, f1_arg1, 0.5, 0.5, 50, 100, 0.5, 0.5, -10, 40 ) --[[ @ 0]]
	...
	rightArrowBtn:appendEventHandler( "input_source_changed", function ( f7_arg0, f7_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f7_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local5 = rightArrowBtn --[[ @ 0]]
	leftArrowBtn = rightArrowBtn.subscribeToModel --[[ @ 0]]
	f1_local7 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( rightArrowBtn, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	leftArrowBtn = CoD.listCounterButton.new( f1_arg0, f1_arg1, 0.5, 0.5, -99, -49, 0.5, 0.5, -10, 40 ) --[[ @ 0]]
	...
	leftArrowBtn:appendEventHandler( "input_source_changed", function ( f17_arg0, f17_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f17_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local7 = leftArrowBtn --[[ @ 0]]
	f1_local5 = leftArrowBtn.subscribeToModel --[[ @ 0]]
	f1_local8 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( leftArrowBtn, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		if IsGamepad( controller ) then
