...
CoD.Menu.ChangeFocusedElement = function ( f3_arg0, f3_arg1, f3_arg2, f3_arg3 )
	...
	if f3_arg2 ~= CoD.GetMouseFocus( f3_arg1 ) then
		...
		if IsMouseOrKeyboard( f3_arg1 ) and f3_arg0.buttonModel and f3_arg0.buttonModel[Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"]] and f3_arg0.buttonModel[Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"]].flags then
			f3_arg0.buttonModel[Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"]].flags:set( 0 ) --[[ @ 0]]
		end
		if f3_arg2 then
...
CoD.Menu.ChangeMouseCursorType = function ( f8_arg0, f8_arg1 )
	...
	if not f8_local0 or f8_local0.__forceCursorTypeNormal then
		Engine[@"SetMouseCursor"]( Enum[@"hash_30A6E5DCD01C0B57"][@"hash_17CEDA982668284"] ) --[[ @ 0]]
	elseif f8_local0.__xcamRotationWidget then
		Engine[@"SetMouseCursor"]( Enum[@"hash_30A6E5DCD01C0B57"][@"hash_68DDB59390F48283"] ) --[[ @ 0]]
	elseif CoD.PCUtility.HasContextualMenuActionInStack( f8_local0, f8_arg0, f8_arg1 ) then
		Engine[@"SetMouseCursor"]( Enum[@"hash_30A6E5DCD01C0B57"][@"hash_22BC29F6508402B0"] ) --[[ @ 0]]
	else
		Engine[@"SetMouseCursor"]( Enum[@"hash_30A6E5DCD01C0B57"][@"hash_4B16AEBDF3238E15"] ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.Menu.FreeCursorPositionUpdateFn = function ( f11_arg0, f11_arg1 )
	return function ( f12_arg0 )
		if not IsFreeCursorActiveAndVisible( f11_arg1 ) and IsGamepad( f11_arg1 ) then
			return 
		elseif f11_arg0.occludedBy or Engine[@"hash_4C55011C00F7272D"]( f11_arg1 ) or f11_arg0.ignoreCursor then
			return 
		...
		if f12_local2 and f12_local2.name then
			...
			if CoD.isPC and f12_local7 ~= nil and not f11_arg0.__ignoreNextMouseDrag then
				...
				local f12_local9 = CoD.BitUtility.IsBitwiseAndNonZero( f12_local8["KeyPressBits.MOUSE1"]:get(), Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) --[[ @ 0]]
				local f12_local10 = Engine[@"GetModelForController"]( f11_arg1 ) --[[ @ 0]]
				local f12_local11 = CoD.BitUtility.IsBitwiseAndNonZero( f12_local10["KeyPressBits.MOUSE2"]:get(), Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) --[[ @ 0]]
				local f12_local12 = Engine[@"GetModelForController"]( f11_arg1 ) --[[ @ 0]]
				if f12_local7.m_eventHandlers.leftmousedrag ~= nil and (f12_local9 or CoD.BitUtility.IsBitwiseAndNonZero( f12_local12.ButtonBits[Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"]]:get(), Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] )) then
...
CoD.Menu.MouseButtonCallbackFunction = function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
	...
	if not f13_local0( f13_arg2 ) then
		return false
	elseif f13_arg0.occludedBy or Engine[@"hash_4C55011C00F7272D"]( f13_arg1 ) or f13_arg0.ignoreCursor or f13_arg0.m_disableAllButtonActions then
		return false
	...
	local f13_local2 = CoD.BitUtility.IsBitwiseAndNonZero( f13_arg3:get(), Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) --[[ @ 0]]
	local f13_local3 = CoD.BitUtility.IsBitwiseAndNonZero( f13_arg3:get(), Enum[@"LUIButtonFlags"][@"hash_73DC8FC0E6AB543F"] ) --[[ @ 0]]
...
CoD.Menu.safeCreateMenu = function ( f22_arg0, f22_arg1, f22_arg2 )
	...
	Engine[@"hash_56E447857BE70BC1"]( "createMenu('" .. f22_arg0 .. "')" ) --[[ @ 0]]
...
CoD.Menu.OcclusionChange = function ( f26_arg0, f26_arg1 )
	...
	if f26_arg1.occluded then
		if not f26_arg0.occludedBy and Engine[@"hash_28069F5969D47DEF"]() then
...
CoD.Menu.AddButtonPromptModel = function ( f27_arg0, f27_arg1, f27_arg2, f27_arg3 )
	...
	if not f27_local0 then
		...
		Engine[@"SetModelValue"]( f27_local0, f27_arg3 or Enum[@"LUIButtonPromptStates"][@"hash_5901DFC093ED4187"] ) --[[ @ 0]]
	end
...
CoD.Menu.AddPCKeyPromptModel = function ( f28_arg0, f28_arg1, f28_arg2, f28_arg3 )
	...
	if not f28_local0 then
		...
		Engine[@"SetModelValue"]( f28_local0, f28_arg3 or Enum[@"LUIButtonPromptStates"][@"hash_5901DFC093ED4187"] ) --[[ @ 0]]
	end
...
CoD.Menu.SetButtonPromptState = function ( f29_arg0, f29_arg1, f29_arg2, f29_arg3 )
	if f29_arg0 and f29_arg0.buttonModel and f29_arg2 ~= Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] then
		...
		if f29_local0:set( f29_arg3 ) and f29_local0.flags then
			...
			if CoD.BitUtility.IsBitwiseAndNonZero( f29_local1, Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_72919C98A7A845F0"] ) or CoD.BitUtility.IsBitwiseAndNonZero( f29_local1, Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_771B04FAC5BE0E35"] ) then
...
CoD.Menu.UpdateButtonShownState = function ( f35_arg0, f35_arg1, f35_arg2, f35_arg3 )
	...
	local f35_local1 = Enum[@"LUIButtonPromptStates"][@"hash_C3FAFD8EBE94438"] --[[ @ 0]]
	if f35_arg1.showButtonDisabled and f35_arg1.showButtonDisabled[f35_arg3] then
		f35_local1 = Enum[@"LUIButtonPromptStates"][@"hash_242F62C12777D074"] --[[ @ 0]]
	end
	for f35_local6, f35_local7 in ipairs( f35_local0 ) --[[ @ 0]] do
		...
		if f35_local5 then
			f35_local1 = Enum[@"LUIButtonPromptStates"][@"hash_5901DFC093ED4187"] --[[ @ 0]]
			break
		elseif f35_local1 ~= Enum[@"LUIButtonPromptStates"][@"hash_242F62C12777D074"] and f35_local7.element and f35_local7.element.showButtonDisabled and f35_local7.element.showButtonDisabled[f35_arg3] then
			f35_local1 = Enum[@"LUIButtonPromptStates"][@"hash_242F62C12777D074"] --[[ @ 0]]
		end
	end
	if f35_local1 == Enum[@"LUIButtonPromptStates"][@"hash_5901DFC093ED4187"] and f35_arg1.occludedBy and f35_arg1.occludedBy.animateInFromOffset then
		f35_local1 = Enum[@"LUIButtonPromptStates"][@"hash_242F62C12777D074"] --[[ @ 0]]
	end
...
CoD.Menu.SetButtonLabel = function ( f36_arg0, f36_arg1, f36_arg2, f36_arg3, f36_arg4 )
	...
	if f36_arg1 ~= Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] and f36_local0 then
		local f36_local1 = f36_local0.Label --[[ @ 0]]
		if f36_local1 then
			if f36_arg2 == @"hash_128080D5840E11B2" then
				f36_local1:set( @"hash_57E8A8BFFB7D0CD4" ) --[[ @ 0]]
			else
		...
		if not Engine[@"hash_28069F5969D47DEF"]() then
			f36_arg3 = CoD.BitUtility.ClearBit( f36_arg3, Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"] ) --[[ @ 0]]
		end
	...
	if CoD.isPC and f36_arg4 ~= nil and f36_arg0.keyModel ~= nil and f36_arg0.keyModel[f36_arg4] ~= nil then
		...
		if f36_arg3 & Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_72919C98A7A845F0"] > 0 then
			f36_arg3 = f36_arg3 - Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_72919C98A7A845F0"] --[[ @ 0]]
		end
		if f36_arg3 & Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_771B04FAC5BE0E35"] > 0 then
			f36_arg3 = f36_arg3 - Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_771B04FAC5BE0E35"] --[[ @ 0]]
		end
...
CoD.Menu.AddPCNavigationHandler = function ( f48_arg0, f48_arg1 )
	...
	if f48_arg0.buttonModel == nil then
		...
		CoD.Menu.AddButtonCallbackFunction( f48_arg0, f48_arg0, f48_arg1, Enum[@"LUIButton"][@"hash_24B11D2B20C75A7F"], "ui_navup", function ( element, menu, controller, f49_arg3 )
		...
		CoD.Menu.AddButtonCallbackFunction( f48_arg0, f48_arg0, f48_arg1, Enum[@"LUIButton"][@"hash_6D4C15FE32148D3A"], "ui_navdown", function ( element, menu, controller, f50_arg3 )
			if not menu.m_disableNavigation and menu:AcceptGamePadButtonInputFromModelCallback( controller ) and CoD.Menu.CanHandleNavigationInput( menu ) then
		...
		CoD.Menu.AddButtonCallbackFunction( f48_arg0, f48_arg0, f48_arg1, Enum[@"LUIButton"][@"hash_1057783F8DA4AAEF"], "ui_navleft", function ( element, menu, controller, f51_arg3 )
			if not menu.m_disableNavigation and menu:AcceptGamePadButtonInputFromModelCallback( controller ) and CoD.Menu.CanHandleNavigationInput( menu ) then
		...
		CoD.Menu.AddButtonCallbackFunction( f48_arg0, f48_arg0, f48_arg1, Enum[@"LUIButton"][@"hash_4571F08AD84807E0"], "ui_navright", function ( element, menu, controller, f52_arg3 )
			if not menu.m_disableNavigation and menu:AcceptGamePadButtonInputFromModelCallback( controller ) and CoD.Menu.CanHandleNavigationInput( menu ) then
...
CoD.Menu.HandleButtonPress = function ( f56_arg0, f56_arg1, f56_arg2, f56_arg3, f56_arg4 )
	if CoD.isPC then
		if f56_arg0.ContextualMenu and (f56_arg2 == Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] or f56_arg2 == Enum[@"LUIButton"][@"hash_64D2505E19049444"]) then
			CoD.PCWidgetUtility.CloseContextualMenu( f56_arg0, f56_arg1 ) --[[ @ 0]]
			Engine[@"SetModelValue"]( f56_arg3, 0 ) --[[ @ 0]]
			return true
		elseif CoD.PCUtility.ChatClientContainer and f56_arg2 == Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] then
		...
		if CoD.PCUtility.FrontendBattlenetContainer and f56_arg2 == Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] and f56_arg0.id ~= "Menu.Social_PlayerDetailsPopup" and f56_arg0.id ~= "Menu.ReportPlayer" then
	...
	if Engine[@"IsControllerBeingUsed"]( f56_arg1 ) or f56_arg0.unusedControllerAllowed then
		...
		for f56_local7, f56_local8 in ipairs( f56_local0 ) --[[ @ 0]] do
			...
			local f56_local10 = CoD.BitUtility.IsBitwiseAndNonZero( f56_local9, Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_72919C98A7A845F0"] ) --[[ @ 0]]
			local f56_local11 = CoD.BitUtility.IsBitwiseAndNonZero( f56_local9, Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_771B04FAC5BE0E35"] ) --[[ @ 0]]
			...
			if (f56_local10 or f56_local11) and not f56_local12 and not f56_local13 and not CoD.BitUtility.IsBitwiseAndNonZero( f56_arg3:get() | f56_arg4, Enum[@"LUIButtonFlags"][@"hash_73DC8FC0E6AB543F"] ) then
				f56_local1 = f56_local1 + 1 --[[ @ 0]]
				Engine[@"hash_7AD22E2D5C97FC6B"]( f56_arg1, f56_local9 >> Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_176ADD225D738C93"], f56_arg2, f56_local11 ) --[[ @ 0]]
			end
...
CoD.Menu.HandlePCKeyPress = function ( f57_arg0, f57_arg1, f57_arg2, f57_arg3, f57_arg4, f57_arg5 )
	...
	if Engine[@"IsControllerBeingUsed"]( f57_arg1 ) or f57_arg0.unusedControllerAllowed then
		...
		for f57_local18, f57_local19 in ipairs( f57_local2 ) --[[ @ 0]] do
			...
			local f57_local11 = CoD.BitUtility.IsBitwiseAndNonZero( f57_local10, Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_72919C98A7A845F0"] ) --[[ @ 0]]
			local f57_local12 = CoD.BitUtility.IsBitwiseAndNonZero( f57_local10, Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_771B04FAC5BE0E35"] ) --[[ @ 0]]
			...
			if (f57_local11 or f57_local12) and not f57_local13 and not f57_local14 then
				...
				Engine[@"hash_7959D466B3459B3A"]( f57_arg1, f57_local10 >> Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_176ADD225D738C93"], f57_arg2, f57_local12, f57_arg4 ) --[[ @ 0]]
			end
...
CoD.Menu.AddButtonCallbackFunction = function ( f60_arg0, f60_arg1, f60_arg2, f60_arg3, f60_arg4, f60_arg5, f60_arg6, f60_arg7 )
	...
	if f60_arg3 ~= Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] then
	...
	if CoD.isPC then
		if f60_arg3 == Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] and (not f60_arg1.buttonFunctions.ESCAPE or not f60_arg1.__autoButtonCallback or f60_arg1.__autoButtonCallback.ESCAPE) and not f60_arg1.__disableAutoButtonCallback then
			f60_arg0:AddButtonCallbackFunction( f60_arg1, f60_arg2, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "ESCAPE", f60_arg5, f60_arg6, f60_arg7 ) --[[ @ 0]]
			f60_arg1.__autoButtonCallback.ESCAPE = true --[[ @ 0]]
		end
		if f60_arg3 == Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] and (not f60_arg1.buttonFunctions.ui_confirm or not f60_arg1.__autoButtonCallback or f60_arg1.__autoButtonCallback.ui_confirm) and not f60_arg1.__disableAutoButtonCallback then
			f60_arg0:AddButtonCallbackFunction( f60_arg1, f60_arg2, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "ui_confirm", f60_arg5, f60_arg6, f60_arg7 ) --[[ @ 0]]
			f60_arg1.__autoButtonCallback.ui_confirm = true --[[ @ 0]]
		end
		if f60_arg3 == Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] and f60_arg1 ~= f60_arg0 and (not f60_arg1.buttonFunctions.MOUSE1 or not f60_arg1.__autoButtonCallback or f60_arg1.__autoButtonCallback.MOUSE1) and not f60_arg1.__disableAutoButtonCallback then
			f60_arg0:AddButtonCallbackFunction( f60_arg1, f60_arg2, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "MOUSE1", f60_arg5, f60_arg6, f60_arg7 ) --[[ @ 0]]
...
CoD.Menu.RemoveFromCurrMenuNameList = function ( f64_arg0 )
	...
	local f64_local0 = Dvar[@"hash_7FEB365B406388"]:get() --[[ @ 0]]
	...
	Dvar[@"hash_7FEB365B406388"]:set( f64_local1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.Menu.AddToCurrMenuNameList = function ( f65_arg0 )
	...
	local f65_local0 = Dvar[@"hash_7FEB365B406388"]:get() --[[ @ 0]]
	if not f65_local0 or f65_local0 == "" then
		Dvar[@"hash_7FEB365B406388"]:set( f65_arg0 ) --[[ @ 0]]
		return 
	end
	...
	Dvar[@"hash_7FEB365B406388"]:set( f65_local0 .. ", " .. f65_arg0 ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.Menu.updateBlur = function ( f76_arg0 )
	...
	if Engine[@"IsInGame"]() then
		if f76_arg0.occludedMenu then
			...
			if CoD.isMultiplayer and not Engine[@"hash_2A55C3ACD0D2BCF0"]() and not CoD.PlayerRoleUtility.IsPositionDraftStage( f76_local0, CoD.PlayerRoleUtility.DraftStage.DRAFT_STAGE_NONE ) then
				return 
			end
			Engine[@"BlurWorld"]( f76_local0, 0 ) --[[ @ 0]]
			if not f76_arg0.disableInputLock then
...
CoD.Menu.CanProcessPCKeyPress = function ( f86_arg0, f86_arg1, f86_arg2, f86_arg3, f86_arg4 )
	...
	if not f86_arg0.occludedBy and (not CoD.Menu.IsPriorityMenuOpen( f86_arg2 ) or f86_arg0._isPriorityMenu) and not CoD.Menu.SpinnerIsActive then
		f86_local0 = CoD.BitUtility.IsBitwiseAndNonZero( Engine[@"GetModelValue"]( f86_arg1 ), Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) --[[ @ 0]]
		if f86_local0 then
	...
	if f86_local0 then
		local f86_local1 = CoD.BitUtility.IsBitwiseAndNonZero( f86_arg1:get(), Enum[@"LUIButtonFlags"][@"hash_73DC8FC0E6AB543F"] ) --[[ @ 0]]
...
CoD.Menu.RecordCurrFocusedElemID = function ( f100_arg0, f100_arg1 )
	...
	if nil ~= LUI.DEV and f100_arg1.name == "record_curr_focused_elem_id" then
		...
		if Dvar[@"hash_3B8B4D0064475D4"]:exists() then
			...
			Dvar[@"hash_3B8B4D0064475D4"]:set( f100_local12 ) --[[ @ 0]]
		end
		if Dvar[@"hash_2196FDA5E89973C6"]:exists() then
			Dvar[@"hash_2196FDA5E89973C6"]:set( f100_local11 ) --[[ @ 0]]
		end
	end
...
CoD.Menu.restoreState = function ( f132_arg0, f132_arg1 )
	if Engine[@"hash_49E5BE3B4BBA4E0E"]( "rat_playback_enabled" ) then
		return 
...
CoD.InGameMenu.CloseAllInGameMenus = function ( f134_arg0, f134_arg1 )
	if Engine[@"CanPauseGame"]() and not Engine[@"hash_2A55C3ACD0D2BCF0"]() then
