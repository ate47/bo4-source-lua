...
CoD.Barracks_StatsOverview_WZ.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	KillsPerGame.StatHeaderText:setText( LocalizeToUpperString( @"hash_6D9EF6EF1578BC4B" ) ) --[[ @ 0]]
	...
	KillDeathRatio.StatHeaderText:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_29F7AB977F072D55" ) ) --[[ @ 0]]
	...
	HeadshotPct.StatValue.__Stat_Value = function ()
		HeadshotPct.StatValue:setText( FractionToPercentageRounded( CoD.PlayerStatsUtility.GetWZGameModeAveragePlayerStorageStatRatio( f1_arg1, f1_arg0, @"hash_6398F3A5D1263466", @"hits", "88%" ) ) ) --[[ @ 0]]
	end
	 --[[ @ 0]]
	...
	MostKills.StatHeaderText:setText( LocalizeToUpperString( @"hash_48F9242469C9FB22" ) ) --[[ @ 0]]
	...
	EfficiencyHeader.HeaderText:setText( LocalizeToUpperString( @"hash_608CA99F2C517036" ) ) --[[ @ 0]]
	...
	AverageDamage.StatHeaderText:setText( LocalizeToUpperString( @"hash_588676CED526A6F" ) ) --[[ @ 0]]
	...
	OtherHeader.HeaderText:setText( LocalizeToUpperString( @"hash_13EF00415621CE8B" ) ) --[[ @ 0]]
	...
	WZGameModeFilter:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	WZGameModeFilterButton:setAlignment( Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"] ) --[[ @ 0]]
