...
CoD.hud_hacked_map_widget = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.hud_hacked_map_widget.__defaultWidth = 348 --[[ @ 0]]
CoD.hud_hacked_map_widget.__defaultHeight = 348 --[[ @ 0]]
CoD.hud_hacked_map_widget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.hud_hacked_map_widget ) --[[ @ 0]]
	self.id = "hud_hacked_map_widget" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local Hacked = LUI.UIImage.new( 0.5, 0.5, -174, 174, 0.5, 0.5, -174, 174 ) --[[ @ 0]]
	Hacked:setRGB( 0.32, 0.48, 0.52 ) --[[ @ 0]]
	Hacked:setImage( RegisterImage( @"uie_ui_hud_core_hacked_map_panel" ) ) --[[ @ 0]]
	...
	local Hacked2 = LUI.UIImage.new( 0.5, 0.5, -174, 174, 0.5, 0.5, -174, 174 ) --[[ @ 0]]
	Hacked2:setRGB( 0.09, 0.2, 0.23 ) --[[ @ 0]]
	Hacked2:setAlpha( 0.5 ) --[[ @ 0]]
	Hacked2:setZRot( 180 ) --[[ @ 0]]
	Hacked2:setImage( RegisterImage( @"uie_ui_hud_core_hacked_map_panel" ) ) --[[ @ 0]]
	Hacked2:setMaterial( LUI.UIImage.GetCachedMaterial( @"uie_flipbook_add" ) ) --[[ @ 0]]
	Hacked2:setShaderVector( 0, 4, 4, 0, 0 ) --[[ @ 0]]
	Hacked2:setShaderVector( 1, 50, 0, 0, 0 ) --[[ @ 0]]
