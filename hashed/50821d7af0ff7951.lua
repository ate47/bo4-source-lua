...
CoD.HubTagBonusButton_Internal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.HubTagBonusButton_Internal.__defaultWidth = 152 --[[ @ 0]]
CoD.HubTagBonusButton_Internal.__defaultHeight = 152 --[[ @ 0]]
CoD.HubTagBonusButton_Internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.HubTagBonusButton_Internal ) --[[ @ 0]]
	self.id = "HubTagBonusButton_Internal" --[[ @ 0]]
...
CoD.HubTagBonusButton_Internal.__clipsPerState = {
	...
	Locked = {
		DefaultClip = function ( f19_arg0, f19_arg1 )
			...
			f19_arg0.tag:setRGB( 0.29, 0.29, 0.29 ) --[[ @ 0]]
			f19_arg0.clipFinished( f19_arg0.tag ) --[[ @ 0]]
			f19_arg0.caclock:completeAnimation() --[[ @ 0]]
			f19_arg0.caclock:setRGB( 1, 1, 1 ) --[[ @ 0]]
			f19_arg0.caclock:setAlpha( 1 ) --[[ @ 0]]
		...
		ChildFocus = function ( f20_arg0, f20_arg1 )
			...
			f20_arg0.tag:setRGB( 0.49, 0.49, 0.49 ) --[[ @ 0]]
		...
		GainChildFocus = function ( f21_arg0, f21_arg1 )
			...
			local f21_local0 = function ( f22_arg0 )
				f21_arg0.tag:beginAnimation( 200 ) --[[ @ 0]]
				f21_arg0.tag:setRGB( 0.49, 0.49, 0.49 ) --[[ @ 0]]
				f21_arg0.tag:registerEventHandler( "interrupted_keyframe", f21_arg0.clipInterrupted ) --[[ @ 0]]
				f21_arg0.tag:registerEventHandler( "transition_complete_keyframe", f21_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f21_arg0.tag:completeAnimation() --[[ @ 0]]
			f21_arg0.tag:setRGB( 0.29, 0.29, 0.29 ) --[[ @ 0]]
			f21_local0( f21_arg0.tag ) --[[ @ 0]]
			local f21_local1 = function ( f23_arg0 )
				f21_arg0.caclock:beginAnimation( 200 ) --[[ @ 0]]
				f21_arg0.caclock:registerEventHandler( "interrupted_keyframe", f21_arg0.clipInterrupted ) --[[ @ 0]]
				f21_arg0.caclock:registerEventHandler( "transition_complete_keyframe", f21_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f21_arg0.caclock:completeAnimation() --[[ @ 0]]
			f21_arg0.caclock:setRGB( 1, 1, 1 ) --[[ @ 0]]
			f21_arg0.caclock:setAlpha( 1 ) --[[ @ 0]]
			f21_local1( f21_arg0.caclock ) --[[ @ 0]]
		end,
	...
	TrialLocked = {
		DefaultClip = function ( f27_arg0, f27_arg1 )
			...
			f27_arg0.caclock:setScale( 0.6, 0.6 ) --[[ @ 0]]
		...
		ChildFocus = function ( f28_arg0, f28_arg1 )
			...
			f28_arg0.caclock:setScale( 0.6, 0.6 ) --[[ @ 0]]
		...
		GainChildFocus = function ( f29_arg0, f29_arg1 )
			...
			f29_arg0.caclock:setScale( 0.6, 0.6 ) --[[ @ 0]]
	...
	New = {
		DefaultClip = function ( f31_arg0, f31_arg1 )
			...
			f31_arg0.clipFinished( f31_arg0.BreadcrumbNew ) --[[ @ 0]]
		end,
		ChildFocus = function ( f32_arg0, f32_arg1 )
			...
			local f32_local0 = function ( f33_arg0 )
				local f33_local0 = function ( f34_arg0 )
				 ...
				 --[[ @ 0]]
				f32_arg0.BreadcrumbNew:beginAnimation( 400 ) --[[ @ 0]]
				f32_arg0.BreadcrumbNew:registerEventHandler( "interrupted_keyframe", f32_arg0.clipInterrupted ) --[[ @ 0]]
				f32_arg0.BreadcrumbNew:registerEventHandler( "transition_complete_keyframe", f33_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f32_arg0.BreadcrumbNew:completeAnimation() --[[ @ 0]]
			f32_arg0.BreadcrumbNew:setAlpha( 1 ) --[[ @ 0]]
			f32_local0( f32_arg0.BreadcrumbNew ) --[[ @ 0]]
		end,
		...
		LoseChildFocus = function ( f36_arg0, f36_arg1 )
			...
			f36_arg0.clipFinished( f36_arg0.BreadcrumbNew ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.HubTagBonusButton_Internal.__onClose = function ( f37_arg0 )
	f37_arg0.tag:close() --[[ @ 0]]
	f37_arg0.caclock:close() --[[ @ 0]]
	f37_arg0.BMGoldBar:close() --[[ @ 0]]
	f37_arg0.CommonButtonOutline:close() --[[ @ 0]]
	f37_arg0.BreadcrumbNew:close() --[[ @ 0]]
