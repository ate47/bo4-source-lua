...
require( "x64:6b74057f7884b1f5" ) --[[ @ 0]]

CoD.ChallengesCareerWZ = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.ChallengesCareerWZ = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "ChallengesCareerWZ", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	self:setClass( CoD.ChallengesCareerWZ ) --[[ @ 0]]
	...
	MenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_51BEB13BCC1D1E4E" ) ) --[[ @ 0]]
	...
	local FETabBar = CoD.StartMenu_challengesCareerTab.new( f1_local1, f1_arg0, 0, 0, 0, 1920, 0, 0, 0, 62 ) --[[ @ 0]]
