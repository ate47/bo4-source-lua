...
CoD.StartMenu_InventoryDescription.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	title:setAlignment( Engine[@"hash_67F8853DC3581AA4"]( Enum[@"LUIAlignment"][@"hash_670510683C22104B"] ) ) --[[ @ 0]]
	...
	WarzoneInventoryUnlockMissionObjective:linkToElementModel( self, "unlockableItemRef", true, function ( model )
		...
		if f21_local0 ~= nil then
			WarzoneInventoryUnlockMissionObjective.WarzoneInventoryUnlockMissionReward.unlockableIcon:setImage( CoD.BaseUtility.AlreadyRegistered( CoD.WZUtility.GetPreviewImageLargeFromRef( Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"], f21_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	alreadyUnlockedLabel:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	alreadyUnlockedLabel:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
