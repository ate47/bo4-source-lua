...
require( "x64:653dd3afce6c5c69" ) --[[ @ 0]]
require( "x64:5d70dffca5f57ab0" ) --[[ @ 0]]
require( "x64:2c980b1a7ed2f310" ) --[[ @ 0]]

CoD.AARTierRewardShowcaseInternalRare = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalRare.__defaultWidth = 310 --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalRare.__defaultHeight = 632 --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalRare.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARTierRewardShowcaseInternalRare ) --[[ @ 0]]
	self.id = "AARTierRewardShowcaseInternalRare" --[[ @ 0]]
	...
	local GlowAnim = CoD.AARTierRewardItemGlowAnimationRare.new( f1_arg0, f1_arg1, 0, 1, 0, 0, 0, 1, 0, 0 ) --[[ @ 0]]
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not CoD.ModelUtility.IsSelfModelValueTrue( element, f1_arg1, "unlocked" ) then
					f11_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum[@"LootRarityType"][@"hash_4895F040FAFBECB9"] ) --[[ @ 0]]
				else
					f11_local0 = false --[[ @ 0]]
				end
				return f11_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f12_local0 then
					f12_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum[@"LootRarityType"][@"hash_4895F040FAFBECB9"] ) --[[ @ 0]]
					if f12_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f13_local0 then
					f13_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum[@"LootRarityType"][@"hash_4895F040FAFBECB9"] ) --[[ @ 0]]
					if f13_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f14_local0 then
					f14_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum[@"LootRarityType"][@"hash_4895F040FAFBECB9"] ) --[[ @ 0]]
					if f14_local0 then
...
CoD.AARTierRewardShowcaseInternalRare.__resetProperties = function ( f21_arg0 )
	f21_arg0.BGWidgetRare:completeAnimation() --[[ @ 0]]
	...
	f21_arg0.BGWidgetRare:setAlpha( 1 ) --[[ @ 0]]
	f21_arg0.BGWidgetRare:setScale( 1, 1 ) --[[ @ 0]]
...
CoD.AARTierRewardShowcaseInternalRare.__clipsPerState = {
	...
	Empty = {
		DefaultClip = function ( f23_arg0, f23_arg1 )
			...
			f23_arg0.BGWidgetRare:completeAnimation() --[[ @ 0]]
			f23_arg0.BGWidgetRare:setAlpha( 0 ) --[[ @ 0]]
			f23_arg0.clipFinished( f23_arg0.BGWidgetRare ) --[[ @ 0]]
	...
	Locked = {
		DefaultClip = function ( f24_arg0, f24_arg1 )
			...
			f24_arg0.BGWidgetRare:completeAnimation() --[[ @ 0]]
			f24_arg0.BGWidgetRare:setAlpha( 0 ) --[[ @ 0]]
			f24_arg0.clipFinished( f24_arg0.BGWidgetRare ) --[[ @ 0]]
		...
		DefaultState = function ( f25_arg0, f25_arg1 )
			...
			local f25_local0 = function ( f26_arg0 )
				local f26_local0 = function ( f27_arg0 )
				 ...
				 --[[ @ 0]]
				f25_arg0.BGWidgetRare:playClip( "DefaultClip" ) --[[ @ 0]]
				f25_arg0.BGWidgetRare:beginAnimation( 200 ) --[[ @ 0]]
				f25_arg0.BGWidgetRare:setAlpha( 0.67 ) --[[ @ 0]]
				f25_arg0.BGWidgetRare:setScale( 0.8, 0.8 ) --[[ @ 0]]
				f25_arg0.BGWidgetRare:registerEventHandler( "interrupted_keyframe", f25_arg0.clipInterrupted ) --[[ @ 0]]
				f25_arg0.BGWidgetRare:registerEventHandler( "transition_complete_keyframe", f26_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f25_arg0.BGWidgetRare:completeAnimation() --[[ @ 0]]
			f25_arg0.BGWidgetRare:setAlpha( 0 ) --[[ @ 0]]
			f25_arg0.BGWidgetRare:setScale( 4, 4 ) --[[ @ 0]]
			f25_local0( f25_arg0.BGWidgetRare ) --[[ @ 0]]
			...
			f25_arg0.Sound:playSound( "uin_mtx_item_get_rare", f25_arg1 ) --[[ @ 0]]
		...
		Contraband = function ( f32_arg0, f32_arg1 )
			...
			local f32_local1 = function ( f37_arg0 )
				local f37_local0 = function ( f38_arg0 )
				 ...
				 --[[ @ 0]]
				f32_arg0.BGWidgetRare:beginAnimation( 790 ) --[[ @ 0]]
				f32_arg0.BGWidgetRare:registerEventHandler( "interrupted_keyframe", f32_arg0.clipInterrupted ) --[[ @ 0]]
				f32_arg0.BGWidgetRare:registerEventHandler( "transition_complete_keyframe", f37_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f32_arg0.BGWidgetRare:completeAnimation() --[[ @ 0]]
			f32_arg0.BGWidgetRare:setAlpha( 0 ) --[[ @ 0]]
			f32_local1( f32_arg0.BGWidgetRare ) --[[ @ 0]]
			...
			f32_arg0.Sound:playSound( "uin_mtx_item_get_rare", f32_arg1 ) --[[ @ 0]]
		...
		Reroll = function ( f42_arg0, f42_arg1 )
			...
			local f42_local1 = function ( f48_arg0 )
				local f48_local0 = function ( f49_arg0 )
				 ...
				 --[[ @ 0]]
				f42_arg0.BGWidgetRare:beginAnimation( 130 ) --[[ @ 0]]
				f42_arg0.BGWidgetRare:registerEventHandler( "interrupted_keyframe", f42_arg0.clipInterrupted ) --[[ @ 0]]
				f42_arg0.BGWidgetRare:registerEventHandler( "transition_complete_keyframe", f48_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f42_arg0.BGWidgetRare:completeAnimation() --[[ @ 0]]
			f42_arg0.BGWidgetRare:setAlpha( 0 ) --[[ @ 0]]
			f42_local1( f42_arg0.BGWidgetRare ) --[[ @ 0]]
		...
		Dupe = function ( f58_arg0, f58_arg1 )
			...
			local f58_local0 = function ( f59_arg0 )
				local f59_local0 = function ( f60_arg0 )
				 ...
				 --[[ @ 0]]
				f58_arg0.BGWidgetRare:beginAnimation( 130 ) --[[ @ 0]]
				f58_arg0.BGWidgetRare:registerEventHandler( "interrupted_keyframe", f58_arg0.clipInterrupted ) --[[ @ 0]]
				f58_arg0.BGWidgetRare:registerEventHandler( "transition_complete_keyframe", f59_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f58_arg0.BGWidgetRare:completeAnimation() --[[ @ 0]]
			f58_arg0.BGWidgetRare:setAlpha( 0 ) --[[ @ 0]]
			f58_local0( f58_arg0.BGWidgetRare ) --[[ @ 0]]
