...
CoD.ui_icon_callingcards_crimewave_wheelspin01 = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ui_icon_callingcards_crimewave_wheelspin01.__defaultWidth = 80 --[[ @ 0]]
CoD.ui_icon_callingcards_crimewave_wheelspin01.__defaultHeight = 120 --[[ @ 0]]
CoD.ui_icon_callingcards_crimewave_wheelspin01.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ui_icon_callingcards_crimewave_wheelspin01 ) --[[ @ 0]]
	self.id = "ui_icon_callingcards_crimewave_wheelspin01" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local wheel1 = LUI.UIImage.new( 0, 0, 0, 80, 0, 0, 0, 120 ) --[[ @ 0]]
	wheel1:setImage( RegisterImage( @"uie_ui_menu_callingcards_crimewave_criminalcar_frontwheel1" ) ) --[[ @ 0]]
	self:addElement( wheel1 ) --[[ @ 0]]
	self.wheel1 = wheel1 --[[ @ 0]]
	
	local wheel2 = LUI.UIImage.new( 0, 0, 0, 80, 0, 0, 0, 120 ) --[[ @ 0]]
	wheel2:setImage( RegisterImage( @"uie_ui_menu_callingcards_crimewave_criminalcar_frontwheel2" ) ) --[[ @ 0]]
		...
		DefaultClip = function ( f3_arg0, f3_arg1 )
			...
			local f3_local0 = function ( f4_arg0 )
				local f4_local0 = function ( f5_arg0 )
				 ...
				 --[[ @ 0]]
				f3_arg0.wheel2:beginAnimation( 100 ) --[[ @ 0]]
				f3_arg0.wheel2:setAlpha( 1 ) --[[ @ 0]]
				f3_arg0.wheel2:registerEventHandler( "interrupted_keyframe", f3_arg0.clipInterrupted ) --[[ @ 0]]
				f3_arg0.wheel2:registerEventHandler( "transition_complete_keyframe", f4_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f3_arg0.wheel2:completeAnimation() --[[ @ 0]]
			f3_arg0.wheel2:setAlpha( 0 ) --[[ @ 0]]
			f3_local0( f3_arg0.wheel2 ) --[[ @ 0]]
