		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsCustomLobby() then
					...
					if f3_local0 then
						f3_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "unlockSessionMode", Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) --[[ @ 0]]
						if f3_local0 then
	...
	DefaultState = {
		...
		GainChildFocus = function ( f13_arg0, f13_arg1 )
			...
			local f13_local0 = function ( f14_arg0 )
				f13_arg0.CamoSlotInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
		...
		LoseChildFocus = function ( f15_arg0, f15_arg1 )
			...
			local f15_local0 = function ( f16_arg0 )
				f15_arg0.CamoSlotInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
	...
	Equipped = {
		...
		GainChildFocus = function ( f19_arg0, f19_arg1 )
			...
			local f19_local0 = function ( f20_arg0 )
				f19_arg0.CamoSlotInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
		...
		LoseChildFocus = function ( f21_arg0, f21_arg1 )
			...
			local f21_local0 = function ( f22_arg0 )
				f21_arg0.CamoSlotInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
	...
	New = {
		...
		GainChildFocus = function ( f27_arg0, f27_arg1 )
			...
			local f27_local0 = function ( f28_arg0 )
				f27_arg0.CamoSlotInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
		...
		LoseChildFocus = function ( f29_arg0, f29_arg1 )
			...
			local f29_local0 = function ( f30_arg0 )
				f29_arg0.CamoSlotInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
