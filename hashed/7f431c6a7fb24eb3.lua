...
require( "x64:502bad6fbafef4fa" ) --[[ @ 0]]
require( "x64:6cfb14ab0b137a5" ) --[[ @ 0]]

CoD.WZAAR_MeritContainerInternal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.WZAAR_MeritContainerInternal.__defaultWidth = 540 --[[ @ 0]]
CoD.WZAAR_MeritContainerInternal.__defaultHeight = 628 --[[ @ 0]]
CoD.WZAAR_MeritContainerInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.WZAAR_MeritContainerInternal ) --[[ @ 0]]
	self.id = "WZAAR_MeritContainerInternal" --[[ @ 0]]
	...
	NextEchelon:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	CurrentEchelon:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	CurrentEchelon:linkToElementModel( self, "rank", true, function ( model )
		...
		if f4_local0 ~= nil then
			CurrentEchelon:setText( f4_local0 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	EarnedEchelonIcon:linkToElementModel( self, "echelon", true, function ( model )
		...
		if f5_local0 ~= nil then
			EarnedEchelonIcon:setImage( RegisterImage( f5_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	ProgressTitle:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	ProgressTitle:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	self:addElement( ProgressTitle ) --[[ @ 0]]
	self.ProgressTitle = ProgressTitle --[[ @ 0]]
	
	local MeritDetails = CoD.WZAAR_MeritBreakdown.new( f1_arg0, f1_arg1, 0.5, 0.5, -180, 180, 0, 0, 119, 377 ) --[[ @ 0]]
	MeritDetails:linkToElementModel( self, nil, false, function ( model )
		MeritDetails:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( MeritDetails ) --[[ @ 0]]
	self.MeritDetails = MeritDetails --[[ @ 0]]
	...
	MeritsHeader:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	MeritsHeader:setAlignment( Enum[@"LUIAlignment"][@"hash_6ED4298C93DC5ED"] ) --[[ @ 0]]
...
CoD.WZAAR_MeritContainerInternal.__resetProperties = function ( f9_arg0 )
	...
	f9_arg0.MeritDetails:completeAnimation() --[[ @ 0]]
	f9_arg0.EarnedEchelonIcon:completeAnimation() --[[ @ 0]]
	f9_arg0.ProgressTitle:completeAnimation() --[[ @ 0]]
	f9_arg0.CurrentEchelon:completeAnimation() --[[ @ 0]]
	f9_arg0.EchelonProgress:completeAnimation() --[[ @ 0]]
	f9_arg0.NextEchelon:completeAnimation() --[[ @ 0]]
	f9_arg0.MeritsHeader:completeAnimation() --[[ @ 0]]
	f9_arg0.IGRbg:completeAnimation() --[[ @ 0]]
	f9_arg0.Title:setAlpha( 1 ) --[[ @ 0]]
	f9_arg0.MeritDetails:setAlpha( 1 ) --[[ @ 0]]
	f9_arg0.EarnedEchelonIcon:setAlpha( 1 ) --[[ @ 0]]
	f9_arg0.ProgressTitle:setAlpha( 0 ) --[[ @ 0]]
	f9_arg0.CurrentEchelon:setAlpha( 1 ) --[[ @ 0]]
	f9_arg0.EchelonProgress:setAlpha( 1 ) --[[ @ 0]]
	f9_arg0.NextEchelon:setAlpha( 1 ) --[[ @ 0]]
	f9_arg0.MeritsHeader:setAlpha( 1 ) --[[ @ 0]]
	f9_arg0.IGRbg:setAlpha( 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.WZAAR_MeritContainerInternal.__clipsPerState = {
	...
	Hidden = {
		DefaultClip = function ( f11_arg0, f11_arg1 )
			...
			f11_arg0.IGRbg:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.IGRbg ) --[[ @ 0]]
			f11_arg0.NextEchelon:completeAnimation() --[[ @ 0]]
			f11_arg0.NextEchelon:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.NextEchelon ) --[[ @ 0]]
			f11_arg0.EchelonProgress:completeAnimation() --[[ @ 0]]
			f11_arg0.EchelonProgress:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.EchelonProgress ) --[[ @ 0]]
			f11_arg0.CurrentEchelon:completeAnimation() --[[ @ 0]]
			f11_arg0.CurrentEchelon:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.CurrentEchelon ) --[[ @ 0]]
			f11_arg0.EarnedEchelonIcon:completeAnimation() --[[ @ 0]]
			f11_arg0.EarnedEchelonIcon:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.EarnedEchelonIcon ) --[[ @ 0]]
			f11_arg0.ProgressTitle:completeAnimation() --[[ @ 0]]
			f11_arg0.ProgressTitle:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.ProgressTitle ) --[[ @ 0]]
			f11_arg0.MeritDetails:completeAnimation() --[[ @ 0]]
			f11_arg0.MeritDetails:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.MeritDetails ) --[[ @ 0]]
			f11_arg0.MeritsHeader:completeAnimation() --[[ @ 0]]
			f11_arg0.MeritsHeader:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.MeritsHeader ) --[[ @ 0]]
...
CoD.WZAAR_MeritContainerInternal.__onClose = function ( f12_arg0 )
	f12_arg0.IGRbg:close() --[[ @ 0]]
	f12_arg0.NextEchelon:close() --[[ @ 0]]
	f12_arg0.EchelonProgress:close() --[[ @ 0]]
	f12_arg0.CurrentEchelon:close() --[[ @ 0]]
	f12_arg0.EarnedEchelonIcon:close() --[[ @ 0]]
	f12_arg0.MeritDetails:close() --[[ @ 0]]
end
 --[[ @ 0]]
