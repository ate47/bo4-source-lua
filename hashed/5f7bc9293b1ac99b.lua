...
CoD.ContractTall.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	TotalTierCount:setAlignment( Enum[@"luialignment"][@"lui_alignment_right"] ) --[[ @ 0]]
	...
	TotalTierCount:linkToElementModel( self, "totalRewardCount", true, function ( model )
		...
		if f11_local0 ~= nil then
			TotalTierCount:setText( LocalizeIntoString( @"mpui/x_tiers", f11_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	ActiveBanner.ActiveTitle:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	...
	CompeletedBanner.CompeletedBanner:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
