...
CoD.Store_NonFeaturedFrame = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.Store_NonFeaturedFrame.__defaultWidth = 1392 --[[ @ 0]]
CoD.Store_NonFeaturedFrame.__defaultHeight = 680 --[[ @ 0]]
CoD.Store_NonFeaturedFrame.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.Store_NonFeaturedFrame ) --[[ @ 0]]
	self.id = "Store_NonFeaturedFrame" --[[ @ 0]]
	...
	TextBox:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7F61DC3EA2DDC93E" ) ) --[[ @ 0]]
	...
	List:setDataSource( "StoreProductList" ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( List, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		if CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, controller, "purchasestatus", Enum[@"StoreProductPurchaseStatus"][@"hash_FC232FC1AF749AA"] ) then
			PurchaseProduct( self, menu, element, controller ) --[[ @ 0]]
			PlaySoundSetSound( self, "action" ) --[[ @ 0]]
			return true
		elseif CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, controller, "purchasestatus", Enum[@"StoreProductPurchaseStatus"][@"hash_1C3D2ED4AABEAE6C"] ) then
			PurchaseProduct( self, menu, element, controller ) --[[ @ 0]]
			PlaySoundSetSound( self, "action" ) --[[ @ 0]]
			return true
		else
		...
		if CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, controller, "purchasestatus", Enum[@"StoreProductPurchaseStatus"][@"hash_FC232FC1AF749AA"] ) then
			...
			return true
		elseif CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, controller, "purchasestatus", Enum[@"StoreProductPurchaseStatus"][@"hash_1C3D2ED4AABEAE6C"] ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_44C69DA062697EC9", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	f1_arg0:AddButtonCallbackFunction( LeftPageOver, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	self.verticalCounter = f1_local6 --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( self, f1_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], nil, function ( element, menu, controller, model )
		if IsPC() then
			CoD.GridAndListUtility.ScrollDown( self.List ) --[[ @ 0]]
			return true
		else
	...
	f1_arg0:AddButtonCallbackFunction( self, f1_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], nil, function ( element, menu, controller, model )
		if IsPC() then
			CoD.GridAndListUtility.ScrollUp( self.List ) --[[ @ 0]]
			return true
		else
	...
	self:subscribeToGlobalModel( f1_arg1, "PerController", "StoreRoot.ready", function ( model )
		...
		elseif CoD.ModelUtility.IsModelValueEqualTo( f1_arg1, "StoreRoot.ready", 1 ) then
			...
			CoD.GridAndListUtility.SetFocusToFirstSelectableItem( self.List ) --[[ @ 0]]
		elseif CoD.ModelUtility.IsModelValueEqualTo( f1_arg1, "StoreRoot.ready", 0 ) then
			SetElementProperty( f30_local0, "m_disableKeyboardNavigation", true ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	f1_local6.id = "verticalCounter" --[[ @ 0]]
	...
	f1_local8 = self --[[ @ 0]]
	SetAsListVerticalCounter( self, f1_local6, "List" ) --[[ @ 0]]
	return self
end
 --[[ @ 0]]
...
CoD.Store_NonFeaturedFrame.__onClose = function ( f40_arg0 )
	...
	f40_arg0.verticalCounter:close() --[[ @ 0]]
end
 --[[ @ 0]]
