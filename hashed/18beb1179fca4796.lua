...
CoD.ConsoleIcon = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ConsoleIcon.__defaultWidth = 22 --[[ @ 0]]
CoD.ConsoleIcon.__defaultHeight = 21 --[[ @ 0]]
CoD.ConsoleIcon.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ConsoleIcon ) --[[ @ 0]]
	self.id = "ConsoleIcon" --[[ @ 0]]
	self.soundSet = "HUD" --[[ @ 0]]
...
CoD.ConsoleIcon.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f3_arg0, f3_arg1 )
			...
			f3_arg0.Icon:setAlpha( 0 ) --[[ @ 0]]
			f3_arg0.clipFinished( f3_arg0.Icon ) --[[ @ 0]]
		end,
