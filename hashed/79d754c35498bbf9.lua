...
CoD.StartMenu_QuitButton = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.StartMenu_QuitButton.__defaultWidth = 240 --[[ @ 0]]
CoD.StartMenu_QuitButton.__defaultHeight = 75 --[[ @ 0]]
CoD.StartMenu_QuitButton.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.StartMenu_QuitButton ) --[[ @ 0]]
	self.id = "StartMenu_QuitButton" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	self.onlyChildrenFocusable = true --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local DirectorGenericButton = CoD.DirectorGenericButton.new( f1_arg0, f1_arg1, 0, 0, 0, 250, 0, 0, 0, 92 ) --[[ @ 0]]
	...
	local HoldButtonFill = CoD.StartMenu_QuitButtonFill.new( f1_arg0, f1_arg1, 0, 0, 0, 250, 0, 0, 0, 91 ) --[[ @ 0]]
	...
	HoldButtonFill:linkToElementModel( self, "" .. Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], false, function ( model )
		HoldButtonFill:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( HoldButtonFill ) --[[ @ 0]]
	self.HoldButtonFill = HoldButtonFill --[[ @ 0]]
	
	local TextBox = LUI.UIText.new( 0, 0, 0, 250, 0, 0, 34, 58 ) --[[ @ 0]]
	TextBox:setRGB( ColorSet.T8__BIEGE.r, ColorSet.T8__BIEGE.g, ColorSet.T8__BIEGE.b ) --[[ @ 0]]
	TextBox:setText( LocalizeToUpperString( @"hash_1D6D98060CE88B87" ) ) --[[ @ 0]]
