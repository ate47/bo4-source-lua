...
LUI.createMenu.BlackMarketBountyDetails = function ( f1_arg0, f1_arg1 )
	...
	BountyBundleList:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( BountyBundleList, f1_arg0, Enum[@"LUIButton"][@"hash_1057783F8DA4AAEF"], nil, function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( BountyBundleList, f1_arg0, Enum[@"LUIButton"][@"hash_4571F08AD84807E0"], nil, function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( BountyBundleList, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( PurchaseButton, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( BMActivateBountyButton, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	self:linkToElementModel( self, "movieName", true, function ( model, f49_arg1 )
		CoD.Menu.UpdateButtonShownState( f49_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f49_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
