...
require( "x64:a94557301609cd0" ) --[[ @ 0]]

CoD.ReservesLootPurchaseBundleButtonContainer = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ReservesLootPurchaseBundleButtonContainer.__defaultWidth = 248 --[[ @ 0]]
CoD.ReservesLootPurchaseBundleButtonContainer.__defaultHeight = 462 --[[ @ 0]]
CoD.ReservesLootPurchaseBundleButtonContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ReservesLootPurchaseBundleButtonContainer ) --[[ @ 0]]
	self.id = "ReservesLootPurchaseBundleButtonContainer" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	self.onlyChildrenFocusable = true --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local ReservesItemHorizontal = CoD.ReservesLootPurchaseBundleButton.new( f1_arg0, f1_arg1, 0.5, 0.5, -124, 124, 0.5, 0.5, -231, 231 ) --[[ @ 0]]
