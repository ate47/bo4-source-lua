...
CoD.PurchaseContractConfirmation = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.PurchaseContractConfirmation = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "PurchaseContractConfirmation", f1_arg0 ) --[[ @ 0]]
	...
	self:setClass( CoD.PurchaseContractConfirmation ) --[[ @ 0]]
