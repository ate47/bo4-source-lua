...
LUI.createMenu.wz_revive_prompt = function ( f1_arg0, f1_arg1 )
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f6_local0 then
					if not CoD.ModelUtility.IsControllerModelValueEqualToSelfModelValue( element, f1_arg0, "hudItems.laststand.revivingClientNum", "clientNum" ) and not Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"] ) then
						f6_local0 = not Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"] ) --[[ @ 0]]
					else
						f6_local0 = false --[[ @ 0]]
					end
				end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f7_local0 --[[ @ 0]]
				if not CoD.ModelUtility.IsControllerModelValueEqualToSelfModelValue( element, f1_arg0, "hudItems.laststand.revivingClientNum", "clientNum" ) and not Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"] ) then
					f7_local0 = not Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"] ) --[[ @ 0]]
				else
					f7_local0 = false --[[ @ 0]]
				end
				return f7_local0
	...
	local f1_local8 = Engine[@"hash_E4D2F32833CFA6C"]( Engine[@"GetClientNum"]( f1_arg0 ) ) --[[ @ 0]]
	...
	f1_local7 = self.subscribeToModel --[[ @ 0]]
	f1_local8 = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	f1_local7( f1_local6, f1_local8["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"]], function ( f13_arg0 )
		f1_local1:updateElementState( self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local7 = self.subscribeToModel --[[ @ 0]]
	f1_local8 = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	f1_local7( f1_local6, f1_local8["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"]], function ( f14_arg0 )
		f1_local1:updateElementState( self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
