...
LUI.createMenu.WZPersonalizeCharacter = function ( f1_arg0, f1_arg1 )
	...
	outfitsPC:linkToElementModel( outfitsPC, "itemType", true, function ( model, f4_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f4_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	outfitsPC:linkToElementModel( outfitsPC, "itemIndex", true, function ( model, f6_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f6_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	outfitsPC:appendEventHandler( "input_source_changed", function ( f7_arg0, f7_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f7_arg0, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_local8( f1_local7, themesPC.LastInput, function ( f8_arg0, f8_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f8_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( outfitsPC, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( outfitsPC, f1_arg0, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_remove", function ( element, menu, controller, model )
	...
	outfitsPC:AddContextualMenuAction( f1_local1, f1_arg0, @"hash_1679ACA6FFC6C8F3", function ( f18_arg0, f18_arg1, f18_arg2, f18_arg3 )
