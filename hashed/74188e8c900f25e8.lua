...
CoD.ZMLoadoutUtility.GetZombieStartWeapons = function ()
	...
	local f1_local0 = Engine[@"hash_2E00B2F29271C60B"]( @"zmstartweapontable" ) --[[ @ 0]]
...
CoD.ZMLoadoutUtility.AnySecondaryWeaponIsRestricted = function ()
	local f5_local0 = CoD.CACUtility.GetUnlockableItemsForLoadoutSlot( Enum[@"emodes"][@"mode_zombies"], "secondary" ) --[[ @ 0]]
	local f5_local1 = {} --[[ @ 0]]
...
CoD.ZMLoadoutUtility.GetLoadoutStorageBuffer = function ( f8_arg0 )
	local f8_local0 = Enum[@"storagefiletype"][@"storage_zm_loadouts_offline"] --[[ @ 0]]
	if not IsLocal() then
		if IsCustomLobby() then
			f8_local0 = Enum[@"storagefiletype"][@"hash_33376D9E1C3C8130"] --[[ @ 0]]
		else
			f8_local0 = Enum[@"storagefiletype"][@"storage_zm_loadouts"] --[[ @ 0]]
		end
	end
...
CoD.ZMLoadoutUtility.GetVariantSlot = function ( f9_arg0, f9_arg1, f9_arg2 )
	...
	if not f9_local1 and f9_arg2 then
		...
		f9_local1.paintjobSlot:set( Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
	end
...
CoD.ZMLoadoutUtility.SetWeaponOptionForVariant = function ( f26_arg0, f26_arg1, f26_arg2, f26_arg3 )
	...
	if f26_local0 and f26_local1 and f26_local2 then
		...
		elseif f26_local5 == Enum[@"eweaponoptiongroup"][@"weaponoption_group_camo"] then
			...
			local f26_local9 = Engine[@"hash_79F0BB7D52A7A978"]( CoD.CACUtility.GetUnlockableItemInfoField( f26_local6, Enum[@"emodes"][@"mode_zombies"], "nameHash" ) ) --[[ @ 0]]
	...
	if f27_local3 then
		...
		if not f27_local4 then
			...
			elseif f27_local4 == Enum[@"eweaponoptiongroup"][@"weaponoption_group_paintjob"] then
				f27_local2.paintjobSlot:set( Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
			end
			CoD.WeaponOptionsUtility.UpdateWeaponOptionLists( f27_arg1, f27_arg2 ) --[[ @ 0]]
		end
	end
	f27_local4 = Enum[@"eweaponoptiongroup"][@"weaponoption_group_invalid"] --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.ZMLoadoutUtility.GetMutuallyExclusiveArmoryAttachments = function ( f31_arg0, f31_arg1, f31_arg2, f31_arg3, f31_arg4 )
	...
	if f31_local2 then
		...
		local f31_local4 = Engine[@"hash_2B8DE256555CACF5"]( f31_arg1, f31_arg2, f31_arg3 ) == Enum[@"eattachmentgroup"][@"hash_26EE211053211305"] --[[ @ 0]]
		...
		for f31_local6 = 0 --[[ @ 0]], #f31_local2 - 1, 1 do
			...
			if CoD.CACUtility.EmptyItemIndex < f31_local9 and f31_arg2 ~= f31_local9 then
				...
				if f31_local5 then
					...
					local f31_local11 = Engine[@"hash_2B8DE256555CACF5"]( f31_arg1, f31_local9, f31_arg3 ) == Enum[@"eattachmentgroup"][@"hash_26EE211053211305"] --[[ @ 0]]
...
CoD.ZMLoadoutUtility.UpdateEquippedWeaponAttachmentAttributes = function ( f35_arg0, f35_arg1, f35_arg2 )
	local f35_local0 = Enum[@"weaponattributescolumn"][@"weaponattributes_reference"] --[[ @ 0]]
	local f35_local1 = Enum[@"weaponattributescolumn"][@"weaponattributes_weapon_name"] --[[ @ 0]]
	local f35_local2 = Enum[@"weaponattributescolumn"][@"weaponattributes_damage"] --[[ @ 0]]
	local f35_local3 = Enum[@"weaponattributescolumn"][@"weaponattributes_range"] --[[ @ 0]]
	local f35_local4 = Enum[@"weaponattributescolumn"][@"weaponattributes_fire_rate"] --[[ @ 0]]
	local f35_local5 = Enum[@"weaponattributescolumn"][@"weaponattributes_accuracy"] --[[ @ 0]]
	local f35_local6 = Engine[@"hash_7B98952F69D937F9"]( f35_arg1, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f35_arg2 ) --[[ @ 0]]
	local f35_local7 = {
		damage = 0,
		range = 0,
		fireRate = 0,
...
CoD.ZMLoadoutUtility.GetArmoryWeaponAttachmentList = function ( f36_arg0, f36_arg1, f36_arg2, f36_arg3, f36_arg4, f36_arg5 )
	local f36_local0 = {} --[[ @ 0]]
	local f36_local1 = Engine[@"getunlockableitemkvpinfo"]( f36_arg2, f36_arg5 ) --[[ @ 0]]
	...
	for f36_local5 = 1 --[[ @ 0]], f36_local2 - 1, 1 do
		...
		if f36_local8 > CoD.CACUtility.EmptyItemIndex then
			...
			if f36_local9 ~= "ir" then
				...
				local f36_local21 = f36_local14 == Enum[@"eattachmentgroup"][@"hash_26EE211053211305"] --[[ @ 0]]
...
CoD.ZMLoadoutUtility.GetEquippedArmoryAttachments = function ( f39_arg0, f39_arg1, f39_arg2 )
	...
	local f39_local4 = {} --[[ @ 0]]
	if f39_local0 then
		local f39_local5 = Engine[@"getunlockableitemkvpinfo"]( f39_arg1, f39_arg2 ) --[[ @ 0]]
		...
		if f39_local7 then
			for f39_local8 = 0 --[[ @ 0]], #f39_local7 - 1, 1 do
				...
				if f39_local11 ~= CoD.CACUtility.EmptyItemIndex then
					...
					local f39_local17 = f39_local14 == Enum[@"eattachmentgroup"][@"hash_26EE211053211305"] --[[ @ 0]]
...
CoD.ZMLoadoutUtility.SetupBGBLoadout = function ( f43_arg0, f43_arg1, f43_arg2, f43_arg3 )
	...
	for f43_local6, f43_local7 in pairs( CoD.ZMLoadoutUtility.BGBSlotPositions ) --[[ @ 0]] do
		...
		local f43_local9 = Engine[@"hash_1E8B1E317B9DD6FE"]( f43_local8, Enum[@"statindexoffset"][@"hash_648CD0338EE0B3AE"], Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
		local f43_local10 = CoD.CACUtility.GetUnlockableItemInfo( f43_local9, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
		...
		local f43_local3 = CoD.CACUtility.AreElixirGameSettingsRestricted( f43_local11, f43_local10[@"bgbrarity"], false ) --[[ @ 0]]
...
DataSources.BGBCategories = ListHelper_SetupDataSource( "BGBCategories", function ( f45_arg0 )
	...
	local f45_local3 = Engine[@"hash_487395843D470BE2"]( f45_local2, Enum[@"statindexoffset"][@"hash_648CD0338EE0B3AE"], Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
	local f45_local4 = Engine[@"getitemgroup"]( f45_local2, Enum[@"statindexoffset"][@"hash_648CD0338EE0B3AE"], Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
...
DataSources.ArmoryWeaponAttachments = ListHelper_SetupDataSource( "ArmoryWeaponAttachments", function ( f49_arg0, f49_arg1, f49_arg2 )
	...
	if f49_arg1.menu then
		...
		f49_local4 = Engine[@"hash_7B98952F69D937F9"]( f49_local3, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f49_local0 ) --[[ @ 0]]
...
CoD.ZMLoadoutUtility.SetEquippedBubbleGumPackToSelectedClass = function ( f51_arg0, f51_arg1, f51_arg2 )
	...
	if f51_local0 == nil and IsZombies() then
		f51_local0 = Enum[@"emodes"][@"mode_zombies"] --[[ @ 0]]
	end
...
CoD.ZMLoadoutUtility.PreviewBubbleGumPack = function ( f52_arg0, f52_arg1, f52_arg2 )
	...
	if f52_local0 == nil and IsZombies() then
		f52_local0 = Enum[@"emodes"][@"mode_zombies"] --[[ @ 0]]
	end
...
CoD.ZMLoadoutUtility.SaveZMLoadoutBuffer = function ( f55_arg0 )
	local f55_local0 = Enum[@"storagefiletype"][@"storage_zm_loadouts_offline"] --[[ @ 0]]
	if not IsLocal() then
		if IsCustomLobby() then
			f55_local0 = Enum[@"storagefiletype"][@"hash_33376D9E1C3C8130"] --[[ @ 0]]
		else
			f55_local0 = Enum[@"storagefiletype"][@"storage_zm_loadouts"] --[[ @ 0]]
		end
	end
...
CoD.ZMLoadoutUtility.UpdateArmoryWeaponModel = function ( f67_arg0, f67_arg1, f67_arg2 )
	...
	if f67_local3 and f67_local3.itemIndex then
		...
		f67_local2 = Engine[@"hash_7B98952F69D937F9"]( f67_local4, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f67_local0 ) --[[ @ 0]]
	end
...
CoD.ZMLoadoutUtility.SetShowcaseWeapon = function ( f75_arg0, f75_arg1, f75_arg2 )
	...
	local f75_local1 = Enum[@"hash_DFC2505E609427C"][@"category_zombies"] --[[ @ 0]]
	...
	if f75_local2 and f75_local2.itemIndex then
		...
		Engine[@"setheroshowcaseweaponattribute"]( f75_arg1, f75_local0, f75_local1, @"weaponindex", f75_local3 ) --[[ @ 0]]
		local f75_local4 = CoD.ZMLoadoutUtility.GetVariantSlot( f75_arg1, f75_local3, false ) --[[ @ 0]]
		if f75_local4 then
			Engine[@"setheroshowcaseweaponattribute"]( f75_arg1, f75_local0, f75_local1, @"camoindex", f75_local4.camoIndex:get() ) --[[ @ 0]]
			Engine[@"setheroshowcaseweaponattribute"]( f75_arg1, f75_local0, f75_local1, @"weaponmodelslot", f75_local4.weaponModelSlot:get() ) --[[ @ 0]]
		end
	end
...
CoD.ZMLoadoutUtility.ShowBubblegumBuffModel = function ( f76_arg0, f76_arg1, f76_arg2, f76_arg3 )
	...
	if f76_local0 then
		...
		local f76_local3 = Engine[@"getitemgroup"]( f76_local1, Enum[@"statindexoffset"][@"hash_648CD0338EE0B3AE"], Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
		...
		local f76_local8 = CoD.CACUtility.GetUnlockableItemInfo( f76_local2, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
		if f76_local8 then
			f76_local6 = f76_local8[@"previewmodelname"] or @"hash_0" --[[ @ 0]]
			f76_local7 = f76_local8[@"previewmodelscale"] or 1 --[[ @ 0]]
		end
...
CoD.ZMLoadoutUtility.EquipBubblegumBuff = function ( f78_arg0, f78_arg1, f78_arg2 )
	...
	Engine[@"hash_498954175CA6A32C"]( f78_local6[f78_local7.globalItemIndex:get()][@"equipsound"] ) --[[ @ 0]]
...
CoD.ZMLoadoutUtility.GetUnlockDescriptionForFeature = function ( f96_arg0, f96_arg1, f96_arg2 )
	local f96_local0 = Enum[@"emodes"][@"mode_zombies"] --[[ @ 0]]
...
CoD.ZMLoadoutUtility.GetUnlockRankIconLargeForFeature = function ( f97_arg0, f97_arg1 )
	local f97_local0 = Enum[@"emodes"][@"mode_zombies"] --[[ @ 0]]
...
CoD.ZMLoadoutUtility.GetEquippedSignatureWeaponImage = function ( f99_arg0, f99_arg1, f99_arg2 )
	if f99_arg0.useVariantSlot and f99_arg0.useVariantSlot:get() > 0 then
		...
		if f99_local1 and f99_local1 > 0 then
			local f99_local2 = CoD.CACUtility.GetUnlockableItemInfo( f99_local0, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
			local f99_local3 = f99_local2.zmPreviewImage --[[ @ 0]]
			local f99_local4 = Engine[@"hash_79F0BB7D52A7A978"]( Engine[@"hash_7B98952F69D937F9"]( f99_local0, Enum[@"statindexoffset"].STATINDEXOFFSET_WEAPON, Enum[@"emodes"][@"mode_zombies"] ) ) --[[ @ 0]]
			local f99_local5 = f99_local4[f99_local1 + 1] --[[ @ 0]]
			if f99_local5 and f99_local5[@"hash_5C2AA73D9F82E9C2"] and f99_local5[@"ismark2"] then
				f99_local3 = f99_local5[@"imagezm"] or f99_local3 --[[ @ 0]]
			end
			return f99_local3
		else
			local f99_local2 = CoD.CACUtility.GetUnlockableItemInfo( f99_local0, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
...
CoD.ZMLoadoutUtility.GetEquippedSignatureWeaponName = function ( f100_arg0, f100_arg1, f100_arg2 )
	if f100_arg0.useVariantSlot and f100_arg0.useVariantSlot:get() > 0 then
		...
		if f100_local1 and f100_local1 > 0 then
			local f100_local2 = Engine[@"hash_4F9F1239CFD921FE"]( Engine[@"getitemname"]( f100_local0, Enum[@"statindexoffset"].STATINDEXOFFSET_WEAPON, Enum[@"emodes"][@"mode_zombies"] ) ) --[[ @ 0]]
			local f100_local3 = Engine[@"hash_79F0BB7D52A7A978"]( Engine[@"hash_7B98952F69D937F9"]( f100_local0, Enum[@"statindexoffset"].STATINDEXOFFSET_WEAPON, Enum[@"emodes"][@"mode_zombies"] ) ) --[[ @ 0]]
			...
			if f100_local4 then
				if f100_local4[@"hash_5C2AA73D9F82E9C2"] and f100_local4[@"ismark2"] then
					if f100_local4[@"displayname"] then
						f100_local2 = Engine[@"hash_4F9F1239CFD921FE"]( f100_local4[@"displayname"] ) or f100_local2 --[[ @ 0]]
					end
				else
			...
			local f100_local2 = CoD.CACUtility.GetUnlockableItemInfo( f100_local0, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
...
CoD.ZMLoadoutUtility.IsCACItemBubbleGum = function ( f108_arg0, f108_arg1, f108_arg2 )
	...
	if f108_local1 and f108_local1.itemIndex then
		...
		if CoD.CACUtility.EmptyItemIndex < f108_local2 then
			local f108_local3 = Engine[@"getitemgroup"]( f108_local2, Enum[@"statindexoffset"][@"hash_648CD0338EE0B3AE"], f108_local0 ) --[[ @ 0]]
...
CoD.ZMLoadoutUtility.ShouldHideLoadoutPreviewSelectButton = function ( f110_arg0, f110_arg1, f110_arg2, f110_arg3, f110_arg4 )
	...
	if f110_local2 and f110_local2.classNum then
		f110_local1 = CoD.CACUtility.IsFeatureItemLocked( f110_arg2, CoD.CACUtility.GetClassesUnlockableItemUnlockInfo( f110_local2.classNum:get(), "featureItemIndex" ), Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
	end
	return f110_local0 or f110_local1
end
 --[[ @ 0]]
CoD.ZMLoadoutUtility.IsCurrentPreviewClassLocked = function ( f111_arg0, f111_arg1 )
	local f111_local0 = Enum[@"emodes"][@"mode_zombies"] --[[ @ 0]]
...
CoD.ZMLoadoutUtility.IsAttachmentMutuallyExclusiveWithSelection = function ( f116_arg0, f116_arg1, f116_arg2 )
	local f116_local0 = Enum[@"emodes"][@"mode_zombies"] --[[ @ 0]]
