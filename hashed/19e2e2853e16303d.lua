...
Lobby.Test.PreTargetSettings = function ( f1_arg0 )
	if f1_arg0.playlistID ~= nil then
		Engine[@"setplaylistid"]( f1_arg0.playlistID ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
Lobby.Test.ProcessFunction = function ()
	...
	local f2_local2 = Engine[@"getlobbyuiscreen"]() --[[ @ 0]]
	if Lobby.Test.currentTest.state == Lobby.Test.STATE.NOT_STARTED then
		...
		elseif f2_local3.gameTimeout == nil then
			...
			Lobby.Test.gameTimeoutDeadline = Engine[@"milliseconds"]() + f2_local3.gameTimeout * 1000 --[[ @ 0]]
		end
...
Lobby.Test.Pump = function ()
	...
	if Lobby.Test.gameTimeout ~= -1 then
		if Engine[@"isingame"]() then
			Lobby.Test.gameTimeoutDeadline = Engine[@"milliseconds"]() + Lobby.Test.gameTimeout * 1000 --[[ @ 0]]
		elseif Engine[@"milliseconds"]() > Lobby.Test.gameTimeoutDeadline then
			Lobby.Test.currentTest.state = Lobby.Test.STATE.NOT_STARTED --[[ @ 0]]
			Lobby.Test.gameTimeout = -1 --[[ @ 0]]
			Engine[@"comerror"]( Enum[@"errorcode"][@"error_softrestart"], "Not in a game for longer than timeout." ) --[[ @ 0]]
		end
	end
end
 --[[ @ 0]]
