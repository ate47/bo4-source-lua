...
CoD.AARRewardContractDesc = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AARRewardContractDesc.__defaultWidth = 380 --[[ @ 0]]
CoD.AARRewardContractDesc.__defaultHeight = 182 --[[ @ 0]]
CoD.AARRewardContractDesc.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARRewardContractDesc ) --[[ @ 0]]
	self.id = "AARRewardContractDesc" --[[ @ 0]]
	...
	local Description = LUI.UIText.new( 0.5, 0.5, -171, 89, 0, 0, 51, 69 ) --[[ @ 0]]
	...
	local Title = LUI.UIText.new( 0.5, 0.5, -171, 89, 0, 0, 24.5, 45.5 ) --[[ @ 0]]
