...
CoD.DecalListFrame = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.DecalListFrame.__defaultWidth = 1820 --[[ @ 0]]
CoD.DecalListFrame.__defaultHeight = 965 --[[ @ 0]]
CoD.DecalListFrame.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DecalListFrame ) --[[ @ 0]]
	self.id = "DecalListFrame" --[[ @ 0]]
	...
	self:linkToElementModel( self, nil, true, function ( model )
		...
		CoD.GridAndListUtility.SetFocusToFirstSelectableItem( self.emblemIconList ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	if IsPC() then
		...
		CoD.GridAndListUtility.SetFocusableBackingWidgetOnPC( f1_local4 ) --[[ @ 0]]
	end
	return self
end
 --[[ @ 0]]
