...
CoD.StartMenu_ChangeTeam.new = function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3, f6_arg4, f6_arg5, f6_arg6, f6_arg7, f6_arg8, f6_arg9 )
	...
	buttonList:setAlignment( Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"] ) --[[ @ 0]]
	...
	buttonList:linkToElementModel( buttonList, "disabled", true, function ( model, f7_arg1 )
		CoD.Menu.UpdateButtonShownState( f7_arg1, f6_arg0, f6_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	buttonList:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f6_arg0, f6_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
		return f8_local0
	end ) --[[ @ 0]]
	f6_arg0:AddButtonCallbackFunction( buttonList, f6_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		...
		if not CoD.ModelUtility.IsSelfModelValueTrue( element, controller, "disabled" ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_72641978FD3DC17A", nil, "ui_confirm" ) --[[ @ 0]]
			return true
		else
			return false
		end
