...
CoD.StartMenuUtility.GetSessionModeFromLobby = function ()
	...
	if not f1_local1 then
		f1_local1 = Enum[@"emodes"][@"mode_invalid"] --[[ @ 0]]
	end
	return f1_local1
end
 --[[ @ 0]]
CoD.StartMenuUtility.InitDataForStartMenu = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	CoD.BreadcrumbUtility.SetClientStorageBufferForMode( f2_arg1, f2_arg2, Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
...
CoD.StartMenuUtility.SetLoadoutStorageBufferForMenu = function ( f8_arg0, f8_arg1 )
	...
	local f8_local1 = Enum[@"storagefiletype"][@"storage_mp_loadouts"] --[[ @ 0]]
	if f8_local0 == Enum[@"emodes"][@"mode_zombies"] then
		f8_local1 = Enum[@"storagefiletype"][@"storage_zm_loadouts"] --[[ @ 0]]
	elseif f8_local0 == Enum[@"emodes"][@"mode_warzone"] then
		f8_local1 = Enum[@"storagefiletype"][@"storage_wz_loadouts"] --[[ @ 0]]
	end
...
DataSources.StartMenuTabs = ListHelper_SetupDataSource( "StartMenuTabs", function ( f17_arg0, f17_arg1 )
	...
	if IsGameTypeDOA() and Engine[@"isingame"]() then
		...
		local f17_local7 = Dvar[@"ui_execdemo"]:get() --[[ @ 0]]
		if f17_local7 then
	...
	elseif not CoD.isPC then
		...
		local f17_local7 = Dvar[@"ui_execdemo_gamescom"]:get() --[[ @ 0]]
		if f17_local7 then
			f17_local7 = not Engine[@"isingame"]() --[[ @ 0]]
		end
		f17_local6.selectIndex = f17_local7 --[[ @ 0]]
...
CoD.StartMenuUtility.GetArenaQuitPenaltyText = function ( f22_arg0, f22_arg1 )
	...
	local f22_local1 = Engine[@"hash_2E00B2F29271C60B"]( @"arena_event_league_play_default" ) --[[ @ 0]]
	if f22_local1 then
...
CoD.StartMenuUtility.GetArenaQuitDeservesExtraPenalty = function ( f24_arg0 )
	if LuaUtils.IsArenaPublicGame() then
		...
		local f24_local1 = Engine[@"hash_2E00B2F29271C60B"]( @"arena_event_league_play_default" ) --[[ @ 0]]
		if f24_local1 then
...
CoD.StartMenuUtility.GetArenaQuitPopupDesc = function ( f25_arg0 )
	local f25_local0 = Engine[@"hash_2E00B2F29271C60B"]( @"arena_event_league_play_default" ) --[[ @ 0]]
	if f25_local0 then
...
CoD.StartMenuUtility.QuitGameWarningPrompt = function ( f26_arg0, f26_arg1 )
	CoD.OverlayUtility.AddAutoDetectOverlay( "QuitWarningPopup", {
		title = function ()
			local f27_local0 = @"menu/quit_game" --[[ @ 0]]
			if not CoD.isOnlineGame() then
				f27_local0 = @"menu/end_game" --[[ @ 0]]
			end
		...
		options = function ( f32_arg0, f32_arg1 )
			...
			local f32_local1 = @"menu/quit_match" --[[ @ 0]]
			if not CoD.isOnlineGame() then
				f32_local1 = @"menu/end_game" --[[ @ 0]]
			end
			table.insert( f32_local0, {
