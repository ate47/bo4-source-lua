...
CoD.StartMenu_Options_PrivacySettingsManagementForm.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	PrivacySettingsOptions:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	...
	Title( Body, DescriptionText.updateProgressState, function ( f2_arg0, f2_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f2_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f2_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	Title( Body, DescriptionText.currentPage, function ( f3_arg0, f3_arg1 )
		CoD.Menu.UpdateButtonShownState( f3_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f3_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	Body = PrivacySettingsOptions --[[ @ 0]]
	Title = PrivacySettingsOptions.subscribeToModel --[[ @ 0]]
	DescriptionText = DataSources.PrivacySettingManagementForm.getModel( f1_arg1 ) --[[ @ 0]]
	Title( Body, DescriptionText.lastPage, function ( f4_arg0, f4_arg1 )
		CoD.Menu.UpdateButtonShownState( f4_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	PrivacySettingsOptions:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( element, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		return f6_local0
	end ) --[[ @ 0]]
