...
CoD.directorCustom.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	SetUpMatchButton:appendEventHandler( "on_session_end", function ( f33_arg0, f33_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f33_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	ZMLoadoutPreviewInfo = SetUpMatchButton --[[ @ 0]]
	StartButton = SetUpMatchButton.subscribeToModel --[[ @ 0]]
	DirectorLobbyPoseMembersZM = Engine[@"GetGlobalModel"]() --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( SetUpMatchButton, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	StartButton.PlayText:setText( LocalizeToUpperString( @"hash_6DDDA371285672BD" ) ) --[[ @ 0]]
	StartButton.PlayTextFocus:setText( LocalizeToUpperString( @"hash_6DDDA371285672BD" ) ) --[[ @ 0]]
	StartButton:appendEventHandler( "on_session_start", function ( f52_arg0, f52_arg1 )
		f52_arg1.menu = f52_arg1.menu or f1_arg0 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f52_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	ZMLoadoutPreviewInfo( DirectorLobbyPoseMembersZM, CustomGamesButton["lobbyRoot.selectedMapId"], function ( f57_arg0, f57_arg1 )
		CoD.Menu.UpdateButtonShownState( f57_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	DirectorLobbyPoseMembersZM = StartButton --[[ @ 0]]
	ZMLoadoutPreviewInfo = StartButton.subscribeToModel --[[ @ 0]]
	CustomGamesButton = Engine[@"GetGlobalModel"]() --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( StartButton, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	DirectorLobbySettingList( DirectorLaboratoryButton, f1_local15["lobbyRoot.lobbyNav"], function ( f74_arg0, f74_arg1 )
		CoD.Menu.UpdateButtonShownState( f74_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
