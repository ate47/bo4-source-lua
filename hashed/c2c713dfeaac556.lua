...
CoD.PurchaseNoDupeCrate = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.PurchaseNoDupeCrate = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "PurchaseNoDupeCrate", f1_arg0 ) --[[ @ 0]]
	...
	self:setClass( CoD.PurchaseNoDupeCrate ) --[[ @ 0]]
	...
	FullscreenPopupTemplate:linkToElementModel( self, "price", true, function ( model )
		...
		if f7_local0 ~= nil then
			FullscreenPopupTemplate.Subtitle:setText( LocalizeIntoString( @"hash_663A994CC66A0901", f7_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	FullscreenPopupTemplate:linkToElementModel( self, "name", true, function ( model )
		local f8_local0 = model:get() --[[ @ 0]]
		if f8_local0 ~= nil then
			FullscreenPopupTemplate.Title:setText( ToUpper( CoD.BlackMarketUtility.NoDupeTitleString( self, f1_arg0, f8_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	FixedAspectRatioImage:linkToElementModel( self, "popupImage", true, function ( model )
		...
		if f10_local0 ~= nil then
			FixedAspectRatioImage:setImage( RegisterImage( f10_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	Price:linkToElementModel( self, "price", true, function ( model )
		...
		if f11_local0 ~= nil then
			Price:setText( CoD.BlackMarketUtility.NoDupePriceString( self:getModel(), f11_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	local ItemName = LUI.UIText.new( 0.5, 0.5, -891, -371, 0.5, 0.5, 153, 193 ) --[[ @ 0]]
	...
	ItemName:linkToElementModel( self, "name", true, function ( model )
		...
		if f14_local0 ~= nil then
			ItemName:setText( LocalizeToUpperString( f14_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	self:addElement( ItemName ) --[[ @ 0]]
	self.ItemName = ItemName --[[ @ 0]]
	
	local BracketLeft = LUI.UIImage.new( 0.5, 0.5, -915, -891, 0.5, 0.5, 137, 209 ) --[[ @ 0]]
	...
	local BracketRight = LUI.UIImage.new( 0.5, 0.5, -371, -347, 0.5, 0.5, 137, 209 ) --[[ @ 0]]
	...
	local f1_local15 = DataSources.ReservesItemCounts.getModel( f1_arg0 ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], nil, function ( element, menu, controller, model )
		...
		elseif not IsElementInState( self.FullscreenPopupTemplate, "FinishedState" ) and CoD.BlackMarketUtility.CanPurchaseNoDupeCrate( controller, menu ) then
			CoD.BlackMarketUtility.AttemptPurchaseNoDupeCrate( self, element, controller, menu ) --[[ @ 0]]
			return true
		else
		...
		if IsElementInState( self.FullscreenPopupTemplate, "ErrorState" ) then
			...
			return true
		elseif not IsElementInState( self.FullscreenPopupTemplate, "FinishedState" ) and CoD.BlackMarketUtility.CanPurchaseNoDupeCrate( controller, menu ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xba_pscross"], @"hash_2EAFD07CB9BF59C5", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	if IsPC() then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput( f1_local1, f1_arg0, f1_local14, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
	end
	return self
end
 --[[ @ 0]]
