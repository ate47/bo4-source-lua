...
CoD.ControllerDependent_TextBoxLargeGamepad.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	KBMText:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_393E719493E9E18F" ) ) --[[ @ 0]]
	KBMText:setTTF( "ttmussels_demibold" ) --[[ @ 0]]
	KBMText:setLetterSpacing( -2 ) --[[ @ 0]]
	KBMText:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	KBMText:setAlignment( Enum[@"LUIAlignment"][@"hash_6ED4298C93DC5ED"] ) --[[ @ 0]]
	self:addElement( KBMText ) --[[ @ 0]]
	self.KBMText = KBMText --[[ @ 0]]
	
	local GamepadText = LUI.UIText.new( -0.2, 1.2, 0, 0, -0.2, 1.2, 0, 0 ) --[[ @ 0]]
	GamepadText:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_393E719493E9E18F" ) ) --[[ @ 0]]
	GamepadText:setTTF( "default" ) --[[ @ 0]]
	GamepadText:setLetterSpacing( -1 ) --[[ @ 0]]
	GamepadText:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_local5( f1_local4, f1_local6["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f4_arg0 )
	...
	f1_local5( f1_local4, f1_local6["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f5_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
