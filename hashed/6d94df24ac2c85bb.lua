...
require( "x64:18092b0c86b8a86c" ) --[[ @ 0]]
...
CoD.DirectorLobbyMemberNeverExpand = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.DirectorLobbyMemberNeverExpand.__defaultWidth = 68 --[[ @ 0]]
CoD.DirectorLobbyMemberNeverExpand.__defaultHeight = 68 --[[ @ 0]]
CoD.DirectorLobbyMemberNeverExpand.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DirectorLobbyMemberNeverExpand ) --[[ @ 0]]
	self.id = "DirectorLobbyMemberNeverExpand" --[[ @ 0]]
	...
	local DirectorLobbyMemberInternal = CoD.DirectorLobbyMemberInternalNeverExpand.new( f1_arg0, f1_arg1, 0, 0, 0, 68, 0, 0, 0, 68 ) --[[ @ 0]]
	...
	contextualMenuFocus:linkToElementModel( self, nil, false, function ( model )
		contextualMenuFocus:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	DirectorPartyBar:linkToElementModel( self, "info", true, function ( model )
		...
		if f4_local0 ~= nil then
			DirectorPartyBar:setModel( f4_local0, f1_arg1 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	DirectorPartyLeader:linkToElementModel( self, "info", true, function ( model )
		...
		if f5_local0 ~= nil then
			DirectorPartyLeader:setModel( f5_local0, f1_arg1 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	self:appendEventHandler( "input_source_changed", function ( f12_arg0, f12_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f12_arg0, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local6 = self --[[ @ 0]]
	f1_local7 = self.subscribeToModel --[[ @ 0]]
...
CoD.DirectorLobbyMemberNeverExpand.__clipsPerState = {
	...
	FirstEmpty = {
		DefaultClip = function ( f20_arg0, f20_arg1 )
			...
			f20_arg0.DirectorCustomStartButton:setAlpha( 1 ) --[[ @ 0]]
			f20_arg0.clipFinished( f20_arg0.DirectorCustomStartButton ) --[[ @ 0]]
			f20_arg0.DirectorLobbyMemberInternal:completeAnimation() --[[ @ 0]]
			f20_arg0.DirectorLobbyMemberInternal:setAlpha( 0 ) --[[ @ 0]]
			f20_arg0.clipFinished( f20_arg0.DirectorLobbyMemberInternal ) --[[ @ 0]]
		end,
		...
		LoseChildFocus = function ( f24_arg0, f24_arg1 )
			...
			f24_arg0.DirectorCustomStartButton:setAlpha( 1 ) --[[ @ 0]]
			f24_arg0.DirectorCustomStartButton:setScale( 1.05, 1.05 ) --[[ @ 0]]
			f24_local0( f24_arg0.DirectorCustomStartButton ) --[[ @ 0]]
			f24_arg0.DirectorLobbyMemberInternal:completeAnimation() --[[ @ 0]]
			f24_arg0.DirectorLobbyMemberInternal:setAlpha( 0 ) --[[ @ 0]]
			f24_arg0.clipFinished( f24_arg0.DirectorLobbyMemberInternal ) --[[ @ 0]]
		end
	},
	Empty = {
		DefaultClip = function ( f26_arg0, f26_arg1 )
			...
			f26_arg0.DirectorLobbyMemberInternal:completeAnimation() --[[ @ 0]]
			f26_arg0.DirectorLobbyMemberInternal:setAlpha( 0 ) --[[ @ 0]]
			f26_arg0.clipFinished( f26_arg0.DirectorLobbyMemberInternal ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.DirectorLobbyMemberNeverExpand.__onClose = function ( f27_arg0 )
	f27_arg0.DirectorCustomStartButton:close() --[[ @ 0]]
	f27_arg0.DirectorLobbyMemberInternal:close() --[[ @ 0]]
	f27_arg0.contextualMenuFocus:close() --[[ @ 0]]
	f27_arg0.DirectorPartyBar:close() --[[ @ 0]]
	f27_arg0.DirectorPartyLeader:close() --[[ @ 0]]
end
 --[[ @ 0]]
