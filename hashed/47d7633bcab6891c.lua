...
LUI.createMenu.LightmanColorPicker = function ( f2_arg0, f2_arg1 )
	...
	ColorPicker:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	ColorPicker:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f2_local1, f2_arg0, Enum[@"luibutton"][@"lui_key_start"] ) --[[ @ 0]]
		return f4_local0
	end ) --[[ @ 0]]
