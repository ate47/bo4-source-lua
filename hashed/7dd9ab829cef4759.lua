	...
	DoubleXPIcon:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return CoD.DoubleXPUtility.CurrentPlaylistHasDoubleXP( f1_arg1 ) and CoD.DoubleXPUtility.CurrentPlaylistHasMainMode( f1_arg1, Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] )
			end
		},
		{
			stateName = "Visible",
