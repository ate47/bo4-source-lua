...
Lobby.JSON.GetMappackBitsForName = function ( f2_arg0 )
	...
	if f2_arg0 == "MP_ORIGINAL_MAPS" then
		f2_local0 = Enum[@"contentflagbits"][@"content_originalmaps"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_1" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc0zm"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_2" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc2mp"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_3" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc1zm"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_4" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc3mp"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_5" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc2zm"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_6" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc4mp"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_7" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc3zm"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_8" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc5mp"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_9" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc4zm"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_10" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc6mp"] --[[ @ 0]]
	elseif f2_arg0 == "DLC_11" then
		f2_local0 = Enum[@"contentflagbits"][@"content_dlc5zm"] --[[ @ 0]]
	end
	return f2_local0
end
 --[[ @ 0]]
...
Lobby.JSON.ParseLobbyBackendDoc = function ( f23_arg0 )
	...
	if f23_local0 == nil then
		...
		Engine[@"comerror"]( Enum[@"errorcode"][@"error_softrestart"], "Lobby.JSON.ParseLobbyBackendDoc has failed, please email your logs to codcoreonline@treyarch.com" ) --[[ @ 0]]
	end
	return f23_local0
end
 --[[ @ 0]]
...
Lobby.JSON.ParseDCQoSInfo = function ( f25_arg0 )
	local f25_local0 = function ( f26_arg0, f26_arg1 )
		Engine[@"printerror"]( Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.ParseDCQoSInfo: " .. f26_arg1 ) --[[ @ 0]]
	...
	for f25_local8 = 1 --[[ @ 0]], f25_local6, 1 do
		...
		f25_local3 = tonumber( Engine[@"uint64tostring"]( f25_local3 ) ) --[[ @ 0]]
...
Lobby.JSON.CreatePlayerInfoDoc = function ( f27_arg0 )
	local f27_local0 = function ( f28_arg0, f28_arg1 )
		Engine[@"printerror"]( Enum[@"consolelabel_e"][@"con_label_live_matchmaking"], "Lobby.JSON.CreatePlayerInfoDoc: " .. f28_arg1 ) --[[ @ 0]]
	...
	local f27_local7 = Engine[@"getconnectiontype"]() == Enum[@"connectiontype_e"][@"connection_type_wireless"] --[[ @ 0]]
	local f27_local8 = "" --[[ @ 0]]
	local f27_local9 = "" --[[ @ 0]]
	local f27_local10 = {} --[[ @ 0]]
	...
	Lobby.JSON.BuildMapPackFlagsTable( f27_local10, Engine[@"getdlcbits"](), Engine[@"ownseasonpass"]( Engine[@"getprimarycontroller"]() ) ) --[[ @ 0]]
	...
	Engine[@"qosprobelistenerenable"]( true, f27_arg0.secIdKey.secIdInt64 ) --[[ @ 0]]
...
Lobby.JSON.CreateStartSearchParamDoc = function ( f29_arg0 )
	...
	local f29_local4 = Engine[@"getplaylistversionnumber"]() --[[ @ 0]]
	local f29_local5 = Engine[@"getplaylistid"]() --[[ @ 0]]
	local f29_local6 = Dvar[@"lobbymultiplaylistsearchenabled"]:exists() --[[ @ 0]]
	if f29_local6 then
		f29_local6 = Dvar[@"lobbymultiplaylistsearchenabled"]:get() --[[ @ 0]]
	end
	local f29_local7 = {} --[[ @ 0]]
	...
	if f29_local6 then
		...
		if f29_local10 then
			...
			for f29_local12 = 1 --[[ @ 0]], f29_local11, 1 do
				table.insert( f29_local7, Engine[@"getplaylistinfobyid"]( f29_local10[f29_local12]:get() ) ) --[[ @ 0]]
			end
	...
	local f29_local11 = Engine[@"getplaylistinfobyid"]( f29_local5 ) --[[ @ 0]]
	...
	elseif f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_wz"] then
		...
		local f29_local22 = Engine[@"hash_E00882E35AF63D2"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
		if f29_local22 ~= nil then
			f29_local15 = f29_local22.fillParty --[[ @ 0]]
		end
	end
	if LuaDefine.isPCClient and f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_mp"] and Dvar[@"hash_203617F20591CC64"]:exists() and Dvar[@"hash_203617F20591CC64"]:get() then
	...
	local f29_local28 = Engine[@"getlobbyuiscreen"]() --[[ @ 0]]
	...
	local f29_local33 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
	local f29_local34 = {} --[[ @ 0]]
		...
		if f29_local10 then
			...
			if not f29_local45 then
				...
				for f29_local48, f29_local49 in ipairs( f29_local33.sessionClients ) --[[ @ 0]] do
					local f29_local54 = Lobby.JSON.CreateFieldAndAddToLocation( f29_local29, f29_local43, Engine[@"uint64tostring"]( f29_local49.xuid ) ) --[[ @ 0]]
					f29_local54:setBool( "mic", f29_local49.VOIPStatus == Enum[@"evoipstatus"][@"voip_nottalking"] ) --[[ @ 0]]
					...
					if f29_local48 == 1 then
						...
						if f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_zm"] then
							f29_local52 = Engine[@"storagegetbuffer"]( f29_local51, Enum[@"storagefiletype"][@"storage_zm_stats_online"] ) --[[ @ 0]]
						elseif f29_local20[@"mainmode"] == Enum[@"lobbymainmode"][@"lobby_mainmode_mp"] then
							f29_local52 = Engine[@"storagegetbuffer"]( f29_local51, Enum[@"storagefiletype"][@"storage_mp_stats_online"] ) --[[ @ 0]]
						end
						if f29_local52 then
