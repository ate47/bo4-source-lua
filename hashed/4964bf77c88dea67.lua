	...
	DefaultState = {
		...
		GainFocus = function ( f9_arg0, f9_arg1 )
			...
			local f9_local4 = function ( f14_arg0 )
				f9_arg0.FocusBrackets:beginAnimation( 100, Enum[@"luitween"][@"luitween_ease_in"] ) --[[ @ 0]]
			...
			local f9_local5 = function ( f15_arg0 )
				f9_arg0.BGGlow:beginAnimation( 100, Enum[@"luitween"][@"luitween_ease_in"] ) --[[ @ 0]]
		...
		LoseFocus = function ( f17_arg0, f17_arg1 )
			...
			local f17_local4 = function ( f22_arg0 )
				f17_arg0.FocusBrackets:beginAnimation( 100, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
			...
			local f17_local6 = function ( f24_arg0 )
				f17_arg0.LabelButton:beginAnimation( 100, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
