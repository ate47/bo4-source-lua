...
require( "x64:73cbd518f629a732" ) --[[ @ 0]]

CoD.CustomGames_SettingButton = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.CustomGames_SettingButton.__defaultWidth = 500 --[[ @ 0]]
CoD.CustomGames_SettingButton.__defaultHeight = 60 --[[ @ 0]]
CoD.CustomGames_SettingButton.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.CustomGames_SettingButton ) --[[ @ 0]]
	self.id = "CustomGames_SettingButton" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	self.onlyChildrenFocusable = true --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local StartMenuOptionsSettingSlider = CoD.CustomGames_SettingButton_Internal.new( f1_arg0, f1_arg1, 0, 0, 0, 500, 0, 0, 0, 60 ) --[[ @ 0]]
