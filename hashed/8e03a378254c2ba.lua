...
CoD.AmmowidgetMP_HealCooldown.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	HeroAbilityUseString:mergeStateConditions( {
		{
			stateName = "Hidden",
			condition = function ( menu, element, event )
				local f13_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"] ) --[[ @ 0]]
				if not f13_local0 then
					f13_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"] ) --[[ @ 0]]
					if not f13_local0 then
						f13_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_5C57360571B0917E"] ) --[[ @ 0]]
					end
				end
				return f13_local0
			end
	...
	GlowRing( FlareBack, BountyHealthCount["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f18_arg0 )
	...
	GlowRing( FlareBack, BountyHealthCount["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f19_arg0 )
		f1_arg0:updateElementState( HeroAbilityUseString, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	GlowRing = HeroAbilityUseString.subscribeToModel --[[ @ 0]]
	BountyHealthCount = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	GlowRing( FlareBack, BountyHealthCount["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5C57360571B0917E"]], function ( f20_arg0 )
		f1_arg0:updateElementState( HeroAbilityUseString, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				return CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "state", Enum[@"hash_F0447219F15F7F3"][@"hash_958A6962CA8F9B7"] ) and CoD.ModelUtility.IsSelfModelValueLessThan( self, f1_arg1, "powerRatio", 1 )
			end
		},
		{
