...
CoD.Challenges_Expert = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.Challenges_Expert = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "Challenges_Expert", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	self:setClass( CoD.Challenges_Expert ) --[[ @ 0]]
	...
	local TabBacking = CoD.CommonTabBarBacking.new( f1_local1, f1_arg0, 0.5, 0.5, -1152, 1152, 0, 0, 52, 89 ) --[[ @ 0]]
	...
	MenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_6892ED10E8BF4877" ) ) --[[ @ 0]]
	...
	local FETabBar = CoD.Common_Tabbar_Center.new( f1_local1, f1_arg0, 0.5, 0.5, -964, 964, 0, 0, 36, 98 ) --[[ @ 0]]
	FETabBar.Tabs.grid:setHorizontalCount( 9 ) --[[ @ 0]]
	FETabBar.Tabs.grid:setDataSource( "ExpertTabs" ) --[[ @ 0]]
...
CoD.Challenges_Expert.__onClose = function ( f7_arg0 )
	f7_arg0.TabFrame:close() --[[ @ 0]]
	f7_arg0.TabBacking:close() --[[ @ 0]]
	f7_arg0.MenuFrame:close() --[[ @ 0]]
	f7_arg0.FETabBar:close() --[[ @ 0]]
end
 --[[ @ 0]]
