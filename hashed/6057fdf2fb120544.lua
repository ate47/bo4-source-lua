...
LUI.createMenu.Store = function ( f1_arg0, f1_arg1 )
	...
	storeCategoryListPC:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	if IsPC() then
		...
		UpdateButtonPromptState( f1_local1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
	end
