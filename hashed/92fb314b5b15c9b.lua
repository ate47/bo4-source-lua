...
CoD.AmmoWidgetWZ_ClipInfo = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AmmoWidgetWZ_ClipInfo.__defaultWidth = 64 --[[ @ 0]]
CoD.AmmoWidgetWZ_ClipInfo.__defaultHeight = 61 --[[ @ 0]]
CoD.AmmoWidgetWZ_ClipInfo.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AmmoWidgetWZ_ClipInfo ) --[[ @ 0]]
	self.id = "AmmoWidgetWZ_ClipInfo" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local Clip = CoD.AmmoWidgetMP_ClipContainerNew.new( f1_arg0, f1_arg1, 0, 0, 0, 64, 0, 0, 4, 30 ) --[[ @ 0]]
	Clip:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsCampaign() then
					f2_local0 = not WeaponUsesAmmo( f1_arg1 ) --[[ @ 0]]
				else
					f2_local0 = false --[[ @ 0]]
				end
				return f2_local0
	...
	local TotalAmmoLabel = Engine[@"getglobalmodel"]() --[[ @ 0]]
	...
	TotalAmmoLabel = LUI.UIText.new( 0, 0, 0, 64, 0, 0, 32, 48 ) --[[ @ 0]]
	...
	TotalAmmoLabel:setMaterial( LUI.UIImage.GetCachedMaterial( @"hash_90D57B1E92D39D7" ) ) --[[ @ 0]]
	TotalAmmoLabel:setShaderVector( 0, 1, 0, 0, 0 ) --[[ @ 0]]
	TotalAmmoLabel:setShaderVector( 1, 0, 0, 0, 0 ) --[[ @ 0]]
	TotalAmmoLabel:setShaderVector( 2, 0.8, 0.8, 0.8, 0.3 ) --[[ @ 0]]
	TotalAmmoLabel:setLetterSpacing( 2 ) --[[ @ 0]]
	TotalAmmoLabel:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	TotalAmmoLabel:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
...
CoD.AmmoWidgetWZ_ClipInfo.__resetProperties = function ( f39_arg0 )
	...
	f39_arg0.Clip:setLeftRight( 0, 0, 0, 64 ) --[[ @ 0]]
	f39_arg0.Clip:setTopBottom( 0, 0, 4, 30 ) --[[ @ 0]]
	f39_arg0.Clip:setRGB( ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b ) --[[ @ 0]]
	f39_arg0.Clip:setAlpha( 1 ) --[[ @ 0]]
	f39_arg0.TotalAmmoLabel:setLeftRight( 0, 0, 0, 64 ) --[[ @ 0]]
	f39_arg0.TotalAmmoLabel:setTopBottom( 0, 0, 32, 48 ) --[[ @ 0]]
...
CoD.AmmoWidgetWZ_ClipInfo.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f40_arg0, f40_arg1 )
			...
			f40_arg0.Clip:setLeftRight( 0, 0, 0, 64 ) --[[ @ 0]]
			f40_arg0.Clip:setTopBottom( 0, 0, 14.5, 40.5 ) --[[ @ 0]]
			f40_arg0.Clip:setRGB( ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b ) --[[ @ 0]]
	...
	DisposableMags = {
		DefaultClip = function ( f41_arg0, f41_arg1 )
			...
			f41_arg0.Clip:setLeftRight( 0, 0, 0, 64 ) --[[ @ 0]]
			f41_arg0.Clip:setTopBottom( 0, 0, 14.5, 40.5 ) --[[ @ 0]]
			f41_arg0.Clip:setRGB( ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b ) --[[ @ 0]]
	...
	WeaponDual = {
		DefaultClip = function ( f44_arg0, f44_arg1 )
			...
			f44_arg0.Clip:setTopBottom( 0, 0, 4, 30 ) --[[ @ 0]]
			...
			f44_arg0.ClipDual:setTopBottom( 0, 0, 4, 30 ) --[[ @ 0]]
			...
			f44_arg0.TotalAmmoLabel:completeAnimation() --[[ @ 0]]
			f44_arg0.TotalAmmoLabel:setAlpha( 1 ) --[[ @ 0]]
			f44_arg0.clipFinished( f44_arg0.TotalAmmoLabel ) --[[ @ 0]]
		end,
	...
	Weapon = {
		DefaultClip = function ( f46_arg0, f46_arg1 )
			...
			f46_arg0.Clip:setLeftRight( 0, 0, 0, 64 ) --[[ @ 0]]
			...
			f46_arg0.TotalAmmoLabel:setLeftRight( 0, 0, 0, 64 ) --[[ @ 0]]
			f46_arg0.TotalAmmoLabel:setTopBottom( 0, 0, 32, 48 ) --[[ @ 0]]
			f46_arg0.TotalAmmoLabel:setRGB( ColorSet.T8__BEIGE__HEADER.r, ColorSet.T8__BEIGE__HEADER.g, ColorSet.T8__BEIGE__HEADER.b ) --[[ @ 0]]
			f46_arg0.TotalAmmoLabel:setAlpha( 1 ) --[[ @ 0]]
		...
		Weapon3Digits = function ( f47_arg0, f47_arg1 )
			...
			f47_arg0.clipFinished( f47_arg0.TotalAmmoLabel ) --[[ @ 0]]
		end
	},
	Weapon3Digits = {
		DefaultClip = function ( f48_arg0, f48_arg1 )
			...
			f48_arg0.Clip:setLeftRight( 0, 0, 0, 64 ) --[[ @ 0]]
			...
			f48_arg0.TotalAmmoLabel:setAlpha( 1 ) --[[ @ 0]]
