...
CoD.AARClassRewardPreview_ZM = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AARClassRewardPreview_ZM.__defaultWidth = 380 --[[ @ 0]]
CoD.AARClassRewardPreview_ZM.__defaultHeight = 440 --[[ @ 0]]
CoD.AARClassRewardPreview_ZM.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARClassRewardPreview_ZM ) --[[ @ 0]]
	self.id = "AARClassRewardPreview_ZM" --[[ @ 0]]
	...
	local rewardDesc = LUI.UIText.new( 0, 0, 17, 383, 0, 0, 409, 426 ) --[[ @ 0]]
	rewardDesc:setRGB( 0.75, 0.75, 0.75 ) --[[ @ 0]]
	rewardDesc:setTTF( "dinnext_regular" ) --[[ @ 0]]
	...
	rewardDesc:linkToElementModel( self, "reward1Desc", true, function ( model )
		...
		if f7_local0 ~= nil then
			rewardDesc:setText( LocalizeToUpperString( f7_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	rewardTitle:linkToElementModel( self, "reward1Title", true, function ( model )
		...
		if f8_local0 ~= nil then
			rewardTitle:setText( LocalizeToUpperString( f8_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	Linker2:setRGB( 0.61, 0.1, 0.11 ) --[[ @ 0]]
	...
	Linker3:setRGB( 0.61, 0.1, 0.11 ) --[[ @ 0]]
