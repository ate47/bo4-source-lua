...
CoD.EmblemEditorGradient.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( gradientColor0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( gradientColor1, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		if CoD.ModelUtility.IsModelValueEqualTo( controller, "Emblem.EmblemProperties.isGradientMode", 1 ) and not CoD.ModelUtility.IsModelValueEqualToEnum( controller, "Emblem.EmblemProperties.colorMode", Enum[@"CustomizationColorMode"][@"hash_38F7F4A0A6A3678B"] ) then
			CoD.CraftUtility.EmblemGradient_BackFromColorPicker( self, element, menu, controller ) --[[ @ 0]]
			return true
		elseif CoD.ModelUtility.IsModelValueEqualTo( controller, "Emblem.EmblemProperties.isGradientMode", 1 ) and CoD.ModelUtility.IsModelValueEqualToEnum( controller, "Emblem.EmblemProperties.colorMode", Enum[@"CustomizationColorMode"][@"hash_38F7F4A0A6A3678B"] ) then
	...
	GradientTypeList:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( GradientTypeList, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f30_local0 then
					f30_local0 = CoD.CraftUtility.IsEmblemEditorPropertyEqualToEnum( f1_arg1, "colorContainerState", Enum[@"CustomizationColorNum"][@"hash_783372F1C29BD7F3"] ) --[[ @ 0]]
					if f30_local0 then
						f30_local0 = CoD.CraftUtility.IsEmblemEditorPropertyEqualToEnum( f1_arg1, "colorMode", Enum[@"CustomizationColorNum"][@"hash_32EFDD03AB2AE52D"] ) --[[ @ 0]]
					end
				end
				return f30_local0
			end
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f31_local0 then
					f31_local0 = CoD.CraftUtility.IsEmblemEditorPropertyEqualToEnum( f1_arg1, "colorContainerState", Enum[@"CustomizationColorNum"][@"hash_783372F1C29BD7F3"] ) --[[ @ 0]]
					if f31_local0 then
						f31_local0 = CoD.CraftUtility.IsEmblemEditorPropertyEqualToEnum( f1_arg1, "colorMode", Enum[@"CustomizationColorNum"][@"hash_32EFDC03AB2AE37A"] ) --[[ @ 0]]
					end
				end
				return f31_local0
			end
		},
		{
			...
			condition = function ( menu, element, event )
				return CoD.CraftUtility.IsEmblemEditorPropertyEqualTo( f1_arg1, "isGradientMode", 1 ) and CoD.CraftUtility.IsEmblemEditorPropertyEqualToEnum( f1_arg1, "colorContainerState", Enum[@"CustomizationColorNum"][@"hash_783372F1C29BD7F3"] )
			end
		}
	} ) --[[ @ 0]]
	f1_local9 = self --[[ @ 0]]
