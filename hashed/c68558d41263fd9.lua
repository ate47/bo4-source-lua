...
CoD.DirectorHeaderTabSafeArea = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.DirectorHeaderTabSafeArea.__defaultWidth = 1920 --[[ @ 0]]
CoD.DirectorHeaderTabSafeArea.__defaultHeight = 1080 --[[ @ 0]]
CoD.DirectorHeaderTabSafeArea.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DirectorHeaderTabSafeArea ) --[[ @ 0]]
	self.id = "DirectorHeaderTabSafeArea" --[[ @ 0]]
	...
	local Tabs = CoD.ZMGameModeTabs.new( f1_arg0, f1_arg1, 0.5, 0.5, -1650, 1650, 0, 0, 35.5, 95.5 ) --[[ @ 0]]
	Tabs.customClasssList:setDataSource( "DirectorPlaylistGameTypeList" ) --[[ @ 0]]
	self:addElement( Tabs ) --[[ @ 0]]
	self.Tabs = Tabs --[[ @ 0]]
	
	local BackingGrayMediumLeft = CoD.header_container_frontend.new( f1_arg0, f1_arg1, 0, 1, 0, 0, 0, 0, 0, -25 ) --[[ @ 0]]
