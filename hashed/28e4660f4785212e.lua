...
LUI.createMenu.FTUEInfoScreen = function ( f1_arg0, f1_arg1 )
	...
	SingleEntryText:setAlignment( Engine[@"hash_67F8853DC3581AA4"]( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) ) --[[ @ 0]]
	SingleEntryText:setAlignment( Engine[@"hash_67F8853DC3581AA4"]( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) ) --[[ @ 0]]
	...
	PCButton2.OptionText:setText( LocalizeToUpperString( @"hash_66393FF34EA56966" ) ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( PCButton2, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_local26( f1_local25, f1_local27["FTUEInfo.layout"], function ( f22_arg0, f22_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f22_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "MOUSE1", function ( element, menu, controller, model )
		...
		if not IsPC() and not IsRepeatButtonPress( f24_local0 ) and CoD.ModelUtility.IsModelValueEqualToEnum( controller, "FTUEInfo.layout", CoD.FTUEUtility.FTUELayouts.StoreUpsell ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_685952ACC6D0C1B0", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_771B04FAC5BE0E35"] | 750 << Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_176ADD225D738C93"], "MOUSE1" ) --[[ @ 0]]
			return true
		elseif not IsPC() and not IsRepeatButtonPress( f24_local0 ) and CoD.ModelUtility.IsModelValueEqualToEnum( controller, "FTUEInfo.layout", CoD.FTUEUtility.FTUELayouts.PromoEvent ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_229C903C6DF90D6F", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_771B04FAC5BE0E35"] | 750 << Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_176ADD225D738C93"], "MOUSE1" ) --[[ @ 0]]
			return true
		elseif not IsPC() and not IsRepeatButtonPress( f24_local0 ) and CoD.ModelUtility.IsModelValueEqualToEnum( controller, "FTUEInfo.layout", CoD.FTUEUtility.FTUELayouts.HoldButtonEntries1 ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_66393FF34EA56966", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_771B04FAC5BE0E35"] | 750 << Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_176ADD225D738C93"], "MOUSE1" ) --[[ @ 0]]
			return true
	...
	f1_local26 = self --[[ @ 0]]
	if IsPC() then
		UpdateButtonPromptState( f1_local1, f1_local26, f1_arg0, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
...
CoD.FTUEInfoScreen.__resetProperties = function ( f29_arg0 )
	...
	f29_arg0.PCButton2.OptionText:setText( LocalizeToUpperString( @"hash_66393FF34EA56966" ) ) --[[ @ 0]]
	f29_arg0.ContentWarningText:setAlpha( 0 ) --[[ @ 0]]
	f29_arg0.FixedAspectRatioImage:setAlpha( 0 ) --[[ @ 0]]
	f29_arg0.PCButton.OptionText:setText( LocalizeToUpperString( @"hash_66393FF34EA56966" ) ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.FTUEInfoScreen.__clipsPerState = {
	...
	PromoEvent = {
		DefaultClip = function ( f34_arg0, f34_arg1 )
			...
			f34_arg0.PCButton.OptionText:setText( LocalizeToUpperString( @"hash_229C903C6DF90D6F" ) ) --[[ @ 0]]
			...
			f34_arg0.PCButton2.OptionText:setText( LocalizeToUpperString( @"hash_23996BAAC73C3F6D" ) ) --[[ @ 0]]
