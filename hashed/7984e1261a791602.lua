...
LUI.createMenu.CodCasterQuickSettingsSideBar = function ( f2_arg0, f2_arg1 )
	...
	backButton.ButtonContainer.Title:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/back" ) ) --[[ @ 0]]
	...
	self:appendEventHandler( "input_source_changed", function ( f18_arg0, f18_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f18_arg0, f2_local1, f2_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f2_local16 = self --[[ @ 0]]
	f2_local17 = self.subscribeToModel --[[ @ 0]]
	f2_local18 = Engine[@"getmodelforcontroller"]( f2_arg0 ) --[[ @ 0]]
	f2_local17( f2_local16, f2_local18.LastInput, function ( f19_arg0, f19_arg1 )
		CoD.Menu.UpdateButtonShownState( f19_arg1, f2_local1, f2_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f2_local1:AddButtonCallbackFunction( self, f2_arg0, Enum[@"luibutton"][@"lui_key_ltrig"], "R", function ( element, menu, controller, model )
		...
		if not IsRepeatButtonPress( nil ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_ltrig"], @"menu/back", nil, "R" ) --[[ @ 0]]
			return true
		else
			return false
		end
...
CoD.CodCasterQuickSettingsSideBar.__resetProperties = function ( f25_arg0 )
	...
	f25_arg0.backButton.ButtonContainer.Title:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/back" ) ) --[[ @ 0]]
...
CoD.CodCasterQuickSettingsSideBar.__clipsPerState = {
	...
	PC = {
		DefaultClip = function ( f29_arg0, f29_arg1 )
			...
			f29_arg0.backButton.ButtonContainer.Title:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/back" ) ) --[[ @ 0]]
