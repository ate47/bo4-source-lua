...
CoD.WZCompassMinorInternal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.WZCompassMinorInternal.__defaultWidth = 62 --[[ @ 0]]
CoD.WZCompassMinorInternal.__defaultHeight = 43 --[[ @ 0]]
CoD.WZCompassMinorInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.WZCompassMinorInternal ) --[[ @ 0]]
	self.id = "WZCompassMinorInternal" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	
	local Text = LUI.UIText.new( 0.5, 0.5, -31, 31, 0, 0, 9, 28 ) --[[ @ 0]]
	...
	Image:setMaterial( LUI.UIImage.GetCachedMaterial( @"uie_feather_add" ) ) --[[ @ 0]]
