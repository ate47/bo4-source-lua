...
CoD.TabbedMultiItemPickup_NavigationPrompt = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.TabbedMultiItemPickup_NavigationPrompt.__defaultWidth = 64 --[[ @ 0]]
CoD.TabbedMultiItemPickup_NavigationPrompt.__defaultHeight = 64 --[[ @ 0]]
CoD.TabbedMultiItemPickup_NavigationPrompt.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.TabbedMultiItemPickup_NavigationPrompt ) --[[ @ 0]]
	self.id = "TabbedMultiItemPickup_NavigationPrompt" --[[ @ 0]]
	...
	local DownImage = CoD.WarzoneDpadButton.new( f1_arg0, f1_arg1, 0.5, 0.5, -32, 32, 0.5, 0.5, -32, 32 ) --[[ @ 0]]
...
CoD.TabbedMultiItemPickup_NavigationPrompt.__resetProperties = function ( f7_arg0 )
	...
	f7_arg0.RightImage:setAlpha( 1 ) --[[ @ 0]]
	f7_arg0.LeftImage:setAlpha( 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.TabbedMultiItemPickup_NavigationPrompt.__clipsPerState = {
	...
	AtLeftAndRight = {
		DefaultClip = function ( f9_arg0, f9_arg1 )
			...
			f9_arg0.LeftImage:completeAnimation() --[[ @ 0]]
			f9_arg0.LeftImage:setAlpha( 0 ) --[[ @ 0]]
			f9_arg0.clipFinished( f9_arg0.LeftImage ) --[[ @ 0]]
	...
	AtLeft = {
		DefaultClip = function ( f10_arg0, f10_arg1 )
			...
			f10_arg0.LeftImage:completeAnimation() --[[ @ 0]]
			f10_arg0.LeftImage:setAlpha( 0 ) --[[ @ 0]]
			f10_arg0.clipFinished( f10_arg0.LeftImage ) --[[ @ 0]]
		end
	},
	AtRight = {
		DefaultClip = function ( f11_arg0, f11_arg1 )
			...
			f11_arg0.RightImage:completeAnimation() --[[ @ 0]]
			f11_arg0.RightImage:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.RightImage ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.TabbedMultiItemPickup_NavigationPrompt.__onClose = function ( f12_arg0 )
	f12_arg0.BackingImage:close() --[[ @ 0]]
	f12_arg0.LeftImage:close() --[[ @ 0]]
	f12_arg0.RightImage:close() --[[ @ 0]]
	f12_arg0.UpImage:close() --[[ @ 0]]
	f12_arg0.DownImage:close() --[[ @ 0]]
end
 --[[ @ 0]]
