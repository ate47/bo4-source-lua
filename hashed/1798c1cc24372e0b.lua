...
CoD.PC_VodViewerQuitButton = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.PC_VodViewerQuitButton.__defaultWidth = 50 --[[ @ 0]]
CoD.PC_VodViewerQuitButton.__defaultHeight = 50 --[[ @ 0]]
CoD.PC_VodViewerQuitButton.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.PC_VodViewerQuitButton ) --[[ @ 0]]
	self.id = "PC_VodViewerQuitButton" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local BTNQuit = LUI.UIImage.new( 0.98, 0.98, -49, 1, 0.02, 0.02, -1, 49 ) --[[ @ 0]]
	BTNQuit:setImage( RegisterImage( @"uie_close_icon" ) ) --[[ @ 0]]
...
CoD.PC_VodViewerQuitButton.__resetProperties = function ( f7_arg0 )
	f7_arg0.BTNQuit:completeAnimation() --[[ @ 0]]
	f7_arg0.BTNQuit:setAlpha( 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.PC_VodViewerQuitButton.__clipsPerState = {
	DefaultState = {
		...
		Focus = function ( f9_arg0, f9_arg1 )
			...
			f9_arg0.BTNQuit:completeAnimation() --[[ @ 0]]
			f9_arg0.clipFinished( f9_arg0.BTNQuit ) --[[ @ 0]]
		end
	},
	Gamepad = {
		DefaultClip = function ( f10_arg0, f10_arg1 )
			...
			f10_arg0.BTNQuit:completeAnimation() --[[ @ 0]]
			f10_arg0.BTNQuit:setAlpha( 0 ) --[[ @ 0]]
			f10_arg0.clipFinished( f10_arg0.BTNQuit ) --[[ @ 0]]
		end
	},
	HiddenUnskippable = {
		DefaultClip = function ( f11_arg0, f11_arg1 )
			...
			f11_arg0.BTNQuit:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.BTNQuit ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
