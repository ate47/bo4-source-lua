...
CoD.SpecialistHeadquarters.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MainInfoText:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	MainInfoText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	DossierButton.Header:setText( LocalizeToUpperString( @"hash_3AD5EF55000B9F90" ) ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( DossierButton, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ENTER", function ( element, menu, controller, model )
		...
		if IsLobbyHostOfCurrentMenu() then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_3AC3B80C833B60E1", nil, "ENTER" ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	ArchivesButton.Header:setText( LocalizeToUpperString( @"hash_C94F6359C701D44" ) ) --[[ @ 0]]
	ArchivesButton:appendEventHandler( "on_session_start", function ( f13_arg0, f13_arg1 )
		f13_arg1.menu = f13_arg1.menu or f1_arg0 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f13_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( ArchivesButton, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ENTER", function ( element, menu, controller, model )
		if IsLobbyHostOfCurrentMenu() then
	...
	LowerSideInfoText:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	LowerSideInfoText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	UpperSideInfoText:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	UpperSideInfoText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( PlayButton, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	Specialists:appendEventHandler( "on_session_start", function ( f40_arg0, f40_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f40_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	RightProgress( MiddleProgress, LeftProgress["lobbyRoot.gameClient.update"], function ( f43_arg0, f43_arg1 )
		CoD.Menu.UpdateButtonShownState( f43_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	MiddleProgress = Specialists --[[ @ 0]]
	RightProgress = Specialists.subscribeToModel --[[ @ 0]]
	LeftProgress = Engine[@"GetGlobalModel"]() --[[ @ 0]]
	RightProgress( MiddleProgress, LeftProgress["lobbyRoot.privateClient.update"], function ( f44_arg0, f44_arg1 )
		CoD.Menu.UpdateButtonShownState( f44_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	MiddleProgress = Specialists --[[ @ 0]]
	RightProgress = Specialists.subscribeToModel --[[ @ 0]]
	LeftProgress = Engine[@"GetGlobalModel"]() --[[ @ 0]]
	RightProgress( MiddleProgress, LeftProgress["MapVote.timerActive"], function ( f45_arg0, f45_arg1 )
		CoD.Menu.UpdateButtonShownState( f45_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( Specialists, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
