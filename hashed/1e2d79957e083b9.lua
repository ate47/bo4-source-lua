...
CoD.CaseExchangeContractConfirmation = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.CaseExchangeContractConfirmation = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "CaseExchangeContractConfirmation", f1_arg0 ) --[[ @ 0]]
	...
	self:setClass( CoD.CaseExchangeContractConfirmation ) --[[ @ 0]]
	...
	FullscreenPopupTemplate.ButtonList:setDataSource( "CaseExchangeContractConfirmationButtons" ) --[[ @ 0]]
	FullscreenPopupTemplate.ErrorSubtitle:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_A5FEF098BBBD5A3" ) ) --[[ @ 0]]
	FullscreenPopupTemplate.WorkingTitle:setText( LocalizeToUpperString( @"hash_354D5E3ECAB13858" ) ) --[[ @ 0]]
	FullscreenPopupTemplate.Title:setText( LocalizeToUpperString( @"hash_359139D06DB080E5" ) ) --[[ @ 0]]
	FullscreenPopupTemplate.DoneTitle.__Done_Title = function ()
		FullscreenPopupTemplate.DoneTitle:setText( Engine[@"hash_4F9F1239CFD921FE"]( CoD.ContractUtility.UseCaseExchangeAndActivateContractCompleteTitleIfNeeded( f1_arg0, @"hash_5456F58A03ED7888" ) ) ) --[[ @ 0]]
	end
	 --[[ @ 0]]
	...
	FullscreenPopupTemplate:linkToElementModel( self, "name", true, function ( model )
		...
		if f8_local0 ~= nil then
			FullscreenPopupTemplate.Subtitle:setText( CoD.ContractUtility.GetCaseExchangeContractConfirmDesc( self:getModel(), f1_arg0, f8_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	FullscreenPopupTemplate.DoneSubtitle.__Done_Subtitle = function ( f9_arg0 )
		local f9_local0 = f9_arg0:get() --[[ @ 0]]
		if f9_local0 ~= nil then
			FullscreenPopupTemplate.DoneSubtitle:setText( CoD.ContractUtility.GetCaseExchangeContractCompleteDesc( self:getModel(), f1_arg0, f9_local0 ) ) --[[ @ 0]]
		end
	end
	 --[[ @ 0]]
	...
	StateIndicator.CostText:setRGB( ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b ) --[[ @ 0]]
	StateIndicator:linkToElementModel( self, "casePrice", true, function ( model )
		local f18_local0 = model:get() --[[ @ 0]]
		if f18_local0 ~= nil then
			StateIndicator.CostText:setText( LocalizeIntoString( @"hash_79CBD79D3C8A2BED", f18_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	StartMenuCODpoints:subscribeToGlobalModel( f1_arg0, "LootStreamProgress", "codPoints", function ( model )
		...
		if f19_local0 ~= nil then
			StartMenuCODpoints.codpointsCount:setText( SetValueIfNumberEqualTo( -1, "-", f19_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	ContractName:linkToElementModel( self, "name", true, function ( model )
		...
		if f21_local0 ~= nil then
			ContractName:setText( Engine[@"hash_4F9F1239CFD921FE"]( f21_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		...
		elseif not IsElementInState( self.FullscreenPopupTemplate, "WorkingState" ) and not MenuPropertyIsTrue( menu, "__keepPopupButtonListPC" ) then
			CoD.BlackMarketUtility.SetElementWorkingStateAndExchangeLootCases( self.FullscreenPopupTemplate, controller ) --[[ @ 0]]
...
CoD.CaseExchangeContractConfirmation.__onClose = function ( f28_arg0 )
	f28_arg0.FullscreenPopupTemplate:close() --[[ @ 0]]
	f28_arg0.SelfIdentityBadge:close() --[[ @ 0]]
	f28_arg0.ContentImage:close() --[[ @ 0]]
	f28_arg0.StateIndicator:close() --[[ @ 0]]
	f28_arg0.StartMenuCODpoints:close() --[[ @ 0]]
	f28_arg0.CommonIdentityWidgetStreamlinedPC:close() --[[ @ 0]]
	f28_arg0.CommonIdentityWidgetStreamlinedC:close() --[[ @ 0]]
	f28_arg0.ContractName:close() --[[ @ 0]]
end
 --[[ @ 0]]
