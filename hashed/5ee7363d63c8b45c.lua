...
LUI.createMenu.Leaderboards_PlayersList = function ( f1_arg0, f1_arg1 )
	...
	SelectedCount:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	SelectedCount:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	SelectedCountTitle:setText( LocalizeToUpperString( @"menu/selected" ) ) --[[ @ 0]]
	SelectedCountTitle:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	SelectedCountTitle:setLetterSpacing( 4 ) --[[ @ 0]]
	SelectedCountTitle:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	SelectedCountTitle:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	noPlayersText:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	noPlayersText:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	GenericMenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"menu/players_list" ) ) --[[ @ 0]]
	...
	PlayerListFullText:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	PlayerListFullText:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"menu/players_list" ) ) --[[ @ 0]]
	...
	PlaylistButton.CommonListButtonShortInternal.Title:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/players_list" ) ) --[[ @ 0]]
	...
	AddPlayerButton.CommonListButtonShortInternal.Title:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/add_players" ) ) --[[ @ 0]]
