...
CoD.GameSettings_Characters.new = function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3, f14_arg4, f14_arg5, f14_arg6, f14_arg7, f14_arg8, f14_arg9 )
	...
	OptionCategoryGrid:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f14_arg0, f14_arg1, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		return f15_local0
	end ) --[[ @ 0]]
	...
	SlidersPC:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f14_arg0, f14_arg1, Enum[@"luibutton"][@"lui_key_start"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( element, f14_arg0, f14_arg1, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
		return f19_local0
	end ) --[[ @ 0]]
