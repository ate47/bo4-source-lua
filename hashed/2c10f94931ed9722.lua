...
CoD.systemOverlay_Prestige.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	WarningText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	PermanentUnlockTokenButton.CommonButtonOutlineThin.ButtonIcon:setImage( RegisterImage( @"hash_55DB5170C4871157" ) ) --[[ @ 0]]
