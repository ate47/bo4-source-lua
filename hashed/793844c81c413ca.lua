...
require( "x64:a6680245b4f97ed" ) --[[ @ 0]]
require( "ui/uieditor/widgets/scoreboard/tabbedscoreboardrank" ) --[[ @ 0]]
require( "ui/uieditor/widgets/emptyfocusable" ) --[[ @ 0]]

CoD.PositionDraft_ViewTeams_Client = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.PositionDraft_ViewTeams_Client.__defaultWidth = 189 --[[ @ 0]]
CoD.PositionDraft_ViewTeams_Client.__defaultHeight = 216 --[[ @ 0]]
CoD.PositionDraft_ViewTeams_Client.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.PositionDraft_ViewTeams_Client ) --[[ @ 0]]
	self.id = "PositionDraft_ViewTeams_Client" --[[ @ 0]]
	...
	EnemyBackground:setRGB( 0.91, 0.31, 0.15 ) --[[ @ 0]]
	...
	FriendlyBackground:linkToElementModel( self, "clientNum", true, function ( model )
		...
		if f2_local0 ~= nil then
			FriendlyBackground:setRGB( ClientBackgroundColor( f1_arg1, f2_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	TopBarEnemy:setRGB( 0.91, 0.3, 0.15 ) --[[ @ 0]]
	...
	TopBarFriendly:linkToElementModel( self, "clientNum", true, function ( model )
		...
		if f3_local0 ~= nil then
			TopBarFriendly:setRGB( ClientBackgroundColor( f1_arg1, f3_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not CoD.ModelUtility.IsSelfModelValueNilOrZero( element, f1_arg1, "characterIndex" ) then
					f8_local0 = IsGametypeSettingsValue( "draftHideEnemyTeam", 1 ) --[[ @ 0]]
				else
					f8_local0 = false --[[ @ 0]]
				end
				return f8_local0
	...
	local Searching = Engine[@"GetGlobalModel"]() --[[ @ 0]]
	...
	Searching = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	PositionDraftCharacter( BG, Searching["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_534C7B2375D2D47"]], function ( f14_arg0 )
		f1_arg0:updateElementState( PositionDraftCharacterEnemy, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	PositionDraftCharacterEnemy:linkToElementModel( self, "characterIndex", true, function ( model )
		...
		if f17_local0 ~= nil then
			PositionDraftCharacterEnemy.Name:setText( LocalizeToUpperString( GetCharacterDisplayNameByIndex( f17_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	Searching = PositionDraftCharacter --[[ @ 0]]
	...
	BG( Searching, Rank["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_534C7B2375D2D47"]], function ( f28_arg0 )
		f1_arg0:updateElementState( PositionDraftCharacter, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	PositionDraftCharacter:linkToElementModel( self, "characterIndex", true, function ( model )
		...
		if f30_local0 ~= nil then
			PositionDraftCharacter.Name:setText( LocalizeToUpperString( GetCharacterDisplayNameByIndex( f30_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	Searching = CoD.PositionDraft_Searching.new( f1_arg0, f1_arg1, 0.5, 0.5, -94.5, 94.5, 0.5, 0.5, 19, 39 ) --[[ @ 0]]
	Searching:setRGB( ColorSet.T8__OFF__GRAY.r, ColorSet.T8__OFF__GRAY.g, ColorSet.T8__OFF__GRAY.b ) --[[ @ 0]]
	Searching:setAlpha( 0 ) --[[ @ 0]]
	...
	local ClientClanTag = LUI.UIText.new( 1, 1, -179, -9, 0.66, 0.66, 48, 68 ) --[[ @ 0]]
	...
	self.PositionDraftCharacterEnemy:linkToElementModel( self, "characterIndex", true, function ( model )
		...
		if f37_local0 ~= nil then
			PositionDraftCharacterEnemy.Portrait:setImage( RegisterImage( GetPositionDraftIconByIndex( f37_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	self.PositionDraftCharacter:linkToElementModel( self, "characterIndex", true, function ( model )
		...
		if f38_local0 ~= nil then
			PositionDraftCharacter.Portrait:setImage( RegisterImage( GetPositionDraftIconByIndex( f38_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f39_local0 --[[ @ 0]]
				if not CoD.ModelUtility.IsSelfModelValueNilOrZero( element, f1_arg1, "characterIndex" ) then
					f39_local0 = IsPublicOnlineGame() --[[ @ 0]]
				else
					f39_local0 = false --[[ @ 0]]
				end
				return f39_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not CoD.ModelUtility.IsSelfModelValueNilOrZero( element, f1_arg1, "characterIndex" ) and not IsGametypeSettingsValue( "draftHideEnemyTeam", 1 ) then
					f43_local0 = IsPublicOnlineGame() --[[ @ 0]]
				else
					f43_local0 = false --[[ @ 0]]
				end
				return f43_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f44_local0 --[[ @ 0]]
				if not CoD.ModelUtility.IsSelfModelValueNilOrZero( element, f1_arg1, "characterIndex" ) then
					f44_local0 = not IsGametypeSettingsValue( "draftHideEnemyTeam", 1 ) --[[ @ 0]]
				else
					f44_local0 = false --[[ @ 0]]
				end
				return f44_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f45_local0 --[[ @ 0]]
				if not CoD.ModelUtility.IsSelfModelValueNilOrZero( element, f1_arg1, "characterIndex" ) then
					f45_local0 = IsGametypeSettingsValue( "draftHideEnemyTeam", 1 ) --[[ @ 0]]
				else
					f45_local0 = false --[[ @ 0]]
				end
				return f45_local0
...
CoD.PositionDraft_ViewTeams_Client.__resetProperties = function ( f50_arg0, f50_arg1 )
	...
	f50_arg0.ClientClanTag:completeAnimation() --[[ @ 0]]
	f50_arg0.TopBarFriendly:completeAnimation() --[[ @ 0]]
	f50_arg0.FriendlyBackground:completeAnimation() --[[ @ 0]]
	f50_arg0.EnemyBackground:completeAnimation() --[[ @ 0]]
	f50_arg0.Searching:completeAnimation() --[[ @ 0]]
	f50_arg0.ClientGamertag:completeAnimation() --[[ @ 0]]
	f50_arg0.Rank:completeAnimation() --[[ @ 0]]
	f50_arg0.PositionDraftCharacterEnemy:completeAnimation() --[[ @ 0]]
	f50_arg0.PositionDraftCharacter:completeAnimation() --[[ @ 0]]
	f50_arg0.TopBarEnemy:completeAnimation() --[[ @ 0]]
	f50_arg0.BG:setAlpha( 0.9 ) --[[ @ 0]]
	f50_arg0.ClientClanTag:setLeftRight( 1, 1, -179, -9 ) --[[ @ 0]]
	f50_arg0.ClientClanTag:setAlpha( 1 ) --[[ @ 0]]
	f50_arg0.TopBarFriendly:setAlpha( 0 ) --[[ @ 0]]
	f50_arg0.FriendlyBackground:setAlpha( 1 ) --[[ @ 0]]
	f50_arg0.EnemyBackground:setAlpha( 1 ) --[[ @ 0]]
	f50_arg0.Searching:setAlpha( 0 ) --[[ @ 0]]
	f50_arg0.ClientGamertag:setLeftRight( 1, 1, -179, -9 ) --[[ @ 0]]
	f50_arg0.ClientGamertag:setAlpha( 1 ) --[[ @ 0]]
	f50_arg0.Rank:setAlpha( 0 ) --[[ @ 0]]
	f50_arg0.PositionDraftCharacterEnemy:setAlpha( 1 ) --[[ @ 0]]
	f50_arg0.PositionDraftCharacter:setAlpha( 1 ) --[[ @ 0]]
	f50_arg0.TopBarEnemy:setAlpha( 0 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.PositionDraft_ViewTeams_Client.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f51_arg0, f51_arg1 )
			...
			f51_arg0.EnemyBackground:setAlpha( 0 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.EnemyBackground ) --[[ @ 0]]
			f51_arg0.FriendlyBackground:completeAnimation() --[[ @ 0]]
			f51_arg0.FriendlyBackground:setAlpha( 0 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.FriendlyBackground ) --[[ @ 0]]
			f51_arg0.TopBarFriendly:completeAnimation() --[[ @ 0]]
			f51_arg0.TopBarFriendly:setAlpha( 1 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.TopBarFriendly ) --[[ @ 0]]
			f51_arg0.PositionDraftCharacterEnemy:completeAnimation() --[[ @ 0]]
			f51_arg0.PositionDraftCharacterEnemy:setAlpha( 0 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.PositionDraftCharacterEnemy ) --[[ @ 0]]
			f51_arg0.PositionDraftCharacter:completeAnimation() --[[ @ 0]]
			f51_arg0.PositionDraftCharacter:setAlpha( 1 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.PositionDraftCharacter ) --[[ @ 0]]
			f51_arg0.BG:completeAnimation() --[[ @ 0]]
			f51_arg0.BG:setAlpha( 0.8 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.BG ) --[[ @ 0]]
			f51_arg0.Searching:completeAnimation() --[[ @ 0]]
			f51_arg0.Searching:setAlpha( 0 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.Searching ) --[[ @ 0]]
			f51_arg0.Rank:completeAnimation() --[[ @ 0]]
			f51_arg0.Rank:setAlpha( 0 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.Rank ) --[[ @ 0]]
			f51_arg0.ClientClanTag:completeAnimation() --[[ @ 0]]
			f51_arg0.ClientClanTag:setAlpha( 0 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.ClientClanTag ) --[[ @ 0]]
			f51_arg0.ClientGamertag:completeAnimation() --[[ @ 0]]
			f51_arg0.ClientGamertag:setAlpha( 0 ) --[[ @ 0]]
			f51_arg0.clipFinished( f51_arg0.ClientGamertag ) --[[ @ 0]]
		end
	},
	...
	Friendly_ValidClient = {
		DefaultClip = function ( f54_arg0, f54_arg1 )
			...
			f54_arg0.BG:completeAnimation() --[[ @ 0]]
			f54_arg0.BG:setAlpha( 0.9 ) --[[ @ 0]]
			f54_arg0.clipFinished( f54_arg0.BG ) --[[ @ 0]]
	...
	Friendly_Searching = {
		DefaultClip = function ( f55_arg0, f55_arg1 )
			...
			f55_arg0.PositionDraftCharacter:setAlpha( 0 ) --[[ @ 0]]
			...
			f55_arg0.Searching:completeAnimation() --[[ @ 0]]
			f55_arg0.Searching:setAlpha( 1 ) --[[ @ 0]]
			f55_arg0.clipFinished( f55_arg0.Searching ) --[[ @ 0]]
			f55_arg0.Rank:completeAnimation() --[[ @ 0]]
			f55_arg0.Rank:setAlpha( 0 ) --[[ @ 0]]
			f55_arg0.clipFinished( f55_arg0.Rank ) --[[ @ 0]]
			f55_arg0.ClientClanTag:completeAnimation() --[[ @ 0]]
			f55_arg0.ClientClanTag:setAlpha( 0 ) --[[ @ 0]]
			f55_arg0.clipFinished( f55_arg0.ClientClanTag ) --[[ @ 0]]
			f55_arg0.ClientGamertag:completeAnimation() --[[ @ 0]]
			f55_arg0.ClientGamertag:setAlpha( 0 ) --[[ @ 0]]
			f55_arg0.clipFinished( f55_arg0.ClientGamertag ) --[[ @ 0]]
		end
	},
	Enemy_CharacterSelected_Rank = {
		DefaultClip = function ( f56_arg0, f56_arg1 )
			...
			f56_arg0.EnemyBackground:setAlpha( 0.07 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.EnemyBackground ) --[[ @ 0]]
			f56_arg0.FriendlyBackground:completeAnimation() --[[ @ 0]]
			f56_arg0.FriendlyBackground:setAlpha( 0 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.FriendlyBackground ) --[[ @ 0]]
			f56_arg0.TopBarEnemy:completeAnimation() --[[ @ 0]]
			f56_arg0.TopBarEnemy:setAlpha( 0.4 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.TopBarEnemy ) --[[ @ 0]]
			f56_arg0.TopBarFriendly:completeAnimation() --[[ @ 0]]
			f56_arg0.TopBarFriendly:setAlpha( 0 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.TopBarFriendly ) --[[ @ 0]]
			f56_arg0.PositionDraftCharacterEnemy:completeAnimation() --[[ @ 0]]
			f56_arg0.PositionDraftCharacterEnemy:setAlpha( 1 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.PositionDraftCharacterEnemy ) --[[ @ 0]]
			f56_arg0.PositionDraftCharacter:completeAnimation() --[[ @ 0]]
			f56_arg0.PositionDraftCharacter:setAlpha( 0 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.PositionDraftCharacter ) --[[ @ 0]]
			f56_arg0.Rank:completeAnimation() --[[ @ 0]]
			f56_arg0.Rank:setAlpha( 1 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.Rank ) --[[ @ 0]]
			f56_arg0.ClientClanTag:completeAnimation() --[[ @ 0]]
			f56_arg0.ClientClanTag:setLeftRight( 1, 1, -149, -9 ) --[[ @ 0]]
	...
	Enemy_CharacterSelected = {
		DefaultClip = function ( f57_arg0, f57_arg1 )
			...
			f57_arg0.TopBarEnemy:setAlpha( 0.4 ) --[[ @ 0]]
			f57_arg0.clipFinished( f57_arg0.TopBarEnemy ) --[[ @ 0]]
			f57_arg0.TopBarFriendly:completeAnimation() --[[ @ 0]]
			f57_arg0.TopBarFriendly:setAlpha( 0 ) --[[ @ 0]]
			f57_arg0.clipFinished( f57_arg0.TopBarFriendly ) --[[ @ 0]]
			f57_arg0.PositionDraftCharacterEnemy:completeAnimation() --[[ @ 0]]
			f57_arg0.PositionDraftCharacterEnemy:setAlpha( 1 ) --[[ @ 0]]
			f57_arg0.clipFinished( f57_arg0.PositionDraftCharacterEnemy ) --[[ @ 0]]
			f57_arg0.PositionDraftCharacter:completeAnimation() --[[ @ 0]]
			f57_arg0.PositionDraftCharacter:setAlpha( 0 ) --[[ @ 0]]
			f57_arg0.clipFinished( f57_arg0.PositionDraftCharacter ) --[[ @ 0]]
			f57_arg0.Searching:completeAnimation() --[[ @ 0]]
			f57_arg0.Searching:setAlpha( 0 ) --[[ @ 0]]
			f57_arg0.clipFinished( f57_arg0.Searching ) --[[ @ 0]]
			f57_arg0.ClientClanTag:completeAnimation() --[[ @ 0]]
			f57_arg0.ClientClanTag:setAlpha( 0 ) --[[ @ 0]]
			f57_arg0.clipFinished( f57_arg0.ClientClanTag ) --[[ @ 0]]
		end
	},
	Enemy_CharacterSelected_Hidden = {
		DefaultClip = function ( f58_arg0, f58_arg1 )
			f58_arg0:__resetProperties( f58_arg1 ) --[[ @ 0]]
			f58_arg0:setupElementClipCounter( 9 ) --[[ @ 0]]
			f58_arg0.EnemyBackground:completeAnimation() --[[ @ 0]]
			f58_arg0.EnemyBackground:setAlpha( 0.07 ) --[[ @ 0]]
			...
			f58_arg0.TopBarEnemy:setAlpha( 0.4 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.TopBarEnemy ) --[[ @ 0]]
			f58_arg0.TopBarFriendly:completeAnimation() --[[ @ 0]]
			f58_arg0.TopBarFriendly:setAlpha( 0 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.TopBarFriendly ) --[[ @ 0]]
			f58_arg0.PositionDraftCharacterEnemy:completeAnimation() --[[ @ 0]]
			f58_arg0.PositionDraftCharacterEnemy:setAlpha( 1 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.PositionDraftCharacterEnemy ) --[[ @ 0]]
			f58_arg0.PositionDraftCharacter:completeAnimation() --[[ @ 0]]
			f58_arg0.PositionDraftCharacter:setAlpha( 0 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.PositionDraftCharacter ) --[[ @ 0]]
			f58_arg0.BG:completeAnimation() --[[ @ 0]]
			f58_arg0.BG:setAlpha( 0.9 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.BG ) --[[ @ 0]]
			f58_arg0.Searching:completeAnimation() --[[ @ 0]]
			f58_arg0.Searching:setAlpha( 0 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.Searching ) --[[ @ 0]]
			f58_arg0.ClientClanTag:completeAnimation() --[[ @ 0]]
			f58_arg0.ClientClanTag:setAlpha( 0 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.ClientClanTag ) --[[ @ 0]]
		end
	},
	Enemy_ValidClient = {
		DefaultClip = function ( f59_arg0, f59_arg1 )
			f59_arg0:__resetProperties( f59_arg1 ) --[[ @ 0]]
			f59_arg0:setupElementClipCounter( 7 ) --[[ @ 0]]
			f59_arg0.EnemyBackground:completeAnimation() --[[ @ 0]]
			f59_arg0.EnemyBackground:setAlpha( 0.07 ) --[[ @ 0]]
			...
			f59_arg0.TopBarEnemy:setAlpha( 0.4 ) --[[ @ 0]]
			f59_arg0.clipFinished( f59_arg0.TopBarEnemy ) --[[ @ 0]]
			f59_arg0.PositionDraftCharacterEnemy:completeAnimation() --[[ @ 0]]
			f59_arg0.PositionDraftCharacterEnemy:setAlpha( 1 ) --[[ @ 0]]
			f59_arg0.clipFinished( f59_arg0.PositionDraftCharacterEnemy ) --[[ @ 0]]
			f59_arg0.PositionDraftCharacter:completeAnimation() --[[ @ 0]]
			f59_arg0.PositionDraftCharacter:setAlpha( 0 ) --[[ @ 0]]
	...
	Enemy_Searching = {
		DefaultClip = function ( f60_arg0, f60_arg1 )
			...
			f60_arg0.TopBarEnemy:setAlpha( 0.4 ) --[[ @ 0]]
			f60_arg0.clipFinished( f60_arg0.TopBarEnemy ) --[[ @ 0]]
			f60_arg0.TopBarFriendly:completeAnimation() --[[ @ 0]]
			f60_arg0.TopBarFriendly:setAlpha( 0 ) --[[ @ 0]]
			f60_arg0.clipFinished( f60_arg0.TopBarFriendly ) --[[ @ 0]]
			f60_arg0.PositionDraftCharacterEnemy:completeAnimation() --[[ @ 0]]
			f60_arg0.PositionDraftCharacterEnemy:setAlpha( 0 ) --[[ @ 0]]
			f60_arg0.clipFinished( f60_arg0.PositionDraftCharacterEnemy ) --[[ @ 0]]
			...
			f60_arg0.Searching:completeAnimation() --[[ @ 0]]
			f60_arg0.Searching:setAlpha( 1 ) --[[ @ 0]]
			f60_arg0.clipFinished( f60_arg0.Searching ) --[[ @ 0]]
