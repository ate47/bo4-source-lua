...
CoD.ContractSupplyChainDetails = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ContractSupplyChainDetails.__defaultWidth = 600 --[[ @ 0]]
CoD.ContractSupplyChainDetails.__defaultHeight = 1080 --[[ @ 0]]
CoD.ContractSupplyChainDetails.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ContractSupplyChainDetails ) --[[ @ 0]]
	self.id = "ContractSupplyChainDetails" --[[ @ 0]]
...
CoD.ContractSupplyChainDetails.__resetProperties = function ( f17_arg0 )
	f17_arg0.XCamMouseControl:completeAnimation() --[[ @ 0]]
	f17_arg0.FixedAspectRatioImage:completeAnimation() --[[ @ 0]]
	f17_arg0.SetBonusWidget:completeAnimation() --[[ @ 0]]
	f17_arg0.XCamMouseControl:setAlpha( 1 ) --[[ @ 0]]
	f17_arg0.FixedAspectRatioImage:setAlpha( 1 ) --[[ @ 0]]
	f17_arg0.SetBonusWidget:setAlpha( 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.ContractSupplyChainDetails.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f18_arg0, f18_arg1 )
			...
			f18_arg0.XCamMouseControl:completeAnimation() --[[ @ 0]]
			f18_arg0.XCamMouseControl:setAlpha( 0 ) --[[ @ 0]]
			f18_arg0.clipFinished( f18_arg0.XCamMouseControl ) --[[ @ 0]]
		end
	},
	Hidden = {
		DefaultClip = function ( f19_arg0, f19_arg1 )
			...
			f19_arg0.SetBonusWidget:completeAnimation() --[[ @ 0]]
			f19_arg0.SetBonusWidget:setAlpha( 0 ) --[[ @ 0]]
			f19_arg0.clipFinished( f19_arg0.SetBonusWidget ) --[[ @ 0]]
		end
	},
	NoInfoPanel = {
		DefaultClip = function ( f20_arg0, f20_arg1 )
			...
			f20_arg0.XCamMouseControl:setAlpha( 0 ) --[[ @ 0]]
			f20_arg0.clipFinished( f20_arg0.XCamMouseControl ) --[[ @ 0]]
			...
			f20_arg0.SetBonusWidget:setAlpha( 0 ) --[[ @ 0]]
			f20_arg0.clipFinished( f20_arg0.SetBonusWidget ) --[[ @ 0]]
		end
	},
...
CoD.ContractSupplyChainDetails.__onClose = function ( f24_arg0 )
	...
	f24_arg0.FixedAspectRatioImage:close() --[[ @ 0]]
	f24_arg0.SetBonusWidget:close() --[[ @ 0]]
end
 --[[ @ 0]]
