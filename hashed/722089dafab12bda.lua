	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_bomb_timer_a"] ) then
					f20_local0 = Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_bomb_timer_b"] ) --[[ @ 0]]
					if f20_local0 then
						if not Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_round_end_killcam"] ) then
							f20_local0 = not Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_play_of_the_match"] ) --[[ @ 0]]
						else
							f20_local0 = false --[[ @ 0]]
						end
					end
