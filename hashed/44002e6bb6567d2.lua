...
LUI.createMenu.Prestige_PlayerLevel = function ( f1_arg0, f1_arg1 )
	...
	GenericMenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( CoD.PrestigeUtility.GetPrestigeMenuTitleString( @"menu/player_level" ) ) ) --[[ @ 0]]
	...
	PermanentUnlockTokenText:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	PermanentUnlockTokenText:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"], "ui_prevtab", function ( element, menu, controller, model )
		...
		if not IsRepeatButtonPress( nil ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_ltrig"], @"hash_0", nil, "ui_prevtab" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"], "ui_nexttab", function ( element, menu, controller, model )
		...
		if not IsRepeatButtonPress( nil ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_rtrig"], @"hash_0", nil, "ui_nexttab" ) --[[ @ 0]]
			return false
		else
			return false
		end
