...
LUI.createMenu.ZMCustomizeClassMenu = function ( f1_arg0, f1_arg1 )
	...
	self:linkToElementModel( self, nil, true, function ( model, f6_arg1 )
		CoD.Menu.UpdateButtonShownState( f6_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_222361E23588705A"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_222361E23588705A"], "ui_contextual_1", function ( element, menu, controller, model )
		...
		if not CoD.CACUtility.IsCurrentClassLocked( menu, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_222361E23588705A"], @"hash_227F19FF8EF11A44", nil, "ui_contextual_1" ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	if not CoD.BaseUtility.IsMenuSessionModeEqualTo( f1_local1, Enum[@"eModes"][@"hash_2B22E0240605CFFE"] ) then
		...
		SetCharacterModeToSessionMode( self, f1_arg0, Enum[@"eModes"][@"hash_73723205FAE52C4A"] ) --[[ @ 0]]
		CoD.FTUEUtility.ShowFTUESequenceIfNotSeen( self, f1_arg0, "ZMLoadoutIntroduction" ) --[[ @ 0]]
	end
	return self
end
