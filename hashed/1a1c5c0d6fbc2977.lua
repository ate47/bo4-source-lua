...
CoD.directorArenaMatchmaking.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MapVotePC:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f5_local0 then
					f5_local0 = CoD.ModelUtility.IsGlobalModelValueEqualToEnum( "MapVote.lobbyMapVoteType", Enum[@"LobbyMapVote"][@"hash_4658B6B1B964D38A"] ) --[[ @ 0]]
					if f5_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f6_local0 then
					f6_local0 = CoD.ModelUtility.IsGlobalModelValueEqualToEnum( "MapVote.lobbyMapVoteType", Enum[@"LobbyMapVote"][@"hash_6D8A67C2C1AF1036"] ) --[[ @ 0]]
					if f6_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f7_local0 then
					f7_local0 = CoD.ModelUtility.IsGlobalModelValueEqualToEnum( "MapVote.lobbyMapVoteType", Enum[@"LobbyMapVote"][@"hash_374A46A6237E75F4"] ) --[[ @ 0]]
					if f7_local0 then
	...
	DirectorPreGameButton.DirectorCustomStartButton.MiddleText:setText( LocalizeToUpperString( @"hash_229C903C6DF90D6F" ) ) --[[ @ 0]]
	DirectorPreGameButton.DirectorCustomStartButton.MiddleTextFocus:setText( LocalizeToUpperString( @"hash_229C903C6DF90D6F" ) ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( DirectorPreGameButton, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		...
		CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_229C903C6DF90D6F", nil, nil ) --[[ @ 0]]
		return true
	end, false ) --[[ @ 0]]
