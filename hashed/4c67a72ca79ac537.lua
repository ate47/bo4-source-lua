...
CoD.JumpkitSelected_Internal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.JumpkitSelected_Internal.__defaultWidth = 152 --[[ @ 0]]
CoD.JumpkitSelected_Internal.__defaultHeight = 152 --[[ @ 0]]
CoD.JumpkitSelected_Internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.JumpkitSelected_Internal ) --[[ @ 0]]
	self.id = "JumpkitSelected_Internal" --[[ @ 0]]
	...
	local f1_local9 = EquippedMarkerTick --[[ @ 0]]
	local f1_local10 = EquippedMarkerTick.subscribeToModel --[[ @ 0]]
	local f1_local11 = DataSources.WZJumpKitItems.getModel( f1_arg1 ) --[[ @ 0]]
...
CoD.JumpkitSelected_Internal.__clipsPerState = {
	...
	Hidden = {
		...
		LoseChildFocus = function ( f22_arg0, f22_arg1 )
			...
			f22_arg0.caclock:setScale( 0.6, 0.6 ) --[[ @ 0]]
	...
	Locked = {
		...
		ChildFocus = function ( f24_arg0, f24_arg1 )
			...
			f24_arg0.icon:setRGB( 0.49, 0.49, 0.49 ) --[[ @ 0]]
		...
		GainChildFocus = function ( f25_arg0, f25_arg1 )
			...
			local f25_local0 = function ( f26_arg0 )
				f25_arg0.icon:beginAnimation( 200 ) --[[ @ 0]]
				f25_arg0.icon:setRGB( 0.49, 0.49, 0.49 ) --[[ @ 0]]
				f25_arg0.icon:registerEventHandler( "interrupted_keyframe", f25_arg0.clipInterrupted ) --[[ @ 0]]
				f25_arg0.icon:registerEventHandler( "transition_complete_keyframe", f25_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f25_arg0.icon:completeAnimation() --[[ @ 0]]
			f25_arg0.icon:setRGB( 0.29, 0.29, 0.29 ) --[[ @ 0]]
			f25_local0( f25_arg0.icon ) --[[ @ 0]]
			local f25_local1 = function ( f27_arg0 )
				f25_arg0.caclock:beginAnimation( 200 ) --[[ @ 0]]
				f25_arg0.caclock:registerEventHandler( "interrupted_keyframe", f25_arg0.clipInterrupted ) --[[ @ 0]]
				f25_arg0.caclock:registerEventHandler( "transition_complete_keyframe", f25_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f25_arg0.caclock:completeAnimation() --[[ @ 0]]
			f25_arg0.caclock:setRGB( 1, 1, 1 ) --[[ @ 0]]
			f25_arg0.caclock:setAlpha( 1 ) --[[ @ 0]]
			f25_local1( f25_arg0.caclock ) --[[ @ 0]]
		end,
...
CoD.JumpkitSelected_Internal.__onClose = function ( f35_arg0 )
	f35_arg0.icon:close() --[[ @ 0]]
	f35_arg0.caclock:close() --[[ @ 0]]
	f35_arg0.BMGoldBar:close() --[[ @ 0]]
	f35_arg0.BreadcrumbNew:close() --[[ @ 0]]
