...
LUI.GridLayout.addLeftRightActiveNavigation = function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
	CoD.Menu.AddButtonCallbackFunction( f8_arg1, f8_arg1, f8_arg2, Enum[@"LUIButton"][@"hash_1057783F8DA4AAEF"], "ui_navleft", function ( element, menu, controller, f9_arg3 )
	...
	CoD.Menu.AddButtonCallbackFunction( f8_arg1, f8_arg1, f8_arg2, Enum[@"LUIButton"][@"hash_4571F08AD84807E0"], "ui_navright", function ( element, menu, controller, f10_arg3 )
		if not f8_arg0.m_disableNavigation then
...
LUI.GridLayout.AddBumperPaging = function ( f11_arg0, f11_arg1, f11_arg2 )
	CoD.Menu.AddButtonCallbackFunction( f11_arg1, f11_arg0, f11_arg2, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"], "ui_pageup", function ( element, menu, controller, f12_arg3 )
	...
	CoD.Menu.AddButtonCallbackFunction( f11_arg1, f11_arg0, f11_arg2, Enum[@"LUIButton"][@"hash_249A252B20B48936"], "ui_pagedown", function ( element, menu, controller, f13_arg3 )
		if not f11_arg0.m_disableNavigation then
			BlockGameFromKeyEvent( controller ) --[[ @ 0]]
...
LUI.GridLayout.navigateItemUp = function ( f87_arg0, f87_arg1 )
	...
	if f87_local0 and f87_local0.gridInfoTable ~= nil then
		...
		for f87_local6 = f87_local1 --[[ @ 0]], f87_local5, -1 do
			...
			if CoD.BitUtility.IsBitwiseAndNonZero( f87_local2, Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) then
				f87_local9 = f87_local9 + math.floor( (#f87_arg0.rowColumnIndexMap[f87_local6] - f87_local3) / 2 ) --[[ @ 0]]
			elseif CoD.BitUtility.IsBitwiseAndNonZero( f87_local2, Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"] ) then
...
LUI.GridLayout.navigateItemDown = function ( f88_arg0, f88_arg1 )
	...
	if f88_local0 and f88_local0.gridInfoTable ~= nil then
		...
		for f88_local6 = f88_local1 --[[ @ 0]], f88_local5, 1 do
			...
			if CoD.BitUtility.IsBitwiseAndNonZero( f88_local2, Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) then
				f88_local9 = f88_local9 - math.floor( (f88_local3 - #f88_arg0.rowColumnIndexMap[f88_local6]) / 2 ) --[[ @ 0]]
			elseif CoD.BitUtility.IsBitwiseAndNonZero( f88_local2, Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"] ) then
...
LUI.GridLayout.updateLayout = function ( f114_arg0, f114_arg1 )
	...
	local f114_local18 = function ( f118_arg0, f118_arg1, f118_arg2 )
		...
		if f114_local15 & Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ~= 0 then
			f118_local0 = f118_local0 + (f114_local14 - f114_local10[f118_arg1]) / 2 --[[ @ 0]]
		elseif f114_local15 & Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"] ~= 0 then
