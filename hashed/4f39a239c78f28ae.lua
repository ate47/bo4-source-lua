...
require( "x64:17074d4a20877dae" ) --[[ @ 0]]

CoD.DemoSideBarButtonInternal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.DemoSideBarButtonInternal.__defaultWidth = 350 --[[ @ 0]]
CoD.DemoSideBarButtonInternal.__defaultHeight = 70 --[[ @ 0]]
CoD.DemoSideBarButtonInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DemoSideBarButtonInternal ) --[[ @ 0]]
	self.id = "DemoSideBarButtonInternal" --[[ @ 0]]
	...
	local Text = LUI.UIText.new( 0, 0, 80, 334, 0.5, 0.5, -11, 11 ) --[[ @ 0]]
	...
	local Icon = CoD.DemoSideBarButtonIcon.new( f1_arg0, f1_arg1, 0, 0, 22, 62, 0, 0, 15, 55 ) --[[ @ 0]]
	...
	Lock = LUI.UIImage.new( 0, 0, 31, 53, 0, 0, 22.5, 47.5 ) --[[ @ 0]]
	Lock:setAlpha( 0 ) --[[ @ 0]]
	...
	self.Text:linkToElementModel( self, "displayText", true, function ( model )
		...
		if f3_local0 ~= nil then
			Text:setText( LocalizeToUpperString( f3_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	self.Icon:linkToElementModel( self, "icon", true, function ( model )
		local f4_local0 = model:get() --[[ @ 0]]
		if f4_local0 ~= nil then
			Icon.Icon:setImage( RegisterImage( f4_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
...
CoD.DemoSideBarButtonInternal.__resetProperties = function ( f9_arg0 )
	...
	f9_arg0.Lock:completeAnimation() --[[ @ 0]]
	f9_arg0.FrontendFocusPip:setRGB( 1, 1, 1 ) --[[ @ 0]]
	...
	f9_arg0.Text:setRGB( 1, 1, 1 ) --[[ @ 0]]
	f9_arg0.Text:setAlpha( 1 ) --[[ @ 0]]
	f9_arg0.FrontendFrameSelectedGlow:setAlpha( 0 ) --[[ @ 0]]
	f9_arg0.SelectorOverlay:setAlpha( 0.01 ) --[[ @ 0]]
	f9_arg0.Lock:setLeftRight( 0, 0, 31, 53 ) --[[ @ 0]]
	f9_arg0.Lock:setTopBottom( 0, 0, 22.5, 47.5 ) --[[ @ 0]]
	f9_arg0.Lock:setAlpha( 0 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.DemoSideBarButtonInternal.__clipsPerState = {
	DefaultState = {
		...
		Focus = function ( f11_arg0, f11_arg1 )
			...
			f11_arg0.Text:setRGB( 0.92, 0.89, 0.72 ) --[[ @ 0]]
		...
		GainFocus = function ( f12_arg0, f12_arg1 )
			...
			f12_local1( f12_arg0.FrontendFrameSelected ) --[[ @ 0]]
			...
			f12_arg0.FrontendFocusPip:setRGB( 1, 1, 1 ) --[[ @ 0]]
			f12_arg0.FrontendFocusPip:setAlpha( 0 ) --[[ @ 0]]
			f12_arg0.FrontendFocusPip:setScale( 1.04, 1.16 ) --[[ @ 0]]
			f12_local2( f12_arg0.FrontendFocusPip ) --[[ @ 0]]
			...
			f12_arg0.Text:setRGB( 0.92, 0.89, 0.72 ) --[[ @ 0]]
		...
		LoseFocus = function ( f17_arg0, f17_arg1 )
			...
			f17_local1( f17_arg0.FrontendFrameSelected ) --[[ @ 0]]
			local f17_local2 = function ( f20_arg0 )
				f17_arg0.FrontendFocusPip:beginAnimation( 150 ) --[[ @ 0]]
				f17_arg0.FrontendFocusPip:setAlpha( 0 ) --[[ @ 0]]
				f17_arg0.FrontendFocusPip:setScale( 1.04, 1.16 ) --[[ @ 0]]
				f17_arg0.FrontendFocusPip:registerEventHandler( "interrupted_keyframe", f17_arg0.clipInterrupted ) --[[ @ 0]]
				f17_arg0.FrontendFocusPip:registerEventHandler( "transition_complete_keyframe", f17_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			f17_local2( f17_arg0.FrontendFocusPip ) --[[ @ 0]]
			local f17_local3 = function ( f21_arg0 )
				f17_arg0.FrontendFrameSelectedGlow:beginAnimation( 150 ) --[[ @ 0]]
				f17_arg0.FrontendFrameSelectedGlow:setAlpha( 0 ) --[[ @ 0]]
				f17_arg0.FrontendFrameSelectedGlow:registerEventHandler( "interrupted_keyframe", f17_arg0.clipInterrupted ) --[[ @ 0]]
				f17_arg0.FrontendFrameSelectedGlow:registerEventHandler( "transition_complete_keyframe", f17_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f17_arg0.FrontendFrameSelectedGlow:completeAnimation() --[[ @ 0]]
			f17_arg0.FrontendFrameSelectedGlow:setAlpha( 0.05 ) --[[ @ 0]]
			f17_local3( f17_arg0.FrontendFrameSelectedGlow ) --[[ @ 0]]
			f17_arg0.Text:completeAnimation() --[[ @ 0]]
			f17_arg0.Text:setRGB( 1, 1, 1 ) --[[ @ 0]]
	...
	Disabled = {
		DefaultClip = function ( f22_arg0, f22_arg1 )
			...
			f22_arg0.clipFinished( f22_arg0.FrontendFocusPip ) --[[ @ 0]]
			f22_arg0.Text:completeAnimation() --[[ @ 0]]
			f22_arg0.Text:setRGB( ColorSet.Disabled.r, ColorSet.Disabled.g, ColorSet.Disabled.b ) --[[ @ 0]]
			f22_arg0.clipFinished( f22_arg0.Text ) --[[ @ 0]]
			f22_arg0.Icon:completeAnimation() --[[ @ 0]]
			f22_arg0.Icon:setRGB( ColorSet.Disabled.r, ColorSet.Disabled.g, ColorSet.Disabled.b ) --[[ @ 0]]
	...
	Locked = {
		DefaultClip = function ( f23_arg0, f23_arg1 )
			...
			f23_arg0.FrontendFocusPip:setAlpha( 0 ) --[[ @ 0]]
			f23_arg0.clipFinished( f23_arg0.FrontendFocusPip ) --[[ @ 0]]
			f23_arg0.Text:completeAnimation() --[[ @ 0]]
			f23_arg0.Text:setRGB( ColorSet.Disabled.r, ColorSet.Disabled.g, ColorSet.Disabled.b ) --[[ @ 0]]
			f23_arg0.Text:setAlpha( 0.5 ) --[[ @ 0]]
			f23_arg0.clipFinished( f23_arg0.Text ) --[[ @ 0]]
			f23_arg0.Icon:completeAnimation() --[[ @ 0]]
			f23_arg0.Icon:setRGB( ColorSet.Disabled.r, ColorSet.Disabled.g, ColorSet.Disabled.b ) --[[ @ 0]]
			f23_arg0.Icon:setAlpha( 0 ) --[[ @ 0]]
			f23_arg0.clipFinished( f23_arg0.Icon ) --[[ @ 0]]
			f23_arg0.Lock:completeAnimation() --[[ @ 0]]
			f23_arg0.Lock:setLeftRight( 0, 0, 31, 53 ) --[[ @ 0]]
			f23_arg0.Lock:setTopBottom( 0, 0, 21.5, 46.5 ) --[[ @ 0]]
			f23_arg0.Lock:setAlpha( 0.2 ) --[[ @ 0]]
			f23_arg0.clipFinished( f23_arg0.Lock ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.DemoSideBarButtonInternal.__onClose = function ( f24_arg0 )
	f24_arg0.Text:close() --[[ @ 0]]
	f24_arg0.Icon:close() --[[ @ 0]]
end
 --[[ @ 0]]
