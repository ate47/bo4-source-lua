...
CoD.vhud_gunship_message = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.vhud_gunship_message.__defaultWidth = 502 --[[ @ 0]]
CoD.vhud_gunship_message.__defaultHeight = 82 --[[ @ 0]]
CoD.vhud_gunship_message.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.vhud_gunship_message ) --[[ @ 0]]
	self.id = "vhud_gunship_message" --[[ @ 0]]
	...
	local messageLayout = LUI.UIImage.new( 0, 0, 140.5, 361.5, 0, 0, 14, 64 ) --[[ @ 0]]
	messageLayout:setImage( RegisterImage( @"uie_ui_hud_vehicle_ac130_message_layout" ) ) --[[ @ 0]]
	messageLayout:setMaterial( LUI.UIImage.GetCachedMaterial( @"hash_31CC85D0A86303B0" ) ) --[[ @ 0]]
	messageLayout:setShaderVector( 0, 1, 0, 0, 0 ) --[[ @ 0]]
	self:addElement( messageLayout ) --[[ @ 0]]
	self.messageLayout = messageLayout --[[ @ 0]]
