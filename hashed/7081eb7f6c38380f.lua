...
CoD.DecalGroupsListFramePaintshop = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.DecalGroupsListFramePaintshop.__defaultWidth = 1820 --[[ @ 0]]
CoD.DecalGroupsListFramePaintshop.__defaultHeight = 965 --[[ @ 0]]
CoD.DecalGroupsListFramePaintshop.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DecalGroupsListFramePaintshop ) --[[ @ 0]]
	self.id = "DecalGroupsListFramePaintshop" --[[ @ 0]]
	...
	GroupsButtonList:setTopBottom( 0, 0, 88, 718 ) --[[ @ 0]]
	GroupsButtonList:setWidgetType( CoD.DecalTypeButton ) --[[ @ 0]]
	GroupsButtonList:setVerticalCount( 8 ) --[[ @ 0]]
	GroupsButtonList:setSpacing( 18 ) --[[ @ 0]]
	GroupsButtonList:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	decalGroupList:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	decalGroupList:appendEventHandler( "input_source_changed", function ( f7_arg0, f7_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f7_arg0, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_start"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	CraftLayersAvailable = decalGroupList --[[ @ 0]]
	DecalGroupsAvailable = decalGroupList.subscribeToModel --[[ @ 0]]
	DecalPreview = Engine[@"getmodelforcontroller"]( f1_arg1 ) --[[ @ 0]]
	DecalGroupsAvailable( CraftLayersAvailable, DecalPreview.LastInput, function ( f8_arg0, f8_arg1 )
		CoD.Menu.UpdateButtonShownState( f8_arg1, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_start"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	DecalGroupsAvailable = CoD.DecalGroupsAvailable.new( f1_arg0, f1_arg1, 0.63, 0.63, 57, 592, 0, 0, 851, 871 ) --[[ @ 0]]
	...
	CraftLayersAvailable = CoD.CraftLayersAvailable.new( f1_arg0, f1_arg1, 0, 0, 1202, 1737, 0, 0, 825, 845 ) --[[ @ 0]]
	self:addElement( CraftLayersAvailable ) --[[ @ 0]]
	self.CraftLayersAvailable = CraftLayersAvailable --[[ @ 0]]
	
	DecalPreview = CoD.DecalPreview.new( f1_arg0, f1_arg1, 0, 0, 1202, 1742, 0, 0, 71.5, 796.5 ) --[[ @ 0]]
	DecalPreview:setAlpha( 0 ) --[[ @ 0]]
	self:addElement( DecalPreview ) --[[ @ 0]]
	self.DecalPreview = DecalPreview --[[ @ 0]]
	
	SlotsUsedWidget = CoD.SlotsUsedWidget.new( f1_arg0, f1_arg1, 0, 0, 1202, 1732, 0, 0, 727, 820 ) --[[ @ 0]]
	...
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "totalSlots", function ( model )
		...
		if f20_local0 ~= nil then
			SlotsUsedWidget.Total:setText( f20_local0 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "usedSlots", function ( model )
		local f21_local0 = model:get() --[[ @ 0]]
		if f21_local0 ~= nil then
			SlotsUsedWidget.Used:setText( f21_local0 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "totalSlots", function ( model )
		local f22_local0 = model:get() --[[ @ 0]]
		if f22_local0 ~= nil then
			SlotsUsedWidget.totalBar:setShaderVector( 1, SetVectorComponent( 2, 1, CoD.GetVectorComponentFromString( f22_local0, 1 ), CoD.GetVectorComponentFromString( f22_local0, 2 ), CoD.GetVectorComponentFromString( f22_local0, 3 ), CoD.GetVectorComponentFromString( f22_local0, 4 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "totalSlots", function ( model )
		local f23_local0 = model:get() --[[ @ 0]]
		if f23_local0 ~= nil then
			SlotsUsedWidget.usedBar:setShaderVector( 1, SetVectorComponent( 2, 1, CoD.GetVectorComponentFromString( f23_local0, 1 ), CoD.GetVectorComponentFromString( f23_local0, 2 ), CoD.GetVectorComponentFromString( f23_local0, 3 ), CoD.GetVectorComponentFromString( f23_local0, 4 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	SlotsUsedWidget:subscribeToGlobalModel( f1_arg1, "CraftSlots", "percent", function ( model )
		local f24_local0 = model:get() --[[ @ 0]]
		if f24_local0 ~= nil then
			SlotsUsedWidget.usedBar:setShaderVector( 2, SetVectorComponent( 4, 1, SetVectorComponent( 3, 0, SetVectorComponent( 1, 0, SwapVectorComponents( 1, 2, CoD.GetVectorComponentFromString( f24_local0, 1 ), CoD.GetVectorComponentFromString( f24_local0, 2 ), CoD.GetVectorComponentFromString( f24_local0, 3 ), CoD.GetVectorComponentFromString( f24_local0, 4 ) ) ) ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	self:addElement( SlotsUsedWidget ) --[[ @ 0]]
	self.SlotsUsedWidget = SlotsUsedWidget --[[ @ 0]]
	
	local CraftLayerNumber = CoD.CraftLayerNumber.new( f1_arg0, f1_arg1, 0, 0, 1212, 1323, 0, 0, 102, 126 ) --[[ @ 0]]
...
CoD.DecalGroupsListFramePaintshop.__onClose = function ( f27_arg0 )
	f27_arg0.DecalPreview:close() --[[ @ 0]]
	f27_arg0.GroupsButtonList:close() --[[ @ 0]]
	f27_arg0.decalGroupList:close() --[[ @ 0]]
	f27_arg0.DecalGroupsAvailable:close() --[[ @ 0]]
	f27_arg0.CraftLayersAvailable:close() --[[ @ 0]]
	f27_arg0.SlotsUsedWidget:close() --[[ @ 0]]
	f27_arg0.CraftLayerNumber:close() --[[ @ 0]]
end
 --[[ @ 0]]
