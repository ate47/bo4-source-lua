...
CoD.StartMenu_Options_Graphics_ColorBlindMinimapPreview.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	playerHeader:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	playerHeader:setAlignment( Enum[@"luialignment"][@"lui_alignment_bottom"] ) --[[ @ 0]]
	...
	friendlyHeader:setText( LocalizeToUpperString( @"menu/friendly" ) ) --[[ @ 0]]
	friendlyHeader:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	friendlyHeader:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	friendlyHeader:setAlignment( Enum[@"luialignment"][@"lui_alignment_bottom"] ) --[[ @ 0]]
	...
	enemyHeader:setText( LocalizeToUpperString( @"menu/enemy" ) ) --[[ @ 0]]
	enemyHeader:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	enemyHeader:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	enemyHeader:setAlignment( Enum[@"luialignment"][@"lui_alignment_bottom"] ) --[[ @ 0]]
