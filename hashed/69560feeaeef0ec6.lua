...
CoD.WaypointHardpoint = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.WaypointHardpoint.__defaultWidth = 120 --[[ @ 0]]
CoD.WaypointHardpoint.__defaultHeight = 180 --[[ @ 0]]
CoD.WaypointHardpoint.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.WaypointHardpoint ) --[[ @ 0]]
	self.id = "WaypointHardpoint" --[[ @ 0]]
	...
	local WaypointText = CoD.Waypoint_TextBG.new( f1_arg0, f1_arg1, 0.5, 0.5, -60, 60, 0.5, 0.5, -93, -61 ) --[[ @ 0]]
	...
	local WaypointPatternColor = CoD.WaypointHardpoint_ColorPattern.new( f1_arg0, f1_arg1, 0.5, 0.5, -38, 38, 0.5, 0.5, -38, 38 ) --[[ @ 0]]
	...
	local WaypointPatternClock = LUI.UIImage.new( 0.5, 0.5, -37, 39, 0.5, 0.5, -38, 38 ) --[[ @ 0]]
	WaypointPatternClock:setRGB( 0.25, 0.25, 0.25 ) --[[ @ 0]]
	WaypointPatternClock:setAlpha( 0.92 ) --[[ @ 0]]
	WaypointPatternClock:setImage( RegisterImage( @"uie_ui_hud_core_waypoint_led" ) ) --[[ @ 0]]
	WaypointPatternClock:setMaterial( LUI.UIImage.GetCachedMaterial( @"uie_clock_normal" ) ) --[[ @ 0]]
	WaypointPatternClock:setShaderVector( 1, 0.5, 0, 0, 0 ) --[[ @ 0]]
	WaypointPatternClock:setShaderVector( 2, 0.5, 0, 0, 0 ) --[[ @ 0]]
	WaypointPatternClock:setShaderVector( 3, 0, 0, 0, 0 ) --[[ @ 0]]
	WaypointPatternClock:setShaderVector( 4, 0, 0, 0, 0 ) --[[ @ 0]]
	WaypointPatternClock:subscribeToGlobalModel( f1_arg1, "BombTimer", "bomb0.timeRemainingMilliSec", function ( model )
		...
		if f26_local0 ~= nil then
			WaypointPatternClock:setShaderVector( 0, CoD.HUDUtility.DivideByBombTimeLimit( f1_arg1, 2, SetVectorComponent( 1, 1, SwapVectorComponents( 1, 2, CoD.GetVectorComponentFromString( f26_local0, 1 ), CoD.GetVectorComponentFromString( f26_local0, 2 ), CoD.GetVectorComponentFromString( f26_local0, 3 ), CoD.GetVectorComponentFromString( f26_local0, 4 ) ) ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	self:addElement( WaypointPatternClock ) --[[ @ 0]]
	self.WaypointPatternClock = WaypointPatternClock --[[ @ 0]]
	
	local BombTimer = CoD.WaypointHardpoint_Timer.new( f1_arg0, f1_arg1, 0.5, 0.5, -57, 57, 0.5, 0.5, 51.5, 77.5 ) --[[ @ 0]]
	...
	WaypointProgressMeterEmpty:linkToElementModel( self, "waypointBacking02", true, function ( model )
		...
		if f28_local0 ~= nil then
			WaypointProgressMeterEmpty:setImage( RegisterImage( f28_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	local WaypointCenterIcon = CoD.WaypointHardpoint_ColorIcon.new( f1_arg0, f1_arg1, 0.5, 0.5, -38, 38, 0.5, 0.5, -39, 39 ) --[[ @ 0]]
	...
	f1_local14 = self --[[ @ 0]]
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = DataSources.CurrentPrimaryOffhand.getModel( f1_arg1 ) --[[ @ 0]]
	...
	f1_local14 = self --[[ @ 0]]
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = DataSources.LethalOffhands.getModel( f1_arg1 ) --[[ @ 0]]
	...
	f1_local14 = self --[[ @ 0]]
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = DataSources.CurrentSecondaryOffhand.getModel( f1_arg1 ) --[[ @ 0]]
	...
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local15( f1_local14, f1_local16["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"]], function ( f51_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local15( f1_local14, f1_local16["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_7ADC477DDE486DD7"]], function ( f52_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local15( f1_local14, f1_local16["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_59333FC97F7870"]], function ( f53_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local15( f1_local14, f1_local16["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_1C630DB86D235A5"]], function ( f54_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	LUI.OverrideFunction_CallOriginalFirst( self, "setModel", function ( element, controller )
		CoD.HUDUtility.SetHardpointObjective( self ) --[[ @ 0]]
	end ) --[[ @ 0]]
...
CoD.WaypointHardpoint.__resetProperties = function ( f59_arg0 )
	...
	f59_arg0.BombTimer:completeAnimation() --[[ @ 0]]
	f59_arg0.WaypointPatternClock:completeAnimation() --[[ @ 0]]
	f59_arg0.WaypointCenterIcon:completeAnimation() --[[ @ 0]]
	f59_arg0.WaypointPatternColor:completeAnimation() --[[ @ 0]]
	f59_arg0.WaypointArrowContainer:setAlpha( 0.95 ) --[[ @ 0]]
	f59_arg0.WaypointArrowDownNotClampedContainer:setAlpha( 0.95 ) --[[ @ 0]]
	f59_arg0.ProgressBar:setLeftRight( 0.5, 0.5, -175, 175 ) --[[ @ 0]]
	f59_arg0.ProgressBar:setTopBottom( 0.5, 0.5, 65, 75 ) --[[ @ 0]]
	f59_arg0.ProgressBar:setAlpha( 1 ) --[[ @ 0]]
	f59_arg0.ProgressBarBGBlur:setLeftRight( 0.5, 0.5, -179, 179 ) --[[ @ 0]]
	f59_arg0.ProgressBarBGBlur:setTopBottom( 0.5, 0.5, 61, 79 ) --[[ @ 0]]
	f59_arg0.ProgressBarBGBlur:setAlpha( 1 ) --[[ @ 0]]
	f59_arg0.ProgressBarBGTint:setLeftRight( 0.5, 0.5, -179, 179 ) --[[ @ 0]]
	f59_arg0.ProgressBarBGTint:setTopBottom( 0.5, 0.5, 61, 79 ) --[[ @ 0]]
	f59_arg0.ProgressBarBGTint:setAlpha( 0.2 ) --[[ @ 0]]
	f59_arg0.WaypointBacker:setAlpha( 1 ) --[[ @ 0]]
	f59_arg0.WaypointText:setLeftRight( 0.5, 0.5, -60, 60 ) --[[ @ 0]]
	f59_arg0.WaypointText:setTopBottom( 0.5, 0.5, -93, -61 ) --[[ @ 0]]
	f59_arg0.WaypointText:setAlpha( 1 ) --[[ @ 0]]
	f59_arg0.WaypointProgressMeterEmpty:setAlpha( 1 ) --[[ @ 0]]
	f59_arg0.WaypointProgressMeter:setLeftRight( 0.5, 0.5, -35, 35 ) --[[ @ 0]]
	f59_arg0.WaypointProgressMeter:setTopBottom( 0.5, 0.5, -35, 35 ) --[[ @ 0]]
	f59_arg0.WaypointProgressMeter:setAlpha( 1 ) --[[ @ 0]]
	f59_arg0.BombTimer:setAlpha( 1 ) --[[ @ 0]]
	f59_arg0.WaypointPatternClock:setAlpha( 0.92 ) --[[ @ 0]]
	f59_arg0.WaypointCenterIcon:setAlpha( 1 ) --[[ @ 0]]
	f59_arg0.WaypointPatternColor:setAlpha( 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.WaypointHardpoint.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f60_arg0, f60_arg1 )
			...
			f60_arg0.WaypointBacker:setAlpha( 1 ) --[[ @ 0]]
	...
	Hidden = {
		DefaultClip = function ( f61_arg0, f61_arg1 )
			...
			f61_arg0.WaypointText:setAlpha( 0 ) --[[ @ 0]]
			...
			f61_arg0.WaypointPatternColor:completeAnimation() --[[ @ 0]]
			f61_arg0.WaypointPatternColor:setAlpha( 0 ) --[[ @ 0]]
			f61_arg0.clipFinished( f61_arg0.WaypointPatternColor ) --[[ @ 0]]
			f61_arg0.WaypointPatternClock:completeAnimation() --[[ @ 0]]
			f61_arg0.WaypointPatternClock:setAlpha( 0 ) --[[ @ 0]]
			f61_arg0.clipFinished( f61_arg0.WaypointPatternClock ) --[[ @ 0]]
			f61_arg0.BombTimer:completeAnimation() --[[ @ 0]]
			f61_arg0.BombTimer:setAlpha( 0 ) --[[ @ 0]]
			f61_arg0.clipFinished( f61_arg0.BombTimer ) --[[ @ 0]]
	...
	NoIcon = {
		DefaultClip = function ( f62_arg0, f62_arg1 )
			...
			f62_arg0:setupElementClipCounter( 12 ) --[[ @ 0]]
			...
			f62_arg0.WaypointText:setTopBottom( 0.5, 0.5, -81, -49 ) --[[ @ 0]]
			f62_arg0.clipFinished( f62_arg0.WaypointText ) --[[ @ 0]]
			f62_arg0.WaypointBacker:completeAnimation() --[[ @ 0]]
			f62_arg0.WaypointBacker:setAlpha( 0 ) --[[ @ 0]]
			f62_arg0.clipFinished( f62_arg0.WaypointBacker ) --[[ @ 0]]
			f62_arg0.WaypointPatternColor:completeAnimation() --[[ @ 0]]
			f62_arg0.WaypointPatternColor:setAlpha( 0 ) --[[ @ 0]]
			f62_arg0.clipFinished( f62_arg0.WaypointPatternColor ) --[[ @ 0]]
			f62_arg0.WaypointPatternClock:completeAnimation() --[[ @ 0]]
			f62_arg0.WaypointPatternClock:setAlpha( 0 ) --[[ @ 0]]
			f62_arg0.clipFinished( f62_arg0.WaypointPatternClock ) --[[ @ 0]]
			f62_arg0.WaypointProgressMeterEmpty:completeAnimation() --[[ @ 0]]
			f62_arg0.WaypointProgressMeterEmpty:setAlpha( 0 ) --[[ @ 0]]
			...
			f62_arg0.WaypointCenterIcon:setAlpha( 0 ) --[[ @ 0]]
			f62_arg0.clipFinished( f62_arg0.WaypointCenterIcon ) --[[ @ 0]]
		end
	},
	ProgressBar = {
		DefaultClip = function ( f63_arg0, f63_arg1 )
			f63_arg0:__resetProperties() --[[ @ 0]]
			f63_arg0:setupElementClipCounter( 12 ) --[[ @ 0]]
			f63_arg0.ProgressBarBGBlur:completeAnimation() --[[ @ 0]]
			f63_arg0.ProgressBarBGBlur:setLeftRight( 0.5, 0.5, -179, 179 ) --[[ @ 0]]
			f63_arg0.ProgressBarBGBlur:setTopBottom( 0.5, 0.5, -35, -17 ) --[[ @ 0]]
			f63_arg0.ProgressBarBGBlur:setAlpha( 1 ) --[[ @ 0]]
			f63_arg0.clipFinished( f63_arg0.ProgressBarBGBlur ) --[[ @ 0]]
			f63_arg0.ProgressBarBGTint:completeAnimation() --[[ @ 0]]
			f63_arg0.ProgressBarBGTint:setLeftRight( 0.5, 0.5, -179, 179 ) --[[ @ 0]]
			f63_arg0.ProgressBarBGTint:setTopBottom( 0.5, 0.5, -35, -17 ) --[[ @ 0]]
			f63_arg0.clipFinished( f63_arg0.ProgressBarBGTint ) --[[ @ 0]]
			f63_arg0.ProgressBar:completeAnimation() --[[ @ 0]]
			f63_arg0.ProgressBar:setLeftRight( 0.5, 0.5, -175, 175 ) --[[ @ 0]]
			f63_arg0.ProgressBar:setTopBottom( 0.5, 0.5, -31, -21 ) --[[ @ 0]]
			f63_arg0.ProgressBar:setAlpha( 1 ) --[[ @ 0]]
			f63_arg0.clipFinished( f63_arg0.ProgressBar ) --[[ @ 0]]
			f63_arg0.WaypointArrowDownNotClampedContainer:completeAnimation() --[[ @ 0]]
			f63_arg0.WaypointArrowDownNotClampedContainer:setAlpha( 0 ) --[[ @ 0]]
			f63_arg0.clipFinished( f63_arg0.WaypointArrowDownNotClampedContainer ) --[[ @ 0]]
			f63_arg0.WaypointArrowContainer:completeAnimation() --[[ @ 0]]
			f63_arg0.WaypointArrowContainer:setAlpha( 0 ) --[[ @ 0]]
			...
			f63_arg0.WaypointPatternColor:completeAnimation() --[[ @ 0]]
			f63_arg0.WaypointPatternColor:setAlpha( 0 ) --[[ @ 0]]
			f63_arg0.clipFinished( f63_arg0.WaypointPatternColor ) --[[ @ 0]]
			f63_arg0.WaypointPatternClock:completeAnimation() --[[ @ 0]]
			f63_arg0.WaypointPatternClock:setAlpha( 0 ) --[[ @ 0]]
			f63_arg0.clipFinished( f63_arg0.WaypointPatternClock ) --[[ @ 0]]
			f63_arg0.BombTimer:completeAnimation() --[[ @ 0]]
			f63_arg0.BombTimer:setAlpha( 0 ) --[[ @ 0]]
			f63_arg0.clipFinished( f63_arg0.BombTimer ) --[[ @ 0]]
			f63_arg0.WaypointProgressMeterEmpty:completeAnimation() --[[ @ 0]]
			f63_arg0.WaypointProgressMeterEmpty:setAlpha( 0 ) --[[ @ 0]]
			f63_arg0.clipFinished( f63_arg0.WaypointProgressMeterEmpty ) --[[ @ 0]]
			f63_arg0.WaypointProgressMeter:completeAnimation() --[[ @ 0]]
			f63_arg0.WaypointProgressMeter:setLeftRight( 0.5, 0.5, -35, 35 ) --[[ @ 0]]
			f63_arg0.WaypointProgressMeter:setTopBottom( 0.5, 0.5, -35, 35 ) --[[ @ 0]]
			f63_arg0.WaypointProgressMeter:setAlpha( 0 ) --[[ @ 0]]
			f63_arg0.clipFinished( f63_arg0.WaypointProgressMeter ) --[[ @ 0]]
			f63_arg0.WaypointCenterIcon:completeAnimation() --[[ @ 0]]
			f63_arg0.WaypointCenterIcon:setAlpha( 0 ) --[[ @ 0]]
	...
	NoFrame = {
		DefaultClip = function ( f64_arg0, f64_arg1 )
			...
			f64_arg0.ProgressBarBGBlur:completeAnimation() --[[ @ 0]]
			f64_arg0.ProgressBarBGBlur:setAlpha( 0 ) --[[ @ 0]]
			f64_arg0.clipFinished( f64_arg0.ProgressBarBGBlur ) --[[ @ 0]]
			f64_arg0.ProgressBarBGTint:completeAnimation() --[[ @ 0]]
			f64_arg0.ProgressBarBGTint:setAlpha( 0 ) --[[ @ 0]]
			f64_arg0.clipFinished( f64_arg0.ProgressBarBGTint ) --[[ @ 0]]
			f64_arg0.ProgressBar:completeAnimation() --[[ @ 0]]
			f64_arg0.ProgressBar:setAlpha( 0 ) --[[ @ 0]]
			f64_arg0.clipFinished( f64_arg0.ProgressBar ) --[[ @ 0]]
			f64_arg0.WaypointArrowDownNotClampedContainer:completeAnimation() --[[ @ 0]]
			f64_arg0.WaypointArrowDownNotClampedContainer:setAlpha( 0.95 ) --[[ @ 0]]
			f64_arg0.clipFinished( f64_arg0.WaypointArrowDownNotClampedContainer ) --[[ @ 0]]
			f64_arg0.WaypointArrowContainer:completeAnimation() --[[ @ 0]]
			f64_arg0.WaypointArrowContainer:setAlpha( 0.95 ) --[[ @ 0]]
			f64_arg0.clipFinished( f64_arg0.WaypointArrowContainer ) --[[ @ 0]]
			f64_arg0.WaypointProgressMeterEmpty:completeAnimation() --[[ @ 0]]
			f64_arg0.WaypointProgressMeterEmpty:setAlpha( 1 ) --[[ @ 0]]
			f64_arg0.clipFinished( f64_arg0.WaypointProgressMeterEmpty ) --[[ @ 0]]
			f64_arg0.WaypointProgressMeter:completeAnimation() --[[ @ 0]]
			f64_arg0.WaypointProgressMeter:setAlpha( 0 ) --[[ @ 0]]
			f64_arg0.clipFinished( f64_arg0.WaypointProgressMeter ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.WaypointHardpoint.__onClose = function ( f65_arg0 )
	f65_arg0.ProgressBar:close() --[[ @ 0]]
	f65_arg0.WaypointArrowDownNotClampedContainer:close() --[[ @ 0]]
	f65_arg0.WaypointArrowContainer:close() --[[ @ 0]]
	f65_arg0.WaypointText:close() --[[ @ 0]]
	f65_arg0.WaypointBacker:close() --[[ @ 0]]
	f65_arg0.WaypointPatternColor:close() --[[ @ 0]]
	f65_arg0.WaypointPatternClock:close() --[[ @ 0]]
	f65_arg0.BombTimer:close() --[[ @ 0]]
	f65_arg0.WaypointProgressMeterEmpty:close() --[[ @ 0]]
	f65_arg0.WaypointProgressMeter:close() --[[ @ 0]]
	f65_arg0.WaypointCenterIcon:close() --[[ @ 0]]
end
 --[[ @ 0]]
