...
CoD.LoadoutClassItemContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	LoadoutClassItemContainerInternal:appendEventHandler( "input_source_changed", function ( f5_arg0, f5_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f5_arg0, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_lstick_pressed"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( LoadoutClassItemContainerInternal, f1_arg1, Enum[@"luibutton"][@"lui_key_lstick_pressed"], "ui_copylayer", function ( element, menu, controller, model )
		...
		if IsMouseOrKeyboard( controller ) and IsInDefaultState( self ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_lstick_pressed"], @"hash_353D10BEF28D6E73", Enum[@"luibuttonpromptflags"][@"bpf_contextual"], "ui_copylayer" ) --[[ @ 0]]
			return true
		else
			return false
		end
