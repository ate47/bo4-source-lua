...
CoD.DropDownList_ItemControl = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.DropDownList_ItemControl.__defaultWidth = 336 --[[ @ 0]]
CoD.DropDownList_ItemControl.__defaultHeight = 65 --[[ @ 0]]
CoD.DropDownList_ItemControl.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DropDownList_ItemControl ) --[[ @ 0]]
	self.id = "DropDownList_ItemControl" --[[ @ 0]]
	self.soundSet = "ChooseDecal" --[[ @ 0]]
	self.onlyChildrenFocusable = true --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local TextBox = LUI.UIText.new( 0, 1, 42, -42, 0.5, 0.5, -8.5, 10.5 ) --[[ @ 0]]
	...
	local Arrow = LUI.UIImage.new( 1, 1, -60, 5, 0.5, 0.5, -32.5, 32.5 ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( center, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		if not CoD.PCUtility.IsUnavailable( self, controller ) then
			CoD.PCWidgetUtility.CreateDropdown( self, self, controller, menu, "DropDown_ItemList" ) --[[ @ 0]]
			return true
		else
