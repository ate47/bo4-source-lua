...
CoD.directorPublic.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	HeaderWZ.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_7A2DD20750465431" ) ) --[[ @ 0]]
	...
	WarzoneHostPlayButton:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f8_local0 then
					f8_local0 = CoD.BaseUtility.IsCurrentSessionModeEqualTo( Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) --[[ @ 0]]
					if f8_local0 then
						...
						if f8_local0 then
							...
							if f8_local0 then
								...
								if f8_local0 then
									f8_local0 = CoD.DirectorUtility.IsMainMode( f1_arg1, Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] ) --[[ @ 0]]
									if f8_local0 then
	...
	WarzoneHostPlayButton.DirectorSelectButtonMiniInternal.MiddleText:setText( LocalizeToUpperString( @"hash_A56BF6A96B02984" ) ) --[[ @ 0]]
	WarzoneHostPlayButton.DirectorSelectButtonMiniInternal.MiddleTextFocus:setText( LocalizeToUpperString( @"hash_A56BF6A96B02984" ) ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( WarzoneHostPlayButton, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	WarzoneClientPlayButton:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f16_local0 then
					f16_local0 = CoD.BaseUtility.IsCurrentSessionModeEqualTo( Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) --[[ @ 0]]
					if f16_local0 then
						if not IsLobbyPrivateHost() then
							...
							if f16_local0 then
								...
								if f16_local0 then
									f16_local0 = CoD.DirectorUtility.IsMainMode( f1_arg1, Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] ) --[[ @ 0]]
									if f16_local0 then
	...
	f1_arg0:AddButtonCallbackFunction( MapAndGameType, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	DirectorReadyButton.DirectorSelectButtonMiniInternal.MiddleText:setText( LocalizeToUpperString( @"hash_17A9F166E7248D86" ) ) --[[ @ 0]]
	DirectorReadyButton.DirectorSelectButtonMiniInternal.MiddleTextFocus:setText( LocalizeToUpperString( @"hash_17A9F166E7248D86" ) ) --[[ @ 0]]
	DirectorReadyButton.PlayText:setText( LocalizeToUpperString( @"hash_5E6F6113B8B75F3E" ) ) --[[ @ 0]]
	DirectorReadyButton:subscribeToGlobalModel( f1_arg1, "PerController", "ButtonBits." .. Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], function ( model )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f45_local0 then
					f45_local0 = CoD.DirectorUtility.IsMainMode( f1_arg1, Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] ) --[[ @ 0]]
					if f45_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				return CoD.DirectorUtility.IsMainMode( f1_arg1, Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] ) and CoD.ModelUtility.IsGlobalModelValueEqualToEnum( "lobbyRoot.publicLobby.stage", LuaEnum.PUBLIC_LOBBY.INVALID )
			end
		},
		{
			stateName = "WarzoneDeploying_isPC",
			condition = function ( menu, element, event )
				return CoD.DirectorUtility.IsMainMode( f1_arg1, Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] ) and IsPC()
			end
		},
		{
			stateName = "WarzoneDeploying",
			condition = function ( menu, element, event )
				return CoD.DirectorUtility.IsMainMode( f1_arg1, Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] )
			end
		},
		{
