...
Lobby.Platform.PlatformSessionGetPartyPrivacyStatus = function ( f1_arg0 )
	...
	if f1_arg0 == Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] then
		f1_local0 = "OPEN" --[[ @ 0]]
	elseif f1_arg0 == Enum[@"PartyPrivacy"][@"hash_1BE1A36D69A39221"] then
		f1_local0 = "FRIENDS ONLY" --[[ @ 0]]
	elseif f1_arg0 == Enum[@"PartyPrivacy"][@"hash_52507221A765592F"] then
		f1_local0 = "INVITE ONLY" --[[ @ 0]]
	elseif f1_arg0 == Enum[@"PartyPrivacy"][@"hash_78B288F48084ABC5"] then
		f1_local0 = "CLOSED" --[[ @ 0]]
	end
	return f1_local0
end
...
Lobby.Platform.PlatformSessionOrbisEnabled = function ()
	if LuaDefine.isPS4 == false or Engine[@"hash_5E39F1F30B306065"]() then
		return false
	elseif not Dvar[@"hash_12B11EC2E089C84"]:exists() then
		return false
	else
		return Dvar[@"hash_12B11EC2E089C84"]:get() > Enum[@"PlatformSessions"][@"hash_642E31EBFC59EA48"]
	end
end
 --[[ @ 0]]
Lobby.Platform.PlatformSessionDurangoEnabled = function ()
	if LuaDefine.isXbox == false or Engine[@"hash_5E39F1F30B306065"]() then
		return false
	elseif not Dvar[@"hash_17843C9D23778443"]:exists() then
		return false
	else
		return Dvar[@"hash_17843C9D23778443"]:get() > Enum[@"PlatformSessions"][@"hash_642E31EBFC59EA48"]
	end
end
 --[[ @ 0]]
...
Lobby.Platform.PlatformSessionPCEnabled = function ()
	if LuaDefine.isPC == false or Engine[@"hash_5E39F1F30B306065"]() then
		return false
	else
		return true
	end
...
Lobby.Platform.IsRankedGame = function ()
	local f7_local0 --[[ @ 0]]
	if Lobby.Platform.IsOnlineGame() == true and not Engine[@"GameModeIsMode"]( Enum[@"eGameModes"][@"hash_15E90ACB801E4A3D"] ) then
...
Lobby.Platform.OnMatchEnd = function ( f13_arg0 )
	...
	if LuaDefine.isPS4 == true and f13_arg0.lobbyType == Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] and Enum[@"LobbyNetworkMode"][@"hash_2E99F41098B71960"] == Engine[@"hash_7A63E42B2FB6EC02"]() then
...
Lobby.Platform.OnPlatformPlayTogether = function ( f14_arg0 )
	...
	if Lobby.Timer.LobbyIsLocked() then
		LuaUtils.UI_ShowErrorMessageDialog( f14_local0, Engine[@"hash_4F9F1239CFD921FE"]( @"hash_21EC124551C8B7E5" ), Engine[@"hash_4F9F1239CFD921FE"]( @"hash_6FA1F1A14BB49273" ) ) --[[ @ 0]]
		return 
...
Lobby.Platform.OnPlatformSessionDataUpdate = function ( f15_arg0 )
	...
	if Lobby.Platform.PlatformSessionOrbisEnabled() then
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "OnPlatformSessionDataUpdate event occurred, sessionId: '" .. f15_local4 .. "', gamertag: " .. f15_local3 .. ".\n" ) --[[ @ 0]]
	elseif Lobby.Platform.PlatformSessionDurangoEnabled() then
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "OnPlatformSessionDataUpdate event occurred, sessionId: '" .. f15_local4 .. "', gamertag: " .. f15_local3 .. ".\n" ) --[[ @ 0]]
	end
...
Lobby.Platform.OnPlatformJoinOrbis = function ( f16_arg0 )
	...
	local f16_local7 = Enum[@"JoinType"][@"hash_40D4D58772DE8652"] --[[ @ 0]]
	if not Engine[@"IsRunningUILevel"]() then
		local f16_local8 = {
		...
		local f16_local9 --[[ @ 0]]
		if f16_local3 then
			f16_local9 = Enum[@"JoinType"][@"hash_40D4D58772DE8652"] --[[ @ 0]]
		...
		f16_local9 = Enum[@"JoinType"][@"hash_C21E48130C4B82B"] --[[ @ 0]]
	else
		if f16_local3 == false then
			f16_local7 = Enum[@"JoinType"][@"hash_C21E48130C4B82B"] --[[ @ 0]]
			f16_local4 = nil --[[ @ 0]]
		end
...
Lobby.Platform.InGamePlatformJoinOrbis = function ( f17_arg0 )
	...
	local f17_local7 = Enum[@"JoinType"][@"hash_40D4D58772DE8652"] --[[ @ 0]]
	if f17_local3 == false then
		f17_local4 = nil --[[ @ 0]]
		f17_local7 = Enum[@"JoinType"][@"hash_C21E48130C4B82B"] --[[ @ 0]]
	end
...
Lobby.Platform.OnPlatformJoinDurango = function ( f18_arg0 )
	...
	if f18_local1 == LuaDefine.INVALID_CONTROLLER_PORT then
		...
		return nil
	elseif Engine[@"hash_686E64DD1C270046"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"], f18_local2 ) or Engine[@"hash_686E64DD1C270046"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], f18_local2 ) then
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6C1DE3DC19B3B20D"], "LobbyVM: Trying to Join lobby we are already part of.\n" ) --[[ @ 0]]
		Engine[@"hash_57C090837EE00D5E"]() --[[ @ 0]]
		return nil
	elseif not Engine[@"IsRunningUILevel"]() then
		...
		local f18_local4 --[[ @ 0]]
		if f18_local0 then
			f18_local4 = Enum[@"JoinType"][@"hash_40D4D58772DE8652"] --[[ @ 0]]
		...
		f18_local4 = Enum[@"JoinType"][@"hash_C21E48130C4B82B"] --[[ @ 0]]
	elseif f18_arg0.invite == true then
		Lobby.ProcessQueue.AddToQueue( "XboxAcceptInvite", Lobby.ProcessPlatform.XboxJoin( Engine[@"GetControllerForXuid"]( f18_arg0.invitedXuid ), f18_arg0.senderXuid, Enum[@"JoinType"][@"hash_40D4D58772DE8652"], LuaEnum.LEAVE_WITH_PARTY.WITHOUT ) ) --[[ @ 0]]
	else
		Lobby.ProcessQueue.AddToQueue( "XboxSessionJoin", Lobby.ProcessPlatform.XboxJoin( Engine[@"GetControllerForXuid"]( f18_arg0.joinerXuid ), f18_arg0.joineeXuid, Enum[@"JoinType"][@"hash_C21E48130C4B82B"], LuaEnum.LEAVE_WITH_PARTY.WITHOUT ) ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
Lobby.Platform.InGamePlatformJoinDurango = function ( f19_arg0 )
	if f19_arg0.invite == true then
		return Lobby.ProcessPlatform.XboxJoin( Engine[@"GetControllerForXuid"]( f19_arg0.invitedXuid ), f19_arg0.senderXuid, Enum[@"JoinType"][@"hash_40D4D58772DE8652"], LuaEnum.LEAVE_WITH_PARTY.WITHOUT )
	else
		return Lobby.ProcessPlatform.XboxJoin( Engine[@"GetControllerForXuid"]( f19_arg0.joinerXuid ), f19_arg0.joineeXuid, Enum[@"JoinType"][@"hash_C21E48130C4B82B"], LuaEnum.LEAVE_WITH_PARTY.WITHOUT )
	end
end
 --[[ @ 0]]
Lobby.Platform.OnPlatformJoin = function ( f20_arg0 )
	if LuaDefine.isPS4 or LuaDefine.isXbox then
		if Lobby.Timer.LobbyIsLocked() then
			LuaUtils.UI_ShowErrorMessageDialog( controller, Engine[@"hash_4F9F1239CFD921FE"]( @"hash_21EC124551C8B7E5" ), Engine[@"hash_4F9F1239CFD921FE"]( @"hash_6FA1F1A14BB49273" ) ) --[[ @ 0]]
			return 
		elseif LuaDefine.isXbox then
			...
			if Engine[@"hash_686E64DD1C270046"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"], f20_local1 ) or Engine[@"hash_686E64DD1C270046"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], f20_local1 ) then
				Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6C1DE3DC19B3B20D"], "LobbyVM: Trying to Join lobby we are already part of.\n" ) --[[ @ 0]]
				Engine[@"hash_57C090837EE00D5E"]() --[[ @ 0]]
				return 
			end
	...
	elseif LuaDefine.isPS4 then
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6C1DE3DC19B3B20D"], "PlatformSession - OnPlatformJoin, sessionId:" .. f20_arg0.sessionId .. ", invite:" .. tostring( f20_arg0.invite ) .. ", invitationId:" .. f20_arg0.invitationId .. ".\n" ) --[[ @ 0]]
	elseif LuaDefine.isXbox then
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6C1DE3DC19B3B20D"], "PlatformSession - OnPlatformJoin, joinerXuid:" .. tostring( f20_arg0.joinerXuid ) .. ", invite:" .. tostring( f20_arg0.invite ) .. ", joineeXuid:" .. tostring( f20_arg0.joineeXuid ) .. ".\n" ) --[[ @ 0]]
	end
	Engine[@"ForceNotifyModelSubscriptions"]( Engine[@"CreateModel"]( Engine[@"GetGlobalModel"](), "lobbyRoot.closePopups" ) ) --[[ @ 0]]
	if Lobby.Platform.PlatformSessionOrbisEnabled() then
...
Lobby.Platform.PlatformSessionDirty = function ( f21_arg0 )
	if Lobby.Platform.PlatformSessionOrbisEnabled() then
		if f21_arg0 ~= Enum[@"LobbyType"][@"hash_20A1647599284110"] then
			return 
		end
...
local f0_local0 = function ( f23_arg0, f23_arg1 )
	...
	Lobby.Platform.PS4.lobbyId[f23_arg0 + 1] = Engine[@"hash_8CB6D1C656D57EE"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"] ) --[[ @ 0]]
	Engine[@"hash_67FA097EC16F2681"]( f23_arg0, Enum[@"LobbyType"][@"hash_20A1647599284110"], f23_arg1 ) --[[ @ 0]]
end
 --[[ @ 0]]
...
local f0_local2 = function ( f26_arg0 )
	...
	Engine[@"hash_67FA097EC16F2681"]( f26_arg0, Enum[@"LobbyType"][@"hash_20A1647599284110"], "" ) --[[ @ 0]]
end
 --[[ @ 0]]
Lobby.Platform.PlatformSessionPS4Error = function ( f27_arg0, f27_arg1 )
	local f27_local0 = Dvar[@"hash_12B11EC2E089C84"]:get() --[[ @ 0]]
	Lobby.Platform.PS4.taskInProgress = false --[[ @ 0]]
	Engine[@"hash_5AF2EDE16C0386FE"]() --[[ @ 0]]
	if f27_local0 == Enum[@"PlatformSessions"][@"hash_275E6BB927BE46B4"] then
		f0_local1( f27_arg0, true, Engine[@"seconds"]() + Engine[@"hash_622EAAB59AA27E9B"]( Lobby.Platform.DISABLE_PLATFORM_SESSIONS ) ) --[[ @ 0]]
	elseif f27_local0 == Enum[@"PlatformSessions"][@"hash_6DB75ABE61E9C81F"] then
		...
		if Dvar[@"hash_9D38D804EC061EB"]:get() == true then
...
Lobby.Platform.PlatformSessionPS4GetLockFlag = function ( f28_arg0 )
	...
	if f28_arg0 == Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] then
		f28_local0 = Lobby.Platform.PLATFORM_SESSION_PS4_LOCK_FLAG.UNLOCKED --[[ @ 0]]
	elseif f28_arg0 == Enum[@"PartyPrivacy"][@"hash_1BE1A36D69A39221"] then
		f28_local0 = Lobby.Platform.PLATFORM_SESSION_PS4_LOCK_FLAG.UNLOCKED --[[ @ 0]]
	elseif f28_arg0 == Enum[@"PartyPrivacy"][@"hash_52507221A765592F"] then
		f28_local0 = Lobby.Platform.PLATFORM_SESSION_PS4_LOCK_FLAG.UNLOCKED --[[ @ 0]]
	elseif f28_arg0 == Enum[@"PartyPrivacy"][@"hash_78B288F48084ABC5"] then
...
Lobby.Platform.PlatformSessionPS4GetSessionTypeFlag = function ( f29_arg0 )
	...
	if f29_arg0 == Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] then
		f29_local0 = Lobby.Platform.PLATFORM_SESSION_PS4_SESSION_FLAG.PUBLIC --[[ @ 0]]
	elseif f29_arg0 == Enum[@"PartyPrivacy"][@"hash_1BE1A36D69A39221"] then
		f29_local0 = Lobby.Platform.PLATFORM_SESSION_PS4_SESSION_FLAG.PUBLIC --[[ @ 0]]
	elseif f29_arg0 == Enum[@"PartyPrivacy"][@"hash_52507221A765592F"] then
		f29_local0 = Lobby.Platform.PLATFORM_SESSION_PS4_SESSION_FLAG.PRIVATE --[[ @ 0]]
	elseif f29_arg0 == Enum[@"PartyPrivacy"][@"hash_78B288F48084ABC5"] then
		f29_local0 = Lobby.Platform.PLATFORM_SESSION_PS4_SESSION_FLAG.PUBLIC --[[ @ 0]]
	end
	return f29_local0
end
...
Lobby.Platform.PlatformSessionPS4CreateComplete = function ( f30_arg0, f30_arg1, f30_arg2 )
	...
	if f30_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4CreateComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f30_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f30_local1 == false then
			...
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4CreateComplete, we have successfully created session id: '" .. Lobby.Platform.PS4GetSessionId( f30_local0 ) .. "'.\n" ) --[[ @ 0]]
			if f30_local0 == Engine[@"GetPrimaryController"]() and Engine[@"hash_10EA2BE00F49480D"]( Enum[@"LobbyType"][@"hash_20A1647599284110"] ) then
				Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4CreateComplete, we are host of private session, setting session data.\n" ) --[[ @ 0]]
				Engine[@"hash_4DBBD19176041D4B"]( Enum[@"LobbyType"][@"hash_20A1647599284110"], Lobby.Platform.PS4GetSessionId( f30_local0 ) ) --[[ @ 0]]
			end
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Create failed: " .. f30_local3 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionPS4Create = function ( f31_arg0, f31_arg1, f31_arg2 )
	...
	Dvar[@"hash_1C97FE4F00531D2C"]:set( Engine[@"LocalizeWithoutLocsMarkers"]( @"hash_3CE60C4536B54FF3" ) ) --[[ @ 0]]
	...
	if f31_local0 == Enum[@"hash_548909109238341F"][@"hash_4CBD4CF0639724C3"] then
		Dvar[@"hash_1C97FE4F00531D2C"]:set( Engine[@"LocalizeWithoutLocsMarkers"]( @"hash_3C466D0DC2A965FA" ) ) --[[ @ 0]]
	end
	Dvar[@"hash_1C866260CA069A59"]:set( " " ) --[[ @ 0]]
	Dvar[@"hash_1E2C2160849F5335"]:set( "" ) --[[ @ 0]]
	Dvar[@"hash_55D1A8E8BCE18B7E"]:set( "platform_session.png" ) --[[ @ 0]]
	local f31_local2 = Engine[@"hash_2B4EEE57E45369DB"]() --[[ @ 0]]
	...
	Dvar[@"hash_49280DC8E09F070A"]:set( f31_local3 ) --[[ @ 0]]
	...
	Dvar[@"hash_2715AEDE405E824B"]:set( f31_local4 ) --[[ @ 0]]
	local f31_local5 = Lobby.ProcessQueue.RegisterEventHandler( Lobby.Platform.PlatformSessionPS4CreateComplete, {
		controller = f31_arg0,
		lobbyType = f31_arg1,
		maxSlot = f31_arg2
	} ) --[[ @ 0]]
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Create started.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionCreateFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Create FAILURE TEST.\n" ) --[[ @ 0]]
		...
		return 
	elseif Engine[@"hash_3E2FB3A90F2AF97D"]( f31_local5, f31_arg0, f31_arg1, f31_arg2 ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Create failed to start.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f31_local5,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionJoinCompletePS4 = function ( f32_arg0, f32_arg1, f32_arg2 )
	...
	if f32_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionJoinCompletePS4 ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f32_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f32_local1 == false then
			if f32_arg2.sessionId ~= nil then
				...
				Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionJoinCompletePS4, we have successfully joined session id: '" .. Lobby.Platform.PS4GetSessionId( f32_local0 ) .. "'.\n" ) --[[ @ 0]]
			end
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Join failed: " .. f32_local3 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionPS4Join = function ( f33_arg0, f33_arg1, f33_arg2 )
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Join started, joining sessionId: '" .. f33_arg2 .. "'.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionJoinFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Join FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f33_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
		...
		return 
	elseif Engine[@"hash_7B30A30609FE9AB9"]( f33_local0, f33_arg0, f33_arg1, f33_arg2 ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Join failed to start.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f33_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionPS4LeaveComplete = function ( f34_arg0, f34_arg1, f34_arg2 )
	...
	if f34_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4LeaveComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f34_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f34_local1 == false then
			local f34_local4 = Engine[@"hash_7810BE2185A15DFF"]( Enum[@"LobbyType"][@"hash_20A1647599284110"] ) --[[ @ 0]]
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4LeaveComplete, we have successfully left session id: '" .. Lobby.Platform.PS4GetSessionId( f34_local0 ) .. "'.\n" ) --[[ @ 0]]
			if f34_local0 == Engine[@"GetPrimaryController"]() and f34_local4.sessionId == Lobby.Platform.PS4GetSessionId( f34_local0 ) then
				Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4LeaveComplete, we are host of private session, clearing session data.\n" ) --[[ @ 0]]
				Engine[@"hash_564DA6B993A721F2"]( Enum[@"LobbyType"][@"hash_20A1647599284110"] ) --[[ @ 0]]
			end
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Leave failed: " .. f34_local3 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionPS4Leave = function ( f35_arg0, f35_arg1, f35_arg2 )
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Leave started, leaving sessionId: '" .. f35_arg2 .. "'.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionLeaveFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Leave FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f35_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
		...
		return 
	elseif Engine[@"hash_5402D6CCEE2BA1C0"]( f35_local0, f35_arg0, f35_arg1, f35_arg2 ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4Leave failed to start.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f35_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionPS4SetPartyPrivacyComplete = function ( f36_arg0, f36_arg1, f36_arg2 )
	...
	if f36_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4SetPartyPrivacyComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f36_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f36_local2 == false then
			...
			Engine[@"hash_67FA097EC16F2681"]( f36_local0, Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], "partyPrivacyStatus: " .. Lobby.Platform.PlatformSessionGetPartyPrivacyStatus( f36_local5 ) ) --[[ @ 0]]
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4SetPartyPrivacyComplete, we have successfully left session.\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4SetPartyPrivacy failed: " .. f36_local4 .. "\n" ) --[[ @ 0]]
		end
	...
	if f36_local2 == true then
		Engine[@"hash_67FA097EC16F2681"]( f36_local0, Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], "partyPrivacyStatus: ERROR" ) --[[ @ 0]]
...
Lobby.Platform.PlatformSessionPS4SetPartyPrivacy = function ( f37_arg0, f37_arg1, f37_arg2, f37_arg3 )
	...
	if f37_local0 == f37_local1 and f37_local2 == f37_local3 then
		...
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4SetPartyPrivacy started.\n" ) --[[ @ 0]]
		if Engine[@"hash_3573048F8D3B4E25"]() == false and 1 == Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionSetPartyPrivacyFailure" ) then
			Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4SetPartyPrivacy FAILURE TEST.\n" ) --[[ @ 0]]
			LobbyVM.ProcessCompleteFailure( {
				actionId = f37_local4,
				isError = true,
				returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
			...
			Dvar[@"hash_49280DC8E09F070A"]:set( f37_local1 ) --[[ @ 0]]
			Dvar[@"hash_2715AEDE405E824B"]:set( f37_local3 ) --[[ @ 0]]
			if Engine[@"hash_678EBBEF5AC089D4"]( f37_local4, f37_arg0, f37_arg1, f37_arg2 ) == false then
				Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6E2AF40CBFD5F81D"], "PlatformSessionPS4SetPartyPrivacy failed to start.\n" ) --[[ @ 0]]
				LobbyVM.ProcessCompleteFailure( {
					actionId = f37_local4,
					isError = true,
					returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionPS4PumpController = function ( f38_arg0, f38_arg1, f38_arg2, f38_arg3, f38_arg4, f38_arg5, f38_arg6, f38_arg7 )
	...
	elseif Lobby.Platform.PS4.changed[f38_local0] == true then
		local f38_local5 = Engine[@"hash_7810BE2185A15DFF"]( Enum[@"LobbyType"][@"hash_20A1647599284110"] ) --[[ @ 0]]
		if f38_local3 == true and (f38_local5.sessionId ~= f38_local1 or f38_local2 ~= Engine[@"hash_8CB6D1C656D57EE"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"] )) then
			Lobby.Platform.PlatformSessionPS4Leave( f38_arg0, f38_arg2, f38_local1 ) --[[ @ 0]]
		end
	...
	elseif f38_local4 == false then
		if f38_local3 == true then
			if true == Dvar[@"hash_639176BF65C21B9A"]:get() and f38_arg0 == f38_arg7 and f38_arg2 == Enum[@"LobbyType"][@"hash_20A1647599284110"] then
				local f38_local5 = Engine[@"hash_2B4EEE57E45369DB"]() --[[ @ 0]]
...
Lobby.Platform.PlatformSessionPS4Pump = function ()
	if Lobby.Platform.PS4.taskInProgress ~= true and true ~= Engine[@"hash_572C6381CF1C22CA"]() then
		if Lobby.ProcessQueue.IsQueueEmpty() == false then
			...
			if f39_local0.nonPSNSessionBlocking ~= true then
				Lobby.Platform.PS4.updateTime = Engine[@"hash_69D33D652B9B0F3B"]() + Dvar[@"hash_27E9699E9C030C67"]:get() --[[ @ 0]]
				return 
			end
		end
		if Lobby.Platform.PS4.updateTime > Engine[@"hash_69D33D652B9B0F3B"]() then
			return 
		end
		Lobby.Platform.PS4.updateTime = Engine[@"hash_69D33D652B9B0F3B"]() + Dvar[@"hash_27E9699E9C030C67"]:get() --[[ @ 0]]
		local f39_local0 = Enum[@"LobbyType"][@"hash_20A1647599284110"] --[[ @ 0]]
		local f39_local1 = 18 --[[ @ 0]]
		local f39_local2 = Engine[@"hash_7A63E42B2FB6EC02"]() == Enum[@"LobbyNetworkMode"][@"hash_2E99F41098B71960"] --[[ @ 0]]
		local f39_local3 = Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f39_local0 ) --[[ @ 0]]
		local f39_local4 = Engine[@"hash_10EA2BE00F49480D"]( f39_local0 ) --[[ @ 0]]
		local f39_local5 --[[ @ 0]]
		if f39_local4 then
			f39_local5 = Engine[@"hash_23797858022DCB59"]( f39_local0 ) --[[ @ 0]]
...
local f0_local5 = function ( f42_arg0, f42_arg1, f42_arg2 )
	...
	Engine[@"hash_67FA097EC16F2681"]( f42_arg0, f42_arg1, f42_arg2 ) --[[ @ 0]]
end
 --[[ @ 0]]
...
local f0_local12 = function ( f49_arg0, f49_arg1 )
	Engine[@"hash_67FA097EC16F2681"]( f49_arg0, f49_arg1, f0_local6( f49_arg0, f49_arg1 ), "  start[ " .. tostring( Lobby.Platform.XBOX.roundStartCounter[f49_arg0 + 1] ) .. " ], end[ " .. tostring( Lobby.Platform.XBOX.roundEndCounter[f49_arg0 + 1] ) .. " ]" ) --[[ @ 0]]
end
 --[[ @ 0]]
local f0_local13 = function ( f50_arg0, f50_arg1 )
	...
	for f50_local1 = Enum[@"LobbyType"][@"hash_20A1647599284110"] --[[ @ 0]], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], 1 do
		f0_local5( f50_arg0, f50_local1, "" ) --[[ @ 0]]
		f0_local7( f50_arg0, f50_local1, false ) --[[ @ 0]]
		Engine[@"hash_7556D44B51D02416"]( f50_arg0, f50_local1 ) --[[ @ 0]]
	end
	...
	Lobby.Platform.XBOX.sessionClosed[f50_local0] = Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] --[[ @ 0]]
	Lobby.Platform.XBOX.joinRestriction[f50_local0] = Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] --[[ @ 0]]
	Lobby.Platform.XBOX.visibility[f50_local0] = Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] --[[ @ 0]]
...
Lobby.Platform.PlatformSessionUpdateErrorCount = function ( f51_arg0 )
	...
	if not Engine[@"StorageIsFileReady"]( f51_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) then
		return 
	end
	local f51_local1 = Engine[@"StorageGetBuffer"]( f51_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
...
Lobby.Platform.PlatformSessionXboxError = function ( f52_arg0, f52_arg1, f52_arg2 )
	...
	Engine[@"hash_5AF2EDE16C0386FE"]() --[[ @ 0]]
	if f52_local0 == Enum[@"PlatformSessions"][@"hash_275E6BB927BE46B4"] then
		f0_local13( f52_arg0, false ) --[[ @ 0]]
		f0_local9( f52_arg0, true, Lobby.Platform.DISABLE_PLATFORM_SESSIONS ) --[[ @ 0]]
	elseif f52_local0 == Enum[@"PlatformSessions"][@"hash_6DB75ABE61E9C81F"] then
		LobbyVM.ExecuteLobbyVMRequest( LuaEnum.LOBBYVM_REQUEST.FORCE_LOCAL_MODE ) --[[ @ 0]]
		if Dvar[@"hash_9D38D804EC061EB"]:get() == true then
			Engine[@"hash_5BC42C678E40DBE8"]( Enum[@"errorCode"][@"hash_12FD312C2C06EC11"], "Platform Session Error: " .. f52_arg2 ) --[[ @ 0]]
		else
			Engine[@"hash_5BC42C678E40DBE8"]( Enum[@"errorCode"][@"hash_12FD312C2C06EC11"], Engine[@"hash_4F9F1239CFD921FE"]( @"hash_295A36FDA596D61E" ) ) --[[ @ 0]]
		end
	end
end
 --[[ @ 0]]
Lobby.Platform.PlatformSessionXboxGenerateSessionId = function ( f53_arg0 )
	local f53_local0 = Engine[@"hash_4A33D06620AC0D6B"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f53_arg0 ) --[[ @ 0]]
	if f53_local0 == nil then
		return false, ""
	else
		return true, Engine[@"hash_23D5B539E107F8FD"]( f53_local0.secId )
	end
end
 --[[ @ 0]]
Lobby.Platform.PlatformSessionXboxCreateComplete = function ( f54_arg0, f54_arg1, f54_arg2 )
	...
	if f54_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxCreateComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f54_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f54_local2 == false then
			...
			Engine[@"hash_79E73F59228A7DCD"]( Enum[@"LobbyType"][@"hash_20A1647599284110"], f0_local6( f54_local0, f54_local1 ), f0_local4( f54_local0, f54_local1 ) ) --[[ @ 0]]
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxCreateComplete, we have successfully created session id: '" .. f54_arg2.sessionId .. "'.\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxCreate failed: " .. f54_local4 .. "\n" ) --[[ @ 0]]
		end
	...
	if f54_local2 == true then
		...
		return true
	elseif f54_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS and f54_local2 == false and f54_local1 == Enum[@"LobbyType"][@"hash_20A1647599284110"] then
...
Lobby.Platform.PlatformSessionXboxCreate = function ( f55_arg0, f55_arg1 )
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxCreate started.\n" ) --[[ @ 0]]
	...
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionCreateFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxCreate FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f55_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
		...
		return 
	elseif f55_local2 == false or Engine[@"hash_1725E4DF0727049F"]( f55_local0, f55_arg0, f55_arg1, f55_local1, f55_local3 ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxCreate failed to start.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f55_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionXboxSetActivityComplete = function ( f56_arg0, f56_arg1, f56_arg2 )
	...
	if f56_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetActivityComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f56_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f56_local3 == false then
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetActivityComplete, we have successfully set sessionId: '" .. f56_local2 .. "' to be the activity session.\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetActivity failed: " .. f56_local5 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionXboxSetActivity = function ( f57_arg0, f57_arg1 )
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetActivity started for sessionId: '" .. f57_local1 .. "'.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionSetActivityFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetActivity FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f57_local2,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
		...
		return 
	elseif Engine[@"hash_5499DB359DD497E4"]( f57_local2, f57_arg0, f57_arg1, f57_local0, f57_local1 ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetActivity failed to start.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f57_local2,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionXboxLeaveComplete = function ( f58_arg0, f58_arg1, f58_arg2 )
	...
	if f58_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxLeaveComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f58_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f58_local2 == false then
			local f58_local5 = Engine[@"hash_745FD16626F84E51"]( Enum[@"LobbyType"][@"hash_20A1647599284110"] ) --[[ @ 0]]
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxLeaveComplete, we have successfully left session.\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxLeave failed: " .. f58_local4 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionXboxLeave = function ( f59_arg0, f59_arg1, f59_arg2 )
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxLeave started.\n" ) --[[ @ 0]]
	local f59_local1, f59_local2 = f0_local11( f59_arg0, f59_arg1 ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionLeaveFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxLeave FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f59_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
		...
		return 
	elseif Engine[@"hash_35EE71E805F47162"]( f59_local0, f59_arg0, f59_arg1, f59_local1, f59_local2 ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxLeave failed to start.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f59_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionXboxSetSessionClosedSetDebugStatus = function ( f60_arg0, f60_arg1, f60_arg2, f60_arg3 )
	...
	if f60_arg3 == Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] then
		f60_local0 = "OPEN" --[[ @ 0]]
	elseif f60_arg3 == Enum[@"PartyPrivacy"][@"hash_1BE1A36D69A39221"] then
		f60_local0 = "FRIENDS ONLY" --[[ @ 0]]
	elseif f60_arg3 == Enum[@"PartyPrivacy"][@"hash_52507221A765592F"] then
		f60_local0 = "INVITE ONLY" --[[ @ 0]]
	elseif f60_arg3 == Enum[@"PartyPrivacy"][@"hash_78B288F48084ABC5"] then
		f60_local0 = "CLOSED" --[[ @ 0]]
	end
	Engine[@"hash_67FA097EC16F2681"]( f60_arg0, f60_arg1, f60_arg2, f60_local0 ) --[[ @ 0]]
end
 --[[ @ 0]]
Lobby.Platform.PlatformSessionXboxSetSessionClosedComplete = function ( f61_arg0, f61_arg1, f61_arg2 )
	...
	if f61_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetSessionClosedComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f61_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f61_local2 == false then
			...
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetSessionClosedComplete, we have successfully left session.\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetSessionClosed failed: " .. f61_local4 .. "\n" ) --[[ @ 0]]
		end
	...
	if f61_local2 == true then
		Engine[@"hash_67FA097EC16F2681"]( f61_local0, Enum[@"LobbyType"][@"hash_20A1647599284110"], f61_arg1.sessionId, "ERROR" ) --[[ @ 0]]
...
Lobby.Platform.PlatformSessionXboxIsSessionClosed = function ( f62_arg0 )
	...
	if f62_arg0 == Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] then
		f62_local0 = false --[[ @ 0]]
	elseif f62_arg0 == Enum[@"PartyPrivacy"][@"hash_1BE1A36D69A39221"] then
		f62_local0 = false --[[ @ 0]]
	elseif f62_arg0 == Enum[@"PartyPrivacy"][@"hash_52507221A765592F"] then
		f62_local0 = false --[[ @ 0]]
	elseif f62_arg0 == Enum[@"PartyPrivacy"][@"hash_78B288F48084ABC5"] then
		f62_local0 = true --[[ @ 0]]
	end
	return f62_local0
end
...
Lobby.Platform.PlatformSessionXboxSetSessionClosed = function ( f63_arg0, f63_arg1, f63_arg2, f63_arg3 )
	...
	if f63_local0 == f63_local1 then
		...
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetSessionClosed started.\n" ) --[[ @ 0]]
		if Engine[@"hash_3573048F8D3B4E25"]() == false and 1 == Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionSetSessionClosedFailure" ) then
			Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetSessionClosed FAILURE TEST.\n" ) --[[ @ 0]]
			LobbyVM.ProcessCompleteFailure( {
				actionId = f63_local2,
				isError = true,
				returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
			...
			return 
		elseif Engine[@"hash_50863A13A2C95973"]( f63_local2, f63_arg0, f63_arg1, f63_local1 ) == false then
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetSessionClosed failed to start.\n" ) --[[ @ 0]]
			LobbyVM.ProcessCompleteFailure( {
				actionId = f63_local2,
				isError = true,
				returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionXboxSetJoinRestrictionComplete = function ( f64_arg0, f64_arg1, f64_arg2 )
	...
	if f64_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetJoinRestrictionComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f64_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f64_local2 == false then
			...
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetJoinRestrictionComplete, we have successfully left session.\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetJoinRestriction failed: " .. f64_local4 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionXboxGetJoinRestriction = function ( f65_arg0 )
	local f65_local0 = Enum[@"DurangoSessionJoinRestriction"][@"hash_250627BF34457EB5"] --[[ @ 0]]
	if f65_arg0 == Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] then
		f65_local0 = Enum[@"DurangoSessionJoinRestriction"][@"hash_250627BF34457EB5"] --[[ @ 0]]
	elseif f65_arg0 == Enum[@"PartyPrivacy"][@"hash_1BE1A36D69A39221"] then
		f65_local0 = Enum[@"DurangoSessionJoinRestriction"][@"hash_2818AA82EE1EA737"] --[[ @ 0]]
	elseif f65_arg0 == Enum[@"PartyPrivacy"][@"hash_52507221A765592F"] then
		f65_local0 = Enum[@"DurangoSessionJoinRestriction"][@"hash_249A29EB19BE42D2"] --[[ @ 0]]
	elseif f65_arg0 == Enum[@"PartyPrivacy"][@"hash_78B288F48084ABC5"] then
		f65_local0 = Enum[@"DurangoSessionJoinRestriction"][@"hash_249A29EB19BE42D2"] --[[ @ 0]]
	end
	return f65_local0
end
...
Lobby.Platform.PlatformSessionXboxSetJoinRestriction = function ( f66_arg0, f66_arg1, f66_arg2, f66_arg3 )
	...
	if f66_local0 == f66_local1 then
		...
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetJoinRestriction started.\n" ) --[[ @ 0]]
		if Engine[@"hash_3573048F8D3B4E25"]() == false and 1 == Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionSetJoinRestrictionFailure" ) then
			Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetJoinRestriction FAILURE TEST.\n" ) --[[ @ 0]]
			LobbyVM.ProcessCompleteFailure( {
				actionId = f66_local2,
				isError = true,
				returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
			...
			return 
		elseif Engine[@"hash_19662D74EAD22C79"]( f66_local2, f66_arg0, f66_arg1, f66_local1 ) == false then
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetJoinRestriction failed to start.\n" ) --[[ @ 0]]
			LobbyVM.ProcessCompleteFailure( {
				actionId = f66_local2,
				isError = true,
				returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionXboxSetVisibilityComplete = function ( f67_arg0, f67_arg1, f67_arg2 )
	...
	if f67_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetVisibilityComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f67_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f67_local2 == false then
			...
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetVisibilityComplete, we have successfully left session.\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetVisibility failed: " .. f67_local4 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionXboxSetVisibility = function ( f68_arg0, f68_arg1, f68_arg2, f68_arg3 )
	Lobby.Platform.XBOX.taskInProgress = true --[[ @ 0]]
	local f68_local0 = Enum[@"DurangoSessionVisibility"][@"hash_14C8B7DA24976D4C"] --[[ @ 0]]
	if f68_arg3 == Enum[@"PartyPrivacy"][@"hash_78B288F48084ABC5"] then
		f68_local0 = Enum[@"DurangoSessionVisibility"][@"hash_1E11D4518DDF1207"] --[[ @ 0]]
	end
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetVisibility started.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionSetVisibilityFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetVisibility FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f68_local1,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
		...
		return 
	elseif Engine[@"hash_3C7CFCAB122CDABB"]( f68_local1, f68_arg0, f68_arg1, f68_local0 ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "PlatformSessionXboxSetVisibility failed to start.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f68_local1,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionXboxRoundStart = function ( f69_arg0, f69_arg1 )
	...
	local f69_local3, f69_local4 = Engine[@"hash_5D0EDFB76022E2B9"]( f69_arg0, f69_arg1, f69_local1, f69_local2 ) --[[ @ 0]]
	if f69_local3 == true then
		Lobby.Platform.XBOX.roundStartSessionId[f69_local0] = f69_local2 --[[ @ 0]]
		Lobby.Platform.XBOX.roundStartTime[f69_local0] = Engine[@"hash_69D33D652B9B0F3B"]() --[[ @ 0]]
...
Lobby.Platform.PlatformSessionXboxRoundEnd = function ( f70_arg0, f70_arg1 )
	...
	if f70_local1 ~= nil then
		...
		if f70_local5 == f0_local6( f70_arg0, f70_arg1 ) then
			Engine[@"hash_7A0C5FA577380928"]( f70_arg0, f70_arg1, f70_local3, f70_local5, f70_local1, f70_local2 ) --[[ @ 0]]
...
Lobby.Platform.OnPlatformSessionMultiplayerSessionChanged = function ( f71_arg0 )
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "Lobby.Platform.OnPlatformSessionMultiplayerSessionChanged().\n" ) --[[ @ 0]]
end
 --[[ @ 0]]
Lobby.Platform.OnPlatformSessionMultiplayerSubscriptionLost = function ( f72_arg0 )
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_1EE5ED682C5B1AEF"], "Lobby.Platform.OnPlatformSessionMultiplayerSubscriptionLost().\n" ) --[[ @ 0]]
...
Lobby.Platform.OnPlatformSuspend = function ( f73_arg0 )
	...
	elseif Lobby.Platform.PlatformSessionDurangoEnabled() then
		for f73_local0 = 1 --[[ @ 0]], LuaDefine.MAX_CONTROLLER_COUNT, 1 do
			Lobby.Platform.PlatformSessionXboxRoundEnd( f73_local0 - 1, Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
		end
	end
end
 --[[ @ 0]]
Lobby.Platform.OnPlatformResume = function ( f74_arg0 )
	if Lobby.Platform.PlatformSessionOrbisEnabled() then
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_4A1C4971DA015C84"], "OnPlatformResume(), clear all session data.\n" ) --[[ @ 0]]
		Engine[@"hash_564DA6B993A721F2"]( Enum[@"LobbyType"][@"hash_20A1647599284110"] ) --[[ @ 0]]
...
Lobby.Platform.PlatformSessionXboxRTASubscription = function ( f75_arg0, f75_arg1, f75_arg2, f75_arg3 )
	if Dvar[@"hash_58A4AA20D982B45C"]:get() == false then
		...
		if f75_arg1 == true and Lobby.Platform.XBOX.rtaSubscribe[f75_local0] == false and f75_arg3 == true then
			local f75_local1, f75_local2, f75_local3 = Engine[@"hash_52099BADCE857DD"]( f75_arg0 ) --[[ @ 0]]
...
Lobby.Platform.PlatformSessionXboxDisabled = function ( f76_arg0, f76_arg1, f76_arg2, f76_arg3, f76_arg4 )
	...
	if LuaUtils.OnlineOnlyDemo() == true and LuaUtils.WarzoneModeAvailable() and Engine[@"CurrentSessionMode"]() == Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] and f76_arg2 == Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] then
		return true
	elseif Lobby.Platform.XBOX.disabled[f76_local0] == true then
		return true
	elseif f76_arg3 == true and Lobby.Platform.XBOX.disabled[f76_local0] == nil and Engine[@"StorageIsFileReady"]( f76_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) then
		local f76_local1 = Engine[@"StorageGetBuffer"]( f76_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
		if f76_local1 then
			Lobby.Platform.XBOX.disabled[f76_local0] = false --[[ @ 0]]
			local f76_local2 = Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionDisableCount" ) --[[ @ 0]]
...
Lobby.Platform.PlatformSessionXboxPumpController = function ( f77_arg0, f77_arg1, f77_arg2, f77_arg3, f77_arg4, f77_arg5, f77_arg6 )
	...
	if f77_local1 == true then
		if f77_arg2 == Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] then
		...
		if true == Dvar[@"hash_639176BF65C21B9A"]:get() and f77_arg0 == f77_arg6 and f77_arg2 == Enum[@"LobbyType"][@"hash_20A1647599284110"] then
			local f77_local5 = Engine[@"hash_2B4EEE57E45369DB"]() --[[ @ 0]]
...
Lobby.Platform.PlatformSessionXboxPump = function ()
	if Lobby.Platform.XBOX.taskInProgress == true or true == Engine[@"hash_572C6381CF1C22CA"]() or Lobby.ProcessQueue.IsQueueEmpty() == false or true == Engine[@"FriendsIsTaskInProgress"]() then
		Lobby.Platform.XBOX.updateTime = Engine[@"hash_69D33D652B9B0F3B"]() + Dvar[@"hash_11370ED9F96CEC10"]:get() --[[ @ 0]]
		return 
	elseif Lobby.Platform.XBOX.updateTime > Engine[@"hash_69D33D652B9B0F3B"]() then
		return 
	end
	Lobby.Platform.XBOX.updateTime = Engine[@"hash_69D33D652B9B0F3B"]() + Dvar[@"hash_11370ED9F96CEC10"]:get() --[[ @ 0]]
	local f78_local0 = Engine[@"hash_7A63E42B2FB6EC02"]() == Enum[@"LobbyNetworkMode"][@"hash_2E99F41098B71960"] --[[ @ 0]]
	for f78_local1 = 1 --[[ @ 0]], LuaDefine.MAX_CONTROLLER_COUNT, 1 do
		local f78_local4 = f78_local1 - 1 --[[ @ 0]]
		local f78_local5 = Engine[@"hash_5BE1ABEFA9A14C34"]( f78_local4 ) --[[ @ 0]]
		local f78_local6 = Engine[@"IsControllerBeingUsed"]( f78_local4 ) --[[ @ 0]]
		if f78_local5 == true then
			for f78_local7 = Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] --[[ @ 0]], Enum[@"LobbyType"][@"hash_20A1647599284110"], -1 do
				local f78_local10 = Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f78_local7 ) --[[ @ 0]]
				local f78_local11 = Engine[@"hash_10EA2BE00F49480D"]( f78_local7 ) --[[ @ 0]]
				local f78_local12 --[[ @ 0]]
				if f78_local11 then
					f78_local12 = Engine[@"hash_23797858022DCB59"]( f78_local7 ) --[[ @ 0]]
...
local f0_local15 = function ( f80_arg0 )
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "TriggerCreateJoinMPSDTask started.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionDurangoS2SCreateJoinFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "TriggerCreateJoinMPSDTask FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f80_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
	...
	elseif Engine[@"hash_38607CD911589254"]( f80_local0, f80_arg0.sessionid, Lobby.Platform.S2S.templateName, f80_arg0.xuid, f80_arg0.isRetry ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "TriggerCreateJoinMPSDTask FAILED, may have backed up MPSD tasks\n" ) --[[ @ 0]]
		return false
	else
		return true
	end
...
local f0_local16 = function ( f81_arg0 )
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "TriggerEncounterTask started.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionDurangoS2SEncounterFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "TriggerEncounterTask FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f81_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
	...
	elseif Engine[@"hash_4B12D2434F4CA2C5"]( f81_local0, f81_arg0.sessionid, Lobby.Platform.S2S.templateName, f81_arg0.xuid, f81_arg0.encounterId, f81_arg0.isRetry ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "TriggerEncounterTask failed, should not happen. The MPSD task buffer may be overloaded\n" ) --[[ @ 0]]
		return false
	else
		return true
	end
...
local f0_local17 = function ( f82_arg0 )
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "TriggerLeaveMPSDTask started.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionDurangoS2SLeaveFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "TriggerLeaveMPSDTask FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f82_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
	...
	elseif Engine[@"hash_748055780DCACAFD"]( f82_local0, f82_arg0.sessionid, Lobby.Platform.S2S.templateName, f82_arg0.xuid, f82_arg0.isRetry ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "TriggerLeaveMPSDTask FAILED, may have backed up MPSD tasks\n" ) --[[ @ 0]]
		return false
	else
		return true
	end
...
Lobby.Platform.PlatformSessionDurangoS2SGenerateSessionId = function ( f83_arg0 )
	local f83_local0 = Engine[@"hash_4A33D06620AC0D6B"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"], f83_arg0 ) --[[ @ 0]]
	if f83_local0 == nil then
		return false, ""
	else
		return true, Engine[@"hash_23D5B539E107F8FD"]( f83_local0.secId )
	end
end
 --[[ @ 0]]
Lobby.Platform.PlatformSessionDurangoS2SEncounter = function ( f84_arg0 )
	if not Lobby.Platform.PlatformSessionDurangoS2SEnabled() then
		...
		local f84_local0, f84_local1 = Lobby.Platform.PlatformSessionDurangoS2SGenerateSessionId( Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
		if f84_local0 == false then
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SEncounter SESSIONID was not ready, should not happen.\n" ) --[[ @ 0]]
			return 
		else
			f0_local16( {
...
Lobby.Platform.PlatformSessionDurangoS2SCreateJoin = function ( f85_arg0 )
	local f85_local0, f85_local1 = Lobby.Platform.PlatformSessionDurangoS2SGenerateSessionId( Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
	if f85_local0 == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SCreateJoin SESSIONID was not ready, should not happen.\n" ) --[[ @ 0]]
		return 
	else
		f0_local15( {
			xuid = f85_arg0,
...
Lobby.Platform.PlatformSessionDurangoS2SLeave = function ( f86_arg0 )
	local f86_local0, f86_local1 = Lobby.Platform.PlatformSessionDurangoS2SGenerateSessionId( Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
	if f86_local0 == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SLeave SESSIONID was not ready, should not happen.\n" ) --[[ @ 0]]
		return 
	else
		f0_local17( {
			xuid = f86_arg0,
...
Lobby.Platform.PlatformSessionDurangoS2SCreateJoinComplete = function ( f87_arg0, f87_arg1, f87_arg2 )
	...
	local f87_local3 --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() ~= false or Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionDurangoS2SCreateJoinForceRetry" ) ~= 1 then
		f87_local3 = false --[[ @ 0]]
	else
		f87_local3 = true --[[ @ 0]]
	end
	if f87_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SCreateJoinComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f87_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f87_local0 == false then
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SCreateJoinComplete, client join succeeded\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SCreateJoinComplete failed: " .. f87_local2 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionDurangoS2SEncounterComplete = function ( f88_arg0, f88_arg1, f88_arg2 )
	...
	local f88_local3 --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() ~= false or Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionDurangoS2SEncounterForceRetry" ) ~= 1 then
		f88_local3 = false --[[ @ 0]]
	else
		f88_local3 = true --[[ @ 0]]
	end
	if f88_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SEncounterComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f88_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f88_local0 == false then
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SEncounterComplete, client encounter recorded\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SEncounterComplete failed: " .. f88_local2 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionDurangoS2SLeaveComplete = function ( f89_arg0, f89_arg1, f89_arg2 )
	...
	local f89_local3 --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() ~= false or Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionDurangoS2SLeaveForceRetry" ) ~= 1 then
		f89_local3 = false --[[ @ 0]]
	else
		f89_local3 = true --[[ @ 0]]
	end
	if f89_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SLeaveComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f89_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f89_local0 == false then
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SLeaveComplete, client left the session\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SLeaveComplete failed: " .. f89_local2 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionDurangoS2SGetServiceTokenComplete = function ( f91_arg0, f91_arg1, f91_arg2 )
	...
	if f91_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetServiceTokenComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f91_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f91_local0 == false then
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetServiceTokenComplete, Service token acquired\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetServiceTokenComplete failed: " .. f91_local2 .. "\n" ) --[[ @ 0]]
		end
	...
	if f91_local0 == true then
		Lobby.Platform.S2S.nextAuthTokenAttemptTime = Engine[@"hash_69D33D652B9B0F3B"]() + Dvar[@"hash_2C05F83D5B9BD2C8"]:get() ^ Lobby.Platform.S2S.authTokenAttempts * 1000 --[[ @ 0]]
		Lobby.Platform.S2S.authTokenAttempts = math.min( Lobby.Platform.S2S.authTokenAttempts + 1, 5 ) --[[ @ 0]]
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetServiceTokenComplete, backing off attempt " .. Lobby.Platform.S2S.authTokenAttempts .. "\n" ) --[[ @ 0]]
	else
...
Lobby.Platform.PlatformSessionDurangoS2SGetXstsTokenComplete = function ( f92_arg0, f92_arg1, f92_arg2 )
	...
	if f92_arg0 == Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetXstsTokenComplete ACTIONSTATE.RUNNING should not happen.\n" ) --[[ @ 0]]
		return false
	elseif f92_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f92_local0 == false then
			Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetXstsTokenComplete, Xsts token acquired\n" ) --[[ @ 0]]
		else
			Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetXstsTokenComplete failed: " .. f92_local2 .. "\n" ) --[[ @ 0]]
		end
...
Lobby.Platform.PlatformSessionDurangoS2SGetServiceToken = function ()
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetServiceToken started.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionDurangoS2SGetServiceTokenFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "platformSessionDurangoS2SGetServiceTokenFailure FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f93_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
	...
	elseif Engine[@"hash_695764175B7C2688"]( f93_local0 ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetServiceToken failed to start.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f93_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionDurangoS2SGetXstsToken = function ()
	...
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetXstsToken started.\n" ) --[[ @ 0]]
	if Engine[@"hash_3573048F8D3B4E25"]() == false and Engine[@"hash_622EAAB59AA27E9B"]( "platformSessionDurangoS2SGetXstsTokenFailure" ) == 1 then
		Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetXstsToken FAILURE TEST.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f94_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
	...
	elseif Engine[@"hash_588B9D1876723759"]( f94_local0 ) == false then
		Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "PlatformSessionDurangoS2SGetXstsToken failed to start.\n" ) --[[ @ 0]]
		LobbyVM.ProcessCompleteFailure( {
			actionId = f94_local0,
			isError = true,
			returnCode = Lobby.ProcessQueue.EVENT_START_ERROR,
...
Lobby.Platform.PlatformSessionDurangoS2SPumpAuth = function ()
	...
	if Lobby.Platform.S2S.authTaskInProgress == true or true == Engine[@"hash_594595E838B11C29"]() then
		return f95_local0
	elseif Lobby.Platform.S2S.nextAuthTokenAttemptTime < Engine[@"hash_69D33D652B9B0F3B"]() then
...
Lobby.Platform.PlatformSessionDurangoS2SPump = function ()
	if Lobby.Platform.S2S.updateTime > Engine[@"hash_69D33D652B9B0F3B"]() then
		return 
	end
	Lobby.Platform.S2S.updateTime = Engine[@"hash_69D33D652B9B0F3B"]() + Dvar[@"hash_790F8ADE0618A3B7"]:get() --[[ @ 0]]
...
Lobby.Platform.InviteComplete = function ( f101_arg0, f101_arg1, f101_arg2 )
	...
	elseif f101_arg0 == Lobby.ProcessQueue.ACTIONSTATE.SUCCESS then
		if f101_arg1.currentInvite == f101_arg1.inviteCount then
			local f101_local3 = Engine[@"hash_E1789115A2356E7"] --[[ @ 0]]
	...
	elseif f101_arg0 == Lobby.ProcessQueue.ACTIONSTATE.FAILURE or f101_arg0 == Lobby.ProcessQueue.ACTIONSTATE.ERROR then
		if true == Dvar[@"hash_9D38D804EC061EB"]:get() then
...
Lobby.Platform.Invite = function ( f102_arg0 )
	...
	Dvar[@"hash_6BE8B8D068E0C551"]:set( f102_local5 ) --[[ @ 0]]
	if Lobby.Platform.PlatformSessionOrbisEnabled() then
		...
		if Engine[@"hash_4F62802472E955C9"]( f102_local8, f102_local0, Enum[@"LobbyType"][@"hash_20A1647599284110"], f102_local9, Lobby.Platform.PS4GetSessionId( f102_local0 ) ) == false then
			Lobby.Platform.InviteFailed( f102_arg0 ) --[[ @ 0]]
			Lobby.ProcessQueue.UnRegisterEventHandler( f102_local8 ) --[[ @ 0]]
		end
	elseif Lobby.Platform.PlatformSessionDurangoEnabled() then
		local f102_local8 = Lobby.ProcessQueue.RegisterEventHandler( Lobby.Platform.InviteComplete, f102_arg0 ) --[[ @ 0]]
		if Engine[@"hash_606E46A8D70A1182"]( f102_local8, f102_local0, Enum[@"LobbyType"][@"hash_20A1647599284110"], f102_local2, f102_local3 ) == false then
			Lobby.Platform.InviteFailed( f102_arg0 ) --[[ @ 0]]
			Lobby.ProcessQueue.UnRegisterEventHandler( f102_local8 ) --[[ @ 0]]
		end
	end
...
Lobby.Platform.SaveState = function ()
	if Engine[@"hash_5E39F1F30B306065"]() == true or true == LuaDefine.isPC then
		return 
	...
	elseif true == LuaDefine.isXbox then
		...
		for f105_local0 = 1 --[[ @ 0]], LuaDefine.MAX_CONTROLLER_COUNT, 1 do
			...
			for f105_local3 = Enum[@"LobbyType"][@"hash_20A1647599284110"] --[[ @ 0]], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], 1 do
...
Lobby.Platform.OnComError = function ( f106_arg0 )
	...
	if f106_arg0.isInCleanup then
		return 
	elseif f106_local0 == Enum[@"errorCode"][@"hash_57039D0A1017FE92"] then
...
Lobby.Platform.Init = function ()
	...
	elseif true == LuaDefine.isPS4 then
		...
		for f110_local0 = 1 --[[ @ 0]], LuaDefine.MAX_CONTROLLER_COUNT, 1 do
			...
			Lobby.Platform.PS4.lockFlag[f110_local0] = Lobby.Platform.GetModelValue( "platformSession.lockFlag." .. tostring( f110_local0 ), Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] ) --[[ @ 0]]
			Lobby.Platform.PS4.sessionTypeFlag[f110_local0] = Lobby.Platform.GetModelValue( "platformSession.sessionTypeFlag." .. tostring( f110_local0 ), Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] ) --[[ @ 0]]
		end
	elseif true == LuaDefine.isXbox then
		...
		for f110_local0 = 1 --[[ @ 0]], LuaDefine.MAX_CONTROLLER_COUNT, 1 do
			...
			Lobby.Platform.XBOX.sessionClosed[f110_local0] = Lobby.Platform.GetModelValue( "platformSession.sessionClosed." .. tostring( f110_local0 ), Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] ) --[[ @ 0]]
			Lobby.Platform.XBOX.joinRestriction[f110_local0] = Lobby.Platform.GetModelValue( "platformSession.joinRestriction." .. tostring( f110_local0 ), Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] ) --[[ @ 0]]
			Lobby.Platform.XBOX.visibility[f110_local0] = Lobby.Platform.GetModelValue( "platformSession.visibility." .. tostring( f110_local0 ), Enum[@"PartyPrivacy"][@"hash_39ACC1F9917ADDE9"] ) --[[ @ 0]]
			f0_local3( f110_local3, Enum[@"LobbyType"][@"hash_20A1647599284110"], Lobby.Platform.GetModelValue( "platformSession.templateName." .. tostring( f110_local0 ) .. "." .. tostring( Enum[@"LobbyType"][@"hash_20A1647599284110"] + 1 ), Lobby.Platform.PLATFORM_SESSION_XBOX_TEMPLATE.PRIVATE_LOBBY ) ) --[[ @ 0]]
			f0_local3( f110_local3, Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], Lobby.Platform.GetModelValue( "platformSession.templateName." .. tostring( f110_local0 ) .. "." .. tostring( Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] + 1 ), Lobby.Platform.PLATFORM_SESSION_XBOX_TEMPLATE.GAME_LOBBY ) ) --[[ @ 0]]
			for f110_local4 = Enum[@"LobbyType"][@"hash_20A1647599284110"] --[[ @ 0]], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], 1 do
...
Lobby.Platform.PS4ProcessPlayTogetherEvent = function ( f111_arg0 )
	...
	local f111_local3 = Engine[@"hash_69882F293C327557"]() --[[ @ 0]]
	local f111_local4 = "" --[[ @ 0]]
	...
	if Engine[@"hash_7A63E42B2FB6EC02"]() == Enum[@"LobbyNetworkMode"][@"hash_1BAA8EC6F3E77255"] then
		local f111_local6 = Lobby.Process.ReloadPrivateLobby( f111_local0, Enum[@"LobbyNetworkMode"][@"hash_2E99F41098B71960"] ) --[[ @ 0]]
	...
	elseif f111_local3 == LobbyData.GetLobbyMenuIDByName( LuaEnum.UI.MAIN ) then
		...
		Engine[@"SetModelValue"]( Engine[@"GetModel"]( Engine[@"GetGlobalModel"](), "lobbyRoot.beginPlay" ), Enum[@"LobbyNetworkMode"][@"hash_2E99F41098B71960"] ) --[[ @ 0]]
		return nil
...
Lobby.Platform.PS4PlayTogetherPump = function ()
	if Engine[@"hash_5E39F1F30B306065"]() == true or true ~= LuaDefine.isPS4 then
		return 
	elseif true ~= Lobby.Platform.playTogether.monitor then
		return 
	end
	local f112_local0 = Lobby.Platform.playTogether.data.controller --[[ @ 0]]
	if Engine[@"hash_69882F293C327557"]() ~= LobbyData.GetLobbyMenuIDByName( LuaEnum.UI.MAIN ) then
