...
LUI.createMenu.Hud_MP_Codcaster = function ( f1_arg0, f1_arg1 )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f13_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_11CDCB451655ABCF"] ) --[[ @ 0]]
				if not f13_local0 then
					f13_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"] ) --[[ @ 0]]
					if not f13_local0 then
						f13_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_54828BED794DA0A5"] ) --[[ @ 0]]
						if not f13_local0 then
							f13_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_11E59914E91E423A"] ) --[[ @ 0]]
						end
					end
				end
				return f13_local0
	...
	f1_local12( f1_local13, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_11CDCB451655ABCF"]], function ( f16_arg0 )
	...
	f1_local12( f1_local13, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f17_arg0 )
		f1_local1:updateElementState( self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	f1_local12( f1_local13, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_54828BED794DA0A5"]], function ( f18_arg0 )
		f1_local1:updateElementState( self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local12 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	f1_local12( f1_local13, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_11E59914E91E423A"]], function ( f19_arg0 )
		f1_local1:updateElementState( self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
