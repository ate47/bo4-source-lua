...
CoD.WZHorizontalCompass.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	HorizontalCompassDirections:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				f3_local0 = not Engine[@"isvisibilitybitset"]( f1_arg1, Enum[@"uivisibilitybit"][@"bit_in_killcam"] ) --[[ @ 0]]
			end
		},
		{
			stateName = "HiddenPC",
