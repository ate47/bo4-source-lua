...
CoD.CommonListButtonShort_Internal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.CommonListButtonShort_Internal.__defaultWidth = 303 --[[ @ 0]]
CoD.CommonListButtonShort_Internal.__defaultHeight = 92 --[[ @ 0]]
CoD.CommonListButtonShort_Internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.CommonListButtonShort_Internal ) --[[ @ 0]]
	self.id = "CommonListButtonShort_Internal" --[[ @ 0]]
	...
	local FocusGlow = LUI.UIImage.new( 0, 1, -143, 143, 0, 1, -26, 26 ) --[[ @ 0]]
	...
	local Title = LUI.UIText.new( 0.5, 0.5, -142.5, 142.5, 0.5, 0.5, -11, 11 ) --[[ @ 0]]
	...
	local StoreCommonTextBacking = CoD.StoreCommonTextBacking.new( f1_arg0, f1_arg1, 0, 1, 4, -4, 0, 1, 4, -4 ) --[[ @ 0]]
...
CoD.CommonListButtonShort_Internal.__clipsPerState = {
	DefaultState = {
		...
		Focus = function ( f7_arg0, f7_arg1 )
			...
			f7_arg0.Title:setRGB( 0.96, 0.94, 0.78 ) --[[ @ 0]]
		...
		GainFocus = function ( f8_arg0, f8_arg1 )
			...
			f8_local3( f8_arg0.SelectorOverlay ) --[[ @ 0]]
			...
			f8_arg0.Title:setRGB( 0.96, 0.94, 0.78 ) --[[ @ 0]]
		...
		LoseFocus = function ( f15_arg0, f15_arg1 )
			...
			f15_local3( f15_arg0.SelectorOverlay ) --[[ @ 0]]
			local f15_local4 = function ( f20_arg0 )
				f15_arg0.FocusBrackets:beginAnimation( 50 ) --[[ @ 0]]
	...
	Disabled = {
		DefaultClip = function ( f21_arg0, f21_arg1 )
			...
			f21_arg0.Lines:setAlpha( 0.5 ) --[[ @ 0]]
			f21_arg0.clipFinished( f21_arg0.Lines ) --[[ @ 0]]
