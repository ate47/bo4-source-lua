...
CoD.ZM_Revive.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	revivingText:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7605483F37772A32" ) ) --[[ @ 0]]
	revivingText:setTTF( "notosans_bold" ) --[[ @ 0]]
	revivingText:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	revivingText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f8_local0 then
					f8_local0 = CoD.ModelUtility.IsSelfModelValueEnumBitSet( element, f1_arg1, "stateFlags", Enum[@"BleedOutStateFlags"][@"hash_187054111A5DB20B"] ) --[[ @ 0]]
					if f8_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f9_local0 then
					f9_local0 = CoD.ModelUtility.IsSelfModelValueEnumBitSet( element, f1_arg1, "stateFlags", Enum[@"BleedOutStateFlags"][@"hash_5388AB9DB3B39402"] ) --[[ @ 0]]
					if f9_local0 then
	...
	f1_local7( f1_local6, f1_local8["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"]], function ( f16_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
