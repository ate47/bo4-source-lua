...
CoD.StartMenu_Options_Frame_Sound = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.StartMenu_Options_Frame_Sound.__defaultWidth = 1920 --[[ @ 0]]
CoD.StartMenu_Options_Frame_Sound.__defaultHeight = 890 --[[ @ 0]]
CoD.StartMenu_Options_Frame_Sound.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.StartMenu_Options_Frame_Sound ) --[[ @ 0]]
	self.id = "StartMenu_Options_Frame_Sound" --[[ @ 0]]
	...
	OptionGroups:setDataSource( "PlayerSettingsAudioList" ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( OptionGroups, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		if IsElementPropertyValue( element, "isAudioTest", true ) then
			PlaySoundAlias( "tst_test_system" ) --[[ @ 0]]
			return true
	...
	LUI.OverrideFunction_CallOriginalFirst( self, "close", function ( element )
		StopSoundAlias( "tst_test_system" ) --[[ @ 0]]
	end ) --[[ @ 0]]
