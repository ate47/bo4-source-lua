...
CoD.GameEndScoreEnemyBacker = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.GameEndScoreEnemyBacker.__defaultWidth = 960 --[[ @ 0]]
CoD.GameEndScoreEnemyBacker.__defaultHeight = 168 --[[ @ 0]]
CoD.GameEndScoreEnemyBacker.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.GameEndScoreEnemyBacker ) --[[ @ 0]]
	self.id = "GameEndScoreEnemyBacker" --[[ @ 0]]
	...
	BgTint:setZRot( 180 ) --[[ @ 0]]
	BgTint:setImage( RegisterImage( @"hash_7136CAB682831EF3" ) ) --[[ @ 0]]
	self:addElement( BgTint ) --[[ @ 0]]
	self.BgTint = BgTint --[[ @ 0]]
	
	local PixelGridTiledBacking = LUI.UIImage.new( 0.02, 0.02, -16, 940, 0.31, 0.31, -44.5, 107.5 ) --[[ @ 0]]
	...
	local BaseBacking = LUI.UIImage.new( 0, 0, 265, 725, 0, 0, 36, 132 ) --[[ @ 0]]
	...
	local Base = LUI.UIImage.new( 0, 0, 265, 725, 0, 0, 36, 132 ) --[[ @ 0]]
	Base:setAlpha( 0.6 ) --[[ @ 0]]
	Base:setYRot( 180 ) --[[ @ 0]]
	...
	local StripBase = LUI.UIImage.new( 0, 0, 265, 725, 0, 0, 122, 130 ) --[[ @ 0]]
	StripBase:setAlpha( 0.17 ) --[[ @ 0]]
	StripBase:setYRot( 180 ) --[[ @ 0]]
	...
	local StripGlow = LUI.UIImage.new( 0, 0, 265, 725, 0, 0, 122, 130 ) --[[ @ 0]]
	StripGlow:setYRot( 180 ) --[[ @ 0]]
	...
	local triangle = LUI.UIImage.new( 0, 0, 897, 905, 0.5, 0.5, -7, 7 ) --[[ @ 0]]
	...
	FrameOuterTop:setImage( RegisterImage( @"hash_615E16C12DDE7014" ) ) --[[ @ 0]]
	self:addElement( FrameOuterTop ) --[[ @ 0]]
	self.FrameOuterTop = FrameOuterTop --[[ @ 0]]
	
	local microtext = LUI.UIImage.new( 0, 0, 915, 933, 0, 0, 3.5, 7.5 ) --[[ @ 0]]
	...
	local microtext5 = LUI.UIImage.new( 0, 0, 915, 933, 0, 0, 159.5, 163.5 ) --[[ @ 0]]
	...
	local microtext2 = LUI.UIImage.new( 0, 0, 904, 922, 0, 0, 4, 8 ) --[[ @ 0]]
	...
	local microtext6 = LUI.UIImage.new( 0, 0, 904, 922, 0, 0, 160, 164 ) --[[ @ 0]]
	...
	local microtext3 = LUI.UIImage.new( 0, 0, 201, 219, 0, 0, 4, 8 ) --[[ @ 0]]
	...
	local microtext7 = LUI.UIImage.new( 0, 0, 201, 219, 0, 0, 160, 164 ) --[[ @ 0]]
	...
	local microtext4 = LUI.UIImage.new( 0, 0, 192, 210, 0, 0, 4.5, 8.5 ) --[[ @ 0]]
	...
	local microtext8 = LUI.UIImage.new( 0, 0, 192, 210, 0, 0, 160.5, 164.5 ) --[[ @ 0]]
	...
	local FrameLight = LUI.UIImage.new( 0, 0, 948, 956, 0, 0, 74, 94 ) --[[ @ 0]]
	FrameLight:setYRot( 180 ) --[[ @ 0]]
		...
		DefaultClip = function ( f7_arg0, f7_arg1 )
			...
			local f7_local0 = function ( f8_arg0 )
				local f8_local0 = function ( f9_arg0 )
					f9_arg0:beginAnimation( 1000, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
					f9_arg0:setAlpha( 0.6 ) --[[ @ 0]]
					f9_arg0:registerEventHandler( "transition_complete_keyframe", f7_arg0.clipFinished ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f7_arg0.Base:beginAnimation( 1000, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
			...
			local f7_local2 = function ( f12_arg0 )
				local f12_local0 = function ( f13_arg0 )
					local f13_local0 = function ( f14_arg0 )
						local f14_local0 = function ( f15_arg0 )
							local f15_local0 = function ( f16_arg0 )
								local f16_local0 = function ( f17_arg0 )
								 ...
								 --[[ @ 0]]
								f16_arg0:beginAnimation( 199, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
								f16_arg0:setShaderVector( 0, 1, 0, 0, 0 ) --[[ @ 0]]
								f16_arg0:registerEventHandler( "transition_complete_keyframe", f16_local0 ) --[[ @ 0]]
							end
							 --[[ @ 0]]
							f15_arg0:beginAnimation( 200, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
					 ...
					 --[[ @ 0]]
					f13_arg0:beginAnimation( 200, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
					f13_arg0:setShaderVector( 0, 1, 0, 0, 0 ) --[[ @ 0]]
					f13_arg0:registerEventHandler( "transition_complete_keyframe", f13_local0 ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f7_arg0.FrameLight:beginAnimation( 200, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
