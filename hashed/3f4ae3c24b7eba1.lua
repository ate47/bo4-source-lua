	...
	vhudmsNotificationOptic:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "fullscreenFilter", Enum[@"VehicleFullscreenFilter"][@"hash_22F62AA55E8A2010"] )
			end
		}
	} ) --[[ @ 0]]
	...
	vhudmsNotificationFlir0:mergeStateConditions( {
		{
			stateName = "Active",
			condition = function ( menu, element, event )
				return CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "fullscreenFilter", Enum[@"VehicleFullscreenFilter"][@"hash_413D609C34003A6C"] )
			end
		}
	} ) --[[ @ 0]]
