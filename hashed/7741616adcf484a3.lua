...
CoD.EmblemOptionsButton_Internal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.EmblemOptionsButton_Internal.__defaultWidth = 180 --[[ @ 0]]
CoD.EmblemOptionsButton_Internal.__defaultHeight = 60 --[[ @ 0]]
CoD.EmblemOptionsButton_Internal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.EmblemOptionsButton_Internal ) --[[ @ 0]]
	self.id = "EmblemOptionsButton_Internal" --[[ @ 0]]
	...
	local Title = LUI.UIText.new( 0, 1, 5, -5, 0.5, 0.5, -11, 11 ) --[[ @ 0]]
...
CoD.EmblemOptionsButton_Internal.__clipsPerState = {
	DefaultState = {
		...
		GainFocus = function ( f8_arg0, f8_arg1 )
			...
			local f8_local3 = function ( f13_arg0 )
				f8_arg0.FrontendFrameSelected:beginAnimation( 200 ) --[[ @ 0]]
		...
		LoseFocus = function ( f16_arg0, f16_arg1 )
			...
			local f16_local2 = function ( f19_arg0 )
				f16_arg0.FocusHighlight:beginAnimation( 200 ) --[[ @ 0]]
			...
			f16_arg0.FocusHighlight:setAlpha( 0.8 ) --[[ @ 0]]
			f16_local2( f16_arg0.FocusHighlight ) --[[ @ 0]]
			local f16_local3 = function ( f20_arg0 )
				f16_arg0.FrontendFrameSelected:beginAnimation( 200 ) --[[ @ 0]]
			...
			local f16_local4 = function ( f21_arg0 )
				f16_arg0.Title:beginAnimation( 200 ) --[[ @ 0]]
				f16_arg0.Title:setRGB( ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b ) --[[ @ 0]]
				f16_arg0.Title:registerEventHandler( "interrupted_keyframe", f16_arg0.clipInterrupted ) --[[ @ 0]]
				f16_arg0.Title:registerEventHandler( "transition_complete_keyframe", f16_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f16_arg0.Title:completeAnimation() --[[ @ 0]]
			f16_arg0.Title:setRGB( 0, 0, 0 ) --[[ @ 0]]
			f16_local4( f16_arg0.Title ) --[[ @ 0]]
	...
	Disabled = {
		DefaultClip = function ( f23_arg0, f23_arg1 )
			...
			f23_arg0.FocusHighlight:completeAnimation() --[[ @ 0]]
			f23_arg0.FocusHighlight:setAlpha( 0 ) --[[ @ 0]]
			f23_arg0.clipFinished( f23_arg0.FocusHighlight ) --[[ @ 0]]
			f23_arg0.DotTiledBacking:completeAnimation() --[[ @ 0]]
			f23_arg0.DotTiledBacking:setAlpha( 0.4 ) --[[ @ 0]]
			f23_arg0.clipFinished( f23_arg0.DotTiledBacking ) --[[ @ 0]]
			f23_arg0.Title:completeAnimation() --[[ @ 0]]
			f23_arg0.Title:setAlpha( 0.2 ) --[[ @ 0]]
			f23_arg0.clipFinished( f23_arg0.Title ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.EmblemOptionsButton_Internal.__onClose = function ( f24_arg0 )
	f24_arg0.FocusBrackets:close() --[[ @ 0]]
	f24_arg0.DotTiledBacking:close() --[[ @ 0]]
	f24_arg0.Title:close() --[[ @ 0]]
	f24_arg0.Lines:close() --[[ @ 0]]
end
 --[[ @ 0]]
