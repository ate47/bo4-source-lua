...
DataSources.TalismanCategories = ListHelper_SetupDataSource( "TalismanCategories", function ( f1_arg0, f1_arg1 )
	...
	if f1_local0 ~= CoD.CACUtility.EmptyItemIndex then
		f1_local1 = Engine[@"hash_487395843D470BE2"]( f1_local0, Enum[@"hash_6EB546760F890D2"][@"hash_15544C104CD15F10"], Enum[@"eModes"][@"hash_73723205FAE52C4A"] ) --[[ @ 0]]
	end
	local f1_local2 = function ( f2_arg0 )
		return f1_local1 and f1_local1[@"hash_4EAC0467BA97BCA9"] == f2_arg0
	end
	 --[[ @ 0]]
	local f1_local3 = {} --[[ @ 0]]
	table.insert( f1_local3, {
		models = {
			...
			tabHasRestrictions = CoD.CACUtility.AnyTalismanRestrictedForRarity( Enum[@"hash_4EAC0467BA97BCA9"][@"hash_1CAF546022922B9B"] )
		},
		properties = {
			rarity = Enum[@"hash_4EAC0467BA97BCA9"][@"hash_1CAF546022922B9B"],
			selectIndex = f1_local2( Enum[@"hash_4EAC0467BA97BCA9"][@"hash_1CAF546022922B9B"] )
		}
	} ) --[[ @ 0]]
	table.insert( f1_local3, {
		models = {
			tabName = @"hash_1D14011B788D0CF7",
			tabHasRestrictions = CoD.CACUtility.AnyTalismanRestrictedForRarity( Enum[@"hash_4EAC0467BA97BCA9"][@"hash_7A113367DDA0F492"] )
		},
		properties = {
			rarity = Enum[@"hash_4EAC0467BA97BCA9"][@"hash_7A113367DDA0F492"],
			selectIndex = f1_local2( Enum[@"hash_4EAC0467BA97BCA9"][@"hash_7A113367DDA0F492"] )
		}
	} ) --[[ @ 0]]
	table.insert( f1_local3, {
		models = {
			tabName = @"hash_499BE3404C6F5504",
			tabHasRestrictions = CoD.CACUtility.AnyTalismanRestrictedForRarity( Enum[@"hash_4EAC0467BA97BCA9"][@"hash_596900358670FFE7"] )
		},
		properties = {
			rarity = Enum[@"hash_4EAC0467BA97BCA9"][@"hash_596900358670FFE7"],
			selectIndex = f1_local2( Enum[@"hash_4EAC0467BA97BCA9"][@"hash_596900358670FFE7"] )
		}
	} ) --[[ @ 0]]
	table.insert( f1_local3, {
		models = {
			tabName = @"hash_7CC5E57AF2A3CF36",
			tabHasRestrictions = CoD.CACUtility.AnyTalismanRestrictedForRarity( Enum[@"hash_4EAC0467BA97BCA9"][@"hash_309F2E1F9312FF03"] )
		},
		properties = {
			rarity = Enum[@"hash_4EAC0467BA97BCA9"][@"hash_309F2E1F9312FF03"],
			selectIndex = f1_local2( Enum[@"hash_4EAC0467BA97BCA9"][@"hash_309F2E1F9312FF03"] )
		}
	} ) --[[ @ 0]]
	return f1_local3
end, true ) --[[ @ 0]]
CoD.ZMTalismanUtility.IsEquippedTalismanOfType = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	if f3_local1 and f3_local1 > CoD.CACUtility.EmptyItemIndex then
		local f3_local2 = Engine[@"hash_487395843D470BE2"]( f3_local1, Enum[@"hash_6EB546760F890D2"][@"hash_15544C104CD15F10"], Enum[@"eModes"][@"hash_73723205FAE52C4A"] ) --[[ @ 0]]
		return f3_local2 and f3_local2[@"hash_7E73D6BF951E301E"] == f3_arg2
	else
		return false
	end
end
...
CoD.ZMTalismanUtility.UpdateTalismanModel = function ( f5_arg0, f5_arg1, f5_arg2 )
	...
	if f5_local0 then
		...
		local f5_local3 = Engine[@"GetItemGroup"]( f5_local1, Enum[@"hash_6EB546760F890D2"][@"hash_15544C104CD15F10"], Enum[@"eModes"][@"hash_73723205FAE52C4A"] ) --[[ @ 0]]
		local f5_local4 = true --[[ @ 0]]
		local f5_local5 = "select01" --[[ @ 0]]
		local f5_local6 = @"hash_0" --[[ @ 0]]
		local f5_local7 = 1 --[[ @ 0]]
		local f5_local8 = CoD.CACUtility.GetUnlockableItemInfo( f5_local2, Enum[@"eModes"][@"hash_73723205FAE52C4A"] ) --[[ @ 0]]
		if f5_local8 then
			f5_local6 = f5_local8[@"hash_B6404450C6BAEEF"] or @"hash_0" --[[ @ 0]]
			f5_local7 = f5_local8[@"hash_4B49D7582CD08B0E"] or 1 --[[ @ 0]]
		end
