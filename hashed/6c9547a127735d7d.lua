...
CoD.KilledByHeader.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MistakesText:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	MistakesText:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	DeathTypeText:setAlignment( Enum[@"luialignment"][@"lui_alignment_right"] ) --[[ @ 0]]
	DeathTypeText:setAlignment( Enum[@"luialignment"][@"lui_alignment_middle"] ) --[[ @ 0]]
	...
	DeathWeaponName:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	DeathWeaponName:setAlignment( Enum[@"luialignment"][@"lui_alignment_middle"] ) --[[ @ 0]]
	...
	DeathWeaponName:subscribeToGlobalModel( f1_arg1, "HUDItems", "killedByItemIndex", function ( model )
		...
		if f8_local0 ~= nil then
			DeathWeaponName:setText( LocalizeToUpperString( GetItemNameFromIndex( Enum[@"statindexoffset"][@"hash_13057ABF96AF8289"], f8_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
