...
CoD.WeaponBribePreview = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.WeaponBribePreview.__defaultWidth = 400 --[[ @ 0]]
CoD.WeaponBribePreview.__defaultHeight = 32 --[[ @ 0]]
CoD.WeaponBribePreview.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.WeaponBribePreview ) --[[ @ 0]]
	self.id = "WeaponBribePreview" --[[ @ 0]]
	...
	TitlePC = LUI.UIText.new( 0, 1, 0, 0, 0.5, 0.5, -12, 12 ) --[[ @ 0]]
	TitlePC:setRGB( ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b ) --[[ @ 0]]
	TitlePC:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_4BAB331BCEF6175C" ) ) --[[ @ 0]]
	...
	TitlePC:setAlignment( Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"] ) --[[ @ 0]]
...
CoD.WeaponBribePreview.__resetProperties = function ( f5_arg0 )
	...
	f5_arg0.TitlePC:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_4BAB331BCEF6175C" ) ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.WeaponBribePreview.__clipsPerState = {
	...
	KBM = {
		DefaultClip = function ( f7_arg0, f7_arg1 )
			...
			f7_arg0.TitlePC:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_2A2F6B846CE688A3" ) ) --[[ @ 0]]
