...
CoD.PurchaseReservesItem = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.PurchaseReservesItem = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "PurchaseReservesItem", f1_arg0 ) --[[ @ 0]]
	...
	self:setClass( CoD.PurchaseReservesItem ) --[[ @ 0]]
	...
	FullscreenPopupTemplate.ButtonList:setDataSource( "PurchaseReservesItemButtons" ) --[[ @ 0]]
	...
	FullscreenPopupTemplate:linkToElementModel( self, "name", true, function ( model )
		...
		if f7_local0 ~= nil then
			FullscreenPopupTemplate.Subtitle:setText( LocalizeIntoString( @"hash_1AF16248246D3D96", f7_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	FullscreenPopupTemplate:linkToElementModel( self, "name", true, function ( model )
		local f8_local0 = model:get() --[[ @ 0]]
		if f8_local0 ~= nil then
			FullscreenPopupTemplate.Title:setText( ToUpper( LocalizeIntoString( @"hash_663FCD1B0849669E", f8_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	PopupImage:linkToElementModel( self, "popupImage", true, function ( model )
		...
		if f10_local0 ~= nil then
			PopupImage:setImage( RegisterImage( f10_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	Price:linkToElementModel( self, "price", true, function ( model )
		...
		if f11_local0 ~= nil then
			Price:setText( LocalizeIntoString( @"hash_27AD54B6F8C27799", f11_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"], nil, function ( element, menu, controller, model )
		if not IsElementInState( self.FullscreenPopupTemplate, "WorkingState" ) and not IsElementInState( self.FullscreenPopupTemplate, "ErrorState" ) then
			...
			CoD.BlackMarketUtility.SendPurchaseReservesEvent( controller, menu ) --[[ @ 0]]
			return true
		else
	...
	if IsPC() and IsElementInState( self.FullscreenPopupTemplate, "ErrorState" ) then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput( f1_local1, f1_arg0, f1_local14, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	elseif IsPC() then
