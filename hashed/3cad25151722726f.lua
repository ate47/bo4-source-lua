...
CoD.ReservesSpecialContractInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	Timer.TextBox2:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	DefaultState = {
		...
		GainFocus = function ( f26_arg0, f26_arg1 )
			...
			local f26_local1 = function ( f28_arg0 )
				f26_arg0.FocusBorder:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
	...
	Complete = {
		...
		GainFocus = function ( f35_arg0, f35_arg1 )
			...
			local f35_local1 = function ( f37_arg0 )
				f35_arg0.FocusBorder:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
