...
LUI.createMenu.PaintjobWeaponSelect = function ( f1_arg0, f1_arg1 )
	...
	LUI.OverrideFunction_CallOriginalFirst( self, "close", function ( element )
		CoD.BreadcrumbUtility.UploadBuffer( f1_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	...
	DefaultState = {
		...
		Close = function ( f13_arg0, f13_arg1 )
			...
			local f13_local0 = function ( f14_arg0 )
				f13_arg0.BackgroundSlidePanel:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
