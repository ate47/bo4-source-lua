...
DataSources.BleedoutPerkVapors = DataSourceHelpers.CustomListSetup( "BleedoutPerkVapors", function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4 )
	CoD.CACUtility.GetCustomClassModel( f1_arg1, Engine[@"hash_3D2B2D1965173543"]( f1_arg1 ), f1_arg2:create( "classModel" ), nil, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
...
DataSources.PerkVapors = DataSourceHelpers.CustomListSetup( "PerkVapors", function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3, f10_arg4 )
	CoD.CACUtility.GetCustomClassModel( f10_arg1, Engine[@"hash_3D2B2D1965173543"]( f10_arg1 ), f10_arg2:create( "classModel" ), nil, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
...
DataSources.ZMEquippedPerks = {
	prepare = function ( f12_arg0, f12_arg1, f12_arg2 )
		...
		local f12_local1 = Engine[@"hash_2E00B2F29271C60B"]( @"zm_altars_info" ) --[[ @ 0]]
		...
		for f12_local9, f12_local10 in ipairs( CoD.ZMPerkUtility.PerkSlotNameList ) --[[ @ 0]] do
			...
			if f12_local11 then
				...
				f12_local7:set( f12_local3[f12_local9][@"altarname"] or @"hash_0" ) --[[ @ 0]]
				f12_local7 = f12_local11:create( "altarImage" ) --[[ @ 0]]
				f12_local7:set( f12_local3[f12_local9][@"altarimage"] or @"hash_0" ) --[[ @ 0]]
...
CoD.ZMPerkUtility.PerkOptionSelected = function ( f24_arg0, f24_arg1, f24_arg2 )
	...
	local f24_local5 = Engine[@"hash_487395843D470BE2"]( f24_local4, Enum[@"statindexoffset"][@"hash_49AF82A21BAD026D"], Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
	...
	if not f24_local6 or f24_local6 ~= f24_local1 then
		if f24_local6 and f24_local5[@"hash_52616A8F1602BB4B"] ~= 1 then
			CoD.CACUtility.SetClassItem( f24_arg2, f24_local2, f24_local6, CoD.CACUtility.GetItemEquippedInSlot( f24_local1, f24_arg2, f24_local0 ), nil, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
		end
		CoD.CACUtility.SetClassItem( f24_arg2, f24_local2, f24_local1, f24_local4, nil, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
		CoD.CACUtility.GetCustomClassModel( f24_arg2, f24_local2, f24_local0, nil, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
...
CoD.ZMPerkUtility.PerkSlotFocused = function ( f26_arg0, f26_arg1, f26_arg2 )
	...
	local f26_local3 = CoD.CACUtility.GetUnlockableItemInfo( Engine[@"hash_1E8B1E317B9DD6FE"]( f26_local2, Enum[@"statindexoffset"][@"hash_49AF82A21BAD026D"], f26_local0 ), f26_local0 ) --[[ @ 0]]
	if not f26_local3 then
		return 
	end
	local f26_local4 = f26_local3.displayName --[[ @ 0]]
	local f26_local5 = f26_local3.description --[[ @ 0]]
	local f26_local6 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/modifier", f26_local3[@"hash_18FC01EA0DDD81D"] or @"hash_0" ) --[[ @ 0]]
	local f26_local7 = f26_local3[@"modifierdescription"] or @"hash_0" --[[ @ 0]]
...
CoD.ZMPerkUtility.GetPerkModifierName = function ( f27_arg0, f27_arg1 )
	local f27_local0 = Engine[@"hash_487395843D470BE2"]( f27_arg1, Enum[@"statindexoffset"][@"hash_49AF82A21BAD026D"], Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
