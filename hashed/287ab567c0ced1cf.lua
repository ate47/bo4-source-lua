...
Lobby.Pregame.LobbyState = {
	IDLE = Enum[@"LobbyPregameState"][@"hash_3ECCE7392BE20418"],
	VOTE = Enum[@"LobbyPregameState"][@"hash_280503ECA55D2B4A"],
	DRAFT = Enum[@"LobbyPregameState"][@"hash_6A92B0F10B2D8631"],
	CAC_EDIT = Enum[@"LobbyPregameState"][@"hash_1069EC00C4FB3000"],
	STREAK_EDIT = Enum[@"LobbyPregameState"][@"hash_2B8F42BBB163BB8F"],
	LAUNCH_GAME = Enum[@"LobbyPregameState"][@"hash_5A5AA22183845C10"],
	COUNT = Enum[@"LobbyPregameState"][@"hash_7A5A048C913985ED"]
} --[[ @ 0]]
Lobby.Pregame.ClientState = {
	IDLE = Enum[@"LobbyClientPregameState"][@"hash_12FFCFE1473B8AD8"],
	SELECTING = Enum[@"LobbyClientPregameState"][@"hash_10AA7DA7C4AE701A"],
	SELECTED = Enum[@"LobbyClientPregameState"][@"hash_211B822C85E9B637"],
	FORCED = Enum[@"LobbyClientPregameState"][@"hash_47C1C9D7AAFD3C80"],
	COMPLETE = Enum[@"LobbyClientPregameState"][@"hash_7FB228954C0E9842"],
	RESET = Enum[@"LobbyClientPregameState"][@"hash_63E5033C5A3470C1"],
	END = Enum[@"LobbyClientPregameState"][@"hash_63735E3C075E8B0B"],
	COUNT = Enum[@"LobbyClientPregameState"][@"hash_153091E1BC9ABEAD"]
} --[[ @ 0]]
Lobby.Pregame.StateInfo = {
	[Lobby.Pregame.Stage.PRESTAGE] = {
		[Lobby.Pregame.LobbyState.VOTE] = {
			setting = "pregamePreStageTime",
			statusString = @"hash_2789B1BB18060943"
		},
	...
	[Lobby.Pregame.Stage.POSTSTAGE] = {
		[Lobby.Pregame.LobbyState.VOTE] = {
			...
			statusString = @"hash_4F0C75904F29F8BC"
		},
		[Lobby.Pregame.LobbyState.DRAFT] = {
			setting = "pregamePostStageTime",
			statusString = @"hash_4F0C75904F29F8BC"
...
Lobby.Pregame.OnClientAdded = function ( f1_arg0 )
	if Engine[@"hash_1C1AA623AAF32C21"]() == Enum[@"LobbyPregameState"][@"hash_3ECCE7392BE20418"] then
		return 
	else
		Engine[@"hash_43E0EFA24890DC98"]( f1_arg0.xuid, Lobby.Pregame.ClientState.SELECTED ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
Lobby.Pregame.StartTimer = function ( f7_arg0, f7_arg1 )
	local f7_local0 = Engine[@"hash_69D33D652B9B0F3B"]() --[[ @ 0]]
...
Lobby.Pregame.LaunchGame = function ()
	LobbyVM.LaunchGameExec( Engine[@"GetPrimaryController"](), Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
	Lobby.Pregame.SetState( Lobby.Pregame.LobbyState.IDLE ) --[[ @ 0]]
end
 --[[ @ 0]]
Lobby.Pregame.GetTeams = function ()
	local f9_local0 = Engine[@"hash_4755D55B3813D249"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
	local f9_local1 = {} --[[ @ 0]]
	for f9_local5, f9_local6 in pairs( f9_local0.sessionClients ) --[[ @ 0]] do
		if f9_local6.team ~= Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
...
Lobby.Pregame.AssignTeamPositions = function ()
	...
	if f12_local1 == Enum[@"PregameSortType"][@"hash_1304012B859D8624"] then
		for f12_local8, f12_local9 in pairs( f12_local0 ) --[[ @ 0]] do
			for f12_local5, f12_local6 in ipairs( Lobby.Pregame.Shuffle( f12_local9 ) ) --[[ @ 0]] do
				Engine[@"hash_7DFCC74C38E7DAA4"]( f12_local6.xuid, f12_local5 ) --[[ @ 0]]
			end
		end
	elseif f12_local1 == Enum[@"PregameSortType"][@"hash_1C4FA3BE8DFF3E84"] then
		for f12_local8, f12_local9 in pairs( f12_local0 ) --[[ @ 0]] do
	...
	elseif f12_local1 == Enum[@"PregameSortType"][@"hash_5DA1C0DCA25E2FC3"] then
...
Lobby.Pregame.PostVoteShuffle = function ()
	...
	if f14_local1 == Enum[@"PregameShuffleMethod"][@"hash_242CE69189B63835"] then
		return 
	elseif f14_local1 == Enum[@"PregameShuffleMethod"][@"hash_751AF62F0910A747"] then
		for f14_local7, f14_local8 in pairs( f14_local0 ) --[[ @ 0]] do
			local f14_local5 = 0 --[[ @ 0]]
			for f14_local6 = #f14_local8 --[[ @ 0]], 1, -1 do
				Engine[@"hash_7DFCC74C38E7DAA4"]( f14_local8[f14_local6].xuid, f14_local5 ) --[[ @ 0]]
				f14_local5 = f14_local5 + 1 --[[ @ 0]]
			end
		end
	elseif f14_local1 == Enum[@"PregameShuffleMethod"][@"hash_2A032B0BCA8CEB04"] then
		for f14_local7, f14_local8 in pairs( f14_local0 ) --[[ @ 0]] do
			for f14_local11, f14_local12 in ipairs( Lobby.Pregame.Shuffle( f14_local8 ) ) --[[ @ 0]] do
				Engine[@"hash_7DFCC74C38E7DAA4"]( f14_local12.xuid, f14_local11 ) --[[ @ 0]]
			end
		end
	end
end
...
Lobby.Pregame.Clear = function ()
	Lobby.Pregame.Timer = {} --[[ @ 0]]
	Lobby.Pregame.CurrentState = {} --[[ @ 0]]
	Engine[@"hash_32099421AC9DAA72"]() --[[ @ 0]]
end
 --[[ @ 0]]
Lobby.Pregame.Shutdown = function ( f16_arg0 )
	Lobby.Timer.UnlockLobby( f16_arg0, true ) --[[ @ 0]]
	Lobby.Pregame.Clear() --[[ @ 0]]
	Engine[@"SetModelValue"]( Engine[@"CreateModel"]( Engine[@"CreateModel"]( Engine[@"GetGlobalModel"](), "lobbyRoot.Pregame" ), "state" ), Enum[@"LobbyPregameState"][@"hash_3ECCE7392BE20418"] ) --[[ @ 0]]
...
Lobby.Pregame.SetState = function ( f17_arg0 )
	if Lobby.Pregame.CurrentState ~= f17_arg0 then
		...
		Engine[@"hash_4B1CC98090648313"]( f17_arg0 ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
Lobby.Pregame.Start = function ()
	...
	if Engine[@"GetGametypeSetting"]( Lobby.Pregame.Settings.VOTE_ENABLED ) == 1 then
		Lobby.Pregame.SetState( Enum[@"LobbyPregameState"][@"hash_280503ECA55D2B4A"] ) --[[ @ 0]]
	elseif Engine[@"GetGametypeSetting"]( Lobby.Pregame.Settings.DRAFT_ENABLED ) == 1 then
		Lobby.Pregame.SetState( Enum[@"LobbyPregameState"][@"hash_6A92B0F10B2D8631"] ) --[[ @ 0]]
	else
...
Lobby.Pregame.GetRandomUnpickedCharacter = function ( f21_arg0 )
	local f21_local0 = Engine[@"GetHeroList"]( Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] ) --[[ @ 0]]
	local f21_local1 = {} --[[ @ 0]]
	for f21_local5, f21_local6 in pairs( f21_arg0 ) --[[ @ 0]] do
		local f21_local7 = f21_local6.characterDraft.characterIndex --[[ @ 0]]
		if f21_local7 >= 0 and (f21_local6.pregameState == Enum[@"LobbyClientPregameState"][@"hash_211B822C85E9B637"] or f21_local6.pregameState == Enum[@"LobbyClientPregameState"][@"hash_47C1C9D7AAFD3C80"]) then
	...
	for f22_local8, f22_local9 in pairs( Lobby.Pregame.GetTeams() ) --[[ @ 0]] do
		...
		for f22_local5, f22_local6 in pairs( f22_local9 ) --[[ @ 0]] do
			if not f22_local4 and f22_local6.pregameState == Lobby.Pregame.ClientState.IDLE then
				Engine[@"hash_43E0EFA24890DC98"]( f22_local6.xuid, Lobby.Pregame.ClientState.SELECTING ) --[[ @ 0]]
				f22_local4 = true --[[ @ 0]]
				f22_local0 = true --[[ @ 0]]
			end
		end
...
Lobby.Pregame.StartRoundForAllPlayers = function ()
	for f23_local6, f23_local7 in pairs( Lobby.Pregame.GetTeams() ) --[[ @ 0]] do
		for f23_local3, f23_local4 in pairs( f23_local7 ) --[[ @ 0]] do
			Engine[@"hash_43E0EFA24890DC98"]( f23_local4.xuid, Lobby.Pregame.ClientState.SELECTING ) --[[ @ 0]]
		end
	end
	Lobby.Pregame.StartTimer( Lobby.Pregame.Stage.ROUND ) --[[ @ 0]]
end
	...
	for f24_local10, f24_local11 in pairs( f24_local0 ) --[[ @ 0]] do
		for f24_local7, f24_local8 in pairs( f24_local11 ) --[[ @ 0]] do
			if f24_local8.pregameState == Lobby.Pregame.ClientState.SELECTING then
				local f24_local5 = Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] ) --[[ @ 0]]
				if f24_local1 == Lobby.Pregame.LobbyState.VOTE then
					Engine[@"hash_724AE7CEC130F10E"]( f24_local5, f24_local8.xuid ) --[[ @ 0]]
				end
				if f24_local1 == Lobby.Pregame.LobbyState.DRAFT then
					...
					if f24_local6 < 0 then
						...
						Engine[@"hash_4558F0683EF31FC"]( f24_local5, f24_local8.xuid, f24_local6 ) --[[ @ 0]]
						goto basicblock_13:
					end
				end
				if f24_local1 == Lobby.Pregame.LobbyState.CAC_EDIT or f24_local1 == Lobby.Pregame.LobbyState.STREAK_EDIT then
					Engine[@"hash_58E262BDF7840361"]( f24_local5, f24_local8.xuid ) --[[ @ 0]]
				end
			end
		end
	end
...
Lobby.Pregame.GetAllBannedItems = function ()
	local f25_local0 = {} --[[ @ 0]]
	local f25_local1 = Engine[@"hash_4C41C2D2C075424E"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] ) ) --[[ @ 0]]
	if f25_local1 ~= nil and #f25_local1 > 0 then
		for f25_local5, f25_local6 in ipairs( f25_local1 ) --[[ @ 0]] do
			if f25_local6.voteType == Enum[@"VoteType"][@"hash_5B7AC034CE116958"] then
...
Lobby.Pregame.AnyCACItemsBanned = function ()
	for f26_local4, f26_local5 in ipairs( Lobby.Pregame.GetAllBannedItems() ) --[[ @ 0]] do
		if f26_local5.voteType == Enum[@"VoteType"][@"hash_5B7AC034CE116958"] then
			if f26_local5.itemType == Enum[@"VoteItemType"][@"hash_49CA3BEF4CEA2F4C"] then
			...
			if f26_local5.itemType == Enum[@"VoteItemType"][@"hash_70531597DBEBAD66"] then
				return true
			elseif f26_local5.itemType == Enum[@"VoteItemType"][@"hash_10C37980943B384C"] then
				return true
			elseif f26_local5.itemType == Enum[@"VoteItemType"][@"hash_5DDA818CB3949372"] then
				return true
			end
		end
	end
...
Lobby.Pregame.AnyStreaksBanned = function ()
	for f27_local4, f27_local5 in ipairs( Lobby.Pregame.GetAllBannedItems() ) --[[ @ 0]] do
		if f27_local5.voteType == Enum[@"VoteType"][@"hash_5B7AC034CE116958"] and f27_local5.itemType == Enum[@"VoteItemType"][@"hash_49CA3BEF4CEA2F4C"] then
...
Lobby.Pregame.OnStageEnd = function ( f28_arg0 )
	...
	Engine[@"hash_7BE6140F85B312F2"]( Lobby.Pregame.ClientState.IDLE ) --[[ @ 0]]
...
Lobby.Pregame.PrestageMonitorSpecialRules = function ()
	if LuaUtils.IsArenaMode() and Dvar[@"hash_2500E4DB2F10F5EE"]:get() > Engine[@"hash_144FC97037CE42ED"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], Enum[@"hash_6575E471C039DBD6"][@"hash_1092BC25E18D296F"] ) then
		Lobby.Pregame.Shutdown( Engine[@"GetPrimaryController"]() ) --[[ @ 0]]
		local f29_local0 = Engine[@"hash_69882F293C327557"]() --[[ @ 0]]
		...
		Lobby.Timer.HostingLobby( {
			...
			mainMode = f29_local1[@"hash_EB7DDC7F079D51B"],
			lobbyTimerType = f29_local1[@"hash_5558B67A321D1120"],
			matchEnded = false,
			status = Lobby.Timer.LOBBY_STATUS.RESET_TO_NEED
		} ) --[[ @ 0]]
		Engine[@"hash_7BE6140F85B312F2"]( Lobby.Pregame.ClientState.RESET ) --[[ @ 0]]
		return true
	else
		return false
	end
...
Lobby.Pregame.Pump = function ()
	local f30_local0 = Engine[@"hash_1C1AA623AAF32C21"]() --[[ @ 0]]
	if f30_local0 == Enum[@"LobbyPregameState"][@"hash_3ECCE7392BE20418"] then
		return 
	end
	local f30_local1 = Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] --[[ @ 0]]
	local f30_local2 = Engine[@"hash_3C3DF042E7492B66"]( f30_local1 ) --[[ @ 0]]
	if not Engine[@"hash_10EA2BE00F49480D"]( f30_local2 ) then
		return 
	end
	local f30_local3 = Lobby.Pregame.Timer --[[ @ 0]]
	local f30_local4, f30_local5 = Engine[@"hash_31ECF7C2EACD404D"]( f30_local2 ) --[[ @ 0]]
	if not f30_local3.startTime or not f30_local3.endTime then
		return 
	elseif f30_local3.startTime == f30_local3.endTime then
		Engine[@"hash_1321357761DC3249"]( f30_local1, f30_local2, f30_local3.stage, -1 ) --[[ @ 0]]
		f30_local3.lastTime = -1 --[[ @ 0]]
		return 
	elseif f30_local3.endTime < Engine[@"hash_69D33D652B9B0F3B"]() and not f30_local3.timerCompleteProcessed then
	...
	local f30_local6 = math.floor( (f30_local3.endTime - Engine[@"hash_69D33D652B9B0F3B"]() + 1) / 1000 ) --[[ @ 0]]
	if f30_local6 ~= f30_local3.lastTime then
		f30_local3.lastTime = f30_local6 --[[ @ 0]]
		Engine[@"hash_1321357761DC3249"]( f30_local1, f30_local2, f30_local3.stage, f30_local6 ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
Lobby.Pregame.AdvanceStateIfAllClientsSelected = function ()
	...
	local f33_local1 = {
		[Enum[@"LobbyClientPregameState"][@"hash_211B822C85E9B637"]] = true,
		[Enum[@"LobbyClientPregameState"][@"hash_47C1C9D7AAFD3C80"]] = true,
		[Enum[@"LobbyClientPregameState"][@"hash_7FB228954C0E9842"]] = true
	} --[[ @ 0]]
	if Lobby.Pregame.AnyClientInState( f33_local0, Enum[@"LobbyClientPregameState"][@"hash_10AA7DA7C4AE701A"] ) == false then
...
Lobby.Pregame.UpdateLobbyStatusInfo = function ( f36_arg0 )
	...
	Engine[@"hash_43B9F1AA6A523204"]( Engine[@"hash_420826BD382E3A23"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] ), Engine[@"GetXUID64"]( f36_arg0.controller ) ) ) --[[ @ 0]]
