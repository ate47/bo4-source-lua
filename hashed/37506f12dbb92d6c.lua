...
CoD.PCUtility.ToggleShortcutMenu = function ( f19_arg0, f19_arg1, f19_arg2 )
	...
	if f19_local0 and not f19_local0.keepShortcutMenuOpened then
		local f19_local1 = Engine[@"milliseconds"]() --[[ @ 0]]
	...
	if f19_local0 and f19_local0.canOpen and f19_local0.canOpen( f19_arg1, f19_local2 ) then
		...
		f19_local7 = function ()
			...
			if not f19_local0.menu or f19_local4 ~= f19_local0.menu then
				...
				if f20_local1 and not InFrontend() and IsInGame() and Engine[@"hash_10C9ACE8D8FE6136"]() and Dvar[@"cl_paused"]:get() ~= 1 then
					Dvar[@"cl_paused"]:set( 1 ) --[[ @ 0]]
					if not f20_local1._pauseGameGoBackOverride then
						f20_local1._pauseGameGoBackOverride = function ( f21_arg0 )
							Dvar[@"cl_paused"]:set( 0 ) --[[ @ 0]]
	...
	for f26_local3, f26_local4 in pairs( CoD.PCUtility.UIMenuShortcutTable ) --[[ @ 0]] do
		f26_arg0:subscribeToModel( Engine[@"hash_7A9FCAD7BE6FA349"]( f26_local3, f26_arg1 ), function ( model )
			...
			if not CoD.PCUtility.PreventUIMenuShortcuts and (not CoD.Menu.IsPriorityMenuOpen( f26_arg1 ) or f26_arg0._isPriorityMenu) and not CoD.Menu.SpinnerIsActive then
				f27_local0 = CoD.BitUtility.IsBitwiseAndNonZero( Engine[@"getmodelvalue"]( model ), Enum[@"luibuttonflags"][@"flag_down"] ) --[[ @ 0]]
				if f27_local0 then
...
CoD.PCUtil.SimulateButtonPress = function ( f37_arg0, f37_arg1, f37_arg2, f37_arg3, f37_arg4 )
	...
	local f37_local2 = Enum[@"luibuttonflags"][@"flag_down"] --[[ @ 0]]
	...
	if f37_arg3 and f37_arg3.flags then
		...
		local f37_local4 = CoD.BitUtility.IsBitwiseAndNonZero( f37_local3, Enum[@"luibuttonpromptflags"][@"hash_72919C98A7A845F0"] ) --[[ @ 0]]
...
CoD.PCUtil.SimulateDPadButtonPress = function ( f39_arg0, f39_arg1 )
	...
	if f39_local0 then
		Engine[@"setmodelvalue"]( f39_local0, Enum[@"luibuttonflags"][@"flag_down"] | Enum[@"luibuttonflags"][@"flag_dpad"] ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.PCUtil.SetupButtonLabelForPC = function ( f41_arg0, f41_arg1 )
	...
	if f41_arg0 == @"menu/back" or f41_arg0 == @"hash_778D439E1B360368" or f41_arg0 == @"menu/leave" or f41_arg0 == @"menu/dismiss" or f41_arg0 == @"menu/cancel" then
		Engine[@"setmodelvalue"]( Engine[@"createmodel"]( f41_arg1, "TooltipKeyShortcut" ), @"key/escape" ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
	...
	if f53_local1 then
		...
		f53_local4.properties = {
			updateAction = function ( f60_arg0, f60_arg1, f60_arg2, f60_arg3 )
				Engine[@"hash_26917B85E01FBFC3"]( f60_arg3, Enum[@"customizationcolornum"][@"customization_color_none"], f60_arg2 ) --[[ @ 0]]
			end
		} --[[ @ 0]]
		f53_local2( f53_local3, f53_local4 ) --[[ @ 0]]
	end
...
CoD.PCUtil.Craft_GetEmblemEditorGradientModeActions = function ( f72_arg0 )
	...
	f72_local3.properties = {
		updateAction = function ( f79_arg0, f79_arg1, f79_arg2 )
			CoD.CraftUtility.EmblemChooseColor_SetOpacity( f79_arg0, f79_arg1, Enum[@"customizationcolornum"][@"customization_color_0"], f79_arg2, f72_arg0, f79_arg0 ) --[[ @ 0]]
		end
	} --[[ @ 0]]
	...
	f72_local3.properties = {
		updateAction = function ( f81_arg0, f81_arg1, f81_arg2 )
			CoD.CraftUtility.EmblemChooseColor_SetOpacity( f81_arg0, f81_arg1, Enum[@"customizationcolornum"][@"customization_color_1"], f81_arg2, f72_arg0, f81_arg0 ) --[[ @ 0]]
		end
	} --[[ @ 0]]
	f72_local1( f72_local2, f72_local3 ) --[[ @ 0]]
	f72_local1 = table.insert --[[ @ 0]]
...
CoD.PCUtil.Craft_GetEmblemEditorMaterialActions = function ()
	...
	f83_local3.properties = {
		updateAction = function ( f86_arg0, f86_arg1, f86_arg2, f86_arg3 )
			Engine[@"emblemsetmaterialangle"]( f86_arg3, 359 * f86_arg2 ) --[[ @ 0]]
		end
	} --[[ @ 0]]
	f83_local1( f83_local2, f83_local3 ) --[[ @ 0]]
	return f83_local0
...
CoD.PCUtil.KeyboardTextFieldUpdate = function ( f117_arg0, f117_arg1 )
	local f117_local0 = Dvar[@"ui_keyboardtitle"]:get() --[[ @ 0]]
	if f117_local0 ~= nil then
		f117_arg0.header:setText( f117_local0 ) --[[ @ 0]]
	end
	local f117_local1 = Dvar[@"ui_keyboard_dvar_edit"]:get() --[[ @ 0]]
...
f0_local4[CoD.OverlayUtility.aCrossPromptFn] = function ( f176_arg0 )
 ...
 --[[ @ 0]]
f0_local4[CoD.OverlayUtility.aCrossPromptText] = @"menu/quit" --[[ @ 0]]
f0_local4[CoD.OverlayUtility.bCirclePromptFn] = function ( f178_arg0 )
 ...
 --[[ @ 0]]
f0_local4[CoD.OverlayUtility.bCirclePromptText] = @"menu/stay" --[[ @ 0]]
		...
		f281_arg0.footerTooltip.keyPrompt:linkToElementModel( f281_arg0, "KeyShortcut", true, function ( model )
			...
			if f285_local0 then
				...
				elseif #f285_local0 > 1 then
					f285_local0 = Engine[@"hash_4F9F1239CFD921FE"]( @"key/" .. f285_local0 ) --[[ @ 0]]
				end
	...
	local f287_local0 = function ()
		if f287_arg1 then
			...
			if f288_local0 ~= nil then
				local f288_local8, f288_local9 = Engine[@"getscreensize"]( f287_arg2 ) --[[ @ 0]]
...
CoD.PCUtility.RemoveFriend = function ( f319_arg0, f319_arg1 )
	...
	if f319_local0.identityBadge and f319_local0.identityBadge.xuid ~= nil then
		Engine[@"removefriend"]( f319_local0.identityBadge.xuid:get() ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
	...
	CoD.PCUtility.SetupEditControlWithModel( f330_arg0, f330_arg1, f330_arg2, f330_local0, function ( f331_arg0, f331_arg1, f331_arg2 )
		if not f331_arg2.canceled and f331_arg2.name == "textbox_editdone" then
			...
			if not Engine[@"hash_E3FC4BECF450A06"]( f330_arg1, f331_local0, Enum[@"keyboardtype"][@"keyboard_type_clan_tag"] ) then
				Engine[@"setclantag"]( f330_arg1, f331_local0 ) --[[ @ 0]]
			end
		end
		f331_arg0:set( "" ) --[[ @ 0]]
	end ) --[[ @ 0]]
...
CoD.PCUtility.RefreshPlayerInfo = function ( f398_arg0 )
	Engine[@"lobbyevent"]( "UpdatePlayerInfo", {} ) --[[ @ 0]]
end
 --[[ @ 0]]
	...
	f400_local3( f400_local2, f400_local4.battlenetCheckoutStatus, function ( f401_arg0 )
		if f401_arg0:get() == 0 then
			...
			if f401_local0 ~= nil then
				LuaUtils.ShowMessageDialog( f400_arg1, Enum[@"messagedialogtype"][@"message_dialog_type_error"], Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7A6BBF6C8401F36E", f401_local0 ), Engine[@"hash_4F9F1239CFD921FE"]( @"menu/error" ) ) --[[ @ 0]]
			end
		end
	end, false ) --[[ @ 0]]
end
...
CoD.PCUtility.ShowBattleNetCatalogError = function ( f406_arg0, f406_arg1 )
	...
	LuaUtils.ShowMessageDialog( f406_arg1, Enum[@"messagedialogtype"][@"message_dialog_type_error"], Engine[@"hash_4F9F1239CFD921FE"]( @"hash_2421AFF727532EEC", Engine[@"hash_5F47248634BEA927"]( f406_arg1 ) ), Engine[@"hash_4F9F1239CFD921FE"]( @"menu/error" ) ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.PCUtility.ShowBattleNetReconciliationError = function ( f407_arg0, f407_arg1 )
	LuaUtils.ShowMessageDialog( f407_arg1, Enum[@"messagedialogtype"][@"message_dialog_type_error"], Engine[@"hash_4F9F1239CFD921FE"]( @"hash_64A89E3BABEE02B7" ), Engine[@"hash_4F9F1239CFD921FE"]( @"menu/error" ) ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.PCUtility.RefreshBnetProductsList = function ( f410_arg0, f410_arg1, f410_arg2 )
	...
	if table.getn( f410_local0 ) == 0 then
		...
		LuaUtils.ShowMessageDialog( f410_arg0, Enum[@"messagedialogtype"][@"message_dialog_type_error"], Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7E090CBB79C37395" ), Engine[@"hash_4F9F1239CFD921FE"]( @"menu/error" ) ) --[[ @ 0]]
	else
...
CoD.PCUtility.SetupSettingsApplyButtonPrompt = function ( f412_arg0, f412_arg1, f412_arg2 )
	f412_arg0:AddButtonCallbackFunction( f412_arg2, f412_arg1, Enum[@"luibutton"][@"lui_key_xby_pstriangle"], "ui_contextual_1", function ( element, menu, controller, model )
		...
		local f414_local3 = Enum[@"luibutton"][@"lui_key_xby_pstriangle"] --[[ @ 0]]
		local f414_local4 --[[ @ 0]]
