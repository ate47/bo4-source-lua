...
Lobby.MatchmakingCP.SetupMatchmakingStage = function ( f1_arg0 )
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_6C1DE3DC19B3B20D"], "Setting up CP matchmaking stage.\n" ) --[[ @ 0]]
	...
	if Lobby.Matchmaking.SearchParams.mode == Lobby.Matchmaking.SearchMode.PUBLIC_CP_ALL then
		Lobby.Matchmaking.SetQueryId( Enum[@"QueryID"][@"hash_C137C49BFA09150"] ) --[[ @ 0]]
		Dvar[@"hash_71DCDE4E59ACB1DF"]:set( Lobby.Matchmaking.GetFfotdPlaylistVersionNumber() ) --[[ @ 0]]
		Dvar[@"hash_257D6B84159AE9C8"]:set( LuaDefine.INT_MAX ) --[[ @ 0]]
	else
	...
	local f1_local2 = Dvar[@"hash_19A8F14A21E7424D"]:get() --[[ @ 0]]
	local f1_local3 = Dvar[@"hash_38E0DBD8C71F9D10"]:get() --[[ @ 0]]
	local f1_local4 = Dvar[@"hash_B2C59B4EE116AEA"]:get() --[[ @ 0]]
