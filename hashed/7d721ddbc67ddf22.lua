...
CoD.Hud_WZ_SafeAreaContainer_Front.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	InGameTalkersWidget:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"] )
			end
		}
	} ) --[[ @ 0]]
	...
	VoipContainerAll( VoipContainerEnemiesOnly, WarzoneGameStatusIndicatorDisplay["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"]], function ( f3_arg0 )
	...
	VoipContainerAll:mergeStateConditions( {
		{
			stateName = "HudStart",
			condition = function ( menu, element, event )
				return IsGametypeSettingsValue( "wzHardcore", 1 ) and not Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"] )
			end
		}
	} ) --[[ @ 0]]
	...
	VoipContainerEnemiesOnly( WarzoneGameStatusIndicatorDisplay, f1_local8["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"]], function ( f5_arg0 )
