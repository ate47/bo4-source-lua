...
LUI.createMenu.Hud = function ( f1_arg0, f1_arg1 )
	...
	ConsoleCenter( SafeAreaContainerFront, FactionInfo["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_1DFB7B5BCEFCABF6"]], function ( f8_arg0 )
	...
	ConsoleCenter( SafeAreaContainerFront, FactionInfo["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_11CDCB451655ABCF"]], function ( f9_arg0 )
		f1_local1:updateElementState( DeadSpectate, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	ConsoleCenter = DeadSpectate.subscribeToModel --[[ @ 0]]
	FactionInfo = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	ConsoleCenter( SafeAreaContainerFront, FactionInfo["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f10_arg0 )
		f1_local1:updateElementState( DeadSpectate, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	ConsoleCenter = DeadSpectate.subscribeToModel --[[ @ 0]]
	FactionInfo = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	ConsoleCenter( SafeAreaContainerFront, FactionInfo["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f12_arg0 )
		f1_local1:updateElementState( DeadSpectate, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	ConsoleCenter = DeadSpectate.subscribeToModel --[[ @ 0]]
	FactionInfo = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	ConsoleCenter( SafeAreaContainerFront, FactionInfo["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"]], function ( f13_arg0 )
		f1_local1:updateElementState( DeadSpectate, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	ConsoleCenter = DeadSpectate.subscribeToModel --[[ @ 0]]
	FactionInfo = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	ConsoleCenter( SafeAreaContainerFront, FactionInfo["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"]], function ( f14_arg0 )
		f1_local1:updateElementState( DeadSpectate, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	ConsoleCenter = DeadSpectate.subscribeToModel --[[ @ 0]]
	FactionInfo = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	ConsoleCenter( SafeAreaContainerFront, FactionInfo["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5C57360571B0917E"]], function ( f15_arg0 )
		f1_local1:updateElementState( DeadSpectate, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	ConsoleCenter = DeadSpectate.subscribeToModel --[[ @ 0]]
	FactionInfo = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	ConsoleCenter( SafeAreaContainerFront, FactionInfo["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_2A69E34E231CE8B6"]], function ( f16_arg0 )
		f1_local1:updateElementState( DeadSpectate, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f19_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"] ) --[[ @ 0]]
				if not f19_local0 then
					if Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_A76381CC97F0253"] ) then
						f19_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_29BF57CE75A8755E"] ) --[[ @ 0]]
						if not f19_local0 then
							f19_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg0, Enum[@"UIVisibilityBit"][@"hash_33AEEAA452536E6E"] ) --[[ @ 0]]
						end
					else
						f19_local0 = true --[[ @ 0]]
					end
	...
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"]], function ( f22_arg0 )
	...
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_A76381CC97F0253"]], function ( f23_arg0 )
		f1_local1:updateElementState( self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
			modelValue = f23_arg0:get(),
			modelName = "UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_A76381CC97F0253"]
		} ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local18 = self --[[ @ 0]]
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_33AEEAA452536E6E"]], function ( f25_arg0 )
		f1_local1:updateElementState( self, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local19( f1_local18, f1_local20["lobbyRoot.lobbyNav"], function ( f28_arg0, f28_arg1 )
		CoD.Menu.UpdateButtonShownState( f28_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
