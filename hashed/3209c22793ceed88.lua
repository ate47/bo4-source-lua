...
CoD.CommonToolTip = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.CommonToolTip.__defaultWidth = 292 --[[ @ 0]]
CoD.CommonToolTip.__defaultHeight = 45 --[[ @ 0]]
CoD.CommonToolTip.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.CommonToolTip ) --[[ @ 0]]
	self.id = "CommonToolTip" --[[ @ 0]]
	self.soundSet = "FrontendMain" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local textCenterAlign = LUI.UIText.new( 0, 1, 0, 0, 0.5, 0.5, -8, 8 ) --[[ @ 0]]
	textCenterAlign:setRGB( ColorSet.T8__OFF__WHITE.r, ColorSet.T8__OFF__WHITE.g, ColorSet.T8__OFF__WHITE.b ) --[[ @ 0]]
	textCenterAlign:setText( "" ) --[[ @ 0]]
	textCenterAlign:setTTF( "dinnext_regular" ) --[[ @ 0]]
	textCenterAlign:setLineSpacing( 2 ) --[[ @ 0]]
	textCenterAlign:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	textCenterAlign:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	textCenterAlign:setBackingType( 1 ) --[[ @ 0]]
	textCenterAlign:setBackingWidget( CoD.CommonToolTipBacking, f1_arg0, f1_arg1 ) --[[ @ 0]]
	textCenterAlign:setBackingXPadding( 20 ) --[[ @ 0]]
