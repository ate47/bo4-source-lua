...
require( "x64:63d814452510a1d6" ) --[[ @ 0]]
require( "ui/uieditor/widgets/pc/utility/verticallistspacer" ) --[[ @ 0]]

CoD.AARSpecialEventReward_ZM = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AARSpecialEventReward_ZM.__defaultWidth = 412 --[[ @ 0]]
CoD.AARSpecialEventReward_ZM.__defaultHeight = 772 --[[ @ 0]]
CoD.AARSpecialEventReward_ZM.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARSpecialEventReward_ZM ) --[[ @ 0]]
	self.id = "AARSpecialEventReward_ZM" --[[ @ 0]]
	...
	local AARStepItem = CoD.AARStepItem.new( f1_arg0, f1_arg1, 0, 0, 16, 396, 0, 0, 611, 711 ) --[[ @ 0]]
	AARStepItem:linkToElementModel( self, nil, false, function ( model )
		AARStepItem:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( AARStepItem ) --[[ @ 0]]
	self.AARStepItem = AARStepItem --[[ @ 0]]
