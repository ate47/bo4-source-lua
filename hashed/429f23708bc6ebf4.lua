...
CoD.GameSettings_ZMWeapons = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.GameSettings_ZMWeapons.__defaultWidth = 1920 --[[ @ 0]]
CoD.GameSettings_ZMWeapons.__defaultHeight = 877 --[[ @ 0]]
CoD.GameSettings_ZMWeapons.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.GameSettings_ZMWeapons ) --[[ @ 0]]
	self.id = "GameSettings_ZMWeapons" --[[ @ 0]]
	...
	OptionCategoryGrid:setDataSource( "ZMWeaponsOptionCategories" ) --[[ @ 0]]
	...
	f1_local6:linkToElementModel( f1_local7, "optionsListDatasource", true, function ( model )
		...
		if f13_local0 ~= nil then
			f1_local6:setDataSource( f13_local0 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
