...
CoD.MapVoteZM.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MapVoteItemRandomZM.GameMode:setText( LocalizeToUpperString( @"menu/mode_classified" ) ) --[[ @ 0]]
	MapVoteItemRandomZM.MapName:setText( LocalizeToUpperString( @"menu/classified" ) ) --[[ @ 0]]
	MapVoteItemRandomZM.GameModeIcon:setImage( RegisterImage( @"blacktransparent" ) ) --[[ @ 0]]
	MapVoteItemRandomZM.VoteType:setText( LocalizeToUpperString( @"menu/random" ) ) --[[ @ 0]]
	...
	MapVoteItemPreviousZM.VoteType:setText( LocalizeToUpperString( @"menu/prev" ) ) --[[ @ 0]]
	...
	MapVoteItemNextZM.VoteType:setText( LocalizeToUpperString( @"menu/next" ) ) --[[ @ 0]]
	...
	SelectedMap = {
		DefaultClip = function ( f102_arg0, f102_arg1 )
			...
			local f102_local0 = function ( f103_arg0 )
				f102_arg0.DirectorMapGameTypeAndDifficulty:beginAnimation( 500, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
			...
			local f102_local1 = function ( f104_arg0 )
				f102_arg0.LobbyStatus:beginAnimation( 500, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
