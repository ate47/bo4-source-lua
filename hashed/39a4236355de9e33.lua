	...
	sequenceOverlays = {
		{
			...
			overlayInfoEntries = {
				{
					models = {
						displayTitle = @"hash_555D96CC762EABDD",
				...
				{
					models = {
						displayTitle = @"hash_7A2DD20750465431",
				...
				{
					models = {
						displayTitle = @"hash_5B06081B8B4567F2",
				...
				{
					models = {
						displayTitle = @"hash_3A47F44E3C7592DE",
...
CoD.FTUEUtility.FTUESequences.WZIntroduction = {
	...
	sequenceEndFunc = function ( f2_arg0, f2_arg1 )
		...
		Engine[@"StorageWrite"]( f2_arg1, Enum[@"StorageFileType"][@"hash_7D1A0F784B3C95A0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.WZProgressionInfo = {
	...
	sequenceEndFunc = function ( f3_arg0, f3_arg1 )
		...
		Engine[@"StorageWrite"]( f3_arg1, Enum[@"StorageFileType"][@"hash_7D1A0F784B3C95A0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.MPIntroduction = {
	...
	sequenceEndFunc = function ( f4_arg0, f4_arg1 )
		...
		Engine[@"StorageWrite"]( f4_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMIntroduction = {
	...
	sequenceEndFunc = function ( f5_arg0, f5_arg1 )
		...
		Engine[@"StorageWrite"]( f5_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMFeaturedPlaylistIntroduction = {
	...
	sequenceEndFunc = function ( f6_arg0, f6_arg1 )
		...
		Engine[@"StorageWrite"]( f6_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMClassicPlaylistIntroduction = {
	sequenceOverlays = {
		{
			overlayLayout = CoD.FTUEUtility.FTUELayouts.Entries1,
			overlayTitle = @"hash_42C192F82B6EAE71",
			overlayInfoEntries = {
				{
					models = {
						displayTitle = @"hash_0",
	...
	sequenceEndFunc = function ( f7_arg0, f7_arg1 )
		...
		Engine[@"StorageWrite"]( f7_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMZombieRushPlaylistIntroduction = {
	...
	sequenceEndFunc = function ( f8_arg0, f8_arg1 )
		...
		Engine[@"StorageWrite"]( f8_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMTCMPlaylistIntroduction = {
	sequenceOverlays = {
		{
			overlayLayout = CoD.FTUEUtility.FTUELayouts.Entries1,
			overlayTitle = @"hash_1C21959514E64ED1",
			overlayInfoEntries = {
				{
					models = {
						displayTitle = @"hash_0",
						displayText = @"hash_3065631F4D4212EB",
	...
	sequenceEndFunc = function ( f9_arg0, f9_arg1 )
		...
		Engine[@"StorageWrite"]( f9_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMGauntletPlaylistIntroduction = {
	sequenceOverlays = {
		{
			overlayLayout = CoD.FTUEUtility.FTUELayouts.Entries1,
			overlayTitle = @"hash_5B09D4E74D55B35D",
			overlayInfoEntries = {
				{
					models = {
						displayTitle = @"hash_0",
	...
	sequenceEndFunc = function ( f10_arg0, f10_arg1 )
		...
		Engine[@"StorageWrite"]( f10_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMTutorialPlaylistIntroduction = {
	sequenceOverlays = {
		{
			overlayLayout = CoD.FTUEUtility.FTUELayouts.Entries1,
			overlayTitle = @"hash_4C79DDA4A0395229",
			overlayInfoEntries = {
				{
					models = {
						displayTitle = @"hash_0",
	...
	sequenceEndFunc = function ( f11_arg0, f11_arg1 )
		...
		Engine[@"StorageWrite"]( f11_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMCustomGameIntroduction = {
	...
	sequenceEndFunc = function ( f12_arg0, f12_arg1 )
		...
		Engine[@"StorageWrite"]( f12_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMLoadoutIntroduction = {
	...
	sequenceEndFunc = function ( f13_arg0, f13_arg1 )
		...
		Engine[@"StorageWrite"]( f13_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMArmoryIntroduction = {
	sequenceOverlays = {
		{
			overlayLayout = CoD.FTUEUtility.FTUELayouts.Entries1,
			overlayTitle = @"hash_7D6BF3A3749C31CD",
			overlayInfoEntries = {
				{
					models = {
						displayTitle = @"hash_0",
	...
	sequenceEndFunc = function ( f14_arg0, f14_arg1 )
		...
		Engine[@"StorageWrite"]( f14_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMLaboratoryIntroduction = {
	...
	sequenceEndFunc = function ( f15_arg0, f15_arg1 )
		...
		Engine[@"StorageWrite"]( f15_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.BlackMarketIntroduction = {
	sequenceOverlays = {
		{
			overlayLayout = CoD.FTUEUtility.FTUELayouts.Entries1,
			overlayTitle = @"hash_229C903C6DF90D6F",
			overlayInfoEntries = {
				{
					models = {
						displayTitle = @"hash_0",
	...
	sequenceEndFunc = function ( f16_arg0, f16_arg1 )
		...
		Engine[@"StorageWrite"]( f16_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
...
CoD.FTUEUtility.FTUESequences.ZMGestureChanges = {
	...
	sequenceEndFunc = function ( f18_arg0, f18_arg1 )
		...
		Engine[@"StorageWrite"]( f18_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.WeaponPersonalizationChanges = {
	...
	sequenceEndFunc = function ( f19_arg0, f19_arg1 )
		...
		Engine[@"StorageWrite"]( f19_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
...
CoD.FTUEUtility.FTUESequences.LeaguePlayIntroduction = {
	...
	sequenceEndFunc = function ( f21_arg0, f21_arg1 )
		...
		CoDLoadoutsShared[@"hash_7243F374ADEF72D"]( f21_arg1, Enum[@"StorageFileType"][@"hash_30067DF1879D992E"], @"hash_54FF2B60D157BBB2" ) --[[ @ 0]]
		CoDLoadoutsShared[@"hash_7243F374ADEF72D"]( f21_arg1, Enum[@"StorageFileType"][@"hash_CEBE62E27709AD0"], @"hash_54FF2B60D157BBB2" ) --[[ @ 0]]
		CoDLoadoutsShared[@"hash_7243F374ADEF72D"]( f21_arg1, Enum[@"StorageFileType"][@"hash_D062FA7B47FC13A"], @"hash_54FF2B60D157BBB2" ) --[[ @ 0]]
		Engine[@"StorageWrite"]( f21_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.BlackMarketSeasonThreeIntroduction = {
	...
	sequenceEndFunc = function ( f22_arg0, f22_arg1 )
		...
		Engine[@"StorageWrite"]( f22_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.BlackjackReservesIntroduction = {
	...
	sequenceEndFunc = function ( f23_arg0, f23_arg1 )
		...
		Engine[@"StorageWrite"]( f23_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.BlackjackShopIntroduction = {
	...
	sequenceEndFunc = function ( f24_arg0, f24_arg1 )
		...
		Engine[@"StorageWrite"]( f24_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.BlackMarketInventoryIntroduction = {
	...
	sequenceEndFunc = function ( f25_arg0, f25_arg1 )
		...
		Engine[@"StorageWrite"]( f25_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
	...
	sequenceEndFunc = function ( f26_arg0, f26_arg1 )
		...
		if f26_local0 then
			...
			while f26_local0[f26_local1] ~= nil do
				...
				if f26_local2 == @"hash_617848314938AB9" then
...
CoD.FTUEUtility.FTUESequences.PromoEvent = {
	...
	sequenceEndFunc = function ( f27_arg0, f27_arg1 )
		...
		Engine[@"StorageWrite"]( f27_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
...
CoD.FTUEUtility.FTUESequences.BlackMarketSunsetIntroduction = {
	...
	sequenceEndFunc = function ( f29_arg0, f29_arg1 )
		...
		Engine[@"StorageWrite"]( f29_arg1, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.WriteMPStats = function ( f30_arg0 )
	Engine[@"StorageWrite"]( f30_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.FTUEUtility.FTUESequences.ZMFactionCallingsIntroduction = {
	...
	sequenceEndFunc = function ( f31_arg0, f31_arg1 )
		...
		Engine[@"StorageWrite"]( f31_arg1, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	end
} --[[ @ 0]]
CoD.FTUEUtility.PlaySpecialistHQIntroductionMovie = function ( f32_arg0, f32_arg1 )
	...
	CoD.CTUtility.SetSeenMovie( f32_arg1, @"hash_7A8C599171B6CDE3" ) --[[ @ 0]]
...
CoD.FTUEUtility.FTUESequences.SpecialistHQIntroduction = {
	...
	sequenceEndFunc = function ( f34_arg0, f34_arg1 )
		...
		if not f34_local1 and f34_local0[@"hash_7C873FF231AABAE6"] ~= nil and f34_local0[@"hash_7C873FF231AABAE6"] ~= "" and CoD.CTUtility.CanPlayVideo( f34_arg1, f34_local0[@"hash_641FF0587D0A3B33"] ) then
			...
			CoD.CTUtility.SetSeenMovie( f34_arg1, @"hash_7A8C599171B6CDE3" ) --[[ @ 0]]
...
CoD.FTUEUtility.FTUEGameModeToSequence = {
	[Enum[@"eModes"][@"hash_383EBA96F36BC4E5"]] = "MPIntroduction",
	[Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"]] = "WZIntroduction",
	[Enum[@"eModes"][@"hash_73723205FAE52C4A"]] = "ZMIntroduction"
} --[[ @ 0]]
CoD.FTUEUtility.FTUESequenceToSequenceInfo = {
	ZMFeaturedPlaylistIntroduction = {
		gameMode = Enum[@"eModes"][@"hash_73723205FAE52C4A"],
	...
	WZProgressionInfo = {
		gameMode = Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"],
		statsVariable = "completedWZProgressionFirstTimeFlow",
		onlyShowForGivenMode = true
	},
	BlackMarketIntroduction = {
		gameMode = Enum[@"eModes"][@"hash_383EBA96F36BC4E5"],
...
local f0_local2 = {
	...
	title = LocalizeToUpperString( @"hash_79F837EEDFBB8117" ),
...
f0_local2[CoD.OverlayUtility.aCrossPromptFn] = function ( f39_arg0 )
 ...
 --[[ @ 0]]
f0_local2[CoD.OverlayUtility.aCrossPromptText] = @"hash_70DFD294FC69F682" --[[ @ 0]]
f0_local2[CoD.OverlayUtility.bCirclePromptFn] = function ( f41_arg0 )
 ...
 --[[ @ 0]]
f0_local2[CoD.OverlayUtility.bCirclePromptText] = @"hash_25C16E02B211A4F4" --[[ @ 0]]
...
CoD.FTUEUtility.SetCurrentSequenceThroughMode = function ( f45_arg0, f45_arg1, f45_arg2 )
	if not IsOnlineGame() then
		return false
	elseif f45_arg2 == Enum[@"eModes"][@"hash_73723205FAE52C4A"] and CoD.PCKoreaUtility.ShowKorea15Plus() then
		return false
	else
