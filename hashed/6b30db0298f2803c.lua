...
CoD.ui_icon_callingcards_crimewave_wheelspin02 = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ui_icon_callingcards_crimewave_wheelspin02.__defaultWidth = 40 --[[ @ 0]]
CoD.ui_icon_callingcards_crimewave_wheelspin02.__defaultHeight = 56 --[[ @ 0]]
CoD.ui_icon_callingcards_crimewave_wheelspin02.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ui_icon_callingcards_crimewave_wheelspin02 ) --[[ @ 0]]
	self.id = "ui_icon_callingcards_crimewave_wheelspin02" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local wheelspin1 = LUI.UIImage.new( 0, 0, 0, 40, 0, 0, 0, 56 ) --[[ @ 0]]
	wheelspin1:setImage( RegisterImage( @"uie_ui_menu_callingcards_crimewave_criminalcar_rearwheel1" ) ) --[[ @ 0]]
	self:addElement( wheelspin1 ) --[[ @ 0]]
	self.wheelspin1 = wheelspin1 --[[ @ 0]]
	
	local wheelspin2 = LUI.UIImage.new( 0, 0, 0, 40, 0, 0, 0, 56 ) --[[ @ 0]]
	wheelspin2:setImage( RegisterImage( @"uie_ui_menu_callingcards_crimewave_criminalcar_rearwheel2" ) ) --[[ @ 0]]
	self:addElement( wheelspin2 ) --[[ @ 0]]
	self.wheelspin2 = wheelspin2 --[[ @ 0]]
...
CoD.ui_icon_callingcards_crimewave_wheelspin02.__resetProperties = function ( f2_arg0 )
	f2_arg0.wheelspin2:completeAnimation() --[[ @ 0]]
	f2_arg0.wheelspin2:setAlpha( 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
		...
		DefaultClip = function ( f3_arg0, f3_arg1 )
			...
			local f3_local0 = function ( f4_arg0 )
				local f4_local0 = function ( f5_arg0 )
				 ...
				 --[[ @ 0]]
				f3_arg0.wheelspin2:beginAnimation( 100 ) --[[ @ 0]]
				f3_arg0.wheelspin2:setAlpha( 1 ) --[[ @ 0]]
				f3_arg0.wheelspin2:registerEventHandler( "interrupted_keyframe", f3_arg0.clipInterrupted ) --[[ @ 0]]
				f3_arg0.wheelspin2:registerEventHandler( "transition_complete_keyframe", f4_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f3_arg0.wheelspin2:completeAnimation() --[[ @ 0]]
			f3_arg0.wheelspin2:setAlpha( 0 ) --[[ @ 0]]
			f3_local0( f3_arg0.wheelspin2 ) --[[ @ 0]]
