...
CoD.BlackJacksShopFrameNoPreview = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.BlackJacksShopFrameNoPreview.__defaultWidth = 1920 --[[ @ 0]]
CoD.BlackJacksShopFrameNoPreview.__defaultHeight = 1080 --[[ @ 0]]
CoD.BlackJacksShopFrameNoPreview.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.BlackJacksShopFrameNoPreview ) --[[ @ 0]]
	self.id = "BlackJacksShopFrameNoPreview" --[[ @ 0]]
	...
	FeaturedSlot1:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot1, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot1, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot1, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_remove", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot1, f1_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], "MWHEELDOWN", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot1, f1_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], "MWHEELUP", function ( element, menu, controller, model )
		if not IsRepeatButtonPress( model ) then
	...
	FeaturedSlot1:subscribeToGlobalModel( f1_arg1, "GlobalModel", "ItemshopRotation.cycled", function ( model )
		local f21_local0 = FeaturedSlot1 --[[ @ 0]]
		if CoD.ModelUtility.IsGlobalModelValueTrue( "ItemshopRotation.cycled" ) then
			CoD.GridAndListUtility.UpdateDataSource( f21_local0, true, true, true ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	FeaturedSlot1:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_52FB29ED3A3CA79", function ( f22_arg0, f22_arg1, f22_arg2, f22_arg3 )
		if CoD.ModelUtility.IsSelfModelValueNonEmptyString( f22_arg0, f22_arg2, "movieName" ) then
			return function ( f23_arg0, f23_arg1, f23_arg2, f23_arg3 )
				SetControllerModelValue( f23_arg2, "LootStreamProgress.playAnimation", false ) --[[ @ 0]]
				CoD.VideoStreamingUtility.SetupVoDMovie( f23_arg2, f23_arg0, "" ) --[[ @ 0]]
	...
	FeaturedLabel:setText( LocalizeToUpperString( @"hash_F29BEFC80072FF5" ) ) --[[ @ 0]]
	FeaturedLabel:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	FeaturedLabel:setLetterSpacing( 4 ) --[[ @ 0]]
	FeaturedLabel:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	FeaturedLabel:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	FeaturedSlot2Timer:subscribeToGlobalModel( f1_arg1, "ItemshopRotation", "loot_itemshop_slot2_timer", function ( model )
		...
		if f24_local0 ~= nil then
			FeaturedSlot2Timer.TextBox2:setText( f24_local0 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	FeaturedSlot2:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	FeaturedSlot2:linkToElementModel( FeaturedSlot2, "movieName", true, function ( model, f25_arg1 )
		CoD.Menu.UpdateButtonShownState( f25_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f25_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	FeaturedSlot2:appendEventHandler( "input_source_changed", function ( f26_arg0, f26_arg1 )
		f26_arg1.menu = f26_arg1.menu or f1_arg0 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f26_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f26_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	SpecialOrders( FeaturedItemsBracket, SpecialOrdersLabel.LastInput, function ( f27_arg0, f27_arg1 )
		CoD.Menu.UpdateButtonShownState( f27_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f27_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	FeaturedSlot2:registerEventHandler( "occlusion_change", function ( element, event )
		...
		if element.OcclusionChange then
			f29_local0 = element:OcclusionChange( event ) --[[ @ 0]]
		elseif element.super.OcclusionChange then
			f29_local0 = element.super:OcclusionChange( event ) --[[ @ 0]]
		end
		if IsEventPropertyEqualTo( event, "occluded", false ) then
			CoD.BlackMarketUtility.TriggerItemShopRevealAnimation( f1_arg1, element ) --[[ @ 0]]
		end
		if not f29_local0 then
			f29_local0 = element:dispatchEventToChildren( event ) --[[ @ 0]]
		end
		return f29_local0
	end ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot2, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		CoD.BlackMarketUtility.PlayItemShopSelectSound( element, controller ) --[[ @ 0]]
		OpenOverlay( self, "ItemShopDetails", controller, {
			_model = element:getModel()
		} ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot2, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
		if CoD.ModelUtility.IsSelfModelValueNonEmptyString( element, controller, "movieName" ) and IsGamepad( controller ) then
			SetControllerModelValue( controller, "LootStreamProgress.playAnimation", false ) --[[ @ 0]]
			CoD.VideoStreamingUtility.SetupVoDMovie( controller, element, "" ) --[[ @ 0]]
			DelayOpenOverlay( menu, "VoDViewer", controller, {
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot2, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_remove", function ( element, menu, controller, model )
		if CoD.ModelUtility.IsSelfModelValueNonEmptyString( element, controller, "movieName" ) and IsMouseOrKeyboard( controller ) then
			SetControllerModelValue( controller, "LootStreamProgress.playAnimation", false ) --[[ @ 0]]
			CoD.VideoStreamingUtility.SetupVoDMovie( controller, element, "" ) --[[ @ 0]]
			DelayOpenOverlay( menu, "VoDViewer", controller, {
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot2, f1_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], "MWHEELDOWN", function ( element, menu, controller, model )
		if not IsRepeatButtonPress( model ) then
			CoD.GridAndListUtility.NavigateGridItemOnParentGridOrList( element, controller, true ) --[[ @ 0]]
			return true
		else
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedSlot2, f1_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], "MWHEELUP", function ( element, menu, controller, model )
		if not IsRepeatButtonPress( model ) then
			CoD.GridAndListUtility.NavigateGridItemOnParentGridOrList( element, controller, false ) --[[ @ 0]]
			return true
		else
	...
	FeaturedSlot2:subscribeToGlobalModel( f1_arg1, "GlobalModel", "ItemshopRotation.cycled", function ( model )
		local f43_local0 = FeaturedSlot2 --[[ @ 0]]
		if CoD.ModelUtility.IsGlobalModelValueTrue( "ItemshopRotation.cycled" ) then
			CoD.GridAndListUtility.UpdateDataSource( f43_local0, true, true, true ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	FeaturedSlot2:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_52FB29ED3A3CA79", function ( f44_arg0, f44_arg1, f44_arg2, f44_arg3 )
		if CoD.ModelUtility.IsSelfModelValueNonEmptyString( f44_arg0, f44_arg2, "movieName" ) then
			return function ( f45_arg0, f45_arg1, f45_arg2, f45_arg3 )
				SetControllerModelValue( f45_arg2, "LootStreamProgress.playAnimation", false ) --[[ @ 0]]
				CoD.VideoStreamingUtility.SetupVoDMovie( f45_arg2, f45_arg0, "" ) --[[ @ 0]]
	...
	SpecialOrders:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	SpecialOrders:linkToElementModel( SpecialOrders, "movieName", true, function ( model, f46_arg1 )
		CoD.Menu.UpdateButtonShownState( f46_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f46_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	SpecialOrders:appendEventHandler( "input_source_changed", function ( f47_arg0, f47_arg1 )
		f47_arg1.menu = f47_arg1.menu or f1_arg0 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f47_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f47_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	FeaturedItemsBracket( SpecialOrdersLabel, MyShopTimer.LastInput, function ( f48_arg0, f48_arg1 )
		CoD.Menu.UpdateButtonShownState( f48_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f48_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	SpecialOrders:registerEventHandler( "occlusion_change", function ( element, event )
		local f50_local0 = nil --[[ @ 0]]
		if element.OcclusionChange then
			f50_local0 = element:OcclusionChange( event ) --[[ @ 0]]
		elseif element.super.OcclusionChange then
			f50_local0 = element.super:OcclusionChange( event ) --[[ @ 0]]
		end
		if IsEventPropertyEqualTo( event, "occluded", false ) then
			CoD.BlackMarketUtility.TriggerItemShopRevealAnimation( f1_arg1, element ) --[[ @ 0]]
		end
		if not f50_local0 then
			f50_local0 = element:dispatchEventToChildren( event ) --[[ @ 0]]
		end
		return f50_local0
	end ) --[[ @ 0]]
	...
	SpecialOrders:registerEventHandler( "gain_focus", function ( element, event )
		...
		if element.gainFocus then
			f53_local0 = element:gainFocus( event ) --[[ @ 0]]
		elseif element.super.gainFocus then
			f53_local0 = element.super:gainFocus( event ) --[[ @ 0]]
		end
		CoD.Menu.UpdateButtonShownState( element, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( element, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( element, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( SpecialOrders, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		CoD.BlackMarketUtility.PlayItemShopSelectSound( element, controller ) --[[ @ 0]]
		SetControllerModelValue( controller, "LootStreamProgress.playAnimation", false ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( SpecialOrders, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
		if CoD.ModelUtility.IsSelfModelValueNonEmptyString( element, controller, "movieName" ) and IsGamepad( controller ) then
			SetControllerModelValue( controller, "LootStreamProgress.playAnimation", false ) --[[ @ 0]]
			CoD.VideoStreamingUtility.SetupVoDMovie( controller, element, "" ) --[[ @ 0]]
			DelayOpenOverlay( menu, "VoDViewer", controller, {
	...
	f1_arg0:AddButtonCallbackFunction( SpecialOrders, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_remove", function ( element, menu, controller, model )
		if CoD.ModelUtility.IsSelfModelValueNonEmptyString( element, controller, "movieName" ) and IsMouseOrKeyboard( controller ) then
			SetControllerModelValue( controller, "LootStreamProgress.playAnimation", false ) --[[ @ 0]]
			CoD.VideoStreamingUtility.SetupVoDMovie( controller, element, "" ) --[[ @ 0]]
			DelayOpenOverlay( menu, "VoDViewer", controller, {
	...
	f1_arg0:AddButtonCallbackFunction( SpecialOrders, f1_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], "MWHEELDOWN", function ( element, menu, controller, model )
		if not IsRepeatButtonPress( model ) then
			CoD.GridAndListUtility.NavigateGridItemOnParentGridOrList( element, controller, true ) --[[ @ 0]]
			return true
		else
	...
	f1_arg0:AddButtonCallbackFunction( SpecialOrders, f1_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], "MWHEELUP", function ( element, menu, controller, model )
		if not IsRepeatButtonPress( model ) then
			CoD.GridAndListUtility.NavigateGridItemOnParentGridOrList( element, controller, false ) --[[ @ 0]]
			return true
		else
	...
	SpecialOrders:subscribeToGlobalModel( f1_arg1, "GlobalModel", "ItemshopRotation.cycled", function ( model )
		local f64_local0 = SpecialOrders --[[ @ 0]]
		if CoD.ModelUtility.IsGlobalModelValueTrue( "ItemshopRotation.cycled" ) then
			CoD.GridAndListUtility.UpdateDataSource( f64_local0, true, true, true ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	SpecialOrders:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_52FB29ED3A3CA79", function ( f65_arg0, f65_arg1, f65_arg2, f65_arg3 )
		if CoD.ModelUtility.IsSelfModelValueNonEmptyString( f65_arg0, f65_arg2, "movieName" ) then
			return function ( f66_arg0, f66_arg1, f66_arg2, f66_arg3 )
				SetControllerModelValue( f66_arg2, "LootStreamProgress.playAnimation", false ) --[[ @ 0]]
				CoD.VideoStreamingUtility.SetupVoDMovie( f66_arg2, f66_arg0, "" ) --[[ @ 0]]
	...
	SpecialOrdersLabel:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	SpecialOrdersLabel:setAlignment( Enum[@"LUIAlignment"][@"hash_670510683C22104B"] ) --[[ @ 0]]
	...
	MyShopTimer:subscribeToGlobalModel( f1_arg1, "ItemshopRotation", "loot_itemshop_slot4_timer", function ( model )
		...
		if f67_local0 ~= nil then
			MyShopTimer.TextBox2:setText( f67_local0 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	SpecialOrdersTimer:subscribeToGlobalModel( f1_arg1, "ItemshopRotation", "loot_itemshop_slot3_timer", function ( model )
		local f68_local0 = model:get() --[[ @ 0]]
		if f68_local0 ~= nil then
			SpecialOrdersTimer.TextBox2:setText( f68_local0 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	MyShop:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	MyShop:linkToElementModel( MyShop, "lootType", true, function ( model, f69_arg1 )
		CoD.Menu.UpdateButtonShownState( f69_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	MyShop:registerEventHandler( "list_item_lose_focus", function ( element, event )
		local f70_local0 = nil --[[ @ 0]]
	...
	MyShop:registerEventHandler( "occlusion_change", function ( element, event )
		...
		if element.OcclusionChange then
			f71_local0 = element:OcclusionChange( event ) --[[ @ 0]]
		elseif element.super.OcclusionChange then
			f71_local0 = element.super:OcclusionChange( event ) --[[ @ 0]]
		end
		if IsEventPropertyEqualTo( event, "occluded", false ) then
			CoD.BlackMarketUtility.TriggerItemShopRevealAnimation( f1_arg1, element ) --[[ @ 0]]
		...
		if not f71_local0 then
			f71_local0 = element:dispatchEventToChildren( event ) --[[ @ 0]]
		end
		return f71_local0
	end ) --[[ @ 0]]
	...
	MyShop:registerEventHandler( "gain_focus", function ( element, event )
		...
		if element.gainFocus then
			f73_local0 = element:gainFocus( event ) --[[ @ 0]]
		elseif element.super.gainFocus then
			f73_local0 = element.super:gainFocus( event ) --[[ @ 0]]
		end
		CoD.Menu.UpdateButtonShownState( element, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( element, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( element, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( MyShop, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( MyShop, f1_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], "MWHEELDOWN", function ( element, menu, controller, model )
		if not IsRepeatButtonPress( model ) then
			CoD.GridAndListUtility.NavigateGridItemOnParentGridOrList( element, controller, true ) --[[ @ 0]]
			return true
		else
	...
	f1_arg0:AddButtonCallbackFunction( MyShop, f1_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], "MWHEELUP", function ( element, menu, controller, model )
		if not IsRepeatButtonPress( model ) then
			CoD.GridAndListUtility.NavigateGridItemOnParentGridOrList( element, controller, false ) --[[ @ 0]]
			return true
		else
	...
	MyShopLabel:setText( LocalizeToUpperString( @"hash_25DAEFC4C9B0A8FA" ) ) --[[ @ 0]]
	...
	MyShopLabel:setAlignment( Enum[@"LUIAlignment"][@"hash_670510683C22104B"] ) --[[ @ 0]]
	...
	TransactionDeepLinkButton:registerEventHandler( "gain_focus", function ( element, event )
		local f82_local0 = nil --[[ @ 0]]
		if element.gainFocus then
			f82_local0 = element:gainFocus( event ) --[[ @ 0]]
		elseif element.super.gainFocus then
			f82_local0 = element.super:gainFocus( event ) --[[ @ 0]]
		end
	...
	self:appendEventHandler( "input_source_changed", function ( f91_arg0, f91_arg1 )
		f91_arg1.menu = f91_arg1.menu or f1_arg0 --[[ @ 0]]
		f1_arg0:updateElementState( self, f91_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	CoD.BlackMarketUtility.ChangeSupplyChainCameraBySelection( f1_arg0, f1_arg1, f1_local19 ) --[[ @ 0]]
	f1_local19 = FeaturedSlot1 --[[ @ 0]]
	CoD.BaseUtility.DisableNavigation( f1_local19 ) --[[ @ 0]]
	SetElementProperty( f1_local19, "__loopOnSameRow", true ) --[[ @ 0]]
	SetElementProperty( f1_local19, "__allowCreateOnLoop", true ) --[[ @ 0]]
	CoD.BlackMarketUtility.InitialHideScrollPrompts( self, f1_arg1, f1_local19 ) --[[ @ 0]]
	CoD.BlackMarketUtility.ShopCycleThroughItems( f1_arg0, f1_arg1, f1_local19, 0.5 ) --[[ @ 0]]
	f1_local19 = FeaturedSlot2 --[[ @ 0]]
	CoD.BaseUtility.DisableNavigation( f1_local19 ) --[[ @ 0]]
	SetElementProperty( f1_local19, "__loopOnSameRow", true ) --[[ @ 0]]
	SetElementProperty( f1_local19, "__allowCreateOnLoop", true ) --[[ @ 0]]
	CoD.BlackMarketUtility.InitialHideScrollPrompts( self, f1_arg1, f1_local19 ) --[[ @ 0]]
	CoD.BlackMarketUtility.ShopCycleThroughItems( f1_arg0, f1_arg1, f1_local19, 0.5 ) --[[ @ 0]]
	f1_local19 = SpecialOrders --[[ @ 0]]
	CoD.BaseUtility.DisableNavigation( f1_local19 ) --[[ @ 0]]
	SetElementProperty( f1_local19, "__loopOnSameRow", true ) --[[ @ 0]]
	SetElementProperty( f1_local19, "__allowCreateOnLoop", true ) --[[ @ 0]]
	CoD.BlackMarketUtility.InitialHideScrollPrompts( self, f1_arg1, f1_local19 ) --[[ @ 0]]
...
CoD.BlackJacksShopFrameNoPreview.__resetProperties = function ( f94_arg0 )
	f94_arg0.MyShop:completeAnimation() --[[ @ 0]]
	f94_arg0.SpecialOrders:completeAnimation() --[[ @ 0]]
	f94_arg0.FeaturedSlot2:completeAnimation() --[[ @ 0]]
	f94_arg0.FeaturedSlot1:completeAnimation() --[[ @ 0]]
	f94_arg0.MyShop:setHorizontalCounter( CoD.horizontalCounterTriggerPrompts ) --[[ @ 0]]
	f94_arg0.SpecialOrders:setHorizontalCounter( CoD.horizontalCounterTriggerPrompts ) --[[ @ 0]]
	f94_arg0.FeaturedSlot2:setHorizontalCounter( CoD.horizontalCounterTriggerPrompts ) --[[ @ 0]]
	f94_arg0.FeaturedSlot1:setHorizontalCounter( CoD.horizontalCounterTriggerPrompts ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.BlackJacksShopFrameNoPreview.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f95_arg0, f95_arg1 )
			...
			f95_arg0:setupElementClipCounter( 0 ) --[[ @ 0]]
		end
	},
	KBM = {
		DefaultClip = function ( f96_arg0, f96_arg1 )
			...
			f96_arg0.FeaturedSlot1:completeAnimation() --[[ @ 0]]
			f96_arg0.FeaturedSlot1:setHorizontalCounter( CoD.horizontalCounter ) --[[ @ 0]]
			f96_arg0.clipFinished( f96_arg0.FeaturedSlot1 ) --[[ @ 0]]
			f96_arg0.FeaturedSlot2:completeAnimation() --[[ @ 0]]
			f96_arg0.FeaturedSlot2:setHorizontalCounter( CoD.horizontalCounter ) --[[ @ 0]]
			f96_arg0.clipFinished( f96_arg0.FeaturedSlot2 ) --[[ @ 0]]
			f96_arg0.SpecialOrders:completeAnimation() --[[ @ 0]]
			f96_arg0.SpecialOrders:setHorizontalCounter( CoD.horizontalCounter ) --[[ @ 0]]
			f96_arg0.clipFinished( f96_arg0.SpecialOrders ) --[[ @ 0]]
			f96_arg0.MyShop:completeAnimation() --[[ @ 0]]
			f96_arg0.MyShop:setHorizontalCounter( CoD.horizontalCounter ) --[[ @ 0]]
			f96_arg0.clipFinished( f96_arg0.MyShop ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.BlackJacksShopFrameNoPreview.__onClose = function ( f97_arg0 )
	f97_arg0.FeaturedSlot1Timer:close() --[[ @ 0]]
	f97_arg0.FeaturedSlot1:close() --[[ @ 0]]
	f97_arg0.FeaturedSlot2Timer:close() --[[ @ 0]]
	f97_arg0.FeaturedSlot2:close() --[[ @ 0]]
	f97_arg0.SpecialOrders:close() --[[ @ 0]]
	f97_arg0.MyShopTimer:close() --[[ @ 0]]
	f97_arg0.SpecialOrdersTimer:close() --[[ @ 0]]
	f97_arg0.MyShop:close() --[[ @ 0]]
	f97_arg0.TransactionDeepLinkButton:close() --[[ @ 0]]
	f97_arg0.DiscountTiersWidget:close() --[[ @ 0]]
end
 --[[ @ 0]]
