...
LUI.createMenu.ChooseSpecialistMidMatch = function ( f1_arg0, f1_arg1 )
	...
	SignatureAbility( SignatureEquipment, ChangeClassButton["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_534C7B2375D2D47"]], function ( f9_arg0 )
		f1_local1:updateElementState( Characters, {
			name = "model_validation",
			menu = f1_local1,
			controller = f1_arg0,
	...
	f1_local1:AddButtonCallbackFunction( ChangeClassButton, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
