							...
							if not f6_local0 then
								if Engine[@"isvisibilitybitset"]( f1_arg0, Enum[@"uivisibilitybit"][@"bit_hud_visible"] ) then
									...
									if not f6_local0 then
										...
										if not f6_local0 then
											f6_local0 = Engine[@"isvisibilitybitset"]( f1_arg0, Enum[@"uivisibilitybit"][@"bit_nemesis_killcam"] ) --[[ @ 0]]
											if not f6_local0 then
												...
												if not f6_local0 then
													...
													if not f6_local0 then
														f6_local0 = Engine[@"isvisibilitybitset"]( f1_arg0, Enum[@"uivisibilitybit"][@"bit_scoreboard_open"] ) --[[ @ 0]]
														if not f6_local0 then
															f6_local0 = Engine[@"isvisibilitybitset"]( f1_arg0, Enum[@"uivisibilitybit"][@"bit_stage_ended"] ) --[[ @ 0]]
															if not f6_local0 then
																f6_local0 = Engine[@"isvisibilitybitset"]( f1_arg0, Enum[@"uivisibilitybit"][@"bit_ui_active"] ) --[[ @ 0]]
																if not f6_local0 then
																	f6_local0 = not Engine[@"isvisibilitybitset"]( f1_arg0, Enum[@"uivisibilitybit"][@"bit_weapon_hud_visible"] ) --[[ @ 0]]
																end
															end
														end
													end
	...
	DefaultState = {
		DefaultClip = function ( f27_arg0, f27_arg1 )
			...
			local f27_local0 = function ( f28_arg0 )
				f27_arg0.DecorativeBGAnim:beginAnimation( 200, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
			...
			local f27_local2 = function ( f31_arg0 )
				local f31_local0 = function ( f32_arg0 )
					f32_arg0:beginAnimation( 200, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
	...
	Revive = {
		DefaultClip = function ( f38_arg0, f38_arg1 )
			...
			local f38_local0 = function ( f39_arg0 )
				f38_arg0.ReviveBarBG2:beginAnimation( 200, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
			...
			local f38_local1 = function ( f40_arg0 )
				f38_arg0.revive_bar:beginAnimation( 200, Enum[@"luitween"][@"luitween_ease_both"] ) --[[ @ 0]]
