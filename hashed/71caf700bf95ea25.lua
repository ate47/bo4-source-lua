...
CoD.PlayerWidget_ZM.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	ScoreShadow:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	self:mergeStateConditions( {
		...
		},
		{
			stateName = "Hidden",
			condition = function ( menu, element, event )
				local f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_4B8E9B69F4B87954"] ) --[[ @ 0]]
				if not f12_local0 then
					f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_5D3ABF9A2753CE40"] ) --[[ @ 0]]
					if not f12_local0 then
						f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_59333FC97F7870"] ) --[[ @ 0]]
						if not f12_local0 then
							f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"] ) --[[ @ 0]]
							if not f12_local0 then
								if Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_7ADC477DDE486DD7"] ) then
									f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_523CD9BAB9B9F4C8"] ) --[[ @ 0]]
									if not f12_local0 then
										f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_47B52A87BC9AA4C7"] ) --[[ @ 0]]
										if not f12_local0 then
											f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_6668F0686232679"] ) --[[ @ 0]]
											if not f12_local0 then
												f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_33AEEAA452536E6E"] ) --[[ @ 0]]
												if not f12_local0 then
													f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_1D298E43D0B6FEF2"] ) --[[ @ 0]]
													if not f12_local0 then
														f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"] ) --[[ @ 0]]
														if not f12_local0 then
															f12_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_2A69E34E231CE8B6"] ) --[[ @ 0]]
														end
													end
												end
											end
	...
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4B8E9B69F4B87954"]], function ( f13_arg0 )
	...
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5D3ABF9A2753CE40"]], function ( f14_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_59333FC97F7870"]], function ( f15_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"]], function ( f16_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_7ADC477DDE486DD7"]], function ( f17_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_523CD9BAB9B9F4C8"]], function ( f18_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_47B52A87BC9AA4C7"]], function ( f19_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_6668F0686232679"]], function ( f20_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_33AEEAA452536E6E"]], function ( f21_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_1D298E43D0B6FEF2"]], function ( f22_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"]], function ( f23_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local13 = self.subscribeToModel --[[ @ 0]]
	f1_local14 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local13( f1_local12, f1_local14["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_2A69E34E231CE8B6"]], function ( f24_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
