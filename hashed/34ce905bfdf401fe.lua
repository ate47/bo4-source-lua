...
LUI.createMenu.FTUEZMInventoryMenu = function ( f1_arg0, f1_arg1 )
	...
	ElixirInfo.InventoryTitleLabel:setText( LocalizeToUpperString( @"menu/elixirs" ) ) --[[ @ 0]]
	...
	PerksInfo.InventoryTitleLabel:setText( LocalizeToUpperString( @"menu/perks" ) ) --[[ @ 0]]
	...
	EquipmentInfo.InventoryTitleLabel:setText( LocalizeToUpperString( @"menu/equipment" ) ) --[[ @ 0]]
	...
	StartingWeaponInfo.InventoryTitleLabel:setText( LocalizeToUpperString( @"menu/starting_weapon" ) ) --[[ @ 0]]
