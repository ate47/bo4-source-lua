...
CoD.ScoreboardMapWZInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_local20( f1_local19, f1_local21["hudItems.waypointStatus"], function ( f5_arg0, f5_arg1 )
		CoD.Menu.UpdateButtonShownState( f5_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_249A252B20B48936"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f5_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	self:appendEventHandler( "deadSpectator.playerIndex", function ( f6_arg0, f6_arg1 )
		f6_arg1.menu = f6_arg1.menu or f1_arg0 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f6_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_249A252B20B48936"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f6_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:appendEventHandler( "input_source_changed", function ( f7_arg0, f7_arg1 )
		f7_arg1.menu = f7_arg1.menu or f1_arg0 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f7_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_249A252B20B48936"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f7_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local19 = self --[[ @ 0]]
	...
	f1_local20( f1_local19, f1_local21.LastInput, function ( f8_arg0, f8_arg1 )
		CoD.Menu.UpdateButtonShownState( f8_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_249A252B20B48936"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f8_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_arg0:AddButtonCallbackFunction( self, f1_arg1, Enum[@"LUIButton"][@"hash_249A252B20B48936"], "MOUSE1", function ( element, menu, controller, model )
		...
		if not CoD.ModelUtility.IsModelValueEqualToEnum( controller, "hudItems.waypointStatus", CoD.WZUtility.WaypointStatus.POST_PLACEMENT_DELAY ) and not CoD.ModelUtility.IsModelValueEqualToEnum( controller, "hudItems.waypointStatus", CoD.WZUtility.WaypointStatus.POST_DELETION_DELAY ) and not CoD.WZUtility.IsControllerDeadAndNotRespawning( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_249A252B20B48936"], @"hash_0", nil, "MOUSE1" ) --[[ @ 0]]
			return false
		elseif not CoD.WZUtility.IsControllerDeadAndNotRespawning( controller ) and IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_249A252B20B48936"], @"hash_0", nil, "MOUSE1" ) --[[ @ 0]]
			return false
	...
	f1_arg0:AddButtonCallbackFunction( self, f1_arg1, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"], "MOUSE3", function ( element, menu, controller, model )
		...
		if CoD.ModelUtility.IsModelValueEqualToEnum( controller, "hudItems.waypointStatus", CoD.WZUtility.WaypointStatus.ALLOW_DELETION ) and not CoD.WZUtility.IsControllerDeadAndNotRespawning( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"], @"hash_0", nil, "MOUSE3" ) --[[ @ 0]]
			return false
		elseif not CoD.WZUtility.IsControllerDeadAndNotRespawning( controller ) and IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"], @"hash_0", nil, "MOUSE3" ) --[[ @ 0]]
			return false
	...
	f1_arg0:AddButtonCallbackFunction( self, f1_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], "MWHEELDOWN", function ( element, menu, controller, model )
		CoD.WZUtility.ZoomMap( controller, false, self.ScoreboardGameStatusMap ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], @"hash_0", nil, "MWHEELDOWN" ) --[[ @ 0]]
		return false
	end, false ) --[[ @ 0]]
	f1_arg0:AddButtonCallbackFunction( self, f1_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], "MWHEELUP", function ( element, menu, controller, model )
		CoD.WZUtility.ZoomMap( controller, true, self.ScoreboardGameStatusMap ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], @"hash_0", nil, "MWHEELUP" ) --[[ @ 0]]
		return false
	end, false ) --[[ @ 0]]
