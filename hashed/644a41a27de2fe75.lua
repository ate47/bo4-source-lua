...
CoD.CompassAwarenessRingSegment.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	Inner:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return CoD.ModelUtility.IsSelfModelValueBitSet( element, f1_arg1, "segmentValue", CoD.HUDUtility.AwarenessLevels.AWARENESS_LEVEL_INNER_BIT ) and IsVisibilityBitSet( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_50F0EF20BB6FB88F"] )
			end
		},
		{
	...
	Outer( f1_local2, f1_local4["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_50F0EF20BB6FB88F"]], function ( f6_arg0 )
		f1_arg0:updateElementState( Inner, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	Outer:mergeStateConditions( {
		{
			stateName = "Detect_CUAV",
			condition = function ( menu, element, event )
				return CoD.ModelUtility.IsSelfModelValueBitSet( element, f1_arg1, "segmentValue", CoD.HUDUtility.AwarenessLevels.AWARENESS_LEVEL_OUTER_BIT ) and IsVisibilityBitSet( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_50F0EF20BB6FB88F"] )
			end
		},
		{
			stateName = "Detect_Jammed",
	...
	f1_local2( f1_local4, f1_local5["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_50F0EF20BB6FB88F"]], function ( f13_arg0 )
		f1_arg0:updateElementState( Outer, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
