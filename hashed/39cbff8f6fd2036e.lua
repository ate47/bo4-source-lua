...
CoD.StartMenu_Personalization_MP.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( specialists, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], "ui_contextual_1", function ( element, menu, controller, model )
		...
		if not CoD.PlayerRoleUtility.IsSelectedShowcaseCharacter( element, controller ) and CoD.PlayerRoleUtility.CanSetAsShowcaseCharacter( controller, element ) and IsGamepad( controller ) then
			...
			return false
		elseif not CoD.PlayerRoleUtility.IsSelectedShowcaseCharacter( element, controller ) and IsMouseOrKeyboard( controller ) and CoD.PlayerRoleUtility.CanSetAsShowcaseCharacter( controller, element ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], @"hash_20E14BE8E7A50BA2", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"], "ui_contextual_1" ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	specialists:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_20E14BE8E7A50BA2", function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
	...
	f1_local15( f1_local14, f1_local16.breadcrumbCount, function ( f38_arg0, f38_arg1 )
		CoD.Menu.UpdateButtonShownState( f38_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_229E5695FF1401AD"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
