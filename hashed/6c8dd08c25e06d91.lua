...
CoD.Waypoint_ZmTrialArcade.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f34_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_11CDCB451655ABCF"] ) --[[ @ 0]]
				if not f34_local0 then
					f34_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"] ) --[[ @ 0]]
					if not f34_local0 then
						f34_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"] ) --[[ @ 0]]
						if not f34_local0 then
							f34_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_5A77EB9347BE4DFF"] ) --[[ @ 0]]
							if not f34_local0 then
								f34_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"] ) --[[ @ 0]]
								if not f34_local0 then
									f34_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_534C7B2375D2D47"] ) --[[ @ 0]]
									if not f34_local0 then
										f34_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_54828BED794DA0A5"] ) --[[ @ 0]]
										if not f34_local0 then
											f34_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_11E59914E91E423A"] ) --[[ @ 0]]
										end
									end
								end
							end
	...
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_11CDCB451655ABCF"]], function ( f39_arg0 )
	...
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"]], function ( f40_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f41_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5A77EB9347BE4DFF"]], function ( f42_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f43_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_534C7B2375D2D47"]], function ( f44_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_54828BED794DA0A5"]], function ( f45_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_11E59914E91E423A"]], function ( f46_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"]], function ( f59_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_7ADC477DDE486DD7"]], function ( f60_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_59333FC97F7870"]], function ( f61_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_1C630DB86D235A5"]], function ( f62_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
