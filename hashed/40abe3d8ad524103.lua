...
CoD.systemOverlay_DeleteEmblemFrame = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.systemOverlay_DeleteEmblemFrame.__defaultWidth = 1920 --[[ @ 0]]
CoD.systemOverlay_DeleteEmblemFrame.__defaultHeight = 290 --[[ @ 0]]
CoD.systemOverlay_DeleteEmblemFrame.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.systemOverlay_DeleteEmblemFrame ) --[[ @ 0]]
	self.id = "systemOverlay_DeleteEmblemFrame" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	self.onlyChildrenFocusable = true --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local emblem = LUI.UIElement.new( 0, 0, 366, 606, 0.5, 0.5, -115, 125 ) --[[ @ 0]]
	emblem:setupEmblem( 2 ) --[[ @ 0]]
	self:addElement( emblem ) --[[ @ 0]]
	self.emblem = emblem --[[ @ 0]]
	
	local Frame = CoD.StartMenuOptionsMainFrame.new( f1_arg0, f1_arg1, 0, 0, 356, 616, 0.5, 0.5, -125, 135 ) --[[ @ 0]]
	...
	local text = CoD.systemOverlay_Layout_ForegroundMultilineText.new( f1_arg0, f1_arg1, 0.5, 0.5, -324, 948, 0, 0, 58.5, 88.5 ) --[[ @ 0]]
	...
	text:linkToElementModel( self, "description", true, function ( model )
		...
		if f2_local0 ~= nil then
			text.text:setText( CoD.BaseUtility.LocalizeIfXHash( f2_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
...
CoD.systemOverlay_DeleteEmblemFrame.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f16_arg0, f16_arg1 )
			...
			f16_arg0.options:setAlpha( 0 ) --[[ @ 0]]
			f16_arg0.clipFinished( f16_arg0.options ) --[[ @ 0]]
		end
	},
	PC = {
