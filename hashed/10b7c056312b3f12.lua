...
CoD.CodCasterButtonPromptContainer = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.CodCasterButtonPromptContainer.__defaultWidth = 264 --[[ @ 0]]
CoD.CodCasterButtonPromptContainer.__defaultHeight = 38 --[[ @ 0]]
CoD.CodCasterButtonPromptContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.CodCasterButtonPromptContainer ) --[[ @ 0]]
	self.id = "CodCasterButtonPromptContainer" --[[ @ 0]]
	...
	Prompt:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f2_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "", Enum[@"luibuttonpromptstates"][@"flag_enable_prompts"] ) --[[ @ 0]]
				if f2_local0 then
	...
	local f1_local2 = Prompt --[[ @ 0]]
	local Text = Prompt.subscribeToModel --[[ @ 0]]
	...
	f1_local2 = Prompt --[[ @ 0]]
	Text = Prompt.subscribeToModel --[[ @ 0]]
	...
	Text = LUI.UIText.new( 0, 0, 160, 326, 0.5, 0.5, -8, 8 ) --[[ @ 0]]
...
CoD.CodCasterButtonPromptContainer.__clipsPerState = {
	...
	Hidden = {
		DefaultClip = function ( f14_arg0, f14_arg1 )
			...
			f14_arg0.clipFinished( f14_arg0.Prompt ) --[[ @ 0]]
