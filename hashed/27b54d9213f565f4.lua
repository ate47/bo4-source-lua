...
CoD.CodCasterLoadoutSelectionSpec = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.CodCasterLoadoutSelectionSpec.__defaultWidth = 60 --[[ @ 0]]
CoD.CodCasterLoadoutSelectionSpec.__defaultHeight = 60 --[[ @ 0]]
CoD.CodCasterLoadoutSelectionSpec.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.CodCasterLoadoutSelectionSpec ) --[[ @ 0]]
	self.id = "CodCasterLoadoutSelectionSpec" --[[ @ 0]]
	self.soundSet = "none" --[[ @ 0]]
	
	local Center = LUI.UIImage.new( 0.5, 0.5, -58.5, 58.5, 0.5, 0.5, -58.5, 58.5 ) --[[ @ 0]]
	Center:setRGB( ColorSet.T8__BIEGE.r, ColorSet.T8__BIEGE.g, ColorSet.T8__BIEGE.b ) --[[ @ 0]]
	Center:setAlpha( 0.8 ) --[[ @ 0]]
	Center:setImage( RegisterImage( @"hash_7BE763D1EB16049A" ) ) --[[ @ 0]]
	self:addElement( Center ) --[[ @ 0]]
	self.Center = Center --[[ @ 0]]
	
	local ItemName = LUI.UIText.new( 0.5, 0.5, -85.5, 85.5, 0, 0, -57.5, -36.5 ) --[[ @ 0]]
