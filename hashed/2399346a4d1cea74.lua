...
LUI.createMenu.DemoFileshareUpload = function ( f1_arg0, f1_arg1 )
	...
	if IsPC() then
		SetGlobalModelValueArg( "fileshareRoot.uploadTask.state", Enum[@"FileshareTaskUIState"][@"hash_53D25EE7E8459854"] ) --[[ @ 0]]
	...
	TitleDescription:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_1A2AC7D3118B5303" ) ) --[[ @ 0]]
	TitleDescription:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	TitleDescription:setLetterSpacing( 2 ) --[[ @ 0]]
	TitleDescription:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	TitleDescription:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( ButtonSave2, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ENTER", function ( element, menu, controller, model )
	...
	LUI.OverrideFunction_CallOriginalFirst( TitleTextBox, "childFocusLost", function ( element )
		if CoD.ModelUtility.IsControllerModelValueNonEmptyString( f1_arg0, "DemoTitleText" ) and CoD.FileshareUtility.IsCurrentCategoryEqualToValue( "clip_private" ) then
			...
			CoD.DemoUtility.SaveFileProperty( element, Enum[@"hash_EAFC1D0E771FFBD"][@"hash_11AFC54394039B37"] ) --[[ @ 0]]
		elseif CoD.ModelUtility.IsControllerModelValueNonEmptyString( f1_arg0, "DemoTitleText" ) and CoD.FileshareUtility.IsCurrentCategoryEqualToValue( "screenshot_private" ) then
			SetElementState( self, element, f1_arg0, "DefaultState" ) --[[ @ 0]]
			CoD.DemoUtility.SaveFileProperty( element, Enum[@"hash_EAFC1D0E771FFBD"][@"hash_6DC6FC8F34BABFED"] ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	LUI.OverrideFunction_CallOriginalFirst( DescTextBox, "childFocusLost", function ( element )
		if CoD.ModelUtility.IsControllerModelValueNonEmptyString( f1_arg0, "DemoDescText" ) and CoD.FileshareUtility.IsCurrentCategoryEqualToValue( "clip_private" ) then
			SetElementState( self, element, f1_arg0, "DefaultState" ) --[[ @ 0]]
			CoD.DemoUtility.SaveFileProperty( element, Enum[@"hash_EAFC1D0E771FFBD"][@"hash_F7E8D387D538B81"] ) --[[ @ 0]]
		elseif CoD.ModelUtility.IsControllerModelValueNonEmptyString( f1_arg0, "DemoDescText" ) and CoD.FileshareUtility.IsCurrentCategoryEqualToValue( "screenshot_private" ) then
			SetElementState( self, element, f1_arg0, "DefaultState" ) --[[ @ 0]]
			CoD.DemoUtility.SaveFileProperty( element, Enum[@"hash_EAFC1D0E771FFBD"][@"hash_6AD19AFB06C8E3D3"] ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], nil, function ( element, menu, controller, model )
		...
		if CoD.FileshareUtility.AreSlotsFull( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], @"hash_5A9A7F1FDCC1803E", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	self:subscribeToGlobalModel( f1_arg0, "GlobalModel", "fileshareRoot.uploadTask.state", function ( model )
		...
		if CoD.ModelUtility.IsGlobalModelValueEqualToEnum( "fileshareRoot.uploadTask.state", Enum[@"FileshareTaskUIState"][@"hash_6FE5B3BE5B00EEEA"] ) then
		...
		elseif CoD.ModelUtility.IsGlobalModelValueEqualToEnum( "fileshareRoot.uploadTask.state", Enum[@"FileshareTaskUIState"][@"hash_2B49C044708FBA4"] ) then
	...
	if IsPC() then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput( f1_local1, f1_arg0, f1_local17, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"] ) --[[ @ 0]]
	end
...
CoD.DemoFileshareUpload.__resetProperties = function ( f39_arg0 )
	...
	f39_arg0.FullscreenPopupTemplate.DoneTitle:setText( LocalizeToUpperString( @"hash_393E719493E9E18F" ) ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.DemoFileshareUpload.__clipsPerState = {
	...
	Fetching = {
		DefaultClip = function ( f42_arg0, f42_arg1 )
			...
			f42_arg0.FullscreenPopupTemplate.WorkingTitle:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_17525250556C866C" ) ) --[[ @ 0]]
			f42_arg0.FullscreenPopupTemplate.Title:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_17525250556C866C" ) ) --[[ @ 0]]
