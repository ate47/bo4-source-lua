...
CoD.PaintjobSelector.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	paintjobsList:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	paintjobsList:appendEventHandler( "input_source_changed", function ( f5_arg0, f5_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f5_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_222361E23588705A"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( paintjobsList, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( paintjobsList, f1_arg1, Enum[@"LUIButton"][@"hash_222361E23588705A"], "ui_contextual_2", function ( element, menu, controller, model )
		...
		if Paintjobs_IsOccupied( element, controller ) and not IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_222361E23588705A"], @"hash_1543AEFED5923E39", nil, "ui_contextual_2" ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	paintjobsList:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_68ADA48E694BFE2C", function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
	...
	paintjobsList:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_5AEC3D591F4359E", function ( f15_arg0, f15_arg1, f15_arg2, f15_arg3 )
	...
	paintjobsList:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1543AEFED5923E39", function ( f17_arg0, f17_arg1, f17_arg2, f17_arg3 )
