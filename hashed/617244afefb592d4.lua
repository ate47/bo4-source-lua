...
CoD.StartMenu_Inventory_CurrentWeaponPC.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( CurrentWeaponVignette, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "MOUSE3", function ( element, menu, controller, model )
		...
		if CoD.ModelUtility.IsGlobalDataSourceModelValueEqualTo( controller, "WarzoneInventory", "currentWeaponIndex", 0 ) and CoD.ModelUtility.IsGlobalDataSourceModelValueEqualTo( controller, "WarzoneInventory", "weapon0.hasAttachments", 1 ) and CoD.WZUtility.ScoreboardVisibilitySetAndPC( controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], @"hash_294D6AF2F50BEFEF", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"], "MOUSE3" ) --[[ @ 0]]
			return true
		elseif CoD.ModelUtility.IsGlobalDataSourceModelValueEqualTo( controller, "WarzoneInventory", "currentWeaponIndex", 1 ) and CoD.ModelUtility.IsGlobalDataSourceModelValueEqualTo( controller, "WarzoneInventory", "weapon1.hasAttachments", 1 ) and CoD.WZUtility.ScoreboardVisibilitySetAndPC( controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], @"hash_294D6AF2F50BEFEF", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"], "MOUSE3" ) --[[ @ 0]]
			return true
	...
	HeaderWeapon2( GamepadText, SwitchWeaponImage["weapon0.hasAttachments"], function ( f18_arg0, f18_arg1 )
		CoD.Menu.UpdateButtonShownState( f18_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( HeaderWeapon, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( HeaderWeapon, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "ui_remove", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( HeaderWeapon, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "F", function ( element, menu, controller, model )
	...
	HeaderWeapon:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_2FFD03BF8361AC75", function ( f26_arg0, f26_arg1, f26_arg2, f26_arg3 )
	...
	HeaderWeapon2.HeaderWeapon:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D3125BD606CC1" ) ) --[[ @ 0]]
	HeaderWeapon2.HeaderWeaponAsian:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D3125BD606CC1" ) ) --[[ @ 0]]
	SwitchWeaponImage = HeaderWeapon2 --[[ @ 0]]
	GamepadText = HeaderWeapon2.subscribeToModel --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( HeaderWeapon2, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		if IsInDefaultState( element ) then
	...
	f1_arg0:AddButtonCallbackFunction( HeaderWeapon2, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "ui_remove", function ( element, menu, controller, model )
		if not CoD.WZUtility.ScoreboardVisibilitySetAndPC( controller ) then
	...
	f1_arg0:AddButtonCallbackFunction( HeaderWeapon2, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "F", function ( element, menu, controller, model )
	...
	HeaderWeapon2:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_2FFD03BF8361AC75", function ( f40_arg0, f40_arg1, f40_arg2, f40_arg3 )
