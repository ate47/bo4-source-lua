...
CoD.AmmoWidgetWZ_AbilityItem_Heal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AmmoWidgetWZ_AbilityItem_Heal.__defaultWidth = 72 --[[ @ 0]]
CoD.AmmoWidgetWZ_AbilityItem_Heal.__defaultHeight = 59 --[[ @ 0]]
CoD.AmmoWidgetWZ_AbilityItem_Heal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AmmoWidgetWZ_AbilityItem_Heal ) --[[ @ 0]]
	self.id = "AmmoWidgetWZ_AbilityItem_Heal" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local Backing = LUI.UIImage.new( 0.5, 0.5, -36, 32, 0.5, 0.5, -30, 30 ) --[[ @ 0]]
	...
	NotAvailable:linkToElementModel( self, "id", true, function ( model )
		...
		if f6_local0 ~= nil then
			NotAvailable.ImgIcon:setImage( GetWeaponGadgetIconAvailable( f6_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	NotAvailable:linkToElementModel( self, "id", true, function ( model )
		local f7_local0 = model:get() --[[ @ 0]]
		if f7_local0 ~= nil then
			NotAvailable.ImgIconGrow:setImage( GetWeaponGadgetIconAvailable( f7_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	self:addElement( NotAvailable ) --[[ @ 0]]
	self.NotAvailable = NotAvailable --[[ @ 0]]
	
	local HeroAbilityUseString = CoD.ControllerDependent_TextBox.new( f1_arg0, f1_arg1, 0.5, 0.5, -36, 36, 0, 0, 68, 92 ) --[[ @ 0]]
	HeroAbilityUseString:mergeStateConditions( {
		...
		},
		{
			stateName = "Hidden",
			condition = function ( menu, element, event )
				local f9_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"] ) --[[ @ 0]]
				if not f9_local0 then
					f9_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"] ) --[[ @ 0]]
					if not f9_local0 then
						f9_local0 = Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_5C57360571B0917E"] ) --[[ @ 0]]
					end
				end
				return f9_local0
			end
	...
	local QuickEquipCycleString = HeroAbilityUseString --[[ @ 0]]
	...
	QuickEquipCycleString = HeroAbilityUseString --[[ @ 0]]
	...
	HeroAbilityHoldString( QuickEquipCycleString, HeroAbilityHoldStringPC["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f16_arg0 )
		f1_arg0:updateElementState( HeroAbilityUseString, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HeroAbilityHoldString = HeroAbilityUseString.subscribeToModel --[[ @ 0]]
	HeroAbilityHoldStringPC = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HeroAbilityHoldString( QuickEquipCycleString, HeroAbilityHoldStringPC["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f17_arg0 )
		f1_arg0:updateElementState( HeroAbilityUseString, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HeroAbilityHoldString = HeroAbilityUseString.subscribeToModel --[[ @ 0]]
	HeroAbilityHoldStringPC = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	HeroAbilityHoldString( QuickEquipCycleString, HeroAbilityHoldStringPC["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5C57360571B0917E"]], function ( f18_arg0 )
		f1_arg0:updateElementState( HeroAbilityUseString, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	HeroAbilityUseString:appendEventHandler( "input_source_changed", function ( f19_arg0, f19_arg1 )
		...
		f1_arg0:updateElementState( HeroAbilityUseString, f19_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	QuickEquipCycleString = HeroAbilityUseString --[[ @ 0]]
	HeroAbilityHoldString = HeroAbilityUseString.subscribeToModel --[[ @ 0]]
	HeroAbilityHoldStringPC = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	...
	QuickEquipCycleString = CoD.ControllerDependent_TextBox.new( f1_arg0, f1_arg1, 0.5, 0.5, 20, 259, 0, 0, 71, 89 ) --[[ @ 0]]
	QuickEquipCycleString:mergeStateConditions( {
		...
		},
		{
			stateName = "KeyboardAndMouseAbilityWZ",
			condition = function ( menu, element, event )
				local f29_local0 = IsMouseOrKeyboard( f1_arg1 ) --[[ @ 0]]
				if f29_local0 then
					f29_local0 = AlwaysTrue() --[[ @ 0]]
					if f29_local0 then
						f29_local0 = CoD.OptionsUtility.IsProfileIntValue( f1_arg1, "warzoneCycleItems", 1 ) --[[ @ 0]]
					end
				end
				return f29_local0
			end
	...
	local LED = QuickEquipCycleString --[[ @ 0]]
	HeroAbilityHoldStringPC = QuickEquipCycleString.subscribeToModel --[[ @ 0]]
	local stackCount = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	...
	LED = QuickEquipCycleString --[[ @ 0]]
	HeroAbilityHoldStringPC = QuickEquipCycleString.subscribeToModel --[[ @ 0]]
	stackCount = Engine[@"GetGlobalModel"]() --[[ @ 0]]
	...
	LED = QuickEquipCycleString --[[ @ 0]]
	HeroAbilityHoldStringPC = QuickEquipCycleString.subscribeToModel --[[ @ 0]]
	stackCount = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	...
	stackCount = CoD.WarzoneAbilityItemCounter.new( f1_arg0, f1_arg1, 0, 0, 38.5, 74.5, 0, 0, 41, 65 ) --[[ @ 0]]
	...
	local f1_local14 = stackCount --[[ @ 0]]
	local f1_local15 = stackCount.subscribeToModel --[[ @ 0]]
	local f1_local16 = DataSources.HUDItems.getModel( f1_arg1 ) --[[ @ 0]]
	...
	stackCount:subscribeToGlobalModel( f1_arg1, "HUDItems", "healthItemstackCount", function ( model )
		...
		if f40_local0 ~= nil then
			stackCount.Quantity:setText( CoD.BaseUtility.AlreadyLocalized( f40_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	f1_local14 = HeroAbilityHoldStringPC --[[ @ 0]]
	f1_local15 = HeroAbilityHoldStringPC.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local15( f1_local14, f1_local16["GameplayFeedbackSettings.hideRadiationHold"], HeroAbilityHoldStringPC.__Alpha ) --[[ @ 0]]
	...
	f1_local15 = self --[[ @ 0]]
	SetElementProperty( NotAvailable, "show_empty_health_flash", true ) --[[ @ 0]]
	f1_local15 = HeroAbilityHoldString --[[ @ 0]]
	if IsPC() then
...
CoD.AmmoWidgetWZ_AbilityItem_Heal.__resetProperties = function ( f53_arg0 )
	...
	f53_arg0.QuickEquipCycleString:completeAnimation() --[[ @ 0]]
	...
	f53_arg0.ClockMeterAdd:completeAnimation() --[[ @ 0]]
	f53_arg0.Backing:completeAnimation() --[[ @ 0]]
	f53_arg0.stackCount:completeAnimation() --[[ @ 0]]
	f53_arg0.NotAvailable:setAlpha( 1 ) --[[ @ 0]]
	f53_arg0.HeroAbilityUseString:setRGB( 1, 1, 1 ) --[[ @ 0]]
	f53_arg0.HeroAbilityUseString:setAlpha( 1 ) --[[ @ 0]]
	f53_arg0.QuickEquipCycleString:setAlpha( 1 ) --[[ @ 0]]
	f53_arg0.PowerBasedImageUnavailable:setRGB( 1, 1, 1 ) --[[ @ 0]]
	f53_arg0.PowerBasedImageUnavailable:setAlpha( 0 ) --[[ @ 0]]
	f53_arg0.PowerBasedImageAvailable:setAlpha( 1 ) --[[ @ 0]]
	f53_arg0.Glow:setAlpha( 0 ) --[[ @ 0]]
	f53_arg0.Glow:setMaterial( LUI.UIImage.GetCachedMaterial( @"ui_add" ) ) --[[ @ 0]]
	f53_arg0.Box:setRGB( 1, 1, 1 ) --[[ @ 0]]
	f53_arg0.Box:setAlpha( 1 ) --[[ @ 0]]
	f53_arg0.LED:setRGB( 0, 0, 0 ) --[[ @ 0]]
	f53_arg0.LED:setAlpha( 0.2 ) --[[ @ 0]]
	f53_arg0.ClockMeterAdd:setRGB( 0, 0, 0 ) --[[ @ 0]]
	f53_arg0.ClockMeterAdd:setAlpha( 0 ) --[[ @ 0]]
	f53_arg0.Backing:setAlpha( 0 ) --[[ @ 0]]
	f53_arg0.stackCount:setLeftRight( 0, 0, 38.5, 74.5 ) --[[ @ 0]]
	f53_arg0.stackCount:setAlpha( 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.AmmoWidgetWZ_AbilityItem_Heal.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f54_arg0, f54_arg1 )
			...
			f54_arg0.NotAvailable:completeAnimation() --[[ @ 0]]
			f54_arg0.NotAvailable:setAlpha( 1 ) --[[ @ 0]]
			f54_arg0.clipFinished( f54_arg0.NotAvailable ) --[[ @ 0]]
			f54_arg0.HeroAbilityUseString:completeAnimation() --[[ @ 0]]
			f54_arg0.HeroAbilityUseString:setRGB( 0.47, 0.47, 0.47 ) --[[ @ 0]]
			f54_arg0.HeroAbilityUseString:setAlpha( 0 ) --[[ @ 0]]
			f54_arg0.clipFinished( f54_arg0.HeroAbilityUseString ) --[[ @ 0]]
			f54_arg0.QuickEquipCycleString:completeAnimation() --[[ @ 0]]
			f54_arg0.QuickEquipCycleString:setAlpha( 0 ) --[[ @ 0]]
			f54_arg0.clipFinished( f54_arg0.QuickEquipCycleString ) --[[ @ 0]]
			f54_arg0.nextClip = "DefaultClip" --[[ @ 0]]
		end
	},
	Hidden = {
	...
	InUse = {
		DefaultClip = function ( f56_arg0, f56_arg1 )
			...
			f56_arg0.Backing:setAlpha( 0.95 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.Backing ) --[[ @ 0]]
			f56_arg0.ClockMeterAdd:completeAnimation() --[[ @ 0]]
			f56_arg0.ClockMeterAdd:setAlpha( 0.8 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.ClockMeterAdd ) --[[ @ 0]]
			f56_arg0.NotAvailable:completeAnimation() --[[ @ 0]]
			f56_arg0.NotAvailable:setAlpha( 0 ) --[[ @ 0]]
			...
			f56_arg0.QuickEquipCycleString:completeAnimation() --[[ @ 0]]
			f56_arg0.QuickEquipCycleString:setAlpha( 0 ) --[[ @ 0]]
			f56_arg0.clipFinished( f56_arg0.QuickEquipCycleString ) --[[ @ 0]]
	...
	Deployed = {
		DefaultClip = function ( f57_arg0, f57_arg1 )
			...
			f57_arg0.clipFinished( f57_arg0.Backing ) --[[ @ 0]]
			...
			f57_arg0.HeroAbilityUseString:setRGB( 0.47, 0.47, 0.47 ) --[[ @ 0]]
			f57_arg0.HeroAbilityUseString:setAlpha( 1 ) --[[ @ 0]]
	...
	PowerBasedEmptyCharging = {
		DefaultClip = function ( f58_arg0, f58_arg1 )
			...
			f58_arg0.Backing:completeAnimation() --[[ @ 0]]
			f58_arg0.Backing:setAlpha( 0 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.Backing ) --[[ @ 0]]
			f58_arg0.ClockMeterAdd:completeAnimation() --[[ @ 0]]
			f58_arg0.ClockMeterAdd:setRGB( 0, 0, 0 ) --[[ @ 0]]
			f58_arg0.ClockMeterAdd:setAlpha( 0.8 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.ClockMeterAdd ) --[[ @ 0]]
			f58_arg0.PowerBasedImageAvailable:completeAnimation() --[[ @ 0]]
			f58_arg0.PowerBasedImageAvailable:setAlpha( 0 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.PowerBasedImageAvailable ) --[[ @ 0]]
			f58_arg0.PowerBasedImageUnavailable:completeAnimation() --[[ @ 0]]
			f58_arg0.PowerBasedImageUnavailable:setAlpha( 0.4 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.PowerBasedImageUnavailable ) --[[ @ 0]]
			f58_arg0.NotAvailable:completeAnimation() --[[ @ 0]]
			f58_arg0.NotAvailable:setAlpha( 1 ) --[[ @ 0]]
			f58_arg0.clipFinished( f58_arg0.NotAvailable ) --[[ @ 0]]
			f58_arg0.HeroAbilityUseString:completeAnimation() --[[ @ 0]]
			f58_arg0.HeroAbilityUseString:setRGB( 0.47, 0.47, 0.47 ) --[[ @ 0]]
	...
	PowerBasedCharging = {
		DefaultClip = function ( f59_arg0, f59_arg1 )
			...
			f59_arg0.ClockMeterAdd:completeAnimation() --[[ @ 0]]
			f59_arg0.ClockMeterAdd:setRGB( 0, 0, 0 ) --[[ @ 0]]
			f59_arg0.ClockMeterAdd:setAlpha( 0.8 ) --[[ @ 0]]
			f59_arg0.clipFinished( f59_arg0.ClockMeterAdd ) --[[ @ 0]]
			f59_arg0.PowerBasedImageAvailable:completeAnimation() --[[ @ 0]]
			f59_arg0.PowerBasedImageAvailable:setAlpha( 0 ) --[[ @ 0]]
			f59_arg0.clipFinished( f59_arg0.PowerBasedImageAvailable ) --[[ @ 0]]
			f59_arg0.PowerBasedImageUnavailable:completeAnimation() --[[ @ 0]]
			f59_arg0.PowerBasedImageUnavailable:setAlpha( 1 ) --[[ @ 0]]
			f59_arg0.clipFinished( f59_arg0.PowerBasedImageUnavailable ) --[[ @ 0]]
			...
			f59_arg0.HeroAbilityUseString:setAlpha( 0 ) --[[ @ 0]]
			f59_arg0.clipFinished( f59_arg0.HeroAbilityUseString ) --[[ @ 0]]
			f59_arg0.QuickEquipCycleString:completeAnimation() --[[ @ 0]]
			f59_arg0.QuickEquipCycleString:setAlpha( 0 ) --[[ @ 0]]
			f59_arg0.clipFinished( f59_arg0.QuickEquipCycleString ) --[[ @ 0]]
		end
	},
	PowerBased = {
		DefaultClip = function ( f60_arg0, f60_arg1 )
			...
			f60_arg0.Glow:setAlpha( 0.1 ) --[[ @ 0]]
			f60_arg0.Glow:setMaterial( LUI.UIImage.GetCachedMaterial( @"ui_add" ) ) --[[ @ 0]]
			f60_arg0.clipFinished( f60_arg0.Glow ) --[[ @ 0]]
			f60_arg0.Box:completeAnimation() --[[ @ 0]]
			f60_arg0.Box:setRGB( 0, 0, 0 ) --[[ @ 0]]
			f60_arg0.Box:setAlpha( 1 ) --[[ @ 0]]
			f60_arg0.clipFinished( f60_arg0.Box ) --[[ @ 0]]
			f60_arg0.PowerBasedImageUnavailable:completeAnimation() --[[ @ 0]]
			f60_arg0.PowerBasedImageUnavailable:setRGB( 0.74, 0.69, 0.42 ) --[[ @ 0]]
			f60_arg0.PowerBasedImageUnavailable:setAlpha( 0 ) --[[ @ 0]]
			...
			f60_arg0.HeroAbilityUseString:setRGB( 1, 1, 1 ) --[[ @ 0]]
			f60_arg0.HeroAbilityUseString:setAlpha( 1 ) --[[ @ 0]]
			f60_arg0.clipFinished( f60_arg0.HeroAbilityUseString ) --[[ @ 0]]
			f60_arg0.LED:completeAnimation() --[[ @ 0]]
			f60_arg0.LED:setRGB( 0, 0, 0 ) --[[ @ 0]]
			f60_arg0.LED:setAlpha( 0.2 ) --[[ @ 0]]
		...
		Pulse = function ( f61_arg0, f61_arg1 )
			...
			f61_arg0.Box:setRGB( 0, 0, 0 ) --[[ @ 0]]
			f61_arg0.Box:setAlpha( 1 ) --[[ @ 0]]
			f61_arg0.clipFinished( f61_arg0.Box ) --[[ @ 0]]
			...
			f61_arg0.LED:setRGB( 0, 0, 0 ) --[[ @ 0]]
			f61_arg0.LED:setAlpha( 0.2 ) --[[ @ 0]]
			f61_arg0.clipFinished( f61_arg0.LED ) --[[ @ 0]]
			f61_arg0.nextClip = "Pulse" --[[ @ 0]]
		end,
		FadeIn = function ( f62_arg0, f62_arg1 )
			...
			local f62_local0 = function ( f63_arg0 )
				...
				f62_arg0.PowerBasedImageAvailable:registerEventHandler( "transition_complete_keyframe", f63_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f62_arg0.PowerBasedImageAvailable:completeAnimation() --[[ @ 0]]
			f62_arg0.PowerBasedImageAvailable:setAlpha( 0 ) --[[ @ 0]]
			f62_local0( f62_arg0.PowerBasedImageAvailable ) --[[ @ 0]]
			...
			local f62_local1 = function ( f65_arg0 )
				local f65_local0 = function ( f66_arg0 )
					f66_arg0:beginAnimation( 210 ) --[[ @ 0]]
					f66_arg0:setAlpha( 1 ) --[[ @ 0]]
					f66_arg0:registerEventHandler( "transition_complete_keyframe", f62_arg0.clipFinished ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f62_arg0.stackCount:beginAnimation( 200 ) --[[ @ 0]]
				f62_arg0.stackCount:registerEventHandler( "interrupted_keyframe", f62_arg0.clipInterrupted ) --[[ @ 0]]
				f62_arg0.stackCount:registerEventHandler( "transition_complete_keyframe", f65_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f62_arg0.stackCount:completeAnimation() --[[ @ 0]]
			f62_arg0.stackCount:setLeftRight( 0, 0, 38, 74 ) --[[ @ 0]]
			f62_arg0.stackCount:setAlpha( 0 ) --[[ @ 0]]
			f62_local1( f62_arg0.stackCount ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.AmmoWidgetWZ_AbilityItem_Heal.__onClose = function ( f67_arg0 )
	f67_arg0.ClockMeterAdd:close() --[[ @ 0]]
	f67_arg0.PowerBasedImageAvailable:close() --[[ @ 0]]
	f67_arg0.PowerBasedImageUnavailable:close() --[[ @ 0]]
	f67_arg0.NotAvailable:close() --[[ @ 0]]
	f67_arg0.HeroAbilityUseString:close() --[[ @ 0]]
	f67_arg0.HeroAbilityHoldString:close() --[[ @ 0]]
	f67_arg0.QuickEquipCycleString:close() --[[ @ 0]]
	f67_arg0.HeroAbilityHoldStringPC:close() --[[ @ 0]]
	f67_arg0.stackCount:close() --[[ @ 0]]
end
 --[[ @ 0]]
