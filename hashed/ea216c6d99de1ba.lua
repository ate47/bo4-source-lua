...
CoD.BountyHunterBuyInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_arg0:AddButtonCallbackFunction( PrimaryBuy, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	SecondaryUpgradeHeader:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	PrimaryUpgradesHeader:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( SecondaryBuy, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		if CoD.BountyHunterUtility.IsBuyMenuVisible( self ) and not IsDemoPlaying() then
	...
	f1_arg0:AddButtonCallbackFunction( ArmorBuy, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		if CoD.BountyHunterUtility.IsBuyMenuVisible( self ) and not IsDemoPlaying() then
	...
	f1_arg0:AddButtonCallbackFunction( ScorestreakBuy, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		if CoD.BountyHunterUtility.IsBuyMenuVisible( self ) and not IsDemoPlaying() then
	...
	f1_arg0:AddButtonCallbackFunction( EquipmentBuy, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		if CoD.BountyHunterUtility.IsBuyMenuVisible( self ) and not IsDemoPlaying() then
	...
	f1_arg0:AddButtonCallbackFunction( PrimaryAmmoBuy, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		if CoD.BountyHunterUtility.IsBuyMenuVisible( self ) and not IsDemoPlaying() then
	...
	f1_arg0:AddButtonCallbackFunction( SecondaryAmmoBuy, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		if CoD.BountyHunterUtility.IsBuyMenuVisible( self ) and not IsDemoPlaying() then
			CoD.BountyHunterUtility.BuyBountyPackageAmmo( controller, menu, element ) --[[ @ 0]]
			return true
		else
