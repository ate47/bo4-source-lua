...
LUI.createMenu.WeaponBribeSelection = function ( f1_arg0, f1_arg1 )
	...
	WeaponBribes:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( WeaponBribes, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
