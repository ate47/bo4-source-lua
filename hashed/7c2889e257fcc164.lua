...
CoD.StickerSetItemInternal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.StickerSetItemInternal.__defaultWidth = 160 --[[ @ 0]]
CoD.StickerSetItemInternal.__defaultHeight = 160 --[[ @ 0]]
CoD.StickerSetItemInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.StickerSetItemInternal ) --[[ @ 0]]
	self.id = "StickerSetItemInternal" --[[ @ 0]]
	...
	local EquippedMarkerBG = LUI.UIImage.new( 1, 1, -38, 6, 0, 0, -7, 37 ) --[[ @ 0]]
	...
	local EquippedMarkerTick = LUI.UIImage.new( 1, 1, -38, 6, 0, 0, -7, 37 ) --[[ @ 0]]
...
CoD.StickerSetItemInternal.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f15_arg0, f15_arg1 )
			...
			f15_arg0.itemImage:setRGB( 0.92, 0.92, 0.92 ) --[[ @ 0]]
	...
	TrialLocked = {
		DefaultClip = function ( f23_arg0, f23_arg1 )
			...
			f23_arg0.itemImage:setRGB( 0.92, 0.92, 0.92 ) --[[ @ 0]]
		...
		LoseChildFocus = function ( f26_arg0, f26_arg1 )
			...
			f26_arg0.itemImage:completeAnimation() --[[ @ 0]]
			f26_arg0.itemImage:setAlpha( 1 ) --[[ @ 0]]
			f26_arg0.clipFinished( f26_arg0.itemImage ) --[[ @ 0]]
	...
	Locked = {
		...
		LoseChildFocus = function ( f31_arg0, f31_arg1 )
			...
			local f31_local0 = function ( f32_arg0 )
				f31_arg0.itemImage:beginAnimation( 200 ) --[[ @ 0]]
				f31_arg0.itemImage:setRGB( 0.29, 0.29, 0.29 ) --[[ @ 0]]
				f31_arg0.itemImage:registerEventHandler( "interrupted_keyframe", f31_arg0.clipInterrupted ) --[[ @ 0]]
				f31_arg0.itemImage:registerEventHandler( "transition_complete_keyframe", f31_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f31_arg0.itemImage:completeAnimation() --[[ @ 0]]
			f31_arg0.itemImage:setRGB( 0.49, 0.49, 0.49 ) --[[ @ 0]]
			f31_local0( f31_arg0.itemImage ) --[[ @ 0]]
	...
	New = {
		...
		ChildFocus = function ( f34_arg0, f34_arg1 )
			...
			local f34_local0 = function ( f35_arg0 )
				local f35_local0 = function ( f36_arg0 )
				 ...
				 --[[ @ 0]]
				f34_arg0.BreadcrumbNew:beginAnimation( 400 ) --[[ @ 0]]
				f34_arg0.BreadcrumbNew:registerEventHandler( "interrupted_keyframe", f34_arg0.clipInterrupted ) --[[ @ 0]]
				f34_arg0.BreadcrumbNew:registerEventHandler( "transition_complete_keyframe", f35_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f34_arg0.BreadcrumbNew:completeAnimation() --[[ @ 0]]
			f34_arg0.BreadcrumbNew:setAlpha( 1 ) --[[ @ 0]]
			f34_local0( f34_arg0.BreadcrumbNew ) --[[ @ 0]]
		end,
		GainChildFocus = function ( f37_arg0, f37_arg1 )
			...
			f37_arg0.BreadcrumbNew:completeAnimation() --[[ @ 0]]
			f37_arg0.BreadcrumbNew:setAlpha( 1 ) --[[ @ 0]]
			f37_arg0.clipFinished( f37_arg0.BreadcrumbNew ) --[[ @ 0]]
		end,
		LoseChildFocus = function ( f38_arg0, f38_arg1 )
			f38_arg0:__resetProperties() --[[ @ 0]]
			f38_arg0:setupElementClipCounter( 2 ) --[[ @ 0]]
			f38_arg0.itemImage:completeAnimation() --[[ @ 0]]
			f38_arg0.itemImage:setAlpha( 1 ) --[[ @ 0]]
			f38_arg0.clipFinished( f38_arg0.itemImage ) --[[ @ 0]]
			f38_arg0.BreadcrumbNew:completeAnimation() --[[ @ 0]]
			f38_arg0.BreadcrumbNew:setAlpha( 0 ) --[[ @ 0]]
	...
	Equipped = {
		...
		ChildFocus = function ( f40_arg0, f40_arg1 )
			...
			f40_arg0.EquippedMarkerBG:completeAnimation() --[[ @ 0]]
			f40_arg0.EquippedMarkerBG:setAlpha( 1 ) --[[ @ 0]]
			f40_arg0.clipFinished( f40_arg0.EquippedMarkerBG ) --[[ @ 0]]
			f40_arg0.EquippedMarkerTick:completeAnimation() --[[ @ 0]]
			f40_arg0.EquippedMarkerTick:setAlpha( 1 ) --[[ @ 0]]
		...
		GainChildFocus = function ( f41_arg0, f41_arg1 )
			...
			f41_arg0.EquippedMarkerBG:completeAnimation() --[[ @ 0]]
			f41_arg0.EquippedMarkerBG:setAlpha( 1 ) --[[ @ 0]]
			f41_arg0.clipFinished( f41_arg0.EquippedMarkerBG ) --[[ @ 0]]
...
CoD.StickerSetItemInternal.__onClose = function ( f43_arg0 )
	f43_arg0.itemImage:close() --[[ @ 0]]
	f43_arg0.CommonButtonOutline:close() --[[ @ 0]]
	f43_arg0.BMGoldBar:close() --[[ @ 0]]
	f43_arg0.BreadcrumbNew:close() --[[ @ 0]]
	f43_arg0.LockIcon:close() --[[ @ 0]]
	f43_arg0.TrialWidget:close() --[[ @ 0]]
end
 --[[ @ 0]]
