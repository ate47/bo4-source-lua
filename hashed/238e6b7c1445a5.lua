...
LUI.createMenu.TimelineEditor = function ( f1_arg0, f1_arg1 )
	...
	SegmentButtonList:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	GenericMenuFrame0( ClipStartTime, ClipEndTime["demo.showFilmOptionsSidebar"], function ( f4_arg0, f4_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f4_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( SegmentButtonList, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		...
		if not IsDisabled( element, controller ) and not CoD.ModelUtility.IsGlobalModelValueTrue( "demo.showFilmOptionsSidebar" ) and not IsTimelineEditorInMoveState( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_38851419C3D83BD3", nil, nil ) --[[ @ 0]]
			return true
		elseif not IsDisabled( element, controller ) and not CoD.ModelUtility.IsGlobalModelValueTrue( "demo.showFilmOptionsSidebar" ) and IsTimelineEditorInMoveState( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], @"hash_7EDE476A5BD7AB24", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	f1_local1:AddButtonCallbackFunction( SegmentButtonList, f1_arg0, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], nil, function ( element, menu, controller, model )
		if SegmentCountGreaterThan( controller, 0 ) and not CoD.ModelUtility.IsGlobalModelValueTrue( "demo.showFilmOptionsSidebar" ) and CanChangeSegmentTransition( element, controller ) and IsSegmentTransition( element, controller, Enum[@"demoClipTransition"][@"hash_569612675859CEFC"] ) and not IsTimelineEditorInMoveState( controller ) then
			TimelineEditorChangeTransition( self, element, controller ) --[[ @ 0]]
			UpdateAllMenuButtonPrompts( menu, controller ) --[[ @ 0]]
			return true
		elseif SegmentCountGreaterThan( controller, 0 ) and not CoD.ModelUtility.IsGlobalModelValueTrue( "demo.showFilmOptionsSidebar" ) and CanChangeSegmentTransition( element, controller ) and IsSegmentTransition( element, controller, Enum[@"demoClipTransition"][@"hash_1345D425EB2FCF20"] ) and not IsTimelineEditorInMoveState( controller ) then
			TimelineEditorChangeTransition( self, element, controller ) --[[ @ 0]]
			UpdateAllMenuButtonPrompts( menu, controller ) --[[ @ 0]]
			return true
		else
		...
		if SegmentCountGreaterThan( controller, 0 ) and not CoD.ModelUtility.IsGlobalModelValueTrue( "demo.showFilmOptionsSidebar" ) and CanChangeSegmentTransition( element, controller ) and IsSegmentTransition( element, controller, Enum[@"demoClipTransition"][@"hash_569612675859CEFC"] ) and not IsTimelineEditorInMoveState( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], @"hash_4E2C45A307C8FAB7", nil, nil ) --[[ @ 0]]
			return true
		elseif SegmentCountGreaterThan( controller, 0 ) and not CoD.ModelUtility.IsGlobalModelValueTrue( "demo.showFilmOptionsSidebar" ) and CanChangeSegmentTransition( element, controller ) and IsSegmentTransition( element, controller, Enum[@"demoClipTransition"][@"hash_1345D425EB2FCF20"] ) and not IsTimelineEditorInMoveState( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], @"hash_5793A2303FCB2877", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	EmptyTimelineEditorText:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	EmptyTimelineEditorText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	f1_local15( f1_local14, f1_local16["demo.showFilmOptionsSidebar"], function ( f16_arg0, f16_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f16_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_222361E23588705A"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
		...
		if SegmentCountGreaterThan( controller, 0 ) and not CoD.ModelUtility.IsGlobalModelValueTrue( "demo.showFilmOptionsSidebar" ) and not IsTimelineEditorInMoveState( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], @"hash_1762B1A3AA910D84", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
