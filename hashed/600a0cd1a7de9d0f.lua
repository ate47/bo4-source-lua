...
function FractionToPercentageRounded( f2_arg0 )
	if f2_arg0 and f2_arg0 ~= @"hash_0" and f2_arg0 ~= "" then
		return Engine[@"hash_4F9F1239CFD921FE"]( @"hash_216A7A1F8ECC8C64", math.floor( f2_arg0 * 100 + 0.5 ) )
	else
		return @"hash_0"
	end
end
...
function NumberAsPercentRounded( f22_arg0 )
	...
	return Engine[@"hash_4F9F1239CFD921FE"]( @"hash_216A7A1F8ECC8C64", tostring( f22_local0 ) )
end

function NumberAsPercent( f23_arg0 )
	return Engine[@"hash_4F9F1239CFD921FE"]( @"hash_216A7A1F8ECC8C64", tostring( f23_arg0 ) )
end
...
function PrependLevelTypeStringWithSeparator( f41_arg0, f41_arg1 )
	...
	elseif LuaUtils.IsArenaMode() then
		f41_local0 = @"hash_23370355189B42A7" --[[ @ 0]]
	end
...
function ConsoleColorFromIndex( f63_arg0, f63_arg1 )
	...
	if f63_arg1 == Enum[@"hash_197A8DF5F2FA8BD5"][@"hash_2F51088437AB5AF5"] then
		f63_local0 = CoD.TeamUtility.GetColorSetEnemyOrShoutCasterColor( f63_arg0 ) --[[ @ 0]]
	elseif f63_arg1 == Enum[@"hash_197A8DF5F2FA8BD5"][@"hash_14D3BDE8AD3D7704"] then
		f63_local0 = CoD.TeamUtility.GetColorSetFriendlyOrShoutCasterColor( f63_arg0 ) --[[ @ 0]]
	elseif f63_arg1 ~= Enum[@"hash_197A8DF5F2FA8BD5"][@"hash_54A8B270BE295E3E"] then
...
function LocalServerStatusToString( f104_arg0 )
	if f104_arg0 == 0 then
		return @"hash_DA680012C01968D"
	else
		return @"hash_5EF105DFE1446B3B"
	end
end

function PresenceToModeString( f105_arg0 )
	local f105_local0 = tonumber( f105_arg0 ) --[[ @ 0]]
	if f105_local0 == Enum[@"hash_4BBA402DE649132"][@"hash_51CF21FD793411B9"] then
		return @"hash_672BB745FED1CD7E"
	elseif f105_local0 == Enum[@"hash_4BBA402DE649132"][@"hash_7A2184EBB293AF2D"] or f105_local0 == Enum[@"hash_4BBA402DE649132"][@"hash_6C14960E60DA36B7"] then
		return @"hash_708E783C525F2FA8"
	elseif f105_local0 >= Enum[@"hash_4BBA402DE649132"][@"hash_669F9F19327AE3B3"] and f105_local0 <= Enum[@"hash_4BBA402DE649132"][@"hash_659DAD56E9325476"] then
		return @"hash_7C00E43A2AA46CC4"
	elseif f105_local0 >= Enum[@"hash_4BBA402DE649132"][@"hash_21DB40BC5D7A26F2"] and f105_local0 <= Enum[@"hash_4BBA402DE649132"][@"hash_5DD9D1D4A601036C"] then
		return LuaUtils.GetDisplayNameForEMode( Enum[@"eModes"][@"hash_73723205FAE52C4A"] )
	elseif f105_local0 >= Enum[@"hash_4BBA402DE649132"][@"hash_41632587246C118A"] and f105_local0 <= Enum[@"hash_4BBA402DE649132"][@"hash_30EDDB0D016B3F54"] then
		return LuaUtils.GetDisplayNameForEMode( Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] )
	elseif f105_local0 >= Enum[@"hash_4BBA402DE649132"][@"hash_361619C03C7E6934"] and f105_local0 <= Enum[@"hash_4BBA402DE649132"][@"hash_886E7F57ED1ED3A"] then
		return @"hash_762CDF997F090DB1"
	elseif f105_local0 >= Enum[@"hash_4BBA402DE649132"][@"hash_179F90DEF3681532"] and f105_local0 <= Enum[@"hash_4BBA402DE649132"][@"hash_435923F6DC7C09AC"] then
		return LuaUtils.GetDisplayNameForEMode( Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] )
	elseif f105_local0 >= Enum[@"hash_4BBA402DE649132"][@"hash_65EEADE3AFEF0F50"] and f105_local0 <= Enum[@"hash_4BBA402DE649132"][@"hash_4AE1F1FC5A87498E"] then
...
function SessionModeToLocalizedSessionMode( f114_arg0 )
	local f114_local0 = @"hash_555D96CC762EABDD" --[[ @ 0]]
	if f114_arg0 == Enum[@"eModes"][@"hash_73723205FAE52C4A"] then
		f114_local0 = @"hash_5B06081B8B4567F2" --[[ @ 0]]
	elseif f114_arg0 == Enum[@"eModes"][@"hash_360063C67132EB69"] then
		f114_local0 = @"hash_762CDF997F090DB1" --[[ @ 0]]
	end
	return Engine[@"hash_4F9F1239CFD921FE"]( f114_local0 )
end

function SessionModeToUnlocalizedSessionModeCaps( f115_arg0 )
	local f115_local0 = @"hash_555D96CC762EABDD" --[[ @ 0]]
	if f115_arg0 == Enum[@"eModes"][@"hash_73723205FAE52C4A"] then
		f115_local0 = @"hash_5B06081B8B4567F2" --[[ @ 0]]
	elseif f115_arg0 == Enum[@"eModes"][@"hash_360063C67132EB69"] then
		f115_local0 = @"hash_762CDF997F090DB1" --[[ @ 0]]
	end
	return f115_local0
end
...
function GameTypeToLocalizedGameType( f123_arg0 )
	if f123_arg0 == nil or f123_arg0 == "" or f123_arg0 == @"hash_0" then
		...
		local f123_local0 = Engine[@"hash_5EA74FA7EE46E195"]( f123_arg0 ) --[[ @ 0]]
...
function GameTypeToLocalizedGameTypeDescription( f124_arg0 )
	if f124_arg0 == nil or f124_arg0 == "" or f124_arg0 == @"hash_0" then
		...
		local f124_local0 = Engine[@"hash_5EA74FA7EE46E195"]( f124_arg0 ) --[[ @ 0]]
...
function GameTypeToImage( f125_arg0 )
	if f125_arg0 == nil or f125_arg0 == "" then
		...
		local f125_local0 = Engine[@"hash_5EA74FA7EE46E195"]( f125_arg0 ) --[[ @ 0]]
		return f125_local0.image
	end
end

function GetGametypeImage( f126_arg0 )
	return GameTypeToImage( Engine[@"hash_169811927938FCD7"]() )
end

function LocalizedGameType( f127_arg0 )
	local f127_local0 = Engine[@"hash_5EA74FA7EE46E195"]( Engine[@"hash_169811927938FCD7"]() ) --[[ @ 0]]
...
function GetGameModeOnMapName( f128_arg0 )
	return CoD.BaseUtility.GetGameModeOnMapNameString( Engine[@"hash_169811927938FCD7"](), Engine[@"hash_3E67E7253CC272C9"]() )
end

function GetGameMode( f129_arg0 )
	local f129_local0 = Engine[@"hash_5EA74FA7EE46E195"]( Engine[@"hash_169811927938FCD7"]() ) --[[ @ 0]]
	local f129_local1 --[[ @ 0]]
	if f129_local0 then
...
function GetMapName( f130_arg0 )
	local f130_local0 = Engine[@"hash_3E67E7253CC272C9"]() --[[ @ 0]]
...
function GetHeroIndexForClientNum( f131_arg0, f131_arg1 )
	...
	if f131_local0 == -1 then
		...
		local f131_local1 = Engine[@"hash_4EE799A4C64E4559"]( f131_arg0, f131_local0 ) --[[ @ 0]]
...
function GetImageViewerParams( f148_arg0, f148_arg1 )
	return Enum[@"ScreenshotViewType"][Engine[@"hash_1C53F8D38DF9042B"]( f148_arg0 )], f148_arg1
end
...
function GetObjectiveProperty( f149_arg0, f149_arg1 )
	...
	local f149_local1 --[[ @ 0]]
	if f149_local0 then
		f149_local1 = f149_local0[Engine[@"hash_1C53F8D38DF9042B"]( f149_arg0 )] --[[ @ 0]]
...
function GetPaintjobIndexParams( f162_arg0, f162_arg1 )
	return f162_arg0, f162_arg1, Enum[@"StorageFileType"][@"hash_2743B8404C246F61"]
end
...
function GetPaintshopExtraCamParameters( f163_arg0, f163_arg1 )
	...
	local f163_local2 = Engine[@"hash_7B98952F69D937F9"]( f163_local1, Enum[@"hash_6EB546760F890D2"][@"hash_6569E84652131CD7"], Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] ) --[[ @ 0]]
...
function GetItemNameFromRef( f170_arg0, f170_arg1 )
	...
	if type( f170_local0 ) ~= "xhash" then
		f170_local0 = Engine[@"hash_1C53F8D38DF9042B"]( f170_local0 ) --[[ @ 0]]
	end
...
function GetHudImageFromItemIndex( f172_arg0 )
	return Engine[@"hash_4D97858119DEE164"]( Engine[@"hash_7B98952F69D937F9"]( f172_arg0 ) .. "_" .. string.lower( CoD.gameMode ), Engine[@"CurrentSessionMode"]() ) or "blacktransparent"
end
...
function GetHudImageFromItemRefHash( f173_arg0, f173_arg1 )
	...
	if f173_local0 and f173_local0 > 0 then
		...
		return Engine[@"hash_4D97858119DEE164"]( f173_arg1, Engine[@"CurrentSessionMode"]() ) or "blacktransparent"
	end
end
...
function GetWeaponGadgetIconAvailable( f176_arg0 )
	local f176_local0 = BlackTransparentIfNilOrEmpty( Engine[@"hash_CAC5353CDB6246D"]( f176_arg0 ) ) --[[ @ 0]]
...
function GetWeaponGadgetIconUnavailable( f177_arg0 )
	return Engine[@"hash_70A9DABDB8742AE8"]( f177_arg0 )
end
...
function GetConsumableCountFromIndex( f178_arg0, f178_arg1 )
	...
	if Engine[@"IsZombiesGame"]() and not IsLobbyNetworkModeLAN() then
		local f178_local1 = Engine[@"hash_3475AAFCBC9AF822"]( f178_local0, Engine[@"hash_1C53F8D38DF9042B"]( Engine[@"GetItemRef"]( f178_arg1 ) ) ) --[[ @ 0]]
...
function GetWeaponAttributesForAttachment( f183_arg0, f183_arg1, f183_arg2, f183_arg3, f183_arg4 )
	...
	if not (f183_local1 ~= nil or Engine[@"CurrentSessionMode"]() ~= Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] or f183_local0 ~= "primary" and f183_local0 ~= "secondary") or not (Engine[@"CurrentSessionMode"]() ~= Enum[@"eModes"][@"hash_73723205FAE52C4A"] or f183_local0 ~= "zmStartWeapon" and f183_local0 ~= "armory") or IsInGame() and CoD.BountyHunterUtility.GameTypeIsBounty( nil ) then
		return 0, 0, 0, 0
	else
...
function GetWeaponAttributeBaseValueForAttachment( f184_arg0, f184_arg1 )
	...
	if not (f184_local1 ~= nil or Engine[@"CurrentSessionMode"]() ~= Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] or f184_local0 ~= "primary" and f184_local0 ~= "secondary") or Engine[@"CurrentSessionMode"]() == Enum[@"eModes"][@"hash_73723205FAE52C4A"] and f184_local0 == "zmStartWeapon" then
		return ""
	else
...
function GetWeaponAttributeAddedValueForAttachment( f185_arg0, f185_arg1 )
	...
	if not (f185_local1 ~= nil or Engine[@"CurrentSessionMode"]() ~= Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] or f185_local0 ~= "primary" and f185_local0 ~= "secondary") or Engine[@"CurrentSessionMode"]() == Enum[@"eModes"][@"hash_73723205FAE52C4A"] and f185_local0 == "zmStartWeapon" then
		return ""
	end
...
function GetClientGameLobbyXUIDForClientNum( f186_arg0 )
	...
	if f186_local0 == LuaDefine.INVALID_CLIENT_INDEX or LuaDefine.MAX_CLIENTS <= f186_local0 then
		return Engine[@"hash_48506F73B393062F"]( LuaDefine.INVALID_XUID )
	else
		return Engine[@"hash_7DB23F7EB606D71B"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] ), f186_arg0 )
	end
end
...
function GetCodcasterPlayerListKD( f193_arg0, f193_arg1 )
	...
	local f193_local1 = Engine[@"hash_E4D2F32833CFA6C"]( f193_local0 ) --[[ @ 0]]
	f193_local1 = f193_local1:create( "kills" ) --[[ @ 0]]
	local f193_local2 = Engine[@"hash_E4D2F32833CFA6C"]( f193_local0 ) --[[ @ 0]]
...
function GetScoreboardPlayerPingBarImage( f195_arg0 )
	...
	if Dvar[@"hash_7DDC61194A7E2C0C"]:get() == false then
		if Dvar[@"hash_33F506D23F310141"]:get() > 1 and f195_arg0 > 0 then
...
function GetScoreboardPlayerPingRange( f196_arg0 )
	...
	if f196_local2 == f196_local0 then
		return Engine[@"hash_4F9F1239CFD921FE"]( @"hash_5A5DFC2E3D7DF772", f196_local1 * (f196_local2 - 1) )
	elseif f196_local2 < f196_local0 then
		return Engine[@"hash_4F9F1239CFD921FE"]( @"hash_302F670BEF7CB789", f196_local1 * (f196_local2 - 1), f196_local1 * f196_local2 - 1 )
	else
		return ""
	end
end
...
function GetScoreboardTeamBackgroundColor( f197_arg0, f197_arg1 )
	if CoD.IsShoutcaster( f197_arg0 ) and CoD.ShoutcasterProfileVarBool( f197_arg0, "shoutcaster_ds_flip_scorepanel" ) then
		if f197_arg1 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			f197_arg1 = Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] --[[ @ 0]]
		elseif f197_arg1 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
			f197_arg1 = Enum[@"team_t"][@"hash_42A34B055ADD98AB"] --[[ @ 0]]
		end
	end
...
function TeamStringFromPlayerIndex( f201_arg0, f201_arg1 )
	...
	if f201_local0 == -1 then
		...
		if CoD.IsShoutcaster( f201_arg0 ) and not CoDShared.IsGametypeTeamBased() and f201_local1 ~= Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
			return ""
		else
...
function TeamColorFromPlayerIndex( f202_arg0, f202_arg1 )
	...
	if f202_local0 == -1 then
		return CoD.TeamUtility.GetTeamFactionColor( Enum[@"team_t"][@"hash_697263B3C1ABADF7"] )
	end
	local f202_local1 = Engine[@"GetTeamID"]( f202_arg0, f202_local0 ) --[[ @ 0]]
	if CoD.IsShoutcaster( f202_arg0 ) and not CoDShared.IsGametypeTeamBased() and f202_local1 ~= Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
		return CoD.TeamUtility.GetTeamFactionColor( Enum[@"team_t"][@"hash_697263B3C1ABADF7"] )
	elseif CoD.IsShoutcaster( f202_arg0 ) and CoD.ShoutcasterProfileVarBool( f202_arg0, "shoutcaster_ds_flip_scorepanel" ) then
		if f202_arg1 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			f202_arg1 = Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] --[[ @ 0]]
		elseif f202_arg1 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
			f202_arg1 = Enum[@"team_t"][@"hash_42A34B055ADD98AB"] --[[ @ 0]]
		end
	end
...
function ClientBackgroundColor( f204_arg0, f204_arg1 )
	...
	if f204_local0 ~= nil and f204_local0.isMember == 1 then
		...
		return CoD.TeamUtility.GetTeamFactionColor( Enum[@"team_t"][@"hash_42A34B055ADD98AB"] )
	end
end
...
function GetPlayerListObjectiveMinimapImage( f223_arg0, f223_arg1 )
	...
	if f223_local0 and f223_local0.name then
		...
		return f223_local1[@"hash_1AA8267261655DF1"] or @"$blacktransparent"
	else
		return @"$blacktransparent"
	end
end
...
function GetPlayerListObjectiveColor( f224_arg0, f224_arg1 )
	...
	if f224_local1 and f224_local1.id and ShouldShowColorForObjective( f224_arg0, f224_local0, f224_local1 ) then
		...
		if f224_local3 == Enum[@"team_t"][@"hash_697263B3C1ABADF7"] or f224_local3 == Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] or f224_local3 == Enum[@"team_t"][@"hash_BD65CBD25CCBEDC"] or f224_local2 ~= 1 then
			return ColorSet.White.r, ColorSet.White.g, ColorSet.White.b
		else
	...
	if f233_local0 and f233_local0.KeyShortcut then
		...
		if f233_local1 then
			...
			elseif #f233_local1 > 1 then
				f233_local1 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_5819ABD75CBD7B59" .. f233_local1 ) --[[ @ 0]]
			end
		end
	end
	return f233_local1
...
function AddLocalizeGameModeToString( f234_arg0 )
	local f234_local0 = Engine[@"hash_5EA74FA7EE46E195"]( Dvar[@"g_gametype"]:get() ) --[[ @ 0]]
	return Engine[@"ToUpper"]( Engine[@"hash_4F9F1239CFD921FE"]( f234_arg0, f234_local0.nameRef ) )
end

function SetProgressTarget( f235_arg0 )
	return Engine[@"hash_4F9F1239CFD921FE"]( @"hash_4B5E5844327FB1A0", f235_arg0 )
end
