...
CoD.ZMInvObjectiveProgressItemSingle = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ZMInvObjectiveProgressItemSingle.__defaultWidth = 64 --[[ @ 0]]
CoD.ZMInvObjectiveProgressItemSingle.__defaultHeight = 64 --[[ @ 0]]
CoD.ZMInvObjectiveProgressItemSingle.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ZMInvObjectiveProgressItemSingle ) --[[ @ 0]]
	self.id = "ZMInvObjectiveProgressItemSingle" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local SlotBackground = LUI.UIImage.new( 0, 1, 0, 0, 0, 1, 0, 0 ) --[[ @ 0]]
	...
	local Earned = LUI.UIImage.new( 0, 1, 0, 0, 0, 1, 0, 0 ) --[[ @ 0]]
	Earned:setAlpha( 0 ) --[[ @ 0]]
