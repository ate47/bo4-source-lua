...
CoD.OverheadName_MP.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	CoD.BaseUtility.InitGlobalModel( "demo.cameraMode", Enum[@"demoCameraMode"][@"hash_7448CED16817146D"] ) --[[ @ 0]]
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f29_local0 then
					if not IsInPrematchPeriod( f1_arg1 ) and not Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_33AEEAA452536E6E"] ) then
						f29_local0 = IsVisibilityBitSet( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_669C28E2FCA82769"] ) --[[ @ 0]]
						if f29_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f30_local0 then
					if not IsInPrematchPeriod( f1_arg1 ) and not Engine[@"IsVisibilityBitSet"]( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_33AEEAA452536E6E"] ) and not IsVisibilityBitSet( f1_arg1, Enum[@"UIVisibilityBit"][@"hash_669C28E2FCA82769"] ) then
	...
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local15( f1_local14, f1_local16["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_33AEEAA452536E6E"]], function ( f39_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local15 = self.subscribeToModel --[[ @ 0]]
	f1_local16 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local15( f1_local14, f1_local16["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_669C28E2FCA82769"]], function ( f40_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
		...
		DefaultState_OldExplode = function ( f56_arg0, f56_arg1 )
			...
			local f56_local4 = function ( f72_arg0 )
				local f72_local0 = function ( f73_arg0 )
				 ...
				 --[[ @ 0]]
				f72_arg0:beginAnimation( 100, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
		...
		DefaultState_OldExplode = function ( f79_arg0, f79_arg1 )
			...
			local f79_local4 = function ( f95_arg0 )
				local f95_local0 = function ( f96_arg0 )
				 ...
				 --[[ @ 0]]
				f95_arg0:beginAnimation( 100, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
		...
		DefaultState_OldExplode = function ( f102_arg0, f102_arg1 )
			...
			local f102_local4 = function ( f118_arg0 )
				local f118_local0 = function ( f119_arg0 )
				 ...
				 --[[ @ 0]]
				f118_arg0:beginAnimation( 100, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
