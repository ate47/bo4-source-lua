	...
	self:mergeStateConditions( {
		{
			stateName = "Captured",
			condition = function ( menu, element, event )
				return CoD.HUDUtility.IsGameTypeEqualToString( "control" ) and CoD.ModelUtility.IsSelfModelValueEqualTo( element, f1_arg1, "state", Enum[@"objectiveState_t"][@"hash_10DF225299252F5E"] )
			end
		},
		{
			stateName = "Hidden",
