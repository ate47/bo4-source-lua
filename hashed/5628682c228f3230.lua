...
require( "x64:6c640857356d4915" ) --[[ @ 0]]

CoD.WZCompassIntercardinal = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.WZCompassIntercardinal.__defaultWidth = 62 --[[ @ 0]]
CoD.WZCompassIntercardinal.__defaultHeight = 37 --[[ @ 0]]
CoD.WZCompassIntercardinal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.WZCompassIntercardinal ) --[[ @ 0]]
	self.id = "WZCompassIntercardinal" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	
	local TextAndPip = CoD.WZCompassIntercardinalInternal.new( f1_arg0, f1_arg1, 0, 0, 0, 62, 0, 0, -6, 37 ) --[[ @ 0]]
