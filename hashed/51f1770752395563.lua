...
CoD.ActiveCamoGrid.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	ActiveCamoList:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( ActiveCamoList, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( ActiveCamoList, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( ActiveCamoList, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( ActiveCamoList, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_contextual_1", function ( element, menu, controller, model )
		...
		if IsMouseOrKeyboard( controller ) and ShouldDisplayContextualMenuInActiveCamoList( controller, element ) and not CoD.WeaponOptionsUtility.IsItemWeaponOptionCamoWrapped( menu, element, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], @"hash_6B1A784560EDFEA7", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"], "ui_contextual_1" ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	f1_arg0:AddButtonCallbackFunction( ActiveCamoList, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "MWHEELUP", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( ActiveCamoList, f1_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "MWHEELDOWN", function ( element, menu, controller, model )
	...
	ActiveCamoList:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f24_arg0, f24_arg1, f24_arg2, f24_arg3 )
	...
	ActiveCamoList:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_6B1A784560EDFEA7", function ( f26_arg0, f26_arg1, f26_arg2, f26_arg3 )
	...
	CamosWillAppearHereText:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	CamosWillAppearHereText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
