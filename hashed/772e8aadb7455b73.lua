...
require( "x64:640bc6e5cf998522" ) --[[ @ 0]]
...
CoD.ContractDetailsSunset = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.ContractDetailsSunset = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "ContractDetailsSunset", f1_arg0 ) --[[ @ 0]]
	...
	self:setClass( CoD.ContractDetailsSunset ) --[[ @ 0]]
	...
	local ContractDetailsPanel = CoD.ContractDetailsPanelSunset.new( f1_local1, f1_arg0, 0.5, 0.5, -840, -64, 0, 0, 178, 905 ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( RewardGridPC, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], "MOUSE1", function ( element, menu, controller, model )
		if IsMouseOrKeyboard( controller ) then
			...
			CoD.BlackMarketUtility.AutoPlayGestureIfApplicable( menu, element, controller ) --[[ @ 0]]
			SetElementState( self, self.SupplyChainDetails, controller, "DefaultState" ) --[[ @ 0]]
			UpdateButtonPromptState( menu, element, controller, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
			return true
		else
...
CoD.ContractDetailsSunset.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f77_arg0, f77_arg1 )
			...
			f77_arg0.Strip:setAlpha( 0.8 ) --[[ @ 0]]
			f77_arg0.clipFinished( f77_arg0.Strip ) --[[ @ 0]]
			f77_arg0.RewardList:completeAnimation() --[[ @ 0]]
			f77_arg0.RewardList:setAlpha( 1 ) --[[ @ 0]]
			f77_arg0.clipFinished( f77_arg0.RewardList ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.ContractDetailsSunset.__onClose = function ( f78_arg0 )
	f78_arg0.ContractDetailsPanel:close() --[[ @ 0]]
	f78_arg0.GenericMenuFrameIdentity:close() --[[ @ 0]]
	f78_arg0.RewardList:close() --[[ @ 0]]
	f78_arg0.RewardGridPC:close() --[[ @ 0]]
	f78_arg0.SupplyChainDetails:close() --[[ @ 0]]
	f78_arg0.ContractInfoPanel:close() --[[ @ 0]]
	f78_arg0.StartMenuCODpoints:close() --[[ @ 0]]
	f78_arg0.XCamMouseControl:close() --[[ @ 0]]
	f78_arg0.Prompts:close() --[[ @ 0]]
end
 --[[ @ 0]]
