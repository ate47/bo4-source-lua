...
LUI.createMenu.BubblegumBuffSelect = function ( f1_arg0, f1_arg1 )
	...
	f1_local1:AddButtonCallbackFunction( selectionList, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "usebgb1", function ( element, menu, controller, model )
		...
		if not CoD.CACUtility.IsCACItemLocked( menu, element, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "usebgb1" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( selectionList, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "usebgb2", function ( element, menu, controller, model )
		...
		if not CoD.CACUtility.IsCACItemLocked( menu, element, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "usebgb2" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( selectionList, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "usebgb3", function ( element, menu, controller, model )
		...
		if not CoD.CACUtility.IsCACItemLocked( menu, element, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "usebgb3" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( selectionList, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "usebgb4", function ( element, menu, controller, model )
		...
		if not CoD.CACUtility.IsCACItemLocked( menu, element, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "usebgb4" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local13( f1_local12, f1_local14.selectedIndex, function ( f26_arg0, f26_arg1 )
		CoD.Menu.UpdateButtonShownState( f26_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f26_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_right"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f26_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f26_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_left"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_local13 = self --[[ @ 0]]
	CoD.BaseUtility.SetMenuSessionMode( f1_local1, Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
