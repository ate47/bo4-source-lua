...
require( "ui/uieditor/widgets/systemoverlays/systemoverlay_democustomizehighlightreel_layout" ) --[[ @ 0]]

CoD.SystemOverlay_DemoCustomizeHighlightReel = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.SystemOverlay_DemoCustomizeHighlightReel = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "SystemOverlay_DemoCustomizeHighlightReel", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	self:setClass( CoD.SystemOverlay_DemoCustomizeHighlightReel ) --[[ @ 0]]
	...
	local layout = CoD.systemOverlay_DemoCustomizeHighlightReel_Layout.new( f1_local1, f1_arg0, 0, 1, 0, 0, 0.5, 0.5, -540, 540 ) --[[ @ 0]]
