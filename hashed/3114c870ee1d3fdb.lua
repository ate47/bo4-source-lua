...
CoD.WeaponOptionsUtility.GetWeaponOptionsTableForCategory = function ( f4_arg0, f4_arg1, f4_arg2, f4_arg3, f4_arg4, f4_arg5 )
	...
	local f4_local2 = Engine[@"hash_7B98952F69D937F9"]( f4_arg3, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f4_local1 ) --[[ @ 0]]
				...
				if f4_local11 and f4_local11.allocation:get() >= 0 then
					...
					if f4_local12 then
						...
						if f4_local15 == 0 and f4_local5 == 0 and f4_arg5 and f4_arg5 == true then
							for f4_local17 = Enum[@"weaponoptionfilter"][@"weaponoption_filter_first"] --[[ @ 0]], Enum[@"weaponoptionfilter"][@"weaponoption_filter_count"] - 1, 1 do
						...
						if f4_local17 then
							...
							if CoD.WeaponOptionFilterStringToEnum( f4_local17 ) == Enum[@"weaponoptionfilter"][@"weaponoption_filter_bm"] then
								local f4_local20 = Engine[@"converttoxhash"]( f4_local11.ref:get() ) --[[ @ 0]]
								...
								if not f4_local23 then
									f4_local23 = Enum[@"lootraritytype"][@"loot_rarity_type_count"] --[[ @ 0]]
								end
							...
							if (not f4_local18 or f4_local18 and not CoD.BlackMarketUtility.IsUnreleasedBlackMarketItem( f4_local18 ) and not CoD.BlackMarketUtility.IsUnavailableBlackMarketItem( f4_arg1, f4_local19 )) and not Engine[@"isweaponoptionlockedentitlement"]( f4_arg1, Enum[@"eattachment"][@"attachment_none"], f4_local8 ) then
									...
									if f4_local11.description:get() ~= @"hash_0" and f4_local21 and f4_local21 ~= @"hash_0" then
										...
										if f4_local23 then
											...
											elseif f4_local1 == Enum[@"emodes"][@"mode_zombies"] then
												...
												f4_local25 = f4_local23[@"revealstring"] --[[ @ 0]]
											end
											if f4_local25 then
								...
								if f4_local13 == "mstr" then
									...
									for f4_local21 = Enum[@"weaponoptionfilter"][@"weaponoption_filter_first"] --[[ @ 0]], Enum[@"weaponoptionfilter"][@"weaponoption_filter_count"] - 1, 1 do
	...
	local f4_local5 = function ( f6_arg0, f6_arg1 )
	 ...
	 --[[ @ 0]]
	local f4_local7 = f4_local5( f4_local0, CoD.WeaponOptionFilterToString( Enum[@"weaponoptionfilter"][@"weaponoption_filter_bm"] ) ) --[[ @ 0]]
	if f4_local7 then
...
CoD.WeaponOptionsUtility.GetPaintjobOptionsTable = function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
	...
	local f8_local2 = function ( f9_arg0, f9_arg1, f9_arg2, f9_arg3, f9_arg4, f9_arg5, f9_arg6 )
		...
		Engine[@"setmodelvalue"]( Engine[@"createmodel"]( f9_local0, "weaponOptionType" ), Enum[@"eweaponoptiongroup"][@"weaponoption_group_paintjob"] ) --[[ @ 0]]
		Engine[@"setmodelvalue"]( Engine[@"createmodel"]( f9_local0, "weaponOptionSubIndex" ), f9_arg2 ) --[[ @ 0]]
		Engine[@"setmodelvalue"]( Engine[@"createmodel"]( f9_local0, "customizationType" ), Enum[@"customizationtype"][@"customization_type_paintshop_view_left"] ) --[[ @ 0]]
		...
		LUI.CreateModelAndInitialize( f9_local0, "unlockSessionMode", Enum[@"emodes"][@"mode_invalid"] ) --[[ @ 0]]
	...
	if f8_local0 and (Engine[@"currentsessionmode"]() ~= Enum[@"emodes"][@"mode_zombies"] or Dvar[@"hash_1419D338C0DC384C"]:get()) then
		...
		if CoD.CACUtility.GetUnlockableItemInfo( f8_local3, Enum[@"emodes"][@"mode_multiplayer"] ) ~= nil then
			...
			f8_local2( f8_local1, @"hash_25E38D76F9A1A511", 1, Engine[@"hash_4F9F1239CFD921FE"]( @"hash_4DFFD9B8A1D5E6D4" ), "paintjob_create", "paintjob", Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
...
CoD.WeaponOptionsUtility.GetWeaponOptionsTable = function ( f10_arg0, f10_arg1, f10_arg2 )
	...
	if CoD.CACUtility.EmptyItemIndex < f10_local4 then
		f10_local0 = CoD.WeaponOptionsUtility.GetWeaponOptionsTableForCategory( f10_arg1.menu, f10_arg0, Enum[@"eweaponoptiongroup"][@"weaponoption_group_camo"], f10_local4, f10_local5, true ) --[[ @ 0]]
	end
	...
	if AllowWeaponPrestige( f10_local1 ) and (f10_local2 == "primary" or f10_local2 == "secondary") then
		...
		local f10_local9 = function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
			...
			f11_local6:set( Enum[@"eweaponoptiongroup"][@"weaponoption_group_invalid"] ) --[[ @ 0]]
			...
			f11_local6:set( Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
...
CoD.WeaponOptionsUtility.GetCamoWeaponOptionIndexFromCamoOptionsIndex = function ( f13_arg0 )
	...
	if f13_local1 then
		f13_local0 = Engine[@"tablelookup"]( CoD.attachmentTable, Enum[@"attachmenttablecolumn_e"][@"attachmenttable_column_index"], Enum[@"attachmenttablecolumn_e"][@"hash_2419575E672F6FA2"], f13_local1 ) --[[ @ 0]]
		if not f13_local0 then
			local f13_local2 = CoD.WeaponOptionsUtility.GetActiveCamoRefForCamoRef( Enum[@"emodes"][@"mode_multiplayer"], f13_local1 ) --[[ @ 0]]
			if f13_local2 and f13_local2 ~= @"hash_0" then
				...
				if f13_local3 and f13_local3.stages and f13_local3.stages[1] and f13_local3.stages[1][@"camooption"] then
					f13_local0 = Engine[@"tablelookup"]( CoD.attachmentTable, Enum[@"attachmenttablecolumn_e"][@"attachmenttable_column_index"], Enum[@"attachmenttablecolumn_e"][@"hash_2419575E672F6FA2"], f13_local3.stages[1][@"camooption"] ) --[[ @ 0]]
				end
			end
		end
	end
...
CoD.WeaponOptionsUtility.IsCamoWeaponOptionIndexActiveCamo = function ( f14_arg0 )
	local f14_local0 = Engine[@"tablelookup"]( CoD.attachmentTable, Enum[@"attachmenttablecolumn_e"][@"hash_2BE9816FAD8AD2D2"], Enum[@"attachmenttablecolumn_e"][@"attachmenttable_column_attachpoint"], "camo", Enum[@"attachmenttablecolumn_e"][@"attachmenttable_column_index"], f14_arg0 ) --[[ @ 0]]
...
DataSources.WeaponReticles = ListHelper_SetupDataSource( "WeaponReticles", function ( f35_arg0, f35_arg1 )
	...
	local f35_local6 = CoD.CACUtility.weaponOptionGroupNames[Enum[@"eweaponoptiongroup"][@"weaponoption_group_reticle"]] --[[ @ 0]]
	...
	if f35_local7 and f35_local8 then
		f35_local0 = CoD.WeaponOptionsUtility.GetWeaponOptionsTableForCategory( f35_arg1.menu, f35_arg0, Enum[@"eweaponoptiongroup"][@"weaponoption_group_reticle"], f35_local7, f35_local8, true ) --[[ @ 0]]
	end
	...
	if f35_local11 and f35_local9 then
		...
		if f35_local12 then
			...
			local f35_local14 = CoD.CACUtility.weaponOptionGroupNames[Enum[@"eweaponoptiongroup"][@"weaponoption_group_reticle"]] --[[ @ 0]]
				...
				if f35_local32 == f35_local13 then
					...
					if not f35_local18 then
						...
						if not f35_local20 then
							f35_local20 = Engine[@"converttoxhash"]( "reticle_" .. f35_local9 .. "_" .. f35_local31 ) --[[ @ 0]]
						end
						...
						if f35_local21.available or f35_local22 and Engine[@"hasentitlement"]( f35_arg0, f35_local22 ) then
							...
							f35_local26.weaponOptionType = Enum[@"eweaponoptiongroup"][@"weaponoption_group_reticle"] --[[ @ 0]]
									...
									if not f35_local21 then
										...
										if f35_local30 then
											...
											if not f35_local21 then
												...
												f35_local20.weaponOptionType = Enum[@"eweaponoptiongroup"][@"weaponoption_group_reticle"] --[[ @ 0]]
...
DataSources.WeaponReticleColor = ListHelper_SetupDataSource( "WeaponReticleColor", function ( f36_arg0, f36_arg1 )
	...
	if f36_local4 and f36_local3 then
		...
		local f36_local8 = CoD.CACUtility.weaponOptionGroupNames[Enum[@"eweaponoptiongroup"][@"weaponoption_group_reticle"]] --[[ @ 0]]
...
DataSources.WeaponOptionsGroups = ListHelper_SetupDataSource( "WeaponOptionsGroups", function ( f37_arg0, f37_arg1 )
	...
	local f37_local7 = CoD.CACUtility.GetUnlockableItemInfo( f37_local5, Enum[@"emodes"][@"mode_multiplayer"] ) ~= nil --[[ @ 0]]
	local f37_local8 = CoD.CACUtility.GetUnlockableItemInfo( f37_local5, Enum[@"emodes"][@"mode_warzone"] ) ~= nil --[[ @ 0]]
	local f37_local9 = CoD.CACUtility.GetUnlockableItemInfo( f37_local5, Enum[@"emodes"][@"mode_zombies"] ) ~= nil --[[ @ 0]]
...
DataSources.ActiveCamoStagesList = DataSourceHelpers.ListSetup( "ActiveCamoStagesList", function ( f42_arg0, f42_arg1 )
	...
	local f42_local4 = CoD.WeaponOptionsUtility.GetActiveCamoRefForCamoRef( f42_local1, type( f42_local3 ) and Engine[@"converttoxhash"]( f42_local3 ) or f42_local3 ) --[[ @ 0]]
		...
		if f42_local5 and f42_local5.stages then
			...
			for f42_local8 = f42_local7 --[[ @ 0]], #f42_local5.stages, 1 do
				...
				if not f42_local12[@"disabled"] or f42_local12[@"disabled"] ~= 1 then
					local f42_local13 = Engine[@"tablelookup"]( CoD.CACUtility.CamoOptionsTable, Enum[@"hash_25DD5CC8AEA7314B"][@"hash_6A6342D60A0D5AAE"], Enum[@"hash_25DD5CC8AEA7314B"][@"hash_3AA94CABDA68EB21"], f42_local12[@"camooption"] ) --[[ @ 0]]
	...
	if f46_local5 then
		for f46_local16, f46_local17 in ipairs( f46_local5 ) --[[ @ 0]] do
			if f46_local16 ~= 1 then
				local f46_local9 = CoD.BlackMarketTableUtility.LootInfoLookup( f46_arg0, f46_local17[@"lootid"], f46_local17[@"entitlement"], f46_local4 ) --[[ @ 0]]
				...
				if f46_local9.owned and f46_local10 then
					...
					if not f46_local15 then
						f46_local15 = Enum[@"lootraritytype"][@"loot_rarity_type_count"] --[[ @ 0]]
					end
	...
	if f49_local5 then
		for f49_local17, f49_local18 in ipairs( f49_local5 ) --[[ @ 0]] do
			if f49_local17 ~= 1 then
				local f49_local9 = CoD.BlackMarketTableUtility.LootInfoLookup( f49_arg0, f49_local18[@"lootid"], f49_local18[@"entitlement"], f49_local4 ) --[[ @ 0]]
				...
				if f49_local9.owned and f49_local10 then
					...
					if f49_local11 then
						...
						local f49_local16 = f49_local18[@"icon"] --[[ @ 0]]
						...
						if not f49_local16 then
							f49_local16 = Enum[@"lootraritytype"][@"loot_rarity_type_count"] --[[ @ 0]]
						end
...
CoD.WeaponOptionsUtility.IsItemWeaponOptionLocked = function ( f56_arg0, f56_arg1, f56_arg2 )
	...
	if f56_local2 == "active" or f56_local2 == "lootbase" then
		...
		local f56_local4 = f56_local3 and Engine[@"converttoxhash"]( f56_local3 ) --[[ @ 0]]
		local f56_local5 --[[ @ 0]]
		if f56_local4 then
				...
				if f63_local7 then
					for f63_local17, f63_local18 in pairs( Engine[@"hash_79F0BB7D52A7A978"]( f63_local7 ) ) --[[ @ 0]] do
						if f63_local18[@"index"] == f63_local8 then
							...
							if f63_local14 then
								f63_local14 = Engine[@"converttoxhash"]( f63_local14 ) --[[ @ 0]]
							end
							...
							if f63_local15 and f63_local15.available and not f63_local15.owned then
								...
								local f63_local16 --[[ @ 0]]
								if f63_local18[@"entitlement"] ~= @"hash_0" then
									f63_local16 = Engine[@"hasentitlement"]( f63_arg2, f63_local18[@"entitlement"] ) --[[ @ 0]]
								else
									f63_local16 = true --[[ @ 0]]
								end
							end
	...
	if f84_local0 then
		...
		if f84_local1 == Enum[@"emodes"][@"mode_multiplayer"] then
			...
			if f84_local10 ~= CoD.CACUtility.EmptyItemIndex and f84_local9[f84_local10 + 1] then
				f84_local4 = Engine[@"hash_4F9F1239CFD921FE"]( f84_local9[f84_local10 + 1][@"displayname"] ) --[[ @ 0]]
			end
		end
...
CoD.WeaponOptionsUtility.SetWeaponOptionClassItem = function ( f92_arg0, f92_arg1, f92_arg2, f92_arg3 )
	...
	if f92_local5 and f92_local6 and f92_local7 then
		...
		local f92_local11 = Engine[@"hash_7B98952F69D937F9"]( CoD.GetCustomization( f92_arg2, "weapon_index" ), Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f92_local1 ) --[[ @ 0]]
...
CoD.WeaponOptionsUtility.PreviewSignatureWeaponTheme = function ( f96_arg0, f96_arg1, f96_arg2 )
	...
	local f96_local3 = Engine[@"hash_7B98952F69D937F9"]( CoD.GetCustomization( f96_arg2, "weapon_index" ), Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f96_local1 ) --[[ @ 0]]
...
CoD.WeaponOptionsUtility.ClearWeaponOptions = function ( f98_arg0, f98_arg1, f98_arg2 )
	...
	local f98_local3 = Engine[@"hash_7B98952F69D937F9"]( CoD.GetCustomization( f98_arg2, "weapon_index" ), Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f98_local1 ) --[[ @ 0]]
	...
	if f98_local18 then
		...
		if not f98_local19 then
			...
			if f98_local10 and f98_local19 == Enum[@"eweaponoptiongroup"][@"weaponoption_group_paintjob"] then
				f98_local10:set( Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
				CoD.CACUtility.SetClassItem( f98_arg2, f98_local5, f98_local6 .. ".paintjobSlot", Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
			end
	...
	f98_local19 = Enum[@"eweaponoptiongroup"][@"weaponoption_group_invalid"] --[[ @ 0]]
end
 --[[ @ 0]]
CoD.WeaponOptionsUtility.SetBaseWeaponOptions = function ( f99_arg0, f99_arg1, f99_arg2 )
	...
	local f99_local3 = Engine[@"hash_7B98952F69D937F9"]( CoD.GetCustomization( f99_arg2, "weapon_index" ), Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f99_local1 ) --[[ @ 0]]
...
CoD.WeaponOptionsUtility.EquipWeaponAccessory = function ( f112_arg0, f112_arg1, f112_arg2, f112_arg3 )
	...
	if f112_local0 then
		...
		Engine[@"saveloadout"]( f112_arg2, f112_local1 ) --[[ @ 0]]
