	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f3_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "", Enum[@"LUIButtonPromptStates"][@"hash_242F62C12777D074"] ) --[[ @ 0]]
				if f3_local0 then
		...
		},
		{
			stateName = "Enabled",
			condition = function ( menu, element, event )
				local f4_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "", Enum[@"LUIButtonPromptStates"][@"hash_5901DFC093ED4187"] ) --[[ @ 0]]
				if f4_local0 then
					f4_local0 = IsGamepad( f1_arg1 ) --[[ @ 0]]
					if f4_local0 then
						f4_local0 = CoD.ModelUtility.IsSelfModelValueEnumFlagSet( element, f1_arg1, "flags", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"] ) --[[ @ 0]]
					end
				end
				return f4_local0
			end
		},
		{
			...
			condition = function ( menu, element, event )
				local f5_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "", Enum[@"LUIButtonPromptStates"][@"hash_242F62C12777D074"] ) --[[ @ 0]]
				if f5_local0 then
					if not IsGamepad( f1_arg1 ) and not ShouldHideButtonPromptForPC( element, f1_arg1 ) then
						f5_local0 = CoD.ModelUtility.IsSelfModelValueEnumFlagSet( element, f1_arg1, "flags", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"] ) --[[ @ 0]]
						if f5_local0 then
							f5_local0 = IsPC() --[[ @ 0]]
						end
					else
		...
		},
		{
			stateName = "EnabledPC",
			condition = function ( menu, element, event )
				local f6_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "", Enum[@"LUIButtonPromptStates"][@"hash_5901DFC093ED4187"] ) --[[ @ 0]]
				if f6_local0 then
					if not IsGamepad( f1_arg1 ) and not ShouldHideButtonPromptForPC( element, f1_arg1 ) then
