...
CoD.CallingCards_Asset_vortex = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.CallingCards_Asset_vortex.__defaultWidth = 512 --[[ @ 0]]
CoD.CallingCards_Asset_vortex.__defaultHeight = 512 --[[ @ 0]]
CoD.CallingCards_Asset_vortex.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.CallingCards_Asset_vortex ) --[[ @ 0]]
	self.id = "CallingCards_Asset_vortex" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local vortex = LUI.UIImage.new( 0, 0, 0, 512, 0, 0, 0, 512 ) --[[ @ 0]]
	vortex:setImage( RegisterImage( @"uie_vortex" ) ) --[[ @ 0]]
		...
		DefaultClip = function ( f3_arg0, f3_arg1 )
			...
			local f3_local0 = function ( f4_arg0 )
				local f4_local0 = function ( f5_arg0 )
				 ...
				 --[[ @ 0]]
				f3_arg0.vortex:beginAnimation( 1000 ) --[[ @ 0]]
				f3_arg0.vortex:setZRot( 90 ) --[[ @ 0]]
				f3_arg0.vortex:registerEventHandler( "interrupted_keyframe", f3_arg0.clipInterrupted ) --[[ @ 0]]
				f3_arg0.vortex:registerEventHandler( "transition_complete_keyframe", f4_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f3_arg0.vortex:completeAnimation() --[[ @ 0]]
			f3_arg0.vortex:setZRot( 0 ) --[[ @ 0]]
			f3_local0( f3_arg0.vortex ) --[[ @ 0]]
