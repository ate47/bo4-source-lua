...
CoD.WZObituaryVictim = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.WZObituaryVictim.__defaultWidth = 168 --[[ @ 0]]
CoD.WZObituaryVictim.__defaultHeight = 26 --[[ @ 0]]
CoD.WZObituaryVictim.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.WZObituaryVictim ) --[[ @ 0]]
	self.id = "WZObituaryVictim" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local Icon = CoD.WZObituaryTeamIcon.new( f1_arg0, f1_arg1, 0, 0, 12, 38, 0, 0, 1, 27 ) --[[ @ 0]]
	Icon:setAlpha( 0 ) --[[ @ 0]]
	Icon.Backer.__TeamColor = function ( f2_arg0 )
	 ...
	 --[[ @ 0]]
	Icon:linkToElementModel( self, "victimClientNum", true, Icon.Backer.__TeamColor ) --[[ @ 0]]
	Icon.Backer.__TeamColor_FullPath = function ()
		local f3_local0 = self:getModel() --[[ @ 0]]
		if f3_local0 then
			f3_local0 = self:getModel() --[[ @ 0]]
			f3_local0 = f3_local0.victimClientNum --[[ @ 0]]
		end
		if f3_local0 then
	...
	local Name = LUI.UIText.new( 0, 0, 42, 210, 0.48, 0.48, -12.5, 13.5 ) --[[ @ 0]]
	...
	Name.__Color = function ( f5_arg0 )
	 ...
	 --[[ @ 0]]
	Name:linkToElementModel( self, "victimColor", true, Name.__Color ) --[[ @ 0]]
	Name.__Color_FullPath = function ()
		local f6_local0 = self:getModel() --[[ @ 0]]
		if f6_local0 then
			f6_local0 = self:getModel() --[[ @ 0]]
			f6_local0 = f6_local0.victimColor --[[ @ 0]]
		end
		if f6_local0 then
