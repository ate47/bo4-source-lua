...
CoD.AbilityHoldToActivate = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AbilityHoldToActivate.__defaultWidth = 200 --[[ @ 0]]
CoD.AbilityHoldToActivate.__defaultHeight = 49 --[[ @ 0]]
CoD.AbilityHoldToActivate.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AbilityHoldToActivate ) --[[ @ 0]]
	self.id = "AbilityHoldToActivate" --[[ @ 0]]
	...
	HeroAbilityHoldString:setText( LocalizeToUpperString( @"hash_10F22A2FAE6154A8" ) ) --[[ @ 0]]
	HeroAbilityHoldString:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	HeroAbilityHoldString:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	HeroAbilityHoldString:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	f1_local7( f1_local6, f1_local8["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"]], function ( f9_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local7 = self.subscribeToModel --[[ @ 0]]
	f1_local8 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local7( f1_local6, f1_local8["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_624E603C16FCC38F"]], function ( f10_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
...
CoD.AbilityHoldToActivate.__resetProperties = function ( f11_arg0 )
	...
	f11_arg0.HeroAbilityHoldString:setText( LocalizeToUpperString( @"hash_10F22A2FAE6154A8" ) ) --[[ @ 0]]
...
CoD.AbilityHoldToActivate.__clipsPerState = {
	...
	VisibleInUse = {
		DefaultClip = function ( f15_arg0, f15_arg1 )
			...
			f15_arg0.HeroAbilityHoldString:setText( LocalizeToUpperString( "DESTROY" ) ) --[[ @ 0]]
