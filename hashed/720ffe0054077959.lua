...
CoD.EmblemEditorGradientColorSwatch.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	lastSavedColor:registerEventHandler( "gain_focus", function ( element, event )
		...
		if CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg1, "Emblem.EmblemProperties.colorNum", Enum[@"CustomizationColorNum"][@"hash_32EFDD03AB2AE52D"] ) then
			CoD.CraftUtility.EmblemChooseColor_SelectionChanged( self, element, f1_arg1 ) --[[ @ 0]]
			SetProperty( self, "isColor0NoColor", false ) --[[ @ 0]]
		elseif CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg1, "Emblem.EmblemProperties.colorNum", Enum[@"CustomizationColorNum"][@"hash_32EFDC03AB2AE37A"] ) then
			CoD.CraftUtility.EmblemChooseColor_SelectionChanged( self, element, f1_arg1 ) --[[ @ 0]]
	...
	self:mergeStateConditions( {
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				return CoD.CraftUtility.IsEmblemEditorPropertyEqualTo( f1_arg1, "isGradientMode", 1 ) and CoD.CraftUtility.IsEmblemEditorPropertyEqualToEnum( f1_arg1, "colorMode", Enum[@"CustomizationColorMode"][@"hash_4E692F9BF30BA124"] )
			end
		}
	} ) --[[ @ 0]]
