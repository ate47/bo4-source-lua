...
CoD.ItemShopFrameInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	FeaturedItems:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( FeaturedItems, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		OpenOverlay( self, "ItemShopDetails", controller, {
			_model = element:getModel()
		} ) --[[ @ 0]]
		PlaySoundAlias( "uin_toggle_generic" ) --[[ @ 0]]
	...
	TextBox2:setText( LocalizeToUpperString( @"hash_5169F716D6484E8A" ) ) --[[ @ 0]]
	...
	TextBox:setText( LocalizeToUpperString( @"hash_2DE9B59A6E570A4B" ) ) --[[ @ 0]]
