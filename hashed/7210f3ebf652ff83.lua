...
require( "x64:9e2dbe056616c47" ) --[[ @ 0]]

CoD.StartMenu_Options_PC_Chat_TabContent = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.StartMenu_Options_PC_Chat_TabContent.__defaultWidth = 1885 --[[ @ 0]]
CoD.StartMenu_Options_PC_Chat_TabContent.__defaultHeight = 812 --[[ @ 0]]
CoD.StartMenu_Options_PC_Chat_TabContent.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.StartMenu_Options_PC_Chat_TabContent ) --[[ @ 0]]
	self.id = "StartMenu_Options_PC_Chat_TabContent" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	self.onlyChildrenFocusable = true --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local SubOptionsNavigation1 = CoD.StartMenu_Options_PC_ChatOptions_SubOptionsNavigation.new( f1_arg0, f1_arg1, 0, 0, 422, 1885, 0, 0, 0, 716 ) --[[ @ 0]]
