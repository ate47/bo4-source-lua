...
CoD.SpecialEventUtility.GetCurrentSpecialEventInfo = function ()
	return CoD.SpecialEventUtility.GetSpecialEventInfo( Engine[@"hash_622EAAB59AA27E9B"]( @"zm_active_event_calling" ) )
end
 --[[ @ 0]]
	...
	getModel = function ( f5_arg0 )
		...
		if f5_local17 then
			...
			if f5_local19 then
				...
				local f5_local24 = f5_local23[@"hash_7EA461D5E8A182EA"] --[[ @ 0]]
				...
				local f5_local34 = f5_local30.event[@"hash_255FF29A262A17DC"] --[[ @ 0]]
	...
	if f6_local2 then
		table.insert( f6_local0, {
			models = {
				...
				rewardText = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D6137AA2004DB90", f6_local2.xp )
			}
		} ) --[[ @ 0]]
	end
...
CoD.SpecialEventUtility.GetSpecialEventRewardModels = function ( f10_arg0, f10_arg1, f10_arg2 )
	...
	if CoD.BaseUtility.IsDvarEnabled( "ui_specialEventAAROverride" ) then
		f10_local1 = Engine[@"hash_622EAAB59AA27E9B"]( @"zm_active_event_calling" ) --[[ @ 0]]
	...
	if f10_local2 and f10_local4 then
		...
		for f10_local9 = f10_local5 --[[ @ 0]], f10_local7 - 1, 1 do
			...
			if f10_local13 then
				...
				f10_local12.mainTitle = f10_local8.event[@"hash_255FF29A262A17DC"] --[[ @ 0]]
				f10_local12.levelText = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_E7E238DA43A9CC9", Engine[@"hash_4F9F1239CFD921FE"]( f10_local14[@"hash_47598EB883D65047"] ) ) --[[ @ 0]]
			...
			f10_local12.totalXP = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D6137AA2004DB90", f10_local13.xp ) --[[ @ 0]]
