...
CoD.fe_RightContainerWithoutRightBoxes = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.fe_RightContainerWithoutRightBoxes.__defaultWidth = 1305 --[[ @ 0]]
CoD.fe_RightContainerWithoutRightBoxes.__defaultHeight = 48 --[[ @ 0]]
CoD.fe_RightContainerWithoutRightBoxes.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.fe_RightContainerWithoutRightBoxes ) --[[ @ 0]]
	self.id = "fe_RightContainerWithoutRightBoxes" --[[ @ 0]]
	...
	local FooterButtonDoublePrompts = CoD.FooterButtonDoublePrompts.new( f1_arg0, f1_arg1, 1, 1, -301, -28, 1, 1, -48, 0 ) --[[ @ 0]]
	...
	local Padbtn = CoD.FooterButtonPrompt.new( f1_arg0, f1_arg1, 1, 1, -542, -301, 1, 1, -48, 0 ) --[[ @ 0]]
	...
	Padbtn:linkToElementModel( self, "" .. Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"], false, function ( model )
		Padbtn:setModel( model, f1_arg1 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:addElement( Padbtn ) --[[ @ 0]]
	self.Padbtn = Padbtn --[[ @ 0]]
	
	local RJoystickbtn = CoD.FooterButtonPrompt.new( f1_arg0, f1_arg1, 1, 1, -678, -542, 1, 1, -48, 0 ) --[[ @ 0]]
...
CoD.fe_RightContainerWithoutRightBoxes.__resetProperties = function ( f9_arg0 )
	f9_arg0.RJoystickbtn:completeAnimation() --[[ @ 0]]
	f9_arg0.RJoystickbtn:setLeftRight( 1, 1, -678, -542 ) --[[ @ 0]]
	f9_arg0.RJoystickbtn:setTopBottom( 1, 1, -48, 0 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.fe_RightContainerWithoutRightBoxes.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f10_arg0, f10_arg1 )
			...
			f10_arg0.RJoystickbtn:completeAnimation() --[[ @ 0]]
			f10_arg0.RJoystickbtn:setLeftRight( 1, 1, -676, -542 ) --[[ @ 0]]
			f10_arg0.RJoystickbtn:setTopBottom( 1, 1, -48, 0 ) --[[ @ 0]]
			f10_arg0.clipFinished( f10_arg0.RJoystickbtn ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.fe_RightContainerWithoutRightBoxes.__onClose = function ( f11_arg0 )
	f11_arg0.FooterButtonDoublePrompts:close() --[[ @ 0]]
	f11_arg0.Padbtn:close() --[[ @ 0]]
	f11_arg0.RJoystickbtn:close() --[[ @ 0]]
end
 --[[ @ 0]]
