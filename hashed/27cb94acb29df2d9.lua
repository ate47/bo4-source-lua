...
CoD.ItemShopRarityBackgroundStream_Epic = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.ItemShopRarityBackgroundStream_Epic.__defaultWidth = 600 --[[ @ 0]]
CoD.ItemShopRarityBackgroundStream_Epic.__defaultHeight = 600 --[[ @ 0]]
CoD.ItemShopRarityBackgroundStream_Epic.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.ItemShopRarityBackgroundStream_Epic ) --[[ @ 0]]
	self.id = "ItemShopRarityBackgroundStream_Epic" --[[ @ 0]]
	...
	RadialGlow2:setImage( RegisterImage( @"hash_58F71B593239CEE7" ) ) --[[ @ 0]]
	RadialGlow2:setMaterial( LUI.UIImage.GetCachedMaterial( @"ui_add" ) ) --[[ @ 0]]
	RadialGlow2:linkToElementModel( self, "rarity", true, function ( model )
		local f4_local0 = model:get() --[[ @ 0]]
		if f4_local0 ~= nil then
			RadialGlow2:setRGB( CoD.BlackMarketUtility.LootRarityToColor( f4_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	BGPatternThin:linkToElementModel( self, "rarity", true, function ( model )
		...
		if f5_local0 ~= nil then
			BGPatternThin:setRGB( CoD.BlackMarketUtility.LootRarityToColorBright( f5_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
