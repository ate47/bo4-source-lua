...
CoD.AARRewardsDynamicXP = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AARRewardsDynamicXP.__defaultWidth = 380 --[[ @ 0]]
CoD.AARRewardsDynamicXP.__defaultHeight = 94 --[[ @ 0]]
CoD.AARRewardsDynamicXP.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARRewardsDynamicXP ) --[[ @ 0]]
	self.id = "AARRewardsDynamicXP" --[[ @ 0]]
	...
	local CommonXpIcon = CoD.CommonXpIcon.new( f1_arg0, f1_arg1, 0, 0, 30, 80, 0, 0, 22, 72 ) --[[ @ 0]]
