...
LUI.createMenu.PurchaseBribeStack = function ( f1_arg0, f1_arg1 )
	...
	self.FullscreenPopupTemplate:linkToElementModel( self, "name", true, function ( model )
		...
		if f14_local0 ~= nil then
			FullscreenPopupTemplate.Title:setText( ToUpper( LocalizeIntoString( @"menu/acquire_item", f14_local0 ) ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	...
	if IsPC() and IsElementInState( self.FullscreenPopupTemplate, "ErrorState" ) then
		CoD.PCUtility.LinkPCSmallCloseButtonToInput( f1_local1, f1_arg0, f1_local13, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	elseif IsPC() then
