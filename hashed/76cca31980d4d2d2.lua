...
CoD.HUD_ZM_ServerPauseNotification.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	Paused:setAlpha( 0 ) --[[ @ 0]]
	Paused:setText( LocalizeToUpperString( @"menu/paused" ) ) --[[ @ 0]]
	Paused:setTTF( "ttmussels_demibold" ) --[[ @ 0]]
	Paused:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	Paused:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
