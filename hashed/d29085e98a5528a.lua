...
CoD.AARTierRewardShowcaseInternalCommon = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCommon.__defaultWidth = 310 --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCommon.__defaultHeight = 632 --[[ @ 0]]
CoD.AARTierRewardShowcaseInternalCommon.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AARTierRewardShowcaseInternalCommon ) --[[ @ 0]]
	self.id = "AARTierRewardShowcaseInternalCommon" --[[ @ 0]]
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not CoD.ModelUtility.IsSelfModelValueTrue( element, f1_arg1, "unlocked" ) then
					f11_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"loot_rarity_type_common"] ) --[[ @ 0]]
				else
					f11_local0 = false --[[ @ 0]]
				end
				return f11_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f12_local0 then
					f12_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"loot_rarity_type_common"] ) --[[ @ 0]]
					if f12_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f13_local0 then
					f13_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"loot_rarity_type_common"] ) --[[ @ 0]]
					if f13_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f14_local0 then
					f14_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "rarity", Enum[@"lootraritytype"][@"loot_rarity_type_common"] ) --[[ @ 0]]
					if f14_local0 then
...
CoD.AARTierRewardShowcaseInternalCommon.__resetProperties = function ( f21_arg0 )
	f21_arg0.BGWidgetCommon:completeAnimation() --[[ @ 0]]
	...
	f21_arg0.BGWidgetCommon:setAlpha( 1 ) --[[ @ 0]]
	f21_arg0.BGWidgetCommon:setScale( 1, 1 ) --[[ @ 0]]
...
CoD.AARTierRewardShowcaseInternalCommon.__clipsPerState = {
	...
	Empty = {
		DefaultClip = function ( f23_arg0, f23_arg1 )
			...
			f23_arg0.BGWidgetCommon:completeAnimation() --[[ @ 0]]
			f23_arg0.BGWidgetCommon:setAlpha( 0 ) --[[ @ 0]]
			f23_arg0.clipFinished( f23_arg0.BGWidgetCommon ) --[[ @ 0]]
	...
	Locked = {
		DefaultClip = function ( f24_arg0, f24_arg1 )
			...
			f24_arg0.BGWidgetCommon:completeAnimation() --[[ @ 0]]
			f24_arg0.BGWidgetCommon:setAlpha( 0 ) --[[ @ 0]]
			f24_arg0.clipFinished( f24_arg0.BGWidgetCommon ) --[[ @ 0]]
		...
		DefaultState = function ( f25_arg0, f25_arg1 )
			...
			local f25_local0 = function ( f26_arg0 )
				local f26_local0 = function ( f27_arg0 )
				 ...
				 --[[ @ 0]]
				f25_arg0.BGWidgetCommon:beginAnimation( 200 ) --[[ @ 0]]
				f25_arg0.BGWidgetCommon:setAlpha( 0.67 ) --[[ @ 0]]
				f25_arg0.BGWidgetCommon:setScale( 0.8, 0.8 ) --[[ @ 0]]
			...
			f25_arg0.BGWidgetCommon:setScale( 4, 4 ) --[[ @ 0]]
			...
			f25_arg0.Sound:playSound( "uin_mtx_item_get_common", f25_arg1 ) --[[ @ 0]]
			...
			f25_arg0.GlowAnim:beginAnimation( 300 ) --[[ @ 0]]
		...
		Contraband = function ( f31_arg0, f31_arg1 )
			...
			local f31_local0 = function ( f32_arg0 )
				local f32_local0 = function ( f33_arg0 )
				 ...
				 --[[ @ 0]]
				f31_arg0.ContrabandFull:beginAnimation( 200 ) --[[ @ 0]]
				f31_arg0.ContrabandFull:setAlpha( 1 ) --[[ @ 0]]
				f31_arg0.ContrabandFull:setScale( 0.8, 0.8 ) --[[ @ 0]]
				f31_arg0.ContrabandFull:registerEventHandler( "interrupted_keyframe", f31_arg0.clipInterrupted ) --[[ @ 0]]
				f31_arg0.ContrabandFull:registerEventHandler( "transition_complete_keyframe", f32_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f31_arg0.ContrabandFull:completeAnimation() --[[ @ 0]]
			f31_arg0.ContrabandFull:setAlpha( 0 ) --[[ @ 0]]
			f31_arg0.ContrabandFull:setScale( 4, 4 ) --[[ @ 0]]
			f31_local0( f31_arg0.ContrabandFull ) --[[ @ 0]]
			local f31_local1 = function ( f36_arg0 )
				local f36_local0 = function ( f37_arg0 )
				 ...
				 --[[ @ 0]]
				f31_arg0.BGWidgetCommon:beginAnimation( 790 ) --[[ @ 0]]
				f31_arg0.BGWidgetCommon:registerEventHandler( "interrupted_keyframe", f31_arg0.clipInterrupted ) --[[ @ 0]]
				f31_arg0.BGWidgetCommon:registerEventHandler( "transition_complete_keyframe", f36_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f31_arg0.BGWidgetCommon:completeAnimation() --[[ @ 0]]
			f31_arg0.BGWidgetCommon:setAlpha( 0 ) --[[ @ 0]]
			f31_local1( f31_arg0.BGWidgetCommon ) --[[ @ 0]]
			local f31_local2 = function ( f38_arg0 )
				local f38_local0 = function ( f39_arg0 )
				 ...
				 --[[ @ 0]]
				f31_arg0.CoreWidgetUniversal:beginAnimation( 790 ) --[[ @ 0]]
				f31_arg0.CoreWidgetUniversal:registerEventHandler( "interrupted_keyframe", f31_arg0.clipInterrupted ) --[[ @ 0]]
				f31_arg0.CoreWidgetUniversal:registerEventHandler( "transition_complete_keyframe", f38_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f31_arg0.CoreWidgetUniversal:completeAnimation() --[[ @ 0]]
			f31_arg0.CoreWidgetUniversal:setAlpha( 0 ) --[[ @ 0]]
			f31_local2( f31_arg0.CoreWidgetUniversal ) --[[ @ 0]]
			f31_arg0.Sound:completeAnimation() --[[ @ 0]]
			f31_arg0.Sound:setPlaySoundDirect( true ) --[[ @ 0]]
			f31_arg0.Sound:playSound( "uin_mtx_item_get_common", f31_arg1 ) --[[ @ 0]]
			f31_arg0.clipFinished( f31_arg0.Sound ) --[[ @ 0]]
			f31_arg0.AARTierRewardDupeIndicator:completeAnimation() --[[ @ 0]]
			f31_arg0.AARTierRewardDupeIndicator:setAlpha( 0 ) --[[ @ 0]]
			f31_arg0.clipFinished( f31_arg0.AARTierRewardDupeIndicator ) --[[ @ 0]]
			f31_arg0.GlowAnim:beginAnimation( 700 ) --[[ @ 0]]
			f31_arg0.GlowAnim:registerEventHandler( "interrupted_keyframe", f31_arg0.clipInterrupted ) --[[ @ 0]]
		...
		Reroll = function ( f41_arg0, f41_arg1 )
			...
			local f41_local0 = function ( f42_arg0 )
				local f42_local0 = function ( f43_arg0 )
				 ...
				 --[[ @ 0]]
				f41_arg0.Rerolled:beginAnimation( 140 ) --[[ @ 0]]
				f41_arg0.Rerolled:registerEventHandler( "interrupted_keyframe", f41_arg0.clipInterrupted ) --[[ @ 0]]
				f41_arg0.Rerolled:registerEventHandler( "transition_complete_keyframe", f42_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f41_arg0.Rerolled:completeAnimation() --[[ @ 0]]
			f41_arg0.Rerolled:setAlpha( 0 ) --[[ @ 0]]
			f41_local0( f41_arg0.Rerolled ) --[[ @ 0]]
			local f41_local1 = function ( f47_arg0 )
				local f47_local0 = function ( f48_arg0 )
					f48_arg0:beginAnimation( 10 ) --[[ @ 0]]
					f48_arg0:setAlpha( 1 ) --[[ @ 0]]
					f48_arg0:registerEventHandler( "transition_complete_keyframe", f41_arg0.clipFinished ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f41_arg0.BGWidgetCommon:beginAnimation( 130 ) --[[ @ 0]]
				f41_arg0.BGWidgetCommon:registerEventHandler( "interrupted_keyframe", f41_arg0.clipInterrupted ) --[[ @ 0]]
				f41_arg0.BGWidgetCommon:registerEventHandler( "transition_complete_keyframe", f47_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f41_arg0.BGWidgetCommon:completeAnimation() --[[ @ 0]]
			f41_arg0.BGWidgetCommon:setAlpha( 0 ) --[[ @ 0]]
			f41_local1( f41_arg0.BGWidgetCommon ) --[[ @ 0]]
			local f41_local2 = function ( f49_arg0 )
				local f49_local0 = function ( f50_arg0 )
					f50_arg0:beginAnimation( 10 ) --[[ @ 0]]
					f50_arg0:setAlpha( 1 ) --[[ @ 0]]
					f50_arg0:registerEventHandler( "transition_complete_keyframe", f41_arg0.clipFinished ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f41_arg0.CoreWidgetUniversal:beginAnimation( 130 ) --[[ @ 0]]
				f41_arg0.CoreWidgetUniversal:registerEventHandler( "interrupted_keyframe", f41_arg0.clipInterrupted ) --[[ @ 0]]
				f41_arg0.CoreWidgetUniversal:registerEventHandler( "transition_complete_keyframe", f49_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f41_arg0.CoreWidgetUniversal:completeAnimation() --[[ @ 0]]
			f41_arg0.CoreWidgetUniversal:setAlpha( 0 ) --[[ @ 0]]
			f41_local2( f41_arg0.CoreWidgetUniversal ) --[[ @ 0]]
			f41_arg0.Sound:completeAnimation() --[[ @ 0]]
			f41_arg0.Sound:setPlaySoundDirect( true ) --[[ @ 0]]
			f41_arg0.Sound:playSound( "uin_mtx_item_reroll", f41_arg1 ) --[[ @ 0]]
			f41_arg0.clipFinished( f41_arg0.Sound ) --[[ @ 0]]
			local f41_local3 = function ( f51_arg0 )
				local f51_local0 = function ( f52_arg0 )
					local f52_local0 = function ( f53_arg0 )
						local f53_local0 = function ( f54_arg0 )
							local f54_local0 = function ( f55_arg0 )
								f55_arg0:playClip( "ReRolling" ) --[[ @ 0]]
							 ...
							 --[[ @ 0]]
							f54_arg0:playClip( "Dupe" ) --[[ @ 0]]
							f54_arg0:beginAnimation( 499 ) --[[ @ 0]]
					 ...
					 --[[ @ 0]]
					f52_arg0:beginAnimation( 190 ) --[[ @ 0]]
					f52_arg0:registerEventHandler( "transition_complete_keyframe", f52_local0 ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f41_arg0.AARTierRewardDupeIndicator:beginAnimation( 140 ) --[[ @ 0]]
				f41_arg0.AARTierRewardDupeIndicator:registerEventHandler( "interrupted_keyframe", f41_arg0.clipInterrupted ) --[[ @ 0]]
				f41_arg0.AARTierRewardDupeIndicator:registerEventHandler( "transition_complete_keyframe", f51_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f41_arg0.AARTierRewardDupeIndicator:completeAnimation() --[[ @ 0]]
			f41_arg0.AARTierRewardDupeIndicator:setAlpha( 0 ) --[[ @ 0]]
			f41_local3( f41_arg0.AARTierRewardDupeIndicator ) --[[ @ 0]]
			f41_arg0.GlowAnim:completeAnimation() --[[ @ 0]]
			f41_arg0.GlowAnim:playClip( "Trigger" ) --[[ @ 0]]
			f41_arg0.clipFinished( f41_arg0.GlowAnim ) --[[ @ 0]]
		end,
		Dupe = function ( f57_arg0, f57_arg1 )
			f57_arg0:__resetProperties() --[[ @ 0]]
			f57_arg0:setupElementClipCounter( 5 ) --[[ @ 0]]
			f57_arg0.Rerolled:completeAnimation() --[[ @ 0]]
			f57_arg0.Rerolled:setAlpha( 0 ) --[[ @ 0]]
			f57_arg0.clipFinished( f57_arg0.Rerolled ) --[[ @ 0]]
			local f57_local0 = function ( f58_arg0 )
				local f58_local0 = function ( f59_arg0 )
				 ...
				 --[[ @ 0]]
				f57_arg0.BGWidgetCommon:beginAnimation( 130 ) --[[ @ 0]]
				f57_arg0.BGWidgetCommon:registerEventHandler( "interrupted_keyframe", f57_arg0.clipInterrupted ) --[[ @ 0]]
				f57_arg0.BGWidgetCommon:registerEventHandler( "transition_complete_keyframe", f58_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f57_arg0.BGWidgetCommon:completeAnimation() --[[ @ 0]]
			f57_arg0.BGWidgetCommon:setAlpha( 0 ) --[[ @ 0]]
			f57_local0( f57_arg0.BGWidgetCommon ) --[[ @ 0]]
			local f57_local1 = function ( f60_arg0 )
				local f60_local0 = function ( f61_arg0 )
				 ...
				 --[[ @ 0]]
				f57_arg0.CoreWidgetUniversal:beginAnimation( 130 ) --[[ @ 0]]
				f57_arg0.CoreWidgetUniversal:registerEventHandler( "interrupted_keyframe", f57_arg0.clipInterrupted ) --[[ @ 0]]
				f57_arg0.CoreWidgetUniversal:registerEventHandler( "transition_complete_keyframe", f60_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f57_arg0.CoreWidgetUniversal:completeAnimation() --[[ @ 0]]
			f57_arg0.CoreWidgetUniversal:setAlpha( 0 ) --[[ @ 0]]
			f57_local1( f57_arg0.CoreWidgetUniversal ) --[[ @ 0]]
			local f57_local2 = function ( f62_arg0 )
				local f62_local0 = function ( f63_arg0 )
					f63_arg0:playClip( "Dupe" ) --[[ @ 0]]
					...
					f63_arg0:registerEventHandler( "transition_complete_keyframe", function ( element, event )
						...
						f57_arg0.clipFinished( element, event ) --[[ @ 0]]
					end ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f57_arg0.AARTierRewardDupeIndicator:playClip( "Dupe" ) --[[ @ 0]]
				f57_arg0.AARTierRewardDupeIndicator:beginAnimation( 130 ) --[[ @ 0]]
				f57_arg0.AARTierRewardDupeIndicator:registerEventHandler( "interrupted_keyframe", f57_arg0.clipInterrupted ) --[[ @ 0]]
				f57_arg0.AARTierRewardDupeIndicator:registerEventHandler( "transition_complete_keyframe", f62_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f57_arg0.AARTierRewardDupeIndicator:completeAnimation() --[[ @ 0]]
			f57_arg0.AARTierRewardDupeIndicator:setAlpha( 0 ) --[[ @ 0]]
			f57_local2( f57_arg0.AARTierRewardDupeIndicator ) --[[ @ 0]]
			f57_arg0.GlowAnim:completeAnimation() --[[ @ 0]]
			f57_arg0.GlowAnim:playClip( "Trigger" ) --[[ @ 0]]
			f57_arg0.clipFinished( f57_arg0.GlowAnim ) --[[ @ 0]]
		end
	},
	Dupe = {
		DefaultClip = function ( f65_arg0, f65_arg1 )
			f65_arg0:__resetProperties() --[[ @ 0]]
			f65_arg0:setupElementClipCounter( 1 ) --[[ @ 0]]
			f65_arg0.AARTierRewardDupeIndicator:completeAnimation() --[[ @ 0]]
			f65_arg0.AARTierRewardDupeIndicator:setAlpha( 1 ) --[[ @ 0]]
			f65_arg0.AARTierRewardDupeIndicator:playClip( "Dupe" ) --[[ @ 0]]
			f65_arg0.clipFinished( f65_arg0.AARTierRewardDupeIndicator ) --[[ @ 0]]
		end
	},
	Reroll = {
		DefaultClip = function ( f66_arg0, f66_arg1 )
			...
			f66_arg0.AARTierRewardDupeIndicator:playClip( "ReRolled" ) --[[ @ 0]]
...
CoD.AARTierRewardShowcaseInternalCommon.__onClose = function ( f68_arg0 )
	f68_arg0.ContrabandFull:close() --[[ @ 0]]
	f68_arg0.Rerolled:close() --[[ @ 0]]
	f68_arg0.BGWidgetCommon:close() --[[ @ 0]]
	f68_arg0.CoreWidgetUniversal:close() --[[ @ 0]]
	f68_arg0.AARTierRewardDupeIndicator:close() --[[ @ 0]]
	f68_arg0.GlowAnim:close() --[[ @ 0]]
end
 --[[ @ 0]]
