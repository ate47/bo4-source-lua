...
CoD.DirectorTheater.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_360E17AB37AB4874" ) ) --[[ @ 0]]
	...
	RecentGames.MiddleText:setText( LocalizeToUpperString( @"hash_3C61974356EAE960" ) ) --[[ @ 0]]
	...
	if IsInTheaterMode() then
		...
		CoD.FileshareUtility.SetFilterOnFileshareContentList( self.BookmarkedGames, Enum[@"hash_A8E3D76FFA84DE1"][@"hash_309DD15D8811C2E4"], 1 ) --[[ @ 0]]
	else
		CoD.FileshareUtility.SetFilterOnFileshareContentList( self.BookmarkedGames, Enum[@"hash_A8E3D76FFA84DE1"][@"hash_309DD15D8811C2E4"], 1 ) --[[ @ 0]]
	end
	return self
