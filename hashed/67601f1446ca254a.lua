...
CoD.AmmoWidget_ClipContainerPress = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AmmoWidget_ClipContainerPress.__defaultWidth = 162 --[[ @ 0]]
CoD.AmmoWidget_ClipContainerPress.__defaultHeight = 63 --[[ @ 0]]
CoD.AmmoWidget_ClipContainerPress.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AmmoWidget_ClipContainerPress ) --[[ @ 0]]
	self.id = "AmmoWidget_ClipContainerPress" --[[ @ 0]]
	...
	Clip:setAlignment( Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"] ) --[[ @ 0]]
	Clip:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	local Glow = LUI.UIImage.new( 0, 0, 47, 123, 0, 0, -19, 57 ) --[[ @ 0]]
	Glow:setRGB( 1, 0, 0 ) --[[ @ 0]]
	Glow:setAlpha( 0 ) --[[ @ 0]]
	...
	local LED = LUI.UIImage.new( 0, 0, 46, 122, 0, 0, -18, 58 ) --[[ @ 0]]
	LED:setRGB( 1, 0, 0 ) --[[ @ 0]]
	LED:setAlpha( 0 ) --[[ @ 0]]
	LED:setImage( RegisterImage( @"hash_792846624408DDB0" ) ) --[[ @ 0]]
...
CoD.AmmoWidget_ClipContainerPress.__resetProperties = function ( f2_arg0 )
	...
	f2_arg0.LED:completeAnimation() --[[ @ 0]]
	...
	f2_arg0.LED:setAlpha( 0 ) --[[ @ 0]]
	f2_arg0.LED:setMaterial( LUI.UIImage.GetCachedMaterial( @"ui_normal" ) ) --[[ @ 0]]
	f2_arg0.Glow:setLeftRight( 0, 0, 47, 123 ) --[[ @ 0]]
	f2_arg0.Glow:setTopBottom( 0, 0, -19, 57 ) --[[ @ 0]]
	f2_arg0.Glow:setAlpha( 0 ) --[[ @ 0]]
	f2_arg0.Glow:setScale( 1, 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.AmmoWidget_ClipContainerPress.__clipsPerState = {
	...
	NoAmmoPress = {
		DefaultClip = function ( f4_arg0, f4_arg1 )
			...
			f4_arg0.Glow:setLeftRight( 0, 0, 34, 110 ) --[[ @ 0]]
			f4_arg0.Glow:setTopBottom( 0, 0, -29, 47 ) --[[ @ 0]]
			f4_arg0.Glow:setAlpha( 0.3 ) --[[ @ 0]]
			f4_arg0.Glow:setScale( 1.1, 1.1 ) --[[ @ 0]]
			f4_arg0.clipFinished( f4_arg0.Glow ) --[[ @ 0]]
			f4_arg0.LED:completeAnimation() --[[ @ 0]]
			f4_arg0.LED:setAlpha( 1 ) --[[ @ 0]]
			f4_arg0.LED:setMaterial( LUI.UIImage.GetCachedMaterial( @"hash_F755127C95CF5B6" ) ) --[[ @ 0]]
			f4_arg0.clipFinished( f4_arg0.LED ) --[[ @ 0]]
			f4_arg0.nextClip = "DefaultClip" --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.AmmoWidget_ClipContainerPress.__onClose = function ( f10_arg0 )
	f10_arg0.Pixel1:close() --[[ @ 0]]
	f10_arg0.Pixel0:close() --[[ @ 0]]
end
 --[[ @ 0]]
