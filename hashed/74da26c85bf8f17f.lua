...
CoD.Social_PlayersListButton_Trial = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.Social_PlayersListButton_Trial.__defaultWidth = 36 --[[ @ 0]]
CoD.Social_PlayersListButton_Trial.__defaultHeight = 36 --[[ @ 0]]
CoD.Social_PlayersListButton_Trial.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.Social_PlayersListButton_Trial ) --[[ @ 0]]
	self.id = "Social_PlayersListButton_Trial" --[[ @ 0]]
