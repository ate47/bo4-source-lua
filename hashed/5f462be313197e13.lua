...
CoD.DirectorZMTutorialSelectItem = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.DirectorZMTutorialSelectItem.__defaultWidth = 512 --[[ @ 0]]
CoD.DirectorZMTutorialSelectItem.__defaultHeight = 476 --[[ @ 0]]
CoD.DirectorZMTutorialSelectItem.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DirectorZMTutorialSelectItem ) --[[ @ 0]]
	self.id = "DirectorZMTutorialSelectItem" --[[ @ 0]]
	...
	DirectorPlaylistOptionaInternal.DoubleXPCardIconsLeftAligned:setAlpha( 0 ) --[[ @ 0]]
...
CoD.DirectorZMTutorialSelectItem.__clipsPerState = {
	DefaultState = {
		...
		ChildFocus = function ( f13_arg0, f13_arg1 )
			...
			f13_arg0.equippedIcon:setLeftRight( 1, 1, -10, 7 ) --[[ @ 0]]
			f13_arg0.equippedIcon:setTopBottom( 0, 0, -6, 10 ) --[[ @ 0]]
		...
		GainChildFocus = function ( f14_arg0, f14_arg1 )
			...
			local f14_local0 = function ( f15_arg0 )
				f14_arg0.DirectorPlaylistOptionaInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
			...
			local f14_local1 = function ( f16_arg0 )
				f14_arg0.equippedIcon:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
				f14_arg0.equippedIcon:setLeftRight( 1, 1, -10, 7 ) --[[ @ 0]]
				f14_arg0.equippedIcon:setTopBottom( 0, 0, -6, 10 ) --[[ @ 0]]
		...
		LoseChildFocus = function ( f17_arg0, f17_arg1 )
			...
			local f17_local0 = function ( f18_arg0 )
				f17_arg0.DirectorPlaylistOptionaInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
			...
			local f17_local1 = function ( f19_arg0 )
				f17_arg0.equippedIcon:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
			...
			f17_arg0.equippedIcon:setLeftRight( 1, 1, -10, 7 ) --[[ @ 0]]
			f17_arg0.equippedIcon:setTopBottom( 0, 0, -6, 10 ) --[[ @ 0]]
	...
	Featured = {
		DefaultClip = function ( f20_arg0, f20_arg1 )
			...
			f20_arg0.DirectorPlaylistOptionaInternal:setTopBottom( 0, 0, 0, 476 ) --[[ @ 0]]
		...
		ChildFocus = function ( f21_arg0, f21_arg1 )
			...
			f21_arg0.DirectorPlaylistOptionaInternal:setTopBottom( 0, 0, 0, 476 ) --[[ @ 0]]
			...
			f21_arg0.equippedIcon:setLeftRight( 1, 1, -10, 7 ) --[[ @ 0]]
			f21_arg0.equippedIcon:setTopBottom( 0, 0, -6, 10 ) --[[ @ 0]]
		...
		GainChildFocus = function ( f22_arg0, f22_arg1 )
			...
			local f22_local0 = function ( f23_arg0 )
				f22_arg0.DirectorPlaylistOptionaInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
			...
			f22_arg0.DirectorPlaylistOptionaInternal:setTopBottom( 0, 0, 0, 476 ) --[[ @ 0]]
			...
			local f22_local1 = function ( f24_arg0 )
				f22_arg0.equippedIcon:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_2053CEB9A0427197"] ) --[[ @ 0]]
				f22_arg0.equippedIcon:setLeftRight( 1, 1, -10, 7 ) --[[ @ 0]]
				f22_arg0.equippedIcon:setTopBottom( 0, 0, -6, 10 ) --[[ @ 0]]
		...
		LoseChildFocus = function ( f25_arg0, f25_arg1 )
			...
			local f25_local0 = function ( f26_arg0 )
				f25_arg0.DirectorPlaylistOptionaInternal:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
			...
			f25_arg0.DirectorPlaylistOptionaInternal:setTopBottom( 0, 0, 0, 476 ) --[[ @ 0]]
			...
			local f25_local1 = function ( f27_arg0 )
				f25_arg0.equippedIcon:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
			...
			f25_arg0.equippedIcon:setLeftRight( 1, 1, -10, 7 ) --[[ @ 0]]
			f25_arg0.equippedIcon:setTopBottom( 0, 0, -6, 10 ) --[[ @ 0]]
