...
Lobby.Actions.LuiEvent = function ( f13_arg0, f13_arg1 )
	return {
		...
		startFuncPtr = function ( f14_arg0 )
			...
			Engine[@"luivm_event"]( f14_arg0.event, f14_arg0.data ) --[[ @ 0]]
		end
	...
	return {
		...
		startFuncPtr = function ( f20_arg0 )
			if f20_arg0.timeDelayMilliseconds == 0 then
				...
				f20_arg0.endTime = f20_arg0.timeDelayMilliseconds + Engine[@"milliseconds"]() --[[ @ 0]]
			end
		end
		,
			...
			if LuaDefine.isPS4 then
				...
				elseif LuaUtils.RequirePaidSubscriptionForOnlinePlay() then
					...
					if f42_local2 == true then
						...
						f42_arg0.checkPlusEndTime = Engine[@"milliseconds"]() + LuaDefine.PS_PLUS_CHECK_TIME --[[ @ 0]]
						return 
					end
				else
					f42_local1 = true --[[ @ 0]]
	...
	return {
		...
		startFuncPtr = function ( f45_arg0 )
			if f45_arg0.connectMode ~= nil then
				Dvar[@"live_connect_mode"]:set( f44_arg1 ) --[[ @ 0]]
			end
...
Lobby.Actions.ConnectingToDemonware = function ( f50_arg0, f50_arg1, f50_arg2 )
	return {
		...
		startFuncPtr = function ( f51_arg0 )
			...
			Dvar[@"live_connect_mode"]:set( 1 ) --[[ @ 0]]
			Engine[@"liveconnectenabledemonwareconnect"]() --[[ @ 0]]
			f51_arg0.endTime = f51_arg0.waitMilliseconds + Engine[@"milliseconds"]() --[[ @ 0]]
			f51_arg0.checkTime = f51_arg0.checkInterval + Engine[@"milliseconds"]() --[[ @ 0]]
		end
		,
		pumpFuncPtr = function ( f52_arg0, f52_arg1 )
			if f52_arg0.checkTime > Engine[@"milliseconds"]() then
				...
				f52_arg0.checkTime = f52_arg0.checkInterval + Engine[@"milliseconds"]() --[[ @ 0]]
				...
				elseif f52_arg0.endTime < Engine[@"milliseconds"]() then
					local f52_local0, f52_local1 = Engine[@"getsysteminfo"]( f50_arg0, Enum[@"sysinfo"][@"sysinfo_connectivity_info"] ) --[[ @ 0]]
	...
	return {
		...
		startFuncPtr = function ( f57_arg0 )
			...
			elseif f57_local2 == Enum[@"dvartype_t"][@"dvar_type_bool"] then
				f57_local3 = f57_local1 == Engine[@"getdvarbool"]( f57_local0 ) --[[ @ 0]]
			elseif f57_local2 == Enum[@"dvartype_t"][@"dvar_type_float"] then
				f57_local3 = f57_local1 == Engine[@"getdvarfloat"]( f57_local0 ) --[[ @ 0]]
			elseif f57_local2 == Enum[@"dvartype_t"][@"dvar_type_int"] then
				f57_local3 = f57_local1 == Engine[@"getdvarint"]( f57_local0 ) --[[ @ 0]]
			elseif f57_local2 == Enum[@"dvartype_t"][@"dvar_type_string"] then
				f57_local3 = f57_local1 == Engine[@"getdvarstring"]( f57_local0 ) --[[ @ 0]]
			end
			if f57_local3 then
				LobbyVM.ProcessCompleteSuccess( {
					actionId = f57_arg0.actionId
		...
		startFuncPtr = function ( f69_arg0 )
			...
			if f69_local0 <= 0 then
				if Dvar[@"arena_defaultplaylist"]:exists() then
					f69_local1 = Dvar[@"arena_defaultplaylist"]:get() --[[ @ 0]]
				else
					f69_local1 = 451 --[[ @ 0]]
				end
			else
			...
			if f69_local2 then
				Engine[@"setplaylistid"]( f69_local2.id ) --[[ @ 0]]
...
Lobby.Actions.RunPlaylistSettings = function ( f72_arg0 )
	return {
		...
		startFuncPtr = function ( f73_arg0 )
			Engine[@"runplaylistsettings"]( f73_arg0.controller, Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_game"] ) --[[ @ 0]]
			LobbyVM.ProcessCompleteSuccess( {
...
Lobby.Actions.RunPlaylistRules = function ( f74_arg0 )
	return {
		...
		startFuncPtr = function ( f75_arg0 )
			Engine[@"runplaylistrules"]( f75_arg0.controller ) --[[ @ 0]]
			LobbyVM.ProcessCompleteSuccess( {
	...
	return {
		...
		startFuncPtr = function ( f77_arg0 )
			...
			if Dvar[@"hash_7A3900525DBB36AF"]:exists() then
				...
				timeoutTime = Engine[@"milliseconds"]() + Dvar[@"hash_7A3900525DBB36AF"]:get() --[[ @ 0]]
			end
...
Lobby.Actions.ForceLobbyUIScreen = function ( f81_arg0, f81_arg1 )
	return {
		...
		startFuncPtr = function ( f82_arg0 )
			Engine[@"forcelobbyuiscreen"]( f82_arg0.screenId ) --[[ @ 0]]
			LobbyVM.ProcessCompleteSuccess( {
...
Lobby.Actions.LobbyHostEnd = function ( f88_arg0 )
	return {
		...
		startFuncPtr = function ( f89_arg0 )
			Engine[@"lobbyhostend"]( f89_arg0.actionId, f89_arg0.lobbyType ) --[[ @ 0]]
		end
		,
...
Lobby.Actions.LobbyHostAddPrimary = function ( f91_arg0 )
	return {
		...
		startFuncPtr = function ( f92_arg0 )
			Engine[@"lobbyhostaddprimary"]( f92_arg0.actionId, f92_arg0.lobbyType ) --[[ @ 0]]
		end
...
Lobby.Actions.LobbyHostAddLocal = function ( f93_arg0, f93_arg1 )
	return {
		...
		startFuncPtr = function ( f94_arg0 )
			Engine[@"lobbyhostaddlocal"]( f94_arg0.actionId, f94_arg0.controller, f94_arg0.lobbyType ) --[[ @ 0]]
		end
...
Lobby.Actions.LobbyClientStart = function ( f95_arg0 )
	return {
		...
		startFuncPtr = function ( f96_arg0 )
			Engine[@"lobbyclientstart"]( f96_arg0.actionId, f96_arg0.lobbyType ) --[[ @ 0]]
		end
...
Lobby.Actions.LobbyClientEnd = function ( f97_arg0 )
	return {
		...
		startFuncPtr = function ( f98_arg0 )
			Engine[@"lobbyclientend"]( f98_arg0.actionId, f98_arg0.lobbyType ) --[[ @ 0]]
...
Lobby.Actions.LobbyLocalClientLeave = function ( f99_arg0, f99_arg1, f99_arg2 )
	return {
		...
		startFuncPtr = function ( f100_arg0 )
			Engine[@"lobbylocalclientleave"]( f100_arg0.actionId, f100_arg0.lobbyType, f100_arg0.controller, f100_arg0.xuid ) --[[ @ 0]]
		end
...
Lobby.Actions.LeaveWithParty = function ( f101_arg0 )
	return {
		...
		startFuncPtr = function ( f102_arg0 )
			...
			local f102_local0 = Engine[@"islobbyhost"]( Enum[@"lobbytype"][@"lobby_type_private"] ) and Enum[@"lobbymodule"][@"lobby_module_host"] or Enum[@"lobbymodule"][@"lobby_module_client"] --[[ @ 0]]
			local f102_local1 = Engine[@"getlobbyclientcount"]( f102_local0, Enum[@"lobbytype"][@"lobby_type_private"], Enum[@"lobbyclientfiltertype"][@"lobby_client_filter_type_all"] ) --[[ @ 0]]
			...
			local f102_local2 = Engine[@"hash_1E42CF04B7DDD5DE"]( LobbyMsg.EncodeToLobbyMsgType( LobbyMsg.LuaMsgType.LUA_MESSAGE_TYPE_LOBBY_CLIENT_LEAVEWITHPARTY ), Enum[@"lobbymodule"][@"hash_3F90DB2D4085A3E0"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
			local f102_local3 = true --[[ @ 0]]
			local f102_local4 = {} --[[ @ 0]]
			local f102_local5, f102_local6 = LobbyMsg.PackageHostLeaveWithPary( f102_local2, Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
			...
			f102_local5 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
			...
			f102_arg0.endTime = f102_arg0.waitMilliseconds + Engine[@"milliseconds"]() --[[ @ 0]]
		end
		,
		pumpFuncPtr = function ( f103_arg0, f103_arg1 )
			local f103_local0 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
			local f103_local1 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_game"] ) --[[ @ 0]]
...
Lobby.Actions.WaitForParty = function ( f105_arg0, f105_arg1 )
	return {
		...
		startFuncPtr = function ( f106_arg0 )
			if Engine[@"islobbyhost"]( Enum[@"lobbytype"][@"lobby_type_transition"] ) == true then
				...
				if Engine[@"getlobbyclientcount"]( Enum[@"lobbymodule"][@"lobby_module_host"], f106_local0, Enum[@"lobbyclientfiltertype"][@"lobby_client_filter_type_all"] ) - Engine[@"getlobbyclientcount"]( Enum[@"lobbymodule"][@"lobby_module_host"], f106_local0, Enum[@"lobbyclientfiltertype"][@"lobby_client_filter_type_local"] ) == 0 then
					...
					f106_arg0.endTime = f106_arg0.waitMilliseconds + Engine[@"milliseconds"]() --[[ @ 0]]
				end
			end
		end
		,
		pumpFuncPtr = function ( f107_arg0, f107_arg1 )
			...
			local f107_local2 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
			local f107_local3 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_host"], f107_local1 ) --[[ @ 0]]
...
Lobby.Actions.MoveLobbySession = function ( f109_arg0, f109_arg1 )
	return {
		...
		startFuncPtr = function ( f110_arg0 )
			local f110_local0 = Engine[@"getlobbyclientcount"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"], Enum[@"lobbyclientfiltertype"][@"lobby_client_filter_type_all"] ) --[[ @ 0]]
			local f110_local1 = Engine[@"getlobbyclientcount"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"], Enum[@"lobbyclientfiltertype"][@"lobby_client_filter_type_local"] ) --[[ @ 0]]
			local f110_local2 = Engine[@"getlobbyhostinfo"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
			local f110_local3 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
			local f110_local4 = {} --[[ @ 0]]
			if f110_local0 - f110_local1 ~= 0 then
				...
				if #f110_local4 > 0 then
					Engine[@"sendlobbymovelist"]( 0, Enum[@"lobbytype"][@"lobby_type_private"], Enum[@"lobbytype"][@"lobby_type_transition"], f110_local4 ) --[[ @ 0]]
				end
			end
			local f110_local5 = f110_arg0.joinResults[1].sourceLobbyType --[[ @ 0]]
			local f110_local6 = f110_arg0.joinResults[1].targetLobbyType --[[ @ 0]]
			Engine[@"copylobbysession"]( Enum[@"lobbymodule"][@"lobby_module_client"], f110_local5, f110_local6 ) --[[ @ 0]]
			Engine[@"clearlobbysession"]( Enum[@"lobbymodule"][@"lobby_module_host"], f110_local6 ) --[[ @ 0]]
			Engine[@"clearlobbysession"]( Enum[@"lobbymodule"][@"lobby_module_host"], f110_local5 ) --[[ @ 0]]
			Engine[@"clearlobbysession"]( Enum[@"lobbymodule"][@"lobby_module_client"], f110_local5 ) --[[ @ 0]]
			Lobby.Timer.HostingLobbyEnd( {
				lobbyType = f110_local6
			} ) --[[ @ 0]]
			Engine[@"sendlobbysessionstaterequest"]( f110_arg0.controller, f110_local6 ) --[[ @ 0]]
			f110_local3 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_client"], f110_local6 ) --[[ @ 0]]
...
Lobby.Actions.CanHostServer = function ( f113_arg0, f113_arg1 )
	return {
		...
		startFuncPtr = function ( f114_arg0 )
			local f114_local0 = Engine[@"getlobbymaxclients"]( Engine[@"islobbyhost"]( Enum[@"lobbytype"][@"lobby_type_game"] ) and Enum[@"lobbymodule"][@"lobby_module_host"] or Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_game"] ) --[[ @ 0]]
			...
			local f114_local1, f114_local2 = Engine[@"canhostserver"]( f114_arg0.controller, f114_local0 ) --[[ @ 0]]
...
Lobby.Actions.GeoMinCheck = function ( f115_arg0, f115_arg1 )
	local f115_local0 = Dvar[@"lobbysearchgeomin"]:get() --[[ @ 0]]
...
Lobby.Actions.SkillCheck = function ( f116_arg0, f116_arg1 )
	...
	elseif f116_arg1.serverType ~= Lobby.Matchmaking.ServerType.DEDICATED_SERVER then
		...
		local f116_local1 = Engine[@"getdvarfloat"]( "lobbySearchBaseSkillRange" ) + Lobby.Matchmaking.SearchParams.retry * Engine[@"getdvarfloat"]( "lobbySearchSkillRangeMultiplier" ) --[[ @ 0]]
...
Lobby.Actions.SearchForLobby = function ( f117_arg0, f117_arg1 )
	return {
		...
		startFuncPtr = function ( f118_arg0 )
			...
			Engine[@"searchforlobby"]( f118_arg0.actionId, f118_arg0.lobbyType ) --[[ @ 0]]
		end
		,
		endFuncPtr = function ( f119_arg0 )
			local f119_local0 = Engine[@"getsearchquery"]() --[[ @ 0]]
			local f119_local1 = Engine[@"getsearchresults"]( f119_arg0.lobbyType ) --[[ @ 0]]
			...
			f119_local4 = Engine[@"getgeolocation"]() --[[ @ 0]]
			f119_local5 = Engine[@"getlobbyhostxuid"]( f119_arg0.lobbyType ) --[[ @ 0]]
			f119_local6 = 1 --[[ @ 0]]
			for f119_local12, f119_local13 in ipairs( f119_local1.remoteHosts ) --[[ @ 0]] do
				...
				if f119_local13.serverType == Lobby.Matchmaking.ServerType.DEDICATED_SERVER then
					if Engine[@"isdedicatedserver"]() == true then
						...
						latencytoserverlocation = Engine[@"getpingforserverlocation"]( f119_local13.serverLocation ) --[[ @ 0]]
				...
				if hostOK then
					hostOK = Lobby.Actions.SkillCheck( Dvar[@"lobbysearchskill"]:get(), f119_local13 ) --[[ @ 0]]
				end
				if hostOK then
					local f119_local10 = Dvar[@"lobbysearchforcexuid"]:get() --[[ @ 0]]
...
Lobby.Actions.QoSJoinSearchResults = function ( f122_arg0, f122_arg1, f122_arg2 )
	return {
		...
		startFuncPtr = function ( f123_arg0 )
			f123_arg0.sourceLobbyType = Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_host"] ) --[[ @ 0]]
			f123_arg0.targetLobbyType = Enum[@"lobbytype"][@"lobby_type_game"] --[[ @ 0]]
			...
			f123_arg0.minInitialCount = #f123_local0 * Dvar[@"qos_minpercent"]:get() / 100 --[[ @ 0]]
			f123_arg0.minInitialCount = math.max( f123_arg0.minInitialCount, Dvar[@"qos_minprobes"]:get() ) --[[ @ 0]]
			f123_arg0.joinStatusCur = Lobby.Actions.JOIN_STATUS.BEGIN --[[ @ 0]]
			f123_arg0.firstResultTime = Engine[@"milliseconds"]() --[[ @ 0]]
			f123_arg0.updateTime = Engine[@"milliseconds"]() --[[ @ 0]]
			f123_arg0.searchTime = Engine[@"milliseconds"]() --[[ @ 0]]
		end
		,
		pumpFuncPtr = function ( f124_arg0 )
			if f124_arg0.joinStatusCur == Lobby.Actions.JOIN_STATUS.BEGIN then
				local f124_local0 = Engine[@"milliseconds"]() --[[ @ 0]]
				...
				if f124_local1 then
					...
					Engine[@"lobbyjoinbegin"]( f124_arg0.actionId, f124_arg0.controller, f124_arg0.sourceLobbyType, f124_arg0.targetLobbyType ) --[[ @ 0]]
					...
					for f124_local6, f124_local7 in ipairs( f124_arg0.qosResultsValid ) --[[ @ 0]] do
						...
						Engine[@"lobbyjoinadd"]( f124_local7.xuid, f124_local7.gameSecurityId, f124_local7.gameSecurityKey, f124_local7.hostAddress, f124_local7.isDedicated, f124_arg0.sendCustomInfo ~= nil ) --[[ @ 0]]
		...
		updateFuncPtr = function ( f126_arg0, f126_arg1 )
			...
			f126_arg0.updateTime = Engine[@"milliseconds"]() --[[ @ 0]]
			...
			elseif f126_arg0.joinStatusCur == Lobby.Actions.JOIN_STATUS.ADD then
				...
				Engine[@"lobbyjoinadd"]( f126_local0.xuid, f126_local0.gameSecurityId, f126_local0.gameSecurityKey, f126_local0.hostAddress, f126_local0.isDedicated, f126_arg0.sendCustomInfo ~= nil ) --[[ @ 0]]
...
Lobby.Actions.AdvertiseLobby = function ( f129_arg0 )
	return {
		...
		startFuncPtr = function ( f130_arg0 )
			...
			Engine[@"advertiselobby"]( f130_arg0.actionId, f130_arg0.lobbyType, f130_arg0.onOff ) --[[ @ 0]]
		end
		,
...
Lobby.Actions.LobbyInfoProbe = function ( f132_arg0, f132_arg1 )
	return {
		...
		startFuncPtr = function ( f133_arg0 )
			Engine[@"lobbyinfoprobe"]( f133_arg0.actionId, f133_arg0.controller, f133_arg0.info.xuid ) --[[ @ 0]]
		end
		,
...
Lobby.Actions.JoinHost = function ( f145_arg0, f145_arg1, f145_arg2, f145_arg3, f145_arg4, f145_arg5, f145_arg6 )
	return {
		...
		startFuncPtr = function ( f146_arg0 )
			Engine[@"joinhost"]( f146_arg0.actionId, f146_arg0.controller, f145_arg5, f145_arg6, f146_arg0.hostXuid, f146_arg0.hostInfo ) --[[ @ 0]]
		end
		,
		...
		errorFuncPtr = function ( f148_arg0 )
			local f148_local0 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/join_result_not_joinable" ) --[[ @ 0]]
...
Lobby.Actions.LobbyJoinXUID = function ( f149_arg0, f149_arg1, f149_arg2 )
	return {
		...
		startFuncPtr = function ( f150_arg0 )
			Engine[@"joinxuid"]( f150_arg0.actionId, f150_arg0.controller, f150_arg0.info.xuid, f150_arg0.joinType ) --[[ @ 0]]
		end
		,
		...
		errorFuncPtr = function ( f153_arg0 )
			local f153_local0 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/join_result_not_joinable" ) --[[ @ 0]]
...
Lobby.Actions.LobbyJoinXUIDExt = function ( f154_arg0, f154_arg1, f154_arg2, f154_arg3 )
	return {
		...
		startFuncPtr = function ( f155_arg0 )
			...
			if f155_local2 == Enum[@"lobbytype"][@"lobby_type_count"] then
				if f155_local0.gameLobby.isValid == true then
					f155_local2 = Enum[@"lobbytype"][@"lobby_type_game"] --[[ @ 0]]
					f155_local3 = f155_local0.gameLobby --[[ @ 0]]
				else
					f155_local2 = Enum[@"lobbytype"][@"lobby_type_private"] --[[ @ 0]]
		...
		errorFuncPtr = function ( f158_arg0 )
			local f158_local0 = Enum[@"xonline_nat_type"][@"xonline_nat_open"] --[[ @ 0]]
			...
			local f158_local2 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/join_result_not_joinable" ) --[[ @ 0]]
...
Lobby.Actions.LobbyJoinSession = function ( f159_arg0, f159_arg1, f159_arg2 )
	return {
		...
		startFuncPtr = function ( f160_arg0 )
			local f160_local0 = Engine[@"getlobbyhostinfo"]( Enum[@"lobbymodule"][@"lobby_module_host"], f160_arg0.destinationLobby ) --[[ @ 0]]
		...
		errorFuncPtr = function ( f163_arg0 )
			local f163_local0 = Enum[@"xonline_nat_type"][@"xonline_nat_open"] --[[ @ 0]]
			...
			local f163_local2 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/join_result_not_joinable" ) --[[ @ 0]]
...
Lobby.Actions.WaitForJoiningClients = function ( f164_arg0 )
	return {
		...
		startFuncPtr = function ( f165_arg0 )
			f165_arg0.endWaitTime = f165_arg0.waitMilliseconds + Engine[@"milliseconds"]() --[[ @ 0]]
			local f165_local0 = Engine[@"lobbyjoincount"]() --[[ @ 0]]
		...
		pumpFuncPtr = function ( f166_arg0 )
			local f166_local0 = Engine[@"lobbyjoincount"]() --[[ @ 0]]
...
Lobby.Actions.SetNetworkMode = function ( f174_arg0, f174_arg1 )
	return {
		...
		startFuncPtr = function ( f175_arg0 )
			Engine[@"setlobbynetworkmode"]( f175_arg0.networkMode ) --[[ @ 0]]
...
Lobby.Actions.PromoteToHostDone = function ( f176_arg0, f176_arg1, f176_arg2, f176_arg3 )
	return {
		...
		startFuncPtr = function ( f177_arg0 )
			Engine[@"lobbyhostmigratesetindexbits"]( f177_arg0.lobbyType, f177_arg0.migrateIndexBits ) --[[ @ 0]]
			Engine[@"lobbysetmap"]( f177_arg0.lobbyType, Engine[@"lobbygetmap"]() ) --[[ @ 0]]
			Engine[@"lobbysetgametype"]( f177_arg0.lobbyType, Engine[@"lobbygetgametype"]() ) --[[ @ 0]]
			Engine[@"promotetohostdone"]( f177_arg0.controller, f177_arg0.lobbyType, f177_arg0.isInGame ) --[[ @ 0]]
			LobbyVM.ProcessCompleteSuccess( {
...
Lobby.Actions.SignUserInToLive = function ( f178_arg0 )
	return {
		...
		startFuncPtr = function ( f179_arg0 )
			Engine[@"signuserintolive"]( f179_arg0.controller ) --[[ @ 0]]
			LobbyVM.ProcessCompleteSuccess( {
...
Lobby.Actions.SignUserOutOfLive = function ( f180_arg0, f180_arg1 )
	return {
		...
		startFuncPtr = function ( f181_arg0 )
			Engine[@"signuseroutoflive"]( f181_arg0.controller ) --[[ @ 0]]
			LobbyVM.ProcessCompleteSuccess( {
...
Lobby.Actions.SetGameAndTypeMapName = function ( f194_arg0, f194_arg1, f194_arg2, f194_arg3 )
	return {
		...
		startFuncPtr = function ( f195_arg0 )
			Engine[@"lobbysetmap"]( f195_arg0.lobbyType, f195_arg0.mapName ) --[[ @ 0]]
			Engine[@"lobbysetgametype"]( f195_arg0.lobbyType, f195_arg0.gameType ) --[[ @ 0]]
			LobbyVM.ProcessCompleteSuccess( {
...
Lobby.Actions.SetSavedOrDefaultMap = function ( f196_arg0, f196_arg1 )
	return {
		...
		startFuncPtr = function ( f197_arg0 )
			local f197_local0 = Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_host"] ) --[[ @ 0]]
			if Engine[@"iscampaigngame"]() then
				if f196_arg1[@"name"] == LuaEnum.UI.DIRECTOR_ONLINE_CP_STORY then
					...
					Engine[@"lobbysetmap"]( f197_local0, f197_local1 ) --[[ @ 0]]
				else
					local f197_local1 = Dvar[@"cp_queued_level"]:get() --[[ @ 0]]
			...
			if f196_arg1[@"id"] == LobbyData.GetLobbyMenuIDByName( LuaEnum.UI.DIRECTOR_ONLINE_MP_CUSTOM ) or f196_arg1[@"id"] == LobbyData.GetLobbyMenuIDByName( LuaEnum.UI.DIRECTOR_ONLINE_MP_ARENA_CUSTOM ) then
				Engine[@"lobbyhostsetofficialcustomgame"]( f197_local0, true ) --[[ @ 0]]
			end
			LobbyVM.ProcessCompleteSuccess( {
...
Lobby.Actions.PlayTogetherBeginPlayWait = function ( f198_arg0 )
	return {
		...
		pumpFuncPtr = function ( f200_arg0, f200_arg1 )
			local f200_local0 = Engine[@"getlobbyuiscreen"]() --[[ @ 0]]
...
Lobby.Actions.AsyncMatchmakingWaitTillHostHasAllTokens = function ( f210_arg0 )
	return {
		...
		startFuncPtr = function ( f211_arg0 )
			f211_arg0.endTime = f211_arg0.waitMilliseconds + Engine[@"milliseconds"]() --[[ @ 0]]
			f211_arg0.checkTime = f211_arg0.checkInterval + Engine[@"milliseconds"]() --[[ @ 0]]
		end
		,
		pumpFuncPtr = function ( f212_arg0, f212_arg1 )
			...
			f212_arg0.checkTime = f212_arg0.checkInterval + Engine[@"milliseconds"]() --[[ @ 0]]
			local f212_local0 = false --[[ @ 0]]
			local f212_local1 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_host"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
	...
	return {
		...
		startFuncPtr = function ( f214_arg0 )
			if Dvar[@"hash_6458DCD5CEE10FC9"]:exists() then
				f214_arg0.timeoutTime = Engine[@"milliseconds"]() + Dvar[@"hash_6458DCD5CEE10FC9"]:get() * 1000 --[[ @ 0]]
			end
		...
		startFuncPtr = function ( f225_arg0 )
			...
			if Lobby.MatchmakingAsync.IsAsyncMatchmakingRunning() == false or f225_local0 == nil then
				...
				if f225_local0 ~= nil then
					local f225_local1 = Lobby.MatchmakingAsync.PartyToMatchSummary[@"searches"][tostring( f225_local0 )] --[[ @ 0]]
					if f225_local1 ~= nil then
						f225_local1[@"search_outcome"] = Lobby.MatchmakingAsync.SearchOutcome.SEARCH_CANCEL --[[ @ 0]]
...
Lobby.Actions.AsyncMatchmakingWaitToComplete = function ( f230_arg0 )
	return {
		...
		startFuncPtr = function ( f232_arg0 )
			f232_arg0.checkTime = f232_arg0.checkInterval + Engine[@"milliseconds"]() --[[ @ 0]]
			Lobby.MMAsync.lastUpdateTime = Engine[@"milliseconds"]() --[[ @ 0]]
			f232_arg0.updateTime = f232_arg0.updateInterval + Engine[@"milliseconds"]() --[[ @ 0]]
		end
		,
		pumpFuncPtr = function ( f233_arg0, f233_arg1 )
			...
			if f233_arg0.updateTime < Engine[@"milliseconds"]() then
				if f233_arg0.updateMessage == 0 then
					f233_arg0.updateTime = Engine[@"milliseconds"]() + 1000 --[[ @ 0]]
					f233_arg0.updateMessage = 1 --[[ @ 0]]
					f233_local1 = LuaEnum.SEARCH_DESCRIPTION.SEARCH_STAGE_2_DESCRIPTION_3 --[[ @ 0]]
				else
					f233_arg0.updateTime = Engine[@"milliseconds"]() + f233_arg0.updateInterval --[[ @ 0]]
					f233_arg0.updateMessage = 0 --[[ @ 0]]
				end
				Lobby.Matchmaking.UpdateSearchStatus( Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_host"] ), LuaEnum.PUBLIC_LOBBY.SEARCH_STAGE_2, f233_local1 ) --[[ @ 0]]
			end
		end
		,
		checkEvent = function ( f234_arg0, f234_arg1 )
			...
			elseif f234_local0 == LuaEnum.bdEventType.BD_LOBBY_NOT_FOUND then
				...
				if f234_local3 == LuaEnum.LobbyNotFoundCause.BD_ILLEGAL_MAP_PACK then
					...
					f234_arg0.msgOverride = @"platform/missingmap" --[[ @ 0]]
		...
		errorFuncPtr = function ( f237_arg0 )
			local f237_local0 = @"menu/join_result_not_joinable" --[[ @ 0]]
...
Lobby.Actions.AsyncMatchmakingJoin = function ( f247_arg0, f247_arg1 )
	return {
		...
		startFuncPtr = function ( f248_arg0 )
			Engine[@"lobbyjoinbegin"]( f248_arg0.actionId, f248_arg0.controller, Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_host"] ), f248_arg0.toTarget[@"lobbytype"] ) --[[ @ 0]]
		...
		errorFuncPtr = function ( f250_arg0 )
			local f250_local0 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/join_result_not_joinable" ) --[[ @ 0]]
