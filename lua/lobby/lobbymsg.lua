...
LobbyMsg.OnTestClientPacket = function ( f4_arg0 )
	local f4_local0 = 0 --[[ @ 0]]
	local f4_local1 = Engine[@"hash_1E42CF04B7DDD5DE"]( LobbyMsg.EncodeToLobbyMsgType( LobbyMsg.LuaMsgType.LUA_MESSAGE_TYPE_TEST ), Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] ) ) --[[ @ 0]]
	local f4_local2 = {
		integer32 = -23345,
		uInteger32 = 23345,
		boolean = true,
		...
		character = -56,
		uCharacter = 132,
		int64 = Engine[@"hash_48506F73B393062F"]( 123456792 ) + Engine[@"hash_48506F73B393062F"]( 123456792 ),
		uInt64 = Engine[@"hash_48506F73B393062F"]( 11121314 ) * Engine[@"hash_48506F73B393062F"]( 11121314 ),
		float = 3.14,
		xuid = Engine[@"GetXUID64"]( 0 ),
		StringTest = "Hello Host",
		testBigToSmall = Engine[@"hash_48506F73B393062F"]( 12345 )
	} --[[ @ 0]]
	...
	f4_local1:sendTo( f4_local0, Enum[@"LobbyModule"][@"hash_3F90DB2D4085A3E0"], Enum[@"hash_3BF5D4C4954EF3E5"][@"hash_4ADB9CF01A956BFF"] ) --[[ @ 0]]
	f4_local1:free() --[[ @ 0]]
end
 --[[ @ 0]]
...
LobbyMsg.ConvertToLuaMsgType = function ( f6_arg0 )
	return f6_arg0 - Enum[@"hash_43901A96E6973A52"][@"hash_28D9789F91FCDB78"]
end
 --[[ @ 0]]
LobbyMsg.EncodeToLobbyMsgType = function ( f7_arg0 )
	return f7_arg0 + Enum[@"hash_43901A96E6973A52"][@"hash_28D9789F91FCDB78"]
end
 --[[ @ 0]]
