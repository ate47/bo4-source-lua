...
local PostLoadFunc = function ( f1_arg0, f1_arg1 )
 ...
 --[[ @ 0]]
CoD.Challenges = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.Challenges = function ( f2_arg0, f2_arg1 )
	local self = CoD.Menu.NewForUIEditor( "Challenges", f2_arg0 ) --[[ @ 0]]
	local f2_local1 = self --[[ @ 0]]
	self:setClass( CoD.Challenges ) --[[ @ 0]]
	...
	local TabFrame = LUI.UIFrame.new( f2_local1, f2_arg0, 0, 0, false ) --[[ @ 0]]
	TabFrame:setLeftRight( 0.5, 0.5, -780, 780 ) --[[ @ 0]]
	TabFrame:setTopBottom( 0.5, 0.5, -380, 400 ) --[[ @ 0]]
	self:addElement( TabFrame ) --[[ @ 0]]
	self.TabFrame = TabFrame --[[ @ 0]]
	
	local MenuFrame = CoD.GenericMenuFrameIdentity.new( f2_local1, f2_arg0, 0, 1, 0, 0, 0, 1, 0, 0 ) --[[ @ 0]]
	MenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_99CD580A52B2E53" ) ) --[[ @ 0]]
	...
	local SafeAreaWidget = CoD.Challenges_SafeAreaWidget.new( f2_local1, f2_arg0, 0, 0, 0, 1920, 0, 0, 0, 1080 ) --[[ @ 0]]
	...
	LUI.OverrideFunction_CallOriginalFirst( self, "close", function ( element )
		CoD.ChallengesUtility.SetTotalMasterInfo( f2_arg0 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	TabFrame.id = "TabFrame" --[[ @ 0]]
	MenuFrame:setModel( self.buttonModel, f2_arg0 ) --[[ @ 0]]
...
CoD.Challenges.__onClose = function ( f11_arg0 )
	...
	f11_arg0.SafeAreaWidget:close() --[[ @ 0]]
end
 --[[ @ 0]]
