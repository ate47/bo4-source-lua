...
LUI.createMenu.EditTeamLogo = function ( f2_arg0, f2_arg1 )
	...
	LogoList:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	LogoList:setDataSource( "TeamIdentityLogoList" ) --[[ @ 0]]
	LogoList:linkToElementModel( LogoList, "disabled", true, function ( model, f6_arg1 )
		CoD.Menu.UpdateButtonShownState( f6_arg1, f2_local1, f2_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f2_local1:AddButtonCallbackFunction( LogoList, f2_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
