...
LUI.createMenu.EmblemEditor = function ( f1_arg0, f1_arg1 )
	...
	BgGrain( GroupFull, f1_local6["Emblem.EmblemProperties.editorMode"], function ( f4_arg0, f4_arg1 )
		CoD.Menu.UpdateButtonShownState( f4_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_left"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f4_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_right"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f4_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f4_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	emptyFocusable:appendEventHandler( "input_source_changed", function ( f5_arg0, f5_arg1 )
		f5_arg1.menu = f5_arg1.menu or f1_local1 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f5_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_left"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f5_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_right"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	GroupFull = emptyFocusable --[[ @ 0]]
	BgGrain = emptyFocusable.subscribeToModel --[[ @ 0]]
	f1_local6 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	BgGrain( GroupFull, f1_local6.LastInput, function ( f6_arg0, f6_arg1 )
		CoD.Menu.UpdateButtonShownState( f6_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_left"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f6_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_right"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	emptyFocusable:linkToElementModel( emptyFocusable, "layerIndex", true, function ( model, f7_arg1 )
		CoD.Menu.UpdateButtonShownState( f7_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	emptyFocusable:linkToElementModel( emptyFocusable, "iconID", true, function ( model, f8_arg1 )
		CoD.Menu.UpdateButtonShownState( f8_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	GroupFull = emptyFocusable --[[ @ 0]]
	BgGrain = emptyFocusable.subscribeToModel --[[ @ 0]]
	f1_local6 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	BgGrain( GroupFull, f1_local6["Emblem.EmblemProperties.groupsUsed"], function ( f9_arg0, f9_arg1 )
		CoD.Menu.UpdateButtonShownState( f9_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	GroupFull = emptyFocusable --[[ @ 0]]
	BgGrain = emptyFocusable.subscribeToModel --[[ @ 0]]
	f1_local6 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	BgGrain( GroupFull, f1_local6["Emblem.EmblemProperties.layersUsed"], function ( f10_arg0, f10_arg1 )
		CoD.Menu.UpdateButtonShownState( f10_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	emptyFocusable:linkToElementModel( emptyFocusable, "isGrouped", true, function ( model, f11_arg1 )
		CoD.Menu.UpdateButtonShownState( f11_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	layerGrid:linkToElementModel( layerGrid, "layerIndex", true, function ( model, f28_arg1 )
		CoD.Menu.UpdateButtonShownState( f28_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	layerGrid:linkToElementModel( layerGrid, "iconID", true, function ( model, f29_arg1 )
		CoD.Menu.UpdateButtonShownState( f29_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	ChangeLayerArrows( layerCarousel, emblemDrawWidget["Emblem.EmblemProperties.groupsUsed"], function ( f30_arg0, f30_arg1 )
		CoD.Menu.UpdateButtonShownState( f30_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerCarousel = layerGrid --[[ @ 0]]
	ChangeLayerArrows = layerGrid.subscribeToModel --[[ @ 0]]
	emblemDrawWidget = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	ChangeLayerArrows( layerCarousel, emblemDrawWidget["Emblem.EmblemProperties.layersUsed"], function ( f31_arg0, f31_arg1 )
		CoD.Menu.UpdateButtonShownState( f31_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerCarousel = layerGrid --[[ @ 0]]
	ChangeLayerArrows = layerGrid.subscribeToModel --[[ @ 0]]
	emblemDrawWidget = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	ChangeLayerArrows( layerCarousel, emblemDrawWidget["Emblem.EmblemProperties.editorMode"], function ( f32_arg0, f32_arg1 )
		CoD.Menu.UpdateButtonShownState( f32_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerGrid:appendEventHandler( "input_source_changed", function ( f33_arg0, f33_arg1 )
		f33_arg1.menu = f33_arg1.menu or f1_local1 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f33_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	layerCarousel = layerGrid --[[ @ 0]]
	ChangeLayerArrows = layerGrid.subscribeToModel --[[ @ 0]]
	emblemDrawWidget = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	...
	ChangeLayerArrows( layerCarousel, emblemDrawWidget["Emblem.EmblemProperties.isClipboardEmpty"], function ( f35_arg0, f35_arg1 )
		CoD.Menu.UpdateButtonShownState( f35_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	emblemDrawWidget( clipboard, emblemHiddenPulseLayerPC["Emblem.EmblemProperties.editorMode"], function ( f85_arg0, f85_arg1 )
		CoD.Menu.UpdateButtonShownState( f85_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerCarousel:linkToElementModel( layerCarousel, "layerIndex", true, function ( model, f86_arg1 )
		CoD.Menu.UpdateButtonShownState( f86_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	layerCarousel:linkToElementModel( layerCarousel, "iconID", true, function ( model, f87_arg1 )
		CoD.Menu.UpdateButtonShownState( f87_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	clipboard = layerCarousel --[[ @ 0]]
	emblemDrawWidget = layerCarousel.subscribeToModel --[[ @ 0]]
	emblemHiddenPulseLayerPC = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	emblemDrawWidget( clipboard, emblemHiddenPulseLayerPC["Emblem.EmblemProperties.groupsUsed"], function ( f88_arg0, f88_arg1 )
		CoD.Menu.UpdateButtonShownState( f88_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	clipboard = layerCarousel --[[ @ 0]]
	emblemDrawWidget = layerCarousel.subscribeToModel --[[ @ 0]]
	emblemHiddenPulseLayerPC = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	emblemDrawWidget( clipboard, emblemHiddenPulseLayerPC["Emblem.EmblemProperties.layersUsed"], function ( f89_arg0, f89_arg1 )
		CoD.Menu.UpdateButtonShownState( f89_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerCarousel:appendEventHandler( "input_source_changed", function ( f90_arg0, f90_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f90_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	clipboard = layerCarousel --[[ @ 0]]
	emblemDrawWidget = layerCarousel.subscribeToModel --[[ @ 0]]
	emblemHiddenPulseLayerPC = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	emblemDrawWidget( clipboard, emblemHiddenPulseLayerPC.LastInput, function ( f91_arg0, f91_arg1 )
		CoD.Menu.UpdateButtonShownState( f91_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsGroupSlotAvailable( f1_arg0 ) then
					f101_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_browse"] ) --[[ @ 0]]
					if f101_local0 then
	...
	EditControls:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f134_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) --[[ @ 0]]
				if f134_local0 then
					f134_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f134_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) then
					f135_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f135_local0 then
						if not CoD.CraftUtility.Emblems_IsLayerASticker( self.layerCarousel, f1_arg0 ) then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f136_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) --[[ @ 0]]
				if f136_local0 then
					f136_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f136_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f137_local0 --[[ @ 0]]
				if not CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) then
					f137_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f137_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f138_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) --[[ @ 0]]
				if f138_local0 then
					f138_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f138_local0 then
	...
	f1_local25( f1_local24, f1_local26["Emblem.EmblemProperties.editorMode"], function ( f164_arg0, f164_arg1 )
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f164_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_start"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	self:linkToElementModel( self, "layerIndex", true, function ( model, f165_arg1 )
		CoD.Menu.UpdateButtonShownState( f165_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f165_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f165_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f165_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f165_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f165_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f165_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f165_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:linkToElementModel( self, "iconID", true, function ( model, f166_arg1 )
		CoD.Menu.UpdateButtonShownState( f166_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f166_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f166_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f166_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f166_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f166_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f166_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f166_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local24 = self --[[ @ 0]]
	f1_local25 = self.subscribeToModel --[[ @ 0]]
	f1_local26 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	f1_local25( f1_local24, f1_local26["Emblem.EmblemProperties.groupsUsed"], function ( f167_arg0, f167_arg1 )
		CoD.Menu.UpdateButtonShownState( f167_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f167_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f167_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f167_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f167_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f167_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f167_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f167_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f167_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local24 = self --[[ @ 0]]
	f1_local25 = self.subscribeToModel --[[ @ 0]]
	f1_local26 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	f1_local25( f1_local24, f1_local26["Emblem.EmblemProperties.layersUsed"], function ( f168_arg0, f168_arg1 )
		CoD.Menu.UpdateButtonShownState( f168_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f168_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f168_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f168_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f168_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f168_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f168_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f168_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f168_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	self:linkToElementModel( self, "isGrouped", true, function ( model, f169_arg1 )
		CoD.Menu.UpdateButtonShownState( f169_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f169_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f169_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f169_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f169_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f169_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:linkToElementModel( self, "isLinked", true, function ( model, f170_arg1 )
		CoD.Menu.UpdateButtonShownState( f170_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:appendEventHandler( "input_source_changed", function ( f171_arg0, f171_arg1 )
		f171_arg1.menu = f171_arg1.menu or f1_local1 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f171_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f171_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f171_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f171_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f171_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f171_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f171_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local24 = self --[[ @ 0]]
	f1_local25 = self.subscribeToModel --[[ @ 0]]
	f1_local26 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	f1_local25( f1_local24, f1_local26.LastInput, function ( f172_arg0, f172_arg1 )
		CoD.Menu.UpdateButtonShownState( f172_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f172_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f172_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f172_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f172_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f172_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f172_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local24 = self --[[ @ 0]]
	f1_local25 = self.subscribeToModel --[[ @ 0]]
	f1_local26 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	f1_local25( f1_local24, f1_local26["Emblem.EmblemProperties.isClipboardEmpty"], function ( f173_arg0, f173_arg1 )
		CoD.Menu.UpdateButtonShownState( f173_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f173_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"], "ESCAPE", function ( element, menu, controller, model )
		...
		elseif CoD.CraftUtility.IsEditMode( controller ) then
			...
			UpdateElementState( self, "BrowseControls", controller ) --[[ @ 0]]
			UpdateElementState( self, "clipboard", controller ) --[[ @ 0]]
			UpdateButtonPromptState( menu, element, controller, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
			return true
		else
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"], nil, function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and not CoD.CraftUtility.Emblem_IsLayerGrouped( self.layerCarousel, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_rstick_pressed"], @"hash_0", nil, nil ) --[[ @ 0]]
			return false
		elseif CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsClipboardEmpty( controller ) and CoD.CraftUtility.Emblem_CanPastFromClipboard( element, controller ) and CoD.CraftUtility.Clipboard_HasEnoughLayersToPaste( self, controller ) and IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_rstick_pressed"], @"hash_0", nil, nil ) --[[ @ 0]]
			return false
