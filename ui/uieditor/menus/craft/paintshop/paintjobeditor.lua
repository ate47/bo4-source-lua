...
LUI.createMenu.PaintjobEditor = function ( f1_arg0, f1_arg1 )
	...
	GroupFull.buttonPromptImage:setImage( RegisterImage( @"warning_triangle" ) ) --[[ @ 0]]
	...
	layerGrid:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	layerGrid:linkToElementModel( layerGrid, "layerIndex", true, function ( model, f9_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f9_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	layerGrid:linkToElementModel( layerGrid, "iconID", true, function ( model, f10_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f10_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	ChangeLayerArrows( layerCarousel, emblemHiddenPulseLayerPC["Emblem.EmblemProperties.groupsUsed"], function ( f11_arg0, f11_arg1 )
		CoD.Menu.UpdateButtonShownState( f11_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f11_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerCarousel = layerGrid --[[ @ 0]]
	ChangeLayerArrows = layerGrid.subscribeToModel --[[ @ 0]]
	emblemHiddenPulseLayerPC = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	ChangeLayerArrows( layerCarousel, emblemHiddenPulseLayerPC["Emblem.EmblemProperties.layersUsed"], function ( f12_arg0, f12_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f12_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerCarousel = layerGrid --[[ @ 0]]
	ChangeLayerArrows = layerGrid.subscribeToModel --[[ @ 0]]
	emblemHiddenPulseLayerPC = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	ChangeLayerArrows( layerCarousel, emblemHiddenPulseLayerPC["Emblem.EmblemProperties.editorMode"], function ( f13_arg0, f13_arg1 )
		CoD.Menu.UpdateButtonShownState( f13_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerGrid:appendEventHandler( "input_source_changed", function ( f14_arg0, f14_arg1 )
		f14_arg1.menu = f14_arg1.menu or f1_local1 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f14_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	layerCarousel = layerGrid --[[ @ 0]]
	ChangeLayerArrows = layerGrid.subscribeToModel --[[ @ 0]]
	emblemHiddenPulseLayerPC = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	ChangeLayerArrows( layerCarousel, emblemHiddenPulseLayerPC.LastInput, function ( f15_arg0, f15_arg1 )
		CoD.Menu.UpdateButtonShownState( f15_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerCarousel = layerGrid --[[ @ 0]]
	ChangeLayerArrows = layerGrid.subscribeToModel --[[ @ 0]]
	emblemHiddenPulseLayerPC = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( layerGrid, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_link", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, element, controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_link" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( layerGrid, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_contextual_3", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsClipboardEmpty( controller ) and CoD.CraftUtility.Emblem_CanPastFromClipboard( element, controller ) and CoD.CraftUtility.Clipboard_HasEnoughLayersToPaste( self, controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_contextual_3" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( layerGrid, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_remove", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, self.layerGrid, controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_remove" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( layerGrid, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_layertop", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_layertop" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( layerGrid, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_layerbottom", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_layerbottom" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( layerGrid, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_newlayer", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, element, controller ) and CoD.CraftUtility.Emblem_IsAnyLayerEmpty( controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_newlayer" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( layerGrid, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_cutlayer", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, element, controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_cutlayer" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( layerGrid, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_copylayer", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, element, controller ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_copylayer" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( layerGrid, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_group", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, element, controller ) and CoD.CraftUtility.Emblems_IsLayerLinked( element, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_group" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	layerCarousel:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	emblemHiddenPulseLayerPC( emblemHiddenPulseLayer, clipboard["Emblem.EmblemProperties.editorMode"], function ( f61_arg0, f61_arg1 )
		CoD.Menu.UpdateButtonShownState( f61_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerCarousel:linkToElementModel( layerCarousel, "layerIndex", true, function ( model, f62_arg1 )
		CoD.Menu.UpdateButtonShownState( f62_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	layerCarousel:linkToElementModel( layerCarousel, "iconID", true, function ( model, f63_arg1 )
		CoD.Menu.UpdateButtonShownState( f63_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	emblemHiddenPulseLayer = layerCarousel --[[ @ 0]]
	emblemHiddenPulseLayerPC = layerCarousel.subscribeToModel --[[ @ 0]]
	clipboard = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	emblemHiddenPulseLayerPC( emblemHiddenPulseLayer, clipboard["Emblem.EmblemProperties.groupsUsed"], function ( f64_arg0, f64_arg1 )
		CoD.Menu.UpdateButtonShownState( f64_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	emblemHiddenPulseLayer = layerCarousel --[[ @ 0]]
	emblemHiddenPulseLayerPC = layerCarousel.subscribeToModel --[[ @ 0]]
	clipboard = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	emblemHiddenPulseLayerPC( emblemHiddenPulseLayer, clipboard["Emblem.EmblemProperties.layersUsed"], function ( f65_arg0, f65_arg1 )
		CoD.Menu.UpdateButtonShownState( f65_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	layerCarousel:appendEventHandler( "input_source_changed", function ( f66_arg0, f66_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f66_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	emblemHiddenPulseLayer = layerCarousel --[[ @ 0]]
	emblemHiddenPulseLayerPC = layerCarousel.subscribeToModel --[[ @ 0]]
	clipboard = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	emblemHiddenPulseLayerPC( emblemHiddenPulseLayer, clipboard.LastInput, function ( f67_arg0, f67_arg1 )
		CoD.Menu.UpdateButtonShownState( f67_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	layerCarousel:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
		return f69_local0
	end ) --[[ @ 0]]
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsGroupSlotAvailable( f1_arg0 ) then
					f73_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_browse"] ) --[[ @ 0]]
					if f73_local0 then
	...
	EditControls:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f89_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) --[[ @ 0]]
				if f89_local0 then
					f89_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f89_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) then
					f90_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f90_local0 then
						if not CoD.CraftUtility.Emblems_IsLayerASticker( self.layerCarousel, f1_arg0 ) then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f91_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) --[[ @ 0]]
				if f91_local0 then
					f91_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f91_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f92_local0 --[[ @ 0]]
				if not CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) then
					f92_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f92_local0 then
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f93_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.scaleMode", Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) --[[ @ 0]]
				if f93_local0 then
					f93_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "Emblem.EmblemProperties.editorMode", Enum[@"customizationeditormode"][@"customization_editor_mode_edit"] ) --[[ @ 0]]
					if f93_local0 then
	...
	DrawEmblemFocusable( EmblemEditorPCLegend, PaintshopFrame["Emblem.EmblemProperties.editorMode"], function ( f112_arg0, f112_arg1 )
		CoD.Menu.UpdateButtonShownState( f112_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_left"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f112_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_right"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f112_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f112_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	emptyFocusable:appendEventHandler( "input_source_changed", function ( f113_arg0, f113_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f113_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_left"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f113_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_right"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	EmblemEditorPCLegend = emptyFocusable --[[ @ 0]]
	DrawEmblemFocusable = emptyFocusable.subscribeToModel --[[ @ 0]]
	PaintshopFrame = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	DrawEmblemFocusable( EmblemEditorPCLegend, PaintshopFrame.LastInput, function ( f114_arg0, f114_arg1 )
		CoD.Menu.UpdateButtonShownState( f114_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_left"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f114_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_right"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	emptyFocusable:linkToElementModel( emptyFocusable, "layerIndex", true, function ( model, f115_arg1 )
		CoD.Menu.UpdateButtonShownState( f115_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	emptyFocusable:linkToElementModel( emptyFocusable, "iconID", true, function ( model, f116_arg1 )
		CoD.Menu.UpdateButtonShownState( f116_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	EmblemEditorPCLegend = emptyFocusable --[[ @ 0]]
	DrawEmblemFocusable = emptyFocusable.subscribeToModel --[[ @ 0]]
	PaintshopFrame = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	DrawEmblemFocusable( EmblemEditorPCLegend, PaintshopFrame["Emblem.EmblemProperties.groupsUsed"], function ( f117_arg0, f117_arg1 )
		CoD.Menu.UpdateButtonShownState( f117_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	EmblemEditorPCLegend = emptyFocusable --[[ @ 0]]
	DrawEmblemFocusable = emptyFocusable.subscribeToModel --[[ @ 0]]
	PaintshopFrame = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	DrawEmblemFocusable( EmblemEditorPCLegend, PaintshopFrame["Emblem.EmblemProperties.layersUsed"], function ( f118_arg0, f118_arg1 )
		CoD.Menu.UpdateButtonShownState( f118_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	emptyFocusable:linkToElementModel( emptyFocusable, "isGrouped", true, function ( model, f119_arg1 )
		CoD.Menu.UpdateButtonShownState( f119_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	emptyFocusable:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_up"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( element, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
		return f120_local0
	end ) --[[ @ 0]]
	...
	f1_local23( f1_local22, f1_local24["Emblem.EmblemProperties.editorMode"], function ( f150_arg0, f150_arg1 )
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_start"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f150_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	self:linkToElementModel( self, "layerIndex", true, function ( model, f151_arg1 )
		CoD.Menu.UpdateButtonShownState( f151_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f151_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f151_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f151_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f151_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f151_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f151_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f151_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f151_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:linkToElementModel( self, "iconID", true, function ( model, f152_arg1 )
		CoD.Menu.UpdateButtonShownState( f152_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f152_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f152_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f152_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f152_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f152_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f152_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f152_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f152_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local22 = self --[[ @ 0]]
	f1_local23 = self.subscribeToModel --[[ @ 0]]
	f1_local24 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	f1_local23( f1_local22, f1_local24["Emblem.EmblemProperties.groupsUsed"], function ( f153_arg0, f153_arg1 )
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f153_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local22 = self --[[ @ 0]]
	f1_local23 = self.subscribeToModel --[[ @ 0]]
	f1_local24 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	f1_local23( f1_local22, f1_local24["Emblem.EmblemProperties.layersUsed"], function ( f154_arg0, f154_arg1 )
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_down"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f154_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	self:linkToElementModel( self, "isGrouped", true, function ( model, f155_arg1 )
		CoD.Menu.UpdateButtonShownState( f155_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_lb"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f155_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f155_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f155_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f155_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:linkToElementModel( self, "isLinked", true, function ( model, f156_arg1 )
		CoD.Menu.UpdateButtonShownState( f156_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rb"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	self:appendEventHandler( "input_source_changed", function ( f157_arg0, f157_arg1 )
		f157_arg1.menu = f157_arg1.menu or f1_local1 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f157_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f157_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f157_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f157_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f157_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local22 = self --[[ @ 0]]
	f1_local23 = self.subscribeToModel --[[ @ 0]]
	f1_local24 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	f1_local23( f1_local22, f1_local24.LastInput, function ( f158_arg0, f158_arg1 )
		CoD.Menu.UpdateButtonShownState( f158_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_back"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f158_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f158_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f158_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f158_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local22 = self --[[ @ 0]]
	f1_local23 = self.subscribeToModel --[[ @ 0]]
	f1_local24 = Engine[@"getmodelforcontroller"]( f1_arg0 ) --[[ @ 0]]
	f1_local23( f1_local22, f1_local24["Emblem.EmblemProperties.isClipboardEmpty"], function ( f159_arg0, f159_arg1 )
		CoD.Menu.UpdateButtonShownState( f159_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"], "ESCAPE", function ( element, menu, controller, model )
		...
		elseif CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsEmblemEmpty( controller ) and CoD.CraftUtility.Emblems_HasChanges( self, controller ) and IsMouseOrKeyboard( controller ) then
			...
			return true
		elseif CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsEmblemEmpty( controller ) and CoD.CraftUtility.Emblems_HasChanges( self, controller ) and IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xbb_pscircle"], @"hash_7AB744CDFD554F5F", nil, "ESCAPE" ) --[[ @ 0]]
			return true
		elseif CoD.CraftUtility.IsEditMode( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xbb_pscircle"], @"menu/back", nil, "ESCAPE" ) --[[ @ 0]]
			return true
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"], "ui_contextual_3", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and not CoD.CraftUtility.Emblem_IsLayerGrouped( self.layerCarousel, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_rstick_pressed"], @"hash_0", nil, "ui_contextual_3" ) --[[ @ 0]]
			return false
		elseif CoD.CraftUtility.IsBrowseMode( controller ) and not CoD.CraftUtility.IsClipboardEmpty( controller ) and CoD.CraftUtility.Emblem_CanPastFromClipboard( element, controller ) and CoD.CraftUtility.Clipboard_HasEnoughLayersToPaste( self, controller ) and IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_rstick_pressed"], @"hash_0", nil, "ui_contextual_3" ) --[[ @ 0]]
			return false
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], "ui_confirm", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xba_pscross"], @"hash_7E84DC9704A3FB30", nil, "ui_confirm" ) --[[ @ 0]]
			return true
		elseif not CoD.CraftUtility.IsLayerEmpty( self, self.layerCarousel, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xba_pscross"], @"hash_132F41E996619F54", nil, "ui_confirm" ) --[[ @ 0]]
			return true
		elseif CoD.CraftUtility.IsLayerEmpty( self, self.layerCarousel, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xba_pscross"], @"hash_7E84DC9704A3FB30", nil, "ui_confirm" ) --[[ @ 0]]
			return true
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_rtrig"], "ui_contextual_2", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsBrowseMode( controller ) and CoD.CraftUtility.Emblem_IsLayerGrouped( self.layerCarousel, controller ) and CoD.CraftUtility.EmblemEditor_CustomDecalGroupsSlotsRemaining( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_rtrig"], @"hash_0", nil, "ui_contextual_2" ) --[[ @ 0]]
			return false
		elseif IsElementInState( self.EmblemEditorPCLegend, "Close" ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_rtrig"], @"hash_490E9019810E01CA", nil, "ui_contextual_2" ) --[[ @ 0]]
			return true
		elseif IsElementInState( self.EmblemEditorPCLegend, "Open" ) and IsMouseOrKeyboard( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_rtrig"], @"hash_490E9019810E01CA", nil, "ui_contextual_2" ) --[[ @ 0]]
			return true
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_loweropacity", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, self.layerGrid, controller ) and not CoD.CraftUtility.Emblems_IsLayerASticker( self.layerGrid, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_loweropacity" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_raiseopacity", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, self.layerGrid, controller ) and not CoD.CraftUtility.Emblems_IsLayerASticker( self.layerGrid, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_raiseopacity" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_prevtab", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, self.layerGrid, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_prevtab" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_nexttab", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, self.layerGrid, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_nexttab" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_open", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and not CoD.CraftUtility.IsLayerEmpty( self, self.layerGrid, controller ) and not CoD.CraftUtility.Emblems_IsLayerASticker( self.layerGrid, controller ) and not CoD.CraftUtility.Emblem_IsGroupedLayerWithSticker( self.layerGrid, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_open" ) --[[ @ 0]]
			return false
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_none"], "ui_toggleoutline", function ( element, menu, controller, model )
		...
		if CoD.CraftUtility.IsEditMode( controller ) and not CoD.CraftUtility.Emblems_IsLayerASticker( self.layerGrid, controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_none"], @"hash_0", nil, "ui_toggleoutline" ) --[[ @ 0]]
			return false
		else
			return false
		end
