...
LUI.createMenu.Leaderboard_Main = function ( f1_arg0, f1_arg1 )
	...
	GenericMenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"hash_1FE3665244ECF33B" ) ) --[[ @ 0]]
	...
	GameModeList:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( GameModeList, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
