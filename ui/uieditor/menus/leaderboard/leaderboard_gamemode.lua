...
LUI.createMenu.Leaderboard_GameMode = function ( f3_arg0, f3_arg1 )
	...
	MenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"menu/leaderboards" ) ) --[[ @ 0]]
	...
	CurrentFilterInfo:setAlignment( Enum[@"luialignment"][@"lui_alignment_right"] ) --[[ @ 0]]
	CurrentFilterInfo:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
