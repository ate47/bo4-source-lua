...
LUI.createMenu.FirstTimeBrightnessSetting = function ( f3_arg0, f3_arg1 )
	...
	DescText:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	continueButton.label:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_66393FF34EA56966" ) ) --[[ @ 0]]
	...
	XboxGamerTag:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	...
	Header.HeaderText:setText( LocalizeToUpperString( @"hash_64ADE150FFB574D4" ) ) --[[ @ 0]]
	...
	f3_local1:AddButtonCallbackFunction( self, f3_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
		CoD.OptionsUtility.ResetPlayerSettingToDefault( self.Button, controller ) --[[ @ 0]]
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], @"hash_619D60864B204458", nil, nil ) --[[ @ 0]]
		return true
	end, false ) --[[ @ 0]]
	f3_local1:AddButtonCallbackFunction( self, f3_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
		ClearMenuSavedState( menu ) --[[ @ 0]]
