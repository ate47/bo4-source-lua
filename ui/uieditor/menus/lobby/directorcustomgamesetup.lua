...
LUI.createMenu.DirectorCustomGameSetUp = function ( f1_arg0, f1_arg1 )
	...
	HeaderGameRule:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	HeaderGameRule:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	FreeTeam:appendEventHandler( "on_session_start", function ( f5_arg0, f5_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f5_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	AxisTeam:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	AxisTeam:appendEventHandler( "on_session_start", function ( f21_arg0, f21_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f21_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	AxisTeam:appendEventHandler( "on_session_end", function ( f22_arg0, f22_arg1 )
		f22_arg1.menu = f22_arg1.menu or f1_local1 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f22_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	AxisTeam:appendEventHandler( "input_source_changed", function ( f29_arg0, f29_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f29_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	BackingAllies = AxisTeam --[[ @ 0]]
	HeaderAxisTeam = AxisTeam.subscribeToModel --[[ @ 0]]
	...
	HeaderAxisTeam( BackingAllies, AlliesTeam.LastInput, function ( f30_arg0, f30_arg1 )
		CoD.Menu.UpdateButtonShownState( f30_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	BackingAllies = AxisTeam --[[ @ 0]]
	HeaderAxisTeam = AxisTeam.subscribeToModel --[[ @ 0]]
	AlliesTeam = DataSources.LobbyRoot.getModel( f1_arg0 ) --[[ @ 0]]
	HeaderAxisTeam( BackingAllies, AlliesTeam.selectedXuidTeam, function ( f31_arg0, f31_arg1 )
		CoD.Menu.UpdateButtonShownState( f31_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	HeaderAxisTeam.Label:setText( LocalizeToUpperString( @"mpui/axis" ) ) --[[ @ 0]]
	...
	AlliesTeam:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
	...
	AlliesTeam:appendEventHandler( "on_session_end", function ( f38_arg0, f38_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f38_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	HeaderAlliesTeam( FooterContainerFrontendRight, CommonHeader["lobbyRoot.privateClient.update"], function ( f41_arg0, f41_arg1 )
		CoD.Menu.UpdateButtonShownState( f41_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	HeaderAlliesTeam( FooterContainerFrontendRight, CommonHeader.selectedXuid, function ( f44_arg0, f44_arg1 )
		CoD.Menu.UpdateButtonShownState( f44_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	AlliesTeam:appendEventHandler( "input_source_changed", function ( f45_arg0, f45_arg1 )
		f45_arg1.menu = f45_arg1.menu or f1_local1 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f45_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	FooterContainerFrontendRight = AlliesTeam --[[ @ 0]]
	HeaderAlliesTeam = AlliesTeam.subscribeToModel --[[ @ 0]]
	...
	HeaderAlliesTeam( FooterContainerFrontendRight, CommonHeader.LastInput, function ( f46_arg0, f46_arg1 )
		CoD.Menu.UpdateButtonShownState( f46_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	FooterContainerFrontendRight = AlliesTeam --[[ @ 0]]
	HeaderAlliesTeam = AlliesTeam.subscribeToModel --[[ @ 0]]
	CommonHeader = DataSources.LobbyRoot.getModel( f1_arg0 ) --[[ @ 0]]
	HeaderAlliesTeam( FooterContainerFrontendRight, CommonHeader.selectedXuidTeam, function ( f47_arg0, f47_arg1 )
		CoD.Menu.UpdateButtonShownState( f47_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	HeaderAlliesTeam.Label:setText( LocalizeToUpperString( @"mpui/allies" ) ) --[[ @ 0]]
	...
	self:linkToElementModel( self, "xuid", true, function ( model, f66_arg1 )
		CoD.Menu.UpdateButtonShownState( f66_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
...
CoD.DirectorCustomGameSetUp.__resetProperties = function ( f71_arg0 )
	...
	f71_arg0.HeaderAlliesTeam.Label:setText( LocalizeToUpperString( @"mpui/allies" ) ) --[[ @ 0]]
	...
	f71_arg0.HeaderAxisTeam.Label:setText( LocalizeToUpperString( @"mpui/axis" ) ) --[[ @ 0]]
...
CoD.DirectorCustomGameSetUp.__clipsPerState = {
	...
	NonTeamBasedGameMode = {
		DefaultClip = function ( f73_arg0, f73_arg1 )
			...
			f73_arg0.HeaderAlliesTeam.Label:setText( LocalizeToUpperString( @"mpui/allies" ) ) --[[ @ 0]]
