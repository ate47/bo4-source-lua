...
LUI.createMenu.DirectorChangeCharacter = function ( f1_arg0, f1_arg1 )
	...
	GenericMenuFrame.CommonHeader.subtitle.StageTitle:setText( LocalizeToUpperString( @"menu/select_character" ) ) --[[ @ 0]]
	...
	f1_local8( f1_local7, f1_local9.breadcrumbCount, function ( f7_arg0, f7_arg1 )
		CoD.Menu.UpdateButtonShownState( f7_arg1, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_rstick_pressed"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
