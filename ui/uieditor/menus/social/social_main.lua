...
LUI.createMenu.Social_Main = function ( f1_arg0, f1_arg1 )
	...
	f1_local8( f1_local7, f1_local9["socialRoot.tab"], function ( f6_arg0, f6_arg1 )
		CoD.Menu.UpdateButtonShownState( f6_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local7 = self --[[ @ 0]]
	...
	f1_local8( f1_local7, f1_local9["socialRoot.sort"], function ( f7_arg0, f7_arg1 )
		CoD.Menu.UpdateButtonShownState( f7_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	f1_local7 = self --[[ @ 0]]
	f1_local8 = self.subscribeToModel --[[ @ 0]]
	f1_local9 = DataSources.SocialRoot.getModel( f1_arg0 ) --[[ @ 0]]
	f1_local8( f1_local7, f1_local9.tab, function ( f8_arg0, f8_arg1 )
		CoD.Menu.UpdateButtonShownState( f8_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_222361E23588705A"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	self:appendEventHandler( "<datasourceChange>ClanInfo", function ( f9_arg0, f9_arg1 )
		f9_arg1.menu = f9_arg1.menu or f1_local1 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f9_arg0, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_222361E23588705A"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	f1_local7 = self --[[ @ 0]]
	f1_local8 = self.subscribeToModel --[[ @ 0]]
	f1_local9 = Engine[@"GetGlobalModel"]() --[[ @ 0]]
	f1_local8( f1_local7, f1_local9["lobbyRoot.rankMode"], function ( f10_arg0, f10_arg1 )
		CoD.Menu.UpdateButtonShownState( f10_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"], nil, function ( element, menu, controller, model )
		if not IsPC() and CoD.ModelUtility.IsGlobalModelValueEqualTo( "socialRoot.tab", "friends" ) and CoD.ModelUtility.IsGlobalModelValueEqualTo( "socialRoot.sort", Enum[@"PresenceSorting"][@"hash_6378D2974EF235BB"] ) then
			...
			return true
		elseif not IsPC() and CoD.ModelUtility.IsGlobalModelValueEqualTo( "socialRoot.tab", "friends" ) and CoD.ModelUtility.IsGlobalModelValueEqualTo( "socialRoot.sort", Enum[@"PresenceSorting"][@"hash_6874C3506F8D93CE"] ) then
			SocialToggleSorting( self, element, controller ) --[[ @ 0]]
			UpdateButtonPromptState( menu, element, controller, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
			return true
		else
		...
		if not IsPC() and CoD.ModelUtility.IsGlobalModelValueEqualTo( "socialRoot.tab", "friends" ) and CoD.ModelUtility.IsGlobalModelValueEqualTo( "socialRoot.sort", Enum[@"PresenceSorting"][@"hash_6378D2974EF235BB"] ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"], @"hash_5CA85F8B6A3ED016", nil, nil ) --[[ @ 0]]
			return true
		elseif not IsPC() and CoD.ModelUtility.IsGlobalModelValueEqualTo( "socialRoot.tab", "friends" ) and CoD.ModelUtility.IsGlobalModelValueEqualTo( "socialRoot.sort", Enum[@"PresenceSorting"][@"hash_6874C3506F8D93CE"] ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"], @"hash_4D80133548748A69", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], nil, function ( element, menu, controller, model )
		...
		if not IsPC() and not IsRepeatButtonPress( f23_local0 ) and CoD.RankUtility.IsCurrentRankModeEqualTo( CoD.RankUtility.RankMode.Multiplayer ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], @"hash_1502E6E565E8BFDE", nil, nil ) --[[ @ 0]]
			return true
		elseif not IsPC() and not IsRepeatButtonPress( f23_local0 ) and CoD.RankUtility.IsCurrentRankModeEqualTo( CoD.RankUtility.RankMode.Arena ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], @"hash_7E4653C70EC64D31", nil, nil ) --[[ @ 0]]
			return true
		elseif not IsPC() and not IsRepeatButtonPress( f23_local0 ) and CoD.RankUtility.IsCurrentRankModeEqualTo( CoD.RankUtility.RankMode.Warzone ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], @"hash_5F9B486622459EBA", nil, nil ) --[[ @ 0]]
			return true
		elseif not IsPC() and not IsRepeatButtonPress( f23_local0 ) and CoD.RankUtility.IsCurrentRankModeEqualTo( CoD.RankUtility.RankMode.Zombies ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], @"hash_534DE38E1E88127D", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
