...
LUI.createMenu.Social_InvitePlayersPopup = function ( f1_arg0, f1_arg1 )
	...
	InvitePlayersText:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	InvitePlayersText:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	SelectedCount2:setText( LocalizeToUpperString( @"menu/selected" ) ) --[[ @ 0]]
	SelectedCount2:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	SelectedCount2:setLetterSpacing( 4 ) --[[ @ 0]]
	SelectedCount2:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	SelectedCount2:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	noPlayersOnlineText:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	noPlayersOnlineText:setAlignment( Enum[@"luialignment"][@"lui_alignment_top"] ) --[[ @ 0]]
	...
	PCSimpleVScrollList:appendEventHandler( "input_source_changed", function ( f8_arg0, f8_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f8_arg0, f1_local1, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( PCSimpleVScrollList, f1_arg0, Enum[@"luibutton"][@"lui_key_xby_pstriangle"], nil, function ( element, menu, controller, model )
		...
		if IsGamepad( controller ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_xby_pstriangle"], @"hash_1E0254269ED8FFD3", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	f1_local28 = self --[[ @ 0]]
	SetElementPropertyEnum( self.onlineList, "_presenceFilter", Enum[@"presencefilter"][@"presence_filter_online"] ) --[[ @ 0]]
