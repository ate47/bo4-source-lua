...
local PostLoadFunc = function ( f2_arg0 )
 ...
 --[[ @ 0]]
CoD.FullScreenBlack = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.FullScreenBlack = function ( f8_arg0, f8_arg1 )
	local self = CoD.Menu.NewForUIEditor( "FullScreenBlack", f8_arg0 ) --[[ @ 0]]
	local f8_local1 = self --[[ @ 0]]
	SetProperty( self, "disableInputLock", true ) --[[ @ 0]]
	self:setClass( CoD.FullScreenBlack ) --[[ @ 0]]
	...
	self.Fullscreen:linkToElementModel( self, "color", true, function ( model )
		...
		if f11_local0 ~= nil then
			Fullscreen:setRGB( f11_local0 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
...
CoD.FullScreenBlack.__onClose = function ( f12_arg0 )
	f12_arg0.Fullscreen:close() --[[ @ 0]]
	f12_arg0.InGameTalkersWidget:close() --[[ @ 0]]
end
 --[[ @ 0]]
