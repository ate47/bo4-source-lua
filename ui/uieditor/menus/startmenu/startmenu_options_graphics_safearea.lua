...
CoD.StartMenu_Options_Graphics_SafeArea = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.StartMenu_Options_Graphics_SafeArea = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "StartMenu_Options_Graphics_SafeArea", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	CoD.BaseUtility.InitControllerModelIfNotSet( f1_arg0, "huditems.safeAreaUpdated", nil ) --[[ @ 0]]
	self:setClass( CoD.StartMenu_Options_Graphics_SafeArea ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], "ui_confirm", function ( element, menu, controller, model )
		if IsMainFirstTimeSetup( controller ) and not IsGameInstalled() and IsDurango() then
			DispatchEventToRoot( element, "update_safe_area", controller ) --[[ @ 0]]
			OpenOverlay_NoDependency( self, "FirstTimeDurangoDownloadSetting", controller, nil ) --[[ @ 0]]
			SetFirstTimeDurangoDownloadSettingDisplayed( controller ) --[[ @ 0]]
			return true
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_up"], "ui_navup", function ( element, menu, controller, model )
		...
		CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_up"], @"hash_0", nil, "ui_navup" ) --[[ @ 0]]
		return false
	end, false ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"luibutton"][@"lui_key_down"], "ui_navdown", function ( element, menu, controller, model )
		...
		CoD.Menu.SetButtonLabel( menu, Enum[@"luibutton"][@"lui_key_down"], @"hash_0", nil, "ui_navdown" ) --[[ @ 0]]
		return false
	end, false ) --[[ @ 0]]
	LUI.OverrideFunction_CallOriginalFirst( self, "close", function ( element )
		ForceNotifyModel( f1_arg0, "huditems.safeAreaUpdated" ) --[[ @ 0]]
	end ) --[[ @ 0]]
...
CoD.StartMenu_Options_Graphics_SafeArea.__resetProperties = function ( f19_arg0 )
	f19_arg0.HUDBounds:completeAnimation() --[[ @ 0]]
	f19_arg0.StartMenuOptionsSafeAreaHints:completeAnimation() --[[ @ 0]]
	f19_arg0.HUDBounds:setAlpha( 1 ) --[[ @ 0]]
	f19_arg0.StartMenuOptionsSafeAreaHints:setAlpha( 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.StartMenu_Options_Graphics_SafeArea.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f20_arg0, f20_arg1 )
			...
			f20_arg0.HUDBounds:completeAnimation() --[[ @ 0]]
			f20_arg0.HUDBounds:setAlpha( 0 ) --[[ @ 0]]
			f20_arg0.clipFinished( f20_arg0.HUDBounds ) --[[ @ 0]]
		end
	},
	PC = {
		DefaultClip = function ( f21_arg0, f21_arg1 )
			...
			f21_arg0.StartMenuOptionsSafeAreaHints:completeAnimation() --[[ @ 0]]
			f21_arg0.StartMenuOptionsSafeAreaHints:setAlpha( 0 ) --[[ @ 0]]
			f21_arg0.clipFinished( f21_arg0.StartMenuOptionsSafeAreaHints ) --[[ @ 0]]
			f21_arg0.HUDBounds:completeAnimation() --[[ @ 0]]
			f21_arg0.HUDBounds:setAlpha( 1 ) --[[ @ 0]]
			f21_arg0.clipFinished( f21_arg0.HUDBounds ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.StartMenu_Options_Graphics_SafeArea.__onClose = function ( f22_arg0 )
	f22_arg0.StartMenuOptionsSafeAreaHints:close() --[[ @ 0]]
	f22_arg0.emptyFocusable:close() --[[ @ 0]]
	f22_arg0.safeArea:close() --[[ @ 0]]
	f22_arg0.HUDBounds:close() --[[ @ 0]]
end
 --[[ @ 0]]
