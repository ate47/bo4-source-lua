...
CoD.EquipmentSelect = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.EquipmentSelect = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "EquipmentSelect", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	CoD.BaseUtility.SetPropertiesFromUserData( self, f1_arg1 ) --[[ @ 0]]
	self:setClass( CoD.EquipmentSelect ) --[[ @ 0]]
	...
	local BackgroundSlidePanel = CoD.cac_background_slide_panel_short.new( f1_local1, f1_arg0, 0, 1, 0, 0, 0, 0, 672, 1294 ) --[[ @ 0]]
	self:addElement( BackgroundSlidePanel ) --[[ @ 0]]
	self.BackgroundSlidePanel = BackgroundSlidePanel --[[ @ 0]]
	
	local EquipmentListWidget = CoD.EquipmentListWidget.new( f1_local1, f1_arg0, 0.5, 0.5, -1100, 1100, 0, 0, 580, 1080 ) --[[ @ 0]]
	...
	CACHeader.subtitle.StageTitle:setText( LocalizeToUpperString( CoD.CACUtility.GetHeaderNameForLoadoutSlot( self, @"hash_305E03714EE77FC" ) ) ) --[[ @ 0]]
...
CoD.EquipmentSelect.__resetProperties = function ( f12_arg0 )
	f12_arg0.EquipmentListWidget:completeAnimation() --[[ @ 0]]
	f12_arg0.BackgroundSlidePanel:completeAnimation() --[[ @ 0]]
	f12_arg0.EquipmentListWidget:setTopBottom( 0, 0, 580, 1080 ) --[[ @ 0]]
	f12_arg0.EquipmentListWidget:setAlpha( 1 ) --[[ @ 0]]
	f12_arg0.BackgroundSlidePanel:setTopBottom( 0, 0, 672, 1294 ) --[[ @ 0]]
	f12_arg0.BackgroundSlidePanel:setAlpha( 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.EquipmentSelect.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f13_arg0, f13_arg1 )
			...
			f13_arg0.clipFinished( f13_arg0.BackgroundSlidePanel ) --[[ @ 0]]
			f13_arg0.EquipmentListWidget:completeAnimation() --[[ @ 0]]
			f13_arg0.EquipmentListWidget:setTopBottom( 0, 0, 1080, 1580 ) --[[ @ 0]]
			f13_arg0.clipFinished( f13_arg0.EquipmentListWidget ) --[[ @ 0]]
		end,
		Open = function ( f14_arg0, f14_arg1 )
			...
			local f14_local0 = function ( f15_arg0 )
				local f15_local0 = function ( f16_arg0 )
					f16_arg0:beginAnimation( 100, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
					f16_arg0:setTopBottom( 0, 0, 672, 1294 ) --[[ @ 0]]
					f16_arg0:setAlpha( 1 ) --[[ @ 0]]
					f16_arg0:registerEventHandler( "transition_complete_keyframe", f14_arg0.clipFinished ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f14_arg0.BackgroundSlidePanel:beginAnimation( 100 ) --[[ @ 0]]
				f14_arg0.BackgroundSlidePanel:registerEventHandler( "interrupted_keyframe", f14_arg0.clipInterrupted ) --[[ @ 0]]
				f14_arg0.BackgroundSlidePanel:registerEventHandler( "transition_complete_keyframe", f15_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f14_arg0.BackgroundSlidePanel:completeAnimation() --[[ @ 0]]
			f14_arg0.BackgroundSlidePanel:setTopBottom( 0, 0, 872, 1494 ) --[[ @ 0]]
			f14_arg0.BackgroundSlidePanel:setAlpha( 0 ) --[[ @ 0]]
			f14_local0( f14_arg0.BackgroundSlidePanel ) --[[ @ 0]]
			local f14_local1 = function ( f17_arg0 )
				local f17_local0 = function ( f18_arg0 )
					f18_arg0:beginAnimation( 49 ) --[[ @ 0]]
					f18_arg0:setTopBottom( 0, 0, 580, 1080 ) --[[ @ 0]]
					f18_arg0:setAlpha( 1 ) --[[ @ 0]]
					f18_arg0:registerEventHandler( "transition_complete_keyframe", f14_arg0.clipFinished ) --[[ @ 0]]
				end
				 --[[ @ 0]]
				f14_arg0.EquipmentListWidget:beginAnimation( 200 ) --[[ @ 0]]
				f14_arg0.EquipmentListWidget:registerEventHandler( "interrupted_keyframe", f14_arg0.clipInterrupted ) --[[ @ 0]]
				f14_arg0.EquipmentListWidget:registerEventHandler( "transition_complete_keyframe", f17_local0 ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f14_arg0.EquipmentListWidget:completeAnimation() --[[ @ 0]]
			f14_arg0.EquipmentListWidget:setTopBottom( 0, 0, 600, 1100 ) --[[ @ 0]]
			f14_arg0.EquipmentListWidget:setAlpha( 0.01 ) --[[ @ 0]]
			f14_local1( f14_arg0.EquipmentListWidget ) --[[ @ 0]]
		end,
		Close = function ( f19_arg0, f19_arg1 )
			f19_arg0:__resetProperties() --[[ @ 0]]
			f19_arg0:setupElementClipCounter( 2 ) --[[ @ 0]]
			local f19_local0 = function ( f20_arg0 )
				f19_arg0.BackgroundSlidePanel:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
				...
				f19_arg0.BackgroundSlidePanel:registerEventHandler( "transition_complete_keyframe", f19_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			local f19_local1 = function ( f21_arg0 )
				f19_arg0.EquipmentListWidget:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
				f19_arg0.EquipmentListWidget:setTopBottom( 0, 0, 980, 1480 ) --[[ @ 0]]
				f19_arg0.EquipmentListWidget:setAlpha( 0 ) --[[ @ 0]]
				f19_arg0.EquipmentListWidget:registerEventHandler( "interrupted_keyframe", f19_arg0.clipInterrupted ) --[[ @ 0]]
				f19_arg0.EquipmentListWidget:registerEventHandler( "transition_complete_keyframe", f19_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f19_arg0.EquipmentListWidget:completeAnimation() --[[ @ 0]]
			f19_arg0.EquipmentListWidget:setTopBottom( 0, 0, 580, 1080 ) --[[ @ 0]]
			f19_arg0.EquipmentListWidget:setAlpha( 1 ) --[[ @ 0]]
			f19_local1( f19_arg0.EquipmentListWidget ) --[[ @ 0]]
		end,
		OpenPC = function ( f22_arg0, f22_arg1 )
			f22_arg0:__resetProperties() --[[ @ 0]]
			f22_arg0:setupElementClipCounter( 2 ) --[[ @ 0]]
			local f22_local0 = function ( f23_arg0 )
				f22_arg0.BackgroundSlidePanel:beginAnimation( 70 ) --[[ @ 0]]
				...
				f22_arg0.BackgroundSlidePanel:registerEventHandler( "transition_complete_keyframe", f22_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			local f22_local1 = function ( f24_arg0 )
				f22_arg0.EquipmentListWidget:beginAnimation( 70 ) --[[ @ 0]]
				f22_arg0.EquipmentListWidget:setAlpha( 1 ) --[[ @ 0]]
				f22_arg0.EquipmentListWidget:registerEventHandler( "interrupted_keyframe", f22_arg0.clipInterrupted ) --[[ @ 0]]
				f22_arg0.EquipmentListWidget:registerEventHandler( "transition_complete_keyframe", f22_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f22_arg0.EquipmentListWidget:completeAnimation() --[[ @ 0]]
			f22_arg0.EquipmentListWidget:setAlpha( 0 ) --[[ @ 0]]
			f22_local1( f22_arg0.EquipmentListWidget ) --[[ @ 0]]
		end,
		ClosePC = function ( f25_arg0, f25_arg1 )
			f25_arg0:__resetProperties() --[[ @ 0]]
			f25_arg0:setupElementClipCounter( 2 ) --[[ @ 0]]
			local f25_local0 = function ( f26_arg0 )
				f25_arg0.BackgroundSlidePanel:beginAnimation( 40 ) --[[ @ 0]]
			...
			local f25_local1 = function ( f27_arg0 )
				f25_arg0.EquipmentListWidget:beginAnimation( 40 ) --[[ @ 0]]
...
CoD.EquipmentSelect.__onClose = function ( f28_arg0 )
	f28_arg0.ItemInfo:close() --[[ @ 0]]
	f28_arg0.RestrictedText:close() --[[ @ 0]]
	f28_arg0.XCamMouseControl:close() --[[ @ 0]]
	f28_arg0.BackgroundSlidePanel:close() --[[ @ 0]]
	f28_arg0.EquipmentListWidget:close() --[[ @ 0]]
	f28_arg0.CACHeader:close() --[[ @ 0]]
	f28_arg0.BackingGrayMediumLeft:close() --[[ @ 0]]
	f28_arg0.FooterContainerFrontendRight:close() --[[ @ 0]]
end
 --[[ @ 0]]
