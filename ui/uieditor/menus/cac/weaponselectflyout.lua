...
require( "x64:76b510bc5f01b8c5" ) --[[ @ 0]]
...
require( "x64:3db0d043e3841f5c" ) --[[ @ 0]]
require( "ui/uieditor/widgets/pc/utility/xcammousecontrol" ) --[[ @ 0]]

CoD.WeaponSelectFlyout = InheritFrom( CoD.Menu ) --[[ @ 0]]
LUI.createMenu.WeaponSelectFlyout = function ( f1_arg0, f1_arg1 )
	local self = CoD.Menu.NewForUIEditor( "WeaponSelectFlyout", f1_arg0 ) --[[ @ 0]]
	local f1_local1 = self --[[ @ 0]]
	CoD.BaseUtility.SetPropertiesFromUserData( self, f1_arg1 ) --[[ @ 0]]
	CoD.BaseUtility.InitControllerModelIfNotSet( f1_arg0, "hudItems.previewingMK2Weapon", 0 ) --[[ @ 0]]
	CoD.BaseUtility.CreateControllerModel( f1_arg0, "VariantListShownUpdate" ) --[[ @ 0]]
	self:setClass( CoD.WeaponSelectFlyout ) --[[ @ 0]]
	...
	local Mark2BonusExpLongBadge = CoD.Mark2BonusExpLongBadge.new( f1_local1, f1_arg0, 0.5, 0.5, -790, -530, 0, 0, 600, 618 ) --[[ @ 0]]
	Mark2BonusExpLongBadge:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsCurrentMenu( menu, "PaintjobWeaponSelect" ) then
					f5_local0 = CoD.CACUtility.IsProgressionEnabledForMenu( menu ) --[[ @ 0]]
					if f5_local0 then
						f5_local0 = CoD.ModelUtility.IsModelValueGreaterThan( f1_arg0, "hudItems.previewingMK2Weapon", 0 ) --[[ @ 0]]
					end
				else
					f5_local0 = false --[[ @ 0]]
				end
	...
	local ItemInfo = Mark2BonusExpLongBadge --[[ @ 0]]
	local WeaponLevel = Mark2BonusExpLongBadge.subscribeToModel --[[ @ 0]]
	local WeaponAttributes = Engine[@"GetModelForController"]( f1_arg0 ) --[[ @ 0]]
	...
	self:addElement( Mark2BonusExpLongBadge ) --[[ @ 0]]
	self.Mark2BonusExpLongBadge = Mark2BonusExpLongBadge --[[ @ 0]]
	
	WeaponLevel = CoD.ItemWeaponLevel.new( f1_local1, f1_arg0, 0.5, 0.5, -790, 790, 0, 0, 650, 662 ) --[[ @ 0]]
	self:addElement( WeaponLevel ) --[[ @ 0]]
	self.WeaponLevel = WeaponLevel --[[ @ 0]]
	
	ItemInfo = CoD.ItemNameDescUnlockText.new( f1_local1, f1_arg0, 0.5, 0.5, -792, -292, 0, 0, 451.5, 558.5 ) --[[ @ 0]]
	self:addElement( ItemInfo ) --[[ @ 0]]
	self.ItemInfo = ItemInfo --[[ @ 0]]
	
	WeaponAttributes = CoD.WeaponAttributes.new( f1_local1, f1_arg0, 0.5, 0.5, 450, 895, 0, 0, 425, 675 ) --[[ @ 0]]
	...
	local RestrictedText = CoD.RestrictedItemWarningText.new( f1_local1, f1_arg0, 0.5, 0.5, -247, 247, 0, 0, 635, 665 ) --[[ @ 0]]
	self:addElement( RestrictedText ) --[[ @ 0]]
	self.RestrictedText = RestrictedText --[[ @ 0]]
	
	local DoubleWeaponXPIcon = CoD.DoubleWeaponXPIcon.new( f1_local1, f1_arg0, 0.5, 0.5, -881, -809, 0, 0, 600, 672 ) --[[ @ 0]]
	self:addElement( DoubleWeaponXPIcon ) --[[ @ 0]]
	self.DoubleWeaponXPIcon = DoubleWeaponXPIcon --[[ @ 0]]
	
	local WeaponListWidget = CoD.WeaponListWidget.new( f1_local1, f1_arg0, 0.5, 0.5, -960, 960, 0, 0, 680, 1170 ) --[[ @ 0]]
	...
	LUI.OverrideFunction_CallOriginalFirst( self, "close", function ( element )
		...
		SetControllerModelValue( f1_arg0, "hudItems.previewingMK2Weapon", 0 ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	elseif IsPC() then
		CoD.BaseUtility.SetModelFromPropertyModel( f1_arg0, self, self ) --[[ @ 0]]
		CoD.CACUtility.PlayChooseScreenIntro( f1_local1, f1_arg0, 200, "OpenPC", false ) --[[ @ 0]]
		MenuHidesFreeCursor( f1_local1, f1_arg0 ) --[[ @ 0]]
	end
	return self
end
...
CoD.WeaponSelectFlyout.__resetProperties = function ( f19_arg0 )
	...
	f19_arg0.WeaponListWidget:setTopBottom( 0, 0, 680, 1170 ) --[[ @ 0]]
	...
	DefaultState = {
		...
		Open = function ( f21_arg0, f21_arg1 )
			...
			local f21_local0 = function ( f22_arg0 )
				local f22_local0 = function ( f23_arg0 )
					f23_arg0:beginAnimation( 100, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
			...
			local f21_local1 = function ( f24_arg0 )
				local f24_local0 = function ( f25_arg0 )
				 ...
				 --[[ @ 0]]
				f21_arg0.WeaponListWidget:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
			...
			f21_arg0.WeaponListWidget:setAlpha( 0.01 ) --[[ @ 0]]
		...
		Close = function ( f26_arg0, f26_arg1 )
			...
			local f26_local0 = function ( f27_arg0 )
				f26_arg0.BackgroundSlidePanel:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
			...
			local f26_local1 = function ( f28_arg0 )
				f26_arg0.WeaponListWidget:beginAnimation( 200, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
		...
		OpenPC = function ( f29_arg0, f29_arg1 )
			...
			local f29_local0 = function ( f30_arg0 )
				f29_arg0.BackgroundSlidePanel:beginAnimation( 70 ) --[[ @ 0]]
				f29_arg0.BackgroundSlidePanel:setAlpha( 1 ) --[[ @ 0]]
				f29_arg0.BackgroundSlidePanel:registerEventHandler( "interrupted_keyframe", f29_arg0.clipInterrupted ) --[[ @ 0]]
				f29_arg0.BackgroundSlidePanel:registerEventHandler( "transition_complete_keyframe", f29_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			...
			local f29_local1 = function ( f31_arg0 )
				f29_arg0.WeaponListWidget:beginAnimation( 70 ) --[[ @ 0]]
				f29_arg0.WeaponListWidget:setAlpha( 1 ) --[[ @ 0]]
				f29_arg0.WeaponListWidget:registerEventHandler( "interrupted_keyframe", f29_arg0.clipInterrupted ) --[[ @ 0]]
				f29_arg0.WeaponListWidget:registerEventHandler( "transition_complete_keyframe", f29_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f29_arg0.WeaponListWidget:completeAnimation() --[[ @ 0]]
			f29_arg0.WeaponListWidget:setAlpha( 0 ) --[[ @ 0]]
			f29_local1( f29_arg0.WeaponListWidget ) --[[ @ 0]]
		end,
		ClosePC = function ( f32_arg0, f32_arg1 )
			f32_arg0:__resetProperties() --[[ @ 0]]
			f32_arg0:setupElementClipCounter( 2 ) --[[ @ 0]]
			local f32_local0 = function ( f33_arg0 )
				f32_arg0.BackgroundSlidePanel:beginAnimation( 40 ) --[[ @ 0]]
				f32_arg0.BackgroundSlidePanel:setAlpha( 0 ) --[[ @ 0]]
				f32_arg0.BackgroundSlidePanel:registerEventHandler( "interrupted_keyframe", f32_arg0.clipInterrupted ) --[[ @ 0]]
				f32_arg0.BackgroundSlidePanel:registerEventHandler( "transition_complete_keyframe", f32_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f32_arg0.BackgroundSlidePanel:completeAnimation() --[[ @ 0]]
			f32_arg0.BackgroundSlidePanel:setAlpha( 1 ) --[[ @ 0]]
			f32_local0( f32_arg0.BackgroundSlidePanel ) --[[ @ 0]]
			local f32_local1 = function ( f34_arg0 )
				f32_arg0.WeaponListWidget:beginAnimation( 40 ) --[[ @ 0]]
				f32_arg0.WeaponListWidget:setAlpha( 0 ) --[[ @ 0]]
				f32_arg0.WeaponListWidget:registerEventHandler( "interrupted_keyframe", f32_arg0.clipInterrupted ) --[[ @ 0]]
				f32_arg0.WeaponListWidget:registerEventHandler( "transition_complete_keyframe", f32_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f32_arg0.WeaponListWidget:completeAnimation() --[[ @ 0]]
			f32_arg0.WeaponListWidget:setAlpha( 1 ) --[[ @ 0]]
			f32_local1( f32_arg0.WeaponListWidget ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.WeaponSelectFlyout.__onClose = function ( f35_arg0 )
	f35_arg0.WeaponLevel:close() --[[ @ 0]]
	f35_arg0.WeaponAttributes:close() --[[ @ 0]]
	f35_arg0.RestrictedText:close() --[[ @ 0]]
	f35_arg0.XCamMouseControl:close() --[[ @ 0]]
	f35_arg0.BackgroundSlidePanel:close() --[[ @ 0]]
	f35_arg0.CACHeader:close() --[[ @ 0]]
	f35_arg0.Mark2BonusExpLongBadge:close() --[[ @ 0]]
	f35_arg0.ItemInfo:close() --[[ @ 0]]
	f35_arg0.DoubleWeaponXPIcon:close() --[[ @ 0]]
	f35_arg0.WeaponListWidget:close() --[[ @ 0]]
