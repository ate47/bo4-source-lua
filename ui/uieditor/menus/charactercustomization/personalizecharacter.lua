...
LUI.createMenu.PersonalizeCharacter = function ( f1_arg0, f1_arg1 )
	...
	outfitsPC:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( outfitsPC, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	f1_local1:AddButtonCallbackFunction( outfitsPC, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], "ui_remove", function ( element, menu, controller, model )
	...
	outfitsPC:AddContextualMenuAction( f1_local1, f1_arg0, @"hash_1679ACA6FFC6C8F3", function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
	...
	themesPC:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( themesPC, f1_arg0, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, function ( element, menu, controller, model )
	...
	self:linkToElementModel( self, "disabled", true, function ( model, f34_arg1 )
		CoD.Menu.UpdateButtonShownState( f34_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
	...
	self:appendEventHandler( "input_source_changed", function ( f35_arg0, f35_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f35_arg0, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f35_arg0, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_local19( f1_local18, f1_local20.LastInput, function ( f36_arg0, f36_arg1 )
		CoD.Menu.UpdateButtonShownState( f36_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
	...
	self:linkToElementModel( self, "previewEnabled", true, function ( model, f37_arg1 )
		CoD.Menu.UpdateButtonShownState( f37_arg1, f1_local1, f1_arg0, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_local1:AddButtonCallbackFunction( self, f1_arg0, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], "ui_contextual_1", function ( element, menu, controller, model )
		...
		if CoD.ModelUtility.IsSelfModelValueTrue( self, controller, "previewEnabled" ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], @"hash_52FB29ED3A3CA79", nil, "ui_contextual_1" ) --[[ @ 0]]
			return true
		else
			return false
		end
	...
	LUI.OverrideFunction_CallOriginalFirst( self, "close", function ( element )
		if IsMultiplayer() then
			...
			CoD.BreadcrumbUtility.UploadBuffer( f1_arg0, Enum[@"StorageFileType"][@"hash_16C886CEB6BF4BCA"] ) --[[ @ 0]]
		elseif IsWarzone() then
			SendClientScriptMenuChangeNotify( f1_arg0, f1_local1, false ) --[[ @ 0]]
			ClearMenuSavedState( f1_local1 ) --[[ @ 0]]
			CoD.PlayerRoleUtility.CleanupOutfitData( f1_arg0 ) --[[ @ 0]]
			CoD.BreadcrumbUtility.UploadBuffer( f1_arg0, Enum[@"StorageFileType"][@"hash_DF87425733853AE"] ) --[[ @ 0]]
