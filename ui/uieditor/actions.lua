...
function SendButtonPressToMenuEx( f15_arg0, f15_arg1, f15_arg2 )
	...
	if f15_local0 then
		Engine[@"setmodelvalue"]( f15_local0, Enum[@"luibuttonflags"][@"flag_down"] ) --[[ @ 0]]
	...
	if CoD.isPC then
		...
		if f16_arg1.__autoButtonCallback then
			for f16_local3, f16_local4 in pairs( f16_arg1.__autoButtonCallback ) --[[ @ 0]] do
				if f16_local4 then
					f16_arg0:AddButtonCallbackFunction( f16_arg1, f16_arg2, Enum[@"luibutton"][@"lui_key_none"], f16_local3, nil, nil, nil ) --[[ @ 0]]
				end
			end
		end
	end
...
function ResetGameSettings()
	Engine[@"setgametype"]( Engine[@"lobbygetgametype"]() ) --[[ @ 0]]
...
function ShowKeyboard( f88_arg0, f88_arg1, f88_arg2, f88_arg3 )
	Engine[@"exec"]( f88_arg2, "ui_keyboard_new " .. Enum[@"keyboardtype"][Engine[@"converttoxhash"]( f88_arg3 )] ) --[[ @ 0]]
end
...
function SetHeadingKickerTextToGameMode()
	if CoD.PrestigeUtility.isInPermanentUnlockMenu then
		SetHeadingKickerText( @"menu/permanent_unlocks" ) --[[ @ 0]]
		return 
...
function RefreshServerList( f96_arg0, f96_arg1 )
	Engine[@"lobbyserverrefreshlocalservers"]( f96_arg1 ) --[[ @ 0]]
end
...
function JoinSystemLinkServer( f97_arg0, f97_arg1, f97_arg2 )
	...
	if f97_local1 == Enum[@"emodes"][@"mode_campaign"] then
		...
		f97_local2 = f97_local3[@"maxlocalclientsnetwork"] --[[ @ 0]]
	...
	local f97_local3 = function ( f98_arg0 )
		if f98_arg0 then
			Engine[@"lobbyserverlistjoinserver"]( f98_arg0.controller, f98_arg0.index ) --[[ @ 0]]
		end
	end
	 --[[ @ 0]]
...
function LobbyAddLocalClient( f99_arg0, f99_arg1 )
	...
	if Engine[@"getusedcontrollercount"]() < Dvar[@"lobby_maxlocalplayers"]:get() then
		...
		local f99_local4 = Engine[@"getdvarint"]( "bot_maxAllies" ) --[[ @ 0]]
		local f99_local5 = Engine[@"getdvarint"]( "bot_maxAxis" ) --[[ @ 0]]
		local f99_local6 = Engine[@"getdvarint"]( "bot_maxFree" ) --[[ @ 0]]
...
function SaveLoadout( f102_arg0, f102_arg1 )
	...
	Engine[@"saveloadout"]( f102_arg1, f102_local0 ) --[[ @ 0]]
	if f102_local0 == Enum[@"emodes"][@"mode_multiplayer"] then
		CoD.BreadcrumbUtility.UploadBuffer( f102_arg1, Enum[@"storagefiletype"][@"storage_mp_stats_online"] ) --[[ @ 0]]
	elseif f102_local0 == Enum[@"emodes"][@"mode_warzone"] then
		CoD.BreadcrumbUtility.UploadBuffer( f102_arg1, Enum[@"storagefiletype"][@"storage_wz_stats_online"] ) --[[ @ 0]]
	elseif f102_local0 == Enum[@"emodes"][@"mode_zombies"] then
		CoD.BreadcrumbUtility.UploadBuffer( f102_arg1, Enum[@"storagefiletype"][@"storage_zm_stats_online"] ) --[[ @ 0]]
	end
end
...
function SaveLoadoutGeneric( f103_arg0 )
	...
	Engine[@"saveloadout"]( f103_arg0, f103_local0 ) --[[ @ 0]]
	if f103_local0 == Enum[@"emodes"][@"mode_multiplayer"] then
		CoD.BreadcrumbUtility.UploadBuffer( f103_arg0, Enum[@"storagefiletype"][@"storage_mp_stats_online"] ) --[[ @ 0]]
	elseif f103_local0 == Enum[@"emodes"][@"mode_warzone"] then
		CoD.BreadcrumbUtility.UploadBuffer( f103_arg0, Enum[@"storagefiletype"][@"storage_wz_stats_online"] ) --[[ @ 0]]
	elseif f103_local0 == Enum[@"emodes"][@"mode_zombies"] then
		CoD.BreadcrumbUtility.UploadBuffer( f103_arg0, Enum[@"storagefiletype"][@"storage_zm_stats_online"] ) --[[ @ 0]]
	end
end
...
function PositionDraftReady( f108_arg0, f108_arg1, f108_arg2 )
	...
	local f108_local0 = Engine[@"getmodelforclient"]( Engine[@"getclientnum"]( f108_arg2 ) ) --[[ @ 0]]
...
function PositionDraftOnFocusCharacter( f109_arg0, f109_arg1, f109_arg2 )
	...
	if not CoD.BaseUtility.IsCurrentSessionModeEqualTo( Enum[@"emodes"][@"mode_warzone"] ) and f109_local2 and f109_local2 >= 0 then
		...
		if f109_local3 and f109_local3 > CoDShared.EmptyItemIndex then
			f109_local0 = Engine[@"getitemref"]( f109_local3, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f109_local1 ) --[[ @ 0]]
		end
	end
...
function PositionDraftSelectCharacter( f112_arg0, f112_arg1, f112_arg2 )
	...
	if f112_local0:get() == false then
		...
		CoD.perController[f112_arg2].classNum = Engine[@"getpositionrolecustomclassindex"]( Engine[@"currentsessionmode"](), f112_arg1.characterIndex ) --[[ @ 0]]
...
function PositionDraftSelectCharacterFrontend( f113_arg0, f113_arg1, f113_arg2 )
	...
	if f113_local0:get() == false then
		...
		Engine[@"sendcharacterdraftselection"]( f113_arg2, Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_client"] ), f113_local0 ) --[[ @ 0]]
		...
		CoD.perController[f113_arg2].classNum = Engine[@"getpositionrolecustomclassindex"]( Engine[@"currentsessionmode"](), f113_local0 ) --[[ @ 0]]
...
function CustomGameSettingsMenuClosed( f115_arg0, f115_arg1 )
	local f115_local0 = Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_host"] ) --[[ @ 0]]
	Engine[@"lobbyevent"]( "OnGametypeSettingsChange", {
		lobbyModule = Enum[@"lobbymodule"][@"lobby_module_host"],
		lobbyType = f115_local0,
		fromUI = true
	} ) --[[ @ 0]]
	Engine[@"lobbyhostsessionsetdirty"]( f115_local0, Enum[@"sessiondirty"][@"session_dirty_state"] ) --[[ @ 0]]
end
...
function SetFirstTimeSetupComplete_MP( f139_arg0, f139_arg1, f139_arg2, f139_arg3, f139_arg4 )
	Engine[@"setfirsttimecomplete"]( f139_arg2, Enum[@"emodes"][@"mode_multiplayer"], true ) --[[ @ 0]]
...
function ResetClientLoadouts( f145_arg0 )
	if Engine[@"islobbyhost"]( Enum[@"lobbytype"][@"lobby_type_private"] ) then
		Engine[@"lobbyevent"]( "ResetClientLoadouts", {} ) --[[ @ 0]]
	end
end
...
function OpenQuarterMaster( f148_arg0, f148_arg1, f148_arg2, f148_arg3, f148_arg4 )
	if not Engine[@"isuserguest"]( f148_arg2 ) then
		...
		CoD.SurveyUtility.OpenSurvey( f148_arg4, f148_arg2, Enum[@"surveytype"][@"hash_251C2AA5FA0D8715"] ) --[[ @ 0]]
	end
end
...
function PromoteToLeader( f151_arg0, f151_arg1, f151_arg2, f151_arg3, f151_arg4, f151_arg5 )
	Engine[@"giveleadership"]( f151_arg3.controller, Enum[@"lobbytype"][@"lobby_type_private"], f151_arg3.xuid ) --[[ @ 0]]
...
function DisconnectClient( f152_arg0, f152_arg1, f152_arg2, f152_arg3, f152_arg4, f152_arg5 )
	if Engine[@"hash_65CB8E6B7FBBFFD5"]( f152_arg3.xuid ) then
		Engine[@"hash_3D79B00C4CCE228B"]( Enum[@"lobbytype"][@"lobby_type_private"], f152_arg3.xuid ) --[[ @ 0]]
	else
		Engine[@"disconnectclientfromlobby"]( f152_arg3.controller, Enum[@"lobbytype"][@"lobby_type_private"], f152_arg3.xuid, Enum[@"lobbydisconnectclient"][@"lobby_disconnect_client_kick"] ) --[[ @ 0]]
		if CoD.isPC then
...
function MutePlayer( f153_arg0, f153_arg1, f153_arg2, f153_arg3, f153_arg4, f153_arg5 )
	if Engine[@"hash_686E64DD1C270046"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_private"], f153_arg3.xuid ) then
		Engine[@"muteplayer"]( f153_arg3.controller, Enum[@"lobbytype"][@"lobby_type_private"], f153_arg3.xuid ) --[[ @ 0]]
	end
	if Engine[@"hash_686E64DD1C270046"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_game"], f153_arg3.xuid ) then
		Engine[@"muteplayer"]( f153_arg3.controller, Enum[@"lobbytype"][@"lobby_type_game"], f153_arg3.xuid ) --[[ @ 0]]
	end
...
function UnMutePlayer( f154_arg0, f154_arg1, f154_arg2, f154_arg3, f154_arg4, f154_arg5 )
	if Engine[@"hash_686E64DD1C270046"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_private"], f154_arg3.xuid ) then
		Engine[@"unmuteplayer"]( f154_arg3.controller, Enum[@"lobbytype"][@"lobby_type_private"], f154_arg3.xuid ) --[[ @ 0]]
	end
	if Engine[@"hash_686E64DD1C270046"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_game"], f154_arg3.xuid ) then
		Engine[@"unmuteplayer"]( f154_arg3.controller, Enum[@"lobbytype"][@"lobby_type_game"], f154_arg3.xuid ) --[[ @ 0]]
	end
...
function LobbyOnlineCustomLaunchGame_SelectionList( f156_arg0, f156_arg1, f156_arg2 )
	...
	CoD.LobbyUtility.LaunchGame( f156_arg0, f156_arg2, Enum[@"lobbytype"][@"lobby_type_game"] ) --[[ @ 0]]
end
...
function OpenTheaterSelectFilm( f158_arg0, f158_arg1 )
	CoD.FileshareUtility.SetFileshareMode( f158_arg1, Enum[@"filesharemode"][@"fileshare_mode_user"] ) --[[ @ 0]]
...
function LobbyQuickJoin( f162_arg0, f162_arg1, f162_arg2, f162_arg3, f162_arg4, f162_arg5 )
	...
	if f162_arg4 ~= nil and f162_arg4 >= 0 and f162_arg4 < Enum[@"jointype"][@"join_type_count"] then
		...
		f162_local3 = Enum[@"jointype"][@"join_type_normal"] --[[ @ 0]]
	end
	local f162_local4 = {
	...
	if Engine[@"isingame"]() then
		if not Engine[@"hash_686E64DD1C270046"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_game"], f162_local4.xuid ) then
			...
			Engine[@"lobbyevent"]( "OnInGameJoin", f162_local4 ) --[[ @ 0]]
		end
	else
		Engine[@"lobbyevent"]( "OnJoin", f162_local4 ) --[[ @ 0]]
	end
end
...
function LobbyQuickJoinPC( f163_arg0, f163_arg1, f163_arg2, f163_arg3 )
	...
	if f163_arg3 and f163_arg3 >= 0 and f163_arg3 < Enum[@"jointype"][@"join_type_count"] then
		...
		f163_local4 = Enum[@"jointype"][@"join_type_normal"] --[[ @ 0]]
	end
...
function LobbyQuickJoinFinal( f165_arg0, f165_arg1, f165_arg2, f165_arg3, f165_arg4 )
	...
	if Engine[@"isingame"]() then
		if not Engine[@"hash_686E64DD1C270046"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_game"], f165_arg3 ) then
			...
			Engine[@"lobbyevent"]( "OnInGameJoin", f165_local0 ) --[[ @ 0]]
		end
	else
		Engine[@"lobbyevent"]( "OnJoin", f165_local0 ) --[[ @ 0]]
	end
	return true
end
...
function EnableMouseLockInputForMap( f184_arg0, f184_arg1, f184_arg2 )
	EnableMouseLockInputBinding( f184_arg0, f184_arg1, f184_arg2, Engine[@"profileint"]( f184_arg1, @"cursor_immediate_lock_map" ) == 1 ) --[[ @ 0]]
end

function EnableMouseLockInputForInventory( f185_arg0, f185_arg1, f185_arg2 )
	EnableMouseLockInputBinding( f185_arg0, f185_arg1, f185_arg2, Engine[@"profileint"]( f185_arg1, @"cursor_immediate_lock_inventory" ) == 1 ) --[[ @ 0]]
end
...
function NavigateToLobby_SelectionList( f237_arg0, f237_arg1, f237_arg2, f237_arg3, f237_arg4 )
	if f237_arg3 == LuaEnum.UI.DIRECTOR_ONLINE_ZM_CUSTOM then
		...
		Engine[@"runplaylistrules"]( f237_arg2 ) --[[ @ 0]]
	end
	...
	local f237_local1 = Engine[@"getdvarbool"]( "probation_public_enabled" ) --[[ @ 0]]
	local f237_local2 = Engine[@"getdvarbool"]( "probation_league_enabled" ) --[[ @ 0]]
...
function GetPlayerCalloutNameColor( f298_arg0, f298_arg1 )
	local f298_local0 = Enum[@"cacheduicolors"][@"cached_ui_color_enemy"] --[[ @ 0]]
	if CoD.IsShoutcaster( f298_arg0 ) then
		...
		if f298_local2 == f298_arg1 then
			f298_local0 = Enum[@"cacheduicolors"][@"cached_ui_color_self"] --[[ @ 0]]
		elseif f298_local1 == Enum[@"team_t"][@"team_allies"] then
			f298_local0 = Enum[@"cacheduicolors"][@"cached_ui_color_allies"] --[[ @ 0]]
		else
			f298_local0 = Enum[@"cacheduicolors"][@"cached_ui_color_axis"] --[[ @ 0]]
		end
		return f298_local0
	...
	elseif Engine[@"getteamid"]( f298_arg0, f298_arg1 ) == CoD.TeamUtility.GetTeamID( f298_arg0 ) then
		f298_local0 = Enum[@"cacheduicolors"][@"cached_ui_color_friendly"] --[[ @ 0]]
	end
	return f298_local0
end
...
function SetupStageResultsWidget( f300_arg0, f300_arg1 )
	...
	f300_local1:set( Enum[@"team_t"][@"team_free"] ) --[[ @ 0]]
...
function PopulateCompletionTimeField( f302_arg0, f302_arg1 )
	...
	local f302_local5 = Engine[@"lobbygetmap"]() --[[ @ 0]]
...
function MarkCACPaintshopDataDirty( f352_arg0, f352_arg1 )
	Engine[@"markpsdatadirty"]( f352_arg1, false ) --[[ @ 0]]
end
...
function BubblegumPackOptionsRename( f356_arg0, f356_arg1, f356_arg2 )
	...
	if f356_local0 then
		...
		Engine[@"exec"]( f356_arg2, "ui_keyboard_new " .. Enum[@"keyboardtype"][@"keyboard_type_bubblegum_pack"] ) --[[ @ 0]]
	end
end
...
function ClassOptionsCopyLoadout( f358_arg0, f358_arg1, f358_arg2, f358_arg3 )
	...
	if f358_local1 and f358_local2 then
		...
		if f358_local3 and f358_local4 then
			Engine[@"copyclass"]( f358_arg2, f358_local3, f358_local4, f358_local0 ) --[[ @ 0]]
...
function ClassOptionsResetToDefault( f360_arg0, f360_arg1, f360_arg2, f360_arg3 )
	...
	local f360_local3 = LuaUtils.IsArenaMode() and @"mp_arena_default_loadouts" or @"mp_default_loadouts" --[[ @ 0]]
	local f360_local4 = nil --[[ @ 0]]
	if f360_local0 == Enum[@"emodes"][@"mode_campaign"] then
		f360_local3 = @"cp_default_loadouts" --[[ @ 0]]
	elseif f360_local0 == Enum[@"emodes"][@"mode_zombies"] then
		f360_local3 = @"zm_default_loadouts" --[[ @ 0]]
	...
	if f360_local1 and f360_local2 then
		...
		if f360_local5 and f360_local6 and f360_local7 then
			...
			if f360_local9 then
				...
				Engine[@"saveloadout"]( f360_arg2, f360_local0 ) --[[ @ 0]]
			end
...
function RecordStoreOnItemGainFocus( f383_arg0, f383_arg1, f383_arg2, f383_arg3 )
	f383_arg1.onGainFocusTime = Engine[@"milliseconds"]() --[[ @ 0]]
end
...
function RecordStoreOnItemLoseFocus( f384_arg0, f384_arg1, f384_arg2, f384_arg3 )
	...
	local f384_local3 = Dvar[@"store_item_viewed_timer"]:get() --[[ @ 0]]
	if f384_local1 ~= nil then
		f384_local2 = Engine[@"milliseconds"]() - f384_local1 --[[ @ 0]]
	end
...
function PublishClip( f396_arg0 )
	...
	if Engine[@"setuptransferdata"]( f396_arg0, "clip_private", f396_local0, CoD.FileshareUtility.GetIsCommunityMode( f396_arg0 ) ) then
		...
		Engine[@"setmodelvalue"]( Engine[@"getmodel"]( CoD.FileshareUtility.GetPublishingModel() ), Enum[@"filesharetaskuistate"][@"fileshare_task_ui_error"] ) --[[ @ 0]]
	end
end

function OpenLocalClipPublishPrompt( f397_arg0, f397_arg1, f397_arg2, f397_arg3, f397_arg4 )
	local f397_local0 = Engine[@"lobbygetdemoinformation"]( Enum[@"lobbymodule"][@"lobby_module_client"], Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_client"] ) ) --[[ @ 0]]
...
function OpenLocalScreenshots( f398_arg0, f398_arg1 )
	...
	CoD.FileshareUtility.SetFileshareMode( f398_arg1, Enum[@"filesharemode"][@"fileshare_mode_user"] ) --[[ @ 0]]
...
function OpenMediaCommunity( f401_arg0, f401_arg1, f401_arg2, f401_arg3, f401_arg4, f401_arg5 )
	...
	CoD.FileshareUtility.SetFileshareMode( f401_arg2, Enum[@"filesharemode"][@"fileshare_mode_community"] ) --[[ @ 0]]
...
function FileshareCategorySelectorItemSelected( f405_arg0, f405_arg1, f405_arg2 )
	...
	if f405_arg0.TabFrame and f405_arg0.TabFrame.framedWidget then
		if f405_arg1.tabId == "bookmarkedgames" then
			CoD.FileshareUtility.SetFilterOnFileshareContentList( f405_arg0.TabFrame.framedWidget, Enum[@"fileshareprimarytags_e"][@"hash_309DD15D8811C2E4"], 1 ) --[[ @ 0]]
		else
...
function FileshareBookmarkRecentGame( f413_arg0 )
	...
	if f413_local3 ~= nil and f413_local3 ~= Engine[@"defaultid64value"]() then
		...
		CoD.OverlayUtility.ShowToast( "RecentGameBookmarked", Engine[@"toupper"]( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/notice" ) ), Engine[@"hash_4F9F1239CFD921FE"]( @"hash_46534C8ED6B43677" ), "uie_bookmark" ) --[[ @ 0]]
	end
end
...
function PaintjobSelector_ChoosePaintjob( f422_arg0, f422_arg1, f422_arg2 )
	...
	CoD.CraftUtility.SetEmblemEditorProperties( f422_arg2, Enum[@"customizationeditormode"][@"customization_editor_mode_browse"], "editorMode" ) --[[ @ 0]]
end
...
function PaintjobSelector_ClearPaintjob( f431_arg0, f431_arg1 )
	...
	CoD.CraftUtility.Paintjobs.ParseDDL( f431_arg1, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
...
function PaintjobSelector_CopyPaintjob( f432_arg0, f432_arg1, f432_arg2, f432_arg3, f432_arg4 )
	...
	if f432_local0 then
		CoD.CraftUtility.Paintjobs.ParseDDL( f432_arg2, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
...
function PaintjobEditor_ToggleGrid( f436_arg0, f436_arg1, f436_arg2, f436_arg3 )
	...
	Engine[@"emblemsetgridsize"]( CoD.GetCustomization( f436_arg2, "type" ), f436_local1 ) --[[ @ 0]]
end

function PaintjobEditor_RemoveGrid( f437_arg0 )
	Engine[@"emblemsetgridsize"]( CoD.GetCustomization( f437_arg0, "type" ), 0 ) --[[ @ 0]]
end

function PaintjobEditor_RestoreGridState( f438_arg0 )
	Engine[@"emblemsetgridsize"]( CoD.GetCustomization( f438_arg0, "type" ), Engine[@"getprofilevarint"]( f438_arg0, CoD.CraftUtility.GetGridTypeName( f438_arg0 ) ) ) --[[ @ 0]]
end
...
function PaintjobEditor_SavePaintjob( f439_arg0, f439_arg1, f439_arg2 )
	...
	CoD.CraftUtility.Paintjobs.ParseDDL( f439_arg1, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
...
function FetchOnlineFriendsData( f442_arg0, f442_arg1, f442_arg2 )
	if "friends" == f442_arg1.tabId or f442_arg1.tabId == "friendsPlayersList" then
		Engine[@"updatefriends"]( f442_arg2, Enum[@"presencefilter"][@"presence_filter_online_and_in_title"] ) --[[ @ 0]]
	end
end
		...
		if not f443_local1 then
			...
			if f443_arg3 then
				...
				if not f443_local2 then
					...
					Engine[@"showplatformprofile"]( f443_arg2, f443_local1, f443_local2 ) --[[ @ 0]]
				end
			end
			...
			if f444_arg3 then
				...
				if not f444_local2 then
					...
					if CoD.isPC then
						...
						Engine[@"showplatformfriendrequest"]( f444_arg2, f444_local1, f444_local2 ) --[[ @ 0]]
					end
				end
			end
...
function SocialJoin( f445_arg0, f445_arg1, f445_arg2, f445_arg3, f445_arg4, f445_arg5 )
	...
	elseif Engine[@"isingame"]() then
		if not Engine[@"hash_686E64DD1C270046"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_game"], f445_arg3.xuid ) then
			...
			Engine[@"lobbyevent"]( "OnInGameJoin", f445_arg3 ) --[[ @ 0]]
		end
	else
		Engine[@"lobbyevent"]( "OnJoin", f445_arg3 ) --[[ @ 0]]
	end
		...
		if f447_local3 ~= nil then
			...
			if not CoD.isPC then
				...
				if f447_local8 ~= nil then
					Engine[@"setmodelvalue"]( Engine[@"createmodel"]( f447_local4, "Social.selectedFriendInTitle" ), f447_local8:get() > Enum[@"presencetitle"][@"hash_7A2184EBB293AF2D"] ) --[[ @ 0]]
				end
			else
...
function SocialToggleSorting( f448_arg0, f448_arg1, f448_arg2 )
	...
	if f448_local1 == Enum[@"presencesorting"][@"presence_sorting_online_most_recent"] then
		Engine[@"setmodelvalue"]( f448_local0, Enum[@"presencesorting"][@"presence_sorting_alphabetical"] ) --[[ @ 0]]
		Engine[@"sortfriends"]( f448_arg2, Enum[@"presencesorting"][@"presence_sorting_alphabetical"] ) --[[ @ 0]]
	elseif f448_local1 == Enum[@"presencesorting"][@"presence_sorting_alphabetical"] then
		Engine[@"setmodelvalue"]( f448_local0, Enum[@"presencesorting"][@"presence_sorting_online_most_recent"] ) --[[ @ 0]]
		Engine[@"sortfriends"]( f448_arg2, Enum[@"presencesorting"][@"presence_sorting_online_most_recent"] ) --[[ @ 0]]
	end
end
...
function UpdateFriends( f450_arg0, f450_arg1, f450_arg2 )
	...
	Engine[@"updatefriends"]( f450_arg2, Enum[@"presencefilter"][@"presence_filter_online_and_in_title"] ) --[[ @ 0]]
end
...
function SetShoutcastHighlightedPlayer( f452_arg0, f452_arg1, f452_arg2 )
	Dvar[@"shoutcasthighlightedclient"]:set( Engine[@"getmodelvalue"]( Engine[@"getmodel"]( f452_arg1:getModel(), "clientNum" ) ) ) --[[ @ 0]]
end
...
function SaveShoutcasterSettings( f461_arg0, f461_arg1, f461_arg2 )
	Engine[@"storagewrite"]( f461_arg2, Enum[@"storagefiletype"][@"storage_profile_shoutcaster"] ) --[[ @ 0]]
end
...
function GetGameplayOptionsAndSendToDlog( f470_arg0 )
	...
	for f470_local4, f470_local5 in ipairs( {
		...
		if f470_local5 == @"grapple_autohold" then
			f470_local0[@"grapple_autohold"] = CoD.PCOptionsUtility.GetCurrentOptionValue( f470_local5, f470_arg0 ) ~= 0 --[[ @ 0]]
		end
		if f470_local5 == @"zm_cartoonmode" then
			f470_local0[@"zm_cartoonmode"] = CoD.PCOptionsUtility.GetCurrentOptionValue( f470_local5, f470_arg0 ) ~= 0 --[[ @ 0]]
		else
			f470_local0[f470_local5] = CoD.PCOptionsUtility.GetCurrentOptionValue( f470_local5, f470_arg0 ) ~= 0 --[[ @ 0]]
		end
	end
	f470_local0[@"m_mousesensitivity"] = Dvar[@"m_mousesensitivity"]:get() --[[ @ 0]]
	f470_local0[@"cg_fov_default"] = Dvar[@"cg_fov_default"]:get() --[[ @ 0]]
	f470_local0[@"weapon_cycle_delay"] = Dvar[@"cg_weaponcycledelay"]:get() --[[ @ 0]]
...
function GetKeybindsAndSendToDlog( f471_arg0 )
	...
	for f471_local6, f471_local7 in ipairs( f471_local2 ) --[[ @ 0]] do
		...
		f471_local1[Engine[@"converttoxhash"]( f471_local9 )] = f471_local8 --[[ @ 0]]
	end
...
function Gunsmith_ClearSelectedGunsmithVariantStats( f482_arg0 )
	...
	if f482_local0 then
		...
		CoD.CraftUtility.Gunsmith.ClearVariantStats( f482_arg0, f482_local1, Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
		CoD.CraftUtility.Gunsmith.ClearVariantStats( f482_arg0, f482_local1, Enum[@"emodes"][@"mode_campaign"] ) --[[ @ 0]]
	end
end
...
function Gunsmith_ClearCACWithUpdatedVariant( f483_arg0, f483_arg1 )
	...
	local f483_local2 = function ( f485_arg0 )
	 ...
	 --[[ @ 0]]
	f483_local2( Enum[@"emodes"][@"mode_campaign"] ) --[[ @ 0]]
	f483_local2( Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
end
	...
	if Engine[@"isingame"]() then
		...
		for f495_local2 = f495_local0 --[[ @ 0]], f495_local1, 1 do
			if Engine[@"iscontrollerbeingused"]( f495_local2 ) then
				Engine[@"setactivemenu"]( f495_local2, Enum[@"uimenucommand_t"][@"uimenu_none"] ) --[[ @ 0]]
			end
		end
	end
end
			...
			if Engine[@"xuidisvalid"]( f500_local1 ) then
				...
				if f500_local4 then
					...
					if f500_local6 > CoD.CACUtility.EmptyItemIndex then
						local f500_local7 = Engine[@"hash_7B98952F69D937F9"]( f500_local6, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f500_local2 ) --[[ @ 0]]
						local f500_local8 = "" --[[ @ 0]]
...
function OpenGroupEmblemSelect( f502_arg0, f502_arg1, f502_arg2, f502_arg3, f502_arg4 )
	CoD.SetCustomization( f502_arg2, Enum[@"customizationtype"][@"customization_type_emblem"], "type" ) --[[ @ 0]]
	Engine[@"emblemgetprofile"]( f502_arg2 ) --[[ @ 0]]
...
function OpenEmblemSelect( f503_arg0, f503_arg1, f503_arg2, f503_arg3, f503_arg4, f503_arg5 )
	...
	CoD.SetCustomization( f503_arg2, Enum[@"customizationtype"][@"customization_type_emblem"], "type" ) --[[ @ 0]]
	Engine[@"emblemgetprofile"]( f503_arg2 ) --[[ @ 0]]
...
function OpenCallingCards( f507_arg0, f507_arg1, f507_arg2, f507_arg3, f507_arg4 )
	...
	f507_local0._storageClientBuffer = CoD.BreadcrumbUtility.GetStorageClientBufferForPlayer( f507_arg2, Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
...
function OpenGroups( f508_arg0, f508_arg1, f508_arg2, f508_arg3, f508_arg4 )
	if IsGroupsEnabled( f508_arg2 ) then
		...
		CoD.FileshareUtility.SetFileshareMode( f508_arg2, Enum[@"filesharemode"][@"fileshare_mode_groups"] ) --[[ @ 0]]
	end
end

function OpenChooseCharacterLoadout( f509_arg0, f509_arg1, f509_arg2, f509_arg3, f509_arg4 )
	CoD.PlayerRoleUtility.customizationMode = Enum[@"emodes"][@"mode_multiplayer"] --[[ @ 0]]
...
function TimelineEditorChangeTransition( f517_arg0, f517_arg1, f517_arg2 )
	...
	if f517_local0 then
		...
		local f517_local2 = tonumber( Engine[@"getdemosegmentinformation"]( f517_local1, "transitionValue" ) ) + 1 --[[ @ 0]]
		if f517_local2 > Enum[@"democliptransition"][@"demo_clip_transition_last"] then
			f517_local2 = Enum[@"democliptransition"][@"demo_clip_transition_first"] --[[ @ 0]]
		end
...
function IncreaseSafeAreaVertical( f520_arg0, f520_arg1, f520_arg2, f520_arg3, f520_arg4 )
	if f520_arg3 == nil then
		f520_arg3 = @"safeareatweakable_vertical" --[[ @ 0]]
	end
...
function DecreaseSafeAreaVertical( f521_arg0, f521_arg1, f521_arg2, f521_arg3, f521_arg4 )
	if f521_arg3 == nil then
		f521_arg3 = @"safeareatweakable_vertical" --[[ @ 0]]
	end
	if not CoD.SafeArea or not CoD.SafeArea.Maximum or not CoD.SafeArea.AdjustAmount then
		return 
...
function IncreaseSafeAreaHorizontal( f522_arg0, f522_arg1, f522_arg2, f522_arg3, f522_arg4 )
	if f522_arg3 == nil then
		f522_arg3 = @"safeareatweakable_horizontal" --[[ @ 0]]
	end
	if not CoD.SafeArea or not CoD.SafeArea.Maximum or not CoD.SafeArea.AdjustAmount then
		return 
...
function DecreaseSafeAreaHorizontal( f523_arg0, f523_arg1, f523_arg2, f523_arg3, f523_arg4 )
	if f523_arg3 == nil then
		f523_arg3 = @"safeareatweakable_horizontal" --[[ @ 0]]
	end
	if not CoD.SafeArea or not CoD.SafeArea.Maximum or not CoD.SafeArea.AdjustAmount then
		return 
...
function CallingCards_EmblemGetProfile( f528_arg0, f528_arg1, f528_arg2 )
	Engine[@"emblemgetprofile"]( f528_arg2 ) --[[ @ 0]]
...
function CallingCards_GoBack( f529_arg0, f529_arg1 )
	if not IsLive() then
		...
		CoD.BreadcrumbUtility.UploadBuffer( f529_arg1, Enum[@"storagefiletype"][@"storage_mp_stats_online"] ) --[[ @ 0]]
	end
...
function CloseCPAAR( f538_arg0, f538_arg1 )
	CoD.perController[f538_arg1].lastAARMapName = Engine[@"lobbygetmap"]() --[[ @ 0]]
...
function SetMap( f541_arg0, f541_arg1, f541_arg2 )
	...
	if f541_local0 == nil then
		f541_arg1 = Engine[@"converttoxhash"]( LuaUtils.GetDefaultMap( LobbyData.GetCurrentMenuTarget() ) ) --[[ @ 0]]
	...
	local f541_local1 = Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_host"] ) --[[ @ 0]]
	if f541_local0[@"hash_3E2D141CB22F2813"] and f541_local0[@"hash_3E2D141CB22F2813"] ~= "" then
		Engine[@"lobbysetmap"]( f541_local1, f541_local0[@"hash_3E2D141CB22F2813"] ) --[[ @ 0]]
	else
		Engine[@"lobbysetmap"]( f541_local1, f541_local0.mapToLoad ) --[[ @ 0]]
	end
...
function OpenPurchaseMapPackConfirmation( f542_arg0, f542_arg1, f542_arg2 )
	local f542_local0 = Engine[@"getdlcbitformapname"] --[[ @ 0]]
...
function SaveCustomGame( f548_arg0, f548_arg1, f548_arg2 )
	...
	if not f548_local5 or f548_local5 == "" then
		local f548_local6 = Engine[@"getgametypeinfo"]( GetCurrentGameType() ) --[[ @ 0]]
	...
	if f548_local1 == nil or f548_local1 == 1 or f548_local1 == true then
		...
		Engine[@"customgame_save"]( f548_arg1, Engine[@"hash_FFDD58B353B5C0B"](), f548_local2, GetCurrentGameType(), f548_local4, f548_local5 ) --[[ @ 0]]
	end
end
...
function DeleteCustomGameYes( f550_arg0, f550_arg1, f550_arg2, f550_arg3, f550_arg4 )
	...
	Engine[@"customgame_delete"]( f550_arg2, f550_local1 ) --[[ @ 0]]
end
...
function OpenPopularCustomGames( f554_arg0, f554_arg1, f554_arg2 )
	CoD.FileshareUtility.SetCurrentCommunityDataType( Enum[@"filesharecommunitydatatype"][@"fileshare_community_data_popular"] ) --[[ @ 0]]
	CoD.FileshareUtility.SetFileshareMode( f554_arg2, Enum[@"filesharemode"][@"fileshare_mode_community"] ) --[[ @ 0]]
	...
	Engine[@"setmodelvalue"]( f554_local1, Enum[@"filesharecommunitydatatype"][@"fileshare_community_data_popular"] ) --[[ @ 0]]
...
function OpenTrendingCustomGames( f555_arg0, f555_arg1, f555_arg2 )
	CoD.FileshareUtility.SetCurrentCommunityDataType( Enum[@"filesharecommunitydatatype"][@"fileshare_community_data_trending"] ) --[[ @ 0]]
	CoD.FileshareUtility.SetFileshareMode( f555_arg2, Enum[@"filesharemode"][@"fileshare_mode_community"] ) --[[ @ 0]]
	...
	Engine[@"setmodelvalue"]( f555_local1, Enum[@"filesharecommunitydatatype"][@"fileshare_community_data_trending"] ) --[[ @ 0]]
	SetInCustomGames( 1 ) --[[ @ 0]]
...
function OpenrRecentCustomGames( f556_arg0, f556_arg1, f556_arg2 )
	CoD.FileshareUtility.SetCurrentCommunityDataType( Enum[@"filesharecommunitydatatype"][@"fileshare_community_data_recent"] ) --[[ @ 0]]
	CoD.FileshareUtility.SetFileshareMode( f556_arg2, Enum[@"filesharemode"][@"fileshare_mode_community"] ) --[[ @ 0]]
	...
	Engine[@"setmodelvalue"]( f556_local1, Enum[@"filesharecommunitydatatype"][@"fileshare_community_data_recent"] ) --[[ @ 0]]
	SetInCustomGames( 1 ) --[[ @ 0]]
...
function SetGameType( f557_arg0, f557_arg1 )
	...
	if not CoD.GameTypeUtility.DoesGameTypeSupportBots( f557_arg1 ) then
		local f557_local1 = Enum[@"lobbymodule"][@"lobby_module_host"] --[[ @ 0]]
		local f557_local2 = Engine[@"lobbygetcontrollinglobbysession"]( f557_local1 ) --[[ @ 0]]
		local f557_local3 = Engine[@"getlobbyclientcount"]( f557_local1, f557_local2, Enum[@"lobbyclientfiltertype"][@"lobby_client_filter_type_bot"] ) --[[ @ 0]]
		if f557_local3 > 0 then
			Engine[@"removelobbybot"]( f557_local2, f557_local3 ) --[[ @ 0]]
		end
	end
	...
	f557_local1:set( Engine[@"converttoxhash"]( f557_arg1 ) ) --[[ @ 0]]
	Engine[@"lobbyevent"]( "OnGametypeSettingsChange", {
		lobbyModule = Enum[@"lobbymodule"][@"lobby_module_host"],
...
function GameModeSelected( f558_arg0, f558_arg1 )
	...
	if f558_local0 then
		local f558_local1 = Engine[@"converttoxhash"]( f558_local0 ) --[[ @ 0]]
