...
function RemoveItemFromClassSlot( f6_arg0, f6_arg1, f6_arg2, f6_arg3, f6_arg4 )
	...
	if f6_local2 and f6_local2 > CoD.CACUtility.EmptyItemIndex then
		...
		if f6_arg1 == "primary" or f6_arg1 == "secondary" then
			...
			CoD.CACUtility.SetClassItem( f6_arg2, f6_local0, f6_arg1 .. "paintjobslot", Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"], nil, f6_arg4 ) --[[ @ 0]]
...
function AttemptAttachItem( f7_arg0, f7_arg1, f7_arg2, f7_arg3, f7_arg4, f7_arg5, f7_arg6, f7_arg7 )
	...
	if f7_local4 then
		...
		if f7_local8 and f7_arg3[f7_local8] then
			...
			f7_local7 = Engine[@"converttoxhash"]( Engine[@"getattachmentrefbyindex"]( f7_local9 ) ) --[[ @ 0]]
			f7_local5 = Engine[@"hash_6037522AE910C327"]( f7_local9, f7_arg2 ) == Enum[@"eattachmentgroup"][@"hash_26EE211053211305"] --[[ @ 0]]
		end
	end
...
function SetBrowseMode( f13_arg0 )
	CoD.CraftUtility.SetEmblemEditorProperties( f13_arg0, Enum[@"customizationeditormode"][@"customization_editor_mode_browse"], "editorMode" ) --[[ @ 0]]
end
...
function EmblemEditor_SetScaleMode( f14_arg0, f14_arg1 )
	...
	Engine[@"emblemsetscalemode"]( f14_arg1 ) --[[ @ 0]]
end
...
function EmblemEditor_RecordMetrics( f19_arg0, f19_arg1, f19_arg2, f19_arg3 )
	...
	if f19_arg0.occludedMenu and f19_arg0.occludedMenu.openTime then
		f19_local0 = Engine[@"milliseconds"]() - f19_arg0.occludedMenu.openTime --[[ @ 0]]
	end
...
function EmblemChooseColor_SetLayerColor( f27_arg0, f27_arg1 )
	...
	Engine[@"emblemsetlayercolor"]( CoD.CraftUtility.GetEmblemEditorProperties( f27_arg1, "colorNum" ), f27_local0 * f27_local3, f27_local1 * f27_local3, f27_local2 * f27_local3 ) --[[ @ 0]]
end
...
function PaintJobEditor_RecordMetrics( f33_arg0, f33_arg1, f33_arg2, f33_arg3, f33_arg4, f33_arg5 )
	...
	if f33_arg0.occludedMenu and f33_arg0.occludedMenu.openTime then
		f33_local0 = Engine[@"milliseconds"]() - f33_arg0.occludedMenu.openTime --[[ @ 0]]
	end
...
function ValidateCreateGroupInformation( f35_arg0, f35_arg1, f35_arg2 )
	...
	if f35_local1 == "" then
		OpenGenericSmallPopup( f35_arg0, f35_arg2, @"hash_44553C10CA6CD641", @"hash_3231A10628026E56", nil, @"menu/ok" ) --[[ @ 0]]
		return false
	else
		return true
	end
