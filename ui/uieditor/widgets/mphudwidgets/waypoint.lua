...
CoD.Waypoint.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"]], function ( f50_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_7ADC477DDE486DD7"]], function ( f51_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_59333FC97F7870"]], function ( f52_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local19 = self.subscribeToModel --[[ @ 0]]
	f1_local20 = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	f1_local19( f1_local18, f1_local20["UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_1C630DB86D235A5"]], function ( f53_arg0 )
		f1_arg0:updateElementState( self, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
