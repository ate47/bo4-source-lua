...
require( "x64:27ed83760022fc51" ) --[[ @ 0]]

CoD.CallingCards_CardWidget = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.CallingCards_CardWidget.__defaultWidth = 360 --[[ @ 0]]
CoD.CallingCards_CardWidget.__defaultHeight = 90 --[[ @ 0]]
CoD.CallingCards_CardWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.CallingCards_CardWidget ) --[[ @ 0]]
	self.id = "CallingCards_CardWidget" --[[ @ 0]]
	self.soundSet = "ChooseDecal" --[[ @ 0]]
	self.onlyChildrenFocusable = true --[[ @ 0]]
	self.anyChildUsesUpdateState = true --[[ @ 0]]
	f1_arg0:addElementToPendingUpdateStateList( self ) --[[ @ 0]]
	
	local CallingCards = CoD.CallingCards_CardWidgetInternal.new( f1_arg0, f1_arg1, 0.5, 0.5, -180, 180, 0.5, 0.5, -45, 45 ) --[[ @ 0]]
