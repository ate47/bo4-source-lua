...
CoD.DirectorMapAndGameTypeContainer = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.DirectorMapAndGameTypeContainer.__defaultWidth = 356 --[[ @ 0]]
CoD.DirectorMapAndGameTypeContainer.__defaultHeight = 200 --[[ @ 0]]
CoD.DirectorMapAndGameTypeContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.DirectorMapAndGameTypeContainer ) --[[ @ 0]]
	self.id = "DirectorMapAndGameTypeContainer" --[[ @ 0]]
	...
	self.__defaultFocus = DirectorMapAndGameInternal --[[ @ 0]]
...
CoD.DirectorMapAndGameTypeContainer.__resetProperties = function ( f6_arg0 )
	f6_arg0.DirectorMapAndGameInternal:completeAnimation() --[[ @ 0]]
	f6_arg0.DirectorMapAndGameInternal:setScale( 1, 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.DirectorMapAndGameTypeContainer.__clipsPerState = {
	DefaultState = {
		...
		ChildFocus = function ( f8_arg0, f8_arg1 )
			...
			f8_arg0.DirectorMapAndGameInternal:completeAnimation() --[[ @ 0]]
			f8_arg0.DirectorMapAndGameInternal:setScale( 1.05, 1.05 ) --[[ @ 0]]
			f8_arg0.clipFinished( f8_arg0.DirectorMapAndGameInternal ) --[[ @ 0]]
		end,
		GainChildFocus = function ( f9_arg0, f9_arg1 )
			f9_arg0:__resetProperties() --[[ @ 0]]
			f9_arg0:setupElementClipCounter( 1 ) --[[ @ 0]]
			local f9_local0 = function ( f10_arg0 )
				f9_arg0.DirectorMapAndGameInternal:beginAnimation( 200 ) --[[ @ 0]]
				f9_arg0.DirectorMapAndGameInternal:setScale( 1.05, 1.05 ) --[[ @ 0]]
				f9_arg0.DirectorMapAndGameInternal:registerEventHandler( "interrupted_keyframe", f9_arg0.clipInterrupted ) --[[ @ 0]]
				f9_arg0.DirectorMapAndGameInternal:registerEventHandler( "transition_complete_keyframe", f9_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f9_arg0.DirectorMapAndGameInternal:completeAnimation() --[[ @ 0]]
			f9_arg0.DirectorMapAndGameInternal:setScale( 1, 1 ) --[[ @ 0]]
			f9_local0( f9_arg0.DirectorMapAndGameInternal ) --[[ @ 0]]
		end,
		LoseChildFocus = function ( f11_arg0, f11_arg1 )
			f11_arg0:__resetProperties() --[[ @ 0]]
			f11_arg0:setupElementClipCounter( 1 ) --[[ @ 0]]
			local f11_local0 = function ( f12_arg0 )
				f11_arg0.DirectorMapAndGameInternal:beginAnimation( 200 ) --[[ @ 0]]
				f11_arg0.DirectorMapAndGameInternal:setScale( 1, 1 ) --[[ @ 0]]
				f11_arg0.DirectorMapAndGameInternal:registerEventHandler( "interrupted_keyframe", f11_arg0.clipInterrupted ) --[[ @ 0]]
				f11_arg0.DirectorMapAndGameInternal:registerEventHandler( "transition_complete_keyframe", f11_arg0.clipFinished ) --[[ @ 0]]
			end
			 --[[ @ 0]]
			f11_arg0.DirectorMapAndGameInternal:completeAnimation() --[[ @ 0]]
			f11_arg0.DirectorMapAndGameInternal:setScale( 1.05, 1.05 ) --[[ @ 0]]
			f11_local0( f11_arg0.DirectorMapAndGameInternal ) --[[ @ 0]]
		end
	}
} --[[ @ 0]]
CoD.DirectorMapAndGameTypeContainer.__onClose = function ( f13_arg0 )
	f13_arg0.DirectorMapAndGameInternal:close() --[[ @ 0]]
end
 --[[ @ 0]]
