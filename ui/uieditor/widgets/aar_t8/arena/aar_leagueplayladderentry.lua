...
CoD.AAR_LeaguePlayLadderEntry = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.AAR_LeaguePlayLadderEntry.__defaultWidth = 898 --[[ @ 0]]
CoD.AAR_LeaguePlayLadderEntry.__defaultHeight = 48 --[[ @ 0]]
CoD.AAR_LeaguePlayLadderEntry.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.AAR_LeaguePlayLadderEntry ) --[[ @ 0]]
	self.id = "AAR_LeaguePlayLadderEntry" --[[ @ 0]]
	...
	NameBg:setAlpha( 0.2 ) --[[ @ 0]]
	self:addElement( NameBg ) --[[ @ 0]]
	self.NameBg = NameBg --[[ @ 0]]
	
	local RankMovement = LUI.UIImage.new( 0, 0, 106, 134, 0, 0, 8.5, 36.5 ) --[[ @ 0]]
	RankMovement:linkToElementModel( self, "arrow", true, function ( model )
		local f2_local0 = model:get() --[[ @ 0]]
		if f2_local0 ~= nil then
			RankMovement:setImage( RegisterImage( f2_local0 ) ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	self:addElement( RankMovement ) --[[ @ 0]]
	self.RankMovement = RankMovement --[[ @ 0]]
	
	local RubiesList = CoD.LeaguePlayRubyList.new( f1_arg0, f1_arg1, 0, 0, 733, 883, 0, 0, 2.5, 42.5 ) --[[ @ 0]]
	...
	local Tied = LUI.UIText.new( 0, 0, 459, 569, 0, 0, 8.5, 38.5 ) --[[ @ 0]]
	...
	local RankPoints = LUI.UIText.new( 0, 0, 574, 714, 0, 0, 9, 39 ) --[[ @ 0]]
	...
	RankPoints:linkToElementModel( self, "ladderPoints", true, function ( model )
		...
		if f4_local0 ~= nil then
			RankPoints:setText( f4_local0 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	self:addElement( RankPoints ) --[[ @ 0]]
	self.RankPoints = RankPoints --[[ @ 0]]
	
	local Rank = LUI.UIText.new( 0, 0, 19.5, 68.5, 0, 0, 8.5, 38.5 ) --[[ @ 0]]
	...
	local Name = CoD.LeaguePlayLeaderboardEntryClanName.new( f1_arg0, f1_arg1, 0, 0, 165, 557, 0, 0, 8.5, 38.5 ) --[[ @ 0]]
	...
	local infoBracketBot = LUI.UIImage.new( 0, 1, -1, 1, 0, 0, 42.5, 50.5 ) --[[ @ 0]]
...
CoD.AAR_LeaguePlayLadderEntry.__clipsPerState = {
	DefaultState = {
		DefaultClip = function ( f11_arg0, f11_arg1 )
			...
			f11_arg0.Selection:completeAnimation() --[[ @ 0]]
			f11_arg0.Selection:setAlpha( 0 ) --[[ @ 0]]
			f11_arg0.clipFinished( f11_arg0.Selection ) --[[ @ 0]]
			f11_arg0.infoBracketBot:completeAnimation() --[[ @ 0]]
			f11_arg0.infoBracketBot:setAlpha( 0.2 ) --[[ @ 0]]
	...
	CurrentPlayerState = {
		DefaultClip = function ( f12_arg0, f12_arg1 )
			...
			f12_arg0.Selection:completeAnimation() --[[ @ 0]]
			f12_arg0.Selection:setAlpha( 0 ) --[[ @ 0]]
			f12_arg0.clipFinished( f12_arg0.Selection ) --[[ @ 0]]
			f12_arg0.RankPoints:completeAnimation() --[[ @ 0]]
			f12_arg0.RankPoints:setRGB( ColorSet.PlayerYellow.r, ColorSet.PlayerYellow.g, ColorSet.PlayerYellow.b ) --[[ @ 0]]
			f12_arg0.clipFinished( f12_arg0.RankPoints ) --[[ @ 0]]
			f12_arg0.Rank:completeAnimation() --[[ @ 0]]
			f12_arg0.Rank:setRGB( ColorSet.PlayerYellow.r, ColorSet.PlayerYellow.g, ColorSet.PlayerYellow.b ) --[[ @ 0]]
			f12_arg0.clipFinished( f12_arg0.Rank ) --[[ @ 0]]
			f12_arg0.Name:completeAnimation() --[[ @ 0]]
			f12_arg0.Name:setRGB( ColorSet.PlayerYellow.r, ColorSet.PlayerYellow.g, ColorSet.PlayerYellow.b ) --[[ @ 0]]
			f12_arg0.clipFinished( f12_arg0.Name ) --[[ @ 0]]
			f12_arg0.infoBracketBot:completeAnimation() --[[ @ 0]]
			f12_arg0.infoBracketBot:setRGB( ColorSet.PlayerYellow.r, ColorSet.PlayerYellow.g, ColorSet.PlayerYellow.b ) --[[ @ 0]]
...
CoD.AAR_LeaguePlayLadderEntry.__onClose = function ( f13_arg0 )
	f13_arg0.Selection:close() --[[ @ 0]]
	f13_arg0.RankMovement:close() --[[ @ 0]]
	f13_arg0.RubiesList:close() --[[ @ 0]]
	f13_arg0.RankPoints:close() --[[ @ 0]]
	f13_arg0.Rank:close() --[[ @ 0]]
