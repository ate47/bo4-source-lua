	...
	EditMode = {
		...
		DefaultState = function ( f24_arg0, f24_arg1 )
			...
			local f24_local3 = function ( f28_arg0 )
				f24_arg0.FrontendFrameSelected:beginAnimation( 150, Enum[@"hash_1F50FFF429AB1890"][@"hash_15193EA7825DC097"] ) --[[ @ 0]]
			...
			local f24_local5 = function ( f30_arg0 )
				f24_arg0.FrontendFocusPip:beginAnimation( 150, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
