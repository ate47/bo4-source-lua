...
CoD.ScoreboardPlayerWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				return CoD.ModelUtility.IsSelfModelValueEqualTo( element, f1_arg1, "team", Enum[@"team_t"][@"hash_42A34B055ADD98AB"] ) and IsCodCaster( f1_arg1 )
			end
		},
		{
			stateName = "CodcasterTeam2",
			condition = function ( menu, element, event )
				return CoD.ModelUtility.IsSelfModelValueEqualTo( element, f1_arg1, "team", Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] ) and IsCodCaster( f1_arg1 )
			end
		}
	} ) --[[ @ 0]]
