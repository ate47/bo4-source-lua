...
CoD.CarryInputPrompt.__resetProperties = function ( f35_arg0 )
	...
	f35_arg0.ButtonPromptText.text:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
...
CoD.CarryInputPrompt.__clipsPerState = {
	...
	OffscreenInteractable = {
		DefaultClip = function ( f62_arg0, f62_arg1 )
			...
			f62_arg0.ButtonPromptText.text:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
