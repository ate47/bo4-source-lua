...
CoD.freeCursorButtonPrompt.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:mergeStateConditions( {
		...
		},
		{
			stateName = "Enabled",
			condition = function ( menu, element, event )
				local f7_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( element, f1_arg1, "", Enum[@"luibuttonpromptstates"][@"flag_enable_prompts"] ) --[[ @ 0]]
				if f7_local0 then
					f7_local0 = IsGamepad( f1_arg1 ) --[[ @ 0]]
					if f7_local0 then
						f7_local0 = CoD.ModelUtility.IsSelfModelValueEnumFlagSet( element, f1_arg1, "flags", Enum[@"luibuttonpromptflags"][@"bpf_contextual"] ) --[[ @ 0]]
					end
				end
				return f7_local0
			end
			...
			condition = function ( menu, element, event )
				...
				if f8_local0 then
					if not IsGamepad( f1_arg1 ) and not ShouldHideButtonPromptForPC( element, f1_arg1 ) then
						f8_local0 = CoD.ModelUtility.IsSelfModelValueEnumFlagSet( element, f1_arg1, "flags", Enum[@"luibuttonpromptflags"][@"bpf_contextual"] ) --[[ @ 0]]
						if f8_local0 then
							f8_local0 = IsPC() --[[ @ 0]]
						end
					else
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f9_local0 then
					if not IsGamepad( f1_arg1 ) and not ShouldHideButtonPromptForPC( element, f1_arg1 ) then
						f9_local0 = CoD.ModelUtility.IsSelfModelValueEnumFlagSet( element, f1_arg1, "flags", Enum[@"luibuttonpromptflags"][@"bpf_contextual"] ) --[[ @ 0]]
						if f9_local0 then
							f9_local0 = IsPC() --[[ @ 0]]
						end
					else
