...
CoD.freeCursorHeaderLabelContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	title( f1_local2, f1_local4["ButtonBits." .. Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"]], function ( f5_arg0 )
		f1_arg0:updateElementState( titlePC, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
	...
	f1_local2( f1_local4, f1_local5["ButtonBits." .. Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"]], function ( f12_arg0 )
		f1_arg0:updateElementState( title, {
			name = "model_validation",
			menu = f1_arg0,
			controller = f1_arg1,
