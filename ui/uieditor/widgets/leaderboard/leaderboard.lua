...
CoD.Leaderboard.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	LeaderboardRows:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( LeaderboardRows, f1_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], nil, function ( element, menu, controller, model )
		...
		if IsSelfInState( self, "DefaultState" ) and not IsRepeatButtonPress( nil ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], @"hash_77630B08CE7BF317", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	f1_arg0:AddButtonCallbackFunction( LeaderboardRows, f1_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], nil, function ( element, menu, controller, model )
		if IsSelfInState( self, "DefaultState" ) and not IsRepeatButtonPress( model ) then
			PlaySoundAlias( "uin_paint_decal_nav" ) --[[ @ 0]]
		...
		if IsSelfInState( self, "DefaultState" ) and not IsRepeatButtonPress( nil ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], @"hash_35B6BF6242A52D2", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	f1_arg0:AddButtonCallbackFunction( LeaderboardRows, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
		...
		if IsSelfInState( self, "DefaultState" ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], @"hash_5973DD79B6545E80", nil, nil ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	f1_arg0:AddButtonCallbackFunction( LeaderboardRows, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	LoadingText:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_36A50DC52864D7AE" ) ) --[[ @ 0]]
	LoadingText:setTTF( "dinnext_regular" ) --[[ @ 0]]
	LoadingText:setLetterSpacing( 2 ) --[[ @ 0]]
	LoadingText:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	LoadingText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
	...
	LeaderboardEmptyText:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
	LeaderboardEmptyText:setAlignment( Enum[@"LUIAlignment"][@"hash_3F41D595A2B0EDF3"] ) --[[ @ 0]]
