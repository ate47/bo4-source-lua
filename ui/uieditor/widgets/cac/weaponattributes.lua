...
CoD.WeaponAttributes.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	MagCountName:setText( LocalizeToUpperString( @"weapon/mags" ) ) --[[ @ 0]]
	MagCountName:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	MagCountName:setLetterSpacing( 3 ) --[[ @ 0]]
	MagCountName:setAlignment( Enum[@"luialignment"][@"lui_alignment_right"] ) --[[ @ 0]]
	...
	UberAttachmentName:setAlignment( Enum[@"luialignment"][@"lui_alignment_right"] ) --[[ @ 0]]
