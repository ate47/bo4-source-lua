...
CoD.ChooseClassWidget.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	perk1Header.header:setText( LocalizeToUpperString( @"hash_CC26359EAAED27A" ) ) --[[ @ 0]]
	...
	perk2Header.header:setText( LocalizeToUpperString( @"hash_CC26259EAAED0C7" ) ) --[[ @ 0]]
	...
	perk3Header.header:setText( LocalizeToUpperString( @"hash_CC26159EAAECF14" ) ) --[[ @ 0]]
	...
	tacticalgear:appendEventHandler( "input_source_changed", function ( f10_arg0, f10_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f10_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	perkTalents( primary, primaryAttachments.LastInput, function ( f11_arg0, f11_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f11_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( tacticalgear, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( tacticalgear, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( tacticalgear, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], "ui_remove", function ( element, menu, controller, model )
	...
	tacticalgear:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f19_arg0, f19_arg1, f19_arg2, f19_arg3 )
	...
	perkTalents:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	perkTalents:linkToElementModel( perkTalents, "loadoutListItem", true, function ( model, f26_arg1 )
		...
		if model then
			perkTalents["__buttonPrompt_loadoutListItem->itemIndex"] = perkTalents:subscribeToModel( model, function ( model )
				CoD.Menu.UpdateButtonShownState( f26_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
				CoD.Menu.UpdateButtonShownState( f26_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
			end ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	perkTalents:appendEventHandler( "input_source_changed", function ( f28_arg0, f28_arg1 )
		f28_arg1.menu = f28_arg1.menu or f1_arg0 --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f28_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f28_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	primaryAttachments = perkTalents --[[ @ 0]]
	primary = perkTalents.subscribeToModel --[[ @ 0]]
	wildcards = Engine[@"GetModelForController"]( f1_arg1 ) --[[ @ 0]]
	primary( primaryAttachments, wildcards.LastInput, function ( f29_arg0, f29_arg1 )
		CoD.Menu.UpdateButtonShownState( f29_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f29_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( perkTalents, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( perkTalents, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( perkTalents, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], "ui_remove", function ( element, menu, controller, model )
	...
	perkTalents:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f37_arg0, f37_arg1, f37_arg2, f37_arg3 )
	...
	primary:appendEventHandler( "input_source_changed", function ( f40_arg0, f40_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f40_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f40_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f40_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f40_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
	...
	primaryAttachments( wildcards, secondary.LastInput, function ( f41_arg0, f41_arg1 )
		CoD.Menu.UpdateButtonShownState( f41_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f41_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f41_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f41_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
	...
	primary:linkToElementModel( primary, "itemIndex", true, function ( model, f42_arg1 )
		CoD.Menu.UpdateButtonShownState( f42_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f42_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f42_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	...
	primaryAttachments( wildcards, secondary["lobbyRoot.lobbyNetworkMode"], function ( f43_arg0, f43_arg1 )
		CoD.Menu.UpdateButtonShownState( f43_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
	...
	primaryAttachments( wildcards, secondary["lobbyRoot.lobbyNav"], function ( f44_arg0, f44_arg1 )
		CoD.Menu.UpdateButtonShownState( f44_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( primary, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( primary, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], "ui_remove", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( primary, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], nil, function ( element, menu, controller, model )
		if IsGamepad( controller ) and not CoD.ModelUtility.IsSelfModelValueEqualTo( element, controller, "itemIndex", CoDShared.EmptyItemIndex ) and not IsElementPropertyValue( element, "__hasFocusOnVariantWidget", true ) then
	...
	f1_arg0:AddButtonCallbackFunction( primary, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_contextual_1", function ( element, menu, controller, model )
		...
		if IsMouseOrKeyboard( controller ) and not CoD.ModelUtility.IsSelfModelValueEqualTo( element, controller, "itemIndex", CoDShared.EmptyItemIndex ) and not IsElementPropertyValue( element, "__hasFocusOnVariantWidget", true ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], @"hash_194122F68876E5D9", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"], "ui_contextual_1" ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	f1_arg0:AddButtonCallbackFunction( primary, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( primary, f1_arg1, Enum[@"LUIButton"][@"hash_64D2505E19049444"], "ui_contextual_2", function ( element, menu, controller, model )
		...
		if IsMouseOrKeyboard( controller ) and not IsLocal() and not IsCustomLobby() and not CoD.ModelUtility.IsSelfModelValueEqualTo( element, controller, "itemIndex", CoDShared.EmptyItemIndex ) and not IsElementPropertyValue( element, "__hasFocusOnVariantWidget", true ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_64D2505E19049444"], @"hash_62BA0F750E758177", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"], "ui_contextual_2" ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	primary:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f58_arg0, f58_arg1, f58_arg2, f58_arg3 )
	...
	primaryAttachments:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	primaryAttachments:linkToElementModel( primaryAttachments, "itemIndex", true, function ( model, f68_arg1 )
		CoD.Menu.UpdateButtonShownState( f68_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f68_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f68_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	primaryAttachments:appendEventHandler( "input_source_changed", function ( f69_arg0, f69_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f69_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f69_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f69_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	secondary = primaryAttachments --[[ @ 0]]
	wildcards = primaryAttachments.subscribeToModel --[[ @ 0]]
	...
	wildcards( secondary, secondaryAttachments.LastInput, function ( f70_arg0, f70_arg1 )
		CoD.Menu.UpdateButtonShownState( f70_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f70_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	...
	primaryAttachments:linkToElementModel( primaryAttachments, "loadoutListItem", true, function ( model, f71_arg1 )
		...
		if model then
			primaryAttachments["__buttonPrompt_loadoutListItem->itemIndex"] = primaryAttachments:subscribeToModel( model, function ( model )
				CoD.Menu.UpdateButtonShownState( f71_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
			end ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	primaryAttachments:linkToElementModel( primaryAttachments, "attachmentSlotIndex", true, function ( model, f73_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f73_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( primaryAttachments, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( primaryAttachments, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], "ui_remove", function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( primaryAttachments, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( primaryAttachments, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_contextual_1", function ( element, menu, controller, model )
	...
	primaryAttachments:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f83_arg0, f83_arg1, f83_arg2, f83_arg3 )
	...
	wildcards:linkToElementModel( wildcards, "loadoutListItem", true, function ( model, f88_arg1 )
		...
		if model then
			wildcards["__buttonPrompt_loadoutListItem->itemIndex"] = wildcards:subscribeToModel( model, function ( model )
				CoD.Menu.UpdateButtonShownState( f88_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
	...
	wildcards:appendEventHandler( "input_source_changed", function ( f90_arg0, f90_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f90_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f90_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	secondary( secondaryAttachments, TempSelectedImage.LastInput, function ( f91_arg0, f91_arg1 )
		CoD.Menu.UpdateButtonShownState( f91_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f91_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( wildcards, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
		if not CoD.ModelUtility.IsSelfModelPathValueEqualTo( element, controller, "loadoutListItem->itemIndex", CoDShared.EmptyItemIndex ) and IsGamepad( controller ) then
			CoD.CACUtility.UnequipLoadoutListItem( element, menu, controller ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( wildcards, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], "ui_remove", function ( element, menu, controller, model )
	...
	wildcards:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f99_arg0, f99_arg1, f99_arg2, f99_arg3 )
	...
	secondary:linkToElementModel( secondary, "itemIndex", true, function ( model, f102_arg1 )
		CoD.Menu.UpdateButtonShownState( f102_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f102_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f102_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	...
	secondary:appendEventHandler( "input_source_changed", function ( f103_arg0, f103_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f103_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f103_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f103_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f103_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	...
	secondaryAttachments( TempSelectedImage, primarygrenade.LastInput, function ( f104_arg0, f104_arg1 )
		CoD.Menu.UpdateButtonShownState( f104_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f104_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f104_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f104_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	...
	secondaryAttachments( TempSelectedImage, primarygrenade["lobbyRoot.lobbyNetworkMode"], function ( f105_arg0, f105_arg1 )
		CoD.Menu.UpdateButtonShownState( f105_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
	...
	secondaryAttachments( TempSelectedImage, primarygrenade["lobbyRoot.lobbyNav"], function ( f106_arg0, f106_arg1 )
		CoD.Menu.UpdateButtonShownState( f106_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"] ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( secondary, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		if not IsElementPropertyValue( element, "__hasFocusOnVariantWidget", true ) then
	...
	f1_arg0:AddButtonCallbackFunction( secondary, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], "ui_remove", function ( element, menu, controller, model )
		...
		if not CoD.ModelUtility.IsSelfModelValueEqualTo( element, controller, "itemIndex", CoDShared.EmptyItemIndex ) and IsGamepad( controller ) and not IsElementPropertyValue( element, "__hasFocusOnVariantWidget", true ) then
			CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], @"hash_194122F68876E5D9", nil, "ui_remove" ) --[[ @ 0]]
			return true
		else
			return false
		end
	end, false ) --[[ @ 0]]
	f1_arg0:AddButtonCallbackFunction( secondary, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], "ui_remove", function ( element, menu, controller, model )
		if not CoD.ModelUtility.IsSelfModelValueEqualTo( element, controller, "itemIndex", CoDShared.EmptyItemIndex ) and IsGamepad( controller ) and not IsElementPropertyValue( element, "__hasFocusOnVariantWidget", true ) then
			CoD.CACUtility.UnequipItem( controller, menu, element ) --[[ @ 0]]
			return true
		elseif IsMouseOrKeyboard( controller ) and not CoD.ModelUtility.IsSelfModelValueEqualTo( element, controller, "itemIndex", CoDShared.EmptyItemIndex ) and not IsElementPropertyValue( element, "__hasFocusOnVariantWidget", true ) then
	...
	f1_arg0:AddButtonCallbackFunction( secondary, f1_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"], nil, function ( element, menu, controller, model )
		if IsGamepad( controller ) and not IsLocal() and not IsCustomLobby() and not IsElementPropertyValue( element, "__hasFocusOnVariantWidget", true ) then
			CoD.CACUtility.SetShowcaseWeapon( menu, controller, element ) --[[ @ 0]]
			PlaySoundAlias( "cac_overload_select" ) --[[ @ 0]]
			return true
	...
	f1_arg0:AddButtonCallbackFunction( secondary, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_contextual_1", function ( element, menu, controller, model )
	...
	secondary:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f120_arg0, f120_arg1, f120_arg2, f120_arg3 )
	...
	secondaryAttachments:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
	...
	secondaryAttachments:linkToElementModel( secondaryAttachments, "itemIndex", true, function ( model, f130_arg1 )
		CoD.Menu.UpdateButtonShownState( f130_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f130_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f130_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	secondaryAttachments:appendEventHandler( "input_source_changed", function ( f131_arg0, f131_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f131_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f131_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f131_arg0, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	primarygrenade = secondaryAttachments --[[ @ 0]]
	TempSelectedImage = secondaryAttachments.subscribeToModel --[[ @ 0]]
	...
	TempSelectedImage( primarygrenade, SpecialistEquipmentWidget.LastInput, function ( f132_arg0, f132_arg1 )
		CoD.Menu.UpdateButtonShownState( f132_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f132_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f132_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end, false ) --[[ @ 0]]
	secondaryAttachments:linkToElementModel( secondaryAttachments, "loadoutListItem", true, function ( model, f133_arg1 )
		...
		if model then
			secondaryAttachments["__buttonPrompt_loadoutListItem->itemIndex"] = secondaryAttachments:subscribeToModel( model, function ( model )
				CoD.Menu.UpdateButtonShownState( f133_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"] ) --[[ @ 0]]
			end ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
	secondaryAttachments:linkToElementModel( secondaryAttachments, "attachmentSlotIndex", true, function ( model, f135_arg1 )
		CoD.Menu.UpdateButtonShownState( f135_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
		CoD.Menu.UpdateButtonShownState( f135_arg1, f1_arg0, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	f1_arg0:AddButtonCallbackFunction( secondaryAttachments, f1_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		if IsListElementChildInState( element, "AttachmentSlot", "WildcardNeeded" ) then
			CoD.CACUtility.OpenWildcardPopup( self, element, menu, controller, "WildcardSelect", self, "bonuscard", true ) --[[ @ 0]]
			return true
	...
	f1_arg0:AddButtonCallbackFunction( secondaryAttachments, f1_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], "ui_remove", function ( element, menu, controller, model )
		if IsGamepad( controller ) and not CoD.ModelUtility.IsSelfModelPathValueEqualTo( element, controller, "loadoutListItem->itemIndex", CoDShared.EmptyItemIndex ) then
	...
	f1_arg0:AddButtonCallbackFunction( secondaryAttachments, f1_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], nil, function ( element, menu, controller, model )
	...
	f1_arg0:AddButtonCallbackFunction( secondaryAttachments, f1_arg1, Enum[@"LUIButton"][@"hash_6A86619565BE54DB"], "ui_contextual_1", function ( element, menu, controller, model )
		if IsMouseOrKeyboard( controller ) and not CoD.ModelUtility.IsSelfModelValueEqualTo( self.secondary, controller, "itemIndex", CoDShared.EmptyItemIndex ) and CoD.ModelUtility.IsSelfModelValueEqualTo( element, controller, "attachmentSlotIndex", CoD.CACUtility.OpticSlotIndex ) and IsListElementChildInState( element, "AttachmentSlot", "DefaultStateHiddenName" ) and CoD.CACUtility.IsAttachmentWithCustomReticle( menu, element ) then
			CoD.CraftUtility.SetUpOpticPersonalization( element, controller ) --[[ @ 0]]
			CoD.CACUtility.OpenCACAttachmentOverlay( self, element, menu, controller, "ReticleSelect", self, "secondary" ) --[[ @ 0]]
			PlaySoundAlias( "cac_open_wpn_cust" ) --[[ @ 0]]
	...
	secondaryAttachments:AddContextualMenuAction( f1_arg0, f1_arg1, @"hash_1679ACA6FFC6C8F3", function ( f145_arg0, f145_arg1, f145_arg2, f145_arg3 )
