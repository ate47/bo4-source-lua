...
CoD.cac_background_slide_panel = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.cac_background_slide_panel.__defaultWidth = 1920 --[[ @ 0]]
CoD.cac_background_slide_panel.__defaultHeight = 622 --[[ @ 0]]
CoD.cac_background_slide_panel.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.cac_background_slide_panel ) --[[ @ 0]]
	self.id = "cac_background_slide_panel" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	
	local BackgroundBlur = LUI.UIImage.new( -0.1, 1.1, 0, 0, 1, 1, -624, 0 ) --[[ @ 0]]
	...
	local GrainBGPattern = LUI.UIImage.new( -0.1, 1.1, 0, 0, 1, 1, -582, 0 ) --[[ @ 0]]
	...
	local TriangleBGPattern01 = LUI.UIImage.new( -0.1, 1.1, 0, 0, 1, 1, -582, 0 ) --[[ @ 0]]
	...
	local VerticalBGPattern2 = LUI.UIImage.new( -0.1, 1.1, 0, 0, 1, 1, -618, -582 ) --[[ @ 0]]
	...
	local TopBar2 = LUI.UIImage.new( -0.1, 1.1, 0, 0, 0, 0, 3, 6 ) --[[ @ 0]]
	TopBar2:setAlpha( 0.12 ) --[[ @ 0]]
