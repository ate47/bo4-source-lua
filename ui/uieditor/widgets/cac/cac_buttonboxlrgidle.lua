...
CoD.cac_ButtonBoxLrgIdle = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.cac_ButtonBoxLrgIdle.__defaultWidth = 168 --[[ @ 0]]
CoD.cac_ButtonBoxLrgIdle.__defaultHeight = 168 --[[ @ 0]]
CoD.cac_ButtonBoxLrgIdle.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.cac_ButtonBoxLrgIdle ) --[[ @ 0]]
	self.id = "cac_ButtonBoxLrgIdle" --[[ @ 0]]
	self.soundSet = "default" --[[ @ 0]]
	
	local Image = LUI.UIImage.new( 0, 1, 0, 0, 0, 1, 0, 0 ) --[[ @ 0]]
	Image:setImage( RegisterImage( @"uie_t7_menu_cac_buttonboxlrgidlefull" ) ) --[[ @ 0]]
