...
CoD.ChooseClassSlideOutInternal.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	ClassList:setAlignment( Enum[@"luialignment"][@"lui_alignment_center"] ) --[[ @ 0]]
	...
	PreviewMWheelFocusable:appendEventHandler( "input_source_changed", function ( f6_arg0, f6_arg1 )
		...
		CoD.Menu.UpdateButtonShownState( f6_arg0, f1_arg0, f1_arg1, Enum[@"luibutton"][@"lui_key_none"] ) --[[ @ 0]]
	end ) --[[ @ 0]]
	...
	ClassPClist:setAlignment( Enum[@"luialignment"][@"lui_alignment_left"] ) --[[ @ 0]]
