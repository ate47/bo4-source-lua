...
CoD.GameSettings_texbox = InheritFrom( LUI.UIElement ) --[[ @ 0]]
CoD.GameSettings_texbox.__defaultWidth = 733 --[[ @ 0]]
CoD.GameSettings_texbox.__defaultHeight = 21 --[[ @ 0]]
CoD.GameSettings_texbox.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	self:setClass( CoD.GameSettings_texbox ) --[[ @ 0]]
	self.id = "GameSettings_texbox" --[[ @ 0]]
	...
	local TextBox = LUI.UIText.new( 0, 1, 0, 0, 0, 0, 0, 21 ) --[[ @ 0]]
	TextBox:setRGB( 0.74, 0.74, 0.74 ) --[[ @ 0]]
	TextBox:setText( "" ) --[[ @ 0]]
	TextBox:setTTF( "ttmussels_regular" ) --[[ @ 0]]
	TextBox:setLineSpacing( 0.5 ) --[[ @ 0]]
