	...
	UseTimer:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f3_local0 then
					f3_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f1_arg0, "playerAbilities.playerGadget1.state", Enum[@"weapongadgetstates"][@"player_ability_state_inuse"] ) --[[ @ 0]]
					if f3_local0 then
	...
	DefaultState = {
		...
		Visible = function ( f23_arg0, f23_arg1 )
			...
			local f23_local0 = function ( f24_arg0 )
				f23_arg0.TextBox:beginAnimation( 200, Enum[@"luitween"][@"luitween_bounce"] | Enum[@"luitween"][@"luitween_ease_in"] ) --[[ @ 0]]
