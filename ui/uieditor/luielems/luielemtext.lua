...
local PostLoadFunc = function ( self, controller )
	...
	if f2_local0.horizontal_alignment then
		self:subscribeToModel( f2_local0.horizontal_alignment, function ( model )
			...
			if f8_local0 == 1 then
				self.Text:setAlignment( Enum[@"LUIAlignment"][@"hash_558C8A85F2048829"] ) --[[ @ 0]]
			elseif f8_local0 == 2 then
				self.Text:setAlignment( Enum[@"LUIAlignment"][@"hash_1FEEB12BCB0D7041"] ) --[[ @ 0]]
			elseif f8_local0 == 3 then
				self.Text:setAlignment( Enum[@"LUIAlignment"][@"hash_3830CFD395E6AA0A"] ) --[[ @ 0]]
			end
		end ) --[[ @ 0]]
	end
end
