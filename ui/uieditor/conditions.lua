...
function CanReportPlayerEndGameWarzone( f4_arg0, f4_arg1 )
	...
	if f4_local0 then
		...
		if f4_local1 ~= f4_local2 then
			f4_local4 = not Engine[@"IsVisibilityBitSet"]( f4_arg1, Enum[@"UIVisibilityBit"][@"hash_54828BED794DA0A5"] ) --[[ @ 0]]
		else
			f4_local4 = false --[[ @ 0]]
		end
		return f4_local4
...
function isFileshareFeatureEnabled()
	if Dvar[@"hash_456FCD2DEBF35884"] ~= nil and Dvar[@"hash_456FCD2DEBF35884"]:get() == true then
		return true
	else
		return false
	end
...
function ShouldSwapCircleAndCross()
	return Engine[@"hash_A53B22CB5CEDB1E"]()
end
...
function IsFirstTimeSetup( f56_arg0, f56_arg1 )
	...
	elseif not (not Engine[@"IsMultiplayerGame"]() or not IsLAN()) or Engine[@"IsInGame"]() then
		return false
	elseif f56_arg1 ~= Enum[@"eModes"][@"hash_360063C67132EB69"] then
		return false
	else
...
function IsCampaignStoryFirstTimeSetup( f57_arg0 )
	return IsFirstTimeSetup( f57_arg0, Enum[@"eModes"][@"hash_360063C67132EB69"] ) and CoD.DirectorUtility.IsLobbyMenu( f57_arg0, LuaEnum.UI.DIRECTOR_ONLINE_CP_STORY )
end
...
function GameEnded( f63_arg0 )
	return IsVisibilityBitSet( f63_arg0, Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"] )
end
...
function IsCampaign()
	...
	return f79_local0[@"hash_EB7DDC7F079D51B"] == Enum[@"LobbyMainMode"][@"hash_37B50049993542C0"]
end

function IsMultiplayer()
	local f80_local0 = LobbyData.GetCurrentMenuTarget() --[[ @ 0]]
	return f80_local0[@"hash_EB7DDC7F079D51B"] == Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"]
end

function IsZombies()
	local f81_local0 = LobbyData.GetCurrentMenuTarget() --[[ @ 0]]
	return f81_local0[@"hash_EB7DDC7F079D51B"] == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"]
end

function IsWarzone()
	local f82_local0 = LobbyData.GetCurrentMenuTarget() --[[ @ 0]]
	return f82_local0[@"hash_EB7DDC7F079D51B"] == Enum[@"LobbyMainMode"][@"hash_378C124999125C42"]
end

function IsWarzoneOrCurrentMilestone()
	local f83_local0 = LobbyData.GetCurrentMenuTarget() --[[ @ 0]]
	local f83_local1 --[[ @ 0]]
	if f83_local0[@"hash_EB7DDC7F079D51B"] ~= Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] then
...
function IsAttackDefendGametype()
	local f85_local0 = Engine[@"hash_5EA74FA7EE46E195"]( Engine[@"hash_36F8027A8BC75673"]() ) --[[ @ 0]]
...
function IsGroupsEnabled( f88_arg0 )
	if CoD.DirectorUtility.DisableForCurrentMilestone( f88_arg0 ) then
		...
		local f88_local0 = Dvar[@"hash_41E464135723AE03"]:get() --[[ @ 0]]
...
function IsGroupMember( f92_arg0, f92_arg1 )
	...
	local f92_local1 --[[ @ 0]]
	if f92_local0 ~= Enum[@"GroupMemberStatus"][@"hash_70CFA361AE88F6ED"] and f92_local0 ~= Enum[@"GroupMemberStatus"][@"hash_60627ECA60EDF19E"] and f92_local0 ~= Enum[@"GroupMemberStatus"][@"hash_5EFDD9EAFDD00BFA"] then
		f92_local1 = false --[[ @ 0]]
	else
		f92_local1 = true --[[ @ 0]]
	end
...
function IsGroupAdmin( f93_arg0, f93_arg1 )
	...
	return f93_local0 == Enum[@"GroupMemberStatus"][@"hash_60627ECA60EDF19E"]
end
...
function IsGroupOwner( f94_arg0, f94_arg1 )
	...
	return f94_local0 == Enum[@"GroupMemberStatus"][@"hash_5EFDD9EAFDD00BFA"]
end
...
function ShowCACExtraClassBreadcrumb( f101_arg0 )
	if IsClassSetsAvailableForCurrentGameMode() and not DoesPlayerHaveExtraSlotsItem( f101_arg0 ) then
		local f101_local0 = Engine[@"StorageGetBuffer"]( f101_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
		if f101_local0 then
...
function IsCACItemBubbleGum( f102_arg0, f102_arg1, f102_arg2 )
	...
	if f102_local0 then
		...
		if f102_local1 then
			local f102_local2 = Engine[@"GetItemGroup"]( Engine[@"GetModelValue"]( f102_local1 ), Enum[@"hash_6EB546760F890D2"][@"hash_648CD0338EE0B3AE"], CoD.PrestigeUtility.GetPermanentUnlockMode() ) --[[ @ 0]]
...
function IsProgressionEnabledT7( f104_arg0 )
	if not (not IsMultiplayer() or not IsLive() or Engine[@"GameModeIsMode"]( Enum[@"eGameModes"][@"hash_15E90ACB801E4A3D"] ) or Engine[@"GameModeIsMode"]( Enum[@"eGameModes"][@"hash_27B5630CD29180CB"] )) or not (not CoD.PrestigeUtility.isInPermanentUnlockMenu or not IsLive() or Engine[@"IsInGame"]()) or not (not IsCampaign() or CoD.perController[f104_arg0].everythingUnlocked) or IsZombies() and IsLive() and not Engine[@"IsInGame"]() then
		return true
	else
		return false
	end
...
function IsCACWeaponAttributeAddedValuePositive( f109_arg0, f109_arg1, f109_arg2, f109_arg3 )
	...
	if not (f109_local1 ~= nil or Engine[@"CurrentSessionMode"]() ~= Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] or f109_local0 ~= "primary" and f109_local0 ~= "secondary") or Engine[@"CurrentSessionMode"]() == Enum[@"eModes"][@"hash_73723205FAE52C4A"] and f109_local0 == "zmStartWeapon" then
		return ""
	end
...
function AllowWeaponPrestige( f110_arg0 )
	local f110_local0 --[[ @ 0]]
	if f110_arg0 ~= Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] then
...
function LobbyConnectedToDedicatedHost()
	return Engine[@"hash_18EB264B38365442"]()
end
...
function IsDoubleWeaponXP( f129_arg0 )
	if not IsPublicOrLeagueGame() then
		...
		if not f129_local0 or f129_local0[@"hash_253DACF8EE94B654"] ~= @"hash_69818A6A90DAF973" then
			return false
		end
	end
	local f129_local0 = LobbyData.GetCurrentMenuTarget() --[[ @ 0]]
...
function IsTierBoostActive( f130_arg0 )
	if not IsPublicOnlineGame() or IsZombies() then
		...
		elseif CoD.BaseUtility.IsDvarEnabled( "ui_fakeTierBoost" ) then
			...
			if Engine[@"hash_5F4F47F17B3BDCB3"]( f130_arg0, Engine[@"hash_2ACFE452C407B25B"]( f130_local1 ), f130_local1, Engine[@"hash_17B3B2B73B53EB34"]() ) then
				return true
			else
...
function IsDoubleLootXP( f131_arg0 )
	if not IsPublicOrLeagueGame() then
		...
		local f131_local0 = Dvar[@"hash_54CB81F80166E79F"]:get() --[[ @ 0]]
...
function IsMainModeInvalid()
	if Engine[@"GetModelValue"]( Engine[@"GetModel"]( Engine[@"GetGlobalModel"](), "lobbyRoot.lobbyMainMode" ) ) == Enum[@"LobbyMainMode"][@"hash_6D5FBB8D74AC6D62"] then
		return true
	else
		return false
	end
...
function IsLive()
	if Engine[@"GetModelValue"]( Engine[@"GetModel"]( Engine[@"GetGlobalModel"](), "lobbyRoot.lobbyNetworkMode" ) ) == Enum[@"LobbyNetworkMode"][@"hash_2E99F41098B71960"] then
		return true
	else
		return false
	end
...
function IsLAN()
	if Engine[@"GetModelValue"]( Engine[@"GetModel"]( Engine[@"GetGlobalModel"](), "lobbyRoot.lobbyNetworkMode" ) ) == Enum[@"LobbyNetworkMode"][@"hash_1BAA8EC6F3E77255"] then
		return true
	else
		return false
	end
...
function IsLocal()
	if Engine[@"GetModelValue"]( Engine[@"GetModel"]( Engine[@"GetGlobalModel"](), "lobbyRoot.lobbyNetworkMode" ) ) == Enum[@"LobbyNetworkMode"][@"hash_E97D54588ADFFD1"] then
		return true
	else
		return false
	end
...
function IsPublicWZLobby()
	return IsLobbyMode( Enum[@"LobbyMode"][@"hash_2BB5FD8AEFC4D4B9"] ) and IsWarzone()
end
...
function IsLobbyTypeActive( f146_arg0 )
	return Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f146_arg0 )
end
...
function IsLobbyNetworkModeLAN()
	return Engine[@"hash_7A63E42B2FB6EC02"]() == Enum[@"LobbyNetworkMode"][@"hash_1BAA8EC6F3E77255"]
end
...
function IsLobbyHost()
	if Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) then
		return Engine[@"hash_10EA2BE00F49480D"]( Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] )
	elseif Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"] ) then
...
function IsLobbyHostOfLobbyType( f151_arg0 )
	return Engine[@"hash_10EA2BE00F49480D"]( f151_arg0 )
end
...
function IsLobbyHostOfCurrentMenu()
	...
	if not f152_local0 then
		...
		if not f152_local1 then
			return false
		elseif f152_local1[@"LobbyType"] == Enum[@"LobbyType"][@"hash_3B0756CC6FC8665C"] then
			return false
		elseif LobbyConnectedToDedicatedHost() then
			return false
		else
			return Engine[@"hash_10EA2BE00F49480D"]( f152_local1[@"LobbyType"] )
		end
	end
end
...
function PregameActive()
	return Engine[@"hash_1C1AA623AAF32C21"]() ~= Enum[@"LobbyPregameState"][@"hash_3ECCE7392BE20418"]
end

function ItemRestrictionVoteActive()
	return Engine[@"hash_1C1AA623AAF32C21"]() == Enum[@"LobbyPregameState"][@"hash_280503ECA55D2B4A"]
end
...
function ClientIsLeader( f167_arg0, f167_arg1 )
	...
	if f167_local0 == nil then
		...
		if Engine[@"hash_E4D2F32833CFA6C"]( f167_local1 ) == nil then
			return false
		else
...
function SelfCharacterIndexIsValid( f168_arg0, f168_arg1, f168_arg2 )
	local f168_local0 = Engine[@"hash_E4D2F32833CFA6C"]( Engine[@"GetClientNum"]( f168_arg2 ) ) --[[ @ 0]]
...
function CharacterIndexIsValid( f169_arg0, f169_arg1, f169_arg2 )
	...
	local f169_local2 = f169_local1 and Engine[@"hash_E4D2F32833CFA6C"]( f169_local1 ) --[[ @ 0]]
...
function SelectedCharacterHasStoryMoment( f170_arg0, f170_arg1, f170_arg2 )
	if f170_arg1:getModel() == nil then
		...
		if f170_local0 == nil or f170_local0 <= 0 then
			...
			local f170_local2 = Engine[@"GetGDTCampaignMapInfo"]( Engine[@"hash_3E67E7253CC272C9"]() ) --[[ @ 0]]
			if f170_local2 then
...
function CharacterHasStoryMoment( f171_arg0, f171_arg1, f171_arg2 )
	...
	if f171_local0 == nil then
		...
		if f171_local1 == nil or f171_local1 < 0 then
			...
			local f171_local3 = Engine[@"GetGDTCampaignMapInfo"]( Engine[@"hash_3E67E7253CC272C9"]() ) --[[ @ 0]]
			if f171_local3 then
...
function PlayerReadiedUp( f172_arg0 )
	local f172_local0 = Engine[@"hash_E4D2F32833CFA6C"]( Engine[@"GetClientNum"]( f172_arg0 ) ) --[[ @ 0]]
...
function TeamIsReady( f173_arg0 )
	local f173_local0 = Engine[@"hash_E4D2F32833CFA6C"]( Engine[@"GetClientNum"]( f173_arg0 ) ) --[[ @ 0]]
	...
	for f173_local2 = 0 --[[ @ 0]], f173_local1 - 1, 1 do
		local f173_local5 = Engine[@"hash_E4D2F32833CFA6C"]( f173_local2 ) --[[ @ 0]]
...
function EnemyTeamIsReady( f174_arg0 )
	local f174_local0 = Engine[@"hash_E4D2F32833CFA6C"]( Engine[@"GetClientNum"]( f174_arg0 ) ) --[[ @ 0]]
	...
	for f174_local2 = 0 --[[ @ 0]], f174_local1 - 1, 1 do
		local f174_local5 = Engine[@"hash_E4D2F32833CFA6C"]( f174_local2 ) --[[ @ 0]]
...
function IsPublicOrLeagueGame( f192_arg0 )
	local f192_local0 = Engine[@"GameModeIsMode"]( Enum[@"eGameModes"][@"hash_795910ACF90F64AD"] ) --[[ @ 0]]
	if not f192_local0 then
		f192_local0 = Engine[@"GameModeIsMode"]( Enum[@"eGameModes"][@"hash_158ECA70A244C08F"] ) --[[ @ 0]]
	end
	return f192_local0
end
...
function ShouldBootUpHUD( f200_arg0, f200_arg1 )
	if IsInPrematchPeriod( f200_arg0 ) then
		return false
	elseif not Engine[@"IsVisibilityBitSet"]( 0, Enum[@"UIVisibilityBit"][@"hash_7ADC477DDE486DD7"] ) then
		return false
	else
...
function DamageFeedbackInStage( f202_arg0, f202_arg1 )
	...
	if f202_local0 then
		return f202_local0 & Enum[@"DamageFeedbackState"][@"hash_78E4CBDF13CA44C1"] == f202_arg1
	else
		return false
	end
end
...
function DamageFeedbackFlagSet( f203_arg0, f203_arg1 )
	...
	if f203_local0 then
		return CoD.BitUtility.IsBitSet( f203_local0 >> Enum[@"DamageFeedbackState"][@"hash_67B818BA51B61DCF"], f203_arg1 )
	else
		return false
	end
end
...
function IsSignatureWeaponInUse( f211_arg0 )
	...
	if f211_local0 ~= nil then
		f211_local1 = Engine[@"hash_29C49FDE2E584E95"]( f211_local0 ) --[[ @ 0]]
	else
		f211_local1 = false --[[ @ 0]]
	end
	return f211_local1
...
function IsSpecificGadgetInUse( f212_arg0, f212_arg1, f212_arg2 )
	...
	local f212_local1 --[[ @ 0]]
	if CoD.SafeGetModelValue( f212_local0, "state" ) ~= Enum[@"hash_F0447219F15F7F3"][@"hash_51873A43E9D1620E"] or CoD.SafeGetModelValue( f212_local0, "id" ) ~= f212_arg2 then
		f212_local1 = false --[[ @ 0]]
	else
		f212_local1 = true --[[ @ 0]]
	end
...
function IsSecondaryOffhandGadgetPowerBased( f215_arg0 )
	return Engine[@"IsPowerBasedGadget"]( f215_arg0, Enum[@"hash_98B551D096F88F5"][@"hash_23FC0C46CF7CC35E"] )
end

function IsUsingSprintDecay()
	return Engine[@"hash_AECB6AA41A2A0BB"]() and IsMultiplayer()
end
...
function IsSimulateCT()
	return LUI.DEV and Engine[@"hash_49E5BE3B4BBA4E0E"]( "ui_simulateCT" )
end
...
function Paintjobs_DisableGroupsFeature()
	return Dvar[@"hash_3211555FF0E63362"].exists() and Dvar[@"hash_3211555FF0E63362"]:get()
end
...
function IsGroupSlotAvailable( f245_arg0 )
	...
	if f245_local0 then
		f245_local1 = Engine[@"GetModelValue"]( f245_local0 ) < Enum[@"CustomizationTypeGroupCount"][@"hash_17CC26C5AE105AF7"] - 1 --[[ @ 0]]
	end
	return f245_local1
end
...
function BrowseModeLinkedLayer( f247_arg0, f247_arg1, f247_arg2, f247_arg3 )
	local f247_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f247_arg1, "Emblem.EmblemProperties.editorMode", Enum[@"CustomizationEditorMode"][@"hash_3EBDFD4FFDC7DA3"] ) --[[ @ 0]]
	if f247_local0 then
...
function BrowseModeGroupedLayer( f248_arg0, f248_arg1, f248_arg2, f248_arg3 )
	local f248_local0 = CoD.ModelUtility.IsModelValueEqualToEnum( f248_arg1, "Emblem.EmblemProperties.editorMode", Enum[@"CustomizationEditorMode"][@"hash_3EBDFD4FFDC7DA3"] ) --[[ @ 0]]
	if f248_local0 then
...
function IsPreBuiltEmblemTab( f257_arg0 )
	if CoD.perController[f257_arg0].selectedEmblemTabStorageType == Enum[@"StorageFileType"][@"hash_7B909AC87BFB6D6C"] or CoD.perController[f257_arg0].selectedEmblemTabStorageType == Enum[@"StorageFileType"][@"hash_60BCE8CBF08D7751"] or CoD.perController[f257_arg0].selectedEmblemTabStorageType == Enum[@"StorageFileType"][@"hash_36A0A3D1062F156F"] then
		return true
	else
		return false
	end
...
function IsEmblemEditor( f258_arg0 )
	return CoD.GetCustomization( f258_arg0, "type" ) == Enum[@"CustomizationType"][@"hash_5979B4C08E9D67B2"]
end

function IsPaintshop( f259_arg0 )
	local f259_local0 = CoD.GetCustomization( f259_arg0, "type" ) --[[ @ 0]]
	local f259_local1 --[[ @ 0]]
	if f259_local0 ~= Enum[@"CustomizationType"][@"hash_64E4802F1ABF1844"] and f259_local0 ~= Enum[@"CustomizationType"][@"hash_6820B78756D14F98"] and f259_local0 ~= Enum[@"CustomizationType"][@"hash_612D0D16BBE10491"] then
		f259_local1 = false --[[ @ 0]]
	else
		f259_local1 = true --[[ @ 0]]
	end
...
function IsDpadButton( f274_arg0 )
	...
	if f274_local0 ~= nil then
		f274_local1 = CoD.BitUtility.IsBitwiseAndNonZero( f274_local0, Enum[@"LUIButtonFlags"][@"hash_BAF13F65A51F649"] ) --[[ @ 0]]
	else
		f274_local1 = true --[[ @ 0]]
	end
	return f274_local1
...
function IsRepeatButtonPress( f275_arg0 )
	...
	if f275_local0 ~= nil then
		f275_local1 = CoD.BitUtility.IsBitwiseAndNonZero( f275_local0, Enum[@"LUIButtonFlags"][@"hash_73DC8FC0E6AB543F"] ) --[[ @ 0]]
	else
		f275_local1 = false --[[ @ 0]]
	end
	return f275_local1
...
function CanUseSharedLoadouts( f279_arg0 )
	...
	local f279_local0 = Dvar[@"hash_7867B95DC8C4230A"]:get() --[[ @ 0]]
...
function IsInTheaterMode()
	if IsLobbyPrivateHost() and IsLobbyMode( Enum[@"LobbyMode"][@"hash_28B3B066EFD7CD01"] ) then
		return true
	else
		return false
	end
...
function LobbyModeTheater()
	return IsLobbyMode( Enum[@"LobbyMode"][@"hash_28B3B066EFD7CD01"] )
end

function IsFilmSelected()
	local f283_local0 = Engine[@"hash_323AF33F30C69410"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] ) ) --[[ @ 0]]
...
function IsUploadClipButtonDisabled()
	if Engine[@"hash_24A884DF5CCCEB2E"]() or Engine[@"hash_75EC757FC8E459CB"]() or Engine[@"hash_379618C46565F5A4"]() <= 0 or Engine[@"hash_33047E45CED1F5A4"]() then
		return true
	else
		return false
	end
...
function IsCustomizeHighlightReelButtonDisabled()
	if Engine[@"hash_75EC757FC8E459CB"]() or Engine[@"hash_33047E45CED1F5A4"]() or not Engine[@"hash_10EA2BE00F49480D"]( Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) or not Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) then
		return true
	else
		return false
	end
...
function IsJumpToStartButtonDisabled()
	if Engine[@"hash_75EC757FC8E459CB"]() or Engine[@"hash_33047E45CED1F5A4"]() or not Engine[@"hash_10EA2BE00F49480D"]( Enum[@"LobbyType"][@"hash_20A1647599284110"] ) or not Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"] ) then
		return true
	else
		return false
	end
...
function IsDemoPlaying()
	return Engine[@"hash_2A55C3ACD0D2BCF0"]()
end

function IsDemoClipPlaying()
	return Engine[@"hash_24A884DF5CCCEB2E"]()
end

function IsDemoClipPreviewRunning()
	return Engine[@"hash_70D351B4D77C79B3"]()
end
...
function IsDemoContextBasicMode()
	return GetDemoContextMode() == Enum[@"demoContextMode"][@"hash_1432E29CBD83BEB5"]
end

function IsDemoContextPlaybackMode()
	return GetDemoContextMode() == Enum[@"demoContextMode"][@"hash_4FDF8441F0D7CD4"]
end

function IsDemoContextDirectorMode()
	return GetDemoContextMode() == Enum[@"demoContextMode"][@"hash_6D6C645A6FE86C79"]
end

function IsDemoContextObjectLinkMode()
	return GetDemoContextMode() == Enum[@"demoContextMode"][@"hash_29F3A6331D6505AB"]
end

function IsDemoContextLighterMode()
	return GetDemoContextMode() == Enum[@"demoContextMode"][@"hash_16D2AFAEC0E25E5C"]
end

function IsDemoContextHighlightReelMode()
	return GetDemoContextMode() == Enum[@"demoContextMode"][@"hash_2699D1F37EAAA1E8"]
end
...
function SegmentCountGreaterThan( f313_arg0, f313_arg1 )
	return f313_arg1 < Engine[@"hash_379618C46565F5A4"]()
end

function CanChangeSegmentTransition( f314_arg0, f314_arg1 )
	local f314_local0 = Engine[@"hash_379618C46565F5A4"]() --[[ @ 0]]
...
function IsSegmentTransition( f315_arg0, f315_arg1, f315_arg2 )
	...
	if f315_local0 then
		return tonumber( Engine[@"hash_161A661773462085"]( Engine[@"GetModelValue"]( f315_local0 ) - 1, "transitionValue" ) ) == f315_arg2
	else
		return false
	end
end
...
function VehicleHasEnemyLock( f317_arg0, f317_arg1 )
	local f317_local0 = CoD.ModelUtility.IsSelfEnumModelValueTrue( f317_arg0, f317_arg1, Enum[@"MissileLockedOnDirection"][@"hash_21091C5D63A96BC0"] ) --[[ @ 0]]
	if not f317_local0 then
		f317_local0 = CoD.ModelUtility.IsSelfEnumModelValueTrue( f317_arg0, f317_arg1, Enum[@"MissileLockedOnDirection"][@"hash_53BBA82A75213295"] ) --[[ @ 0]]
		if not f317_local0 then
			f317_local0 = CoD.ModelUtility.IsSelfEnumModelValueTrue( f317_arg0, f317_arg1, Enum[@"MissileLockedOnDirection"][@"hash_7654066BD0500BF0"] ) --[[ @ 0]]
			if not f317_local0 then
				f317_local0 = CoD.ModelUtility.IsSelfEnumModelValueTrue( f317_arg0, f317_arg1, Enum[@"MissileLockedOnDirection"][@"hash_763CE4D237D81945"] ) --[[ @ 0]]
			end
		end
	end
	return f317_local0
...
function IsDurangoGamepad( f327_arg0 )
	...
	if not f327_local0 then
		...
		if f327_local0 then
			...
			if f327_local0 then
				f327_local0 = Engine[@"GamepadType"]( f327_arg0 ) == Enum[@"gamepadType_e"][@"hash_7A6F6CFA25C35148"] --[[ @ 0]]
			end
		end
	end
	return f327_local0
...
function IsOrbisGamepad( f328_arg0 )
	...
	if not IsOrbis() or Engine[@"LastInput_Vita"]( f328_arg0 ) then
		...
		if f328_local0 then
			...
			if f328_local0 then
				if Engine[@"GamepadType"]( f328_arg0 ) ~= Enum[@"gamepadType_e"][@"hash_1605C7602BE486FF"] then
					f328_local0 = false --[[ @ 0]]
				else
					f328_local0 = true --[[ @ 0]]
				end
...
function DurangoGamepadInPorts( f330_arg0 )
	return IsPC() and Engine[@"GamepadType"]( f330_arg0 ) == Enum[@"gamepadType_e"][@"hash_7A6F6CFA25C35148"]
end

function OrbisGamepadInPorts( f331_arg0 )
	return IsPC() and Engine[@"GamepadType"]( f331_arg0 ) == Enum[@"gamepadType_e"][@"hash_1605C7602BE486FF"]
end

function NoGamepadInPorts( f332_arg0 )
	return IsPC() and Engine[@"GamepadType"]( f332_arg0 ) == Enum[@"gamepadType_e"][@"hash_226C4FAFF3A48655"]
end

function WasCampaignSoloGame( f333_arg0 )
	return Engine[@"GetScoreboardTeamClientCount"]( Enum[@"team_t"][@"hash_42A34B055ADD98AB"] ) == 1
end

function HasFriends( f334_arg0 )
	return Engine[@"GetFriendsCount"]( f334_arg0, Enum[@"PresenceFilter"][@"hash_6708B5057D80F5FF"] ) > 0
end
...
function IsInTitle( f337_arg0, f337_arg1 )
	...
	if f337_local1 then
		...
		if f337_local2 == Enum[@"PresenceActivity"][@"hash_214916BC7C01AE13"] then
			return false
		elseif f337_local2 == Enum[@"PresenceActivity"][@"hash_449372DE9D3CE680"] then
			return false
		end
	end
	return true
...
function IsJoinable( f338_arg0, f338_arg1 )
	...
	if f338_local0 then
		...
		if f338_local1 == Enum[@"LobbyJoinable"][@"hash_61FD2A499E7CD0E4"] then
			return true
		elseif f338_local1 == Enum[@"LobbyJoinable"][@"hash_30BFB4278A2E811D"] then
...
function IsScoreboardPingAsBars( f340_arg0, f340_arg1 )
	if Dvar[@"hash_7DDC61194A7E2C0C"]:get() == false then
		return Dvar[@"hash_33F506D23F310141"]:get() > 1
	else
...
function ScoreboardVisible( f341_arg0 )
	local f341_local0 = Engine[@"IsVisibilityBitSet"]( f341_arg0, Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"] ) --[[ @ 0]]
...
function IsScoreboardPlayerMuted( f342_arg0, f342_arg1 )
	return Engine[@"hash_5AC4DDADDA07242F"]( f342_arg0, Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], CoD.SafeGetModelValue( f342_arg1:getModel(), "clientNum" ) )
end
...
function IsScoreboardPlayerCodCaster( f343_arg0, f343_arg1 )
	...
	if f343_local0 ~= nil and f343_local0 >= 0 then
		return Engine[@"GetTeamID"]( f343_arg0, f343_local0 ) == Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"]
	else
		return false
	end
end
...
function IsScoreboardPlayerSelf( f346_arg0, f346_arg1 )
	...
	if f346_local0 then
		...
		if IsInGame() and Engine[@"IsVisibilityBitSet"]( f346_arg1, Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"] ) then
			f346_local1 = 0 --[[ @ 0]]
...
function ShouldShowPartyPrivacy( f349_arg0 )
	local f349_local0 = LobbyData.GetLobbyMenuByID( Engine[@"hash_69882F293C327557"]() ) --[[ @ 0]]
	local f349_local1 = Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
	local f349_local2 = Enum[@"LobbyType"][@"hash_20A1647599284110"] --[[ @ 0]]
	if f349_local1 and f349_local0[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_3F5EE25D311E5223"] then
		f349_local2 = Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] --[[ @ 0]]
	end
	if not Engine[@"hash_10EA2BE00F49480D"]( f349_local2 ) then
		return false
	elseif f349_local0[@"hash_3EE71E4EE12BC453"] <= 1 then
		return false
	else
		return true
	end
...
function ShouldShowLeaveParty( f350_arg0 )
	local f350_local0 = LobbyData.GetLobbyMenuByID( Engine[@"hash_69882F293C327557"]() ) --[[ @ 0]]
	local f350_local1 = Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
	local f350_local2 = Enum[@"LobbyType"][@"hash_20A1647599284110"] --[[ @ 0]]
	if f350_local1 and f350_local0[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_3F5EE25D311E5223"] then
		f350_local2 = Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] --[[ @ 0]]
	end
	local f350_local3 = Engine[@"hash_4755D55B3813D249"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f350_local2 ) --[[ @ 0]]
...
function ShouldShowBootPlayer( f352_arg0 )
	local f352_local0 = LobbyData.GetLobbyMenuByID( Engine[@"hash_69882F293C327557"]() ) --[[ @ 0]]
	local f352_local1 = Engine[@"hash_23E68E350BEFE50D"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
	local f352_local2 = Enum[@"LobbyType"][@"hash_20A1647599284110"] --[[ @ 0]]
	if f352_local1 and f352_local0[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_3F5EE25D311E5223"] then
		f352_local2 = Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] --[[ @ 0]]
	end
	if not Engine[@"hash_10EA2BE00F49480D"]( f352_local2 ) then
		return false
	end
	local f352_local3 = Engine[@"hash_4755D55B3813D249"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"], f352_local2 ) --[[ @ 0]]
...
function IsBleedOutVisible( f353_arg0, f353_arg1 )
	if Engine[@"IsVisibilityBitSet"]( f353_arg1, Enum[@"UIVisibilityBit"][@"hash_66FFF566DCC09BBD"] ) then
		return false
	end
	...
	if f353_local0 then
		...
		if f353_local1 ~= nil then
			return CoD.BitUtility.IsAnyBitSet( f353_local1, {
				Enum[@"BleedOutStateFlags"][@"hash_28013AC127C215B4"],
				Enum[@"BleedOutStateFlags"][@"hash_5388AB9DB3B39402"]
			} )
		end
	end
	return false
...
function ShouldHideButtonPromptForPC( f356_arg0, f356_arg1 )
	if CoD.isPC then
		...
		elseif f356_local0 and f356_local0.Label and f356_local0.Label == @"hash_0" then
			return true
		elseif f356_local0 and f356_local0.Label and f356_local0.Label == @"hash_6D0BB36CD318F55F" and f356_local0.Button == Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] then
			return true
		elseif f356_local2 and CoD.BitUtility.IsBitwiseAndNonZero( f356_local2, Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"] ) and not CoD.FreeCursorUtility.CanShowContextualButtonPromptPC( f356_arg0, f356_arg1 ) then
			return true
		end
	end
	return false
...
function IsOwedVials( f359_arg0 )
	local f359_local0 = Engine[@"StorageGetBuffer"]( f359_arg0, Enum[@"StorageFileType"][@"hash_2EC77AD28A19F8E0"] ) --[[ @ 0]]
	if not f359_local0 then
		return false
	elseif Dvar[@"hash_160119E9B65593E1"]:exists() then
		local f359_local1 --[[ @ 0]]
		if f359_local0.vialsOwed:get() > 0 then
			f359_local1 = Dvar[@"hash_160119E9B65593E1"]:get() --[[ @ 0]]
		else
			f359_local1 = false --[[ @ 0]]
		end
		return f359_local1
...
function IsLootReady( f362_arg0 )
	return Engine[@"hash_42C75EFD5414E496"]( f362_arg0 )
end
...
function ShouldOpenGraphicsAndSoundOptions()
	...
	elseif CoD.DirectorUtility.IsOfflineOnlyDemo() then
		...
		local f365_local0 --[[ @ 0]]
		if Dvar[@"hash_1E017690F8837DD6"]:get() then
			f365_local0 = Dvar[@"hash_1E017690F8837DD6"]:get() --[[ @ 0]]
			if f365_local0 then
				f365_local0 = Dvar[@"hash_242A6A3568FF9F81"]:get() --[[ @ 0]]
			end
		else
			f365_local0 = true --[[ @ 0]]
		end
...
function IsArabicSku()
	if Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_28BDB4147F05F2A2"] ) and Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"language_arabic"] ) then
		return true
	else
		return false
	end
...
function IsChineseSku()
	if Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_6518A7E7D67F8C88"] ) and Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_7B481FC3055D43A1"] ) then
		return true
	else
		return false
	end
...
function IsJapaneseSku()
	if CoD.isPC and Engine[@"hash_7543F4AF0F31BA06"]() then
		return true
	elseif Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_39A4194D08679C69"] ) and Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"language_japanese"] ) then
		return true
	else
		return false
	end
...
function IsRussianSku()
	if Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_237F47E9EC48B533"] ) and Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"language_russian"] ) then
		return true
	else
		return false
	end
...
function IsPolishSku()
	if Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_404A6F14865F072B"] ) and Engine[@"IsLanguageSupportedInSKU"]( Enum[@"hash_2AA0EE37DF15F5A8"][@"language_polish"] ) then
		return true
	else
		return false
	end
...
function IsCurrentLanguageEnglish()
	...
	if f415_local0 == Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_7DC77F190F9D7964"] or f415_local0 == Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_28BDB4147F05F2A2"] then
		return true
	else
		return false
	end
...
function IsCurrentLanguageArabic()
	if Dvar[@"loc_language"]:get() == Enum[@"hash_2AA0EE37DF15F5A8"][@"language_arabic"] then
		return true
	else
		return false
	end
...
function IsCurrentLanguageKorean()
	if Dvar[@"loc_language"]:get() == Enum[@"hash_2AA0EE37DF15F5A8"][@"language_korean"] then
		return true
	else
		return false
	end
...
function IsCurrentLanguageTraditionalChinese()
	if Dvar[@"loc_language"]:get() == Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_6518A7E7D67F8C88"] then
		return true
	else
		return false
	end
...
function IsCurrentLanguageFrench()
	if Dvar[@"loc_language"]:get() == Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_7FDE0E0CF4EA7FAC"] then
		return true
	else
		return false
	end
...
function IsGameModeInstalled( f425_arg0, f425_arg1 )
	if f425_arg1 == Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] then
		return true
...
function ShouldShowLobbyAddControllerMessage( f427_arg0, f427_arg1 )
	...
	if f427_local5 ~= Engine[@"GetUsedControllerCount"]() or f427_local5 >= Dvar[@"hash_66BAC8B42067D2C5"]:get() then
...
function ShouldShowSplitscreenControllerText( f428_arg0, f428_arg1 )
	if Engine[@"hash_5CB675CA7856DA25"]() and not LuaUtils.TrialAllowSplitscreen() then
		...
		local f428_local0 = Engine[@"GetUsedControllerCount"]() < Dvar[@"hash_66BAC8B42067D2C5"]:get() --[[ @ 0]]
		local f428_local1 = LobbyData.GetLobbyMenuByID( Engine[@"hash_69882F293C327557"]() ) --[[ @ 0]]
		return f428_local0 and Engine[@"hash_144FC97037CE42ED"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"], Enum[@"LobbyType"][@"hash_20A1647599284110"], Enum[@"hash_6575E471C039DBD6"][@"hash_1092BC25E18D296F"] ) < f428_local1[@"hash_3EE71E4EE12BC453"]
	end
end
...
function ZMDoubleXPWidgetVisible( f429_arg0 )
	...
	if IsInGame() then
		...
		local f429_local1 --[[ @ 0]]
		if Engine[@"hash_144FC97037CE42ED"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], Enum[@"hash_6575E471C039DBD6"][@"hash_1092BC25E18D296F"] ) <= 1 and Engine[@"hash_144FC97037CE42ED"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"], Enum[@"hash_6575E471C039DBD6"][@"hash_28A42AF1547AB4DF"] ) <= 1 then
			f429_local1 = false --[[ @ 0]]
		else
			f429_local1 = true --[[ @ 0]]
		end
...
function IsMultiplayerCombatRecordMode()
	return CoD.GetCombatRecordMode() == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"]
end

function IsZombiesCombatRecordMode()
	return CoD.GetCombatRecordMode() == Enum[@"eModes"][@"hash_73723205FAE52C4A"]
end
...
function IsFreeCursorActive( f439_arg0 )
	...
	if f439_local0 then
		f439_local0 = Dvar[@"hash_48E0F129D51A415C"]:get() --[[ @ 0]]
		if f439_local0 then
...
function AnyContextualButtonPrompts( f441_arg0, f441_arg1 )
	...
	if f441_local0 then
		for f441_local1 = 0 --[[ @ 0]], Enum[@"LUIButton"][@"hash_295F016E15E34356"] - 1, 1 do
			local f441_local4 = f441_local0[f441_local1] --[[ @ 0]]
			if f441_local4 and f441_local4:get() ~= Enum[@"LUIButtonPromptStates"][@"hash_C3FAFD8EBE94438"] then
				...
				if f441_local7 then
					f441_local7 = f441_local1 == Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"] --[[ @ 0]]
				end
				if not f441_local7 and f441_local5 and f441_local6 and f441_local6:get() ~= "" and f441_local5:get() & Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"] ~= 0 then
					return true
				end
			end
		end
