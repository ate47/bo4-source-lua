...
CoD.StoreUtility.AddUpsellToDescriptionIfNeeded = function ( f3_arg0, f3_arg1, f3_arg2 )
	if not Engine[@"ismapvalid"]( f3_arg1 ) and ShowPurchasableMap( f3_arg0, f3_arg1 ) then
		local f3_local0 = Engine[@"getdlcbitformapname"]( f3_arg1 ) --[[ @ 0]]
...
CoD.StoreUtility.PrependPurchaseIconIfNeeded = function ( f4_arg0, f4_arg1, f4_arg2 )
	if not Engine[@"ismapvalid"]( f4_arg1 ) and ShowPurchasableMap( f4_arg0, f4_arg1 ) then
		local f4_local0 = Engine[@"getdlcbitformapname"]( f4_arg1 ) --[[ @ 0]]
...
CoD.StoreUtility.AddListDLCListener = function ( f5_arg0 )
	f5_arg0._previousDLCBits = Engine[@"getdlcbits"]() --[[ @ 0]]
...
CoD.StoreUtility.ShouldUpsellOrDownloadPlaylist = function ( f18_arg0, f18_arg1 )
	local f18_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( f18_arg1, f18_arg0, "lockState", Enum[@"playlistlockstate"][@"hash_4BDEB566326AC98"] ) --[[ @ 0]]
	if not f18_local0 then
		f18_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEnum( f18_arg1, f18_arg0, "lockState", Enum[@"playlistlockstate"][@"pls_required_dlc_not_available"] ) --[[ @ 0]]
	end
	return f18_local0
end
 --[[ @ 0]]
...
CoD.StoreUtility.GetDLCImageByPlaylistId = function ( f20_arg0, f20_arg1 )
	if f20_arg1 then
		local f20_local0 = Engine[@"getplaylistinfobyid"]( f20_arg1 ) --[[ @ 0]]
...
CoD.StoreUtility.GetDLCPackByPlaylistId = function ( f21_arg0, f21_arg1 )
	if f21_arg1 then
		local f21_local0 = Engine[@"getplaylistinfobyid"]( f21_arg1 ) --[[ @ 0]]
