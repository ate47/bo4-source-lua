...
CoD.OptionsUtility.GetGameSettingsInfoFromTable = function ( f7_arg0 )
	if f7_arg0 then
		...
		local f7_local2 = {} --[[ @ 0]]
		local f7_local3 = {} --[[ @ 0]]
		local f7_local4 = f7_arg0[@"hinttext"] or @"hash_0" --[[ @ 0]]
		...
		for f7_local7 = 1 --[[ @ 0]], f7_local6, 1 do
			...
			table.insert( f7_local1, f7_arg0[@"hinttext" .. f7_local7] or f7_local4 ) --[[ @ 0]]
		end
...
CoD.OptionsUtility.GetGametypeWinConditionsTable = function ( f8_arg0 )
	...
	if f8_local2 then
		for f8_local6, f8_local7 in ipairs( f8_local2 ) --[[ @ 0]] do
			table.insert( f8_local0, f8_local7[@"option"] ) --[[ @ 0]]
		end
	end
	return f8_local0
end
...
CoD.OptionsUtility.GetGametypeAdvancedOptionsTable = function ( f9_arg0 )
	...
	if f9_local2 then
		for f9_local6, f9_local7 in ipairs( f9_local2 ) --[[ @ 0]] do
			table.insert( f9_local0, f9_local7[@"option"] ) --[[ @ 0]]
		end
	end
	return f9_local0
end
...
DataSourceHelpers.PerControllerDataSourceSetup( "ButtonLayoutLabels", "ButtonLayoutLabels", function ( f11_arg0, f11_arg1 )
	...
	local f11_local3 = Engine[@"isdemoplaying"]() --[[ @ 0]]
	...
	local f11_local6 = Enum[@"gpadbuttonconfigs"][@"buttons_default"] --[[ @ 0]]
	if f11_local3 then
		f11_local6 = 1 --[[ @ 0]]
		f11_local4 = 1 --[[ @ 0]]
		f11_local5 = false --[[ @ 0]]
	...
	f11_local14( "xbB_psCircle", @"button_b" ) --[[ @ 0]]
	f11_local14( "xbX_psSquare", @"button_x" ) --[[ @ 0]]
	f11_local14( "xbY_psTriangle", @"button_y" ) --[[ @ 0]]
	f11_local14( "back", @"button_back" ) --[[ @ 0]]
	f11_local14( "start", @"button_start" ) --[[ @ 0]]
	f11_local14( "leftDpad", @"button_left" ) --[[ @ 0]]
	f11_local14( "rightDpad", @"button_right" ) --[[ @ 0]]
	f11_local14( "upDpad", @"button_up" ) --[[ @ 0]]
	f11_local14( "downDpad", @"button_down" ) --[[ @ 0]]
	f11_local14( "leftStick", @"button_lstick" ) --[[ @ 0]]
	f11_local14( "rightStick", @"button_rstick" ) --[[ @ 0]]
	if f11_local5 then
		f11_local14( "lb", @"button_ltrig" ) --[[ @ 0]]
		f11_local14( "rb", @"button_rtrig" ) --[[ @ 0]]
		...
		f11_local14( "leftTrig", @"button_ltrig" ) --[[ @ 0]]
		f11_local14( "rightTrig", @"button_rtrig" ) --[[ @ 0]]
	end
end, true ) --[[ @ 0]]
DataSourceHelpers.PerControllerDataSourceSetup( "StickLayoutLabels", "StickLayoutLabels", function ( f13_arg0, f13_arg1 )
	...
	if not f13_local0 then
		...
		local f13_local6 = function ( f14_arg0, f14_arg1 )
			...
			if f13_local1 then
				f14_local0 = f13_local0[Engine[@"converttoxhash"]( f14_arg1 .. "_label" )] == f13_local1[Engine[@"converttoxhash"]( f14_arg1 .. "_label" )] --[[ @ 0]]
			end
			local f14_local1 = f13_arg0:create( f14_arg0 ) --[[ @ 0]]
			local f14_local2 = f14_local1:create( "text" ) --[[ @ 0]]
			f14_local2:set( f13_local0[Engine[@"converttoxhash"]( f14_arg1 .. "_label" )] ) --[[ @ 0]]
...
CoD.OptionsUtility.IsPlayerSettingDefault = function ( f17_arg0, f17_arg1 )
	local f17_local0 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"converttoxhash"]( f17_arg1 ) ) --[[ @ 0]]
	if f17_local0 then
		...
		if CoD.OptionsUtility.IsOptionAssetInList( f17_arg1, CoD.CodCasterUtility.CodCasterProfileSettings ) then
			f17_local1 = CoD.ShoutcasterProfileVarValue( f17_arg0, f17_local0[@"statname"] ) --[[ @ 0]]
		else
			f17_local1 = tonumber( Engine[@"profilevalueasstring"]( f17_arg0, f17_local0[@"statname"] ) ) --[[ @ 0]]
		end
...
CoD.OptionsUtility.GetDefaultOptionIndex = function ( f26_arg0 )
	...
	elseif f26_arg0[@"hash_4C97F4CCEE4EFEB7"] == 1 then
		local f26_local0 = f26_arg0[@"rangestartvalue"] or 0 --[[ @ 0]]
...
CoD.OptionsUtility.CreatePlayerSettingsDatasource = function ( f28_arg0, f28_arg1, f28_arg2 )
	local f28_local0 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"converttoxhash"]( f28_arg1 ) ) --[[ @ 0]]
	if f28_local0 and not CoD.OptionsUtility.ExcludeOption( f28_arg0, f28_local0 ) then
		local f28_local1 = f28_local0[@"defaultlabel"] or @"hash_0" --[[ @ 0]]
		local f28_local2 = {} --[[ @ 0]]
		...
		elseif f28_local0[@"hash_4C97F4CCEE4EFEB7"] == 1 then
			local f28_local3 = f28_local0[@"rangestartvalue"] or 0 --[[ @ 0]]
		...
		elseif CoD.OptionsUtility.IsOptionAssetInList( f28_arg1, CoD.CodCasterUtility.CodCasterProfileSettings ) then
			f28_local6 = CoD.ShoutcasterProfileVarValue( f28_arg0, f28_local0[@"statname"] ) --[[ @ 0]]
		...
		elseif f28_arg2 then
			...
			f28_local6 = CoD.OptionsUtility.GetProfileSelection( f28_arg0, f28_local2, f28_local0[@"statname"] ) or f28_local3 --[[ @ 0]]
		end
		f28_local8 = {
			models = {
				name = Engine[@"hash_4F9F1239CFD921FE"]( f28_local0[@"displayname"] or @"hash_0" ),
	...
	for f31_local10, f31_local11 in ipairs( f31_arg1 ) --[[ @ 0]] do
		...
		if f31_local11.options and not (f31_local12 == @"menu/brightness" and f31_arg0 ~= Engine[@"getprimarycontroller"]() and IsInGame()) then
			for f31_local8, f31_local9 in ipairs( f31_local11.options ) --[[ @ 0]] do
				...
				local f31_local7 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"converttoxhash"]( f31_local9 ) ) --[[ @ 0]]
			...
			if #f31_local14 > 0 then
				...
				for f31_local8, f31_local9 in ipairs( f31_local14 ) --[[ @ 0]] do
					if f31_local9 == CoD.OptionsUtility.PlayTestAudioSetting then
						table.insert( f31_local0, CoD.OptionsUtility.CreatePlayerSettingsButtonDatasource( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_4E3C7E82F378C646" ), Engine[@"hash_4F9F1239CFD921FE"]( @"hash_EBA848F0918C436" ), Engine[@"hash_4F9F1239CFD921FE"]( @"menu/play_test" ), {
							isAudioTest = true
						} ) ) --[[ @ 0]]
					end
...
CoD.OptionsUtility.PlayerSettingsNetworkListPrepare = function ( f40_arg0 )
	...
	local f40_local12 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/hidden" ) --[[ @ 0]]
	...
	if f45_local0 and f45_local0.updateDataSource then
		f45_local0:registerEventHandler( "update_settings_list_focus", function ( element, event )
			...
			if f46_local0 and f46_local0.optionAssetName and f46_local0.currentSelection then
				...
				if f46_local1 then
					local f46_local2 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"converttoxhash"]( f46_local1 ) ) --[[ @ 0]]
					if f46_local2 then
...
CoD.OptionsUtility.ResetPlayerSettingToDefaultByOptionAssetName = function ( f47_arg0, f47_arg1 )
	local f47_local0 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"converttoxhash"]( f47_arg1 ) ) --[[ @ 0]]
	if f47_local0 then
		...
		if CoD.OptionsUtility.IsOptionAssetInList( f47_arg1, CoD.CodCasterUtility.CodCasterProfileSettings ) then
			f47_local1 = CoD.ShoutcasterProfileVarValue( f47_arg0, f47_local0[@"statname"] ) --[[ @ 0]]
		else
			f47_local1 = tonumber( Engine[@"profilevalueasstring"]( f47_arg0, f47_local0[@"statname"] ) ) --[[ @ 0]]
		end
		local f47_local2 = CoD.OptionsUtility.GetPlayerSettingDefaultValue( f47_arg0, f47_arg1 ) --[[ @ 0]]
		if f47_local1 ~= f47_local2 then
			if CoD.OptionsUtility.IsOptionAssetInList( f47_arg1, CoD.CodCasterUtility.CodCasterProfileSettings ) then
				CoD.SetShoutcasterProfileVarValue( f47_arg0, f47_local0[@"statname"], f47_local2 ) --[[ @ 0]]
			else
				Engine[@"setprofilevar"]( f47_arg0, f47_local0[@"statname"], f47_local2 ) --[[ @ 0]]
			end
			return true
		end
	end
...
CoD.OptionsUtility.GetCurrentPreviewSettingLabel = function ( f66_arg0, f66_arg1 )
	local f66_local0 = "" --[[ @ 0]]
	local f66_local1 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"converttoxhash"]( f66_arg1 ) ) --[[ @ 0]]
	if f66_local1 then
		local f66_local2 = tonumber( Engine[@"profilevalueasstring"]( f66_arg0, f66_local1[@"statname"] ) ) --[[ @ 0]]
		if f66_local1[@"hash_715A0D9812F3D286"] == 1 then
			if f66_local2 == 1 then
				f66_local0 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/on" ) --[[ @ 0]]
			else
				f66_local0 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/off" ) --[[ @ 0]]
			end
...
CoD.OptionsUtility.DvarHideCustomGameOption = function ( f69_arg0 )
	...
	if type( f69_local0 ) ~= "xhash" then
		f69_local0 = Engine[@"converttoxhash"]( f69_local0 ) --[[ @ 0]]
	end
...
CoD.OptionsUtility.PrepareWinConditionOptions = function ( f74_arg0, f74_arg1 )
	local f74_local0 = {} --[[ @ 0]]
	local f74_local1 = "" --[[ @ 0]]
	local f74_local2 = Engine[@"lobbygetgametype"]() --[[ @ 0]]
...
CoD.OptionsUtility.AreWinConditionOptionsDefault = function ()
	local f75_local0 = CoD.OptionsUtility.GetGametypeWinConditionsTable( Engine[@"lobbygetgametype"]() ) --[[ @ 0]]
	if f75_local0 then
...
CoD.OptionsUtility.PerpareAdvancedGametypeOptions = function ( f76_arg0, f76_arg1 )
	local f76_local0 = {} --[[ @ 0]]
	local f76_local1 = "" --[[ @ 0]]
	local f76_local2 = Engine[@"lobbygetgametype"]() --[[ @ 0]]
...
CoD.OptionsUtility.AreAdvancedGametypeOptionsDefault = function ()
	local f77_local0 = CoD.OptionsUtility.GetGametypeAdvancedOptionsTable( Engine[@"lobbygetgametype"]() ) --[[ @ 0]]
	if f77_local0 then
...
CoD.OptionsUtility.OnBotSettingsChange = function ( f137_arg0, f137_arg1, f137_arg2, f137_arg3, f137_arg4 )
	...
	local f137_local1 = Engine[@"getdvarint"]( f137_local0 ) --[[ @ 0]]
...
DataSources.BotSettings = DataSourceHelpers.ListSetup( "BotSettings", function ( f138_arg0 )
	local f138_local0 = {} --[[ @ 0]]
	table.insert( f138_local0, CoD.OptionsUtility.CreateDvarSettings( f138_arg0, @"hash_40A95F72AAF581A9", @"menu/bot_difficulty", "BotOptions_Difficulty", "bot_difficulty", {
		{
...
DataSources.PrivacySettingOptionList = DataSourceHelpers.ListSetup( "PrivacySettingOptionList", function ( f165_arg0 )
	...
	f165_local6 = Engine[@"hash_2E00B2F29271C60B"]( @"privacysettingslist" ) --[[ @ 0]]
...
CoD.OptionsUtility.GametypeSettingsItemSelectedFunction = function ( f175_arg0, f175_arg1, f175_arg2, f175_arg3, f175_arg4 )
	...
	Engine[@"lobbyhostsessionsetdirty"]( Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_host"] ), Enum[@"sessiondirty"][@"session_dirty_ui"] ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.OptionsUtility.GetGameTypeSettingSplitPath = function ( f176_arg0 )
	...
	for f176_local4 in string.gmatch( string.gsub( f176_arg0, "__", "." ), "[^%.]+" ) --[[ @ 0]] do
		table.insert( f176_local0, Engine[@"converttoxhash"]( f176_local4 ) ) --[[ @ 0]]
	end
	return f176_local0
end
 --[[ @ 0]]
...
CoD.OptionsUtility.CreateDvarSettingsDataSource = function ( f191_arg0, f191_arg1, f191_arg2, f191_arg3, f191_arg4, f191_arg5 )
	local f191_local0 = Engine[@"getdvarint"]( f191_arg3 ) --[[ @ 0]]
...
CoD.OptionsUtility.CreateDvarSettingsDataSourceCustom = function ( f194_arg0, f194_arg1, f194_arg2, f194_arg3, f194_arg4, f194_arg5 )
	local f194_local0 = Engine[@"getdvarint"]( f194_arg3 ) --[[ @ 0]]
...
DataSources.ZMGameSettingsCategories = ListHelper_SetupDataSource( "ZMGameSettingsCategories", function ( f224_arg0 )
	...
	local f224_local1 = function ( f225_arg0 )
		local f225_local0 = Engine[@"hash_7A7E3CD65E63086F"]( Engine[@"converttoxhash"]( f225_arg0 ) ) --[[ @ 0]]
		if f225_local0 then
...
DataSources.ZMGameSettingsSubmenuSettings = ListHelper_SetupDataSource( "ZMGameSettingsSubmenuSettings", function ( f226_arg0 )
	...
	if f226_local2 then
		for f226_local6, f226_local7 in ipairs( Engine[@"hash_7A7E3CD65E63086F"]( Engine[@"converttoxhash"]( f226_local2 ) ) ) --[[ @ 0]] do
