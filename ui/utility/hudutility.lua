...
CoD.HUDUtility.ObjectiveHasAnyTextFlagOverrides = function ( f3_arg0 )
	for f3_local0 = 1 --[[ @ 0]], CoD.HUDUtility.MaxObjectiveFlagOverrides, 1 do
		local f3_local3 = @"textflag" .. f3_local0 --[[ @ 0]]
...
CoD.HUDUtility.ObjectiveUpdated = function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3, f7_arg4, f7_arg5, f7_arg6 )
	...
	if f7_local11 then
		f7_local3 = f7_arg2[@"textneutral"] or f7_local3 --[[ @ 0]]
		f7_local0 = f7_arg2[@"iconneutral"] or f7_local0 --[[ @ 0]]
	...
	if CoD.HUDUtility.ObjectiveHasAnyTextFlagOverrides( f7_arg2 ) then
		f7_local14 = @"textflag" .. f7_local13 --[[ @ 0]]
		...
		if not f8_local1 then
			...
			local f8_local3 = function ( f10_arg0, f10_arg1 )
				...
				local f10_local6 = function ( f13_arg0 )
				 ...
				 --[[ @ 0]]
				f10_local6 = f10_local6( f10_local1[@"widget"] ) --[[ @ 0]]
				...
				if (f10_local2( f10_local5 ) or f10_local3( f10_local5 )) and f10_local6 then
					...
					if f10_local9 ~= nil and f10_local9.objectiveWidget ~= f10_local1[@"widget"] then
						f10_local8:set( Enum[@"objectivestate_t"][@"objst_done"] ) --[[ @ 0]]
						f10_local9 = nil --[[ @ 0]]
					end
					if f10_local9 == nil then
						Engine[@"beginpixevent"]( "Create Waypoint" ) --[[ @ 0]]
						f10_local9 = f10_local6.new( f8_arg1, f10_arg0, 0, 0, 0, f10_local6.__defaultWidth, 0, 0, 0, f10_local6.__defaultHeight ) --[[ @ 0]]
						f10_local9.objectiveWidget = f10_local1[@"widget"] --[[ @ 0]]
			...
			Engine[@"forceobjectiverefresh"]( f8_arg2 ) --[[ @ 0]]
		end
	end
	f8_local1 = nil --[[ @ 0]]
end
...
CoD.HUDUtility.UpdateBallModels = function ( f30_arg0, f30_arg1 )
	...
	if CoD.IsShoutcaster( f30_arg0 ) then
		Engine[@"setmodelvalue"]( Engine[@"createmodel"]( f30_local1, "ballHeldByFriendly" ), f30_local0 == Enum[@"team_t"][@"team_allies"] ) --[[ @ 0]]
		Engine[@"setmodelvalue"]( Engine[@"createmodel"]( f30_local1, "ballHeldByEnemy" ), f30_local0 == Enum[@"team_t"][@"team_axis"] ) --[[ @ 0]]
	else
...
CoD.HUDUtility.SetupWaypoint = function ( f33_arg0, f33_arg1, f33_arg2 )
	if f33_arg2 then
		...
		local f33_local5 = Enum[@"objecticontype"][@"objectiveicon_map"] --[[ @ 0]]
...
CoD.HUDUtility.Get3DWeaponHintPickupHintText = function ( f44_arg0, f44_arg1 )
	...
	if IsWarzone() then
		...
		if CoD.BitUtility.IsBitSet( f44_local1, CoD.HUDUtility.Weapon3DHintStateFlags.INVENTORY_FULL ) then
			f44_local0 = @"warzone/inventory_full" --[[ @ 0]]
...
CoD.HUDUtility.Get3DWeaponHintPickupHintTextWithPickUpOptions = function ( f45_arg0, f45_arg1 )
	...
	if IsWarzone() then
		...
		if CoD.BitUtility.IsBitSet( f45_local2, CoD.HUDUtility.Weapon3DHintStateFlags.INVENTORY_FULL ) then
			f45_local0 = @"warzone/inventory_full" --[[ @ 0]]
		...
		elseif CoD.BitUtility.IsBitSet( f45_local2, CoD.HUDUtility.Weapon3DHintStateFlags.AMMO_FULL ) then
			f45_local0 = @"warzone/ammo_full" --[[ @ 0]]
	...
	if IsWarzone() then
		local f48_local0 = function ()
			...
			elseif CoD.BitUtility.IsBitSet( f49_local1, CoD.HUDUtility.Weapon3DHintStateFlags.INVENTORY_FULL ) then
				f49_local0 = @"warzone/inventory_full" --[[ @ 0]]
			...
			elseif CoD.BitUtility.IsBitSet( f49_local1, CoD.HUDUtility.Weapon3DHintStateFlags.AMMO_FULL ) then
				f49_local0 = @"warzone/ammo_full" --[[ @ 0]]
			else
				f49_local0 = @"hash_0" --[[ @ 0]]
			end
...
CoD.HUDUtility.WaypointSetCompassObjectiveIcon = function ( f53_arg0, f53_arg1, f53_arg2, f53_arg3, f53_arg4, f53_arg5 )
	if f53_arg3 or f53_arg4 then
		if f53_arg5 then
			if f53_arg3 then
				Engine[@"setobjectiveicon"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_map"], f53_arg3, f53_arg5.r, f53_arg5.g, f53_arg5.b ) --[[ @ 0]]
				Engine[@"setobjectiveicon"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"], f53_arg3, f53_arg5.r, f53_arg5.g, f53_arg5.b ) --[[ @ 0]]
			end
			if f53_arg4 then
				Engine[@"hash_3DADAACD4057DBDB"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_map"], f53_arg4, f53_arg5.r, f53_arg5.g, f53_arg5.b ) --[[ @ 0]]
				Engine[@"hash_3DADAACD4057DBDB"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"], f53_arg4, f53_arg5.r, f53_arg5.g, f53_arg5.b ) --[[ @ 0]]
			end
		else
			if f53_arg3 then
				Engine[@"setobjectiveicon"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_map"], f53_arg3 ) --[[ @ 0]]
				Engine[@"setobjectiveicon"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"], f53_arg3 ) --[[ @ 0]]
			end
			if f53_arg4 then
				Engine[@"hash_3DADAACD4057DBDB"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_map"], f53_arg4 ) --[[ @ 0]]
				Engine[@"hash_3DADAACD4057DBDB"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"], f53_arg4 ) --[[ @ 0]]
			end
		end
		Engine[@"setobjectiverotatewithentity"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_map"], f53_arg0.objective[@"hash_68172B233C10D79B"] == 1 ) --[[ @ 0]]
		Engine[@"setobjectiverotatewithentity"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"], f53_arg0.objective[@"hash_68172B233C10D79B"] == 1 ) --[[ @ 0]]
		Engine[@"setobjectiveiconpulse"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_map"], f53_arg0.objective[@"pulse"] == 1 ) --[[ @ 0]]
		local f53_local0 = f53_arg0.objective[@"hash_65141E79748AB619"] == 1 --[[ @ 0]]
		Engine[@"hash_1D40DC95325722DF"]( f53_arg1, f53_arg0.objId, Enum[@"objecticontype"][@"objectiveicon_map"], f53_local0 ) --[[ @ 0]]
		Engine[@"hash_1D40DC95325722DF"]( f53_arg1, f53_arg0.objId, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"], f53_local0 ) --[[ @ 0]]
	else
		Engine[@"clearobjectiveicon"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_map"] ) --[[ @ 0]]
		Engine[@"clearobjectiveicon"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"] ) --[[ @ 0]]
		Engine[@"hash_8275F3C972C0D3A"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_map"] ) --[[ @ 0]]
		Engine[@"hash_8275F3C972C0D3A"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"] ) --[[ @ 0]]
		Engine[@"setobjectiveiconpulse"]( f53_arg1, f53_arg2, Enum[@"objecticontype"][@"objectiveicon_map"], false ) --[[ @ 0]]
		Engine[@"hash_1D40DC95325722DF"]( f53_arg1, f53_arg0.objId, Enum[@"objecticontype"][@"objectiveicon_map"], false ) --[[ @ 0]]
		Engine[@"hash_1D40DC95325722DF"]( f53_arg1, f53_arg0.objId, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"], false ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.HUDUtility.WaypointClearCompassObjectiveIcon = function ( f54_arg0, f54_arg1, f54_arg2 )
	Engine[@"clearobjectiveicon"]( f54_arg1, f54_arg2, Enum[@"objecticontype"][@"objectiveicon_map"] ) --[[ @ 0]]
	Engine[@"clearobjectiveicon"]( f54_arg1, f54_arg2, Enum[@"objecticontype"][@"objectiveicon_shoutcaster_map"] ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.HUDUtility.WaypointUpdate_Ball_Ball = function ( f59_arg0, f59_arg1 )
	...
	if CoD.IsShoutcaster( f59_arg1 ) then
		Engine[@"setmodelvalue"]( Engine[@"createmodel"]( f59_local2, "ballHeldByFriendly" ), f59_local1 == Enum[@"team_t"][@"team_allies"] ) --[[ @ 0]]
		Engine[@"setmodelvalue"]( Engine[@"createmodel"]( f59_local2, "ballHeldByEnemy" ), f59_local1 == Enum[@"team_t"][@"team_axis"] ) --[[ @ 0]]
	else
...
CoD.HUDUtility.WaypointUpdate_Hardpoint = function ( f64_arg0, f64_arg1 )
	...
	if f64_local2 then
		...
		f64_local4:set( CoD.TeamUtility.GetTeamFactionColor( Enum[@"team_t"][@"team_allies"] ) ) --[[ @ 0]]
		f64_local4 = f64_local0:create( "HUDItems.codcaster.ObjectiveB.color" ) --[[ @ 0]]
		f64_local4:set( CoD.TeamUtility.GetTeamFactionColor( Enum[@"team_t"][@"team_axis"] ) ) --[[ @ 0]]
	else
		f64_local4 = f64_local0:create( "HUDItems.codcaster.ObjectiveA.color" ) --[[ @ 0]]
...
CoD.HUDUtility.WaypointUpdateIconAndText = function ( f78_arg0, f78_arg1, f78_arg2 )
	local f78_local0 = f78_arg0.objective[@"minimapimage"] --[[ @ 0]]
	if f78_arg2 ~= 0 then
...
CoD.HUDUtility.WaypointUpdateSnapToCenter = function ( f80_arg0, f80_arg1, f80_arg2, f80_arg3 )
	...
	elseif f80_local0 == true then
		local f80_local1 = f80_arg0.objective[@"snapoffsetx"] or 0 --[[ @ 0]]
		local f80_local2 = f80_arg0.objective[@"snapoffsety"] or 0 --[[ @ 0]]
...
CoD.HUDUtility.WaypointUpdate = function ( f83_arg0, f83_arg1 )
	...
	if f83_local1 and f83_local2 then
		...
		local f83_local8 = function ( f84_arg0 )
			...
			f84_arg0:beginAnimation( f83_local7, Enum[@"luitween"][@"luitween_linear"] ) --[[ @ 0]]
	...
	f83_arg0:setEntityContainerScale( f83_arg0.objective[@"scale3d"] == 1 ) --[[ @ 0]]
...
CoD.HUDUtility.GetFriendlyOrEnemyColorByObjIdInternal = function ( f90_arg0, f90_arg1, f90_arg2, f90_arg3 )
	...
	local f90_local2 = CoD.perController[f90_arg0].objMeterPrevTeams and CoD.perController[f90_arg0].objMeterPrevTeams[f90_arg1] or Enum[@"team_t"][@"team_neutral"] --[[ @ 0]]
	local f90_local3 = Enum[@"team_t"][@"team_neutral"] --[[ @ 0]]
	...
	if f90_local0 == Enum[@"team_t"][@"team_neutral"] then
		...
		elseif f90_local8 then
			f90_local3 = Enum[@"team_t"][@"team_allies"] --[[ @ 0]]
		elseif f90_local9 then
			f90_local3 = Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
		else
			f90_local3 = f90_local2 --[[ @ 0]]
		end
		...
		if CoD.IsShoutcaster( f90_arg0 ) then
			...
			if f90_local1 == Enum[@"team_t"][@"team_axis"] then
				if f90_local3 == Enum[@"team_t"][@"team_axis"] then
					local f90_local10 = Enum[@"team_t"][@"team_allies"] --[[ @ 0]]
				end
				f90_local8 = f90_local10 or Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
			end
...
CoD.HUDUtility.VisibleIfInDemoPlayback = function ()
	...
	if Engine[@"isdemoplaying"]() then
		f98_local0 = CoD.ModelUtility.IsGlobalModelValueEqualToEnum( "demo.cameraMode", Enum[@"democameramode"][@"demo_camera_mode_none"] ) --[[ @ 0]]
	else
		f98_local0 = true --[[ @ 0]]
	end
	return f98_local0
	...
	if f103_local0 then
		...
		if f103_local1 then
			for f103_local2 = 0 --[[ @ 0]], LuaDefine.MAX_CLIENTS - 1, 1 do
				local f103_local5 = Engine[@"getmodelforclient"]( f103_local2 ) --[[ @ 0]]
		...
		if f103_local2 then
			...
			repeat
				...
				f103_local6:set( Enum[@"team_t"][@"team_free"] ) --[[ @ 0]]
	...
	if f104_local0 then
		...
		if f104_local1 then
			...
			elseif CoD.isPublicOnlineGame() then
				local f104_local4 = Engine[@"getplaylistinfobyid"]( Engine[@"getplaylistid"]() ) --[[ @ 0]]
				f104_local3 = f104_local4.maxPlayers / 2 --[[ @ 0]]
			else
				f104_local3 = Engine[@"getlobbymaxclients"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
			end
...
CoD.HUDUtility.GetPlayerNameColorByClientNum = function ( f116_arg0, f116_arg1 )
	if IsZombies() then
		local f116_local0 = Enum[@"colorvisiondeficiencies"][@"cvd_off"] --[[ @ 0]]
		...
		if f116_local1 ~= nil and f116_local1[@"colorblindmode"] ~= nil then
			f116_local0 = f116_local1[@"colorblindmode"]:get() --[[ @ 0]]
		end
		if f116_local0 == Enum[@"colorvisiondeficiencies"][@"cvd_off"] then
			local f116_local2 = nil --[[ @ 0]]
			if f116_arg1 == 0 then
				local f116_local3 = {} --[[ @ 0]]
				f116_local2 = Dvar[@"cg_scorescolor_gamertag_0"]:get() --[[ @ 0]]
			elseif f116_arg1 == 1 then
				local f116_local3 = {} --[[ @ 0]]
				f116_local2 = Dvar[@"cg_scorescolor_gamertag_1"]:get() --[[ @ 0]]
			elseif f116_arg1 == 2 then
				local f116_local3 = {} --[[ @ 0]]
				f116_local2 = Dvar[@"cg_scorescolor_gamertag_2"]:get() --[[ @ 0]]
			elseif f116_arg1 == 3 then
				local f116_local3 = {} --[[ @ 0]]
				f116_local2 = Dvar[@"cg_scorescolor_gamertag_3"]:get() --[[ @ 0]]
			end
...
CoD.HUDUtility.GetPlayerHealthBarColorByClientNum = function ( f117_arg0, f117_arg1 )
	if IsZombies() then
		local f117_local0 = Enum[@"colorvisiondeficiencies"][@"cvd_off"] --[[ @ 0]]
		...
		if f117_local1 ~= nil and f117_local1[@"colorblindmode"] ~= nil then
			f117_local0 = f117_local1[@"colorblindmode"]:get() --[[ @ 0]]
		end
		if f117_local0 == Enum[@"colorvisiondeficiencies"][@"cvd_off"] then
			local f117_local2 = nil --[[ @ 0]]
			if f117_arg1 == 0 then
				local f117_local3 = {} --[[ @ 0]]
				f117_local2 = Dvar[@"cg_scorescolor_gamertag_0"]:get() --[[ @ 0]]
			elseif f117_arg1 == 1 then
				local f117_local3 = {} --[[ @ 0]]
				f117_local2 = Dvar[@"cg_scorescolor_gamertag_1"]:get() --[[ @ 0]]
			elseif f117_arg1 == 2 then
				local f117_local3 = {} --[[ @ 0]]
				f117_local2 = Dvar[@"cg_scorescolor_gamertag_2"]:get() --[[ @ 0]]
			elseif f117_arg1 == 3 then
				local f117_local3 = {} --[[ @ 0]]
				f117_local2 = Dvar[@"cg_scorescolor_gamertag_3"]:get() --[[ @ 0]]
			end
...
CoD.HUDUtility.GetModIconforClient = function ( f125_arg0, f125_arg1 )
	...
	if f125_arg1 == Enum[@"meansofdeath_t"][@"mod_head_shot"] then
		...
		f125_local0 = CoD.HUDUtility.GetModIcon( Enum[@"meansofdeath_t"][@"mod_unknown"], @"hash_78DAF2B58F8C7979" ) --[[ @ 0]]
	end
...
CoD.HUDUtility.GetModIcon = function ( f126_arg0, f126_arg1 )
	...
	if f126_local1 then
		f126_local0 = f126_local1[@"icon"] --[[ @ 0]]
	end
	return f126_local0
end
 --[[ @ 0]]
...
CoD.HUDUtility.GetMeansOfDeathTable = function ()
	if not CoD.HUDUtility.MeansOfDeathTable then
		local f128_local0 = {} --[[ @ 0]]
		local f128_local1 = Engine[@"hash_7A7E3CD65E63086F"]( @"meansofdeathlist" ) --[[ @ 0]]
		if f128_local1 then
			for f128_local5, f128_local6 in ipairs( f128_local1 ) --[[ @ 0]] do
				f128_local0[Enum[@"meansofdeath_t"][Engine[@"converttoxhash"]( f128_local6[@"mod"] )]] = f128_local6 --[[ @ 0]]
			end
		end
...
CoD.HUDUtility.InitLoadingMovie = function ( f130_arg0 )
	...
	elseif CoD.isZombie then
		...
		if Engine[@"getlobbymode"]( Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_client"] ) ) == Enum[@"lobbymode"][@"hash_3B3A1BBF18C0B176"] or IsSimulateCT() then
			...
			f130_local2, f130_local6 = CoD.CTUtility.GetLoadingMovie( f130_arg0, f130_local8, Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
...
CoD.HUDUtility.StartPlay = function ( f133_arg0, f133_arg1 )
	...
	if Engine[@"islobbyhost"]( Enum[@"lobbytype"][@"lobby_type_game"] ) then
		Engine[@"setloadingmovieskippedstate"]( true ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.HUDUtility.GetDidYouKnowString = function ( f134_arg0 )
	...
	local f134_local2 = {} --[[ @ 0]]
	if CoD.isPC then
		table.insert( f134_local2, @"pc_gamepad" ) --[[ @ 0]]
	end
	...
	elseif CoD.isWarzone then
		table.insert( f134_local2, @"warzone" ) --[[ @ 0]]
		if Engine[@"getcurrentmap"]() == "wz_escape" then
			table.insert( f134_local2, @"warzoneescape" ) --[[ @ 0]]
		else
			table.insert( f134_local2, @"warzoneopenskyscrapers" ) --[[ @ 0]]
		end
		if CoD.HUDUtility.IsGameTypeEqualToString( "warzone_hot_pursuit" ) then
			table.insert( f134_local2, @"warzonehotpursuit" ) --[[ @ 0]]
		elseif CoD.HUDUtility.IsGameTypeWzAmbush() then
			table.insert( f134_local2, @"warzoneambush" ) --[[ @ 0]]
		elseif CoD.HUDUtility.IsGameTypeWzSpectre() then
			table.insert( f134_local2, @"warzonespectrerising" ) --[[ @ 0]]
		elseif CoD.HUDUtility.IsGameTypeWzGroundWar() then
			table.insert( f134_local2, @"warzonegroundwar" ) --[[ @ 0]]
		end
	...
	return function ( f153_arg0, f153_arg1, f153_arg2, f153_arg3 )
		...
		if f152_arg0.__lastHealth and not f153_local3 then
			...
			if f153_local5 <= 0 then
				...
				f152_arg0.HealthBar.CleanseBar:beginAnimation( f153_local9, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
				...
				if f153_local4 then
					f152_arg0.__healthBarAnimDelay = LUI.UITimer.newElementTimer( f153_local9, true, function ()
						f152_arg0.HealthBar.HealthFill:beginAnimation( f153_local6 * f153_local8, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
						...
						if f152_arg0.HealthBar.LowHealthFill then
							f152_arg0.HealthBar.LowHealthFill:beginAnimation( f153_local6 * f153_local8, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
					...
					f152_arg0.HealthBar.HealthFill:beginAnimation( f153_local6, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
					if f152_arg0.HealthBar.LowHealthFill then
						f152_arg0.HealthBar.LowHealthFill:beginAnimation( f153_local6, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
					end
				end
	...
	return function ( f158_arg0 )
		...
		if not f158_local2 or f158_local2 == 0 or not f158_local1 then
			...
			if f158_local2 < f158_local1 then
				...
				f157_arg0.HealthBar.WoundBar:beginAnimation( Dvar[@"hash_26B4CD2F5C8ADDBC"]:get(), Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
			end
...
CoD.HUDUtility.UpdateClientHealth = function ( f161_arg0, f161_arg1 )
	f161_arg0:linkToElementModel( f161_arg0, "clientNum", true, function ( model )
		...
		local f162_local5 = Engine[@"getmodelforclient"]( f162_local0 ) --[[ @ 0]]
		f162_local5 = f162_local5:create( "health.healthValue" ) --[[ @ 0]]
		local f162_local6 = Engine[@"getmodelforclient"]( f162_local0 ) --[[ @ 0]]
		f162_local6 = f162_local6:create( "health.maxHealth" ) --[[ @ 0]]
		local f162_local7 = Engine[@"getmodelforclient"]( f162_local0 ) --[[ @ 0]]
		f162_local7 = f162_local7:create( "health.maxHealthRegen" ) --[[ @ 0]]
		local f162_local8 = Engine[@"getmodelforclient"]( f162_local0 ) --[[ @ 0]]
		f162_local8 = f162_local8:create( "characterIndex" ) --[[ @ 0]]
		local f162_local9 = Engine[@"getmodelforclient"]( f162_local0 ) --[[ @ 0]]
...
CoD.HUDUtility.InitHealthBoostNotification = function ( f176_arg0, f176_arg1, f176_arg2, f176_arg3, f176_arg4 )
	...
	f176_arg0:linkToElementModel( f176_arg0, "clientNum", true, function ( model )
		...
		local f177_local1 = Engine[@"getmodelforclient"]( f177_local0 ) --[[ @ 0]]
		f177_local1 = f177_local1:create( "health.maxHealth" ) --[[ @ 0]]
		local f177_local2 = Engine[@"getmodelforclient"]( f177_local0 ) --[[ @ 0]]
...
CoD.HUDUtility.SetupCharacterPortrait = function ( f182_arg0, f182_arg1 )
	f182_arg0:linkToElementModel( f182_arg0, "clientNum", true, function ( model )
		...
		if f183_local0 < 0 or f183_local0 >= LuaDefine.MAX_CLIENTS then
			...
			f182_arg0:setModel( Engine[@"getmodelforclient"]( f183_local0 ), f182_arg1 ) --[[ @ 0]]
		end
	end ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.HUDUtility.GetRoundPipsDatasourceTable = function ( f215_arg0, f215_arg1 )
	...
	local f215_local2 = Enum[@"team_t"][@"team_neutral"] --[[ @ 0]]
...
DataSources.PlayerTeamRoundPips = DataSourceHelpers.ListSetup( "PlayerTeamRoundPips", function ( f221_arg0 )
	local f221_local0 = Enum[@"team_t"][@"team_allies"] --[[ @ 0]]
...
DataSources.EnemyTeamRoundPips = DataSourceHelpers.ListSetup( "EnemyTeamRoundPips", function ( f222_arg0 )
	local f222_local0 = Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
	if not IsCodCaster( f222_arg0 ) then
		...
		if f222_local0 == f222_local1.actualTeam:get() then
			f222_local0 = Enum[@"team_t"][@"team_allies"] --[[ @ 0]]
		end
	end
...
CoD.HUDUtility.IsWZCustomGame = function ( f234_arg0 )
	...
	if Engine[@"currentsessionmode"]() == Enum[@"emodes"][@"mode_warzone"] then
		f234_local0 = Engine[@"gamemodeismode"]( Enum[@"egamemodes"][@"mode_game_matchmaking_manual"] ) --[[ @ 0]]
	else
		f234_local0 = false --[[ @ 0]]
	end
	return f234_local0
...
DataSources.EnemyTeamLastLivesData = {
	...
	prepare = function ( f254_arg0, f254_arg1, f254_arg2 )
		...
		local f254_local1 = Enum[@"team_t"][@"team_allies"] --[[ @ 0]]
		if f254_local1 == f254_local0 then
			f254_local1 = Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
		end
...
CoD.HUDUtility.InitWeaponPowerDrainBar = function ( f287_arg0, f287_arg1, f287_arg2, f287_arg3, f287_arg4 )
	...
	f287_arg1:linkToElementModel( f287_arg0, "powerRatio", true, function ( model )
		...
		elseif not f287_arg1.__endClipPlayed then
			f287_arg1:beginAnimation( f287_arg3, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
...
CoD.HUDUtility.TransformWorldPosToCompassRelativePosition = function ( f303_arg0, f303_arg1, f303_arg2 )
	local f303_local0, f303_local1, f303_local2, f303_local3 = Engine[@"getcompasscorners"]( f303_arg0 ) --[[ @ 0]]
	local f303_local4, f303_local5 = Engine[@"getcompassnorth"]( f303_arg0 ) --[[ @ 0]]
...
CoD.HUDUtility.TransformCompassRelativePositionToWorldPos = function ( f304_arg0, f304_arg1, f304_arg2 )
	local f304_local0, f304_local1, f304_local2, f304_local3 = Engine[@"getcompasscorners"]( f304_arg0 ) --[[ @ 0]]
	local f304_local4, f304_local5 = Engine[@"getcompassnorth"]( f304_arg0 ) --[[ @ 0]]
...
CoD.HUDUtility.OnDamageFeedbackSetState = function ( f310_arg0, f310_arg1, f310_arg2 )
	...
	elseif f310_arg0.moveToDefaultTimer then
		...
		f310_arg0.moveToDefaultTimer = LUI.UITimer.newElementTimer( 600, true, function ()
			...
			if f311_local0 then
				Engine[@"setmodelvalue"]( f311_local0, Enum[@"damagefeedbackstate"][@"damage_feedback_state_none"] ) --[[ @ 0]]
			end
		end ) --[[ @ 0]]
...
CoD.HUDUtility.PrematchCountdownPostLoad = function ( f314_arg0, f314_arg1 )
	...
	f314_arg0:subscribeToGlobalModel( f314_arg1, "PerController", "scriptNotify", function ( model )
		...
		if f318_local0 == @"show_gametype_objective_hint" then
			...
			local f318_local2 = Engine[@"getgametypeinfo"]( Engine[@"getcurrentgametype"]() ) --[[ @ 0]]
...
CoD.HUDUtility.PrematchCountdownMinimizePostLoad = function ( f324_arg0, f324_arg1 )
	...
	f324_arg0:subscribeToGlobalModel( f324_arg1, "PerController", "scriptNotify", function ( model )
		...
		elseif f327_local0 == @"show_gametype_objective_hint" then
			...
			local f327_local1 = Engine[@"getgametypeinfo"]( Engine[@"getcurrentgametype"]() ) --[[ @ 0]]
...
CoD.HUDUtility.UpdateConsequenceModels = function ( f350_arg0, f350_arg1, f350_arg2, f350_arg3 )
	...
	if f350_local0 then
		local f350_local1 = Engine[@"hash_7A7E3CD65E63086F"]( Engine[@"converttoxhash"]( f350_local0 ) ) --[[ @ 0]]
		if f350_local1 then
			...
			if f350_local2 then
				...
				if f350_local4 == Enum[@"team_t"][@"team_allies"] then
					f350_local3.message:set( f350_local2[@"alliesmessage"] or "" ) --[[ @ 0]]
					f350_local3.detail:set( f350_local2[@"alliesdetail"] or "" ) --[[ @ 0]]
					f350_local3.image:set( f350_local2[@"alliesimage"] or "" ) --[[ @ 0]]
					f350_local3.color:set( f350_local2[@"alliescolor"] or "" ) --[[ @ 0]]
				elseif f350_local4 == Enum[@"team_t"][@"team_axis"] then
					f350_local3.message:set( f350_local2[@"axismessage"] or "" ) --[[ @ 0]]
					f350_local3.detail:set( f350_local2[@"axisdetail"] or "" ) --[[ @ 0]]
					f350_local3.image:set( f350_local2[@"axisimage"] or "" ) --[[ @ 0]]
					f350_local3.color:set( f350_local2[@"axiscolor"] or "" ) --[[ @ 0]]
				end
			end
		end
	end
...
CoD.HUDUtility.IsArmorAtFullHealth = function ( f392_arg0 )
	local f392_local0 = Engine[@"getmodelforclient"]( Engine[@"getclientnum"]( f392_arg0 ) ) --[[ @ 0]]
	...
	prepare = function ( f399_arg0 )
		...
		DataSources.TeammateHealTargeting.subscriptions[f399_arg0]:subscribeToModel( f399_local0:create( "targetClientNum" ), function ( model )
			...
			if f400_local0 ~= LuaDefine.INVALID_CLIENT_INDEX then
				f399_local1:set( Engine[@"getmodelforclient"]( f400_local0 ) ) --[[ @ 0]]
			end
		end, false ) --[[ @ 0]]
	end,
...
CoD.HUDUtility.IsTeammateHealTargetAlreadyBoosted = function ( f407_arg0 )
	...
	if f407_local1 and f407_local1 ~= LuaDefine.INVALID_CLIENT_INDEX then
		local f407_local2 = Engine[@"getmodelforclient"]( f407_local1 ) --[[ @ 0]]
...
CoD.HUDUtility.AbilityFlashIsFull = function ( f408_arg0, f408_arg1 )
	...
	if not f408_local0 then
		f408_local0 = CoD.ModelUtility.IsSelfModelValueEqualToEitherValue( f408_arg0, f408_arg1, "state", Enum[@"weapongadgetstates"][@"hash_61CF78BFE5F942F1"], Enum[@"weapongadgetstates"][@"player_ability_state_ready"] ) --[[ @ 0]]
	end
	return f408_local0
end
 --[[ @ 0]]
...
DataSources.SpraysAndGestures = DataSourceHelpers.ListSetup( "SpraysAndGestures", function ( f427_arg0, f427_arg1 )
	...
	for f427_local7, f427_local8 in ipairs( Engine[@"hash_688987BA1B9D616B"]( f427_arg0, Engine[@"currentsessionmode"]() ) ) --[[ @ 0]] do
		if f427_local7 ~= 1 then
			...
			if f427_local6 then
				CoD.CACUtility.AddToTableIfNotEmpty( f427_local1, f427_local6[@"icon"] ) --[[ @ 0]]
...
DataSourceHelpers.PerControllerDataSourceSetup( "QuickSpray", "QuickSpray", function ( f429_arg0, f429_arg1 )
	...
	local f429_local5 --[[ @ 0]]
	if f429_local0 then
		f429_local5 = f429_local0[@"icon"] --[[ @ 0]]
...
CoD.HUDUtility.MenuDelayedSetRightStickLock = function ( f430_arg0, f430_arg1, f430_arg2, f430_arg3 )
	...
	if not f430_arg0._hasHidingRightStickUnlock then
		...
		LUI.OverrideFunction_CallOriginalFirst( f430_arg0, "close", function ()
			Engine[@"lockrightstick"]( f430_arg1, false ) --[[ @ 0]]
		end ) --[[ @ 0]]
	end
	if f430_arg2 == 0 then
		Engine[@"lockrightstick"]( f430_arg1, f430_arg3 ) --[[ @ 0]]
...
DataSources.CalloutWheel = DataSourceHelpers.ListSetup( "CalloutWheel", function ( f459_arg0, f459_arg1 )
	...
	local f459_local5 = Engine[@"converttoxhash"]( Engine[@"lobbygetgametype"]() ) --[[ @ 0]]
...
CoD.HUDUtility.AddCalloutWheelCallback = function ( f463_arg0, f463_arg1 )
	f463_arg1._onChooseWedge = function ( f464_arg0, f464_arg1, f464_arg2 )
		Engine[@"hash_346C794158F47657"]( f463_arg0, @"callout_items", @"selected", (f464_arg2.arrayIndex:get() or f464_arg0) + f464_arg2.addNumber:get() ) --[[ @ 0]]
	end
	 --[[ @ 0]]
end
 --[[ @ 0]]
	...
	if f465_local0 and f465_arg3 and f465_arg4 then
		...
		if not CoD.isPC then
			if IsCurrentLanguageReversed() then
				...
				f465_local6.text0color:set( Enum[@"cacheduicolors"][@"cached_ui_color_invalid"] ) --[[ @ 0]]
			else
				f465_local6.text0:set( f465_local2 ) --[[ @ 0]]
				f465_local6.text0color:set( f465_local1 ) --[[ @ 0]]
				f465_local6.text1:set( f465_local5 ) --[[ @ 0]]
				f465_local6.text1color:set( Enum[@"cacheduicolors"][@"cached_ui_color_invalid"] ) --[[ @ 0]]
				if f465_arg5 then
					f465_local6.text2:set( f465_local4 ) --[[ @ 0]]
					f465_local6.text2color:set( f465_local3 ) --[[ @ 0]]
				else
...
CoD.HUDUtility.HandleRestartPromptNotifies = function ( f472_arg0, f472_arg1, f472_arg2, f472_arg3 )
	...
	if not Engine[@"isshipbuild"]() then
		f472_local1 = Engine[@"lobbygetcontrollinglobbysession"]( Enum[@"lobbymodule"][@"lobby_module_client"] ) --[[ @ 0]]
	end
	local f472_local2 = Engine[@"islobbyhost"]( f472_local1 ) --[[ @ 0]]
...
CoD.HUDUtility[@"hash_3E213B828E44EBE4"] = function ( f481_arg0, f481_arg1, f481_arg2 )
	...
	local f481_local0 = function ( f482_arg0 )
		local f482_local0 = f482_arg0:get() & Enum[@"luibuttonflags"][@"flag_down"] --[[ @ 0]]
	...
	local f481_local1 = function ( f483_arg0 )
		local f483_local0 = f483_arg0:get() & Enum[@"luibuttonflags"][@"flag_down"] --[[ @ 0]]
	...
	local f481_local3 = f481_local2.ButtonBits[Enum[@"luibutton"][@"lui_key_xbx_pssquare"]] --[[ @ 0]]
	local f481_local4 = f481_local2.ButtonBits[Enum[@"luibutton"][@"lui_key_xbb_pscircle"]] --[[ @ 0]]
...
CoD.HUDUtility.ZMScrPostLoad = function ( f530_arg0, f530_arg1, f530_arg2 )
	...
	for f530_local5 = 0 --[[ @ 0]], f530_local0 - 1, 1 do
		...
		local f530_local11 = Engine[@"getmodelforclient"]( f530_local8 ) --[[ @ 0]]
