...
CoD.DirectorUtility.FocusFeaturedFiltered = Engine[@"CurrentSessionMode"]() == Enum[@"eModes"][@"hash_2B22E0240605CFFE"] --[[ @ 0]]
DataSources.DirectorFilters = DataSourceHelpers.ListSetup( "DirectorFilters", function ( f1_arg0, f1_arg1 )
	...
	if not CoD.DirectorUtility.FocusFeaturedFiltered then
		f1_local1 = Engine[@"hash_17B3B2B73B53EB34"]() --[[ @ 0]]
	else
		f1_local1 = false --[[ @ 0]]
	end
	...
	local f3_local0 = {
		{
			models = {
				...
				filter = Enum[@"LobbyMainMode"][@"hash_6D5FBB8D74AC6D62"]
			}
		}
	} --[[ @ 0]]
	for f3_local4, f3_local5 in ipairs( {
		Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"],
		Enum[@"LobbyMainMode"][@"hash_379D01499920B292"],
		Enum[@"LobbyMainMode"][@"hash_378C124999125C42"],
		Enum[@"LobbyMainMode"][@"hash_37B50049993542C0"]
	} ) --[[ @ 0]] do
...
CoD.DirectorUtility.CreateCardListDataSource = function ( f4_arg0, f4_arg1, f4_arg2, f4_arg3 )
	...
	if f4_arg3.cards then
		...
		local f4_local2 --[[ @ 0]]
		if not CoD.DirectorUtility.FocusFeaturedFiltered then
			f4_local2 = Engine[@"hash_17B3B2B73B53EB34"]() --[[ @ 0]]
		else
			f4_local2 = false --[[ @ 0]]
		end
		for f4_local10, f4_local11 in ipairs( f4_arg3.cards ) --[[ @ 0]] do
			if f4_local11.mode == nil or LuaUtils.GetDisplayNameForLobbyMainMode( f4_local11.mode ) ~= @"hash_0" then
				...
				if not CoD.DirectorUtility.RegionOnlyAllowsFeaturedPlaylistForMode( f4_arg1, f4_local11.mode ) or f4_local11.playlist == Engine[@"hash_17B3B2B73B53EB34"]() or f4_local11.lowPopPlaylist then
...
DataSources.DirectorTextModes = DataSourceHelpers.ListSetup( "DirectorTextModes", function ( f5_arg0, f5_arg1 )
	...
	if f5_arg1.menu:getSessionMode() == Enum[@"eModes"][@"hash_2B22E0240605CFFE"] then
		f5_arg1.menu:setSessionMode( Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] ) --[[ @ 0]]
	end
	return f5_local0
end, true ) --[[ @ 0]]
	...
	if f6_arg1.rank then
		...
		if LuaUtils.GameModeAvailable( f6_local2 ) then
			if IsArenaMode() then
				...
				if f6_local2 == Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] then
		...
		if not f6_local3 then
			...
			if f6_arg1.isMember and f6_arg1.isMember ~= 0 and 1 < f6_arg0 then
				...
				if not f6_local3 then
					...
					local f6_local7 = Enum[@"PresenceActivity"][@"hash_35BC71242ADF26CC"] --[[ @ 0]]
					...
					if 0 < Dvar[@"hash_868D54ACE3910EB"]:get() then
					...
					if IsArenaMode() and (f6_local3 == nil or f6_local3 == 0) and not CoD.ModelUtility.IsGlobalModelValueTrue( "lobbyRoot.lobbyLockedIn" ) and not CoD.LobbyUtility.MapVoteInState( LuaEnum.MAP_VOTE_STATE.RESULT ) then
						Engine[@"hash_2CEA0B24CB282661"]( Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"], f6_arg1.xuid ) --[[ @ 0]]
					end
				end
			end
			f6_local3 = 0 --[[ @ 0]]
...
CoD.DirectorUtility.DirectorPartyListEntryForXUID = function ( f7_arg0, f7_arg1, f7_arg2 )
	...
	f7_local1.info = f7_local2.LobbyClients:create( Engine[@"hash_75065E759595C457"]( f7_arg1 ) ) --[[ @ 0]]
...
DataSourceHelpers.GlobalDataSourceSetup( "DirectorLobbyPoseMembers", "lobbyRoot.lobbyPoseMembers", function ( f9_arg0, f9_arg1 )
	if not DataSources.DirectorLobbyPoseMembers.__callbackElement then
		...
		local f9_local1 = function ()
			local f10_local0 = Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] --[[ @ 0]]
			local f10_local1 = Engine[@"hash_3C3DF042E7492B66"]( f10_local0 ) --[[ @ 0]]
			local f10_local2 = Engine[@"hash_4755D55B3813D249"]( f10_local0, f10_local1 ) --[[ @ 0]]
			...
			for f10_local9, f10_local10 in ipairs( f10_local2.sessionClients ) --[[ @ 0]] do
				if f10_local1 ~= Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] or f10_local5 == f10_local10.team then
...
CoD.DirectorUtility.UpdateLobbyClientInfo = function ( f11_arg0, f11_arg1 )
	...
	if CoD.isWarzone then
		DataSources.DirectorPartyList.TeamCounts = {
			[Enum[@"team_t"][@"hash_42A34B055ADD98AB"]] = 0,
			[Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"]] = 0,
	...
	elseif CoDShared.IsGametypeTeamBased() then
		DataSources.DirectorPartyList.TeamCounts = {
			[Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"]] = 0,
			[Enum[@"team_t"][@"hash_42A34B055ADD98AB"]] = 0,
			[Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"]] = 0
		} --[[ @ 0]]
	else
		DataSources.DirectorPartyList.TeamCounts = {
			[Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"]] = 0,
			[Enum[@"team_t"][@"hash_697263B3C1ABADF7"]] = 0
		} --[[ @ 0]]
	end
	...
	local f11_local2 = Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] --[[ @ 0]]
	local f11_local3 = Engine[@"hash_7EFBAAD12776201D"]( f11_local2, Engine[@"hash_3C3DF042E7492B66"]( f11_local2 ), Engine[@"GetXUID64"]( Engine[@"GetPrimaryController"]() ) ) --[[ @ 0]]
	if f11_local3 == LuaDefine.INVALID_CLIENT_INDEX then
		f11_local3 = Engine[@"GetClientNum"]( Engine[@"GetPrimaryController"]() ) --[[ @ 0]]
	end
	local f11_local4 = {} --[[ @ 0]]
	local f11_local5 = Engine[@"hash_25A93802BE50A531"]( f11_local2, f11_local3 ) --[[ @ 0]]
	...
	f11_local6 = f11_local6.PartyPrivacy.privacy:get() == Enum[@"PartyPrivacy"][@"hash_78B288F48084ABC5"] --[[ @ 0]]
	f11_local7 = DataSources.LobbyClients.getModel() --[[ @ 0]]
	f11_local8 = f11_local7:create( Engine[@"hash_75065E759595C457"]( LuaDefine.INVALID_XUID_X64 ) ) --[[ @ 0]]
	f11_local9 = {} --[[ @ 0]]
	...
	for f11_local13, f11_local14 in ipairs( f11_local4 ) --[[ @ 0]] do
		local f11_local20 = Engine[@"hash_75065E759595C457"]( f11_local14.xuid ) --[[ @ 0]]
...
CoD.DirectorUtility.InitLobbyListsOnce = function ( f13_arg0, f13_arg1 )
	if not DataSources.DirectorPartyList._subscriptionElement then
		...
		DataSources.DirectorPartyList.OnSubscriptionNotified = function ( f15_arg0 )
			if f15_arg0 == f13_arg0.privateClient.update and (f13_arg0.lobbyMode:get() ~= Enum[@"LobbyMode"][@"hash_3F5EE25D311E5223"] or Enum[@"eModes"][@"hash_73723205FAE52C4A"] == Engine[@"CurrentSessionMode"]()) then
				return 
			end
			CoD.DirectorUtility.UpdateLobbyClientInfo( f13_arg0, f13_arg1 ) --[[ @ 0]]
			local f15_local0 = {} --[[ @ 0]]
...
CoD.DirectorUtility.DirectorPartyAndCustomListHelper = function ( f18_arg0, f18_arg1, f18_arg2 )
	...
	f18_local5 = f18_local5.LobbyClients:create( Engine[@"hash_75065E759595C457"]( LuaDefine.INVALID_XUID_X64 ) ) --[[ @ 0]]
	...
	f18_local15 = f18_local15.PartyPrivacy.privacy:get() == Enum[@"PartyPrivacy"][@"hash_78B288F48084ABC5"] --[[ @ 0]]
	if Engine[@"CurrentSessionMode"]() == Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] or Engine[@"CurrentSessionMode"]() == Enum[@"eModes"][@"hash_73723205FAE52C4A"] then
	...
	if CoD.isWarzone then
		...
		f18_local16 = {
			[Enum[@"team_t"][@"hash_42A34B055ADD98AB"]] = f18_local17,
			[Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"]] = f18_local17,
	...
	elseif f18_local8 then
		f18_local16 = {
			[Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"]] = 2,
			[Enum[@"team_t"][@"hash_42A34B055ADD98AB"]] = 6,
			[Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"]] = 6
		} --[[ @ 0]]
	else
		f18_local16 = {
			[Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"]] = 2,
			[Enum[@"team_t"][@"hash_697263B3C1ABADF7"]] = 12
		} --[[ @ 0]]
	end
	local f18_local17 = nil --[[ @ 0]]
	if f18_local0 or not Engine[@"SessionModeIsMode"]( Enum[@"hash_51DD23D27A61F09A"][@"hash_19A232F8674583A3"] ) then
		f18_local17 = Engine[@"hash_229B25E8DA873863"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"] ) --[[ @ 0]]
	else
		local f18_local18 = Engine[@"hash_63ACB99DBAD24D55"]( Engine[@"hash_17B3B2B73B53EB34"]() ) --[[ @ 0]]
	...
	if (f18_local3 or f18_local4) and f18_local1 and f18_local18 < f18_local6 and not f18_local15 then
		for f18_local23, f18_local24 in pairs( DataSources.DirectorPartyList.TeamCounts ) --[[ @ 0]] do
			if f18_local4 and not f18_local19 then
				break
			elseif f18_local8 or f18_local23 == Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] or f18_local23 == Enum[@"team_t"][@"hash_697263B3C1ABADF7"] then
...
CoD.DirectorUtility.PlaylistIDToPlaylistName = function ( f29_arg0 )
	...
	local f29_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f29_arg0 ) --[[ @ 0]]
	local f29_local1 --[[ @ 0]]
	if f29_local0 then
...
CoD.DirectorUtility.PlaylistIDToPlaylistIcon = function ( f30_arg0 )
	...
	local f30_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f30_arg0 ) --[[ @ 0]]
	local f30_local1 --[[ @ 0]]
	if f30_local0 then
...
CoD.DirectorUtility.PlaylistIDToPlaylistImage = function ( f31_arg0 )
	...
	local f31_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f31_arg0 ) --[[ @ 0]]
	local f31_local1 --[[ @ 0]]
	if f31_local0 then
...
CoD.DirectorUtility.PlaylistIDToPlaylistImageTileSideInfo = function ( f32_arg0 )
	if not IsLobbyNetworkModeLive() then
		...
		local f32_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f32_arg0 ) --[[ @ 0]]
		if f32_local0 then
...
CoD.DirectorUtility.PlaylistIDToPlaylistImageTileSmall = function ( f33_arg0 )
	if not IsLobbyNetworkModeLive() then
		...
		local f33_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f33_arg0 ) --[[ @ 0]]
		if f33_local0 then
...
CoD.DirectorUtility.PlaylistIDToZMPlaylistImage = function ( f35_arg0 )
	if not IsLobbyNetworkModeLive() then
		...
		local f35_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f35_arg0 ) --[[ @ 0]]
		if f35_local0 then
...
CoD.DirectorUtility.PlaylistIDToZMPlaylistName = function ( f36_arg0 )
	...
	local f36_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f36_arg0 ) --[[ @ 0]]
	if f36_local0 then
...
CoD.DirectorUtility.PlaylistIDToZMPlaylistSubtitle = function ( f37_arg0 )
	...
	local f37_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f37_arg0 ) --[[ @ 0]]
...
CoD.DirectorUtility.PlaylistIDToZMPlaylistDifficulty = function ( f38_arg0 )
	if not IsLobbyNetworkModeLive() then
		...
		local f38_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f38_arg0 ) --[[ @ 0]]
...
CoD.DirectorUtility.PlaylistIDToPlaylistDesc = function ( f39_arg0 )
	...
	local f39_local0 = Engine[@"hash_63ACB99DBAD24D55"]( f39_arg0 ) --[[ @ 0]]
	local f39_local1 --[[ @ 0]]
	if f39_local0 then
...
CoD.DirectorUtility.SetPlaylist = function ( f40_arg0, f40_arg1 )
	Engine[@"hash_5CE25A90DC553200"]( f40_arg1.playlistID ) --[[ @ 0]]
...
DataSources.DirectorMapList = DataSourceHelpers.ListSetup( "DirectorMapList", function ( f44_arg0, f44_arg1 )
	...
	local f44_local6 = function ( f47_arg0 )
		...
		if Dvar[@"hash_1E017690F8837DD6"]:get() and f47_local1 then
			f47_local1 = isMapInDemo( f47_arg0 ) --[[ @ 0]]
		end
		if Engine[@"hash_77D47312EBA41751"]() and f47_local1 then
			f47_local1 = f44_local4( f47_arg0 ) --[[ @ 0]]
		end
		if f47_local2[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_3B3A1BBF18C0B176"] and CoD.MapUtility.MapsTable[f47_arg0][@"hash_6CEA99714A694D78"] ~= 1 then
			return false
	 ...
	 --[[ @ 0]]
	local f44_local7 = Engine[@"SessionModeIsMode"]( Enum[@"hash_51DD23D27A61F09A"][@"hash_30B674220A0C7377"] ) --[[ @ 0]]
	local f44_local8 = 1 --[[ @ 0]]
	local f44_local9 = Engine[@"hash_1C53F8D38DF9042B"]( Engine[@"hash_3E67E7253CC272C9"]() ) --[[ @ 0]]
	if f44_local7 == false then
		...
		for f44_local26, f44_local27 in LUI.IterateTableBySortedKeys( CoD.MapUtility.MapsTable, f44_local5, f44_local6 ) --[[ @ 0]] do
			...
			if f44_local16 and f44_local16:get() == @"ztrials" then
				...
				if f44_local18 ~= @"hash_0" then
					f44_local17 = Engine[@"hash_622EAAB59AA27E9B"]( f44_local18 ) or 0 --[[ @ 0]]
				end
			...
			for f44_local18 = 0 --[[ @ 0]], f44_local17, 1 do
				...
				if f44_local14 then
					...
					f44_local21 = Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] ) --[[ @ 0]]
					...
					Engine[@"hash_2202BEB9A6859B8B"]( f44_local21, Enum[@"SessionDirty"][@"hash_29EC6BB6276BDCE6"] ) --[[ @ 0]]
				end
			end
		end
		if not f44_local10 and #f44_local0 > 0 then
			...
			f44_local11 = Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] ) --[[ @ 0]]
			Engine[@"hash_787AE7E64BA5AD61"]( "OnGametypeSettingsChange", {
				lobbyModule = Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"],
				lobbyType = f44_local11,
				fromUI = true
			} ) --[[ @ 0]]
			Engine[@"hash_2202BEB9A6859B8B"]( f44_local11, Enum[@"SessionDirty"][@"hash_29EC6BB6276BDCE6"] ) --[[ @ 0]]
		end
	end
...
DataSourceHelpers.PerControllerDataSourceSetup( "MapModePreview", "MapModePreview", function ( f49_arg0, f49_arg1 )
	...
	f49_local0:set( Engine[@"hash_1C53F8D38DF9042B"]( Engine[@"hash_3E67E7253CC272C9"]() ) ) --[[ @ 0]]
...
DataSources.DirectorGameTypeList = DataSourceHelpers.ListSetup( "DirectorGameTypeList", function ( f51_arg0, f51_arg1 )
	...
	local f51_local5 = Engine[@"hash_169811927938FCD7"]() --[[ @ 0]]
	if f51_local3[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_3B3A1BBF18C0B176"] then
		for f51_local9, f51_local10 in ipairs( CoD.DirectorUtility.CombatTrainingGameTypes ) --[[ @ 0]] do
			local f51_local11 = Engine[@"hash_5EA74FA7EE46E195"]( f51_local10 ) --[[ @ 0]]
		...
		local f51_local6 = function ( f52_arg0, f52_arg1 )
			local f52_local0 = {} --[[ @ 0]]
			if f52_arg0 == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] then
				f52_local0 = {
					@"zclassic",
					@"zstandard",
					@"ztrials",
		...
		for f51_local10, f51_local11 in pairs( f51_local4 ) --[[ @ 0]] do
			if f51_local11.category == "standard" or f51_local3[@"hash_EB7DDC7F079D51B"] == Enum[@"LobbyMainMode"][@"hash_37B50049993542C0"] or f51_local3[@"hash_EB7DDC7F079D51B"] == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] and f51_local11.category ~= "hidden" then
				local f51_local12 = Engine[@"hash_5EA74FA7EE46E195"]( f51_local11.gametype ) --[[ @ 0]]
				local f51_local13 = Engine[@"hash_1C53F8D38DF9042B"]( f51_local11.gametype ) --[[ @ 0]]
				local f51_local14 = Engine[@"hash_1C53F8D38DF9042B"]( f51_local12.groupName ) --[[ @ 0]]
				if f51_local3[@"LobbyMode"] ~= Enum[@"LobbyMode"][@"hash_3F5EE25D311E5223"] or f51_local3[@"hash_EB7DDC7F079D51B"] ~= Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] or f51_local13 == @"zclassic" or IsLobbyNetworkModeLAN() and not CoD.DirectorUtility.IsOfflineScreenStateCustomGame() then
					if f51_local14 ~= @"ztcm" and (f51_local13 ~= @"ztrials" or not IsBooleanDvarSet( @"hash_70431CAAEFB37761" ) and f51_local13 == @"ztrials") and (f51_local13 ~= @"ztutorial" or f51_local13 == @"ztutorial" and f51_local2 == 1) then
						table.insert( f51_local0, {
							...
							properties = {
								...
								sortIndex = f51_local6( f51_local3[@"hash_EB7DDC7F079D51B"], f51_local13 )
							}
						} ) --[[ @ 0]]
					end
				end
...
CoD.DirectorUtility.GetCombatTrainingMapIterator = function ()
	...
	, function ( f57_arg0 )
		local f57_local0 --[[ @ 0]]
		if CoD.mapsTable[f57_arg0].session_mode ~= Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] or CoD.mapsTable[f57_arg0][@"hash_6CEA99714A694D78"] ~= 1 then
			f57_local0 = false --[[ @ 0]]
		else
			f57_local0 = true --[[ @ 0]]
		end
...
DataSources.DirectorSuggestedActivities = DataSourceHelpers.ListSetup( "DirectorSuggestedActivities", function ( f58_arg0, f58_arg1 )
	...
	local f58_local1 = Engine[@"hash_38020859DF7AAF7B"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"] ) --[[ @ 0]]
	local f58_local2 = {} --[[ @ 0]]
	for f58_local6, f58_local7 in ipairs( f58_local1 ) --[[ @ 0]] do
		local f58_local8 = f58_local0[Engine[@"hash_75065E759595C457"]( f58_local7 )].playerSuggestion --[[ @ 0]]
	...
	for f58_local8, f58_local9 in pairs( f58_local2 ) --[[ @ 0]] do
		...
		local f58_local11 = Engine[@"hash_63ACB99DBAD24D55"]( f58_local8 ) --[[ @ 0]]
...
CoD.DirectorUtility.GetPlaylists = function ()
	if IsLobbyNetworkModeLive() and Engine[@"hash_504E58F1E46816B6"]() ~= Engine[@"DefaultID64Value"]() then
...
CoD.DirectorUtility.GetFirstOrFeaturedPlaylistEntry = function ( f72_arg0, f72_arg1, f72_arg2, f72_arg3, f72_arg4 )
	...
	for f72_local13, f72_local14 in ipairs( f72_arg1 ) --[[ @ 0]] do
		if f72_local14.lobbyMainMode == f72_local1 or f72_local14.lobbyMainMode == Enum[@"LobbyMainMode"][@"hash_6D5FBB8D74AC6D62"] then
			local f72_local15 --[[ @ 0]]
						...
						if not f72_arg4 or not f72_local22 then
							if f72_local21.featured then
								...
								if f72_local21.isQuickplayCard then
									f72_local19 = Dvar[@"hash_4B0C30E95930EE40"]:exists() and Dvar[@"hash_4B0C30E95930EE40"]:get() or -1 --[[ @ 0]]
...
CoD.DirectorUtility.MainScreenModes = {
	{
		arena = false,
		mainMode = Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"],
		stringIfLocked = @"hash_555D96CC762EABDD",
		lockedOffline = false,
	...
	},
	{
		arena = true,
		mainMode = Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"],
		stringIfLocked = @"hash_4CE36E3614BD4EAE",
		lockedOffline = false,
	...
	{
		arena = false,
		mainMode = Enum[@"LobbyMainMode"][@"hash_378C124999125C42"],
		stringIfLocked = @"hash_7A2DD20750465431",
		lockedOffline = false,
	...
	{
		arena = false,
		mainMode = Enum[@"LobbyMainMode"][@"hash_379D01499920B292"],
		stringIfLocked = @"hash_5B06081B8B4567F2",
		lockedOffline = false,
...
CoD.DirectorUtility.IsMainModeLocked = function ( f77_arg0, f77_arg1 )
	...
	elseif IsLobbyNetworkModeLAN() and f77_arg1.lockedOffline then
		return true
	elseif CoD.DirectorUtility.DisableForCurrentMilestone() and f77_arg1.mainMode == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] and LuaUtils.MatchmakingTest() ~= 1 then
		return true
...
DataSources.DirectorExtraHomeButtons = ListHelper_SetupDataSource( "DirectorExtraHomeButtons", function ( f85_arg0, f85_arg1 )
	...
	if f85_local1 then
		...
		table.insert( f85_local0, {
			models = {
				subtitle = @"hash_360E17AB37AB4874",
				iconBackground = @"blacktransparent",
				iconBackgroundFocus = @"blacktransparent",
				showOnLeft = true,
				small = true,
		...
		if IsBooleanDvarSet( @"loot_enableblackmarket" ) then
			...
			local f85_local9 --[[ @ 0]]
			if f85_local8 then
				f85_local9 = f85_local8[@"hash_7B470A49831A5DCB"] --[[ @ 0]]
...
CoD.DirectorUtility.AddBlackoutVODFeaturedCard = function ( f88_arg0, f88_arg1 )
	table.insert( f88_arg0, {
		models = {
			locked = false,
			name = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7A2DD20750465431" ),
...
CoD.DirectorUtility.DirectorSelectAction = function ( f89_arg0, f89_arg1, f89_arg2, f89_arg3, f89_arg4 )
	...
	local f89_local2 = f89_local1[@"hash_EB7DDC7F079D51B"] --[[ @ 0]]
	local f89_local3 = f89_local1[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_6D42D003CEEA3F87"] --[[ @ 0]]
...
CoD.DirectorUtility.DirectorSelectLockedAction = function ( f90_arg0, f90_arg1, f90_arg2, f90_arg3, f90_arg4 )
	...
	local f90_local1 = f90_local0[@"hash_EB7DDC7F079D51B"] --[[ @ 0]]
...
CoD.DirectorUtility.DirectorTheaterOpenSelectFilm = function ( f92_arg0, f92_arg1, f92_arg2, f92_arg3, f92_arg4 )
	if not CoDShared.IsInTheaterLobby() then
		return 
	elseif f92_arg3 ~= Enum[@"eModes"][@"hash_2B22E0240605CFFE"] then
		CoD.FileshareUtility.SetCurrentFilter( Enum[@"hash_A8E3D76FFA84DE1"][@"hash_7309C4BC434A44FC"], Engine[@"hash_48506F73B393062F"]( f92_arg3 ) ) --[[ @ 0]]
	end
...
CoD.DirectorUtility.DirectorTheaterLaunchDemo = function ( f93_arg0, f93_arg1, f93_arg2 )
	local f93_local0 = Engine[@"hash_323AF33F30C69410"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] ) ) --[[ @ 0]]
	if not f93_local0 then
		return 
	elseif f93_arg2 == nil then
		f93_arg2 = "" --[[ @ 0]]
	end
	f93_local0.map = Engine[@"hash_3E67E7253CC272C9"]() --[[ @ 0]]
	f93_local0.gametype = Engine[@"hash_169811927938FCD7"]() --[[ @ 0]]
	f93_local0.controller = f93_arg1 --[[ @ 0]]
	f93_local0.demoMode = f93_arg2 --[[ @ 0]]
	Engine[@"hash_4E0C7C66C7ED2605"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] ), f93_local0 ) --[[ @ 0]]
	CoD.MetricsUtility.WatchVideoEvent( f93_arg1, f93_local0 ) --[[ @ 0]]
	CoD.LobbyUtility.LaunchDemo( f93_arg0, f93_arg1, Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
	CoD.FileshareUtility.SetAutoStart( false ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.DirectorUtility.IsQuickplayAvailableForMode = function ( f94_arg0 )
	if Dvar[@"hash_1E20802F756EFAF"]:exists() and Dvar[@"hash_1E20802F756EFAF"]:get() then
		if f94_arg0 == Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"] then
			return Dvar[@"hash_3A7864B7F74641C9"]:exists() and Dvar[@"hash_3A7864B7F74641C9"]:get()
		elseif f94_arg0 == Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] then
			return Dvar[@"hash_3A646AB7F735A2F1"]:exists() and Dvar[@"hash_3A646AB7F735A2F1"]:get()
		elseif f94_arg0 == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] then
			return Dvar[@"hash_3A537FB7F727536D"]:exists() and Dvar[@"hash_3A537FB7F727536D"]:get()
		end
	end
	return false
end
...
CoD.DirectorUtility.GetQuickplayPlaylistsForCurrentMode = function ( f95_arg0, f95_arg1 )
	...
	if f95_local1 == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] then
...
CoD.DirectorUtility.PrepareSearchPlaylistModels = function ( f96_arg0, f96_arg1 )
	...
	if Dvar[@"hash_1E20802F756EFAF"]:exists() and Dvar[@"hash_1E20802F756EFAF"]:get() then
		...
		local f96_local4 = Engine[@"hash_17B3B2B73B53EB34"]() --[[ @ 0]]
		local f96_local5 = Engine[@"hash_63ACB99DBAD24D55"]( f96_local4 ) --[[ @ 0]]
...
CoD.DirectorUtility.OpenDirectorChangeCharacterMenu = function ( f104_arg0, f104_arg1, f104_arg2, f104_arg3, f104_arg4 )
	if f104_arg3 and f104_arg3._sessionMode == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] then
		OpenOverlay( f104_arg0, "DirectorPersonalizeCharacterMP", f104_arg2, f104_arg3 ) --[[ @ 0]]
	elseif f104_arg3 and f104_arg3._sessionMode == Enum[@"eModes"][@"hash_73723205FAE52C4A"] then
		OpenOverlay( f104_arg0, "ZMPersonalizeCharacterMain", f104_arg2, f104_arg3 ) --[[ @ 0]]
	elseif f104_arg3 and f104_arg3._sessionMode == Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] then
	...
	for f107_local16, f107_local17 in ipairs( CoD.DirectorUtility.MainScreenModes ) --[[ @ 0]] do
		if f107_local17.isVisible() then
			...
			if f107_local17.arena then
				f107_local6 = @"hash_4CE36E3614BD4EAE" --[[ @ 0]]
				f107_local7 = @"hash_1D1B1F44DD4D669E" --[[ @ 0]]
				if f107_local1 then
...
DataSources.DirectorTheaterLandingPageModes = ListHelper_SetupDataSource( "DirectorTheaterLandingPageModes", function ( f108_arg0, f108_arg1 )
	...
	table.insert( f108_local0, {
		...
		properties = {
			action = CoD.DirectorUtility.DirectorTheaterOpenSelectFilm,
			actionParam = Enum[@"eModes"][@"hash_2B22E0240605CFFE"]
		}
	} ) --[[ @ 0]]
	return f108_local0
end ) --[[ @ 0]]
	...
	for f113_local1 = 1 --[[ @ 0]], #f113_arg3, 1 do
		...
		if f113_local4 ~= nil then
			...
			if CoD.DirectorUtility.DisableForCurrentMilestone( f113_arg1 ) then
				...
				f113_local12 = LuaUtils.PlaylistRulesIncludes( f113_local4.rules, @"hash_C9735B7B2ADB9E1", "2" ) --[[ @ 0]]
				f113_local13 = LuaUtils.PlaylistRulesIncludes( f113_local4.rules, @"scr_credit_scale", "2" ) --[[ @ 0]]
				f113_local14 = CoD.ZombieUtility.IsDoubleNP( f113_arg1 ) and f113_local4.mainMode == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] --[[ @ 0]]
			end
			if not (f113_local4.minUserTier == Enum[@"hash_B16E5B2AF9D5263"][@"hash_62731C51590EF20A"] or f113_local9 >= f113_local4.minUserTier) or f113_local4.maxUserTier ~= Enum[@"hash_B16E5B2AF9D5263"][@"hash_62731C51590EF20A"] and f113_local4.maxUserTier < f113_local9 then
				f113_local8 = true --[[ @ 0]]
			end
			if f113_local10 == Enum[@"hash_4DACBB5C5F26BCD9"][@"hash_5B469AFA64270B7E"] then
				f113_local8 = true --[[ @ 0]]
			end
			...
			f113_local22 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_4650ADB7FBE404F8", f113_local4.minPlayers, f113_local4.maxPlayers ) --[[ @ 0]]
			...
			if f113_local8 ~= true then
				...
				f113_arg0.cards[f113_local0] = {
					...
					locked = Engine[@"hash_648A9F0577411885"]( f113_arg1, f113_local6 ),
...
DataSources.DirectorPregameButtons = ListHelper_SetupDataSource( "DirectorPregameButtons", function ( f115_arg0, f115_arg1 )
	...
	local f115_local4 = function ( f116_arg0, f116_arg1 )
		...
		if not f116_local1 and f116_arg0.featureItemIndex then
			...
			if CoD.CACUtility.IsFeatureItemLocked( f115_arg0, f116_arg0.featureItemIndex, f115_local2 ) then
				f116_local1 = CoD.GetUnlockStringForItemIndex( f115_arg0, f116_arg0.featureItemIndex, Enum[@"hash_6EB546760F890D2"][@"hash_13057ABF96AF8289"], f115_local2 ) --[[ @ 0]]
			end
		end
	 ...
	 --[[ @ 0]]
	if f115_local1 == Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"] then
		...
		if f115_arg1:getParent() then
			...
			if f115_local7._preGameType == "public" then
				...
				if f115_local7 and f115_local7:get() then
					...
					if f115_local8 then
						f115_local8 = Engine[@"hash_63ACB99DBAD24D55"]( f115_local7:get() ) --[[ @ 0]]
					end
		...
		if not CoDShared.IsInTheaterLobby() then
			if not IsLobbyNetworkModeLAN() and (not CoD.DirectorUtility.IsOfflineDemo() or Engine[@"hash_5CB675CA7856DA25"]()) then
				f115_local4( {
					name = @"hash_10C07E700FAFA31F",
					subtitle = @"hash_10C07E700FAFA31F",
					iconBackground = @"$blacktransparent",
	...
	if f115_local1 == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] then
		if not IsLobbyNetworkModeLAN() and (not CoD.DirectorUtility.IsOfflineDemo() or Engine[@"hash_5CB675CA7856DA25"]()) then
			f115_local4( {
		...
		f115_local4( {
			name = @"hash_7D6BF3A3749C31CD",
			subtitle = @"hash_7D6BF3A3749C31CD",
			iconBackground = @"$blacktransparent",
			showPregameButton = true
		}, {
	...
	if f115_local1 == Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] then
		if not IsLobbyNetworkModeLAN() and (not CoD.DirectorUtility.IsOfflineDemo() or Engine[@"hash_5CB675CA7856DA25"]()) then
			f115_local4( {
				name = @"hash_10C07E700FAFA31F",
				subtitle = @"hash_10C07E700FAFA31F",
...
CoD.DirectorUtility.IsMainMode = function ( f120_arg0, f120_arg1 )
	...
	return f120_local0[@"hash_EB7DDC7F079D51B"] == f120_arg1
end
 --[[ @ 0]]
...
CoD.DirectorUtility.ShowDirectorPublic = function ( f124_arg0 )
	...
	local f124_local1 --[[ @ 0]]
	if f124_local0[@"LobbyMode"] ~= Enum[@"LobbyMode"][@"hash_2BB5FD8AEFC4D4B9"] or f124_local0[@"hash_3B07E287B4DC239E"] == 0 then
		f124_local1 = false --[[ @ 0]]
	else
		f124_local1 = true --[[ @ 0]]
	end
...
CoD.DirectorUtility.ShowDirectorCustom = function ( f125_arg0, f125_arg1 )
	if not CoD.ModelUtility.IsSelfModelValueNilOrTrue( f125_arg0, f125_arg1, "available" ) then
		...
		return f125_local0[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_3F5EE25D311E5223"]
	end
end
 --[[ @ 0]]
CoD.DirectorUtility.ShowDirectorPrivate = function ( f126_arg0, f126_arg1 )
	...
	local f126_local1 --[[ @ 0]]
	if f126_local0[@"LobbyMode"] ~= Enum[@"LobbyMode"][@"hash_2BB5FD8AEFC4D4B9"] or f126_local0[@"hash_3B07E287B4DC239E"] ~= 0 then
		f126_local1 = false --[[ @ 0]]
	else
		f126_local1 = true --[[ @ 0]]
	end
...
CoD.DirectorUtility.ShowDirectorArena = function ( f128_arg0 )
	...
	local f128_local1 --[[ @ 0]]
	if f128_local0[@"LobbyMode"] ~= Enum[@"LobbyMode"][@"hash_6D42D003CEEA3F87"] or f128_local0[@"LobbyType"] ~= Enum[@"LobbyType"][@"hash_20A1647599284110"] then
		f128_local1 = false --[[ @ 0]]
	else
		f128_local1 = true --[[ @ 0]]
	end
...
CoD.DirectorUtility.ShowDirectorArenaMatchmaking = function ( f129_arg0 )
	...
	local f129_local1 --[[ @ 0]]
	if f129_local0[@"LobbyMode"] ~= Enum[@"LobbyMode"][@"hash_6D42D003CEEA3F87"] or f129_local0[@"LobbyType"] ~= Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] then
		f129_local1 = false --[[ @ 0]]
	else
		f129_local1 = true --[[ @ 0]]
	end
...
CoD.DirectorUtility.IsMatchmakingInProgress = function ( f130_arg0 )
	...
	if f130_local0[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_6D42D003CEEA3F87"] and f130_local0[@"LobbyType"] == Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] then
		return true
...
CoD.DirectorUtility.ShowDirectorLobbyList = function ( f131_arg0 )
	...
	if f131_local0 then
		if not CoD.DirectorUtility.IsMainMode( f131_arg0, Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) then
...
CoD.DirectorUtility.ShowDirectorCustomMatchCoDCasterList = function ( f132_arg0 )
	...
	if f132_local0[@"name"] == LuaEnum.UI.DIRECTOR_ONLINE_CP_STORY then
		return false
	elseif Engine[@"hash_144FC97037CE42ED"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] ), Enum[@"hash_6575E471C039DBD6"][@"hash_28A42AF1547AB4DF"] ) == 1 and Engine[@"GetGametypeSetting"]( @"hash_31ECE5CAD71BF4EA" ) == 1 then
		return true
	else
		return false
	end
...
CoD.DirectorUtility[@"hash_61E20A632CB63092"] = function ( f133_arg0 )
	...
	local f133_local1 = Engine[@"hash_1C53F8D38DF9042B"]( f133_local0[@"hash_2355141FF0C48EDA"] ) --[[ @ 0]]
	local f133_local2 --[[ @ 0]]
	if f133_local1 ~= @"lobby_pose" and f133_local1 ~= @"hash_757E90B1451515A7" and f133_local1 ~= @"arena_pose" and f133_local1 ~= @"private_lobby_pose" then
		f133_local2 = false --[[ @ 0]]
	else
		f133_local2 = true --[[ @ 0]]
	end
...
CoD.DirectorUtility.ShowDirectorCustomMatchPartyOverflowList = function ( f135_arg0 )
	...
	local f135_local1 = Engine[@"hash_56C6FE1BF41EB9AF"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] ) ) --[[ @ 0]]
	for f135_local5, f135_local6 in pairs( f135_local1.clientTeams ) --[[ @ 0]] do
		if f135_local6.team == Enum[@"team_t"][@"hash_697263B3C1ABADF7"] then
			return true
		end
	end
	return false
...
CoD.DirectorUtility.ShowDirectorCustomMatchBotButtons = function ( f136_arg0 )
	...
	if Dvar[@"hash_547BB8673052413C"]:get() == true and f136_local0[@"name"] ~= LuaEnum.UI.DIRECTOR_ONLINE_CP_STORY then
...
CoD.DirectorUtility.ShowDirectorCustomMatchStartButton = function ( f137_arg0 )
	...
	if f137_local0[@"name"] ~= LuaEnum.UI.DIRECTOR_ONLINE_MP_CUSTOM and f137_local0[@"name"] ~= LuaEnum.UI.DIRECTOR_ONLINE_MP_ARENA_CUSTOM then
		...
		return Engine[@"hash_10EA2BE00F49480D"]( Enum[@"LobbyType"][@"hash_20A1647599284110"] )
	end
end
 --[[ @ 0]]
CoD.DirectorUtility.ShowDirectorTheater = function ( f138_arg0 )
	local f138_local0 = LobbyData.GetCurrentMenuTarget() --[[ @ 0]]
	return f138_local0[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_28B3B066EFD7CD01"]
end
 --[[ @ 0]]
CoD.DirectorUtility.ShouldShowFillSquadButton = function ()
	...
	if f139_local0.lobbyMainMode:get() ~= Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] then
		return false
...
CoD.DirectorUtility.IsElementMapOrGameTypeSelected = function ( f145_arg0, f145_arg1 )
	...
	if f145_arg0.isMapElement or f145_arg0.mapList then
		f145_local0 = Engine[@"hash_1C53F8D38DF9042B"]( Engine[@"hash_3E67E7253CC272C9"]() ) --[[ @ 0]]
	...
	if f145_local0 then
		...
		if f145_local1 and type( f145_local4 ) == "string" then
			f145_local4 = Engine[@"hash_1C53F8D38DF9042B"]( f145_local4 ) --[[ @ 0]]
		end
		...
		for f145_local9, f145_local10 in ipairs( f145_local2 ) --[[ @ 0]] do
			...
			if f145_local1 and type( f145_local8 ) == "string" then
				f145_local8 = Engine[@"hash_1C53F8D38DF9042B"]( f145_local8 ) --[[ @ 0]]
			end
...
CoD.DirectorUtility.PrivateLobbyListPlayerCountAndMax = function ( f147_arg0 )
	local f147_local0 = Engine[@"hash_144FC97037CE42ED"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"], Enum[@"hash_6575E471C039DBD6"][@"hash_1092BC25E18D296F"] ) --[[ @ 0]]
	local f147_local1 = Engine[@"hash_229B25E8DA873863"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_20A1647599284110"] ) --[[ @ 0]]
	local f147_local2 --[[ @ 0]]
...
local f0_local0 = function ( f149_arg0, f149_arg1, f149_arg2 )
	if not CoD.isZombie and IsFirstTimeSetup( f149_arg1, Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] ) and (not Engine[@"IsCampaignGame"]() or not IsFirstTimeSetup( f149_arg1, Enum[@"eModes"][@"hash_360063C67132EB69"] )) then
		return 
	end
...
CoD.DirectorUtility.GetDirectorFiltersCardsForMode = function ( f150_arg0, f150_arg1, f150_arg2, f150_arg3 )
	...
	local f150_local4 = Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"] --[[ @ 0]]
	if CoD.DirectorUtility.IsMainMode( f150_arg1, f150_local4 ) then
		for f150_local5 = 1 --[[ @ 0]], f150_local2, 1 do
			...
			if f150_local4 == f150_local8.lobbyMainMode then
				local f150_local9 = CoD.DirectorUtility.CreateFilter( f150_arg1, f150_local8.lobbyMainMode, "Featured", @"hash_F29BEFC80072FF5", @"hash_4F713C5F8E1A479C", f150_local8.entries, f150_arg0._mainMode, IsArenaMode(), true, f150_arg3 ) --[[ @ 0]]
...
CoD.DirectorUtility.RegionOnlyAllowsFeaturedPlaylistForMode = function ( f157_arg0, f157_arg1 )
	if f157_arg1 ~= Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] then
		return false
	end
	local f157_local0 = Dvar[@"hash_6A9E06F8886F97C1"]:get() --[[ @ 0]]
	if not f157_local0 then
		return false
	end
	local f157_local1 = "" --[[ @ 0]]
	if Dvar[@"hash_50A227017683285B"]:exists() == true and Dvar[@"hash_50A227017683285B"]:get() == true then
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "RegionOnlyAllowsFeaturedPlaylistForMode: Using geoip\n" ) --[[ @ 0]]
		...
		if f157_local2 ~= nil then
			...
			Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "RegionOnlyAllowsFeaturedPlaylistForMode: Couldn't get country code\n" ) --[[ @ 0]]
		end
	else
		local f157_local2 = Engine[@"hash_56BA9980BA648FB3"]( f157_arg0 ) --[[ @ 0]]
		f157_local1 = f157_local2.Country --[[ @ 0]]
	end
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "RegionOnlyAllowsFeaturedPlaylistForMode: Country is " .. f157_local1 .. "\n" ) --[[ @ 0]]
...
CoD.DirectorUtility.IsInLowPopRegion = function ( f158_arg0 )
	...
	local f158_local1 = "" --[[ @ 0]]
	if Dvar[@"hash_50A227017683285B"]:exists() == true and Dvar[@"hash_50A227017683285B"]:get() == true then
		Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "IsInLowPopRegion: Using geoip\n" ) --[[ @ 0]]
		...
		if f158_local2 ~= nil then
			...
			Engine[@"PrintWarning"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "IsInLowPopRegion: Couldn't get country code\n" ) --[[ @ 0]]
		end
	else
		local f158_local2 = Engine[@"hash_56BA9980BA648FB3"]( f158_arg0 ) --[[ @ 0]]
		f158_local1 = f158_local2.Country --[[ @ 0]]
	end
	Engine[@"PrintInfo"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_3A9AE284CC7DE955"], "IsInLowPopRegion: Country is " .. f158_local1 .. "\n" ) --[[ @ 0]]
...
CoD.DirectorUtility.GetPreferredPlaylistForMainMode = function ( f159_arg0, f159_arg1, f159_arg2 )
	...
	if f159_arg2 then
		...
		if not f159_local2 then
			...
			local f159_local4 = Engine[@"hash_63ACB99DBAD24D55"]( f159_local3 ) --[[ @ 0]]
...
CoD.DirectorUtility.SaveCurrentPlaylistForMainMode = function ( f162_arg0, f162_arg1, f162_arg2 )
	...
	if f162_local0 ~= Enum[@"LobbyMainMode"][@"hash_6D5FBB8D74AC6D62"] or f162_arg1 ~= nil then
		local f162_local1 = Engine[@"GetGlobalModel"]() --[[ @ 0]]
		f162_local1 = f162_local1.lobbyRoot.playlistId:get() --[[ @ 0]]
		if Engine[@"hash_63ACB99DBAD24D55"]( f162_local1 ) then
			if f162_local0 ~= Enum[@"LobbyMainMode"][@"hash_6D5FBB8D74AC6D62"] then
...
CoD.DirectorUtility.ForceStreamPlaylistImages = function ( f169_arg0 )
	...
	for f169_local7, f169_local8 in pairs( CoD.DirectorUtility.GetPlaylists() ) --[[ @ 0]] do
		for f169_local4, f169_local5 in ipairs( f169_local8.entries ) --[[ @ 0]] do
			if f169_arg0 == Enum[@"eModes"][@"hash_2B22E0240605CFFE"] or f169_arg0 == LuaUtils.GetEModeForLobbyMainMode( f169_local5.mainMode ) then
...
CoD.DirectorUtility.IsMPFirstTimeComplete = function ( f179_arg0 )
	...
	local f179_local1 = Engine[@"StorageGetBuffer"]( f179_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
...
CoD.DirectorUtility.SetMPFirstTimeComplete = function ( f180_arg0, f180_arg1 )
	local f180_local0 = Engine[@"StorageGetBuffer"]( f180_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
	if f180_local0 then
		local f180_local1 = f180_local0.completedFirstTimeFlow --[[ @ 0]]
		if f180_arg1 then
			f180_local1:set( 1 ) --[[ @ 0]]
			Engine[@"StorageWrite"]( f180_arg0, Enum[@"StorageFileType"][@"hash_6FDE358A242AFA2C"] ) --[[ @ 0]]
		else
			f180_local1:set( 0 ) --[[ @ 0]]
		end
	end
...
CoD.DirectorUtility.PostLoad = function ( f181_arg0, f181_arg1 )
	...
	f181_arg1:addMenuOpenedCallback( function ()
		if Engine[@"CurrentSessionMode"]() == Enum[@"eModes"][@"hash_2B22E0240605CFFE"] and not f181_arg1._openedEntitlementPopups then
	...
	if f181_local2 ~= Enum[@"eModes"][@"hash_2B22E0240605CFFE"] and f181_local2 ~= Engine[@"GetMostRecentPlayedMode"]( f181_arg0 ) then
			...
			if f181_local14.isVisible() then
				...
				if not f181_local10 then
					...
					if f181_local11 and f181_local11.properties then
						...
						if Engine[@"hash_63ACB99DBAD24D55"]( f181_local12 ) then
	...
	if Engine[@"hash_23ADF2C70B61E0EF"]( f181_local7 ) then
		Engine[@"hash_5CE25A90DC553200"]( f181_local7 ) --[[ @ 0]]
	end
	local f181_local8 = {} --[[ @ 0]]
	...
	f181_arg1:subscribeToModel( f181_local9, function ( model )
		...
		local f184_local3 = LuaUtils.GetEModeForLobbyMainMode( f184_local2[@"hash_EB7DDC7F079D51B"] ) --[[ @ 0]]
		if f184_local3 ~= nil then
			if f184_local3 == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] and f184_local2[@"id"] == LobbyData.GetLobbyMenuIDByName( LuaEnum.UI.DIRECTOR_ONLINE_MP_TRAINING ) then
				CoD.FTUEUtility.ShouldBlockMPFTUE = false --[[ @ 0]]
			elseif f184_local3 == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] and CoD.FTUEUtility.ShouldBlockMPFTUE then
				CoD.FTUEUtility.ShouldBlockMPFTUE = false --[[ @ 0]]
			elseif f181_arg1:getParent() then
				if f184_local3 == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] then
					if f184_local2[@"LobbyMode"] == Enum[@"LobbyMode"][@"hash_6D42D003CEEA3F87"] then
				...
				elseif f184_local3 == Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] then
					CoD.FTUEUtility.ShowFTUESequenceIfNotSeen( f181_arg1, f181_arg0, "GestureChanges" ) --[[ @ 0]]
				elseif f184_local3 == Enum[@"eModes"][@"hash_73723205FAE52C4A"] then
					CoD.FTUEUtility.ShowFTUESequenceIfNotSeen( f181_arg1, f181_arg0, "ZMGestureChanges" ) --[[ @ 0]]
				end
			end
			if f184_local3 ~= Enum[@"eModes"][@"hash_2B22E0240605CFFE"] then
				local f184_local4 --[[ @ 0]]
	...
	local f181_local11 = function ()
		...
		if f185_local2 then
			...
			if f185_local3 then
				local f185_local4 = LuaUtils.GetEModeForLobbyMainMode( f185_local3[@"hash_EB7DDC7F079D51B"] ) --[[ @ 0]]
				...
				elseif f185_local3[@"hash_EB7DDC7F079D51B"] == Enum[@"LobbyMainMode"][@"hash_6D5FBB8D74AC6D62"] then
					CoD.DirectorUtility.ForceStreamDirectorImagesForMode( f181_arg0, Enum[@"eModes"][@"hash_2B22E0240605CFFE"] ) --[[ @ 0]]
				...
				if f185_local4 ~= nil and f185_local4 ~= Enum[@"eModes"][@"hash_2B22E0240605CFFE"] and (f181_local14 ~= f185_local3[@"name"] == LuaUtils.LobbyMainModeData[f185_local3[@"hash_EB7DDC7F079D51B"]].OnlineCustomMenu or f181_local10 ~= f185_local3[@"name"] == LuaUtils.LobbyMainModeData[f185_local3[@"hash_EB7DDC7F079D51B"]].OnlineArenaCustomMenu) then
					...
					f181_local14 = f185_local3[@"name"] == LuaUtils.LobbyMainModeData[f185_local3[@"hash_EB7DDC7F079D51B"]].OnlineCustomMenu --[[ @ 0]]
					f181_local10 = f185_local3[@"name"] == LuaUtils.LobbyMainModeData[f185_local3[@"hash_EB7DDC7F079D51B"]].OnlineArenaCustomMenu --[[ @ 0]]
				end
			end
			if f185_local1 and CoD.mapsTable[f185_local1] then
				if f185_local2 == LobbyData.GetLobbyMenuIDByName( LuaEnum.UI.DIRECTOR_ONLINE_WZ_CUSTOM ) and (IsBooleanDvarSet( "use_wz_escape" ) or IsBooleanDvarSet( "use_wz_escape_alt" ) or IsBooleanDvarSet( "use_wz_alt" )) then
					if IsBooleanDvarSet( "use_wz_escape" ) or IsBooleanDvarSet( "use_wz_escape_alt" ) then
						if IsBooleanDvarSet( "use_wz_escape_alt" ) then
							SetMap( f181_arg0, @"hash_6C4FD4AF9DA9E4CA", false ) --[[ @ 0]]
						else
							SetMap( f181_arg0, @"hash_4023B088683398E2", false ) --[[ @ 0]]
						end
						...
						SetMap( f181_arg0, @"hash_1E0F02C86F90C804", false ) --[[ @ 0]]
					end
				elseif not Engine[@"IsMapValid"]( f185_local1 ) and not CoD.LobbyUtility.isMapFree( f185_local1 ) then
					...
					if f185_local4 then
						f185_local4 = Engine[@"hash_1C53F8D38DF9042B"]( f185_local4 ) --[[ @ 0]]
						if f185_local4 ~= @"hash_0" and CoD.mapsTable[f185_local4] then
							SetMap( f181_arg0, f185_local4, false ) --[[ @ 0]]
						end
					end
				end
				if f185_local3[@"hash_EB7DDC7F079D51B"] == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] then
	...
	local f181_local12 = function ()
		if IsLobbyNetworkModeLive() then
			...
			if f186_local0 ~= nil then
				local f186_local1 = Engine[@"hash_63ACB99DBAD24D55"]( f186_local0 ) --[[ @ 0]]
				if f186_local1 then
					...
					f186_local4 = Engine[@"hash_63ACB99DBAD24D55"]( f186_local0 ) --[[ @ 0]]
	...
	f181_arg1:subscribeToModel( f181_local3:create( "lobbyMainMode" ), function ( model )
		...
		Engine[@"hash_6F5E84EE46588907"]( f181_arg0, true ) --[[ @ 0]]
		if model:get() == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] then
	...
	if Engine[@"CurrentSessionMode"]() == Enum[@"eModes"][@"hash_2B22E0240605CFFE"] then
		...
		if IsLobbyNetworkModeLive() and Dvar[@"hash_65ACE5F4E5F09824"]:exists() then
			...
			if IsGameTrial() then
				Engine[@"hash_139D15A32073B948"]( f181_arg0, f181_local19 ) --[[ @ 0]]
...
CoD.DirectorUtility.ValidateMaxPlayers = function ( f196_arg0 )
	...
	if f196_arg0 >= Engine[@"hash_144FC97037CE42ED"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] ), Enum[@"hash_6575E471C039DBD6"][@"hash_1092BC25E18D296F"] ) and f196_arg0 <= f196_local0.maxClients - f196_local0.maxCoDcasterClients then
		return true
	else
		return false
	end
...
CoD.DirectorUtility.CardNavigateToLobby = function ( f198_arg0, f198_arg1, f198_arg2, f198_arg3, f198_arg4 )
	...
	if not f198_local1 or f198_local3 == Enum[@"LobbyMainMode"][@"hash_6D5FBB8D74AC6D62"] then
		return 
	end
	...
	if IsLobbyNetworkModeLive() then
		if f198_local0[@"eGameModes"] == Enum[@"eGameModes"][@"hash_3EF1485A96433A7"] then
		...
		elseif f198_local4 > LuaDefine.INVALID_PLAYLIST_ID then
			if f198_local3 == Enum[@"LobbyMainMode"][@"hash_37B50049993542C0"] then
				local f198_local5 = Engine[@"hash_63ACB99DBAD24D55"]( f198_local4 ) --[[ @ 0]]
				Dvar[@"hash_78D438D99BE5C86F"]:set( f198_local5.rotationList[1].map ) --[[ @ 0]]
			else
				if f198_local3 == Enum[@"LobbyMainMode"][@"hash_378C124999125C42"] then
					local f198_local5 = Engine[@"GetGlobalModel"]() --[[ @ 0]]
					f198_local5 = f198_local5.lobbyRoot.lobbyList.playerCount:get() --[[ @ 0]]
					local f198_local6 = Engine[@"hash_63ACB99DBAD24D55"]( f198_local4 ) --[[ @ 0]]
					if not f198_local6 or f198_local5 > f198_local6.maxPartySize then
						return 
					end
				end
				if f198_local3 == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] then
					Engine[@"hash_787AE7E64BA5AD61"]( "OnGameLobbyGameServerDataUpdate", {} ) --[[ @ 0]]
				end
			end
			if IsArenaMode() then
				Engine[@"hash_195FA783443EBEC3"]( f198_arg2 ) --[[ @ 0]]
				...
				if f198_local0[@"name"] ~= f198_local5 then
					...
					Engine[@"hash_5CE25A90DC553200"]( f198_local4 ) --[[ @ 0]]
...
CoD.DirectorUtility.NavigateToCustomLobbyForCurrentMode = function ( f201_arg0, f201_arg1 )
	...
	local f201_local2 = f201_local1[@"hash_EB7DDC7F079D51B"] --[[ @ 0]]
	if f201_local2 then
		if IsLobbyNetworkModeLive() then
			if IsArenaMode() then
...
CoD.DirectorUtility.NavigateToCustomLobby = function ( f202_arg0, f202_arg1, f202_arg2, f202_arg3 )
	CoD.DirectorUtility.NavigateToCustomLobbyForMode( f202_arg0, f202_arg1, f202_arg2, f202_arg3, Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"] ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.DirectorUtility.NavigateToPrivateLobbyForCurrentMode = function ( f203_arg0, f203_arg1 )
	...
	local f203_local2 = f203_local1[@"hash_EB7DDC7F079D51B"] --[[ @ 0]]
...
CoD.DirectorUtility.IsSessionModeAvailable = function ( f204_arg0, f204_arg1 )
	if Engine[@"hash_77D47312EBA41751"]() or Engine[@"hash_5CB675CA7856DA25"]() then
		return f204_arg1 == Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"]
	else
...
CoD.DirectorUtility.GetTrialEndDate = function ()
	return Dvar[@"hash_5406048B77730F50"]:get()
end
 --[[ @ 0]]
...
CoD.DirectorUtility.NavigateToArenaLobby = function ( f210_arg0, f210_arg1, f210_arg2, f210_arg3 )
	...
	local f210_local1 = Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"] --[[ @ 0]]
...
CoD.DirectorUtility.NavigateToArenaMatchmakingLobby = function ( f211_arg0, f211_arg1, f211_arg2, f211_arg3 )
	...
	local f211_local1 = Enum[@"LobbyMainMode"][@"hash_37E41449995CD57E"] --[[ @ 0]]
...
CoD.DirectorUtility.SetPrivatePartySuggestion = function ( f212_arg0, f212_arg1 )
	...
	local f212_local2 = Enum[@"LobbyType"][@"hash_20A1647599284110"] --[[ @ 0]]
...
CoD.DirectorUtility.ClearPrivatePartySuggestion = function ( f213_arg0, f213_arg1 )
	Engine[@"hash_91B6247B44FCAFE"]( f213_arg0, Enum[@"LobbyType"][@"hash_20A1647599284110"], LuaDefine.INVALID_PLAYLIST_ID ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.DirectorUtility.IsPlaylistSuggestedBySelf = function ( f214_arg0, f214_arg1 )
	...
	return f214_local2.LobbyClients[Engine[@"hash_75065E759595C457"]( f214_local1 )].playerSuggestion:get() == f214_local0
end
 --[[ @ 0]]
CoD.DirectorUtility.IsPlaylistCardRestricted = function ( f215_arg0, f215_arg1 )
	...
	if f215_local1 and f215_local1.playlist then
		...
		local f215_local3 = Engine[@"hash_1BD0797FECF76174"]( f215_local2 ) --[[ @ 0]]
		local f215_local4 = Engine[@"hash_6B2BAD8AD577224E"]( f215_local2 ) --[[ @ 0]]
...
CoD.DirectorUtility.ClearSelectedClient = function ( f220_arg0 )
	...
	f220_local0:set( Enum[@"team_t"][@"hash_697263B3C1ABADF7"] ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.DirectorUtility.InitPublicLobbyModels = function ( f230_arg0, f230_arg1, f230_arg2 )
	...
	f230_local1:set( Dvar[@"hash_4A0A01C39967B404"]:get() / 1000 ) --[[ @ 0]]
...
CoD.DirectorUtility.GetMatchMakingMatchStartTimeString = function ( f233_arg0 )
	return Engine[@"hash_4F9F1239CFD921FE"]( @"hash_2054799E48E26840", f233_arg0 )
end
 --[[ @ 0]]
...
CoD.DirectorUtility.ConvertLobbyMainModeToModeOrArenaString = function ( f235_arg0 )
	...
	if f235_local0 == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] and LuaUtils.IsArenaMode() then
...
CoD.DirectorUtility.LobbyPlayerColorByXUID = function ( f238_arg0 )
	return CoD.ColorUtility.ConvertTableToRGB( Engine[@"hash_60041DC2CF4139D7"]( f238_arg0 ) and ColorSet.PlayerYellow or ColorSet.T8__OFF__GRAY )
end
 --[[ @ 0]]
...
CoD.DirectorUtility.LobbyPlayerColorByXUIDElseDefaultSelfModel = function ( f240_arg0, f240_arg1, f240_arg2, f240_arg3, f240_arg4 )
	if f240_arg0 then
		...
		if f240_local1 ~= nil and Engine[@"hash_60041DC2CF4139D7"]( f240_local1 ) then
...
CoD.DirectorUtility.LobbyPlayerColorByXUIDElseDefaultControllerModel = function ( f241_arg0, f241_arg1, f241_arg2, f241_arg3, f241_arg4 )
	...
	if f241_local2 and Engine[@"hash_60041DC2CF4139D7"]( f241_local2 ) then
		return CoD.ColorUtility.ConvertTableToRGB( ColorSet.PlayerYellow )
	else
...
CoD.DirectorUtility.CPOnlineNewGame = function ( f245_arg0, f245_arg1, f245_arg2, f245_arg3 )
	...
	Engine[@"SetFirstTimeComplete"]( f245_arg2, Enum[@"eModes"][@"hash_360063C67132EB69"], false ) --[[ @ 0]]
...
CoD.DirectorUtility.ShowDirectorCustomLobbyModeNav = function ( f249_arg0, f249_arg1 )
	...
	elseif LobbyConnectedToDedicatedHost() then
		...
		return Engine[@"hash_10EA2BE00F49480D"]( f249_local0[@"LobbyType"] )
	end
end
 --[[ @ 0]]
...
CoD.DirectorUtility.ZombieLimitedShouldOpenStore = function ( f255_arg0 )
	local f255_local0 --[[ @ 0]]
	if f255_arg0 == Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] then
...
CoD.DirectorUtility.ModifyAmplitudeBasedOnVoipStatus = function ( f256_arg0, f256_arg1, f256_arg2, f256_arg3 )
	f256_arg1:linkToElementModel( f256_arg0, "voipStatus", true, function ( model )
		...
		if f256_arg1._previousValue <= f257_local1 then
			f256_arg1:beginAnimation( f256_arg3, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
		else
			f256_arg1:beginAnimation( f256_arg2, Enum[@"hash_1F50FFF429AB1890"][@"hash_66F6186B702830BC"] ) --[[ @ 0]]
		end
...
CoD.DirectorUtility.IsOfflineDemo = function ()
	local f261_local0 --[[ @ 0]]
	if not CoD.isPC and LuaUtils.GetDisplayNameForLobbyMainMode( Enum[@"LobbyMainMode"][@"hash_379D01499920B292"] ) == @"hash_0" and not LuaUtils.OnlineOnlyDemo() then
...
CoD.DirectorUtility.IsNumClientsExceeded = function ( f264_arg0 )
	if IsLobbyNetworkModeLive() then
		...
		local f264_local1 = Engine[@"hash_63ACB99DBAD24D55"]( f264_local0:get() ) --[[ @ 0]]
...
CoD.DirectorUtility.OpenTooManyClientsPopup = function ( f265_arg0, f265_arg1 )
	if IsLobbyNetworkModeLive() then
		...
		local f265_local1 = Engine[@"hash_63ACB99DBAD24D55"]( f265_local0:get() ) --[[ @ 0]]
		OpenGenericSmallPopup( f265_arg0, f265_arg1, Engine[@"hash_4F9F1239CFD921FE"]( @"hash_5D0CB6ADB37BED49" ), Engine[@"hash_4F9F1239CFD921FE"]( @"hash_6128045808A178F3", f265_local1.maxPartySize ), nil, CoD.isPC and Engine[@"hash_4F9F1239CFD921FE"]( @"hash_25BE4A02B20F31F1" ) or nil ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.DirectorUtility.AllClientsOwnDLCForPlaylist = function ( f266_arg0 )
	...
	if IsLobbyNetworkModeLive() then
		...
		local f266_local2 = Engine[@"hash_63ACB99DBAD24D55"]( f266_local1:get() ) --[[ @ 0]]
...
CoD.DirectorUtility.OpenMapsNotEnabledPopup = function ( f268_arg0, f268_arg1 )
	OpenGenericSmallPopup( f268_arg0, f268_arg1, Engine[@"hash_4F9F1239CFD921FE"]( @"hash_5D0CB6ADB37BED49" ), Engine[@"hash_4F9F1239CFD921FE"]( @"hash_1C103184D0E20B3B" ), nil, CoD.isPC and Engine[@"hash_4F9F1239CFD921FE"]( @"hash_25BE4A02B20F31F1" ) or nil ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.DirectorUtility.SetLocalClientsReady = function ()
	...
	for f270_local4 = f270_local0 --[[ @ 0]], f270_local1, 1 do
		Engine[@"hash_1E4F48ADE95237E7"]( f270_local4, f270_local3, not Engine[@"hash_D9A83F15CB8D41B"]( Engine[@"hash_10EA2BE00F49480D"]( f270_local3 ) and Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] or Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f270_local3, f270_local4 ) ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.DirectorUtility.SetPlayerReady = function ( f271_arg0 )
	...
	local f271_local2 = Engine[@"hash_D9A83F15CB8D41B"]( Engine[@"hash_10EA2BE00F49480D"]( f271_local1 ) and Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] or Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f271_local1, f271_arg0 ) --[[ @ 0]]
	...
	for f271_local5 = f271_local3 --[[ @ 0]], f271_local4, 1 do
		if Engine[@"IsControllerBeingUsed"]( f271_local5 ) then
			Engine[@"hash_1E4F48ADE95237E7"]( f271_local5, f271_local1, not f271_local2 ) --[[ @ 0]]
		end
	end
end
 --[[ @ 0]]
CoD.DirectorUtility.GetPlayerReady = function ( f272_arg0 )
	...
	return Engine[@"hash_D9A83F15CB8D41B"]( Engine[@"hash_10EA2BE00F49480D"]( f272_local1 ) and Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] or Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f272_local1, f272_arg0 )
end
 --[[ @ 0]]
CoD.DirectorUtility.CanReadyUp = function ( f273_arg0 )
	...
	local f273_local2 --[[ @ 0]]
	if not Engine[@"hash_D9A83F15CB8D41B"]( Engine[@"hash_10EA2BE00F49480D"]( f273_local1 ) and Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] or Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f273_local1, f273_arg0 ) then
...
CoD.DirectorUtility.CanReadyDown = function ( f274_arg0 )
	...
	return Engine[@"hash_D9A83F15CB8D41B"]( Engine[@"hash_10EA2BE00F49480D"]( f274_local1 ) and Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] or Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f274_local1, f274_arg0 ) and CoD.DirectorUtility.InReadyStage( f274_arg0 )
end
 --[[ @ 0]]
...
CoD.DirectorUtility.GetPrivateMatchName = function ( f276_arg0 )
	if f276_arg0 then
		return @"hash_2B666A1A7DCE3FD8"
	else
		return @"hash_550AE8D52A8AA406"
	end
end
 --[[ @ 0]]
...
CoD.DirectorUtility.AddFeaturedWidgetListAction = function ( f278_arg0, f278_arg1, f278_arg2 )
	f278_arg0:AddButtonCallbackFunction( f278_arg0, f278_arg2, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, function ( element, menu, controller, model )
...
CoD.DirectorUtility.GetMainModeByLobbyNav = function ()
	...
	if f281_local1 then
		return f281_local1[@"hash_EB7DDC7F079D51B"]
	else
		return Enum[@"LobbyMainMode"][@"hash_6D5FBB8D74AC6D62"]
	end
end
 --[[ @ 0]]
		...
		if IsZombies() and CoD.ZombieUtility then
			...
			if f286_local6 and f286_local6:get() then
				...
				if f286_local7 then
					...
					if f286_local8 then
						local f286_local9 = Engine[@"GetHeroBundleInfo"]( Enum[@"eModes"][@"hash_73723205FAE52C4A"], f286_local8 ) --[[ @ 0]]
...
CoD.DirectorUtility.IsInvalidLobbyClientInfo = function ( f289_arg0, f289_arg1 )
	...
	local f289_local2 --[[ @ 0]]
	if f289_local0 ~= nil and f289_local0 ~= f289_local1.LobbyClients:create( Engine[@"hash_75065E759595C457"]( LuaDefine.INVALID_XUID_X64 ) ) then
		f289_local2 = false --[[ @ 0]]
	else
		f289_local2 = true --[[ @ 0]]
	end
...
CoD.DirectorUtility.IsHostOfLobbyType = function ( f290_arg0 )
	return Engine[@"hash_10EA2BE00F49480D"]( f290_arg0 )
end
 --[[ @ 0]]
...
CoD.OverlayUtility.AddAutoDetectOverlay( "AppLoadoutConfirmLoadout", {
	...
	options = function ()
		local f297_local0 = function ( f298_arg0, f298_arg1 )
			...
			CoD.DirectorUtility.AcceptAppLoadout( f298_arg1, Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] ) --[[ @ 0]]
		...
		table.insert( f297_local2, {
			text = @"hash_40BD872543F8A833",
			action = f297_local0
		} ) --[[ @ 0]]
		table.insert( f297_local2, {
			text = @"hash_1FD0A4EC72EF5F3F",
			action = f297_local1
		} ) --[[ @ 0]]
		return f297_local2
	end
...
CoD.DirectorUtility.AppLoadoutReady = function ( f301_arg0 )
	...
	elseif Engine[@"StorageIsFileReady"]( f301_arg0, Enum[@"StorageFileType"][@"hash_5492E24872A65D74"] ) then
		...
		if f301_local0 and f301_local0.loadoutVersion:get() == Dvar[@"hash_62C3C580035FD180"]:get() then
			return true
		end
	end
	return false
...
CoD.DirectorUtility.AcceptAppLoadout = function ( f305_arg0, f305_arg1 )
	if f305_arg1 ~= Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] then
		return 
	end
	local f305_local0 = Engine[@"StorageGetBuffer"]( f305_arg0, Enum[@"StorageFileType"][@"hash_16C886CEB6BF4BCA"] ) --[[ @ 0]]
	...
	if f305_local0 and f305_local1 then
		...
		if f305_local2 and f305_local3 then
			for f305_local6 = Enum[@"hash_733AC0FF9A1537DE"][@"hash_3B269FFE65DEF21C"] --[[ @ 0]], Enum[@"hash_733AC0FF9A1537DE"][@"hash_63618B16E81F1FBD"] - 1, 1 do
			...
			Engine[@"hash_2E6C09FDF6C8D188"]( f305_arg0, f305_arg1 ) --[[ @ 0]]
		end
	end
end
 --[[ @ 0]]
CoD.DirectorUtility.CreditsPostLoad = function ( f306_arg0, f306_arg1 )
	...
	local f306_local7 = function ()
	 ...
	 --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_1057783F8DA4AAEF"], nil, f306_local6, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_24B11D2B20C75A7F"], nil, f306_local6, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_4571F08AD84807E0"], nil, f306_local6, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_6D4C15FE32148D3A"], nil, f306_local6, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ESCAPE", f306_local5, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	if LUI.DEV == nil then
		f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	end
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_222361E23588705A"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_249A252B20B48936"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_16CE8023188D673F"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_229E5695FF1401AD"], nil, f306_local4, f306_local0, false ) --[[ @ 0]]
	f306_arg0:AddButtonCallbackFunction( f306_arg0, f306_arg1, Enum[@"LUIButton"][@"hash_3865DD2DB1EFE9F8"], "SPACE", f306_local7, false, false ) --[[ @ 0]]
	local f306_local8 = {
		x = false,
		y = false
	} --[[ @ 0]]
...
CoD.DirectorUtility.LiveEventViewerPreLoad = function ( f318_arg0, f318_arg1 )
	...
	local f318_local8 = function ( f327_arg0, f327_arg1, f327_arg2, f327_arg3 )
		if PropertyIsTrue( f318_arg0, "showPrompt" ) then
			if IsChildElementInState( f327_arg1, "LiveEventViewerMovieAndBackground", "Windowed" ) then
				...
				CoD.Menu.UpdateButtonShownState( f327_arg0, f327_arg1, f327_arg2, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"] ) --[[ @ 0]]
				return true
			else
	...
	local f318_local9 = function ( f328_arg0, f328_arg1, f328_arg2, f328_arg3 )
	 ...
	 --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_1057783F8DA4AAEF"], nil, f318_local9, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_24B11D2B20C75A7F"], nil, f318_local9, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_4571F08AD84807E0"], nil, f318_local9, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_6D4C15FE32148D3A"], nil, f318_local9, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], nil, f318_local5, f318_local0, false ) --[[ @ 0]]
	if LUI.DEV == nil then
		f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_593AB4C84F113EE1"], nil, f318_local5, f318_local0, false ) --[[ @ 0]]
	end
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_222361E23588705A"], nil, f318_local5, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_2493152B20AE4F58"], nil, f318_local5, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_249A252B20B48936"], nil, f318_local5, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], nil, f318_local5, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], nil, f318_local5, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_16CE8023188D673F"], nil, f318_local5, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_229E5695FF1401AD"], nil, f318_local5, f318_local0, false ) --[[ @ 0]]
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"], nil, f318_local6, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum[@"LUIButton"][@"hash_1805EFA15E9E7E5A"], @"hash_382A84E964320CF4" ) --[[ @ 0]]
		return true
	end, false ) --[[ @ 0]]
	if f318_local7 then
		f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], nil, squareButtonPress, function ( element, menu, controller )
	...
	f318_arg0:AddButtonCallbackFunction( f318_arg0, f318_arg1, Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"], nil, f318_local8, function ( element, menu, controller )
