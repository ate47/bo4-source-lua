...
CoD.JobFeedUtility.OnJobFeedItemInserted = function ( f5_arg0, f5_arg1 )
	...
	f5_local3.medalAsset:set( Engine[@"TableLookup"]( CoD.scoreInfoTable, Enum[@"hash_1D4C3CD6D885D4E5"][@"hash_3B237CBC52108354"], Enum[@"hash_1D4C3CD6D885D4E5"][@"hash_406F5F59B9644339"], f5_arg0._scriptRef ) or @"hash_0" ) --[[ @ 0]]
...
CoD.JobFeedUtility.GetJobType = function ( f11_arg0 )
	return Engine[@"hash_25DC2BA4A99CE43E"]( CoD.scoreInfoTable, f11_arg0, Enum[@"hash_1D4C3CD6D885D4E5"][@"hash_406DD2AD27B53BEB"] )
end
 --[[ @ 0]]
...
CoD.JobFeedUtility.JobFeedEventReceived = function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
	...
	if f13_local0 then
		...
		if f13_local2 then
			...
			local f13_local3 = Engine[@"hash_25DC2BA4A99CE43E"]( CoD.scoreInfoTable, f13_local0, Enum[@"hash_1D4C3CD6D885D4E5"][@"hash_406F5F59B9644339"] ) --[[ @ 0]]
			if f13_arg1 == "challenge_coin_received" then
				local f13_local4 = Engine[@"hash_25DC2BA4A99CE43E"]( CoD.scoreInfoTable, f13_local0, Enum[@"hash_1D4C3CD6D885D4E5"][@"hash_C4972E817CC8B90"] ) --[[ @ 0]]
				local f13_local5 = Engine[@"hash_25DC2BA4A99CE43E"]( CoD.scoreInfoTable, f13_local0, Enum[@"hash_1D4C3CD6D885D4E5"][@"hash_1FE69ECFC89EDE2A"] ) --[[ @ 0]]
				local f13_local6 = Engine[@"hash_25DC2BA4A99CE43E"]( CoD.scoreInfoTable, f13_local0, Enum[@"hash_1D4C3CD6D885D4E5"][@"hash_3B237CBC52108354"] ) --[[ @ 0]]
				local f13_local7 = Engine[@"hash_25DC2BA4A99CE43E"]( CoD.scoreInfoTable, f13_local0, Enum[@"hash_1D4C3CD6D885D4E5"][@"hash_12B88D3D2E541010"] ) --[[ @ 0]]
				...
				if f13_local4 == @"base" or f13_local4 == @"hash_2F312C483C3CB8A9" then
					CoD.JobFeedUtility.JobFeedIncrementBaseMedalGroup( f13_local2, f13_local3 ) --[[ @ 0]]
					if f13_local4 == @"hash_2F312C483C3CB8A9" then
				...
				elseif f13_local4 == @"hash_354A663DF6E5DEB5" then
					if f13_local5 ~= @"hash_0" then
						CoD.JobFeedUtility.CashInJob( f13_local2, f13_local5, {
							medalAssetName = f13_local6,
							comboCashIn = true
				...
				elseif f13_local4 == @"hash_75E13205E2BDEAE5" then
