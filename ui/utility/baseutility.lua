...
CoD.BaseUtility.InvalidXHash = Engine[@"hash_48506F73B393062F"]( 0 ) --[[ @ 0]]
...
CoD.BaseUtility.SwitchModeOnMenu = function ( f47_arg0 )
	...
	CoD.BaseUtility.SwitchMode( f47_arg0, LuaUtils.GetEModeForLobbyMainMode( f47_local0[@"hash_EB7DDC7F079D51B"] ) ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.BaseUtility.GetGameModeOnMapNameString = function ( f54_arg0, f54_arg1 )
	return Engine[@"hash_4F9F1239CFD921FE"]( @"hash_59547CB092095AC0", Engine[@"hash_4F9F1239CFD921FE"]( CoD.GameTypeUtility.GetGameTypeValue( f54_arg0, "nameRef", @"hash_0" ) ), CoD.MapUtility.GetMapValue( f54_arg1, "mapName", @"hash_0" ) )
end
 --[[ @ 0]]
...
CoD.BaseUtility.SetStateByMenuSessionMode = function ( f98_arg0, f98_arg1, f98_arg2 )
	...
	if f98_local0 == Enum[@"eModes"][@"hash_360063C67132EB69"] then
		f98_arg1:setState( f98_arg2, "Campaign" ) --[[ @ 0]]
	elseif f98_local0 == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] then
...
CoD.BaseUtility.GetCurrentSessionModeString = function ()
	...
	if f99_local0 == Enum[@"eModes"][@"hash_360063C67132EB69"] then
		return "cp"
	elseif f99_local0 == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] then
		return "mp"
	elseif f99_local0 == Enum[@"eModes"][@"hash_73723205FAE52C4A"] then
		return "zm"
	elseif f99_local0 == Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] then
		return "wz"
	else
		return ""
	end
...
CoD.BaseUtility.SmoothLinearInterpolateClientTime = function ( f115_arg0, f115_arg1, f115_arg2, f115_arg3 )
	...
	local f115_local4 = tonumber( Engine[@"hash_64C599F1694E23EF"]( f115_local3 - f115_local0.lastTime ) ) --[[ @ 0]]
	...
	f115_local0.interpolateTimer = LUI.UITimer.newElementTimer( 10, false, function ( f117_arg0 )
		f115_local6 = tonumber( Engine[@"hash_64C599F1694E23EF"]( Engine[@"hash_6316595FEDC72451"]() - f115_local0.lastTime ) ) --[[ @ 0]]
...
CoD.BaseUtility.IsCurrentLanguageRussian = function ()
	local f129_local0 --[[ @ 0]]
	if Dvar[@"loc_language"]:get() ~= Enum[@"hash_2AA0EE37DF15F5A8"][@"language_russian"] and Dvar[@"loc_language"]:get() ~= Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_237F47E9EC48B533"] then
		f129_local0 = false --[[ @ 0]]
	else
		f129_local0 = true --[[ @ 0]]
	end
...
CoD.BaseUtility.IsCurrentLanguageAsian = function ()
	...
	if f130_local0 == Enum[@"hash_2AA0EE37DF15F5A8"][@"language_korean"] or f130_local0 == Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_6518A7E7D67F8C88"] or f130_local0 == Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_7B481FC3055D43A1"] or f130_local0 == Enum[@"hash_2AA0EE37DF15F5A8"][@"hash_39A4194D08679C69"] or f130_local0 == Enum[@"hash_2AA0EE37DF15F5A8"][@"language_japanese"] then
		return true
	else
		return false
	end
