...
CoD.DemoUtility.UpdateDemoCameraMode = function ( f27_arg0, f27_arg1, f27_arg2, f27_arg3, f27_arg4 )
	...
	if f27_arg3 == "next" or f27_arg3 == "cycle" then
		if f27_local0 == Enum[@"democameramode"][@"demo_camera_mode_none"] then
			f27_local1 = Enum[@"democameramode"][@"demo_camera_mode_thirdperson"] --[[ @ 0]]
		elseif f27_local0 == Enum[@"democameramode"][@"demo_camera_mode_thirdperson"] then
			f27_local1 = Enum[@"democameramode"][@"demo_camera_mode_freecam"] --[[ @ 0]]
		elseif f27_arg3 == "cycle" then
			f27_local1 = Enum[@"democameramode"][@"demo_camera_mode_none"] --[[ @ 0]]
		else
			return 
		end
	...
	Engine[@"switchdemocameramode"]( f27_local1 ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.DemoUtility.StartStopRecordClip = function ( f38_arg0, f38_arg1, f38_arg2, f38_arg3, f38_arg4 )
	if Engine[@"isdemocliprecording"]() then
		...
		if Engine[@"isdemocameraeditmode"]() then
			...
			Engine[@"switchdemofreecameramode"]( Enum[@"demofreecameramode"][@"demo_freecam_mode_dolly"] ) --[[ @ 0]]
		end
...
CoD.DemoUtility.UpdateDollyCameraTimeScaleMode = function ( f44_arg0, f44_arg1, f44_arg2, f44_arg3, f44_arg4 )
	...
	if f44_arg3 == "next" or f44_arg3 == "cycle" then
		if f44_local1 == Enum[@"demodollycameratimescalemode"][@"demo_dollycam_timescale_mode_manual"] then
			f44_local2 = Enum[@"demodollycameratimescalemode"][@"demo_dollycam_timescale_mode_linear"] --[[ @ 0]]
		elseif f44_local1 == Enum[@"demodollycameratimescalemode"][@"demo_dollycam_timescale_mode_linear"] then
			f44_local2 = Enum[@"demodollycameratimescalemode"][@"demo_dollycam_timescale_mode_fixed"] --[[ @ 0]]
		elseif f44_arg3 == "cycle" then
			f44_local2 = Enum[@"demodollycameratimescalemode"][@"demo_dollycam_timescale_mode_manual"] --[[ @ 0]]
		else
			return 
		end
...
CoD.DemoUtility.UpdateLightmanLightMode = function ( f54_arg0, f54_arg1, f54_arg2, f54_arg3, f54_arg4 )
	...
	if f54_arg3 == "next" or f54_arg3 == "cycle" then
		if f54_local1 == Enum[@"demolightmanlightmode"][@"demo_lightman_light_mode_omni"] then
			f54_local2 = Enum[@"demolightmanlightmode"][@"demo_lightman_light_mode_spot"] --[[ @ 0]]
		elseif f54_arg3 == "cycle" then
			f54_local2 = Enum[@"demolightmanlightmode"][@"demo_lightman_light_mode_omni"] --[[ @ 0]]
		else
			return 
		end
...
CoD.DemoUtility.DPadDownAction = function ( f97_arg0, f97_arg1, f97_arg2, f97_arg3 )
	...
	f97_local5 = f97_local5.demo.currentDollyCamMarkerTimeScaleMode:get() == Enum[@"demodollycameratimescalemode"][@"demo_dollycam_timescale_mode_manual"] --[[ @ 0]]
...
CoD.DemoUtility.OpenSavePopup = function ( f98_arg0, f98_arg1 )
	...
	if f98_local1 == "demo_save_clip" then
		...
		CoD.FileshareUtility.OpenPrivateUploadPopup( f98_arg0, f98_local2, "screenshot_private", function ( f99_arg0 )
			Engine[@"savescreenshot"]( f99_arg0, false, 0 ) --[[ @ 0]]
		end ) --[[ @ 0]]
	end
	if f98_local0 then
...
CoD.DemoUtility.StartMenuUploadClip = function ( f102_arg0, f102_arg1, f102_arg2, f102_arg3, f102_arg4 )
	local f102_local0 = Engine[@"getdemostreameddownloadprogress"]() --[[ @ 0]]
	if f102_local0 < 100 then
		LuaUtils.ShowMessageDialog( f102_arg2, Enum[@"messagedialogtype"][@"message_dialog_type_error"], Engine[@"hash_4F9F1239CFD921FE"]( @"hash_3166EE50B1458BCD", math.floor( f102_local0 ) ), Engine[@"hash_4F9F1239CFD921FE"]( @"menu/notice" ) ) --[[ @ 0]]
		return 
	else
		...
		CoD.FileshareUtility.OpenPrivateUploadPopup( f102_arg0, f102_arg2, "clip_private", function ( f103_arg0 )
			Engine[@"saveanduploadclip"]( f103_arg0, 0 ) --[[ @ 0]]
		end ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.DemoUtility.SetupUIModels = function ( f112_arg0 )
	...
	f112_local1:set( Enum[@"democameramode"][@"demo_camera_mode_none"] ) --[[ @ 0]]
	if Engine[@"isdemoclipplaying"]() then
		f112_local1 = f112_local0:create( "contextMode" ) --[[ @ 0]]
		f112_local1:set( Enum[@"democontextmode"][@"demo_context_mode_playback"] ) --[[ @ 0]]
	elseif Engine[@"isdemohighlightreelmode"]() then
		f112_local1 = f112_local0:create( "contextMode" ) --[[ @ 0]]
		f112_local1:set( Enum[@"democontextmode"][@"demo_context_mode_highlight_reel"] ) --[[ @ 0]]
	else
		f112_local1 = f112_local0:create( "contextMode" ) --[[ @ 0]]
		f112_local1:set( Enum[@"democontextmode"][@"demo_context_mode_basic"] ) --[[ @ 0]]
	end
...
CoD.DemoUtility.AddHUDWidgets = function ( f114_arg0, f114_arg1 )
	local f114_local0 = Engine[@"isdemoplaying"]() --[[ @ 0]]
	...
	if f114_local0 then
		...
		elseif f114_arg1.openHighlightStartScreen then
			...
			if Engine[@"getnumberofhighlightreelmoments"]() > 0 then
				...
				LuaUtils.ShowMessageDialog( f114_local1, Enum[@"messagedialogtype"][@"message_dialog_type_error"], Engine[@"hash_4F9F1239CFD921FE"]( @"hash_704F1B56A7BD9CDF" ), Engine[@"hash_4F9F1239CFD921FE"]( @"menu/notice" ) ) --[[ @ 0]]
				Dvar[@"demo_pause"]:set( true ) --[[ @ 0]]
			end
		end
		if CoD.isPC then
...
CoD.DemoUtility.SetupDemoSegmentModel = function ( f116_arg0 )
	...
	local f116_local6 = Engine[@"getdemosegmentcount"]() --[[ @ 0]]
	...
	if f116_arg0 < f116_local6 then
		f116_local0 = Engine[@"getdemosegmentinformation"]( f116_arg0, "name" ) --[[ @ 0]]
		f116_local1 = Engine[@"getdemosegmentinformation"]( f116_arg0, "durationTimeDisplay" ) --[[ @ 0]]
		f116_local2 = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/transition" ) .. Engine[@"getdemosegmentinformation"]( f116_arg0, "transition" ) --[[ @ 0]]
		if Engine[@"isdemohighlightreelmode"]() then
			local f116_local10 = tonumber( Engine[@"getdemosegmentinformation"]( f116_arg0, "score" ) ) --[[ @ 0]]
			local f116_local11 = tonumber( Engine[@"getdemosegmentinformation"]( f116_arg0, "stars" ) ) --[[ @ 0]]
...
CoD.DemoUtility.Timeline_GetSelectedSegmentModel = function ()
	local f118_local0 = Engine[@"getdemosegmentcount"]() --[[ @ 0]]
...
CoD.DemoUtility.Timeline_GetHighlightedSegmentModel = function ()
	local f119_local0 = Engine[@"getdemosegmentcount"]() --[[ @ 0]]
...
CoD.DemoUtility.TimelineEditor_AddTimeline = function ( f129_arg0 )
	local f129_local0 = Engine[@"getdemosegmentcount"]() --[[ @ 0]]
	local f129_local1 = Engine[@"getdemosegmentinformation"]( 0, "totalClipDuration" ) --[[ @ 0]]
	...
	for f129_local7 = 1 --[[ @ 0]], f129_local0, 1 do
		local f129_local10 = Engine[@"getdemosegmentinformation"]( f129_local7 - 1, "duration" ) / f129_local1 * f129_local4 --[[ @ 0]]
...
CoD.DemoUtility.TimelineEditorPostLoad = function ( f133_arg0, f133_arg1 )
	local f133_local0 = function ( f134_arg0, f134_arg1 )
		if Engine[@"getdemosegmentcount"]() <= 0 then
			...
			if f134_arg0.ClipEndTime then
				f134_arg0.ClipEndTime.Text:setText( Engine[@"getdemosegmentinformation"]( 0, "totalClipDurationTimeDisplay" ) ) --[[ @ 0]]
			end
		end
	end
	 --[[ @ 0]]
...
CoD.DemoUtility.TimelineEditorPlaceSegment = function ( f136_arg0, f136_arg1, f136_arg2, f136_arg3, f136_arg4 )
	...
	if f136_arg3 == true then
		...
		if f136_local3 ~= f136_local4 then
			...
			for f136_local5 = 1 --[[ @ 0]], Engine[@"getdemosegmentcount"](), 1 do
...
CoD.DemoUtility.RebuildHighlightReelTimeline = function ( f141_arg0 )
	...
	CoD.DemoUtility.SetNumHighlightReelMomentsModel( Engine[@"getnumberofhighlightreelmoments"]() ) --[[ @ 0]]
end
 --[[ @ 0]]
