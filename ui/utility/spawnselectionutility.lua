...
CoD.SpawnSelectionUtility.PositionMarker = function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
	if f10_arg2 then
		...
		local f10_local2, f10_local3, f10_local4, f10_local5 = Engine[@"getcompasscorners"]( f10_arg1 ) --[[ @ 0]]
		local f10_local6, f10_local7 = Engine[@"getcompassnorth"]( f10_arg1 ) --[[ @ 0]]
...
CoD.SpawnSelectionUtility.ResizeSpawnRadius = function ( f22_arg0, f22_arg1, f22_arg2 )
	...
	local f22_local2, f22_local3, f22_local4, f22_local5 = Engine[@"getcompasscorners"]( f22_arg2 ) --[[ @ 0]]
	local f22_local6, f22_local7 = Engine[@"getcompassnorth"]( f22_arg2 ) --[[ @ 0]]
	...
	local f22_local9 = Engine[@"hash_2E00B2F29271C60B"]( @"default_spawnbeacon_settings" ) --[[ @ 0]]
	local f22_local10 = f22_local9[@"collectionradiusmax"] --[[ @ 0]]
			...
			if not f23_local4 then
				...
				if f23_local0 then
					...
					if not f23_local4 then
						...
						f23_local2( f23_local3, f23_local4 ) --[[ @ 0]]
						f23_local1.KeyPrompt.keybind:setText( Engine[@"hash_4F9F1239CFD921FE"]( @"key/space" ) ) --[[ @ 0]]
...
CoD.SpawnSelectionUtility.SetupSpawnSelectControls = function ( f42_arg0, f42_arg1, f42_arg2, f42_arg3 )
	...
	local f42_local1 = function ( f46_arg0 )
	 ...
	 --[[ @ 0]]
	f42_arg3:subscribeToModel( Engine[@"getmodel"]( Engine[@"getmodelforcontroller"]( f42_arg1 ), "ButtonBits." .. Enum[@"luibutton"][@"lui_key_xba_pscross"] ), f42_local1, false ) --[[ @ 0]]
	f42_arg3:subscribeToModel( Engine[@"getmodel"]( Engine[@"getmodelforcontroller"]( f42_arg1 ), "ButtonBits." .. Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ), f42_local1, false ) --[[ @ 0]]
	if CoD.isPC then
		...
		f42_arg3:subscribeToModel( Engine[@"getmodel"]( Engine[@"getmodelforcontroller"]( f42_arg1 ), "KeyPressBits.ESCAPE" ), function ( model )
			...
			local f48_local1 = CoD.BitUtility.IsBitwiseAndNonZero( f48_local0, Enum[@"luibuttonflags"][@"flag_down"] ) --[[ @ 0]]
			local f48_local2 = CoD.BitUtility.IsBitwiseAndNonZero( f48_local0, Enum[@"luibuttonflags"][@"flag_isrepeat"] ) --[[ @ 0]]
...
CoD.SpawnSelectionUtility.InitTimeLimit = function ( f65_arg0, f65_arg1, f65_arg2 )
	local f65_local0 = Engine[@"getdvarfloat"]( "spawnselect_timelimit_ms" ) --[[ @ 0]]
	if not f65_local0 or f65_local0 == 0 then
		f65_local0 = CoD.SpawnSelectionUtility.SPAWNSELECT_TIMELIMIT_MS --[[ @ 0]]
	end
	local f65_local1 = Engine[@"getservertime"]( f65_arg1 ) --[[ @ 0]]
...
CoD.SpawnSelectionUtility.SetupSpawnTimer = function ( f70_arg0, f70_arg1, f70_arg2 )
	...
	local f70_local1 = function ()
		...
		local f72_local1 = f70_arg0._endTime - Engine[@"getservertime"]( f70_arg1 ) --[[ @ 0]]
	...
	f70_arg0:subscribeToGlobalModel( f70_arg1, "HUDItems", "spawnSelectEndTime", function ( model )
		...
		if f73_local0 ~= nil then
			...
			local f73_local2 = f73_local1 - Engine[@"getservertime"]( f70_arg1 ) --[[ @ 0]]
