...
CoD.NotificationUtility.InitNotifications = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	f3_arg0:subscribeToGlobalModel( f3_arg1, "PerController", "scriptNotify", function ( model )
		...
		elseif f4_local0 == @"medal_received" then
			if (Engine[@"getdvarbool"]( "ui_show_medals" ) or Engine[@"isshipbuild"]()) and CoD.JobFeedUtility.GetJobType( f4_local1.data[1] ) == @"hash_0" and (CoD.HUDUtility.FullscreenController == nil or f3_arg1 == CoD.HUDUtility.FullscreenController) then
	...
	if IsMultiplayer() then
		...
		f3_arg0:subscribeToModel( f3_local3["UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_demo_camera_mode_moviecam"]], f3_local2 ) --[[ @ 0]]
		f3_arg0:subscribeToModel( f3_local3["UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_demo_all_game_hud_hidden"]], f3_local2 ) --[[ @ 0]]
		f3_arg0:subscribeToModel( f3_local3["UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_team_spectator"]], f3_local2 ) --[[ @ 0]]
...
CoD.NotificationUtility.CreateNotification.WeaponLevelUp = function ( f15_arg0, f15_arg1, f15_arg2 )
	...
	f15_local0:set( Engine[@"hash_4F9F1239CFD921FE"]( @"mpui/level_n", f15_arg1.rank + 2 ) ) --[[ @ 0]]
	...
	if f15_local0 then
		...
		if not f15_local1 then
			...
			if f15_arg1.rewardXP and f15_arg1.rewardXP > 0 then
				f15_arg0.NotificationRewardQueue:addReward( CoD.NotificationUtility.AccentColors[f15_arg1.type], CoD.NotificationUtility.XPRewardImage, Engine[@"hash_4F9F1239CFD921FE"]( @"rank/xp", f15_arg1.rewardXP ) ) --[[ @ 0]]
			end
...
CoD.NotificationUtility.CreateNotification.RankUp = function ( f16_arg0, f16_arg1, f16_arg2 )
	...
	f16_local3:set( Engine[@"hash_4F9F1239CFD921FE"]( @"mpui/level_n", f16_local1 ) ) --[[ @ 0]]
	...
	if f16_arg1.rewardXP and f16_arg1.rewardXP > 0 then
		f16_arg0.NotificationRewardQueue:addReward( CoD.NotificationUtility.AccentColors[f16_arg1.type], CoD.NotificationUtility.XPRewardImage, Engine[@"hash_4F9F1239CFD921FE"]( @"rank/xp", f16_arg1.rewardXP ) ) --[[ @ 0]]
	end
		...
		for f18_local13, f18_local14 in ipairs( f18_local8.pinnedContracts[f18_local7] ) --[[ @ 0]] do
			if f18_local14.id == f18_arg1.contractId then
				if f18_local14.xpAmount and f18_local14.xpAmount > 0 then
					f18_arg0.NotificationRewardQueue:addReward( CoD.NotificationUtility.AccentColors[f18_arg1.type], CoD.NotificationUtility.XPRewardImage, Engine[@"hash_4F9F1239CFD921FE"]( @"rank/xp", f18_local14.xpAmount ) ) --[[ @ 0]]
				end
...
CoD.NotificationUtility.GetMedalData = function ( f20_arg0 )
	...
	if f20_local1 and f20_local1 ~= @"hash_0" then
		...
		if f20_local2 then
			...
			f20_local0.iconSmall = f20_local2[@"iconsmall"] --[[ @ 0]]
			f20_local0.iconLarge = f20_local2[@"iconlarge"] --[[ @ 0]]
			f20_local0.widgetName = f20_local2[@"widget"] --[[ @ 0]]
...
CoD.NotificationUtility.ReadyEventsPostLoad = function ( f47_arg0, f47_arg1 )
	...
	f47_arg0.appendNotification = function ( f51_arg0, f51_arg1 )
		...
		elseif f51_arg0.currentNotification ~= nil then
			local f51_local1 = Engine[@"milliseconds"]() - f51_arg0.notificationStartTime --[[ @ 0]]
	...
	LUI.OverrideFunction_CallOriginalSecond( f47_arg0, "playClip", function ( element )
		element.notificationStartTime = Engine[@"milliseconds"]() --[[ @ 0]]
	end ) --[[ @ 0]]
...
CoD.NotificationUtility.InitHealNagNotification = function ( f67_arg0, f67_arg1 )
	...
	local f67_local2 = function ( f70_arg0, f70_arg1 )
		...
		if Engine[@"getdvartype"]( "healNag_minHealthBeforeNag" ) then
			f70_local0 = Engine[@"getdvarint"]( "healNag_minHealthBeforeNag" ) --[[ @ 0]]
		end
	...
	f67_arg0:appendEventHandler( "clip_over", function ( f71_arg0, f71_arg1 )
		...
		if Engine[@"getdvartype"]( "healNag_maxExtraNags" ) then
			f71_local0 = Engine[@"getdvarint"]( "healNag_maxExtraNags" ) --[[ @ 0]]
		end
