...
CoD.CraftUtility.InvalidateWCItemRender = function ( f5_arg0 )
	Engine[@"invalidatewcitemrender"]( f5_arg0 ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CraftUtility.OpenPublishPromptPaintjob = function ( f19_arg0, f19_arg1, f19_arg2, f19_arg3, f19_arg4 )
	local f19_local0 = CoD.CraftUtility.GetDDLRoot( f19_arg2, Enum[@"storagefiletype"][@"storage_paintjobs"], Engine[@"getmodelvalue"]( Engine[@"getmodel"]( CoD.perController[f19_arg2].selectedPaintjobModel, "paintjobSlot" ) ) ) --[[ @ 0]]
	local f19_local1 = "" --[[ @ 0]]
...
CoD.CraftUtility.GetWeaponGroupName = function ( f23_arg0 )
	...
	local f23_local1 = "" --[[ @ 0]]
	if f23_local0 then
		f23_local1 = Engine[@"getitemgroup"]( f23_local0, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
	end
	return f23_local1
end
 --[[ @ 0]]
...
CoD.CraftUtility.Gunsmith.GetSnapshotSessionMode = function ()
	...
	local f28_local1 = Enum[@"emodes"][@"mode_multiplayer"] --[[ @ 0]]
	if f28_local0 then
...
CoD.CraftUtility.Gunsmith.GetWeaponStatList = function ( f34_arg0, f34_arg1, f34_arg2 )
	local f34_local0 = {} --[[ @ 0]]
	local f34_local1 = Engine[@"getitemref"]( f34_arg1, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f34_arg2 ) --[[ @ 0]]
...
CoD.CraftUtility.Gunsmith.GetAttachmentIconList = function ( f43_arg0, f43_arg1, f43_arg2, f43_arg3 )
	return DataSourceHelpers.ListSetup( f43_arg1, function ( f44_arg0 )
		local f44_local0 = {} --[[ @ 0]]
		local f44_local1 = Enum[@"emodes"][@"mode_multiplayer"] --[[ @ 0]]
...
CoD.CraftUtility.Gunsmith.GetWeaponPlusAttachmentsForVariant = function ( f60_arg0, f60_arg1 )
	local f60_local0 = Engine[@"hash_7B98952F69D937F9"]( CoD.GetCustomization( f60_arg0, "weapon_index" ), Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
	local f60_local1 = "" --[[ @ 0]]
	if f60_arg1 then
...
CoD.CraftUtility.Gunsmith.GetWeaponAttachmentList = function ( f61_arg0, f61_arg1 )
	...
	local f61_local1 = Engine[@"getitemref"]( f61_local0, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
	local f61_local2 = {} --[[ @ 0]]
	if f61_arg1 then
...
CoD.CraftUtility.Gunsmith.DisplayWeaponWithPaintjob = function ( f63_arg0, f63_arg1 )
	local f63_local0 = Engine[@"hash_7B98952F69D937F9"]( CoD.GetCustomization( f63_arg0, "weapon_index" ), Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
...
CoD.CraftUtility.Groups.GetTotalAllowed = function ( f72_arg0 )
	if CoD.CraftUtility.EmblemDefaultGroupCategory == CoD.perController[f72_arg0].selectedDecalCategory then
		local f72_local0 = Engine[@"getstoragefileinfo"]( Enum[@"storagefiletype"][@"hash_562F6DBD58F37089"] ) --[[ @ 0]]
...
CoD.CraftUtility.RefreshPaintjobList = function ( f91_arg0 )
	if #CoD.CraftUtility.Paintjobs.CachedPaintjobs == 0 then
		CoD.CraftUtility.Paintjobs.ParseDDL( f91_arg0, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.CraftUtility.Paintjobs.UploadPaintjob = function ( f102_arg0, f102_arg1 )
	...
	local f102_local4 = CoD.CraftUtility.GetDDLRoot( f102_arg0, Enum[@"storagefiletype"][@"storage_paintjobs"], f102_local0 ) --[[ @ 0]]
...
CoD.CraftUtility.Paintjobs.Copy = function ( f104_arg0, f104_arg1 )
	...
	local f104_local4 = CoD.CraftUtility.GetDDLRoot( f104_arg0, Enum[@"storagefiletype"][@"storage_paintjobs"], f104_local0 ) --[[ @ 0]]
	local f104_local5 = CoD.CraftUtility.Paintjobs.GetEmptyPaintjob( f104_local1 ) --[[ @ 0]]
	if f104_local4 ~= nil and f104_local5 ~= nil then
		local f104_local6 = CoD.CraftUtility.GetDDLRoot( f104_arg0, Enum[@"storagefiletype"][@"storage_paintjobs"], f104_local5.paintjobSlot ) --[[ @ 0]]
...
CoD.CraftUtility.Paintjobs.RemovePaintJobFromLoadout = function ( f105_arg0, f105_arg1, f105_arg2, f105_arg3 )
	...
	for f105_local2 = 0 --[[ @ 0]], f105_local1 - 1, 1 do
		...
		if f105_local5 == f105_arg1 then
			f105_local0.customclass[f105_local2].primarypaintjobslot:set( Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
		end
		if f105_local6 == f105_arg1 then
			f105_local0.customclass[f105_local2].secondarypaintjobslot:set( Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
		end
	end
end
 --[[ @ 0]]
CoD.CraftUtility.Paintjobs.RemovePaintJobFromVariantList = function ( f106_arg0, f106_arg1, f106_arg2 )
	for f106_local0 = 0 --[[ @ 0]], f106_arg1 - 1, 1 do
		if f106_arg0.variant[f106_local0].paintjobSlot:get() == f106_arg2 then
			f106_arg0.variant[f106_local0].paintjobSlot:set( Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
		end
	end
end
 --[[ @ 0]]
CoD.CraftUtility.Paintjobs.RemovePaintJobFromZM = function ( f107_arg0, f107_arg1 )
	local f107_local0 = Engine[@"storagegetbuffer"]( f107_arg0, Enum[@"storagefiletype"][@"storage_zm_loadouts"] ) --[[ @ 0]]
...
CoD.CraftUtility.Paintjobs.RemovePaintJobFromAllLoadouts = function ( f108_arg0, f108_arg1 )
	CoD.CraftUtility.Paintjobs.RemovePaintJobFromLoadout( f108_arg0, f108_arg1, Enum[@"storagefiletype"][@"storage_mp_loadouts"], Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
...
CoD.CraftUtility.Paintjobs.ClearPaintjob = function ( f109_arg0, f109_arg1 )
	local f109_local0 = CoD.CraftUtility.GetDDLRoot( f109_arg0, Enum[@"storagefiletype"][@"storage_paintjobs"], f109_arg1 ) --[[ @ 0]]
...
CoD.CraftUtility.Paintjobs.GetPaintjobName = function ( f110_arg0, f110_arg1 )
	local f110_local0 = CoD.CraftUtility.GetDDLRoot( f110_arg0, Enum[@"storagefiletype"][@"storage_paintjobs"], f110_arg1 ) --[[ @ 0]]
...
CoD.CraftUtility.Paintjobs.RenamePaintjob = function ( f111_arg0, f111_arg1, f111_arg2 )
	local f111_local0 = Enum[@"storagefiletype"][@"storage_paintjobs"] --[[ @ 0]]
...
CoD.CraftUtility.Paintjobs.PublishPaintjob = function ( f112_arg0 )
	...
	local f112_local1 = CoD.CraftUtility.GetDDLRoot( f112_arg0, Enum[@"storagefiletype"][@"storage_paintjobs"], f112_local0 ) --[[ @ 0]]
...
CoD.CraftUtility.Emblems.CopyLootModels = function ( f122_arg0, f122_arg1 )
	if f122_arg0 and f122_arg1 then
		for f122_local5, f122_local3 in pairs( f122_arg1 ) --[[ @ 0]] do
			if f122_local5 == "rarity" then
				f122_local3 = CoD.BlackMarketUtility.LootIdRarities[f122_arg1.rarity] or Enum[@"lootraritytype"][@"loot_rarity_type_count"] --[[ @ 0]]
			end
	...
	elseif f122_arg0 then
		...
		f122_local0:set( Enum[@"lootraritytype"][@"loot_rarity_type_count"] ) --[[ @ 0]]
				...
				if f123_local10.isBonusItem then
					...
					if f123_local10.lootInfo then
						if f123_local10.lootInfo.owned then
							f123_local10.lootInfo.unlockInfo = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/set_complete" ) --[[ @ 0]]
						else
							f123_local10.lootInfo.unlockInfo = Engine[@"hash_4F9F1239CFD921FE"]( @"menu/set_incomplete" ) --[[ @ 0]]
						end
					end
				else
		...
		if f126_arg0.lootInfo and f126_arg1.lootInfo then
			...
			elseif f126_arg0.lootInfo.rarity ~= f126_arg1.lootInfo.rarity then
				...
				if not f126_local0 then
					f126_local0 = Enum[@"lootraritytype"][@"loot_rarity_type_count"] --[[ @ 0]]
				end
				local f126_local1 = CoD.BlackMarketUtility.LootIdRarities[f126_arg1.lootInfo.rarity] --[[ @ 0]]
				if not f126_local1 then
					f126_local1 = Enum[@"lootraritytype"][@"loot_rarity_type_count"] --[[ @ 0]]
				end
...
CoD.CraftUtility.Emblems.GetTotalAllowedEmblems = function ( f128_arg0, f128_arg1, f128_arg2 )
	...
	elseif f128_arg1 == Enum[@"storagefiletype"][@"storage_default_emblems"] or f128_arg1 == Enum[@"storagefiletype"][@"storage_emblems_loot"] then
		local f128_local0 = Engine[@"getstoragefileinfo"]( f128_arg1 ) --[[ @ 0]]
...
CoD.CraftUtility.Emblems.GetOpenSlot = function ( f129_arg0 )
	local f129_local0 = CoD.CraftUtility.Emblems.GetTotalAllowedEmblems( f129_arg0, Enum[@"storagefiletype"][@"storage_emblems"], nil ) --[[ @ 0]]
...
CoD.CraftUtility.Emblems.AddEmblemToCache = function ( f133_arg0, f133_arg1 )
	...
	for f133_local2 = 0 --[[ @ 0]], f133_local1 - 1, 1 do
		...
		if f133_local6 then
			...
			f133_local5.assetHash = Engine[@"converttoxhash"]( f133_local6.emblemName:get() ) --[[ @ 0]]
...
CoD.CraftUtility.Emblems.ParseDDL = function ( f134_arg0, f134_arg1, f134_arg2 )
	...
	if f134_arg1 == Enum[@"storagefiletype"][@"storage_default_emblems"] then
		CoD.CraftUtility.Emblems.AddEmblemToCache( f134_arg0, Enum[@"storagefiletype"][@"storage_emblems_loot"] ) --[[ @ 0]]
	end
	return true
end
 --[[ @ 0]]
...
CoD.CraftUtility.Emblems.UploadEmblem = function ( f136_arg0, f136_arg1 )
	...
	local f136_local4 = CoD.CraftUtility.GetDDLRoot( f136_arg0, Enum[@"storagefiletype"][@"storage_emblems"], f136_local0 ) --[[ @ 0]]
	if f136_local4 then
...
CoD.CraftUtility.Emblems.ClearEmblem = function ( f138_arg0, f138_arg1 )
	...
	local f138_local1 = Enum[@"customizationtype"][@"customization_type_emblem"] --[[ @ 0]]
...
CoD.CraftUtility.Emblems.GetEmblemBreadcrumbRoot = function ( f143_arg0, f143_arg1, f143_arg2 )
	...
	if f143_local0 then
		local f143_local1 = Engine[@"storagegetbuffer"]( f143_arg0, Enum[@"storagefiletype"][@"storage_mp_stats_online"] ) --[[ @ 0]]
		if f143_local1 then
...
CoD.CraftUtility.ClearEmblem = function ()
	Engine[@"hash_53DFB162BEAB9E19"]( Enum[@"customizationtype"][@"customization_type_emblem"] ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CraftUtility.GetStorageFileTypeFromCustomiztionType = function ( f162_arg0, f162_arg1 )
	local f162_local0 = Enum[@"storagefiletype"][@"storage_paintjobs"] --[[ @ 0]]
	if f162_arg1 == Enum[@"customizationtype"][@"customization_type_emblem"] then
		f162_local0 = Enum[@"storagefiletype"][@"storage_emblems"] --[[ @ 0]]
...
CoD.CraftUtility.ValidateEquippedUGC = function ( f182_arg0 )
	Engine[@"emblemgetprofile"]( f182_arg0 ) --[[ @ 0]]
	...
	if IsLive() then
		...
		if f183_local0 == Enum[@"storagefiletype"][@"hash_36A0A3D1062F156F"] then
			if Engine[@"hash_2D1419DCE072A0B1"]( f183_local1 ) and Engine[@"hash_52EE0A51483D8E7C"]( f183_arg0, f183_local1 ) then
				Engine[@"emblemsetprofile"]( f183_arg0, Enum[@"storagefiletype"][@"storage_default_emblems"], 0 ) --[[ @ 0]]
			end
...
CoD.CraftUtility.IsPaintjobAllSidesEmpty = function ( f201_arg0 )
	local f201_local0 = Enum[@"customizationtypelayercount"][@"customization_type_paintshop_max_layers"] --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_StopEdits = function ( f230_arg0 )
	Engine[@"emblemendedit"]( f230_arg0 ) --[[ @ 0]]
	if IsPaintshop( f230_arg0 ) then
		CoD.SetCustomization( f230_arg0, Enum[@"customizationtype"][@"customization_type_paintshop_view_left"], "type" ) --[[ @ 0]]
		ForceNotifyModel( f230_arg0, "Paintshop.UpdateDataSource" ) --[[ @ 0]]
	else
		CoD.SetCustomization( f230_arg0, Enum[@"customizationtype"][@"customization_type_emblem"], "type" ) --[[ @ 0]]
	...
	CoD.CraftUtility.SetEmblemEditorProperties( f230_arg0, Enum[@"customizationeditormode"][@"customization_editor_mode_none"], "editorMode" ) --[[ @ 0]]
	CoD.CraftUtility.SetEmblemEditorProperties( f230_arg0, Enum[@"customizationcolormode"][@"customization_color_mode_none"], "colorMode" ) --[[ @ 0]]
	...
	Engine[@"emblemsetgridsize"]( CoD.GetCustomization( f230_arg0, "type" ), 0 ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_SetEditMode = function ( f234_arg0 )
	CoD.CraftUtility.SetEmblemEditorProperties( f234_arg0, Enum[@"customizationeditormode"][@"customization_editor_mode_edit"], "editorMode" ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_LayerGainFocus = function ( f236_arg0, f236_arg1, f236_arg2, f236_arg3 )
	...
	CoD.Menu.SetButtonLabel( f236_arg0, Enum[@"luibutton"][@"lui_key_xbb_pscircle"], @"hash_7AB744CDFD554F5F" ) --[[ @ 0]]
	...
	if CoD.IsLayerEmpty( f236_arg3, CoD.perController[f236_arg3].selectedLayerIndex ) == true then
		CoD.Menu.SetButtonLabel( f236_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], @"hash_4A7613F6A836BA31" ) --[[ @ 0]]
	else
		CoD.Menu.SetButtonLabel( f236_arg0, Enum[@"luibutton"][@"lui_key_xba_pscross"], @"hash_132F41E996619F54" ) --[[ @ 0]]
	end
...
CoD.CraftUtility.EmblemEditor_InsertDecalPressed = function ( f239_arg0, f239_arg1, f239_arg2 )
	...
	Engine[@"emblemcopylayer"]( CoD.perController[f239_arg2].selectedLayerIndex ) --[[ @ 0]]
	Engine[@"embleminsertlayer"]( CoD.perController[f239_arg2].selectedLayerIndex, f239_local0 ) --[[ @ 0]]
	Engine[@"emblemclearlayerbyindex"]( CoD.perController[f239_arg2].selectedLayerIndex, f239_local0 ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_EditSelectedLayer = function ( f241_arg0, f241_arg1, f241_arg2 )
	...
	Engine[@"emblemcopylayer"]( f241_local0 ) --[[ @ 0]]
	...
	Engine[@"emblembeginedit"]( f241_arg2 ) --[[ @ 0]]
	CoD.perController[f241_arg2].selectedLayerMaterialID = Engine[@"getselectedlayermaterialid"]( f241_arg2, f241_local0 ) --[[ @ 0]]
	EmblemEditor_SetScaleMode( f241_arg2, Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) --[[ @ 0]]
	EmblemEditor_SetMaterialScaleMode( f241_arg2, Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_MoveLayerLeft = function ( f245_arg0, f245_arg1, f245_arg2, f245_arg3, f245_arg4, f245_arg5 )
	...
	if not f245_local2( f245_arg3, f245_local1, f245_local0 ) or not CoD.isPC and f245_arg3 > 0 then
		Engine[@"emblemmovelayerrelative"]( f245_arg2, CoD.isPC and 1 or -1, f245_arg4 ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_MoveLayerRight = function ( f247_arg0, f247_arg1, f247_arg2, f247_arg3, f247_arg4, f247_arg5 )
	...
	if not f247_local2( f247_arg3 ) or not CoD.isPC and f247_arg3 + f247_local1 < f247_local0 then
		Engine[@"emblemmovelayerrelative"]( f247_arg2, CoD.isPC and -1 or 1, f247_arg4 ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_CopyLayerToClipboard = function ( f250_arg0, f250_arg1, f250_arg2 )
	Engine[@"emblemcopylayer"]( CoD.perController[f250_arg2].selectedLayerIndex ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_InsertLayer = function ( f255_arg0, f255_arg1, f255_arg2 )
	...
	Engine[@"embleminsertlayer"]( CoD.perController[f255_arg2].selectedLayerIndex, f255_local0 ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_HandleBackInEditMode = function ( f259_arg0, f259_arg1, f259_arg2 )
	Engine[@"emblemendedit"]( f259_arg2 ) --[[ @ 0]]
	...
	CoD.CraftUtility.SetEmblemEditorProperties( f259_arg2, Enum[@"customizationeditormode"][@"customization_editor_mode_browse"], "editorMode" ) --[[ @ 0]]
...
CoD.CraftUtility.InitializeColorPickerProperties = function ( f272_arg0 )
	...
	if f272_local0.red == f272_local1.red and f272_local0.green == f272_local1.green and f272_local0.blue == f272_local1.blue and f272_local0.alpha == f272_local1.alpha then
		CoD.CraftUtility.SetEmblemEditorProperties( f272_arg0, Enum[@"customizationcolormode"][@"customization_color_mode_solid"], "colorMode" ) --[[ @ 0]]
		CoD.CraftUtility.SetEmblemEditorProperties( f272_arg0, 0, "isGradientMode" ) --[[ @ 0]]
		CoD.CraftUtility.SetEmblemEditorProperties( f272_arg0, Enum[@"customizationcolornum"][@"customization_color_none"], "colorNum" ) --[[ @ 0]]
		return 
	else
		CoD.CraftUtility.SetEmblemEditorProperties( f272_arg0, Enum[@"customizationcolormode"][@"customization_color_mode_none"], "colorMode" ) --[[ @ 0]]
		CoD.CraftUtility.SetEmblemEditorProperties( f272_arg0, 1, "isGradientMode" ) --[[ @ 0]]
		CoD.CraftUtility.SetEmblemEditorProperties( f272_arg0, Enum[@"customizationcolornum"][@"customization_color_0"], "colorNum" ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_SaveEmblemAndEdit = function ( f284_arg0, f284_arg1, f284_arg2, f284_arg3, f284_arg4 )
	...
	if f284_arg4 then
		if IsPreBuiltEmblemTab( f284_arg2 ) then
			CoD.perController[f284_arg2].selectedEmblemTabStorageType = Enum[@"storagefiletype"][@"storage_emblems"] --[[ @ 0]]
			CoD.CraftUtility.Emblems.ParseDDL( f284_arg2, Enum[@"storagefiletype"][@"storage_emblems"], CoD.perController[f284_arg2].selectedEmblemTabStickerCategory ) --[[ @ 0]]
		end
		...
		Engine[@"setmodelvalue"]( Engine[@"getmodel"]( f284_arg3, "storageFileType" ), Enum[@"storagefiletype"][@"storage_emblems"] ) --[[ @ 0]]
	end
	...
	Engine[@"hash_C3742A77E5CD0BE"]( f284_arg2, f284_local4, Enum[@"storagefiletype"][@"storage_emblems"] ) --[[ @ 0]]
	Engine[@"invalidateemblemcomponent"]( f284_arg2 ) --[[ @ 0]]
	Engine[@"setupemblemdata"]( f284_arg2, f284_local4, Enum[@"storagefiletype"][@"storage_emblems"], CoD.GetCustomization( f284_arg2, "type" ) ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CraftUtility.SavePaintjob = function ( f286_arg0, f286_arg1 )
	...
	if not f286_local0 then
		...
		CoD.CraftUtility.Paintjobs.ParseDDL( f286_arg1, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
...
CoD.CraftUtility.SaveEmblem = function ( f287_arg0, f287_arg1 )
	...
	if not f287_local0 then
		...
		CoD.CraftUtility.Emblems.ParseDDL( f287_arg1, Enum[@"storagefiletype"][@"storage_emblems"] ) --[[ @ 0]]
		local f287_local4 = Engine[@"getmodelvalue"]( Engine[@"getmodel"]( f287_local0, "emblemIndex" ) ) --[[ @ 0]]
		Engine[@"hash_C3742A77E5CD0BE"]( f287_arg1, f287_local4, Enum[@"storagefiletype"][@"storage_emblems"] ) --[[ @ 0]]
		Engine[@"setupemblemdata"]( f287_arg1, f287_local4, Enum[@"storagefiletype"][@"storage_emblems"], CoD.GetCustomization( f287_arg1, "type" ) ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.CraftUtility.PaintjobEditor_SavePaintjobAndEdit = function ( f288_arg0, f288_arg1, f288_arg2, f288_arg3, f288_arg4 )
	...
	CoD.CraftUtility.Paintjobs.ParseDDL( f288_arg2, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
...
function PaintjobEditor_SavePaintjob( f292_arg0, f292_arg1, f292_arg2 )
	...
	CoD.CraftUtility.Paintjobs.ParseDDL( f292_arg1, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
...
CoD.CraftUtility.PaintjobEditor_ReturnToSelect = function ( f294_arg0, f294_arg1, f294_arg2 )
	CoD.CraftUtility.Paintjobs.ParseDDL( f294_arg2, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_ToggleScaleMode = function ( f297_arg0, f297_arg1, f297_arg2 )
	...
	if Engine[@"getemblemscalemode"]( f297_arg2 ) == Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] then
		f297_local0 = Enum[@"customizationscaletype"][@"customization_scale_type_free"] --[[ @ 0]]
	else
		f297_local0 = Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] --[[ @ 0]]
	end
	CoD.CraftUtility.SetEmblemEditorProperties( f297_arg2, f297_local0, "scaleMode" ) --[[ @ 0]]
	Engine[@"emblemsetscalemode"]( f297_local0 ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CraftUtility.EmblemChooseIcon_SelectionRejected = function ( f318_arg0, f318_arg1, f318_arg2 )
	...
	elseif f318_local0 == CoD.CraftUtility.EMBLEM_ADDDECAL.INSERT then
		Engine[@"emblemcutlayer"]( f318_local1 ) --[[ @ 0]]
	else
		Engine[@"hash_6F71ED1E6B331311"]( f318_local1 ) --[[ @ 0]]
	...
	CoD.CraftUtility.SetEmblemEditorProperties( f318_arg2, Enum[@"customizationeditormode"][@"customization_editor_mode_browse"], "editorMode" ) --[[ @ 0]]
end
 --[[ @ 0]]
		...
		if f319_local1 and f319_local1.isLoot and f319_local1.itemId and f319_local2 then
			...
			if f319_local2 == Enum[@"customizationtype"][@"customization_type_emblem"] then
				...
				if not f319_local7 then
					...
					f319_local6[@"used_in"] = f319_local7 --[[ @ 0]]
...
CoD.CraftUtility.EmblemChooseIcon_SelectionChanged = function ( f320_arg0, f320_arg1, f320_arg2 )
	...
	if CoD.CraftUtility.EmblemChooseIcon_IsDecalGroupCategorySelected( f320_arg0, f320_arg2 ) then
		...
		Engine[@"emblemsetselectedlayericonid"]( f320_local1 ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemChooseIcon_SelectedClassified = function ( f321_arg0, f321_arg1 )
	...
	Engine[@"emblemsetselectedlayericonid"]( f321_local1 ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemChooseMaterial_SelectionChanged = function ( f329_arg0, f329_arg1, f329_arg2 )
	...
	if f329_local0 then
		Engine[@"emblemsetselecteddecalmaterialid"]( f329_arg2, Engine[@"getmodelvalue"]( f329_local0 ) ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.CraftUtility.EmblemChooseMaterial_ToggleScaleMode = function ( f331_arg0, f331_arg1, f331_arg2 )
	...
	if Engine[@"getlayermaterialscalemode"]( f331_arg2 ) == Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] then
		f331_local0 = Enum[@"customizationscaletype"][@"customization_scale_type_free"] --[[ @ 0]]
	else
		f331_local0 = Enum[@"customizationscaletype"][@"customization_scale_type_fixed"] --[[ @ 0]]
	end
...
CoD.CraftUtility.EmblemChooseColor_ToggleBlend = function ( f332_arg0, f332_arg1, f332_arg2 )
	Engine[@"emblemtogglecolorblend"]( f332_arg2, CoD.GetCustomization( f332_arg2, "type" ) ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.CraftUtility.EmblemChooseColor_ClearSelectedLayerMaterial = function ( f333_arg0, f333_arg1, f333_arg2 )
	Engine[@"emblemclearselectedlayermaterialid"]() --[[ @ 0]]
end
 --[[ @ 0]]
CoD.CraftUtility.EmblemChooseColor_SelectionChanged = function ( f334_arg0, f334_arg1, f334_arg2 )
	...
	if f334_local0 == 0 then
		Engine[@"emblemsetlayercolor"]( Enum[@"customizationcolornum"][@"customization_color_none"], f334_local2[1], f334_local2[2], f334_local2[3] ) --[[ @ 0]]
		Engine[@"emblemcleargradient"]( f334_arg2 ) --[[ @ 0]]
	elseif f334_local0 == 1 then
		if f334_local1 == Enum[@"customizationcolornum"][@"customization_color_0"] then
			Engine[@"emblemsetlayercolor"]( f334_local1, f334_local2[1], f334_local2[2], f334_local2[3] ) --[[ @ 0]]
			if PropertyIsTrue( f334_arg0, "isColor1NoColor" ) then
				Engine[@"emblemsetlayercolor"]( Enum[@"customizationcolornum"][@"customization_color_1"], f334_local2[1], f334_local2[2], f334_local2[3] ) --[[ @ 0]]
			end
		elseif f334_local1 == Enum[@"customizationcolornum"][@"customization_color_1"] then
			Engine[@"emblemsetlayercolor"]( f334_local1, f334_local2[1], f334_local2[2], f334_local2[3] ) --[[ @ 0]]
			if PropertyIsTrue( f334_arg0, "isColor0NoColor" ) then
				Engine[@"emblemsetlayercolor"]( Enum[@"customizationcolornum"][@"customization_color_0"], f334_local2[1], f334_local2[2], f334_local2[3] ) --[[ @ 0]]
			end
		end
	end
end
...
CoD.CraftUtility.EmblemChooseColor_SelectNoColor = function ( f335_arg0, f335_arg1, f335_arg2 )
	...
	if f335_local0 ~= nil then
		...
		Engine[@"emblemsetlayercolor"]( f335_local2, f335_local1[1], f335_local1[2], f335_local1[3] ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemEditor_UpdateContainerStateForMode = function ( f337_arg0, f337_arg1, f337_arg2, f337_arg3 )
	...
	if f337_arg3 == 1 then
		CoD.CraftUtility.SetEmblemEditorProperties( f337_arg1, Enum[@"customizationcolormode"][@"customization_color_mode_none"], "colorMode" ) --[[ @ 0]]
...
CoD.CraftUtility.InitializeColorContainerFromSelection = function ( f338_arg0, f338_arg1 )
	...
	CoD.CraftUtility.EmblemEditor_UpdateContainerStateForMode( f338_arg0, f338_arg1, Enum[@"customizationcolormode"][@"customization_color_mode_solid"], f338_local0 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.CraftUtility.EmblemChooseColor_ToggleColorMode = function ( f339_arg0, f339_arg1, f339_arg2, f339_arg3 )
	...
	if f339_local0 == Enum[@"customizationcolormode"][@"customization_color_mode_mixer"] then
		CoD.CraftUtility.EmblemEditor_UpdateContainerStateForMode( f339_arg3, f339_arg2, Enum[@"customizationcolormode"][@"customization_color_mode_solid"], f339_local1 ) --[[ @ 0]]
		CoD.CraftUtility.SetEmblemEditorProperties( f339_arg2, Enum[@"customizationcolormode"][@"customization_color_mode_solid"], "colorMode" ) --[[ @ 0]]
	elseif f339_local0 == Enum[@"customizationcolormode"][@"customization_color_mode_solid"] then
		...
		if f339_local3 == 1 and f339_local5 == Enum[@"customizationcolornum"][@"customization_color_0"] then
			Engine[@"emblemsetlayercolor"]( f339_local5, 1, 1, 1 ) --[[ @ 0]]
		...
		CoD.CraftUtility.EmblemEditor_UpdateContainerStateForMode( f339_arg3, f339_arg2, Enum[@"customizationcolormode"][@"customization_color_mode_mixer"], f339_local1 ) --[[ @ 0]]
		CoD.CraftUtility.SetEmblemEditorProperties( f339_arg2, Enum[@"customizationcolormode"][@"customization_color_mode_mixer"], "colorMode" ) --[[ @ 0]]
	end
	EmblemChooseColor_SetupSelectedLayerColorModel( f339_arg2 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.CraftUtility.EmblemChooseColor_ToggleGradientMode = function ( f340_arg0, f340_arg1, f340_arg2, f340_arg3 )
	...
	if f340_local0 == 1 then
		...
		if f340_local2 ~= nil and f340_local2 == 1 then
			Engine[@"emblemsetlayercolor"]( Enum[@"customizationcolornum"][@"customization_color_0"], 1, 1, 1 ) --[[ @ 0]]
		...
		CoD.CraftUtility.SetEmblemEditorProperties( f340_arg2, Enum[@"customizationcolornum"][@"customization_color_none"], "colorNum" ) --[[ @ 0]]
		CoD.CraftUtility.SetEmblemEditorProperties( f340_arg2, Enum[@"customizationcolormode"][@"customization_color_mode_solid"], "colorMode" ) --[[ @ 0]]
		CoD.CraftUtility.EmblemEditor_UpdateContainerStateForMode( f340_arg3, f340_arg2, Enum[@"customizationcolormode"][@"customization_color_mode_solid"], 0 ) --[[ @ 0]]
	elseif f340_local0 == 0 then
		CoD.CraftUtility.SetEmblemEditorProperties( f340_arg2, 1, "isGradientMode" ) --[[ @ 0]]
		Engine[@"hash_6459D9FB14BA721B"]( f340_arg2, Enum[@"customizationcolornum"][@"customization_color_1"], -1 ) --[[ @ 0]]
		if f340_local1 == Enum[@"customizationcolormode"][@"customization_color_mode_mixer"] then
			CoD.CraftUtility.EmblemEditor_UpdateContainerStateForMode( f340_arg3, f340_arg2, Enum[@"customizationcolormode"][@"customization_color_mode_mixer"], 1 ) --[[ @ 0]]
		else
			CoD.CraftUtility.EmblemEditor_UpdateContainerStateForMode( f340_arg3, f340_arg2, Enum[@"customizationcolormode"][@"customization_color_mode_solid"], 1 ) --[[ @ 0]]
		end
	end
	EmblemChooseColor_SetupSelectedLayerColorModel( f340_arg2 ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemChooseColor_UpdateBothColorOpacity = function ( f346_arg0, f346_arg1, f346_arg2, f346_arg3 )
	if Engine[@"getmodelvalue"]( Engine[@"getmodel"]( Engine[@"getmodelforcontroller"]( f346_arg3 ), "Emblem.EmblemSelectedLayerProperties.max_opacity" ) ) + f346_arg2 <= 100 then
		Engine[@"hash_6459D9FB14BA721B"]( f346_arg3, Enum[@"customizationcolornum"][@"customization_color_none"], f346_arg2 ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.CraftUtility.EmblemGradient_Color0GainFocus = function ( f347_arg0, f347_arg1, f347_arg2 )
	if CoD.CraftUtility.GetEmblemEditorProperties( f347_arg2, "colorMode" ) == Enum[@"customizationcolormode"][@"customization_color_mode_none"] then
		CoD.CraftUtility.SetEmblemEditorProperties( f347_arg2, Enum[@"customizationcolornum"][@"customization_color_0"], "colorNum" ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.CraftUtility.EmblemGradient_Color1GainFocus = function ( f348_arg0, f348_arg1, f348_arg2 )
	if CoD.CraftUtility.GetEmblemEditorProperties( f348_arg2, "colorMode" ) == Enum[@"customizationcolormode"][@"customization_color_mode_none"] then
		CoD.CraftUtility.SetEmblemEditorProperties( f348_arg2, Enum[@"customizationcolornum"][@"customization_color_1"], "colorNum" ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.CraftUtility.EmblemGradient_ColorGradientSliderGainFocus = function ( f349_arg0, f349_arg1, f349_arg2 )
	if CoD.CraftUtility.GetEmblemEditorProperties( f349_arg2, "colorMode" ) == Enum[@"customizationcolormode"][@"customization_color_mode_none"] then
		CoD.CraftUtility.SetEmblemEditorProperties( f349_arg2, Enum[@"customizationcolornum"][@"customization_color_gradient"], "colorNum" ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.CraftUtility.EmblemGradient_ShowSwatchContainer = function ( f350_arg0, f350_arg1, f350_arg2, f350_arg3 )
	...
	CoD.CraftUtility.SetEmblemEditorProperties( f350_arg3, Enum[@"customizationcolormode"][@"customization_color_mode_solid"], "colorMode" ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemGradient_BackFromColorPicker = function ( f352_arg0, f352_arg1, f352_arg2, f352_arg3 )
	...
	CoD.CraftUtility.SetEmblemEditorProperties( f352_arg3, Enum[@"customizationcolormode"][@"customization_color_mode_none"], "colorMode" ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemGradient_SetAngle = function ( f356_arg0, f356_arg1, f356_arg2, f356_arg3 )
	Engine[@"emblemsetgradientangle"]( f356_arg3, f356_arg2 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.CraftUtility.EmblemGradient_ToggleGradientType = function ( f357_arg0, f357_arg1, f357_arg2 )
	Engine[@"emblemtogglegradienttype"]( f357_arg2 ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CraftUtility.EmblemGradient_SetGradientFill = function ( f359_arg0, f359_arg1, f359_arg2, f359_arg3 )
	Engine[@"emblemsetgradientfill"]( f359_arg3, f359_arg2 ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemGradient_BackFromGradientPicker = function ( f360_arg0, f360_arg1, f360_arg2 )
	if CoD.CraftUtility.GetEmblemEditorProperties( f360_arg2, "isColor0NoColor" ) == 1 and CoD.CraftUtility.GetEmblemEditorProperties( f360_arg2, "isColor1NoColor" ) == 1 then
		Engine[@"emblemsetlayercolor"]( Enum[@"customizationcolornum"][@"customization_color_none"], 1, 1, 1 ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.CraftUtility.BlackMarketSetAsEmblem = function ( f365_arg0, f365_arg1, f365_arg2 )
	...
	Engine[@"setupemblemdata"]( f365_local1, f365_local2, f365_local3, Enum[@"customizationtype"][@"customization_type_emblem"] ) --[[ @ 0]]
	if IsLive() then
		Engine[@"emblemsetprofile"]( f365_local1, CoD.perController[f365_local1].selectedEmblemTabStorageType, f365_local0 ) --[[ @ 0]]
		CoD.perController[f365_local1].uploadProfile = true --[[ @ 0]]
	else
		Engine[@"setprofilevar"]( f365_local1, "default_emblem_index", f365_local2 ) --[[ @ 0]]
		Engine[@"invalidateemblemcomponent"]( f365_local1 ) --[[ @ 0]]
	end
...
CoD.CraftUtility.EmblemSelect_Back = function ( f369_arg0, f369_arg1, f369_arg2 )
	if not IsLive() then
		...
		CoD.BreadcrumbUtility.UploadBuffer( f369_arg2, Enum[@"storagefiletype"][@"storage_mp_stats_online"] ) --[[ @ 0]]
	end
...
CoD.CraftUtility.EmblemSelect_SetAsEmblem = function ( f371_arg0, f371_arg1, f371_arg2 )
	if IsLive() and not IsUserContentRestricted( f371_arg2 ) then
		...
		Engine[@"emblemsetprofile"]( f371_arg2, f371_local2, f371_local0 ) --[[ @ 0]]
		...
		Engine[@"invalidateemblemcomponent"]( f371_arg2 ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.CraftUtility.EmblemSelect_GainFocus = function ( f373_arg0, f373_arg1, f373_arg2 )
	...
	Engine[@"setupemblemdata"]( f373_arg2, Engine[@"getmodelvalue"]( f373_arg1:getModel( f373_arg2, "emblemIndex" ) ), Engine[@"getmodelvalue"]( f373_arg1:getModel( f373_arg2, "storageFileType" ) ), Enum[@"customizationtype"][@"customization_type_emblem"] ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CraftUtility.EmblemSelect_ChooseEmblem = function ( f376_arg0, f376_arg1, f376_arg2 )
	CoD.perController[f376_arg2].totalLayers = Enum[@"customizationtypelayercount"][@"customization_type_emblem_max_layers"] --[[ @ 0]]
	CoD.perController[f376_arg2].totalGroups = Enum[@"customizationtypegroupcount"][@"customization_type_max_groups"] - 1 --[[ @ 0]]
	CoD.CraftUtility.SetEmblemEditorProperties( f376_arg2, Enum[@"customizationeditormode"][@"customization_editor_mode_browse"], "editorMode" ) --[[ @ 0]]
	local f376_local0 = Enum[@"customizationtype"][@"customization_type_emblem"] --[[ @ 0]]
...
CoD.CraftUtility.EmblemSelect_ClearEmblem = function ( f379_arg0, f379_arg1 )
	...
	CoD.CraftUtility.Emblems.ParseDDL( f379_arg1, Enum[@"storagefiletype"][@"storage_emblems"], CoD.perController[f379_arg1].selectedEmblemTabStickerCategory ) --[[ @ 0]]
...
CoD.CraftUtility.EmblemSelect_CopyEmblem = function ( f380_arg0, f380_arg1, f380_arg2, f380_arg3 )
	if CoD.CraftUtility.Emblems.Copy( f380_arg2, CoD.perController[f380_arg2].selectedEmblemModel, CoD.perController[f380_arg2].selectedEmblemTabStorageType ) then
		CoD.CraftUtility.Emblems.ParseDDL( f380_arg2, Enum[@"storagefiletype"][@"storage_emblems"], CoD.perController[f380_arg2].selectedEmblemTabStickerCategory ) --[[ @ 0]]
...
CoD.CraftUtility.UpdateWeaponModel = function ( f383_arg0, f383_arg1, f383_arg2 )
	...
	local f383_local1 = Enum[@"emodes"][@"mode_multiplayer"] --[[ @ 0]]
...
CoD.CraftUtility.OpenPaintjobWeaponSelection = function ( f386_arg0, f386_arg1, f386_arg2, f386_arg3, f386_arg4 )
	...
	elseif CheckIfFeatureIsBanned( f386_arg2, LuaEnum.FEATURE_BAN.USER_GENERATED_CONTENT ) then
		...
		CoD.SetCustomization( f386_arg2, Enum[@"customizationtype"][@"customization_type_paintshop_view_left"], "type" ) --[[ @ 0]]
...
CoD.CraftUtility.OpenPaintjobSelection = function ( f387_arg0, f387_arg1, f387_arg2, f387_arg3, f387_arg4 )
	Engine[@"setmodelvalue"]( Engine[@"createmodel"]( Engine[@"getmodelforcontroller"]( f387_arg2 ), "Paintshop.Mode" ), Enum[@"paintshopmode"][@"paintshopmode_weaponlist"] ) --[[ @ 0]]
	CoD.SetCustomization( f387_arg2, Enum[@"customizationtype"][@"customization_type_paintshop_view_left"], "type" ) --[[ @ 0]]
	CoD.perController[f387_arg2].totalLayers = Enum[@"customizationtypelayercount"][@"customization_type_paintshop_max_layers"] --[[ @ 0]]
	CoD.perController[f387_arg2].totalGroups = Enum[@"customizationtypegroupcount"][@"customization_type_max_groups"] - 1 --[[ @ 0]]
	local f387_local0 = CoD.CraftUtility.Paintjobs.ParseDDL( f387_arg2, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
	if f387_local0 then
...
CoD.CraftUtility.SetupPaintjobPersonalization = function ( f388_arg0, f388_arg1, f388_arg2 )
	CoD.CraftUtility.Paintjobs.ParseDDL( f388_arg2, Enum[@"storagefiletype"][@"storage_paintjobs"] ) --[[ @ 0]]
...
CoD.CraftUtility.PaintjobPersonalization_RestoreSelected = function ( f391_arg0, f391_arg1 )
	...
	if f391_local0 then
		...
		CoD.CraftUtility.Gunsmith.DisplayWeaponWithPaintjob( f391_arg1, Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
