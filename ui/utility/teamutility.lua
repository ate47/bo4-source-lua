...
CoD.TeamUtility.TeamName[Enum[@"team_t"][@"hash_697263B3C1ABADF7"]] = @"hash_67D9E6FC77F8801D" --[[ @ 0]]
CoD.TeamUtility.TeamName[Enum[@"team_t"][@"hash_BD65CBD25CCBEDC"]] = @"hash_275AD55270B8D7CE" --[[ @ 0]]
CoD.TeamUtility.TeamName[Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"]] = @"hash_D6E737E18961BDC" --[[ @ 0]]
if not CoD.isMultiplayer then
	CoD.TeamUtility.TeamName[Enum[@"team_t"][@"hash_BD65CBD25CCBEDC"]] = @"hash_275AD55270B8D7CE" --[[ @ 0]]
	CoD.TeamUtility.TeamName[Enum[@"team_t"][@"hash_7855F9A6F0EA0143"]] = @"hash_3E283EA5896DD5A6" --[[ @ 0]]
end
CoD.TeamUtility.GetTeam = function ( f1_arg0 )
	if IsCodCaster( f1_arg0 ) then
		...
		return Engine[@"hash_25A93802BE50A531"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"GetClientNum"]( f1_arg0 ) )
	end
end
 --[[ @ 0]]
CoD.TeamUtility.GetTeams = function ()
	CoD.TeamUtility.Teams = {} --[[ @ 0]]
	local f2_local0 = Engine[@"hash_56C6FE1BF41EB9AF"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"] ) ) --[[ @ 0]]
	local f2_local1 = {} --[[ @ 0]]
...
CoD.TeamUtility.IsValidPlayerTeam = function ( f6_arg0, f6_arg1 )
	...
	elseif CoDShared.IsGametypeTeamBased( f6_arg1 ) then
		local f6_local0 = {
			[Enum[@"team_t"][@"hash_42A34B055ADD98AB"]] = true,
			[Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"]] = true
		} --[[ @ 0]]
		return f6_local0[f6_arg0] ~= nil
	else
		local f6_local0 --[[ @ 0]]
		if f6_arg0 <= Enum[@"team_t"][@"hash_697263B3C1ABADF7"] or f6_arg0 >= Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
			f6_local0 = false --[[ @ 0]]
		else
			f6_local0 = true --[[ @ 0]]
		end
...
CoD.TeamUtility.GetOppositeTeamAxisAllies = function ( f7_arg0 )
	if f7_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
		return Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"]
	elseif f7_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
		return Enum[@"team_t"][@"hash_42A34B055ADD98AB"]
	else
		return f7_arg0
	end
end
...
CoD.TeamUtility.GetTeamIDForController = function ( f9_arg0 )
	...
	local f9_local1 = Engine[@"hash_4755D55B3813D249"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], Enum[@"LobbyType"][@"hash_692676CF5B6FCD43"] ) --[[ @ 0]]
	...
	return Enum[@"team_t"][@"hash_75C697ECEC0E8AFC"]
end
 --[[ @ 0]]
...
CoD.TeamUtility.GetDefaultTeamName = function ( f12_arg0 )
	if IsMultiplayer() then
		if f12_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			return @"hash_3C815AF97EE8C135"
		elseif f12_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
			return @"hash_412BD5927860415A"
		end
...
CoD.TeamUtility.TeamDevStringToEnumTable = {
	allies = Enum[@"team_t"][@"hash_42A34B055ADD98AB"],
	axis = Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"]
} --[[ @ 0]]
CoD.TeamUtility.TeamDevStringToEnum = function ( f13_arg0 )
	...
	if not f13_local0 then
		f13_local0 = Enum[@"team_t"][@"hash_75C697ECEC0E8AFC"] --[[ @ 0]]
	end
	return f13_local0
end
 --[[ @ 0]]
CoD.TeamUtility.GetDefaultTeamShortName = function ( f14_arg0 )
	if IsMultiplayer() then
		if f14_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			return @"hash_EDCCEFE94375E18"
		elseif f14_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
...
CoD.TeamUtility.GetDefaultTeamFactionDescription = function ( f15_arg0 )
	if IsMultiplayer() then
		if f15_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			return @"hash_4F61ADAF3651241F"
		elseif f15_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
...
CoD.TeamUtility.GetDefaultTeamFactionColor = function ( f16_arg0 )
	...
	if f16_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
		f16_local0 = ColorSet.FriendlyBlue --[[ @ 0]]
	elseif f16_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
	...
	elseif f16_arg0 == Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
...
CoD.TeamUtility.GetDefaultTeamFactionIcon = function ( f17_arg0 )
	if IsCampaign() then
		if f17_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			return "cp_icon_faction_allies"
		elseif f17_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
			return "cp_icon_faction_axis"
		end
	elseif f17_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
...
CoD.TeamUtility.GetSimplifiedTeamFactionIcon = function ( f18_arg0 )
	if IsCampaign() then
		if f18_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			return "uie_t8_cp_faction_allies"
		elseif f18_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
...
CoD.TeamUtility.GetTeamFactionColor = function ( f20_arg0 )
	...
	if CoD.CodCasterUtility.IsCodCasterOrAssigned( f20_local0 ) then
		...
		if f20_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			f20_local1 = ColorSet.FriendlyBlue --[[ @ 0]]
		elseif f20_arg0 == Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
...
CoD.TeamUtility.GetTeamNameCaps = function ( f22_arg0 )
	if Engine[@"GameModeIsMode"]( Enum[@"eGameModes"][@"hash_158ECA70A244C08F"] ) then
		if f22_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] and Dvar[@"g_customteamname_allies"]:get() ~= "" then
			return Engine[@"ToUpper"]( Dvar[@"g_customteamname_allies"]:get() )
		elseif f22_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] and Dvar[@"g_customteamname_axis"]:get() ~= "" then
	...
	local f22_local0 = CoD.TeamUtility.GetTeamName( f22_arg0 ) --[[ @ 0]]
	if f22_arg0 == Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
...
CoD.TeamUtility.GetColorSetNameFriendlyColor = function ( f23_arg0, f23_arg1 )
	...
	if CoD.IsShoutcaster( f23_arg0 ) then
		if f23_arg1 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			f23_local0 = "CodCasterFactionAllies" --[[ @ 0]]
		elseif f23_arg1 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
...
CoD.TeamUtility.GetColorSetNameEnemyColor = function ( f25_arg0, f25_arg1 )
	...
	if CoD.IsShoutcaster( f25_arg0 ) then
		if f25_arg1 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			f25_local0 = "CodCasterFactionAllies" --[[ @ 0]]
		elseif f25_arg1 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
...
CoD.TeamUtility.IsTeamLivesLow = function ( f29_arg0 )
	...
	elseif f29_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
		local f29_local2 = Engine[@"GetGlobalModel"]() --[[ @ 0]]
...
CoD.TeamUtility.GetTeamCount = function ( f30_arg0 )
	...
	if f30_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
		local f30_local1 = Engine[@"GetGlobalModel"]() --[[ @ 0]]
		f30_local0 = f30_local1.scoreboard.team1.count:get() --[[ @ 0]]
	elseif f30_arg0 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
		local f30_local1 = Engine[@"GetGlobalModel"]() --[[ @ 0]]
...
CoD.TeamUtility.IsEnemyTeamLivesLow = function ( f32_arg0 )
	...
	local f32_local1 = Enum[@"team_t"][@"hash_42A34B055ADD98AB"] --[[ @ 0]]
	if f32_local1 == f32_local0 then
		f32_local1 = Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] --[[ @ 0]]
	end
...
DataSources.ChangeTeamOptions = DataSourceHelpers.ListSetup( "ChangeTeamOptions", function ( f42_arg0 )
	...
	local f42_local1 = function ( f45_arg0, f45_arg1 )
		...
		for f45_local7, f45_local8 in pairs( f45_local2 ) --[[ @ 0]] do
			if f45_local8 == f45_arg1 and Engine[@"hash_140145EEB2E913D2"]( f45_arg0, f45_local7 ) == 0 then
				f45_local3 = f45_local3 + 1 --[[ @ 0]]
			end
		end
		f45_local4 = 0 --[[ @ 0]]
		for f45_local8, f45_local9 in ipairs( f45_local0 ) --[[ @ 0]] do
			if Engine[@"hash_53CC7B57F23F03F1"]( f45_arg0, f45_local9.bodyIndex, f45_arg1 ) < f45_local1.maxUniqueRolesPerTeam[f45_local9.bodyIndex]:get() then
	...
	local f42_local4 --[[ @ 0]]
	if Engine[@"GetGametypeSetting"]( @"spectatetype" ) >= 1 and Engine[@"GetGametypeSetting"]( @"hash_31ECE5CAD71BF4EA" ) == 1 then
	...
	if f42_local4 then
		f42_local4 = Engine[@"hash_622EAAB59AA27E9B"]( "allow_shoutcaster_team_switch" ) == 1 --[[ @ 0]]
	end
	...
	if CoDShared.IsGametypeTeamBased() == true and CoD.IsTeamChangeAllowed( f42_arg0 ) then
		if f42_local3 ~= Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
			if f42_local1( f42_arg0, Enum[@"team_t"][@"hash_42A34B055ADD98AB"] ) then
				table.insert( f42_local2, f42_local0( f42_arg0, @"hash_3C815AF97EE8C135", "allies", @"hash_617E759991A40568", CoD.TeamUtility.GetTeamFactionIcon( Enum[@"team_t"][@"hash_42A34B055ADD98AB"] ), false ) ) --[[ @ 0]]
			else
				table.insert( f42_local2, f42_local0( f42_arg0, @"hash_3C815AF97EE8C135", "allies", @"hash_6A3EE0239CF6265D", CoD.TeamUtility.GetTeamFactionIcon( Enum[@"team_t"][@"hash_42A34B055ADD98AB"] ), true ) ) --[[ @ 0]]
			end
		end
		if f42_local3 ~= Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
			if f42_local1( f42_arg0, Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] ) then
				table.insert( f42_local2, f42_local0( f42_arg0, @"hash_412BD5927860415A", "axis", @"hash_46838CD03F01BF13", CoD.TeamUtility.GetTeamFactionIcon( Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] ), false ) ) --[[ @ 0]]
			else
				table.insert( f42_local2, f42_local0( f42_arg0, @"hash_412BD5927860415A", "axis", @"hash_6A3EE0239CF6265D", CoD.TeamUtility.GetTeamFactionIcon( Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] ), true ) ) --[[ @ 0]]
			end
		end
	end
	if CoDShared.IsGametypeTeamBased() == true or f42_local3 == Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
		table.insert( f42_local2, f42_local0( f42_arg0, @"hash_2AD8F376215AE5D7", "autoassign", @"hash_38BFAF5D14337A27", "" ) ) --[[ @ 0]]
	end
	if f42_local3 ~= Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] and f42_local4 == true then
...
DataSources.Factions = {
	...
	prepare = function ( f47_arg0, f47_arg1, f47_arg2 )
		...
		DataSources.Factions.factionSubscription[f47_arg0]:subscribeToModel( f47_local3, function ( model )
			...
			if f48_local0 then
				if CoD.IsShoutcaster( f47_arg0 ) then
					f48_local0 = Enum[@"team_t"][@"hash_42A34B055ADD98AB"] --[[ @ 0]]
				...
				if CoD.IsShoutcaster( f47_arg0 ) then
					local f48_local3 = CoD.TeamUtility.GetTeamFactionColor( Enum[@"team_t"][@"hash_42A34B055ADD98AB"] ) --[[ @ 0]]
		...
		DataSources.Factions.factionSubscription[f47_arg0]:subscribeToModel( f47_local11, function ( model )
			...
			if f49_local0 then
				if CoD.IsShoutcaster( f47_arg0 ) then
					f49_local0 = Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] --[[ @ 0]]
				...
				if CoD.IsShoutcaster( f47_arg0 ) then
					local f49_local3 = CoD.TeamUtility.GetTeamFactionColor( Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] ) --[[ @ 0]]
					if not CoDShared.IsGametypeTeamBased() then
