...
CoD.FreeCursorUtility.SetAllowFreeCursor = function ( f1_arg0 )
	if Engine[@"hash_28069F5969D47DEF"]() then
		Dvar[@"hash_48E0F129D51A415C"]:set( f1_arg0 ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.FreeCursorUtility.ConfinePositionToScreenSafe = function ( f43_arg0, f43_arg1 )
	...
	local f43_local2 = function ()
		...
		local f44_local4, f44_local5 = Engine[@"hash_61A28BE9919661FA"]( f43_arg1 ) --[[ @ 0]]
		if CoD.isPC then
...
CoD.FreeCursorUtility.SetVisibilityToAnyContextualButtonVisible = function ( f45_arg0, f45_arg1, f45_arg2 )
	...
	for f45_local4, f45_local5 in ipairs( {
		Enum[@"LUIButton"][@"hash_1E6DB407A2AF8B09"],
		Enum[@"LUIButton"][@"hash_4C083113BC81F23F"],
		Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"]
	} ) --[[ @ 0]] do
		if f45_local0[f45_local5] and f45_local0[f45_local5]:get() == Enum[@"LUIButtonPromptStates"][@"hash_5901DFC093ED4187"] and f45_local0[f45_local5].flags and CoD.BitUtility.IsBitwiseAndNonZero( f45_local0[f45_local5].flags:get(), Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"] ) then
...
CoD.FreeCursorUtility.IsTooltipInDetailedView = function ( f47_arg0, f47_arg1 )
	...
	if f47_local0 then
		f47_local0 = CoD.ModelUtility.AreButtonModelValueBitsSet( f47_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) --[[ @ 0]]
...
CoD.FreeCursorUtility.IsTooltipTitleVisible = function ( f48_arg0, f48_arg1 )
	if not CoD.ModelUtility.IsSelfModelValueNonEmptyString( f48_arg0, f48_arg1, "title" ) then
		...
		elseif f48_local0 == CoD.FreeCursorUtility.TooltipArchetypes.DEFAULT then
			local f48_local1 = CoD.ModelUtility.AreButtonModelValueBitsSet( f48_arg1, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) --[[ @ 0]]
...
CoD.FreeCursorUtility.ShowingContextualPromptForFlags = function ( f49_arg0, f49_arg1 )
	...
	f49_local0 = CoD.ModelUtility.IsSelfModelValueEnumFlagSet( f49_arg0, f49_arg1, "flags", Enum[@"hash_3BEBDBAEEB3ECCCA"][@"hash_4B6372335C630AD3"] ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.FreeCursorUtility.XUIDToClientName = function ( f50_arg0, f50_arg1 )
	local f50_local0 = Engine[@"hash_334E2C136520C3C8"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f50_arg1 ) --[[ @ 0]]
	local f50_local1 --[[ @ 0]]
	if f50_local0 then
...
CoD.FreeCursorUtility.XUIDToClanTag = function ( f51_arg0, f51_arg1 )
	local f51_local0 = Engine[@"hash_334E2C136520C3C8"]( Enum[@"LobbyModule"][@"hash_40C46B73E8E18BA2"], f51_arg1 ) --[[ @ 0]]
	local f51_local1 --[[ @ 0]]
	if f51_local0 then
		...
		if not DataSources.FreeCursor.models[f53_arg0] then
			...
			if DataSources.FreeCursor.subscriptionElements[f53_arg0] == nil then
				...
				if not CoD.isPC then
					DataSources.FreeCursor.subscriptionElements[f53_arg0]:subscribeToGlobalModel( f53_arg0, "PerController", "ButtonBits." .. Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], function ( model )
						f53_local1.detailedView:set( CoD.BitUtility.IsBitwiseAndNonZero( model:get(), Enum[@"LUIButtonFlags"][@"hash_5253A6F6CAAAE464"] ) ) --[[ @ 0]]
					end ) --[[ @ 0]]
				end
			end
			if CoD.isPC then
...
CoD.FreeCursorUtility.PrepareTooltipPC = function ( f82_arg0, f82_arg1, f82_arg2 )
	...
	local f82_local1 = function ( f84_arg0, f84_arg1, f84_arg2, f84_arg3 )
		local f84_local0, f84_local1 = Engine[@"hash_61A28BE9919661FA"]( f82_arg1 ) --[[ @ 0]]
	...
	local f82_local2 = function ()
		...
		if f85_local0 and f85_local1 then
			...
			if f85_local3 ~= nil then
				local f85_local11, f85_local12 = Engine[@"hash_61A28BE9919661FA"]( f82_arg1 ) --[[ @ 0]]
