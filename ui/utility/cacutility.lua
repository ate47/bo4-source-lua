...
CoD.CACUtility[@"hash_5E6E8B9715ECC201"] = function ( f4_arg0, f4_arg1 )
	...
	if f4_local0 == Enum[@"emodes"][@"mode_multiplayer"] then
		...
		for f4_local2 = 1 --[[ @ 0]], f4_local1, 1 do
			local f4_local5 = Engine[@"getcustomclasscacroot"]( f4_arg0, f4_local2 - 1, f4_local0 ) --[[ @ 0]]
			if f4_local5 then
				for f4_local17, f4_local18 in ipairs( {
					...
					if f4_local19 then
						...
						local f4_local10 = f4_local19[@"weaponmodelslot"]:get() --[[ @ 0]]
						if f4_local9 ~= CoDShared.EmptyItemIndex then
							...
							if f4_local11 ~= @"hash_0" then
								...
								if not f4_local13 or not CoD.CACUtility.FilterSignatureWeapon( f4_arg0, f4_local13, false, true ) then
									f4_local19[@"weaponmodelslot"]:set( 0 ) --[[ @ 0]]
								else
									local f4_local14 = f4_local19[@"camoindex"]:get() --[[ @ 0]]
									if f4_local14 ~= 0 then
										...
										if f4_local15 and not CoD.CACUtility.MasteryCamos[f4_local15] then
											...
											if f4_local16 ~= f4_local14 then
												f4_local19[@"camoindex"]:set( f4_local16 ) --[[ @ 0]]
											end
										end
									end
								end
						...
						local f4_local11 = f4_local19[@"camoindex"]:get() --[[ @ 0]]
		...
		CoDLoadoutsShared[@"validatemploadouts"]( f4_arg0, f4_arg1 ) --[[ @ 0]]
	elseif f4_local0 == Enum[@"emodes"][@"mode_zombies"] and not IsLive() then
		...
		for f4_local3 = 0 --[[ @ 0]], CoD.ZMStoryUtility.StoryIndex.STORY_INDEX_COUNT - 1, 1 do
			...
			for f4_local5 = 1 --[[ @ 0]], f4_local2, 1 do
				local f4_local18 = Engine[@"getcustomclasscacroot"]( f4_arg0, f4_local5 - 1, f4_local0 ) --[[ @ 0]]
				if f4_local18 then
					local f4_local19 = f4_local18[@"talisman1"] --[[ @ 0]]
					if f4_local19 then
...
CoD.CACUtility.SetDefaultLoadouts = function ( f8_arg0 )
	...
	if f8_local1 == Enum[@"storagefiletype"][@"storage_cp_loadouts"] or f8_local1 == Enum[@"storagefiletype"][@"storage_cp_loadouts_offline"] then
		...
		if f8_local5 then
			local f8_local6 = Enum[@"emodes"][@"mode_campaign"] --[[ @ 0]]
			local f8_local7 = Engine[@"hash_2E00B2F29271C60B"]( @"cp_default_loadouts" ) --[[ @ 0]]
			...
			Engine[@"saveloadout"]( f8_local0, f8_local6 ) --[[ @ 0]]
		end
	elseif f8_local1 == Enum[@"storagefiletype"][@"storage_mp_loadouts"] or f8_local1 == Enum[@"storagefiletype"][@"storage_mp_loadouts_custom"] or f8_local1 == Enum[@"storagefiletype"][@"storage_mp_loadouts_offline"] or f8_local1 == Enum[@"storagefiletype"][@"hash_30067DF1879D992E"] or f8_local1 == Enum[@"storagefiletype"][@"hash_CEBE62E27709AD0"] or f8_local1 == Enum[@"storagefiletype"][@"hash_D062FA7B47FC13A"] then
		...
		local f8_local5 = f8_local4.cacLoadouts --[[ @ 0]]
		if f8_local5 then
			local f8_local6 = Enum[@"emodes"][@"mode_multiplayer"] --[[ @ 0]]
			...
			elseif f8_local1 == Enum[@"storagefiletype"][@"hash_30067DF1879D992E"] or f8_local1 == Enum[@"storagefiletype"][@"hash_CEBE62E27709AD0"] or f8_local1 == Enum[@"storagefiletype"][@"hash_D062FA7B47FC13A"] then
				f8_local7 = Engine[@"hash_2E00B2F29271C60B"]( @"mp_arena_default_loadouts" ) --[[ @ 0]]
			else
			...
			for f8_local8 = Enum[@"loadoutclass_t"][@"custom_class_first"] + 1 --[[ @ 0]], Enum[@"loadoutclass_t"][@"basic_custom_class_count"], 1 do
				CoDShared.SetCustomDefaultLoadout( f8_local5, f8_local8, f8_local7, f8_local6, nil ) --[[ @ 0]]
				CoDShared.SetDefaultLoadoutForClass( f8_local5, f8_local8 + Enum[@"loadoutclass_t"][@"basic_custom_class_count"], f8_local8, f8_local7, f8_local6, nil ) --[[ @ 0]]
			end
			if f8_local3 then
				for f8_local8 = Enum[@"loadoutclass_t"][@"default_class_first"] + 1 --[[ @ 0]], Enum[@"loadoutclass_t"][@"default_class_last"] + 1, 1 do
	...
	elseif f8_local1 == Enum[@"storagefiletype"][@"storage_zm_loadouts"] or f8_local1 == Enum[@"storagefiletype"][@"hash_33376D9E1C3C8130"] or f8_local1 == Enum[@"storagefiletype"][@"storage_zm_loadouts_offline"] then
		...
		local f8_local5 = f8_local4.cacLoadouts --[[ @ 0]]
		if f8_local5 then
			local f8_local6 = Enum[@"emodes"][@"mode_zombies"] --[[ @ 0]]
			local f8_local7 = Engine[@"hash_2E00B2F29271C60B"]( @"zm_default_loadouts" ) --[[ @ 0]]
	...
	elseif f8_local1 == Enum[@"storagefiletype"][@"storage_wz_loadouts"] then
		...
		local f8_local5 = Enum[@"emodes"][@"mode_warzone"] --[[ @ 0]]
		...
		for f8_local11, f8_local12 in ipairs( f8_local6 ) --[[ @ 0]] do
			...
			local f8_local14 = Engine[@"getpositionrolebundleinfo"]( f8_local5, f8_local13 ) --[[ @ 0]]
		...
		Engine[@"saveloadout"]( f8_local0, f8_local5 ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
CoD.CACUtility.ValidateMPBlackMarketAttachments = function ( f9_arg0 )
	...
	local f9_local4 = Engine[@"storagegetbuffer"]( f9_arg0, Enum[@"storagefiletype"][@"storage_mp_loadouts_custom"] ) --[[ @ 0]]
	local f9_local5 = Engine[@"storagegetbuffer"]( f9_arg0, Enum[@"storagefiletype"][@"storage_mp_loadouts"] ) --[[ @ 0]]
	...
	f9_local2 = Engine[@"storagegetbuffer"]( f9_arg0, Enum[@"storagefiletype"][@"storage_mp_class_sets"] ) --[[ @ 0]]
	if f9_local2 then
...
CoD.CACUtility.ValidateMPLootWeapons = function ( f11_arg0 )
	local f11_local0 = function ( f12_arg0, f12_arg1 )
		...
		for f12_local6, f12_local7 in ipairs( f12_arg0 ) --[[ @ 0]] do
			...
			local f12_local9 = Engine[@"getitemindexfromreference"]( f12_local8, Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
	 ...
	 --[[ @ 0]]
	local f11_local1 = Engine[@"storagegetbuffer"]( f11_arg0, Enum[@"storagefiletype"][@"storage_mp_stats_online"] ) --[[ @ 0]]
	if f11_local1 then
...
CoD.CACUtility.ValidateZMBGBEntitlement = function ( f13_arg0 )
	for f13_local0 = 0 --[[ @ 0]], 9, 1 do
		for f13_local3 = 0 --[[ @ 0]], 4, 1 do
			local f13_local6 = Engine[@"getdlcnameforitem"]( Engine[@"getbubblegumbuff"]( f13_arg0, f13_local0, f13_local3 ), Enum[@"statindexoffset"][@"hash_648CD0338EE0B3AE"], Enum[@"emodes"][@"mode_zombies"] ) --[[ @ 0]]
...
CoD.OverlayUtility.AddSystemOverlay( "PrestigeWeapon", {
	...
	listDatasource = function ( f22_arg0, f22_arg1 )
		DataSources.PrestigeWeaponOptionsList = DataSourceHelpers.ListSetup( "PrestigeWeaponOptionsList", function ( f23_arg0 )
			...
			table.insert( f23_local0, f23_local1( Engine[@"hash_4F9F1239CFD921FE"]( @"menu/cancel" ), f23_local4, true ) ) --[[ @ 0]]
			return f23_local0
		end, true ) --[[ @ 0]]
...
CoD.CACUtility.GetClassAttachments = function ( f33_arg0, f33_arg1, f33_arg2, f33_arg3, f33_arg4 )
	local f33_local0 = Engine[@"getcustomclasscacroot"]( f33_arg0, f33_arg2, f33_arg1 ) --[[ @ 0]]
...
CoD.CACUtility.GetLoadoutsMPOffline = function ( f38_arg0 )
	local f38_local0 = Engine[@"storagegetbuffer"]( f38_arg0, Enum[@"storagefiletype"][@"storage_mp_loadouts_offline"] ) --[[ @ 0]]
	return f38_local0.cacLoadouts
end
 --[[ @ 0]]
CoD.CACUtility.GetLoadoutsMPOnlinePublic = function ( f39_arg0 )
	local f39_local0 = Engine[@"storagegetbuffer"]( f39_arg0, Enum[@"storagefiletype"][@"storage_mp_loadouts"] ) --[[ @ 0]]
	return f39_local0.cacLoadouts
end
 --[[ @ 0]]
CoD.CACUtility.GetLoadoutsMPOnlineCustom = function ( f40_arg0 )
	local f40_local0 = Engine[@"storagegetbuffer"]( f40_arg0, Enum[@"storagefiletype"][@"storage_mp_loadouts_custom"] ) --[[ @ 0]]
...
CoD.CACUtility.GetLoadoutsCPOffline = function ( f44_arg0 )
	local f44_local0 = Engine[@"storagegetbuffer"]( f44_arg0, Enum[@"storagefiletype"][@"storage_cp_loadouts_offline"] ) --[[ @ 0]]
	return f44_local0.cacLoadouts
end
 --[[ @ 0]]
CoD.CACUtility.GetLoadoutsCPOnline = function ( f45_arg0 )
	local f45_local0 = Engine[@"storagegetbuffer"]( f45_arg0, Enum[@"storagefiletype"][@"storage_cp_loadouts"] ) --[[ @ 0]]
	return f45_local0.cacLoadouts
end
 --[[ @ 0]]
CoD.CACUtility.GetLoadoutsZMOffline = function ( f46_arg0 )
	local f46_local0 = Engine[@"storagegetbuffer"]( f46_arg0, Enum[@"storagefiletype"][@"storage_zm_loadouts_offline"] ) --[[ @ 0]]
	return f46_local0.cacLoadouts
end
 --[[ @ 0]]
CoD.CACUtility.GetLoadoutsZMOnline = function ( f47_arg0 )
	local f47_local0 = Engine[@"storagegetbuffer"]( f47_arg0, Enum[@"storagefiletype"][@"storage_zm_loadouts"] ) --[[ @ 0]]
...
CoD.CACUtility.SetGametypeSettingsCACRoot = function ( f49_arg0, f49_arg1 )
	...
	if f49_arg1 == Enum[@"team_t"][@"team_free"] then
		...
		f49_local0 = f49_arg1 - Enum[@"team_t"][@"team_first_playing_team"] + 1 --[[ @ 0]]
	end
...
CoD.CACUtility.GetMutuallyExclusiveSlotName = function ( f69_arg0, f69_arg1, f69_arg2, f69_arg3, f69_arg4, f69_arg5 )
	...
	elseif CoD.CACUtility.IsSlotNameInList( CoD.CACUtility.PrimaryAttachmentSlotNameList, f69_arg2 ) or CoD.CACUtility.IsSlotNameInList( CoD.CACUtility.SecondaryAttachmentSlotNameList, f69_arg2 ) then
		...
		local f69_local5 = Engine[@"hash_2B8DE256555CACF5"]( f69_local3, f69_arg3, f69_arg5 ) == Enum[@"eattachmentgroup"][@"hash_26EE211053211305"] --[[ @ 0]]
		...
		for f69_local18, f69_local19 in ipairs( f69_local7 ) --[[ @ 0]] do
			...
			if f69_local20 > CoD.CACUtility.EmptyItemIndex and f69_local20 ~= f69_arg3 then
				...
				if f69_local6 then
					...
					local f69_local12 = Engine[@"hash_2B8DE256555CACF5"]( f69_local3, f69_local20, f69_arg5 ) == Enum[@"eattachmentgroup"][@"hash_26EE211053211305"] --[[ @ 0]]
...
CoD.CACUtility.BuildItemModelDataFromUnlockableItem = function ( f89_arg0, f89_arg1, f89_arg2, f89_arg3, f89_arg4, f89_arg5, f89_arg6 )
	...
	elseif f89_arg2.itemGroup == "bubblegum_consumable" or f89_arg2.itemGroup == "bubblegum" then
		...
		if not CoD.DirectorUtility.ShowDirectorPregame( f89_arg1 ) then
			local f89_local15 = CoD.CACUtility.AreElixirGameSettingsRestricted( f89_local13, f89_arg2[@"bgbrarity"], false ) --[[ @ 0]]
	...
	elseif f89_arg2.itemGroup == CoD.CACUtility.talismanItemGroup then
		...
		if not CoD.DirectorUtility.ShowDirectorPregame( f89_arg1 ) then
			local f89_local16 = CoD.CACUtility.AreTalismanGameSettingsRestricted( f89_local10, f89_arg2[@"talismanrarity"], false ) --[[ @ 0]]
	...
	if not f89_local20 then
		f89_local20 = Enum[@"lootraritytype"][@"loot_rarity_type_count"] --[[ @ 0]]
	end
		...
		if not f90_arg2 or f90_arg2 <= 0 then
			...
			if f90_local1 then
				if f90_local1[@"hash_5C2AA73D9F82E9C2"] and f90_local1[@"ismark2"] then
					f90_arg3.displayName = Engine[@"hash_4F9F1239CFD921FE"]( f90_local1[@"displayname"] ) --[[ @ 0]]
				else
					...
					f90_arg3.signatureVariantName = f90_local1[@"displayname"] --[[ @ 0]]
				end
				if f89_local1 == Enum[@"emodes"][@"mode_zombies"] then
					f90_arg3.image = f90_local1[@"imagezm"] --[[ @ 0]]
				else
...
CoD.CACUtility.GetDefaultCustomClassNameForGametype = function ()
	local f93_local0 = Engine[@"lobbygetgametype"]() --[[ @ 0]]
	if f93_local0 then
		local f93_local1 = CoD.GameTypeUtility.GameTypeTable[Engine[@"converttoxhash"]( f93_local0 )] --[[ @ 0]]
...
CoD.CACUtility.GetDefaultCustomClassName = function ( f94_arg0, f94_arg1 )
	...
	if f94_arg1 == Enum[@"emodes"][@"mode_zombies"] or f94_arg1 == Enum[@"emodes"][@"mode_multiplayer"] then
		...
		if f94_arg1 == Enum[@"emodes"][@"mode_zombies"] then
			f94_local1 = Engine[@"hash_2E00B2F29271C60B"]( @"zm_default_loadouts" ) --[[ @ 0]]
		else
			f94_local1 = Engine[@"hash_2E00B2F29271C60B"]( LuaUtils.IsArenaMode() and @"mp_arena_default_loadouts" or @"mp_default_loadouts" ) --[[ @ 0]]
			...
			if f94_arg0 > Enum[@"loadoutclass_t"][@"custom_class_count"] then
				f94_arg0 = f94_arg0 - Enum[@"loadoutclass_t"][@"custom_class_count"] --[[ @ 0]]
		...
		f94_local0 = f94_local3[@"customclassname"] --[[ @ 0]]
		if f94_arg1 == Enum[@"emodes"][@"mode_zombies"] then
			...
			if f94_local4 > 1 then
				local f94_local6 = @"customclassname" .. f94_local5 --[[ @ 0]]
...
CoD.CACUtility.GetCustomClassModel = function ( f95_arg0, f95_arg1, f95_arg2, f95_arg3, f95_arg4 )
	...
	local f95_local0 = Engine[@"getcustomclasscacroot"]( f95_arg0, f95_arg1, f95_arg4, f95_arg3 ) --[[ @ 0]]
	...
	if f95_arg1 >= Enum[@"loadoutclass_t"][@"custom_class_count"] then
		...
		f95_local3:set( Engine[@"getdefaultclassname"]( f95_arg1 - Enum[@"loadoutclass_t"][@"custom_class_count"] ) ) --[[ @ 0]]
	end
	f95_local3 = function ( f96_arg0 )
		...
		if f96_local0 and f96_local0.itemIndex then
			...
			if f96_local1 ~= CoDShared.EmptyItemIndex then
				local f96_local3 = CoD.CACUtility.GetUnlockableItemInfoField( f96_local1, f95_arg4, "itemGroup", Enum[@"itemgroup_t"][@"itemgroup_invalid"] ) --[[ @ 0]]
	...
	f95_local5 = function ( f98_arg0, f98_arg1, f98_arg2 )
		...
		if f98_local1 > CoD.CACUtility.EmptyItemIndex then
					...
					if f98_local17 then
						if f98_local17[@"hash_5C2AA73D9F82E9C2"] and f98_local17[@"ismark2"] then
							if f98_local17[@"displayname"] then
								f98_local4 = Engine[@"hash_4F9F1239CFD921FE"]( f98_local17[@"displayname"] ) or f98_local4 --[[ @ 0]]
							end
						else
							f98_local4 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_341954FC612B5845", f98_local4 ) --[[ @ 0]]
							f98_local10 = true --[[ @ 0]]
							f98_local11 = f98_local17[@"displayname"] or @"hash_0" --[[ @ 0]]
						end
						if f95_arg4 ~= Enum[@"emodes"][@"mode_zombies"] then
							f98_local6 = f98_local17[@"imageref"] or f98_local6 --[[ @ 0]]
			...
			f98_local18:set( CoD.CACUtility.GetUnlockableItemInfoField( f98_local2, f95_arg4, @"unequipsound", @"hash_0" ) ) --[[ @ 0]]
		...
		elseif f95_arg4 == Enum[@"emodes"][@"mode_zombies"] then
			...
			elseif f98_arg1 == Enum[@"statindexoffset"][@"hash_15544C104CD15F10"] then
				...
				f98_local3 = CoD.CACUtility.AreTalismanGameSettingsRestricted( CoD.ZMTalismanUtility.TalismanToBooleanGameSettingsHash[f98_local0.refHash:get()], f98_local4[@"talismanrarity"], false ) or CoD.CACUtility.AreGameSettingsStateOff( CoD.ZMTalismanUtility.TalismanToEnumGameSettingsHash[f98_local0.refHash:get()], false ) --[[ @ 0]]
	 ...
	 --[[ @ 0]]
	f95_local5( "primary", Enum[@"statindexoffset"][@"hash_6569E84652131CD7"] ) --[[ @ 0]]
	f95_local5( "secondary", Enum[@"statindexoffset"][@"hash_6569E84652131CD7"] ) --[[ @ 0]]
		...
		local f99_local2 = function ( f100_arg0 )
			...
			for f100_local1 = 1 --[[ @ 0]], #f99_local1[f100_arg0], 1 do
				...
				if f100_local7 > CoD.CACUtility.EmptyItemIndex then
					...
					f100_local9:set( Engine[@"getattachmentnameshort"]( f99_local0, f100_local4, f95_arg4 ) ) --[[ @ 0]]
	...
	f95_local5( "primarygrenade", Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], @"hash_0" ) --[[ @ 0]]
	f95_local5( "tacticalgear", Enum[@"statindexoffset"][@"hash_68EA6ADA81FD4511"], @"hash_0" ) --[[ @ 0]]
	if f95_arg4 == Enum[@"emodes"][@"mode_zombies"] then
		f95_local5( "herogadget", Enum[@"statindexoffset"][@"hash_6569E84652131CD7"] ) --[[ @ 0]]
		for f95_local10, f95_local11 in ipairs( CoD.ZMPerkUtility.PerkSlotNameList ) --[[ @ 0]] do
			f95_local5( f95_local11, Enum[@"statindexoffset"][@"hash_49AF82A21BAD026D"] ) --[[ @ 0]]
		end
		for f95_local10, f95_local11 in ipairs( CoD.CACUtility.TalismanSlotNameList ) --[[ @ 0]] do
			f95_local5( f95_local11, Enum[@"statindexoffset"][@"hash_15544C104CD15F10"] ) --[[ @ 0]]
		end
	...
	if f95_arg4 == Enum[@"emodes"][@"mode_multiplayer"] then
		...
		if CoD.CACUtility.EmptyItemIndex < f95_local8 then
			local f95_local11 = Engine[@"getunlockableitemkvpinfo"]( f95_local8, f95_arg4 ) --[[ @ 0]]
			if f95_local11 then
		...
		for f95_local14, f95_local15 in ipairs( CoD.CACUtility.TalentSlotNameList ) --[[ @ 0]] do
			f95_local5( f95_local15, Enum[@"statindexoffset"][@"hash_68EA6ADA81FD4511"], @"hash_0" ) --[[ @ 0]]
		end
		...
		for f95_local14, f95_local15 in ipairs( CoD.CACUtility.BonuscardSlotNameList ) --[[ @ 0]] do
			f95_local5( f95_local15, Enum[@"statindexoffset"][@"hash_1A949B83CC070B0"], @"hash_0" ) --[[ @ 0]]
		end
		...
		f95_local11:set( Engine[@"hash_4F9F1239CFD921FE"]( @"mpui/perk1" ) ) --[[ @ 0]]
		f95_local11 = f95_arg2:create( "talent2Header" ) --[[ @ 0]]
		f95_local11:set( Engine[@"hash_4F9F1239CFD921FE"]( @"mpui/perk2" ) ) --[[ @ 0]]
		f95_local11 = f95_arg2:create( "talent3Header" ) --[[ @ 0]]
		f95_local11:set( Engine[@"hash_4F9F1239CFD921FE"]( @"mpui/perk3" ) ) --[[ @ 0]]
...
CoD.CACUtility.AttachmentLoadoutListPrepareHelper = function ( f101_arg0, f101_arg1, f101_arg2, f101_arg3, f101_arg4 )
	...
	DataSources[f101_local0] = DataSourceHelpers.ListSetup( f101_local0, function ( f102_arg0, f102_arg1 )
		...
		local f102_local4 = Engine[@"getunlockableitemkvpinfo"]( f102_local1, f101_arg4 ) --[[ @ 0]]
...
CoD.CACUtility.GetSignatureWeaponsListInternal = function ( f111_arg0, f111_arg1, f111_arg2, f111_arg3, f111_arg4, f111_arg5, f111_arg6, f111_arg7, f111_arg8 )
	...
	if f111_local4 and CoD.CACUtility.EmptyItemIndex < f111_arg6 then
		for f111_local25, f111_local26 in CoD.CACUtility.ForAvailableSignatureWeapons( f111_arg0, f111_local4, not IsCurrentMenu( f111_arg2, "PaintjobWeaponSelect" ) ) --[[ @ 0]] do
			local f111_local8 = Engine[@"hash_4F9F1239CFD921FE"]( f111_local26[@"displayname"] ) --[[ @ 0]]
			...
			local f111_local28 = f111_local26[@"ismark2"] --[[ @ 0]]
			...
			elseif not f111_local27 or not f111_local28 then
				...
				f111_local13 = f111_local26[@"displayname"] --[[ @ 0]]
				...
				if f111_local16 and #f111_local16 > 0 then
					for f111_local23, f111_local24 in ipairs( f111_local16 ) --[[ @ 0]] do
						if tonumber( Engine[@"hash_4C6F8EC444864600"]( CoD.attachmentTable, f111_local24, Enum[@"attachmenttablecolumn_e"][@"hash_726CA7CCFF2886B5"] ) ) == f111_local26[@"index"] then
							...
							f111_local21 = Engine[@"hash_4C6F8EC444864600"]( CoD.attachmentTable, f111_local24, Enum[@"attachmenttablecolumn_e"][@"attachmenttable_column_image"] ) --[[ @ 0]]
			...
			if f111_arg7 == Enum[@"emodes"][@"mode_zombies"] then
				...
				if f111_local26[@"imagezm"] and f111_local27 then
					f111_local11 = f111_local26[@"imagezm"] --[[ @ 0]]
				end
			end
			...
			if f111_arg8 then
				...
				if not f111_local19 then
					f111_local19 = Enum[@"lootraritytype"][@"loot_rarity_type_count"] --[[ @ 0]]
				end
...
CoD.CACUtility.GetHighestPermanentlyCompletedActiveCamoStage = function ( f118_arg0, f118_arg1, f118_arg2 )
	...
	for f118_local6, f118_local7 in ipairs( f118_arg1.stages ) --[[ @ 0]] do
		local f118_local8 = f118_local7[@"permanentstatname"] --[[ @ 0]]
...
CoD.CACUtility.AdjustCamoIfSignatureCamo = function ( f119_arg0, f119_arg1, f119_arg2 )
	...
	if f119_local1 and f119_local1 ~= @"hash_0" then
		...
		if f119_local2 and f119_local2.stages then
			...
			if f119_local3 then
				local f119_local4 = Engine[@"tablelookup"]( CoD.CACUtility.CamoOptionsTable, Enum[@"hash_25DD5CC8AEA7314B"][@"hash_6A6342D60A0D5AAE"], Enum[@"hash_25DD5CC8AEA7314B"][@"hash_3AA94CABDA68EB21"], f119_local3[@"camooption"] ) --[[ @ 0]]
...
CoD.CACUtility.ClearWeaponOptionsForClass = function ( f121_arg0, f121_arg1, f121_arg2 )
	...
	if f121_local5 then
		f121_local5:set( Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
		CoD.CACUtility.SetClassItem( f121_arg0, f121_local0, f121_local1 .. ".paintjobSlot", Enum[@"customizationpaintjobinvalidid"][@"customization_invalid_paintjob_slot"] ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.CACUtility.GetLoadout = function ( f130_arg0, f130_arg1 )
	...
	for f130_local6, f130_local7 in pairs( f130_local1 ) --[[ @ 0]] do
		...
		if LUI.startswith( f130_local6, "talent" ) or LUI.startswith( f130_local6, "tacticalgear" ) then
			f130_local0.talents[f130_local6] = Engine[@"hash_1E8B1E317B9DD6FE"]( f130_local7, Enum[@"statindexoffset"][@"hash_68EA6ADA81FD4511"], f130_local2 ) or f130_local7 --[[ @ 0]]
		end
		if LUI.startswith( f130_local6, "bonuscard" ) then
			f130_local0.bonuscards[f130_local6] = Engine[@"hash_1E8B1E317B9DD6FE"]( f130_local7, Enum[@"statindexoffset"][@"hash_1A949B83CC070B0"], f130_local2 ) or f130_local7 --[[ @ 0]]
		end
...
CoD.CACUtility.SetShowcaseWeaponToClassPrimary = function ( f132_arg0, f132_arg1 )
	...
	if CoD.CACUtility.EmptyItemIndex < f132_local4 then
		Engine[@"setheroshowcaseweaponattribute"]( f132_arg0, f132_local0, f132_local2, @"weaponindex", f132_local4 ) --[[ @ 0]]
	end
	...
	Engine[@"setheroshowcaseweaponattribute"]( f132_arg0, f132_local0, f132_local2, @"camoindex", CoD.CACUtility.GetItemEquippedInSlot( "primaryCamo", f132_arg0, f132_local1 ) ) --[[ @ 0]]
	Engine[@"setheroshowcaseweaponattribute"]( f132_arg0, f132_local0, f132_local2, @"paintjobslot", CoD.CACUtility.GetItemEquippedInSlot( "primarypaintjobslot", f132_arg0, f132_local1 ) ) --[[ @ 0]]
	...
	if f133_local0 ~= Enum[@"emodes"][@"mode_invalid"] and (f133_local4 == "primary" or f133_local4 == "secondary") then
		...
		if f133_local8 and f133_local8 > CoD.CACUtility.EmptyItemIndex and f133_local5 and f133_local5:get() and f133_local6 and f133_local6:get() then
			...
			if f133_local8 > CoD.CACUtility.EmptyItemIndex then
				Engine[@"setheroshowcaseweaponattribute"]( f133_arg1, f133_local1, f133_local9, @"weaponindex", f133_local8 ) --[[ @ 0]]
			end
			...
			Engine[@"setheroshowcaseweaponattribute"]( f133_arg1, f133_local1, f133_local9, @"camoindex", f133_local5:get() ) --[[ @ 0]]
			Engine[@"setheroshowcaseweaponattribute"]( f133_arg1, f133_local1, f133_local9, @"paintjobslot", f133_local6:get() ) --[[ @ 0]]
			Engine[@"setheroshowcaseweaponattribute"]( f133_arg1, f133_local1, f133_local9, @"weaponmodelslot", f133_local7:get() ) --[[ @ 0]]
...
CoD.CACUtility.GetAllRestrictedItems = function ()
	local f151_local0 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_game"] ) --[[ @ 0]]
...
CoD.CACUtility.GetItemVotedBy = function ( f158_arg0 )
	local f158_local0 = Engine[@"lobbygetsessionclients"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_game"] ) --[[ @ 0]]
...
CoD.CACUtility.GetCurrentWeaponXP = function ( f161_arg0, f161_arg1, f161_arg2 )
	local f161_local0 = Engine[@"getplayerstats"]( f161_arg0.CoD.STATS_LOCATION_NORMAL, Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
...
CoD.CACUtility.GetDescription = function ( f167_arg0, f167_arg1 )
	if f167_arg0 ~= Enum[@"emodes"][@"mode_zombies"] or f167_arg1.zmDescription == @"hash_0" or not f167_arg1.zmDescription then
...
CoD.CACUtility.GetFeatureCACItemIndex = function ()
	if CoD.CACUtility.CACFeatureItemIndex == nil or CoD.CACUtility.CACFeatureItemIndex == CoD.CACUtility.EmptyItemIndex then
		CoD.CACUtility.CACFeatureItemIndex = Engine[@"hash_2D97229B24C685D5"]( CoD.CACUtility.CACFeatureUnlockableItem, Enum[@"emodes"][@"mode_multiplayer"] ) --[[ @ 0]]
	end
...
CoD.CACUtility.GetEmblemColorList = function ( f173_arg0 )
	...
	local f173_local2 = Enum[@"customizationcolorswatch"][@"customization_color_swatch_rows"] --[[ @ 0]]
	local f173_local3 = Enum[@"customizationcolorswatch"][@"customization_color_swatch_columns"] --[[ @ 0]]
...
CoD.CACUtility.GetClassItem = function ( f178_arg0, f178_arg1, f178_arg2, f178_arg3 )
	...
	local f178_local0 = Engine[@"getcustomclasscacroot"]( f178_arg0, f178_arg1, f178_arg3 ) --[[ @ 0]]
	if f178_local0 then
...
CoD.CACUtility.SetClassItem = function ( f180_arg0, f180_arg1, f180_arg2, f180_arg3, f180_arg4, f180_arg5 )
	...
	local f180_local0 = Engine[@"getcustomclasscacroot"]( f180_arg0, f180_arg1, f180_arg5 ) --[[ @ 0]]
...
CoD.CACUtility.PrepareOverCapactiyList = function ( f182_arg0, f182_arg1 )
	...
	if LUI.startswith( f182_local5, "primary.attachment" ) or LUI.startswith( f182_local5, "secondary.attachment" ) then
		...
		local f182_local17 = Engine[@"getunlockableitemkvpinfo"]( f182_local15, f182_local4 ) --[[ @ 0]]
...
CoD.CACUtility.GetWeaponNameHashAndAttachmentsForXcam = function ( f195_arg0, f195_arg1, f195_arg2, f195_arg3, f195_arg4, f195_arg5, f195_arg6 )
	...
	if f195_local1 or f195_arg5 then
		...
		local f195_local3 = Engine[@"hash_7B98952F69D937F9"]( f195_local2, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f195_arg4 ) --[[ @ 0]]
		local f195_local4 = Engine[@"getunlockableitemkvpinfo"]( f195_local2, f195_arg4 ) --[[ @ 0]]
...
CoD.CACUtility.UnequipIncompatibleAttachments = function ( f196_arg0, f196_arg1, f196_arg2, f196_arg3, f196_arg4 )
	local f196_local0 = Engine[@"getcustomclasscacroot"]( f196_arg0, f196_arg1, f196_arg4 ) --[[ @ 0]]
...
CoD.CACUtility.AreAnyAttachmentsIncompatible = function ( f197_arg0, f197_arg1, f197_arg2, f197_arg3, f197_arg4 )
	local f197_local0 = Engine[@"getcustomclasscacroot"]( f197_arg0, f197_arg1, f197_arg4 ) --[[ @ 0]]
...
CoD.CACUtility.GetMutuallyExclusiveAttachments = function ( f203_arg0, f203_arg1, f203_arg2, f203_arg3, f203_arg4 )
	local f203_local0 = Engine[@"getcustomclasscacroot"]( f203_arg0, f203_arg1, f203_arg4 ) --[[ @ 0]]
	...
	if #f203_local1 > 1 then
		...
		local f203_local7 = Engine[@"hash_2B8DE256555CACF5"]( f203_local3, f203_arg3, f203_arg4 ) == Enum[@"eattachmentgroup"][@"hash_26EE211053211305"] --[[ @ 0]]
			...
			for f203_local9 = 0 --[[ @ 0]], #f203_local4 - 1, 1 do
				...
				if f203_local12 > CoD.CACUtility.EmptyItemIndex and f203_local12 ~= f203_arg3 then
					...
					if f203_local6 then
						...
						local f203_local14 = Engine[@"hash_2B8DE256555CACF5"]( f203_local3, f203_local12, f203_arg4 ) == Enum[@"eattachmentgroup"][@"hash_26EE211053211305"] --[[ @ 0]]
...
CoD.CACUtility.GetUsedAllocation = function ( f204_arg0, f204_arg1, f204_arg2 )
	...
	local f204_local1 = Engine[@"getcustomclasscacroot"]( f204_arg0, f204_arg1, f204_arg2 ) --[[ @ 0]]
...
CoD.CACUtility.GetLastSelectedLoadoutState = function ( f207_arg0, f207_arg1 )
	local f207_local0 = Engine[@"storagegetbuffer"]( f207_arg0, Enum[@"storagefiletype"][@"storage_common_settings"] ) --[[ @ 0]]
	if f207_local0 then
...
CoD.CACUtility.GetSpecialistEquipmentForSpecialistIndex = function ( f221_arg0, f221_arg1 )
	...
	if f221_local1 then
		local f221_local2 = Engine[@"getpositionroledefaultloadout"]( f221_arg1, f221_local1 ) --[[ @ 0]]
...
CoD.CACUtility.UpdateWeaponModelHelper = function ( f229_arg0, f229_arg1, f229_arg2, f229_arg3, f229_arg4, f229_arg5, f229_arg6, f229_arg7 )
	...
	elseif LUI.startswith( f229_arg3, "primarygrenade" ) then
		...
		f229_local0 = Engine[@"hash_7B98952F69D937F9"]( f229_arg4, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f229_arg5 ) --[[ @ 0]]
		...
		elseif f229_arg5 == Enum[@"emodes"][@"mode_zombies"] then
			...
			if f229_local4 and f229_local4[@"hash_5550F6A3B55C35"] then
				...
				f229_local3 = f229_local4[@"previewmodelscale"] or 1 --[[ @ 0]]
			end
		end
...
CoD.CACUtility.SetPerControllerClassNumFromCharacterIndex = function ( f252_arg0 )
	CoD.perController[f252_arg0].classNum = Engine[@"getpositionrolecustomclassindex"]( Engine[@"currentsessionmode"](), Engine[@"getcharacterindexforclientnum"]( f252_arg0, Engine[@"getclientnum"]( f252_arg0 ) ) ) --[[ @ 0]]
end
 --[[ @ 0]]
...
CoD.CACUtility.UpdateButtonPromptStatesForListSlots = function ( f254_arg0, f254_arg1, f254_arg2 )
	UpdateButtonPromptState( f254_arg0, f254_arg1, f254_arg2, Enum[@"luibutton"][@"lui_key_xba_pscross"] ) --[[ @ 0]]
	UpdateButtonPromptState( f254_arg0, f254_arg1, f254_arg2, Enum[@"luibutton"][@"lui_key_xbx_pssquare"] ) --[[ @ 0]]
	if CoD.isPC then
		UpdateButtonPromptState( f254_arg0, f254_arg1, f254_arg2, Enum[@"luibutton"][@"lui_key_ltrig"] ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
	...
	if IsBooleanDvarSet( "ui_enableCACScene" ) then
		...
		if f263_local0 ~= Enum[@"emodes"][@"mode_invalid"] then
			...
			if f263_local1[@"selectedcustomclass"] then
				local f263_local2 = Engine[@"getcustomclasscacroot"]( f263_arg0, f263_local1[@"selectedcustomclass"]:get(), f263_local0 ) --[[ @ 0]]
...
CoD.CACUtility.SetActiveListItemForWeaponGroup = function ( f292_arg0, f292_arg1, f292_arg2 )
	...
	if f292_local2 == "primary" or f292_local2 == "secondary" then
		if CoD.CACUtility.EmptyItemIndex < f292_local3 then
			local f292_local5 = Engine[@"getitemgroup"]( f292_local3, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f292_local1 ) --[[ @ 0]]
...
CoD.CACUtility.IsBaseSignatureWeapon = function ( f312_arg0, f312_arg1, f312_arg2 )
	...
	if f312_local0 and f312_local2 and f312_local1 and f312_local4 then
		local f312_local5 = Engine[@"hash_79F0BB7D52A7A978"]( Engine[@"hash_7B98952F69D937F9"]( f312_local4, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f312_local1 ) ) --[[ @ 0]]
		local f312_local6 --[[ @ 0]]
	...
	if f315_local0 and f315_local0.itemIndex then
		...
		if f315_local3 then
			if f315_local2[f315_local1 + 1][@"index"] > 0 then
				f315_local3 = not f315_local2[f315_local1 + 1][@"ismark2"] --[[ @ 0]]
			else
				f315_local3 = false --[[ @ 0]]
			end
		end
...
CoD.CACUtility.EquippingFocusedItemWouldRemoveThisItem = function ( f322_arg0, f322_arg1, f322_arg2 )
	...
	elseif f322_local0 ~= nil then
		...
		local f322_local2 = Engine[@"getcustomclasscacroot"]( f322_arg2, classNum, Engine[@"currentsessionmode"]() ) --[[ @ 0]]
...
CoD.CACUtility.ShouldHideItemNameText = function ( f344_arg0, f344_arg1 )
	...
	if not f344_local0 then
		if not IsElementPropertyValue( f344_arg0, "_showItemNameOnButtonHold", true ) or CoD.ModelUtility.AreButtonModelValueBitsSet( f344_arg1, Enum[@"luibutton"][@"lui_key_ltrig"], Enum[@"luibuttonflags"][@"flag_down"] ) then
			f344_local0 = CoD.ModelUtility.AreButtonModelValueBitsSet( f344_arg1, Enum[@"luibutton"][@"lui_key_ltrig"], Enum[@"luibuttonflags"][@"flag_down"] ) --[[ @ 0]]
			if f344_local0 then
...
CoD.CACUtility.GetItemImageFromIndex = function ( f355_arg0, f355_arg1, f355_arg2 )
	...
	if not f355_arg1 then
		f355_arg1 = Enum[@"statindexoffset"][@"hash_13057ABF96AF8289"] --[[ @ 0]]
	end
...
CoD.CACUtility.GetItemNameFromIndex = function ( f356_arg0, f356_arg1, f356_arg2 )
	...
	if not f356_arg1 then
		f356_arg1 = Enum[@"statindexoffset"][@"hash_13057ABF96AF8289"] --[[ @ 0]]
	end
...
CoD.CACUtility.GetItemDescriptionFromIndex = function ( f357_arg0, f357_arg1, f357_arg2 )
	...
	if not f357_arg1 then
		f357_arg1 = Enum[@"statindexoffset"][@"hash_13057ABF96AF8289"] --[[ @ 0]]
	end
...
CoD.CACUtility.FilterSignatureWeapon = function ( f370_arg0, f370_arg1, f370_arg2, f370_arg3 )
	...
	if f370_local0.isLoot then
		...
		return true
	elseif f370_arg1[@"entitlement"] ~= @"hash_0" and Engine[@"hasentitlement"]( f370_arg0, f370_arg1[@"entitlement"] ) then
		return true
	end
...
CoD.CACUtility.SetBaseWeaponNameAlpha = function ( f374_arg0, f374_arg1, f374_arg2, f374_arg3, f374_arg4 )
	...
	if f374_local1 and f374_arg3 and f374_local2 and f374_local4 then
		local f374_local5 = Engine[@"hash_79F0BB7D52A7A978"]( Engine[@"hash_7B98952F69D937F9"]( f374_local4, Enum[@"statindexoffset"][@"hash_6569E84652131CD7"], f374_local2 ) ) --[[ @ 0]]
		local f374_local6 --[[ @ 0]]
