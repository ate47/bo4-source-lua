...
CoD.CPUtility.CreateCPFactionList = function ( f3_arg0, f3_arg1, f3_arg2, f3_arg3 )
	...
	local f3_local1 = function ( f4_arg0 )
	 ...
	 --[[ @ 0]]
	table.insert( f3_local0, f3_local1( Enum[@"team_t"][@"team_allies"] ) ) --[[ @ 0]]
	table.insert( f3_local0, f3_local1( Enum[@"team_t"][@"team_axis"] ) ) --[[ @ 0]]
	return f3_local0
end
 --[[ @ 0]]
...
CoD.OverlayUtility.AddSystemOverlay( "ConfirmCompanionChange", {
	...
	description = function ( f15_arg0, f15_arg1 )
		...
		local f15_local1 = CoD.PlayerRoleUtility.GetCachedHeroInfo( Enum[@"emodes"][@"mode_campaign"], f15_local0.companion:get() ) --[[ @ 0]]
...
CoD.CPUtility.SetupFrontendForFaction = function ( f31_arg0, f31_arg1 )
	...
	SendCustomClientScriptNotifyForAdjustedClient( f31_arg0, CoD.CPUtility.FrontendPlayerCharacterUpdate, "changeBody", CoD.CPUtility.GetFactionBodyIndexForPlayer( f31_arg1 ), Enum[@"emodes"][@"mode_campaign"], true ) --[[ @ 0]]
	...
	if f31_arg1 ~= CoD.CPUtility.GetFactionFromStats( f31_local0 ) then
		for f31_local5, f31_local6 in ipairs( CoD.PlayerRoleUtility.GetHeroList( Enum[@"emodes"][@"mode_campaign"] ) ) --[[ @ 0]] do
...
CoD.CPUtility.SpawnDynamicCPHUDWidgets = function ( f58_arg0, f58_arg1 )
	...
	local f58_local1 = function ( f59_arg0, f59_arg1, f59_arg2, f59_arg3 )
		if worldIconModel then
			...
			if f59_local0 then
				LUI.CreateModelAndInitialize( f59_local0, "status", Enum[@"weakpointwidgetstates"][@"weakpoint_state_default"] ) --[[ @ 0]]
		...
		if f61_local0 == "weakpoint_update" then
			...
			if f61_local1.data[1] == 0 then
				if f58_arg0.weakpoints[f61_local2] and f58_arg0.weakpoints[f61_local2][f61_local3] then
					...
					if f61_local4 then
						Engine[@"setmodelvalue"]( f61_local4, Enum[@"weakpointwidgetstates"][@"weakpoint_state_closing"] ) --[[ @ 0]]
					end
	...
	if f58_local0 then
		...
		while f58_local6 do
			...
			local f58_local11 = Engine[@"getmodelforclient"]( f58_local5 ) --[[ @ 0]]
...
CoD.CPUtility.SetupNewsroomDataWatchers = function ( f68_arg0, f68_arg1 )
	...
	local f68_local1 = f68_local0 and Engine[@"hash_2E00B2F29271C60B"]( Engine[@"converttoxhash"]( f68_local0 ) ) --[[ @ 0]]
		...
		f68_arg0:linkToElementModel( f68_arg0, "noble.imageIndex", true, function ( model )
			...
			if f72_local1 > 0 and f68_local4.nobleimageentries then
				...
				if f72_local2[@"graphic"] ~= "" then
					f72_local0 = f72_local2[@"graphic"] or f72_local0 --[[ @ 0]]
				end
			end
		...
		if f73_local5 and #f73_local5 > 0 then
			...
			if #f73_local1 > 0 then
				...
				f73_arg0:addElement( LUI.UITimer.newElementTimer( 0, false, function ( f74_arg0 )
					...
					f73_local1[1].text:setText( Engine[@"localize"]( f73_local5[f74_local0][@"entry"] ) ) --[[ @ 0]]
					...
					if f74_arg0 then
						...
						if not f74_local7 then
							...
							while f74_local2 - f74_local3 < f73_local7 and f74_local9 <= #f73_local1 do
								f73_local1[f74_local9].text:setText( Engine[@"localize"]( f73_local5[f74_local0][@"entry"] ) ) --[[ @ 0]]
...
CoD.CPUtility.InitObjectiveNotificationSlidingTransition = function ( f103_arg0, f103_arg1, f103_arg2, f103_arg3, f103_arg4, f103_arg5 )
	...
	local f103_local3 = function ()
		f103_arg1:beginAnimation( CoD.CPUtility.NOTIFICATION_SLIDE_ANIM_TIME_MS, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
	...
	f109_arg0:registerEventHandler( CoD.CPUtility.ObjectiveNotificationTransitionEvent, function ( element, event )
		...
		if f115_local0 then
			...
			if f115_local2 then
				...
				f115_local0:beginAnimation( CoD.CPUtility.NOTIFICATION_SHRINK_ANIM_TIME_MS, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
				f115_local0:setLeftPx( f115_local8 ) --[[ @ 0]]
			end
			local f115_local3 = f109_arg0:getParent() --[[ @ 0]]
			if f115_local3 then
				f109_arg0.__savedHeight = f109_arg0:getHeight() --[[ @ 0]]
				f115_local3:beginAnimation( CoD.CPUtility.NOTIFICATION_SHRINK_ANIM_TIME_MS, Enum[@"luitween"][@"luitween_ease_out"] ) --[[ @ 0]]
...
CoD.CPUtility.LocalizeWithShortFriendlyAndEnemyTeams = function ( f130_arg0, f130_arg1 )
	...
	if f130_local0 == Enum[@"team_t"][@"team_allies"] then
		f130_local1 = Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
	else
		f130_local0 = Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
		f130_local1 = Enum[@"team_t"][@"team_allies"] --[[ @ 0]]
	end
...
CoD.CPUtility.LocalizeWithShortFriendlyTeam = function ( f131_arg0, f131_arg1 )
	...
	if f131_local0 ~= Enum[@"team_t"][@"team_allies"] then
		f131_local0 = Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
	end
...
CoD.CPUtility.LocalizeWithShortEnemyTeam = function ( f132_arg0, f132_arg1 )
	...
	if f132_local0 == Enum[@"team_t"][@"team_allies"] then
		f132_local1 = Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
	else
		f132_local1 = Enum[@"team_t"][@"team_allies"] --[[ @ 0]]
	end
...
CoD.CPUtility.TEMP_GetOnlyOtherNonCompanionPlayerDefectionText = function ( f133_arg0, f133_arg1 )
	for f133_local0 = 0 --[[ @ 0]], LuaDefine.MAX_CLIENTS - 1, 1 do
		local f133_local3 = Engine[@"getmodelforclient"]( f133_local0 ) --[[ @ 0]]
		if f133_local3.clientNum:get() ~= Engine[@"getclientnum"]( f133_arg0 ) and not f133_local3.isBot:get() then
			...
			if f133_local3.team:get() == Enum[@"team_t"][@"team_allies"] then
				f133_local4 = Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
			else
				f133_local4 = Enum[@"team_t"][@"team_allies"] --[[ @ 0]]
			end
...
CoD.CPUtility.TEMP_GetOnlyOtherNonCompanionPlayerDefectionColor = function ( f134_arg0, f134_arg1 )
	for f134_local0 = 0 --[[ @ 0]], LuaDefine.MAX_CLIENTS - 1, 1 do
		local f134_local3 = Engine[@"getmodelforclient"]( f134_local0 ) --[[ @ 0]]
...
CoD.OverlayUtility.AddSystemOverlay( "CPDefectPopup", {
	...
	description = function ( f136_arg0 )
		...
		if CoD.TeamUtility.GetTeam( f136_arg0 ) == Enum[@"team_t"][@"team_allies"] then
			f136_local0 = Enum[@"team_t"][@"team_axis"] --[[ @ 0]]
		else
			f136_local0 = Enum[@"team_t"][@"team_allies"] --[[ @ 0]]
		end
...
CoD.CPUtility.SetupChyron = function ( f144_arg0, f144_arg1 )
	...
	for f144_local2 = 1 --[[ @ 0]], 5, 1 do
		local f144_local5 = CoD.BaseUtility.GetMapValue( f144_local1, @"chyronline" .. f144_local2, @"hash_0" ) --[[ @ 0]]
