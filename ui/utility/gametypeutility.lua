...
CoD.GameTypeUtility.GameTypeTable = Engine[@"hash_1787E4B8EABFC69E"]() --[[ @ 0]]
...
CoD.GameTypeUtility.GetAllGameModes = function ( f4_arg0 )
	...
	for f4_local7, f4_local8 in pairs( Engine[@"GetGametypesBase"]( f4_arg0 ) ) --[[ @ 0]] do
		local f4_local9 = Engine[@"hash_7D492E0385F6D3E4"]( Engine[@"hash_1C53F8D38DF9042B"]( f4_local8.gametype ) ) --[[ @ 0]]
...
CoD.GameTypeUtility.GetStandardGameModes = function ( f5_arg0 )
	...
	for f5_local10, f5_local11 in pairs( Engine[@"GetGametypesBase"]( f5_arg0 ) ) --[[ @ 0]] do
		local f5_local12 = Engine[@"hash_5EA74FA7EE46E195"]( f5_local11.gametype ) --[[ @ 0]]
		if f5_local12[@"hash_31EBE909570DCA37"] == 0 then
			local f5_local3 = Engine[@"hash_7D492E0385F6D3E4"]( Engine[@"hash_1C53F8D38DF9042B"]( f5_local11.gametype ) ) --[[ @ 0]]
...
CoD.GameTypeUtility.GetLimitedTimeModes = function ( f6_arg0 )
	...
	for f6_local10, f6_local11 in pairs( Engine[@"GetGametypesBase"]( f6_arg0 ) ) --[[ @ 0]] do
		local f6_local12 = Engine[@"hash_5EA74FA7EE46E195"]( f6_local11.gametype ) --[[ @ 0]]
		if f6_local12[@"hash_31EBE909570DCA37"] == 1 then
			local f6_local3 = Engine[@"hash_7D492E0385F6D3E4"]( Engine[@"hash_1C53F8D38DF9042B"]( f6_local11.gametype ) ) --[[ @ 0]]
...
CoD.GameTypeUtility.ConvertMapNameToXHash = function ( f20_arg0 )
	if type( f20_arg0 ) ~= "xhash" then
		f20_arg0 = Engine[@"hash_1C53F8D38DF9042B"]( f20_arg0 ) --[[ @ 0]]
	end
	return f20_arg0
end
 --[[ @ 0]]
