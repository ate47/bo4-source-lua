...
CoD.MapUtility.AllMembersHaveDLCMask = function ( f5_arg0, f5_arg1, f5_arg2 )
	local f5_local0 = f5_arg2 == Enum[@"lobbymainmode"][@"lobby_mainmode_mp"] --[[ @ 0]]
	...
	for f5_local7, f5_local8 in ipairs( f5_arg0 ) --[[ @ 0]] do
		if f5_local2 then
			local f5_local6 = Engine[@"hash_5B892CC772EEDA44"]( Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
...
CoD.MapUtility.AllMembersHaveDLCMap = function ( f6_arg0, f6_arg1 )
	local f6_local0 = f6_arg1 and Engine[@"getdlcbitformapname"]( f6_arg1 ) --[[ @ 0]]
	if f6_local0 then
...
CoD.MapUtility.IsDLCMapFromName = function ( f8_arg0 )
	local f8_local0 = f8_arg0 and CoD.MapUtility.GetMapValue( f8_arg0, "dlc_pack", Enum[@"dlcindex_t"][@"content_original_map_index"] ) --[[ @ 0]]
...
CoD.MapUtility.LobbyHasMap = function ( f9_arg0, f9_arg1 )
	...
	if f9_local1 and f9_local1 ~= Enum[@"dlcindex_t"][@"content_dev_map_index"] and f9_local1 ~= Enum[@"dlcindex_t"][@"content_original_map_index"] then
		if not f9_arg1 then
			f9_arg1 = CoDShared.GetLobbyDLCBits( Engine[@"getlobbymainmode"](), Enum[@"lobbymodule"][@"lobby_module_client"], Enum[@"lobbytype"][@"lobby_type_private"] ) --[[ @ 0]]
		end
...
CoD.MapUtility.PlayMapLoadingMusic = function ()
	...
	if CoD.isWarzone then
		Dvar[@"cg_minimappadding"]:set( 22 ) --[[ @ 0]]
	else
		Dvar[@"cg_minimappadding"]:set( 14 ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.MapUtility.ConvertMapNameToXHash = function ( f19_arg0 )
	if type( f19_arg0 ) ~= "xhash" then
		f19_arg0 = Engine[@"converttoxhash"]( f19_arg0 ) --[[ @ 0]]
	end
	return f19_arg0
end
 --[[ @ 0]]
...
CoD.MapUtility.GetMapTeamNameFromMapID = function ( f28_arg0 )
	local f28_local0 = CoD.TeamUtility.TeamDevStringToEnum( CoD.MapUtility.GetMapValue( f28_arg0, @"playerteam", "" ) ) --[[ @ 0]]
	local f28_local1 --[[ @ 0]]
