...
local f0_local2 = function ( f26_arg0, f26_arg1 )
	local f26_local0 = function ( f27_arg0, f27_arg1, f27_arg2 )
		...
		local f27_local6, f27_local7 = Engine[@"hash_61A28BE9919661FA"]( f27_arg2 ) --[[ @ 0]]
	...
	local f26_local2 = function ()
		for f28_local3, f28_local4, f28_local5 in f26_local1:forEachElement() --[[ @ 0]] do
			if CoD.SafeGetModelValue( f28_local5:getModel(), "getActionFunction" ) then
				f26_arg0:AddButtonCallbackFunction( f28_local5, f26_arg1, Enum[@"LUIButton"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
...
CoD.ChatClientUtility.GetColorForGameEventType = function ( f40_arg0 )
	if f40_arg0 == Enum[@"hash_197A8DF5F2FA8BD5"][@"hash_2F51088437AB5AF5"] then
		return ColorSet.T8_PC_CHAT_EVENT_ENEMY
	elseif f40_arg0 == Enum[@"hash_197A8DF5F2FA8BD5"][@"hash_14D3BDE8AD3D7704"] then
		return ColorSet.T8_PC_CHAT_EVENT_ALLY
	elseif f40_arg0 ~= Enum[@"hash_197A8DF5F2FA8BD5"][@"hash_54A8B270BE295E3E"] then
