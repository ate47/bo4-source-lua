...
CoD.BonuscardUtility.GetSlotWithEquippedBonuscard = function ( f4_arg0, f4_arg1, f4_arg2 )
	if f4_arg0 then
		for f4_local3, f4_local4 in ipairs( CoD.CACUtility.BonuscardSlotNameList ) --[[ @ 0]] do
			...
			if f4_local5 and Engine[@"hash_7B98952F69D937F9"]( f4_local5.itemIndex:get(), Enum[@"hash_6EB546760F890D2"][@"hash_1A949B83CC070B0"], f4_arg2 ) == f4_arg1 then
				return f4_local4
			end
		end
	end
...
CoD.BonuscardUtility.IsBonuscardEquipped = function ( f6_arg0, f6_arg1, f6_arg2 )
	if f6_arg0 then
		for f6_local3, f6_local4 in ipairs( CoD.CACUtility.BonuscardSlotNameList ) --[[ @ 0]] do
			...
			if f6_local5 and Engine[@"hash_7B98952F69D937F9"]( f6_local5.itemIndex:get(), Enum[@"hash_6EB546760F890D2"][@"hash_1A949B83CC070B0"], f6_arg2 ) == f6_arg1 then
				return true
			end
		end
	end
...
CoD.BonuscardUtility.SpecificGunfighterEquippedCountDDL = function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
	...
	for f11_local5, f11_local6 in ipairs( CoD.CACUtility.BonuscardSlotNameList ) --[[ @ 0]] do
		...
		if f11_local7 > CoD.CACUtility.EmptyItemIndex and CoD.BonuscardUtility.IsBonuscardOfTypeList( f11_arg2, Engine[@"hash_7B98952F69D937F9"]( f11_local7, Enum[@"hash_6EB546760F890D2"][@"hash_1A949B83CC070B0"], f11_arg3 ) ) then
...
CoD.BonuscardUtility.GetBonucardUnlockHint = function ( f22_arg0, f22_arg1 )
	...
	return Engine[@"Localize"]( @"hash_1F8AF6E1799C89BB", Engine[@"GetItemName"]( f22_local0, Enum[@"hash_6EB546760F890D2"][@"hash_1A949B83CC070B0"], f22_arg1 ), Engine[@"GetItemUnlockLevel"]( f22_local0, Enum[@"hash_6EB546760F890D2"][@"hash_1A949B83CC070B0"], f22_arg1 ) + 1 )
end
 --[[ @ 0]]
