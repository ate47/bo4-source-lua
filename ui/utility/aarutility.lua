...
CoD.AARUtility.GetMinMaxXPForRank = function ( f8_arg0, f8_arg1 )
	return tonumber( Engine[@"hash_5446674C5F7BF2A7"]( f8_arg0 ) ), tonumber( Engine[@"hash_175A718DCC739F09"]( f8_arg0 ) )
end
 --[[ @ 0]]
...
CoD.AARUtility.UseTestData = function ()
	local f11_local0 = Dvar[@"hash_5A7587A8B8240BC4"]:exists() --[[ @ 0]]
	if f11_local0 then
		if Dvar[@"hash_5A7587A8B8240BC4"]:get() ~= true and Dvar[@"hash_5A7587A8B8240BC4"]:get() ~= "1" then
			f11_local0 = false --[[ @ 0]]
		else
			f11_local0 = true --[[ @ 0]]
		end
...
CoD.AARUtility.SetupNeededAarModels = function ( f14_arg0 )
	Engine[@"SetModelValue"]( Engine[@"CreateModel"]( Engine[@"GetModelForController"]( f14_arg0 ), "UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"] ), 1 ) --[[ @ 0]]
	Engine[@"SetModelValue"]( Engine[@"CreateModel"]( Engine[@"GetModelForController"]( f14_arg0 ), "UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_68A5E996D4528DA2"] ), 1 ) --[[ @ 0]]
	Engine[@"SetModelValue"]( Engine[@"CreateModel"]( Engine[@"GetModelForController"]( f14_arg0 ), "UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5198075B069840DC"] ), 1 ) --[[ @ 0]]
end
 --[[ @ 0]]
CoD.AARUtility.SetupUIModels = function ( f15_arg0 )
	...
	Engine[@"CreateModel"]( Engine[@"GetModelForController"]( f15_arg0 ), "UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_5C57360571B0917E"] ) --[[ @ 0]]
	Engine[@"CreateModel"]( Engine[@"GetModelForController"]( f15_arg0 ), "gameScore.gameTimeEnd" ) --[[ @ 0]]
	Engine[@"CreateModel"]( Engine[@"GetModelForController"]( f15_arg0 ), "UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_4F4EDA8B636F3F04"] ) --[[ @ 0]]
	if f15_local0 then
	...
	if f15_local0 then
		...
		local f15_local11 = Engine[@"hash_5EA74FA7EE46E195"]( f15_local2 ) --[[ @ 0]]
		...
		local f15_local12 = Engine[@"hash_778C0C3911890AB7"]() --[[ @ 0]]
		...
		if f15_local2 and f15_local2 ~= "" then
			...
			local f15_local22 = Engine[@"hash_1C53F8D38DF9042B"]( f15_local2 ) --[[ @ 0]]
...
CoD.AARUtility.CreateUIModelsForPerformanceGraphs = function ( f19_arg0, f19_arg1, f19_arg2 )
	...
	local f19_local5 = Engine[@"hash_7D492E0385F6D3E4"]( Engine[@"hash_1C53F8D38DF9042B"]( f19_arg2 ) ) --[[ @ 0]]
...
CoD.AARUtility.GetBlueprintStringPrefixForItem = function ( f22_arg0 )
	...
	if f22_local0 == "primary" or f22_local0 == "secondary" then
		return Engine[@"GetItemGroup"]( f22_arg0, Enum[@"hash_6EB546760F890D2"][@"hash_6569E84652131CD7"], Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] )
	else
		return f22_local0
	end
end
...
DataSources.AARTabs = ListHelper_SetupDataSource( "AARTabs", function ( f38_arg0, f38_arg1 )
		...
		if LuaUtils.IsArenaMode() then
			if CoD.AARUtility.PlayerEarnedRewards( f38_arg0 ) then
				table.insert( f38_local0, {
					models = {
						tabName = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_897061E92EE5BFC" ),
			...
			table.insert( f38_local0, {
				models = {
					tabName = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_15E9C86634E25EA8" ),
					action = CoD.AARUtility.SwitchAARTabs,
			...
			table.insert( f38_local0, {
				models = {
					tabName = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_707BB5E9B11633E3" ),
					action = CoD.AARUtility.SwitchAARTabs,
	...
	elseif Engine[@"IsZombiesGame"]() then
		...
		if CoD.AARUtility.GetCurrentGametype( f38_arg0 ) == "ztrials" then
			table.insert( f38_local0, {
				models = {
					tabName = Engine[@"ToUpper"]( Engine[@"hash_4F9F1239CFD921FE"]( @"hash_B8937E3C7212A42" ) ),
					action = CoD.AARUtility.SwitchAARTabs,
...
DataSources.AARStatTypeTabHeader = ListHelper_SetupDataSource( "AARStatTypeTabHeader", function ( f39_arg0 )
	...
	if IsWarzone() then
		table.insert( f39_local0, {
			models = {
				title = @"hash_FF67B9A8F997AB9",
				type = CoD.AARUtility.AARStatType.KILLS
			}
		} ) --[[ @ 0]]
		table.insert( f39_local0, {
			models = {
				title = @"hash_61100A6B91B62C1",
...
DataSources.AARGameHistory = ListHelper_SetupDataSource( "AARGameHistory", function ( f40_arg0, f40_arg1 )
	local f40_local0 = {} --[[ @ 0]]
	local f40_local1 = Engine[@"hash_7D492E0385F6D3E4"]( Engine[@"hash_1C53F8D38DF9042B"]( CoD.AARUtility.GetCurrentGametype( f40_arg0 ) ) ) --[[ @ 0]]
...
DataSources.AARKillStats = {
	...
	getItem = function ( f52_arg0, f52_arg1, f52_arg2 )
		...
		if f52_local1 then
			...
			local f52_local3 = Engine[@"hash_E4D2F32833CFA6C"]( CoD.AARUtility.GetInGameClientNum( f52_arg0 ) ) --[[ @ 0]]
	...
	if f56_local2 then
		...
		for f56_local11, f56_local12 in ipairs( f56_local2 ) --[[ @ 0]] do
			...
			if f56_local15.foundMedal then
				...
				if not IsWarzone() then
					f56_local10 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D6137AA2004DB90", f56_local9 ) --[[ @ 0]]
				else
					f56_local10 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_1BCE3D9B07DE63B7", f56_local9 ) --[[ @ 0]]
				end
				if f56_local5 and f56_local15.name == @"hash_6A3BB5B3F6DB9EF" then
				...
				if f56_local15.name == @"hash_6A3BB5B3F6DB9EF" then
...
CoD.AARUtility.GetPlayerRewards = function ( f60_arg0 )
	...
	local f60_local8 = function ( f61_arg0, f61_arg1 )
		...
		if IsZombies() then
			...
			f61_local2 = CoD.AARUtility.GetCurrencyEarned( f61_arg0, "initialPlasma", @"hash_229BE58E64C4830B", f61_local1 ) --[[ @ 0]]
			...
			if f61_local2 > 0 then
				...
				f61_local0.reward1Desc = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_79DB9C526E6370AB", f61_local2 ) --[[ @ 0]]
	...
	local f60_local11 = function ( f64_arg0, f64_arg1 )
		if f64_arg0 then
			...
			if not f64_arg1 then
				...
				return Engine[@"GetItemImage"]( Engine[@"hash_2D97229B24C685D5"]( f64_arg0, f60_local4 ), Enum[@"hash_6EB546760F890D2"][@"hash_68EA6ADA81FD4511"], f60_local4 )
			end
		else
	...
	local f60_local12 = function ( f65_arg0, f65_arg1, f65_arg2 )
		f65_arg0.title = f65_arg1[@"hash_C9C4F192EAB4DCD"] --[[ @ 0]]
		...
		f65_arg0.perksDataSource = CoD.AARUtility.CreateClassRewardPreviewDataSource( "AARClassRewardPerks_" .. f65_arg2, f65_arg1.talents, @"talent", Enum[@"hash_6EB546760F890D2"][@"hash_68EA6ADA81FD4511"] ) --[[ @ 0]]
		f65_arg0.wildcardsDataSource = CoD.AARUtility.CreateClassRewardPreviewDataSource( "AARClassRewardWildcards_" .. f65_arg2, f65_arg1.bonuscards, @"bonuscard", Enum[@"hash_6EB546760F890D2"][@"hash_1A949B83CC070B0"] ) --[[ @ 0]]
	end
	 --[[ @ 0]]
	local f60_local13 = function ( f66_arg0, f66_arg1 )
		...
		local f66_local3 = {
			...
			featureType = f66_local0[@"hash_21BF6EBC1ED37F75"]
		} --[[ @ 0]]
		if f66_local1 then
			local f66_local4 = Engine[@"hash_2E00B2F29271C60B"]( @"mp_default_loadouts" ) --[[ @ 0]]
			local f66_local5 = f66_local0[@"loadoutindex"] --[[ @ 0]]
			if f66_local0[@"hash_21BF6EBC1ED37F75"] == CoD.AARUtility.AARFeatureRewardType.CAC then
				f66_local3.desc = @"hash_0" --[[ @ 0]]
			elseif f66_local0[@"hash_21BF6EBC1ED37F75"] == CoD.AARUtility.AARFeatureRewardType.DEFAULT_CLASS then
				f60_local12( f66_local3, f66_local4.defaultloadouts[f66_local5], f66_arg1 ) --[[ @ 0]]
				f66_local3.desc = @"hash_2F75210679B788D6" --[[ @ 0]]
			elseif f66_local0[@"hash_21BF6EBC1ED37F75"] == CoD.AARUtility.AARFeatureRewardType.CUSTOM_CLASS then
	...
	for f60_local17, f60_local18 in pairs( f60_local6 ) --[[ @ 0]] do
		local f60_local23 = CoD.AARUtility.UpdateRankInfoIconsForPrestige( f60_arg0, f60_local17, Engine[@"hash_72C42E2565410E35"]( f60_local17 ), f60_local4 ) --[[ @ 0]]
...
CoD.AARUtility.GetWeaponRewards = function ( f69_arg0 )
	...
	for f69_local20, f69_local21 in pairs( f69_local2 ) --[[ @ 0]] do
		...
		for f69_local11, f69_local12 in pairs( f69_local21 ) --[[ @ 0]] do
			...
			f69_local13.totalXP = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D6137AA2004DB90", f69_local15 ) --[[ @ 0]]
...
CoD.AARUtility.AddTestChallengeReward = function ( f75_arg0, f75_arg1, f75_arg2 )
	...
	if f75_local0 then
		local f75_local1 = Engine[@"hash_4C6F8EC444864600"]( f75_local0, f75_arg2, Enum[@"milestoneTableColumns_t"][@"hash_3B52A4AE299402A3"] ) --[[ @ 0]]
		local f75_local2 = CoD.ChallengesUtility.ChallengeTypeHashToEnum[f75_local1] --[[ @ 0]]
		if not f75_local2 then
			f75_local2 = Enum[@"statsMilestoneTypes_t"][@"hash_626D4317EE22AF96"] --[[ @ 0]]
		end
		local f75_local3 = 0 --[[ @ 0]]
		local f75_local4 = 225 --[[ @ 0]]
		if f75_local2 == Enum[@"statsMilestoneTypes_t"][@"hash_14D0D341C55C3159"] then
			f75_local4 = 4 --[[ @ 0]]
		elseif f75_local2 == Enum[@"statsMilestoneTypes_t"][@"hash_586B082C51FC2370"] then
			f75_local4 = 1 --[[ @ 0]]
		end
		if f75_local2 == Enum[@"statsMilestoneTypes_t"][@"hash_626D4317EE22AF96"] then
			local f75_local5 = {
				"weapon_smg",
				"weapon_assault",
				"weapon_tactical",
			...
			for f75_local10, f75_local11 in ipairs( f75_local5 ) --[[ @ 0]] do
				if Engine[@"hash_1C53F8D38DF9042B"]( f75_local11 ) == f75_local1 then
...
CoD.AARUtility.GetContractRewards = function ( f78_arg0 )
	...
	local f78_local2 = function ( f79_arg0, f79_arg1 )
		...
		if f79_local0 and f79_local0.completed and f79_local0.completed:get() and f79_arg1 and f79_arg1.models then
			...
			local f79_local2 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_7D6137AA2004DB90", f79_local1.xpReward ) --[[ @ 0]]
...
DataSources.CharacterUnlock = ListHelper_SetupDataSource( "CharacterUnlock", function ( f81_arg0 )
	local f81_local0 = {} --[[ @ 0]]
	local f81_local1 = Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] --[[ @ 0]]
	...
	if #f81_local2 > 0 then
		...
		for f81_local24, f81_local25 in ipairs( f81_local3 ) --[[ @ 0]] do
			...
			local f81_local27 = Engine[@"hash_70B678B832BC9DC0"]( f81_local1, f81_local26 ) --[[ @ 0]]
			for f81_local21, f81_local22 in ipairs( f81_local2 ) --[[ @ 0]] do
				if f81_local22.refHash == f81_local27[@"hash_35E9D6D3424C0E7E"] then
					local f81_local8 = nil --[[ @ 0]]
					local f81_local9 = @"hash_C6F2E103E4397D" --[[ @ 0]]
					if IsBooleanDvarSet( @"hash_4A5FD7D94CFC9DFD" ) and f81_local27[@"hash_6E69216C2DA7060A"] == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] then
	...
	for f81_local24, f81_local25 in ipairs( CoD.AARUtility.GetRecentlyUnlockedWarzoneCharacters( f81_arg0 ) ) --[[ @ 0]] do
		...
		if f81_local26 then
			...
			local f81_local28 = Engine[@"hash_70B678B832BC9DC0"]( f81_local1, f81_local26 ) --[[ @ 0]]
			local f81_local29 = nil --[[ @ 0]]
			local f81_local23 = @"hash_C6F2E103E4397D" --[[ @ 0]]
			if IsBooleanDvarSet( @"hash_4A5FD7D94CFC9DFD" ) and f81_local28[@"hash_6E69216C2DA7060A"] == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] then
...
CoD.AARUtility.IsNemesis = function ( f103_arg0, f103_arg1 )
	...
	if f103_local0 then
		...
		local f103_local3 = Engine[@"hash_E4D2F32833CFA6C"]( f103_local0.clientNum:get() ) --[[ @ 0]]
...
CoD.AARUtility.ShouldShowNemesis = function ( f105_arg0, f105_arg1 )
	...
	if f105_local1.currentFocusedClient then
		...
		if f105_local2 then
			...
			if f105_local4 then
				local f105_local5 = Engine[@"hash_E4D2F32833CFA6C"]( f105_local4.clientNum:get() ) --[[ @ 0]]
...
CoD.AARUtility.RegisterForRightStickGridControl = function ( f113_arg0, f113_arg1, f113_arg2, f113_arg3 )
	...
	if IsFreeCursorActive( f113_arg2 ) then
		f113_arg0:AddButtonCallbackFunction( f113_arg0, f113_arg2, Enum[@"LUIButton"][@"hash_1057783F8DA4AAEF"], nil, function ( element, menu, controller, model )
		...
		f113_arg0:AddButtonCallbackFunction( f113_arg0, f113_arg2, Enum[@"LUIButton"][@"hash_4571F08AD84807E0"], nil, function ( element, menu, controller, model )
...
CoD.AARUtility.RegisterForTriggerNavigation = function ( f116_arg0, f116_arg1, f116_arg2, f116_arg3, f116_arg4 )
	...
	if f116_local0 then
		...
		f116_arg0:AddButtonCallbackFunction( f116_arg0, f116_arg2, Enum[@"LUIButton"][@"hash_3D2F467A6C6DA1AC"], "ui_prevtab", function ( element, menu, controller, model )
		...
		f116_arg0:AddButtonCallbackFunction( f116_arg0, f116_arg2, Enum[@"LUIButton"][@"hash_3820DDD869ABBFAA"], "ui_nexttab", function ( element, menu, controller, model )
			if IsRepeatButtonPress( model ) then
				return 
			else
...
CoD.AARUtility.SetupSummaryStats = function ( f119_arg0 )
	...
	local f119_local5 = CoD.BaseUtility.GetGameModeOnMapNameString( Engine[@"hash_1C53F8D38DF9042B"]( f119_local3 ), Engine[@"hash_1C53F8D38DF9042B"]( f119_local4 ) ) --[[ @ 0]]
	...
	f119_local8.gametype = Engine[@"hash_1C53F8D38DF9042B"]( f119_local3 ) --[[ @ 0]]
	...
	if not IsPublicOnlineGame() then
		...
		local f119_local24 = CoD.AARUtility.UpdateRankInfoIconsForPrestige( f119_arg0, f119_local22, Engine[@"hash_72C42E2565410E35"]( f119_local22 ) ) --[[ @ 0]]
		local f119_local25 = f119_local22 + 1 --[[ @ 0]]
		local f119_local26 = CoD.AARUtility.UpdateRankInfoIconsForPrestige( f119_arg0, f119_local25, Engine[@"hash_72C42E2565410E35"]( f119_local25 ) ) --[[ @ 0]]
	...
	Engine[@"hash_30DE279ECDDDD966"]( f119_arg0, @"hash_143529817734F2D9", {
		...
		[@"hash_426EC9C0483B3469"] = f119_local8.damage,
...
CoD.AARUtility.SetupSummaryStats_WZ = function ( f121_arg0 )
	...
	local f121_local4 = {
		...
		gametype = Engine[@"hash_1C53F8D38DF9042B"]( f121_local3 ),
	...
	if f121_local1 and f121_local2 then
		...
		if f121_local2 then
			...
			if not f121_local9 then
				...
				local f121_local13 = Engine[@"hash_72C42E2565410E35"]( f121_local9 ) --[[ @ 0]]
				local f121_local14 = Engine[@"hash_72C42E2565410E35"]( f121_local9 + 1 ) --[[ @ 0]]
				...
				if f121_local13 then
					...
					if f121_local11 ~= nil then
						f121_local18 = Engine[@"GetRankIcon"]( f121_local13.level, f121_local11, Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) --[[ @ 0]]
				...
				if f121_local14 then
					...
					local f121_local18 --[[ @ 0]]
					if f121_local11 ~= nil then
						f121_local18 = Engine[@"GetRankIcon"]( f121_local14.level, f121_local11, Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) --[[ @ 0]]
						if not f121_local18 then
...
CoD.AARUtility.SetupScoreboard = function ( f134_arg0 )
	...
	f134_local2:set( 0 ) --[[ @ 0]]
	local f134_local3 = Engine[@"hash_E4D2F32833CFA6C"]( CoD.AARUtility.GetInGameClientNum( f134_arg0 ) ) --[[ @ 0]]
	local f134_local4 = nil --[[ @ 0]]
	if CoD.CodCasterUtility.IsCodCasterAssigned( f134_arg0 ) then
		f134_local4 = Enum[@"team_t"][@"hash_42A34B055ADD98AB"] --[[ @ 0]]
	else
		f134_local4 = f134_local3.team:get() --[[ @ 0]]
	end
	local f134_local5 = Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] --[[ @ 0]]
	local f134_local6 = "TEAM_ALLIES" --[[ @ 0]]
	local f134_local7 = "TEAM_AXIS" --[[ @ 0]]
	if f134_local4 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
		f134_local5 = Enum[@"team_t"][@"hash_42A34B055ADD98AB"] --[[ @ 0]]
...
CoD.AARUtility.CanShowAAR = function ( f139_arg0, f139_arg1 )
	...
	if f139_local2 and f139_local3 then
		...
		local f139_local5 = Engine[@"hash_7D492E0385F6D3E4"]( Engine[@"hash_1C53F8D38DF9042B"]( f139_local4 ) ) --[[ @ 0]]
...
CoD.AARUtility.AddForceStreamAARImages = function ( f141_arg0 )
	...
	if f141_local1 and f141_local2 then
		...
		for f141_local5 = f141_local3 --[[ @ 0]], f141_local4, 1 do
			local f141_local8 = CoD.AARUtility.UpdateRankInfoIconsForPrestige( f141_arg0, f141_local5, Engine[@"hash_72C42E2565410E35"]( f141_local5 ) ) --[[ @ 0]]
...
CoD.AARUtility.GetPreviousGameStatForGametype = function ( f152_arg0, f152_arg1, f152_arg2 )
	...
	if f152_local1 then
		local f152_local2 = f152_local1.PlayerStatsByGameType[Engine[@"hash_7D492E0385F6D3E4"]( Engine[@"hash_1C53F8D38DF9042B"]( f152_arg1 ) )] --[[ @ 0]]
		if f152_local2 then
...
CoD.AARUtility.AddLootCaseRewardDataToTable = function ( f155_arg0, f155_arg1, f155_arg2 )
	table.insert( f155_arg1, {
		models = {
			...
			isLootCase = true,
			itemCategory = @"hash_355E6190E8792FD1",
...
CoD.AARUtility.UnlockTierRewards = function ( f163_arg0, f163_arg1 )
	...
	f163_local0._unlockTimer = LUI.UITimer.newElementTimer( CoD.AARUtility.AARTierRewardStaggeredUnlockTime, false, function ( f165_arg0 )
		...
		if f165_local0 > 0 and f163_local4 <= f165_local0 then
			...
			if f165_local1.itemName and f165_local1.itemName:get() == @"hash_355E6190E8792FD1" then
...
CoD.AARUtility.GetLootCaseData = function ( f174_arg0 )
	...
	if f174_local0 then
		...
		if Engine[@"hash_72DA54CF5D6B7F02"]() and Dvar[@"hash_7F6CA45E5DCB4A98"]:exists() then
...
CoD.AARUtility.GetPreMatchLootCaseData = function ( f175_arg0 )
	...
	if f175_local1 and f175_local2 then
		...
		if Engine[@"hash_72DA54CF5D6B7F02"]() and Dvar[@"hash_7F61BE860EB8007A"]:exists() then
...
CoD.AARUtility.SetupTierRewardModels = function ( f181_arg0, f181_arg1 )
	...
	if f181_local0 < f181_local2 then
		for f181_local17, f181_local18 in ipairs( CoD.BlackMarketUtility.GetTierItemsForStream( f181_arg1, f181_local0 + 1, f181_local2, false, true ) ) --[[ @ 0]] do
			if f181_local18.unlocked and f181_local18.itemName == @"hash_355E6190E8792FD1" then
...
CoD.AARUtility.IsTierRewardCharacterType = function ( f192_arg0, f192_arg1 )
	...
	if f192_local0 and f192_local0.itemCategory then
		...
		local f192_local2 --[[ @ 0]]
		if f192_local1 ~= @"hash_1DD691088352B680" and f192_local1 ~= @"hash_3C398D8E22A2269B" then
			f192_local2 = false --[[ @ 0]]
		else
			f192_local2 = true --[[ @ 0]]
		end
			...
			if f200_local3[f200_local17] then
				if f200_local3[f200_local17]:get() == 0 and f200_local4[f200_local17]:get() == 1 then
					...
					for f200_local14, f200_local15 in ipairs( f200_local6 ) --[[ @ 0]] do
						if f200_local15[@"hash_514C91FFB3BA4240"] == f200_local17 then
					...
					if f200_local10 then
						table.insert( f200_local0, {
							models = {
								mainTitle = f200_local10[@"hash_42224F4DE4A23299"],
								levelText = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_47FC454B26C88374" ),
								mainIcon = f200_local10[@"hash_3EBCB3D3B3ECFBC0"],
								rewardType = CoD.AARUtility.AARRewardType.SPECIAL_EVENT,
								reward1Icon = f200_local10[@"hash_5BFF4CC56C2092F0"],
...
CoD.AARUtility.GetUnlockableItemInfoFromCharacterIndex = function ( f202_arg0, f202_arg1 )
	local f202_local0 = Engine[@"hash_70B678B832BC9DC0"]( f202_arg0, f202_arg1 ) --[[ @ 0]]
	return Engine[@"GetUnlockableInfoByIndex"]( Engine[@"hash_2D97229B24C685D5"]( f202_local0[@"hash_35E9D6D3424C0E7E"], f202_arg0 ), f202_arg0 )
end
 --[[ @ 0]]
...
CoD.AARUtility.SetupMissionRewardModels = function ( f204_arg0, f204_arg1 )
	...
	if f204_local2 then
		...
		local f204_local4 = CoD.AARUtility.UpdateRankInfoIconsForPrestige( f204_arg1, f204_local3, Engine[@"hash_72C42E2565410E35"]( f204_local3 ) ) --[[ @ 0]]
...
CoD.AARUtility.SetMeritModelsFromRankInfo = function ( f205_arg0, f205_arg1, f205_arg2, f205_arg3, f205_arg4 )
	...
	if f205_arg1 then
		...
		if f205_arg3 ~= nil then
			f205_local1 = Engine[@"GetRankIcon"]( f205_arg1.level, f205_arg3, Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) --[[ @ 0]]
			if not f205_local1 then
				...
				local f205_local2 --[[ @ 0]]
				if f205_arg3 ~= nil then
					f205_local2 = Engine[@"hash_11F63E4E0932DCCF"]( f205_arg1.level, f205_arg3, Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) --[[ @ 0]]
	...
	if f205_arg2 then
		local f205_local1 --[[ @ 0]]
		if f205_arg3 ~= nil then
			f205_local1 = Engine[@"GetRankIcon"]( f205_arg2.level, f205_arg3, Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) --[[ @ 0]]
			if not f205_local1 then
...
CoD.AARUtility.SetupMeritRewardModels = function ( f207_arg0, f207_arg1, f207_arg2 )
	...
	local f207_local11 = Engine[@"hash_7D492E0385F6D3E4"]( Engine[@"hash_1C53F8D38DF9042B"]( f207_local10 ) ) --[[ @ 0]]
	...
	local f207_local15 = Engine[@"hash_72C42E2565410E35"]( f207_local0 ) --[[ @ 0]]
	local f207_local16 = Engine[@"hash_72C42E2565410E35"]( f207_local0 + 1 ) --[[ @ 0]]
	if f207_local12 then
	...
	if f207_arg2 then
		f207_local15 = Engine[@"hash_72C42E2565410E35"]( f207_local1 ) --[[ @ 0]]
		f207_local16 = Engine[@"hash_72C42E2565410E35"]( f207_local1 + 1 ) --[[ @ 0]]
	end
	...
	if f207_arg0._placementMerits > 0 then
		local f207_local20 = function ( f208_arg0 )
		 ...
		 --[[ @ 0]]
		f207_local19 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_2F3AA35A77FB540C", f207_local20( f207_arg0._placementMerits ) ) --[[ @ 0]]
	else
	...
	local f207_local20 = LocalizeStringWithParameter( @"hash_250158F8FB37F010", tostring( f207_local17 ) ) --[[ @ 0]]
	...
	f207_local23:set( @"hash_73EC1D01B53129AE" ) --[[ @ 0]]
	...
	f207_local23:set( @"hash_BCD9AEC3F8CFEBE" ) --[[ @ 0]]
	...
	local f207_local31 = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_BCD9AEC3F8CFEBE" ) --[[ @ 0]]
...
CoD.AARUtility.AnimateMeritBar = function ( f219_arg0, f219_arg1 )
	...
	f219_arg0._barAnimTimer = LUI.UITimer.newElementTimer( 10, false, function ( f220_arg0 )
		...
		if f219_local5 <= f219_local6 then
			...
			if f219_arg0._currentRank < f219_arg0._endRank then
				CoD.AARUtility.SetMeritModelsFromRankInfo( f219_arg1, Engine[@"hash_72C42E2565410E35"]( f219_arg0._currentRank ), Engine[@"hash_72C42E2565410E35"]( f219_arg0._currentRank + 1 ), f219_arg0._currentPrestige, not f219_arg0._hasShownRank ) --[[ @ 0]]
		...
		if f221_local5 then
			for f221_local6 = 0 --[[ @ 0]], 3, 1 do
				...
				if f221_local9 then
					...
					local f221_local11 = Engine[@"hash_72C42E2565410E35"]( f221_local10 ) --[[ @ 0]]
...
CoD.AARUtility.SetupLevelUpModels = function ( f224_arg0, f224_arg1 )
	...
	local f224_local8 = CoD.AARUtility.UpdateRankInfoIconsForPrestige( f224_arg1, f224_local2, Engine[@"hash_72C42E2565410E35"]( f224_local2 ) ) --[[ @ 0]]
	local f224_local9 = f224_local2 + 1 --[[ @ 0]]
	local f224_local10 = CoD.AARUtility.UpdateRankInfoIconsForPrestige( f224_arg1, f224_local9, Engine[@"hash_72C42E2565410E35"]( f224_local9 ) ) --[[ @ 0]]
	if f224_local7 then
...
CoD.AARUtility.RankUp = function ( f225_arg0, f225_arg1 )
	...
	local f225_local2 = CoD.AARUtility.UpdateRankInfoIconsForPrestige( f225_arg1, f225_local0, Engine[@"hash_72C42E2565410E35"]( f225_local0 ) ) --[[ @ 0]]
	local f225_local3 = CoD.AARUtility.UpdateRankInfoIconsForPrestige( f225_arg1, f225_local1, Engine[@"hash_72C42E2565410E35"]( f225_local1 ) ) --[[ @ 0]]
...
CoD.AARUtility.ProcessAAROverlays_WZ = function ( f244_arg0, f244_arg1 )
	...
	local f244_local1 = function ()
		...
		local f246_local7 --[[ @ 0]]
		if f246_local4 ~= Engine[@"GetPrestigeCap"]( Enum[@"eModes"][@"hash_3BF1DCC8138A9D39"] ) or f246_local3 ~= f246_local6 - 1 or f246_local5 ~= f246_local6 then
			f246_local7 = false --[[ @ 0]]
		else
			f246_local7 = true --[[ @ 0]]
		end
...
CoD.OverlayUtility.AddSystemOverlay( "AAR_LeaguePlayDivPlacement", {
	...
	[CoD.OverlayUtility.aCrossPromptText] = @"hash_66393FF34EA56966",
