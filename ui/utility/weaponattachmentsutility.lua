...
CoD.WeaponAttachmentsUtility.WeaponAttachmentGroupNames = {
	{
		attachmentGroup = Enum[@"hash_7420BCDBDE17A84"][@"hash_56AC43DB9B6634DA"],
		name = @"hash_313BE4995FD8DBF8"
	},
	{
		attachmentGroup = Enum[@"hash_7420BCDBDE17A84"][@"hash_72FDACB5DC7958DD"],
		name = @"hash_649BD5D27E45D8A4"
	},
	{
		attachmentGroup = Enum[@"hash_7420BCDBDE17A84"][@"hash_42701CB609E58337"],
		name = @"hash_7DBA1D8EA36A999"
	},
	{
		attachmentGroup = Enum[@"hash_7420BCDBDE17A84"][@"hash_26EE211053211305"],
		name = @"hash_4CD6625B5DAFD45F"
	},
	{
		attachmentGroup = Enum[@"hash_7420BCDBDE17A84"][@"hash_34877F405CA40935"],
		name = @"hash_649BD5D27E45D8A4"
	}
} --[[ @ 0]]
	...
	if f1_arg1 and f1_arg0.attachmentUpgrades then
		for f1_local3, f1_local4 in ipairs( f1_arg0.attachmentUpgrades ) --[[ @ 0]] do
			if f1_local4[@"hash_1BF43C7495E3788C"] == f1_arg1 then
				return f1_local4[@"hash_57EB5A64A49DE165"]
			end
		end
	end
end
...
CoD.WeaponAttachmentsUtility.GetUpgradedAttachmentRef = function ( f2_arg0, f2_arg1 )
	if f2_arg1 and f2_arg0.attachmentUpgrades then
		for f2_local3, f2_local4 in ipairs( f2_arg0.attachmentUpgrades ) --[[ @ 0]] do
			if f2_local4[@"hash_57EB5A64A49DE165"] == f2_arg1 then
...
CoD.WeaponAttachmentsUtility.GetAttachmentCautionText = function ( f9_arg0, f9_arg1, f9_arg2, f9_arg3, f9_arg4, f9_arg5 )
	...
	if #f9_local2 > 0 then
		...
		if not Engine[@"IsOptic"]( f9_arg3, f9_arg4 ) or not Engine[@"IsOptic"]( f9_arg3, f9_local2[1].attachmentIndex ) then
			if Engine[@"hash_6037522AE910C327"]( f9_local3, f9_arg5 ) == Enum[@"hash_7420BCDBDE17A84"][@"hash_26EE211053211305"] then
				f9_local1 = @"hash_691F59C33FE184A9" --[[ @ 0]]
			else
				f9_local1 = @"hash_673A7619DEA60089" --[[ @ 0]]
			end
		end
	end
	return f9_local1
...
CoD.WeaponAttachmentsUtility.UpdateHorizontalCount = function ( f11_arg0, f11_arg1, f11_arg2 )
	...
	if f11_local1 and CoD.CACUtility.EmptyItemIndex < f11_local3 then
		local f11_local7 = Engine[@"hash_72964239F2151F6F"]( f11_local3, f11_local1 ) --[[ @ 0]]
...
CoD.WeaponAttachmentsUtility.UpdateEquippedWeaponAttachmentAttributes = function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
	local f13_local0 = Enum[@"WeaponAttributesColumn"][@"hash_55B7E5FC5552F23A"] --[[ @ 0]]
	local f13_local1 = Enum[@"WeaponAttributesColumn"][@"hash_1115E22D013F28C1"] --[[ @ 0]]
	local f13_local2 = Enum[@"WeaponAttributesColumn"][@"hash_51BABA455D2DC80"] --[[ @ 0]]
	local f13_local3 = Enum[@"WeaponAttributesColumn"][@"hash_1A6E182D6FE3472"] --[[ @ 0]]
	local f13_local4 = Enum[@"WeaponAttributesColumn"][@"hash_5083C82F930E500"] --[[ @ 0]]
	local f13_local5 = Enum[@"WeaponAttributesColumn"][@"hash_2295ABB48F2C6284"] --[[ @ 0]]
	local f13_local6 = f13_arg0[f13_arg1 .. ".itemIndex"]:get() --[[ @ 0]]
	local f13_local7 = Engine[@"hash_7B98952F69D937F9"]( f13_local6, Enum[@"hash_6EB546760F890D2"][@"hash_6569E84652131CD7"], f13_arg3 ) --[[ @ 0]]
	local f13_local8 = {
		damage = 0,
		range = 0,
		fireRate = 0,
...
CoD.WeaponAttachmentsUtility.GetWeaponAttachmentAttributes = function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3, f14_arg4 )
	local f14_local0 = Enum[@"WeaponAttributesColumn"][@"hash_55B7E5FC5552F23A"] --[[ @ 0]]
	local f14_local1 = Enum[@"WeaponAttributesColumn"][@"hash_1115E22D013F28C1"] --[[ @ 0]]
	local f14_local2 = Engine[@"hash_7B98952F69D937F9"]( f14_arg0, Enum[@"hash_6EB546760F890D2"][@"hash_6569E84652131CD7"], f14_arg2 ) --[[ @ 0]]
	local f14_local3 = CoD.CACUtility.GetUnlockableItemInfo( f14_arg0, f14_arg2 ) --[[ @ 0]]
	local f14_local4 = f14_local3.attributesTable --[[ @ 0]]
	if f14_local3.attributesTableZM and f14_arg2 == Enum[@"eModes"][@"hash_73723205FAE52C4A"] then
	...
	local f14_local5 = function ( f15_arg0, f15_arg1 )
	 ...
	 --[[ @ 0]]
	local f14_local6 = {
		damage = f14_local5( "damage", Enum[@"WeaponAttributesColumn"][@"hash_51BABA455D2DC80"] ),
		range = f14_local5( "range", Enum[@"WeaponAttributesColumn"][@"hash_1A6E182D6FE3472"] ),
		fireRate = f14_local5( "fireRate", Enum[@"WeaponAttributesColumn"][@"hash_5083C82F930E500"] ),
		accuracy = f14_local5( "accuracy", Enum[@"WeaponAttributesColumn"][@"hash_2295ABB48F2C6284"] ),
		magCount = 0,
		magSize = 0,
		uberName = @"hash_0",
		uberImage = @"hash_0"
	...
	if f14_arg2 == Enum[@"eModes"][@"hash_73723205FAE52C4A"] then
...
CoD.WeaponAttachmentsUtility.GetWeaponAttachmentList = function ( f18_arg0, f18_arg1, f18_arg2 )
	...
	local f18_local6 = Engine[@"hash_72964239F2151F6F"]( f18_local5, f18_local2 ) --[[ @ 0]]
	...
	for f18_local11 = 1 --[[ @ 0]], f18_local7 - 1, 1 do
		...
		if CoD.CACUtility.EmptyItemIndex < f18_local14 then
			...
			local f18_local17 = Engine[@"hash_A48813350B43601"]( f18_local5, f18_local11, f18_local2 ) --[[ @ 0]]
			...
			local f18_local28 = f18_local21 == Enum[@"hash_7420BCDBDE17A84"][@"hash_26EE211053211305"] --[[ @ 0]]
			...
			elseif f18_local28 then
				if f18_local2 == Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] then
...
CoD.WeaponAttachmentsUtility.UpdateAttachmentFilter = function ( f22_arg0, f22_arg1, f22_arg2 )
	...
	local f22_local1 = function ( f23_arg0 )
		if f22_local0 == "optic" then
			return f23_arg0 == Enum[@"hash_7420BCDBDE17A84"][@"hash_56AC43DB9B6634DA"]
		elseif f22_local0 == "uber" then
			return f23_arg0 == Enum[@"hash_7420BCDBDE17A84"][@"hash_26EE211053211305"]
		else
			local f23_local0 --[[ @ 0]]
			if f23_arg0 == Enum[@"hash_7420BCDBDE17A84"][@"hash_56AC43DB9B6634DA"] or f23_arg0 == Enum[@"hash_7420BCDBDE17A84"][@"hash_26EE211053211305"] then
				f23_local0 = false --[[ @ 0]]
			else
				f23_local0 = true --[[ @ 0]]
			end
...
CoD.WeaponAttachmentsUtility.GetAttachmentSlotForItemIndex = function ( f29_arg0, f29_arg1, f29_arg2, f29_arg3, f29_arg4 )
	local f29_local0 = Engine[@"hash_ED9C4D9D6233895"]( f29_arg0, f29_arg2, f29_arg4 ) --[[ @ 0]]
	if f29_local0 then
...
CoD.WeaponAttachmentsUtility.ValidateUpgradeAttachmentLoadoutHelper = function ( f30_arg0, f30_arg1, f30_arg2, f30_arg3 )
	...
	local f30_local1 = Engine[@"hash_72964239F2151F6F"]( f30_local0, f30_arg3 ) --[[ @ 0]]
