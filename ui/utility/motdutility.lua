...
CoD.MOTDUtility.MOTD_UnhandledAction = function ( f9_arg0, f9_arg1, f9_arg2, f9_arg3 )
	...
	Engine[@"PrintError"]( Enum[@"hash_77A63DCD561B0FA8"][@"hash_71725ABF82092BD8"], "MOTD: Unhandled action: " .. f9_arg3 .. " at offset: " .. tostring( f9_local0 ) .. ".\n" ) --[[ @ 0]]
...
CoD.MOTDUtility.Close = function ( f11_arg0, f11_arg1, f11_arg2 )
	...
	if CoD.perController[f11_arg1].isMOTDInLobbyVM and Engine[@"hash_69882F293C327557"]() == LobbyData.GetLobbyMenuIDByName( LuaEnum.UI.MAIN ) then
...
CoD.MOTDUtility.CreateMOTDFeatureCard = function ( f20_arg0, f20_arg1 )
	if Dvar[@"hash_261B37B5CD0C5CC1"]:exists() and Dvar[@"hash_261B37B5CD0C5CC1"]:get() then
		table.insert( f20_arg0, {
			models = {
				locked = false,
				name = Engine[@"hash_4F9F1239CFD921FE"]( @"hash_22DEBC821FE9A08B" ),
...
CoD.MOTDUtility.MOTD_ShouldLogInteraction = function ( f23_arg0 )
	if CoD.MOTDUtility.ReportCount ~= 0 and f23_arg0 == CoD.MOTDUtility.LastMessageID then
		...
		if CoD.MOTDUtility.ReportCount < CoD.MOTDUtility.MaxReportCount then
			...
			return true
		elseif CoD.MOTDUtility.NextReportTime > Engine[@"hash_69D33D652B9B0F3B"]() then
			return false
		else
			CoD.MOTDUtility.NextReportTime = Engine[@"hash_69D33D652B9B0F3B"]() + CoD.MOTDUtility.ReportInterval * 1000 --[[ @ 0]]
			return true
		end
	end
end
					...
					if not f24_local3 then
						...
						if f24_local3 and f24_local4 and (f24_arg2 or CoD.MOTDUtility.MOTD_ShouldLogInteraction( f24_local3 )) then
							Engine[@"hash_30DE279ECDDDD966"]( f24_arg0, @"hash_46647F4E58A2A212", {
								[@"hash_672F1795FF3E15F4"] = f24_local2,
	...
	if f25_local2( f25_local1 ) then
		if not CoD.MOTDUtility.AllActionsDisabled() then
			...
			if not f25_local7() then
				table.insert( f25_local0, CoD.MOTDUtility.packageMOTDButtonData( @"hash_229C903C6DF90D6F", f25_local3, f25_local7 ) ) --[[ @ 0]]
			end
			...
			if not f25_local10() then
				table.insert( f25_local0, CoD.MOTDUtility.packageMOTDButtonData( @"hash_E07AF27BEA3B907", f25_local3, f25_local10 ) ) --[[ @ 0]]
			end
			...
			if not f25_local12() then
				table.insert( f25_local0, CoD.MOTDUtility.packageMOTDButtonData( @"hash_3FF19F036B1F8248", f25_local3, f25_local12 ) ) --[[ @ 0]]
			end
			...
			if not f25_local14() then
				table.insert( f25_local0, CoD.MOTDUtility.packageMOTDButtonData( @"hash_6DDDA371285672BD", f25_local3, f25_local14 ) ) --[[ @ 0]]
			end
		end
		table.insert( f25_local0, CoD.MOTDUtility.packageMOTDButtonData( @"hash_66C253CF816B40B5", f25_local4, AlwaysFalse ) ) --[[ @ 0]]
	end
	return f25_local0
end, true ) --[[ @ 0]]
...
DataSources.MOTDBannerList = ListHelper_SetupDataSource( "MOTDBannerList", function ( f51_arg0, f51_arg1 )
	...
	if Dvar[@"hash_261B37B5CD0C5CC1"]:get() then
		local f51_local2 = function ( f52_arg0, f52_arg1, f52_arg2, f52_arg3, f52_arg4, f52_arg5, f52_arg6, f52_arg7, f52_arg8, f52_arg9, f52_arg10 )
			...
			f52_local0.models.locationID = Engine[@"hash_48506F73B393062F"]( 1 ) --[[ @ 0]]
			f52_local0.models.image = f52_arg2 --[[ @ 0]]
			f52_local0.models.messageID = Engine[@"hash_48506F73B393062F"]( f52_arg9 ) --[[ @ 0]]
...
CoD.MOTDUtility.FeatureCard_SetPopupActionButtonName = function ( f68_arg0, f68_arg1, f68_arg2, f68_arg3 )
	...
	if f68_local0 then
		...
		if f68_local1 == "store" then
			CoD.Menu.SetButtonLabel( f68_arg3, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], @"hash_13C12F98C86B4DA8" ) --[[ @ 0]]
		elseif f68_local1 == "registration" then
			CoD.Menu.SetButtonLabel( f68_arg3, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], @"hash_11AF6B0A327DB28A" ) --[[ @ 0]]
		elseif f68_local1 == "depot" then
			CoD.Menu.SetButtonLabel( f68_arg3, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], @"hash_229C903C6DF90D6F" ) --[[ @ 0]]
		elseif f68_local1 == "shop" then
			CoD.Menu.SetButtonLabel( f68_arg3, Enum[@"LUIButton"][@"hash_4C083113BC81F23F"], @"hash_790379DA9EEC8DB9" ) --[[ @ 0]]
		end
	end
end
 --[[ @ 0]]
