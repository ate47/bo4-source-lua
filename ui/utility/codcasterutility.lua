...
CoD.CodCasterUtility.GetAttackingTeamColor = function ( f1_arg0 )
	...
	if f1_arg0 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
		f1_local0 = CoD.TeamUtility.GetTeamFactionColor( Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] ) --[[ @ 0]]
	else
		f1_local0 = CoD.TeamUtility.GetTeamFactionColor( Enum[@"team_t"][@"hash_42A34B055ADD98AB"] ) --[[ @ 0]]
	end
	return f1_local0
end
 --[[ @ 0]]
...
CoD.CodCasterUtility.GetCodCasterFactionIcon = function ( f6_arg0, f6_arg1 )
	...
	if f6_arg1 == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
		f6_local0 = "team1" --[[ @ 0]]
	elseif f6_arg1 == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
		f6_local0 = "team2" --[[ @ 0]]
	end
	if f6_local0 then
...
CoD.CodCasterUtility.GetStandardOrCodCasterTeam = function ( f8_arg0 )
	...
	if IsCodCaster( f8_arg0 ) then
		f8_local0 = Enum[@"team_t"][@"hash_42A34B055ADD98AB"] --[[ @ 0]]
	else
...
CoD.CodCasterUtility.CodCasterIsInAerialCam = function ( f16_arg0 )
	...
	if not f16_local0 then
		f16_local0 = Engine[@"hash_12548878F5D63D47"]( f16_arg0 ) --[[ @ 0]]
	end
	return f16_local0
end
 --[[ @ 0]]
...
CoD.CodCasterUtility.CharacterIndexForClientNum = function ( f20_arg0, f20_arg1 )
	if f20_arg1 == -1 then
		...
		local f20_local0 = Engine[@"hash_140145EEB2E913D2"]( f20_arg0, f20_arg1 ) --[[ @ 0]]
...
CoD.CodCasterUtility.GetPrimaryWeaponName = function ( f23_arg0, f23_arg1 )
	...
	return Engine[@"hash_4F9F1239CFD921FE"]( Engine[@"GetItemName"]( f23_local0:get(), Enum[@"hash_6EB546760F890D2"][@"hash_13057ABF96AF8289"], Engine[@"CurrentSessionMode"]() ) )
end
 --[[ @ 0]]
CoD.CodCasterUtility.GetSecondaryWeaponName = function ( f24_arg0, f24_arg1 )
	...
	return Engine[@"hash_4F9F1239CFD921FE"]( Engine[@"GetItemName"]( f24_local0:get(), Enum[@"hash_6EB546760F890D2"][@"hash_13057ABF96AF8289"], Engine[@"CurrentSessionMode"]() ) )
end
 --[[ @ 0]]
...
CoD.CodCasterUtility.AreCodCasterAssigned = function ( f28_arg0 )
	local f28_local0 = Engine[@"hash_4755D55B3813D249"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"], Engine[@"hash_3C3DF042E7492B66"]( Enum[@"LobbyModule"][@"hash_298EA1BB7164D103"] ) ) --[[ @ 0]]
	for f28_local4, f28_local5 in ipairs( f28_local0.sessionClients ) --[[ @ 0]] do
		if f28_local5.team == Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
			return true
		end
	end
	return false
...
CoD.CodCasterUtility.IsCodCasterAssigned = function ( f29_arg0 )
	...
	local f29_local1 = Engine[@"hash_E4D2F32833CFA6C"]( CoD.AARUtility.GetInGameClientNum( f29_arg0 ) ) --[[ @ 0]]
	if f29_local1.team:get() == Enum[@"team_t"][@"hash_5E4DDAC9C5C45556"] then
		return true
	else
		return false
	end
...
CoD.CodCasterUtility.Announcement.ExtraDataToStringParameter = function ( f35_arg0, f35_arg1 )
	if f35_arg0 <= 0 then
		return nil
	elseif f35_arg1 == @"hash_1E6607166B31C6DD" then
		if f35_arg0 == 1 then
			return "A"
...
CoD.CodCasterUtility.Announcement.OnNewAnnouncement = function ( f37_arg0, f37_arg1, f37_arg2 )
	return function ( f38_arg0 )
		...
		if CoD.CodCasterUtility.Announcement.Data == nil then
			CoD.CodCasterUtility.Announcement.Data = Engine[@"hash_2E00B2F29271C60B"]( @"hash_3BAC2BE54C1FC57A" ) --[[ @ 0]]
		end
...
CoD.CodCasterUtility.Announcement.ShowAnnouncement = function ( f40_arg0, f40_arg1, f40_arg2, f40_arg3 )
	...
	local f40_local2 = f40_local0[@"hash_100DE167907C171A"] --[[ @ 0]]
	local f40_local3 = f40_local0[@"hash_48A3366583423D67"] --[[ @ 0]]
	local f40_local4 = math.floor( f40_local0[@"delay"] * 1000 ) + 400 --[[ @ 0]]
	local f40_local5 = nil --[[ @ 0]]
	local f40_local6 = CoD.CodCasterUtility.Announcement.ExtraDataToStringParameter( f40_arg2.extraData, f40_local0[@"hash_30FA4B83BCF32178"] ) --[[ @ 0]]
	if f40_local6 then
	...
	elseif f40_arg2.teamId == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] or f40_arg2.teamId == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
	...
	if not ScoreboardVisible( f40_arg1 ) and IsCodCasterProfileValueEqualTo( f40_arg1, "shoutcaster_ds_teamscore", 1 ) and IsCodCasterProfileValueEqualTo( f40_arg1, "shoutcaster_qs_playerlist", 1 ) and IsCodCasterProfileValueEqualTo( f40_arg1, "shoutcaster_ds_notification_announcements", 1 ) then
		if f40_arg2.teamId == Enum[@"team_t"][@"hash_33F83D7CE4BD7B68"] then
			f40_arg3.announcementImageHighlightRight:setRGB( f40_arg2.teamColor ) --[[ @ 0]]
			f40_local1:playClip( "OnTeam2" ) --[[ @ 0]]
		elseif f40_arg2.teamId == Enum[@"team_t"][@"hash_42A34B055ADD98AB"] then
...
CoD.CodCasterUtility.SetPortraitHoverState = function ( f77_arg0, f77_arg1, f77_arg2 )
	...
	if f77_arg2 then
		...
		Dvar[@"hash_69E29B87C17AED9"]:set( f77_local0 ) --[[ @ 0]]
...
CoD.CodCasterUtility.IsPlayerAtIndexAlive = function ( f80_arg0, f80_arg1, f80_arg2, f80_arg3, f80_arg4 )
	...
	local f80_local1 = Engine[@"hash_E4D2F32833CFA6C"]( Engine[@"GetModelValue"]( Engine[@"GetModel"]( f80_local0:getModel(), "clientNum" ) ) ) --[[ @ 0]]
...
CoD.CodCasterUtility.GetTeamPlayerCount = function ( f94_arg0, f94_arg1 )
	...
	for f94_local2 = 0 --[[ @ 0]], f94_local1 - 1, 1 do
		local f94_local5 = Engine[@"hash_E4D2F32833CFA6C"]( f94_local2 ) --[[ @ 0]]
...
CoD.CodCasterUtility.AreCodCasterOptionsDefault = function ( f98_arg0, f98_arg1 )
	if f98_arg0 then
		for f98_local3, f98_local4 in ipairs( Engine[@"hash_7A7E3CD65E63086F"]( f98_arg0 ) ) --[[ @ 0]] do
			if CoD.ShoutcasterProfileVarValue( f98_arg1, f98_local4[@"hash_66E183377E0C37F4"] ) ~= CoD.OptionsUtility.GetPlayerSettingDefaultValueFromOptionInfo( f98_arg1, f98_local4 ) then
				return false
			end
		end
	end
	...
	for f99_local10, f99_local11 in ipairs( f99_arg1 ) --[[ @ 0]] do
		...
		if f99_local11.options and not (f99_arg0 ~= Engine[@"GetPrimaryController"]() and IsInGame()) then
			for f99_local7, f99_local8 in ipairs( f99_local11.options ) --[[ @ 0]] do
				local f99_local9 = Engine[@"hash_2E00B2F29271C60B"]( Engine[@"hash_1C53F8D38DF9042B"]( f99_local8 ) ) --[[ @ 0]]
...
CoD.CodCasterUtility.CodCasterSettings.QuickSettingsCategories = {
	{
		gameSettingListName = @"hash_3DE2BF5462B82D4D"
	}
} --[[ @ 0]]
...
CoD.CodCasterUtility.NonTeamBasedPostLoad = function ( f120_arg0, f120_arg1 )
	local f120_local0 = Engine[@"hash_5EA74FA7EE46E195"]( Engine[@"GetCurrentGameType"]() ) --[[ @ 0]]
...
CoD.CodCasterUtility.SetLoadoutWildcardsText = function ( f143_arg0 )
	...
	for f143_local1 = 1 --[[ @ 0]], f143_local0, 1 do
		...
		if f143_local4 ~= nil then
			...
			f143_local4.CodCasterLoadoutSelection.ItemName:setText( Engine[@"hash_4F9F1239CFD921FE"]( Engine[@"GetItemName"]( Engine[@"hash_2D97229B24C685D5"]( f143_local5:get(), Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] ), Enum[@"hash_6EB546760F890D2"][@"hash_1A949B83CC070B0"], Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] ) ) ) --[[ @ 0]]
		end
	end
end
 --[[ @ 0]]
...
CoD.CodCasterUtility.SetLoadoutElementsText = function ( f147_arg0, f147_arg1, f147_arg2 )
	...
	if f147_local8 ~= nil then
		f147_local7.CodCasterLoadoutModulePrimaryWeapon.CodCasterLoadoutSelection.ItemName:setText( Engine[@"hash_4F9F1239CFD921FE"]( Engine[@"GetItemName"]( f147_local8, Enum[@"hash_6EB546760F890D2"][@"hash_6569E84652131CD7"], Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] ) ) ) --[[ @ 0]]
	end
	...
	if f147_local8 ~= nil then
		f147_local10.CodCasterLoadoutModuleSecondaryWeapon.CodCasterLoadoutSelection.ItemName:setText( Engine[@"hash_4F9F1239CFD921FE"]( Engine[@"GetItemName"]( f147_local8, Enum[@"hash_6EB546760F890D2"][@"hash_6569E84652131CD7"], Enum[@"eModes"][@"hash_383EBA96F36BC4E5"] ) ) ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.CodCasterUtility.ScoreByGametype = function ( f164_arg0, f164_arg1 )
	...
	if CoD.CodCasterUtility.IsGameTypeOrHCVariant( "sd" ) then
		local f164_local1 = Engine[@"hash_E4D2F32833CFA6C"]( f164_local0 ) --[[ @ 0]]
		f164_local1 = f164_local1["scoreboard.footer1"] --[[ @ 0]]
		local f164_local2 = Engine[@"hash_E4D2F32833CFA6C"]( f164_local0 ) --[[ @ 0]]
		...
		if f168_local3 then
			...
			if f168_local4 then
				for f168_local8, f168_local9 in ipairs( Engine[@"hash_7A7E3CD65E63086F"]( f168_local4 ) ) --[[ @ 0]] do
					CoD.SetShoutcasterProfileVarValue( f168_arg0, f168_local9[@"hash_66E183377E0C37F4"], CoD.OptionsUtility.GetPlayerSettingDefaultValueFromOptionInfo( f168_arg0, f168_local9 ) ) --[[ @ 0]]
				end
			end
		end
	end
...
CoD.CodCasterUtility.TeamSettings_RenameTeam = function ( f176_arg0, f176_arg1 )
	...
	if not Engine[@"hash_E3FC4BECF450A06"]( f176_arg1, f176_local0, Enum[@"KeyboardType"][@"hash_424364F159D318D1"] ) then
	...
	for f180_local0 = 1 --[[ @ 0]], #f180_arg1, 1 do
		...
		if f180_local3 then
			for f180_local7, f180_local8 in ipairs( Engine[@"hash_7A7E3CD65E63086F"]( f180_local3 ) ) --[[ @ 0]] do
				CoD.SetShoutcasterProfileVarValue( f180_arg0, f180_local8[@"hash_66E183377E0C37F4"], CoD.OptionsUtility.GetPlayerSettingDefaultValueFromOptionInfo( f180_arg0, f180_local8 ) ) --[[ @ 0]]
				CoD.OptionsUtility.NotifyPlayerSettingsUpdate( f180_arg0, f180_local8[@"name"] ) --[[ @ 0]]
				if Engine[@"IsInGame"]() and f180_local8[@"hash_66E183377E0C37F4"] == "shoutcaster_ds_thirdperson" then
					Engine[@"ExecNow"]( f180_arg0, "shoutcaster_thirdperson " .. CoD.ShoutcasterProfileVarValue( f180_arg0, f180_local8[@"hash_66E183377E0C37F4"] ) ) --[[ @ 0]]
				end
			end
		end
	end
...
CoD.CodCasterUtility.SwapTeamIdentity = function ( f188_arg0, f188_arg1 )
	if CoD.ShoutcasterProfileVarBool( f188_arg1, "shoutcaster_fe_team_identity" ) then
		...
		Engine[@"StorageWrite"]( f188_arg1, Enum[@"StorageFileType"][@"hash_20ED1503A2D3DAE6"] ) --[[ @ 0]]
	end
end
 --[[ @ 0]]
...
CoD.CodCasterUtility.HandleListenInForProfileChange = function ( f190_arg0 )
	if not CoD.ShoutcasterProfileVarBool( f190_arg0, "shoutcaster_qs_listen_in" ) then
		Engine[@"exec"]( f190_arg0, "shoutcastSetListenInTeam " .. Enum[@"team_t"][@"hash_BD65CBD25CCBEDC"] ) --[[ @ 0]]
		return 
	end
...
CoD.CodCasterUtility.PostLoadFunc = function ( f191_arg0, f191_arg1, f191_arg2 )
	...
	f191_arg0:subscribeToModel( Engine[@"GetModel"]( Engine[@"GetModelForController"]( f191_arg1 ), "UIVisibilityBit." .. Enum[@"UIVisibilityBit"][@"hash_2A69E34E231CE8B6"] ), function ( model )
		f191_arg0:processEvent( {
			name = "gain_focus",
			controller = f191_arg1
		} ) --[[ @ 0]]
