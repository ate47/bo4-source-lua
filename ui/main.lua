...
if CoD.isFrontend then
	...
	local f0_local16 = function ( f29_arg0, f29_arg1 )
		Engine[@"setactivemenu"]( f29_arg1.controller, Enum[@"uimenucommand_t"][@"uimenu_none"] ) --[[ @ 0]]
	end
	 --[[ @ 0]]
	...
	function HUD_SetupEventHandlers_Multiplayer( f43_arg0 )
		...
		f43_arg0:subscribeToModel( Engine[@"getmodel"]( f43_local2, "UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_spectating_client"] ), f43_local1 ) --[[ @ 0]]
		f43_arg0:subscribeToModel( Engine[@"getmodel"]( f43_local2, "UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_team_spectator"] ), f43_local1 ) --[[ @ 0]]
		f43_arg0:subscribeToModel( Engine[@"getmodel"]( f43_local2, "UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_ui_active"] ), f43_local1 ) --[[ @ 0]]
		f43_arg0:subscribeToModel( Engine[@"getmodel"]( f43_local2, "UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_game_ended"] ), f43_local1 ) --[[ @ 0]]
		f43_arg0:subscribeToModel( Engine[@"getmodel"]( f43_local2, "UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_in_killcam"] ), f43_local1 ) --[[ @ 0]]
		f43_arg0:subscribeToModel( Engine[@"getmodel"]( f43_local2, "UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_final_killcam"] ), f43_local1 ) --[[ @ 0]]
		f43_arg0:subscribeToModel( Engine[@"getmodel"]( f43_local2, "UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_round_end_killcam"] ), f43_local1 ) --[[ @ 0]]
		f43_arg0:subscribeToModel( Engine[@"getmodel"]( f43_local2, "UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_play_of_the_match"] ), f43_local1 ) --[[ @ 0]]
		f43_arg0:subscribeToModel( Engine[@"getmodel"]( f43_local2, "UIVisibilityBit." .. Enum[@"uivisibilitybit"][@"bit_migrating_host"] ), f43_local1 ) --[[ @ 0]]
		...
		f43_arg0:subscribeToModel( f43_local2.heldWeapons[0]:create( "viewmodelWeaponName" ), function ( model )
			CoD.HUDUtility[@"updateicepick"]( f43_arg0, f43_arg0.safeArea, model:get(), f43_local0 ) --[[ @ 0]]
		end ) --[[ @ 0]]
	...
	function HUD_FirstSnapshot_Common( f58_arg0, f58_arg1 )
		CoD.scoreInfoTable = CoD.GameTypeUtility.GetGameTypeValue( Engine[@"lobbygetgametype"](), "scoreInfoFile", CoD.scoreInfoTable ) --[[ @ 0]]
	...
	function HUD_AddHintTextElements( f59_arg0, f59_arg1 )
		...
		local f59_local1 = Engine[@"lobbygetgametype"]() --[[ @ 0]]
	...
	function HUD_FirstSnapshot_NotZombie( f70_arg0, f70_arg1 )
		...
		local f70_local3 = Engine[@"lobbygetgametype"]() --[[ @ 0]]
	...
	function HUD_CloseInGameMenu( f99_arg0, f99_arg1 )
		...
		f0_local9 = nil --[[ @ 0]]
		if Engine[@"canpausegame"]() then
			Engine[@"setactivemenu"]( f99_arg1.controller, Enum[@"uimenucommand_t"][@"uimenu_none"] ) --[[ @ 0]]
		end
	end
	...
	local f0_local23 = function ( f108_arg0 )
		...
		if Engine[@"issplitscreen"]() == false then
			if Engine[@"isdemoshoutcaster"]() ~= true then
				f108_local0 = Engine[@"isvisibilitybitset"]( f108_arg0, Enum[@"uivisibilitybit"][@"bit_spectating_client"] ) --[[ @ 0]]
				if f108_local0 then
					f108_local0 = Engine[@"isvisibilitybitset"]( f108_arg0, Enum[@"uivisibilitybit"][@"bit_team_spectator"] ) --[[ @ 0]]
					if f108_local0 then
						if not Engine[@"isvisibilitybitset"]( f108_arg0, Enum[@"uivisibilitybit"][@"bit_game_ended"] ) then
							f108_local0 = not Engine[@"isvisibilitybitset"]( f108_arg0, Enum[@"uivisibilitybit"][@"bit_ui_active"] ) --[[ @ 0]]
						else
							f108_local0 = false --[[ @ 0]]
						end
					end
	...
	f0_local6 = function ( f114_arg0, f114_arg1 )
		...
		local f114_local5 = Engine[@"getmodelforclient"]( f114_local0 ) --[[ @ 0]]
	...
	function HUD_IsFFA()
		if f0_local7 == nil then
			local f115_local0 = Engine[@"lobbygetgametype"]() --[[ @ 0]]
			local f115_local1 --[[ @ 0]]
